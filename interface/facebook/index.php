 ...
 * Last Updated: $Date: 2014-10-07 21:14:20 -0400 (Tue, 07 Oct 2014) $
 * </pre>
 *
...
if ( isset( $_GET['error'] ) AND $_GET['error_reason'] == 'user_denied' )
{
	$facebook->userHasRemovedApp();
	$registry->getClass('output')->silentRedirect( ipsRegistry::$settings['board_url'] );
	exit();
}
