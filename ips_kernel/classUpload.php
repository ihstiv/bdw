 ...
 * Last Updated: $Date: 2014-09-09 04:24:53 -0400 (Tue, 09 Sep 2014) $
 * </pre>
 *
	...
	public function process()
	{
		...
		if ( $this->is_image )
		{
			...
			if ( $this->image_check )
			{
				...
				if( !in_array( $img_attributes[2], array( IMAGETYPE_GIF, IMAGETYPE_JPEG, IMAGETYPE_PNG ) ) )
				{
