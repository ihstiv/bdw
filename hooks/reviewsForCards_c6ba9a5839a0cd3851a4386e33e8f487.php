...
class reviewsForCards
{
	...
	public function getOutput()
	{
        ...
        if( $this->settings['mr_status'] == '1' && $this->settings['mr_view_card'] == '1' ){
		...
		$member	    = $this->registry->output->getTemplate('profile')->functionData['showCard'][0]['member'];
					...
					if ( isset( $member['reviews'] ) )
					{
                         ...
                         /* The new HTML */
                         $stuff = $this->registry->output->getTemplate('reviews_hooks')->reviewsInCard($reviews);
                    }
        }
