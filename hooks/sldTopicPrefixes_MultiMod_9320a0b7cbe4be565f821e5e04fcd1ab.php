...
/**
 * Change the prefix/tags after submitting an in-topic multimod
 */

IPSDebug::fireBug( 'info', array( 'Loaded sldTopicPrefixes_MultiMod' ) );

class sldTopicPrefixes_MultiMod extends public_forums_moderate_multimod
{
	/**
	 * Multi-mod?
	 */
