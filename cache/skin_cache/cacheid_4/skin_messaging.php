...
{
$count_75188849c3bb6701209dc7d8f986c402 = is_array($this->functionData['messengerDisabled']) ? count($this->functionData['messengerDisabled']) : 0;
}
...
{
$count_1c804fe61cd05e17b32cc7e81d0275d9 = is_array($this->functionData['messengerTemplate']) ? count($this->functionData['messengerTemplate']) : 0;
$this->functionData['messengerTemplate'][$count_1c804fe61cd05e17b32cc7e81d0275d9]['html'] = $html;
$this->functionData['messengerTemplate'][$count_1c804fe61cd05e17b32cc7e81d0275d9]['jumpmenu'] = $jumpmenu;
$this->functionData['messengerTemplate'][$count_1c804fe61cd05e17b32cc7e81d0275d9]['dirData'] = $dirData;
$this->functionData['messengerTemplate'][$count_1c804fe61cd05e17b32cc7e81d0275d9]['totalData'] = $totalData;
$this->functionData['messengerTemplate'][$count_1c804fe61cd05e17b32cc7e81d0275d9]['topicParticipants'] = $topicParticipants;
$this->functionData['messengerTemplate'][$count_1c804fe61cd05e17b32cc7e81d0275d9]['inlineError'] = $inlineError;
$this->functionData['messengerTemplate'][$count_1c804fe61cd05e17b32cc7e81d0275d9]['deletedTopic'] = $deletedTopic;
}
...
<div id='messenger_utilities' class='left'>
	...
	" . ((is_array( $topicParticipants ) and count( $topicParticipants )) ? ("<div class='ipsSideBlock' id='participants'>
			...
			<ul id='participants_list' class='ipsList_withminiphoto'>
				".$this->__f__19ba7781b86ab0229e1d4c20fe474dd2($html,$jumpmenu,$dirData,$totalData,$topicParticipants,$inlineError,$deletedTopic)."					
			</ul>
	...
	<div id='folder_list' class='ipsSideBlock'>
		...
		<ol id='folders'>
			" . ((count($dirData)) ? ("
				".$this->__f__64c3abdf0bf5e6e23d14d8ec1f257bba($html,$jumpmenu,$dirData,$totalData,$topicParticipants,$inlineError,$deletedTopic)."			") : ("")) . "
		</ol>
...
function __f__19ba7781b86ab0229e1d4c20fe474dd2($html, $jumpmenu, $dirData, $totalData=array(), $topicParticipants=array(), $inlineError='', $deletedTopic=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__64c3abdf0bf5e6e23d14d8ec1f257bba($html, $jumpmenu, $dirData, $totalData=array(), $topicParticipants=array(), $inlineError='', $deletedTopic=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_9ddec2aeb93f6fafb05479a0dcbce264 = is_array($this->functionData['sendNewPersonalTopicForm']) ? count($this->functionData['sendNewPersonalTopicForm']) : 0;
$this->functionData['sendNewPersonalTopicForm'][$count_9ddec2aeb93f6fafb05479a0dcbce264]['displayData'] = $displayData;
}
...
<div class='message error'>
	...
	".$this->__f__e7e0c482dc8c2dd0db495c0d0676e67e($displayData)."	<p>{$this->lang->words['pme_none_sent']}</p>
</div>
") : ("")) . "
<div class='ipsBox'>
...
function __f__e7e0c482dc8c2dd0db495c0d0676e67e($displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_7182c07b900cda827fe4aaff48af3292 = is_array($this->functionData['sendReplyForm']) ? count($this->functionData['sendReplyForm']) : 0;
$this->functionData['sendReplyForm'][$count_7182c07b900cda827fe4aaff48af3292]['displayData'] = $displayData;
}
$IPBHTML .= "<div id='message_compose' class='post_form'>
...
<div class='message error'>
	<h4>{$this->lang->words['err_errors']}</h4>
	".$this->__f__78b04cb0ae42a6e63d8837f7eb33b23a($displayData)."	<p>{$this->lang->words['pme_none_sent']}</p>
</div>
") : ("")) . "
<div class='ipsBox'>
	<div class='ipsBox_container'>
...
function __f__78b04cb0ae42a6e63d8837f7eb33b23a($displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $displayData['errors'] as $_error )
...
{
$count_906902adbaccc963b664612561231c0d = is_array($this->functionData['showConversation']) ? count($this->functionData['showConversation']) : 0;
$this->functionData['showConversation'][$count_906902adbaccc963b664612561231c0d]['topic'] = $topic;
$this->functionData['showConversation'][$count_906902adbaccc963b664612561231c0d]['replies'] = $replies;
$this->functionData['showConversation'][$count_906902adbaccc963b664612561231c0d]['members'] = $members;
$this->functionData['showConversation'][$count_906902adbaccc963b664612561231c0d]['jump'] = $jump;
}
...
<div class='ipsBox'>
	<div class='ipsBox_container'>
		".$this->__f__7dcf02c7a26ade4671500022061cc89f($topic,$replies,$members,$jump)."	</div>
</div>
...
function __f__7dcf02c7a26ade4671500022061cc89f($topic, $replies, $members, $jump="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_4b5d8c407e76887e97a62069e2db9828 = is_array($this->functionData['showConversationForArchive']) ? count($this->functionData['showConversationForArchive']) : 0;
$this->functionData['showConversationForArchive'][$count_4b5d8c407e76887e97a62069e2db9828]['topic'] = $topic;
$this->functionData['showConversationForArchive'][$count_4b5d8c407e76887e97a62069e2db9828]['replies'] = $replies;
$this->functionData['showConversationForArchive'][$count_4b5d8c407e76887e97a62069e2db9828]['members'] = $members;
}
...
$IPBHTML .= "<html>
	...
	<body>
		...
		<br />
		<br />
		".$this->__f__6c55aa452c846b76d02045a2cda39516($topic,$replies,$members)."	</body>
</html>";
return $IPBHTML;
}


function __f__6c55aa452c846b76d02045a2cda39516($topic, $replies, $members)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $replies as $msg_id => $msg )
...
{
$count_24eb828c3384f87b2bfbd3cc08c7bf8f = is_array($this->functionData['showFolder']) ? count($this->functionData['showFolder']) : 0;
$this->functionData['showFolder'][$count_24eb828c3384f87b2bfbd3cc08c7bf8f]['messages'] = $messages;
$this->functionData['showFolder'][$count_24eb828c3384f87b2bfbd3cc08c7bf8f]['dirname'] = $dirname;
$this->functionData['showFolder'][$count_24eb828c3384f87b2bfbd3cc08c7bf8f]['pages'] = $pages;
$this->functionData['showFolder'][$count_24eb828c3384f87b2bfbd3cc08c7bf8f]['currentFolderID'] = $currentFolderID;
$this->functionData['showFolder'][$count_24eb828c3384f87b2bfbd3cc08c7bf8f]['jumpFolderHTML'] = $jumpFolderHTML;
}
		...
		<div class='ipsBox'>
			<div class='ipsBox_container'>
				<table class='ipb_table' id='message_table'>
					...
					" . ((count( $messages )) ? ("
						".$this->__f__601210acf9116dbe5d6e0b4b4bf869ef($messages,$dirname,$pages,$currentFolderID,$jumpFolderHTML)."					") : ("
						<tr>
...
function __f__efae902ee39ee6189011b9a1d9431ad2($messages, $dirname, $pages, $currentFolderID, $jumpFolderHTML,$id='',$msg='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__601210acf9116dbe5d6e0b4b4bf869ef($messages, $dirname, $pages, $currentFolderID, $jumpFolderHTML)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
							...
							<tr id='{$msg['mt_id']}' class='" . (($msg['map_has_unread']) ? ("unread") : ("")) . "'>
								...
								<td class='col_m_subject'>
									...
									" . ((is_array( $msg['pages'] ) AND count( $msg['pages'] )) ? ("
										...
										".$this->__f__efae902ee39ee6189011b9a1d9431ad2($messages,$dirname,$pages,$currentFolderID,$jumpFolderHTML,$id,$msg)."										</ul>
									") : ("")) . "
								</td>
...
{
$count_21007548abbaf6eb4b6284e537554387 = is_array($this->functionData['showSearchResults']) ? count($this->functionData['showSearchResults']) : 0;
$this->functionData['showSearchResults'][$count_21007548abbaf6eb4b6284e537554387]['messages'] = $messages;
$this->functionData['showSearchResults'][$count_21007548abbaf6eb4b6284e537554387]['pages'] = $pages;
$this->functionData['showSearchResults'][$count_21007548abbaf6eb4b6284e537554387]['error'] = $error;
}
$IPBHTML .= "<script type='text/javascript'>
//<![CDATA[
	...
	<div class='ipsBox'>
		<div class='ipsBox_container'>
			<table class='ipb_table' id='message_table'>
				...
				" . ((count( $messages )) ? ("
					".$this->__f__f2c4626a16ba8a041ad305a0a2a8632a($messages,$pages,$error)."				") : ("
					<tr>
...
function __f__f2c4626a16ba8a041ad305a0a2a8632a($messages, $pages, $error)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $messages as $id => $msg )
