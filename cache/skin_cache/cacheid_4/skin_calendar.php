...
{
$count_fc9025fac7d6ecaa97e35444139a0c4e = is_array($this->functionData['bbCodeEvent']) ? count($this->functionData['bbCodeEvent']) : 0;
$this->functionData['bbCodeEvent'][$count_fc9025fac7d6ecaa97e35444139a0c4e]['event'] = $event;
$this->functionData['bbCodeEvent'][$count_fc9025fac7d6ecaa97e35444139a0c4e]['type'] = $type;
$this->functionData['bbCodeEvent'][$count_fc9025fac7d6ecaa97e35444139a0c4e]['ends'] = $ends;
}
...
{
$count_ee24f1b436d94f8a2b76f2ce1657540a = is_array($this->functionData['boardIndexBirthdays']) ? count($this->functionData['boardIndexBirthdays']) : 0;
$this->functionData['boardIndexBirthdays'][$count_ee24f1b436d94f8a2b76f2ce1657540a]['birthdays'] = $birthdays;
$this->functionData['boardIndexBirthdays'][$count_ee24f1b436d94f8a2b76f2ce1657540a]['data'] = $data;
}
		...
		<div class='_sbcollapsable'>
			" . ((count( $birthdays )) ? ("
				<ul class='ipsList_withminiphoto'>
					".$this->__f__c0faad7ce09e563bfe5580ba30f22482($birthdays,$data)."				</ul>
			") : ("
...
function __f__c0faad7ce09e563bfe5580ba30f22482($birthdays, $data=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_fae0d1f4fca7be34e0cd4cb4d589f910 = is_array($this->functionData['boardIndexCalEvents']) ? count($this->functionData['boardIndexCalEvents']) : 0;
$this->functionData['boardIndexCalEvents'][$count_fae0d1f4fca7be34e0cd4cb4d589f910]['events'] = $events;
}
		...
		<div class='_sbcollapsable'>
			" . ((is_array( $events )) ? ("
				<ul itemscope itemtype=\"http://schema.org/Event\" class='ipsList_withminiphoto'>
					".$this->__f__f55f31e8b9f10d65b5a2f23fe0ce4859($events)."				</ul>
			") : ("
...
function __f__f55f31e8b9f10d65b5a2f23fe0ce4859($events)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_5bef491fdbd1b1909dc239ed21b27e97 = is_array($this->functionData['cal_date_cell']) ? count($this->functionData['cal_date_cell']) : 0;
$this->functionData['cal_date_cell'][$count_5bef491fdbd1b1909dc239ed21b27e97]['day'] = $day;
$this->functionData['cal_date_cell'][$count_5bef491fdbd1b1909dc239ed21b27e97]['events'] = $events;
$this->functionData['cal_date_cell'][$count_5bef491fdbd1b1909dc239ed21b27e97]['cal_date_queued'] = $cal_date_queued;
$this->functionData['cal_date_cell'][$count_5bef491fdbd1b1909dc239ed21b27e97]['queued'] = $queued;
$this->functionData['cal_date_cell'][$count_5bef491fdbd1b1909dc239ed21b27e97]['js_id'] = $js_id;
}
$IPBHTML .= "<!--Day-->
...
{
$count_69a03e5797e9f03f1aede21efe7e7e53 = is_array($this->functionData['cal_date_cell_today']) ? count($this->functionData['cal_date_cell_today']) : 0;
$this->functionData['cal_date_cell_today'][$count_69a03e5797e9f03f1aede21efe7e7e53]['day'] = $day;
$this->functionData['cal_date_cell_today'][$count_69a03e5797e9f03f1aede21efe7e7e53]['events'] = $events;
$this->functionData['cal_date_cell_today'][$count_69a03e5797e9f03f1aede21efe7e7e53]['cal_date_queued'] = $cal_date_queued;
$this->functionData['cal_date_cell_today'][$count_69a03e5797e9f03f1aede21efe7e7e53]['queued'] = $queued;
$this->functionData['cal_date_cell_today'][$count_69a03e5797e9f03f1aede21efe7e7e53]['js_id'] = $js_id;
}
$IPBHTML .= "<!--Day-->
...
{
$count_36442ab4ce07daf292ca4179af9e9628 = is_array($this->functionData['cal_week_dayentry']) ? count($this->functionData['cal_week_dayentry']) : 0;
$this->functionData['cal_week_dayentry'][$count_36442ab4ce07daf292ca4179af9e9628]['wday'] = $wday;
$this->functionData['cal_week_dayentry'][$count_36442ab4ce07daf292ca4179af9e9628]['date'] = $date;
$this->functionData['cal_week_dayentry'][$count_36442ab4ce07daf292ca4179af9e9628]['month'] = $month;
$this->functionData['cal_week_dayentry'][$count_36442ab4ce07daf292ca4179af9e9628]['mid'] = $mid;
$this->functionData['cal_week_dayentry'][$count_36442ab4ce07daf292ca4179af9e9628]['year'] = $year;
$this->functionData['cal_week_dayentry'][$count_36442ab4ce07daf292ca4179af9e9628]['events'] = $events;
$this->functionData['cal_week_dayentry'][$count_36442ab4ce07daf292ca4179af9e9628]['queued'] = $queued;
}
...
{
$count_2b05d6c526a38ebe30ebabce81fd157e = is_array($this->functionData['calendar_likeSummaryContents']) ? count($this->functionData['calendar_likeSummaryContents']) : 0;
$this->functionData['calendar_likeSummaryContents'][$count_2b05d6c526a38ebe30ebabce81fd157e]['data'] = $data;
$this->functionData['calendar_likeSummaryContents'][$count_2b05d6c526a38ebe30ebabce81fd157e]['relId'] = $relId;
$this->functionData['calendar_likeSummaryContents'][$count_2b05d6c526a38ebe30ebabce81fd157e]['opts'] = $opts;
}
...
{
$count_0575f7211edf9741ec0348b68fbc2c09 = is_array($this->functionData['calendarBirthdayList']) ? count($this->functionData['calendarBirthdayList']) : 0;
$this->functionData['calendarBirthdayList'][$count_0575f7211edf9741ec0348b68fbc2c09]['rows'] = $rows;
}
$IPBHTML .= "<h2 class='ipsType_subtitle'>{$this->lang->words['celebrating_bday']}</h2>
<br />
" . ((is_array( $rows ) and count( $rows )) ? ("
	".$this->__f__f5fc8601fa91b1c4e630b8a4d34e2843($rows)."") : ("
	<br />
...
function __f__f5fc8601fa91b1c4e630b8a4d34e2843($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_fb8fb266466d0193ec129f8314f3917c = is_array($this->functionData['calendarEventForm']) ? count($this->functionData['calendarEventForm']) : 0;
$this->functionData['calendarEventForm'][$count_fb8fb266466d0193ec129f8314f3917c]['data'] = $data;
}
...
{
$count_09f38e1b664bf806f21db6e1eee53e44 = is_array($this->functionData['calendarEventsList']) ? count($this->functionData['calendarEventsList']) : 0;
$this->functionData['calendarEventsList'][$count_09f38e1b664bf806f21db6e1eee53e44]['data'] = $data;
}
...
{
$count_513186eb30bdab079b021733a464534b = is_array($this->functionData['calendarJump']) ? count($this->functionData['calendarJump']) : 0;
$this->functionData['calendarJump'][$count_513186eb30bdab079b021733a464534b]['calendars'] = $calendars;
$this->functionData['calendarJump'][$count_513186eb30bdab079b021733a464534b]['calendar'] = $calendar;
$this->functionData['calendarJump'][$count_513186eb30bdab079b021733a464534b]['chosen_date'] = $chosen_date;
}
$IPBHTML .= "" . ((is_array( $calendars ) && count( $calendars ) > 1) ? ("
	...
	<ul class='ipbmenu_content' style='display: none' id='calendar_chooser_menucontent'>
		".$this->__f__899fcf4abd52e4fa17b7bec24d38c327($calendars,$calendar,$chosen_date)."	</ul>
	<script type='text/javascript'>
...
function __f__899fcf4abd52e4fa17b7bec24d38c327($calendars, $calendar, $chosen_date=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_23054cde762841acc3f80a4dd3d57d0e = is_array($this->functionData['calendarMainContent']) ? count($this->functionData['calendarMainContent']) : 0;
$this->functionData['calendarMainContent'][$count_23054cde762841acc3f80a4dd3d57d0e]['data'] = $data;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("calendar", "0" ) . "
<script type='text/javascript'>
	ipb.vars['month_url'] = \"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=calendar&module=calendar&section=view&cal_id={$data['calendar']['cal_id']}", "public",'' ), "", "" ) . "\";
...
<div class='ipsBox'>
	<div class='ipsBox_container'>
		<table id='calendar_table' class='ipsCalendar ipb_table vcalendar' summary=\"{$this->lang->words['calendar_for']} {$data['month_title']} {$data['chosen_date']['year']}\">
			<tr class='header'>
				".$this->__f__7da833c4865f8b92201eba240ce88858($data)."				{$data['events']}
			</tr>
		</table>
	</div>
</div>
...
function __f__7da833c4865f8b92201eba240ce88858($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_33720ff39e43a761cbe5674df65d530c = is_array($this->functionData['calendarWeekView']) ? count($this->functionData['calendarWeekView']) : 0;
$this->functionData['calendarWeekView'][$count_33720ff39e43a761cbe5674df65d530c]['data'] = $data;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("calendar", "0" ) . "
<script type='text/javascript'>
	ipb.vars['month_url'] = \"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=calendar&module=calendar&section=view&cal_id={$data['calendar']['cal_id']}", "public",'' ), "", "" ) . "\";
...
{
$count_c7643c623fda022b96c7d0f5f4367a75 = is_array($this->functionData['calEventFollowedWrapper']) ? count($this->functionData['calEventFollowedWrapper']) : 0;
$this->functionData['calEventFollowedWrapper'][$count_c7643c623fda022b96c7d0f5f4367a75]['rows'] = $rows;
}
...
$IPBHTML .= "<div id='search_results'>
	<ol>
		" . ((is_array($rows) && count($rows)) ? ("
			".$this->__f__d23e9a5e77ce793a2e05e6da9b5459d4($rows)."		") : ("")) . "
	</ol>
</div>";
return $IPBHTML;
}
...
function __f__d23e9a5e77ce793a2e05e6da9b5459d4($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_582b3fe54b518abebf0ae0cd4528f5ad = is_array($this->functionData['calEventSearchResult']) ? count($this->functionData['calEventSearchResult']) : 0;
$this->functionData['calEventSearchResult'][$count_582b3fe54b518abebf0ae0cd4528f5ad]['r'] = $r;
$this->functionData['calEventSearchResult'][$count_582b3fe54b518abebf0ae0cd4528f5ad]['resultAsTitle'] = $resultAsTitle;
$this->functionData['calEventSearchResult'][$count_582b3fe54b518abebf0ae0cd4528f5ad]['type'] = $type;
$this->functionData['calEventSearchResult'][$count_582b3fe54b518abebf0ae0cd4528f5ad]['ends'] = $ends;
}
...
{
$count_0eb99e67a598f950c44fcdbc4834a8cd = is_array($this->functionData['event_likeSummaryContents']) ? count($this->functionData['event_likeSummaryContents']) : 0;
$this->functionData['event_likeSummaryContents'][$count_0eb99e67a598f950c44fcdbc4834a8cd]['data'] = $data;
$this->functionData['event_likeSummaryContents'][$count_0eb99e67a598f950c44fcdbc4834a8cd]['relId'] = $relId;
$this->functionData['event_likeSummaryContents'][$count_0eb99e67a598f950c44fcdbc4834a8cd]['opts'] = $opts;
}
$IPBHTML .= "<span class='ipsButton_extra right " . (($data['totalCount']) ? ("_fmore clickable") : ("")) . "' title='" . sprintf( $this->lang->words['like_totalcount_' . $data['vernacular'] ], $data['totalCount'] ) . "' data-tooltip=\"" . sprintf( $this->lang->words['like_totalcount_' . $data['vernacular'] ], $data['totalCount'] ) . "\"><img src='{$this->settings['img_url']}/icon_users.png' /> <strong>{$data['totalCount']}</strong></span>
" . (($this->memberData['member_id']) ? ("<a href='#' title=\"" . (($data['iLike']) ? ("" . sprintf( $this->lang->words['fave_tt_on'], $this->lang->words['like_ucfirst_un' . $data['vernacular'] ]) . "") : ("" . sprintf( $this->lang->words['fave_tt_off'], $this->lang->words['like_ucfirst_' . $data['vernacular'] ]) . "")) . "\" class='ftoggle ipsButton_secondary'>" . (($data['iLike']) ? ("" . sprintf( $this->lang->words['unset_fave_button'], $this->lang->words['like_ucfirst_un' . $data['vernacular'] ]) . "") : ("" . sprintf( $this->lang->words['set_fave_button'], $this->lang->words['like_ucfirst_' . $data['vernacular'] ]) . "")) . "</a>") : ("")) . "";
return $IPBHTML;
...
{
$count_cbc7a2150a053c399c82a21487e67140 = is_array($this->functionData['eventAttendee']) ? count($this->functionData['eventAttendee']) : 0;
$this->functionData['eventAttendee'][$count_cbc7a2150a053c399c82a21487e67140]['member'] = $member;
$this->functionData['eventAttendee'][$count_cbc7a2150a053c399c82a21487e67140]['event'] = $event;
}
...
{
$count_d1b4cc4cc1fad8d7c8d0e31159d7b10e = is_array($this->functionData['followedContentCalendars']) ? count($this->functionData['followedContentCalendars']) : 0;
$this->functionData['followedContentCalendars'][$count_d1b4cc4cc1fad8d7c8d0e31159d7b10e]['rows'] = $rows;
}
$IPBHTML .= "<div id='search_results'>
	<ol>
		".$this->__f__53194ee424555d32e042f607726e53ad($rows)."	</ol>
</div>";
return $IPBHTML;
}


function __f__53194ee424555d32e042f607726e53ad($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $r )
...
{
$count_1cf606c578b93dbf6a24c54c1c961a3b = is_array($this->functionData['mini_cal_date_cell']) ? count($this->functionData['mini_cal_date_cell']) : 0;
$this->functionData['mini_cal_date_cell'][$count_1cf606c578b93dbf6a24c54c1c961a3b]['day'] = $day;
}
$IPBHTML .= "<td>
...
{
$count_9f6625d1803f206a184c8ce649176d7a = is_array($this->functionData['mini_cal_date_cell_today']) ? count($this->functionData['mini_cal_date_cell_today']) : 0;
$this->functionData['mini_cal_date_cell_today'][$count_9f6625d1803f206a184c8ce649176d7a]['day'] = $day;
}
...
{
$count_7b7e4ab6798b7054d092434d0aae10b1 = is_array($this->functionData['miniCalendarWrapper']) ? count($this->functionData['miniCalendarWrapper']) : 0;
$this->functionData['miniCalendarWrapper'][$count_7b7e4ab6798b7054d092434d0aae10b1]['data'] = $data;
}
$IPBHTML .= "<div class='mini_cal_wrap ipsBox'>
	<div class='ipsBox_container'>
		...
		<table class='mini_cal vcalendar'>
			<tr>
				".$this->__f__e80ca2694ad00cabd8887c44b3be00e3($data)."			
				{$data['events']}
			</tr>
		</table>
	</div>
...
function __f__e80ca2694ad00cabd8887c44b3be00e3($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data['day_words'] as $day )
...
{
$count_0f7aeac92f6b74d218c0f27ffa7c1c7d = is_array($this->functionData['modEventsWrapper']) ? count($this->functionData['modEventsWrapper']) : 0;
$this->functionData['modEventsWrapper'][$count_0f7aeac92f6b74d218c0f27ffa7c1c7d]['events'] = $events;
$this->functionData['modEventsWrapper'][$count_0f7aeac92f6b74d218c0f27ffa7c1c7d]['pages'] = $pages;
}
...
<div class='clearfix'>
	" . ((count($events)) ? ("
		".$this->__f__1b1c31c146c95aecea8406d2949c236a($events,$pages)."	") : ("
...
function __f__1b1c31c146c95aecea8406d2949c236a($events, $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $events as $event )
...
{
$count_ef33ada7f5a174369026087612049312 = is_array($this->functionData['showEvent']) ? count($this->functionData['showEvent']) : 0;
$this->functionData['showEvent'][$count_ef33ada7f5a174369026087612049312]['event'] = $event;
$this->functionData['showEvent'][$count_ef33ada7f5a174369026087612049312]['member'] = $member;
$this->functionData['showEvent'][$count_ef33ada7f5a174369026087612049312]['typeInfo'] = $typeInfo;
$this->functionData['showEvent'][$count_ef33ada7f5a174369026087612049312]['like'] = $like;
}
	...
	" . (($event['event_rsvp']) ? ("<div class='ipsBox_container ipsLayout_right'>
			<div id='event_rsvp' class='ipsPad'>
				...
				" . ((count($event['_rsvp_attendees_short'])) ? ("
					...
					".$this->__f__8f759e15e66ba530c895c2324a3f8446($event,$member,$typeInfo,$like)."					</ul>
				") : ("
		...
		" . (($event['_rsvp_count'] > count( $event['_rsvp_attendees_short'] )) ? ("
			<div id='see_all_attendees_popup' style='display: none'>
				...
				<div class='fixed_inner'>
					...
					".$this->__f__9b84ad929a4e458761a0856ff85ce11c($event,$member,$typeInfo,$like)."					</ul>
				</div>
			</div>
			<script type='text/javascript'>
...
function __f__8f759e15e66ba530c895c2324a3f8446($event, $member, $typeInfo, $like='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__9b84ad929a4e458761a0856ff85ce11c($event, $member, $typeInfo, $like='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_8187a1067327dd9664afd48c08ae8bab = is_array($this->functionData['showEventSimple']) ? count($this->functionData['showEventSimple']) : 0;
$this->functionData['showEventSimple'][$count_8187a1067327dd9664afd48c08ae8bab]['event'] = $event;
}
		...
		<div class='post_body'>
			...
			" . (($event['event_rsvp']) ? ("<div class='rsvp'>
					" . ((count( $event['_rsvp_attendees'] )) ? ("
						...
						<div class='clearfix'>
							".$this->__f__fabcdc9d4865cca2a32f4f6dd1d2689c($event)."						</div>
					") : ("
...
function __f__fabcdc9d4865cca2a32f4f6dd1d2689c($event)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
