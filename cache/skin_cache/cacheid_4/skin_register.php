...
{
$count_9b4cac72d8a483abef42ede917caa5e9 = is_array($this->functionData['completePartialLogin']) ? count($this->functionData['completePartialLogin']) : 0;
$this->functionData['completePartialLogin'][$count_9b4cac72d8a483abef42ede917caa5e9]['mid'] = $mid;
$this->functionData['completePartialLogin'][$count_9b4cac72d8a483abef42ede917caa5e9]['key'] = $key;
$this->functionData['completePartialLogin'][$count_9b4cac72d8a483abef42ede917caa5e9]['custom_fields'] = $custom_fields;
$this->functionData['completePartialLogin'][$count_9b4cac72d8a483abef42ede917caa5e9]['errors'] = $errors;
$this->functionData['completePartialLogin'][$count_9b4cac72d8a483abef42ede917caa5e9]['reg'] = $reg;
$this->functionData['completePartialLogin'][$count_9b4cac72d8a483abef42ede917caa5e9]['userFromService'] = $userFromService;
}
						...
						<ul class='ipsForm ipsForm_horizontal ipsPad'>
							...
							" . (($custom_fields != '') ? ("<fieldset class='rcomplete'>
								" . ((is_array( $custom_fields['required'] ) && count( $custom_fields['required'] )) ? ("
									".$this->__f__9581cb81a10da54a0769a7be5286d605($mid,$key,$custom_fields,$errors,$reg,$userFromService)."								") : ("")) . "
	
								" . ((is_array( $custom_fields['optional'] ) && count( $custom_fields['optional'] )) ? ("
									".$this->__f__a31922f3c789750117d1157cb138891e($mid,$key,$custom_fields,$errors,$reg,$userFromService)."								") : ("")) . "
								</fieldset>") : ("")) . "
						</ul>
					</fieldset>
...
function __f__9581cb81a10da54a0769a7be5286d605($mid="",$key="",$custom_fields="",$errors="", $reg="", $userFromService=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a31922f3c789750117d1157cb138891e($mid="",$key="",$custom_fields="",$errors="", $reg="", $userFromService=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_68d8637337dbcd41d0d3dd0de560ae00 = is_array($this->functionData['lostPasswordForm']) ? count($this->functionData['lostPasswordForm']) : 0;
$this->functionData['lostPasswordForm'][$count_68d8637337dbcd41d0d3dd0de560ae00]['errors'] = $errors;
}
...
{
$count_650035ddfcd5b3339bd77ce9b9f955ce = is_array($this->functionData['registerCoppaForm']) ? count($this->functionData['registerCoppaForm']) : 0;
}
$IPBHTML .= "<html>
	<head>
...
{
$count_b5d6878655b2d9a0676d37296f18e850 = is_array($this->functionData['registerCoppaStart']) ? count($this->functionData['registerCoppaStart']) : 0;
}
		...
		<fieldset class='general_box'>
			...
			<div class='ipsPad ipsForm_center'>
				...
				<select name='month' id='coppa_bday_m'>
					".$this->__f__6f9c6fe267887bbf80aeca04e94905e7()."				</select>
				&nbsp;
				<select name='day' id='coppa_bday_d'>
					".$this->__f__64aeba00ac9be646acd0743a94046044()."				</select>
				&nbsp;
				<select name='year' id='coppa_bday_y'>
					".$this->__f__3bab63b008dbb1aa8825c4bdfe467ca6()."				</select>
			</div>
		</fieldset>
...
function __f__6f9c6fe267887bbf80aeca04e94905e7()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__64aeba00ac9be646acd0743a94046044()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__3bab63b008dbb1aa8825c4bdfe467ca6()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_8e8d4d33ca1e60576bcc22ecbebcce8a = is_array($this->functionData['registerForm']) ? count($this->functionData['registerForm']) : 0;
$this->functionData['registerForm'][$count_8e8d4d33ca1e60576bcc22ecbebcce8a]['general_errors'] = $general_errors;
$this->functionData['registerForm'][$count_8e8d4d33ca1e60576bcc22ecbebcce8a]['data'] = $data;
$this->functionData['registerForm'][$count_8e8d4d33ca1e60576bcc22ecbebcce8a]['inline_errors'] = $inline_errors;
$this->functionData['registerForm'][$count_8e8d4d33ca1e60576bcc22ecbebcce8a]['time_select'] = $time_select;
$this->functionData['registerForm'][$count_8e8d4d33ca1e60576bcc22ecbebcce8a]['custom_fields'] = $custom_fields;
$this->functionData['registerForm'][$count_8e8d4d33ca1e60576bcc22ecbebcce8a]['nexusFields'] = $nexusFields;
$this->functionData['registerForm'][$count_8e8d4d33ca1e60576bcc22ecbebcce8a]['nexusStates'] = $nexusStates;
}
...
<div id='register_form'>
	...
	<div class='message error'>
		...
		<ul>
			".$this->__f__d3b4207596760f89c13467e85d3093ca($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates)."		</ul>
	</div>
	<br />
	") : ("")) . "
			...
			<div class='ipsBox_container ipsPad'>
				...
				<!--hook.if.skin_register.registerForm.hasNexusFields.pre.startif-->" . ((!empty( $nexusFields )) ? ("
					<script type='text/javascript'>
						...
						".$this->__f__6bf9e166bd06f20cd8fc6098b3f3de1f($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates)."					</script>
					<hr />
					<fieldset>
						<ul class='ipsForm ipsForm_horizontal'>
							".$this->__f__a314891321fd39b1d5d2994eda3b7cf3($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates)."						</ul>
					</fieldset>
					<script type='text/javascript'>
						function states()
						{
				...
				" . ((( is_array( $custom_fields['required'] ) && count( $custom_fields['required'] ) ) || ( is_array( $custom_fields['optional'] ) && count( $custom_fields['optional'] ) )) ? ("<hr />
					<fieldset>
						<ul class='ipsForm ipsForm_horizontal'>
						" . ((is_array( $custom_fields['required'] ) && count( $custom_fields['required'] )) ? ("
							".$this->__f__094db689c769347de190eb9d5c0c288b($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates)."						") : ("")) . "
			
						" . ((is_array( $custom_fields['optional'] ) && count( $custom_fields['optional'] )) ? ("
							".$this->__f__396b4bb3615090fbc24ac7b145a29191($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates)."						") : ("")) . "
					</fieldset>") : ("")) . "
				<hr />
				{$data['qandaHTML']}
				{$data['captchaHTML']}
...
function __f__d3b4207596760f89c13467e85d3093ca($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__6bf9e166bd06f20cd8fc6098b3f3de1f($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__47f698ac37ef34c825b7f8024bf2a6d2($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array(),$f='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( explode( "\n", $f['f_extra'] ) as $k => $v )
...
function __f__e881f6c4ca77219eaf5ce176012ab499($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array(),$f='',$country='',$_states='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__6e41a85a13a6774aa83e780e5b4eaa1b($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array(),$f='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $nexusStates as $country => $_states )
	{
		...
		$_ips___x_retval .= "
												<select name='_cm_state' id='{$country}-states' class='input_select' style='display:none'>
													".$this->__f__e881f6c4ca77219eaf5ce176012ab499($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates,$f,$country,$_states)."												</select>
...
function __f__a314891321fd39b1d5d2994eda3b7cf3($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		$_ips___x_retval .= "
								...
								" . (($f['f_type'] == 'dropdown') ? ("<li class='ipsField clear'>
										...
										<div class='ipsField_content'>
											<select name='{$f['f_column']}' id='{$f['f_column']}' tabindex='5' " . (($f['f_column'] == 'cm_country') ? ("onchange='states()'") : ("")) . ">
												".$this->__f__47f698ac37ef34c825b7f8024bf2a6d2($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates,$f)."											</select>
										</div>
										" . (($f['f_reg_require'] and $this->request['do'] == 'process_form' and !$this->request[ $f['f_column'] ]) ? ("
											<span class='error'>{$this->lang->words['err_complete_form']}</span>
										") : ("")) . "
								...
								" . (($f['f_type'] == 'special') ? ("<li class='ipsField clear'>
										...
										<div class='ipsField_content'>
											...
											".$this->__f__6e41a85a13a6774aa83e780e5b4eaa1b($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates,$f)."										</div>
										" . (($f['f_reg_require'] and $this->request['do'] == 'process_form' and !$this->request[ $f['f_column'] ]) ? ("
											<span class='error'>{$this->lang->words['err_complete_form']}</span>
										") : ("")) . "
									</li>") : ("")) . "
...
function __f__094db689c769347de190eb9d5c0c288b($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $custom_fields['required'] as $_field )
...
function __f__396b4bb3615090fbc24ac7b145a29191($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $custom_fields['optional'] as $_field )
...
{
$count_b3da061d9723b3dff91e182200eb77bf = is_array($this->functionData['showLostpassForm']) ? count($this->functionData['showLostpassForm']) : 0;
$this->functionData['showLostpassForm'][$count_b3da061d9723b3dff91e182200eb77bf]['error'] = $error;
}
...
{
$count_d70c02d5e85746ececcf9b628c3df6e6 = is_array($this->functionData['showRevalidateForm']) ? count($this->functionData['showRevalidateForm']) : 0;
$this->functionData['showRevalidateForm'][$count_d70c02d5e85746ececcf9b628c3df6e6]['name'] = $name;
$this->functionData['showRevalidateForm'][$count_d70c02d5e85746ececcf9b628c3df6e6]['error'] = $error;
}
$IPBHTML .= "<h1 class='ipsType_pagetitle'>{$this->lang->words['rv_title']}</h1>
<br />
" . (($error) ? ("
