...
{
$count_7714ff48e1c8d14f95785b989c7ad41b = is_array($this->functionData['create2']) ? count($this->functionData['create2']) : 0;
$this->functionData['create2'][$count_7714ff48e1c8d14f95785b989c7ad41b]['blog'] = $blog;
$this->functionData['create2'][$count_7714ff48e1c8d14f95785b989c7ad41b]['errors'] = $errors;
}
...
{
$count_6658bbc182059c4aaa45d48adc1dc67e = is_array($this->functionData['listCategories']) ? count($this->functionData['listCategories']) : 0;
$this->functionData['listCategories'][$count_6658bbc182059c4aaa45d48adc1dc67e]['blog'] = $blog;
}
	...
	<table class=\"ipb_table\">
		<tr class=\"header\">
			...
			<th class='col_mod'></th>
				...
				".$this->__f__947e623e936edc5a0ad52f89bf5b1d44($blog)."	</table>
...
</script>".$this->__f__f596b3b9ea9916f1440bc65db59482fe($blog)."";
return $IPBHTML;
}


function __f__947e623e936edc5a0ad52f89bf5b1d44($blog=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__f596b3b9ea9916f1440bc65db59482fe($blog=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $blog['_categories'] as $id => $category )
...
{
$count_651f0296df8e3975f3616369da4f8440 = is_array($this->functionData['manageComments']) ? count($this->functionData['manageComments']) : 0;
$this->functionData['manageComments'][$count_651f0296df8e3975f3616369da4f8440]['comments'] = $comments;
$this->functionData['manageComments'][$count_651f0296df8e3975f3616369da4f8440]['blog'] = $blog;
$this->functionData['manageComments'][$count_651f0296df8e3975f3616369da4f8440]['pagination'] = $pagination;
}
...
" . ((is_array( $comments ) && count( $comments )) ? ("<div class='ipsBox'>
		".$this->__f__aa961bbcd039e5374ab7a91b7d1dc355($comments,$blog,$pagination)."	</div>
	" . (($this->memberData['g_blog_allowownmod']) ? ("
			<div class='bar altbar moderation_bar with_action'>
...
function __f__aa961bbcd039e5374ab7a91b7d1dc355($comments, $blog, $pagination)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_2c9349ca1b133877b0fbb0d3a1c7678e = is_array($this->functionData['manageDashboard']) ? count($this->functionData['manageDashboard']) : 0;
$this->functionData['manageDashboard'][$count_2c9349ca1b133877b0fbb0d3a1c7678e]['myBlogs'] = $myBlogs;
$this->functionData['manageDashboard'][$count_2c9349ca1b133877b0fbb0d3a1c7678e]['latestComments'] = $latestComments;
$this->functionData['manageDashboard'][$count_2c9349ca1b133877b0fbb0d3a1c7678e]['error'] = $error;
$this->functionData['manageDashboard'][$count_2c9349ca1b133877b0fbb0d3a1c7678e]['dropdown'] = $dropdown;
}
...
<div class='ipsLayout " . ((is_array( $latestComments ) && count( $latestComments )) ? ("ipsLayout_withright ipsLayout_bigright") : ("")) . " clearfix'>
		...
		<table class='ipb_table' summary=\"{$this->lang->words['your_current_blogs']}\">
			<tr class='header'>
				...
				<th scope='col' class='short' width=\"10%\">{$this->lang->words['your_blogs_comments']}</th>
						...
						".$this->__f__1a0a490733440523fa2dbda4baba53a0($myBlogs,$latestComments,$error,$dropdown)."		</table>
		<br />
	</div>
	" . ((is_array( $latestComments ) && count( $latestComments )) ? ("<div class='ipsLayout_right'>
			...
			<div class='ipsBox'>
				".$this->__f__c87feebae94d2a7ddff17bffcc262084($myBlogs,$latestComments,$error,$dropdown)."			</div>
...
function __f__1a0a490733440523fa2dbda4baba53a0($myBlogs=array(), $latestComments=array(), $error='', $dropdown='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__c87feebae94d2a7ddff17bffcc262084($myBlogs=array(), $latestComments=array(), $error='', $dropdown='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_97474cfd456c66141955d01aaf46d5b1 = is_array($this->functionData['rssImportForm']) ? count($this->functionData['rssImportForm']) : 0;
$this->functionData['rssImportForm'][$count_97474cfd456c66141955d01aaf46d5b1]['blog'] = $blog;
$this->functionData['rssImportForm'][$count_97474cfd456c66141955d01aaf46d5b1]['data'] = $data;
$this->functionData['rssImportForm'][$count_97474cfd456c66141955d01aaf46d5b1]['error'] = $error;
$this->functionData['rssImportForm'][$count_97474cfd456c66141955d01aaf46d5b1]['tagBox'] = $tagBox;
}
				...
				<li class='ipsField ipsField_select'>
					...
					<p class='ipsField_content'>
						<select name='rss_cats[]' id='rss_cats' multiple='true' size='5'>
							" . ((is_array($data['_cats']) AND count($data['_cats'])) ? ("".$this->__f__b1cf328804589c3a8ec5e7d00414f355($blog,$data,$error,$tagBox)."							") : ("")) . "
						</select>
...
function __f__b1cf328804589c3a8ec5e7d00414f355($blog, $data, $error, $tagBox)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_206a3613451eb20e5c836d1ddb1849fb = is_array($this->functionData['settingsForm']) ? count($this->functionData['settingsForm']) : 0;
$this->functionData['settingsForm'][$count_206a3613451eb20e5c836d1ddb1849fb]['blog'] = $blog;
$this->functionData['settingsForm'][$count_206a3613451eb20e5c836d1ddb1849fb]['error'] = $error;
}
$IPBHTML .= "<script type=\"text/javascript\">
								...
								<ul>
									...
									<li class='field' id='list_blog_view_level'>
										...
										<select class='input_select blogform' name='blog_view_level' id='blog_view_level'>
											".$this->__f__c8c8616a3281b8f94d98b168fae074bf($blog,$error)."										</select>
									</li>
								</ul>
								</fieldset>
							</td>
					...
					<tr class=\"row1\">
						<td valign=\"top\">
							...
							<fieldset>
								...
								<ul>
								".$this->__f__247db29ce7c8bf5d31a6b948c6d8a486($blog,$error)."								</ul>
							</fieldset>
							") : ("
...
function __f__c8c8616a3281b8f94d98b168fae074bf($blog, $error='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__247db29ce7c8bf5d31a6b948c6d8a486($blog, $error='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
