...
{
$count_479a61e885a3f2d18df26b7f81bfef60 = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_479a61e885a3f2d18df26b7f81bfef60]['r'] = $r;
$this->functionData['comment'][$count_479a61e885a3f2d18df26b7f81bfef60]['parent'] = $parent;
$this->functionData['comment'][$count_479a61e885a3f2d18df26b7f81bfef60]['settings'] = $settings;
}
...
{
$count_0b31fc73b376b86d157590f106bb32b7 = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_0b31fc73b376b86d157590f106bb32b7]['r'] = $r;
$this->functionData['commentHidden'][$count_0b31fc73b376b86d157590f106bb32b7]['parent'] = $parent;
$this->functionData['commentHidden'][$count_0b31fc73b376b86d157590f106bb32b7]['settings'] = $settings;
}
...
{
$count_7df5b6144b14eba5e1d5e71edc0d0052 = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_7df5b6144b14eba5e1d5e71edc0d0052]['comments'] = $comments;
$this->functionData['commentsList'][$count_7df5b6144b14eba5e1d5e71edc0d0052]['settings'] = $settings;
$this->functionData['commentsList'][$count_7df5b6144b14eba5e1d5e71edc0d0052]['pages'] = $pages;
$this->functionData['commentsList'][$count_7df5b6144b14eba5e1d5e71edc0d0052]['parent'] = $parent;
$this->functionData['commentsList'][$count_7df5b6144b14eba5e1d5e71edc0d0052]['preReply'] = $preReply;
}
...
<div class='ipsComment_wrap' id='comment_wrap'>
	".$this->__f__daf1608a2f0241e21aa95bfbe859bc92($comments,$settings,$pages,$parent,$preReply)."</div>
" . (($pages) ? ("
	<div class='topic_controls'>
		{$pages}
	</div>
...
function __f__daf1608a2f0241e21aa95bfbe859bc92($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_a00364bca1ff9fef49dfda7ff31eb03e = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_a00364bca1ff9fef49dfda7ff31eb03e]['comment'] = $comment;
$this->functionData['form'][$count_a00364bca1ff9fef49dfda7ff31eb03e]['parent'] = $parent;
$this->functionData['form'][$count_a00364bca1ff9fef49dfda7ff31eb03e]['editor'] = $editor;
$this->functionData['form'][$count_a00364bca1ff9fef49dfda7ff31eb03e]['settings'] = $settings;
$this->functionData['form'][$count_a00364bca1ff9fef49dfda7ff31eb03e]['errors'] = $errors;
$this->functionData['form'][$count_a00364bca1ff9fef49dfda7ff31eb03e]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
