...
{
$count_629e00dc616f3e148be99132cebd9537 = is_array($this->functionData['forumAttachments']) ? count($this->functionData['forumAttachments']) : 0;
$this->functionData['forumAttachments'][$count_629e00dc616f3e148be99132cebd9537]['title'] = $title;
$this->functionData['forumAttachments'][$count_629e00dc616f3e148be99132cebd9537]['rows'] = $rows;
$this->functionData['forumAttachments'][$count_629e00dc616f3e148be99132cebd9537]['pages'] = $pages;
}
...
<table class='ipb_table'>
	<tr class='header'>
		...
		" . ((count($rows)) ? ("".$this->__f__7282fd6099dc9a6a94df1b8614fbd8bf($title,$rows,$pages)."	") : ("")) . "
</table>
" . (($pages) ? ("
	<br />
	<div class='topic_controls'>{$pages}</div>
...
function __f__7282fd6099dc9a6a94df1b8614fbd8bf($title, $rows, $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_b7b7f10761f02ca88e8baec195599f8c = is_array($this->functionData['forumIndexTemplate']) ? count($this->functionData['forumIndexTemplate']) : 0;
$this->functionData['forumIndexTemplate'][$count_b7b7f10761f02ca88e8baec195599f8c]['forum_data'] = $forum_data;
$this->functionData['forumIndexTemplate'][$count_b7b7f10761f02ca88e8baec195599f8c]['announce_data'] = $announce_data;
$this->functionData['forumIndexTemplate'][$count_b7b7f10761f02ca88e8baec195599f8c]['topic_data'] = $topic_data;
$this->functionData['forumIndexTemplate'][$count_b7b7f10761f02ca88e8baec195599f8c]['other_data'] = $other_data;
$this->functionData['forumIndexTemplate'][$count_b7b7f10761f02ca88e8baec195599f8c]['multi_mod_data'] = $multi_mod_data;
$this->functionData['forumIndexTemplate'][$count_b7b7f10761f02ca88e8baec195599f8c]['sub_forum_data'] = $sub_forum_data;
$this->functionData['forumIndexTemplate'][$count_b7b7f10761f02ca88e8baec195599f8c]['footer_filter'] = $footer_filter;
$this->functionData['forumIndexTemplate'][$count_b7b7f10761f02ca88e8baec195599f8c]['active_user_data'] = $active_user_data;
$this->functionData['forumIndexTemplate'][$count_b7b7f10761f02ca88e8baec195599f8c]['mod_data'] = $mod_data;
$this->functionData['forumIndexTemplate'][$count_b7b7f10761f02ca88e8baec195599f8c]['inforum'] = $inforum;
}
...
" . ((is_array( $announce_data ) AND count( $announce_data )) ? ("
	<table class='ipb_table topic_list hover_rows' summary='{$this->lang->words['forum_topic_list']} \"{$forum_data['name']}\"' id='announcements'>
		".$this->__f__eec4826786ce6fe244465b0de319c342($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."	</table>
	<br />
") : ("")) . "
<!-- __-SUBFORUMS-__ -->
		...
		<div class='ipsBox table_wrap'>
			<div class='ipsBox_container'>
				<table class='ipb_table' summary=\"{$this->lang->words['cat_subforums']} '{$forum_data['name']}'\">
					".$this->__f__4731f70f0d018fc4833a8dc03062bb83($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."				</table>
			</div>
		</div>
	</div>
	<br /><br />
		...
		<div class='ipsBox_container'>
			<table class='ipb_table topic_list hover_rows " . (($this->memberData['is_mod'] == 1) ? ("is_mod") : ("")) . "' summary='{$this->lang->words['forum_topic_list']} \"{$forum_data['name']}\"' id='forum_table'>
				...
				" . ((is_array( $topic_data ) AND count( $topic_data )) ? ("
					".$this->__f__9860051072dd69e65478dd546353eb74($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."				") : ("<tr>
						" . (($this->memberData['is_mod'] == 1) ? ("
	...
	<div id='forum_footer' class='statistics clear clearfix'>
		" . ((is_array( $mod_data ) AND count( $mod_data )) ? ("
			<div id='forum_led_by' class='right ipsType_small'>
				...
				".$this->__f__23025f953d708f3750f10db0e3a1e5d3($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."			</div>
		") : ("")) . "
...
" . ((is_array( $multi_mod_data ) AND count( $multi_mod_data )) ? ("
	".$this->__f__eb066d184a16dbdbb21900680c0f28ab($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."") : ("")) . "
</select>";
return $IPBHTML;
}


function __f__eec4826786ce6fe244465b0de319c342($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e2b7ca3cd41b496737db4e70f2b7424c($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1,$_data='',$forum_id='',$forum_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__2cb579df13e602d6ea218518cf239b85($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1,$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
										...
										<td class='col_c_forum'>
											...
											" . (($forum_data['show_subforums'] AND count( $forum_data['subforums'] ) AND $forum_data['show_subforums']) ? ("
												...
												<ol class='ipsList_inline ipsType_small subforums' id='subforums_{$forum_data['id']}'>
													".$this->__f__e2b7ca3cd41b496737db4e70f2b7424c($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum,$_data,$forum_id,$forum_data)."												</ol>
											") : ("")) . "
...
function __f__4731f70f0d018fc4833a8dc03062bb83($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $sub_forum_data as $_data )
	{
		...
		$_ips___x_retval .= "
						" . ((is_array( $_data['forum_data'] ) AND count( $_data['forum_data'] )) ? ("
							".$this->__f__2cb579df13e602d6ea218518cf239b85($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum,$_data)."						") : ("")) . "
...
function __f__9860051072dd69e65478dd546353eb74($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__23025f953d708f3750f10db0e3a1e5d3($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__eb066d184a16dbdbb21900680c0f28ab($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_f3296d1c675da244bb15e2e773f84d43 = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_f3296d1c675da244bb15e2e773f84d43]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_f3296d1c675da244bb15e2e773f84d43]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_f3296d1c675da244bb15e2e773f84d43]['opts'] = $opts;
}
...
{
$count_d79f757692fe3479df2a65488e7a0655 = is_array($this->functionData['topic']) ? count($this->functionData['topic']) : 0;
$this->functionData['topic'][$count_d79f757692fe3479df2a65488e7a0655]['data'] = $data;
$this->functionData['topic'][$count_d79f757692fe3479df2a65488e7a0655]['forum_data'] = $forum_data;
$this->functionData['topic'][$count_d79f757692fe3479df2a65488e7a0655]['other_data'] = $other_data;
$this->functionData['topic'][$count_d79f757692fe3479df2a65488e7a0655]['inforum'] = $inforum;
}
$IPBHTML .= "" . ((($this->memberData['is_mod'] AND ! $data['approved']) OR $data['_isDeleted']) ? ("<tr" . (($inforum) ? (" itemscope itemtype=\"http://schema.org/Article\"") : ("")) . " class='__topic " . ((!$data['folder_img']['is_read']) ? ("unread") : ("")) . " expandable moderated' id='trow_{$data['_tid']}' data-tid=\"{$data['_tid']}\">") : ("<tr" . (($inforum) ? (" itemscope itemtype=\"http://schema.org/Article\"") : ("")) . " class='__topic " . ((!$data['folder_img']['is_read']) ? ("unread") : ("")) . " expandable' id='trow_{$data['_tid']}' data-tid=\"{$data['_tid']}\">")) . "
	...
	<td class='col_f_content " . (($this->memberData['is_mod'] == 1 || $forum_data['permissions']['TopicSoftDelete']) ? (" with_mod_links") : ("")) . "'>
		...
		") : ("")) . "
		" . ((! $inforum && $data['nav']) ? ("
			".$this->__f__97821fad74bd88e141b0f3fbc85baa8f($data,$forum_data,$other_data,$inforum)."		") : ("")) . "
		{$data['prefix']}
		<h4>
		...
		" . ((isset( $data['pages'] ) AND is_array( $data['pages'] ) AND count( $data['pages'] )) ? ("
			...
			".$this->__f__f947718e21a9d3f6b6c7919df10536f6($data,$forum_data,$other_data,$inforum)."			</ul>
		") : ("")) . "
	</td>
...
function __f__97821fad74bd88e141b0f3fbc85baa8f($data, $forum_data, $other_data, $inforum)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__f947718e21a9d3f6b6c7919df10536f6($data, $forum_data, $other_data, $inforum)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_db3e81a6731194da171171fe7b480ff6 = is_array($this->functionData['topic_rating_image']) ? count($this->functionData['topic_rating_image']) : 0;
$this->functionData['topic_rating_image'][$count_db3e81a6731194da171171fe7b480ff6]['rating_id'] = $rating_id;
}
$IPBHTML .= "<span class='mini_rate'>".$this->__f__a454b93300411e084e9fe007c1865abd($rating_id)."</span>";
return $IPBHTML;
}


function __f__a454b93300411e084e9fe007c1865abd($rating_id=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_6a5de03ecec6912121f896489b058618 = is_array($this->functionData['topicPrefixWrap']) ? count($this->functionData['topicPrefixWrap']) : 0;
$this->functionData['topicPrefixWrap'][$count_6a5de03ecec6912121f896489b058618]['text'] = $text;
}
$IPBHTML .= "" . (($text) ? ("
