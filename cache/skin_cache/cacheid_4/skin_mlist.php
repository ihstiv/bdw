...
{
$count_67c36cfc0da9a81084e94e15037faad0 = is_array($this->functionData['member_list_show']) ? count($this->functionData['member_list_show']) : 0;
$this->functionData['member_list_show'][$count_67c36cfc0da9a81084e94e15037faad0]['members'] = $members;
$this->functionData['member_list_show'][$count_67c36cfc0da9a81084e94e15037faad0]['pages'] = $pages;
$this->functionData['member_list_show'][$count_67c36cfc0da9a81084e94e15037faad0]['dropdowns'] = $dropdowns;
$this->functionData['member_list_show'][$count_67c36cfc0da9a81084e94e15037faad0]['defaults'] = $defaults;
$this->functionData['member_list_show'][$count_67c36cfc0da9a81084e94e15037faad0]['custom_fields'] = $custom_fields;
$this->functionData['member_list_show'][$count_67c36cfc0da9a81084e94e15037faad0]['url'] = $url;
}
	...
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=members&amp;module=list", "public",'' ), "false", "" ) . "\" method=\"post\">
		...
		<ul id='filters_1'>
			...
			" . ((count( $custom_fields->out_fields )) ? ("
				".$this->__f__cdb2217e46342723401d93cebd10bca3($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			") : ("")) . "			
		</ul>
		<ul id='filters_2'>
			<li class='field'>
		...
		<fieldset class='other_filters row2 altrow'>
			<select name='filter' class='input_select'>
				".$this->__f__4760b5966d7d9173a631d675eb36dabd($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			</select>
			{$this->lang->words['sorting_text_by']}
			<select name='sort_key' class='input_select'>
				".$this->__f__62eca801f057c5b957581af5bb3d529e($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			</select>
			{$this->lang->words['sorting_text_in']}
			<select name='sort_order' class='input_select'>
				".$this->__f__79dd44d1ca2bbc69c02c786553fbfc24($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			</select>
			{$this->lang->words['sorting_text_with']}
			<select name='max_results' class='input_select'>
				".$this->__f__fe0e36ca8063731750238e114ad623c0($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."			</select>
...
<div class='ipsBox ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_tinyleft clearfix'>
	<div class='ipsVerticalTabbed_tabs ipsVerticalTabbed_minitabs ipsLayout_left' id='mlist_tabs'>
		<ul>
			...
			")) . "
			".$this->__f__d87d08b7c5fcb2d55138422c9711e803($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."		</ul>
	</div>
		...
		<div class='ipsBox_container ipsPad' id='mlist_content'>
			<ul class='ipsMemberList'>
				" . ((is_array( $members ) and count( $members )) ? ("
										".$this->__f__bf64012bd15895e00cf1817493f7e04c($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."				") : ("
...
function __f__cdb2217e46342723401d93cebd10bca3($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__4760b5966d7d9173a631d675eb36dabd($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__62eca801f057c5b957581af5bb3d529e($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__79dd44d1ca2bbc69c02c786553fbfc24($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__fe0e36ca8063731750238e114ad623c0($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__d87d08b7c5fcb2d55138422c9711e803($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__bf64012bd15895e00cf1817493f7e04c($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
