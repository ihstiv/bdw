...
{
$count_3c97c0f2a4ad4bebf0b6c05c2f08e0f3 = is_array($this->functionData['boardIndexTemplate']) ? count($this->functionData['boardIndexTemplate']) : 0;
$this->functionData['boardIndexTemplate'][$count_3c97c0f2a4ad4bebf0b6c05c2f08e0f3]['lastvisit'] = $lastvisit;
$this->functionData['boardIndexTemplate'][$count_3c97c0f2a4ad4bebf0b6c05c2f08e0f3]['stats'] = $stats;
$this->functionData['boardIndexTemplate'][$count_3c97c0f2a4ad4bebf0b6c05c2f08e0f3]['cat_data'] = $cat_data;
$this->functionData['boardIndexTemplate'][$count_3c97c0f2a4ad4bebf0b6c05c2f08e0f3]['show_side_blocks'] = $show_side_blocks;
$this->functionData['boardIndexTemplate'][$count_3c97c0f2a4ad4bebf0b6c05c2f08e0f3]['side_blocks'] = $side_blocks;
}
...
<div id='board_index' class='ipsLayout " . (($this->templateVars['sidebar_enabled']) ? ("ipsLayout_withright") : ("")) . " ipsLayout_largeright clearfix " . ((IPSCookie::get('hide_sidebar') == '1') ? ("no_sidebar") : ("")) . "'>	
	...
	<!-- CATS AND FORUMS -->
		" . ((is_array( $cat_data ) AND count( $cat_data )) ? ("
			".$this->__f__7ccf6331c98f4e65688fb9ca5e5c786d($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks)."		") : ("")) . "
	</div>
	" . (($this->templateVars['sidebar_enabled']) ? ("<div id='index_stats' class='ipsLayout_right clearfix' " . ((IPSCookie::get('hide_sidebar') == '1') ? ("style='display: none'") : ("")) . ">
			".$this->__f__cf30c941a0f9b2453de1fcee4f076a4c($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks)."		</div>
...
//<![CDATA[
	...
	" . ((is_array( $cat_data ) AND count( $cat_data )) ? ("
		".$this->__f__0e5817e74ab2e77ebf5a47a1a05189ab($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks)."	") : ("")) . "
//]]>
</script>
...
function __f__fcd98bd6a20cbdffd652f91031a42f66($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array(),$_data='',$forum_id='',$forum_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a522c41fafa0d30f8d589fb63df87e12($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array(),$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
												...
												<td class='col_c_forum'>
													...
													" . (($forum_data['show_subforums'] AND count( $forum_data['subforums'] ) AND $forum_data['show_subforums']) ? ("
														...
														<ol class='ipsList_inline ipsType_small subforums' id='subforums_{$forum_data['id']}'>
															".$this->__f__fcd98bd6a20cbdffd652f91031a42f66($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks,$_data,$forum_id,$forum_data)."														</ol>
													") : ("")) . "
...
function __f__7ccf6331c98f4e65688fb9ca5e5c786d($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
						...
						<div class='ipsBox table_wrap'>
							<div class='ipsBox_container'>
								<table class='ipb_table' summary=\"{$this->lang->words['forums_in_cat']} '{$_data['cat_data']['name']}'\">
									...
									<!-- / CAT HEADER -->
									".$this->__f__a522c41fafa0d30f8d589fb63df87e12($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks,$_data)."								</table>
							</div>
						</div>
						<br />
					</div>") : ("")) . "
...
function __f__cf30c941a0f9b2453de1fcee4f076a4c($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array())
{
...
function __f__fa9854b5a16e554f767894ca8598032f($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array(),$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $_data['forum_data'] as $forum_id => $forum_data )
...
function __f__0e5817e74ab2e77ebf5a47a1a05189ab($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $cat_data as $_data )
	{
		...
		$_ips___x_retval .= "
			" . ((is_array( $_data['forum_data'] ) AND count( $_data['forum_data'] )) ? ("
				".$this->__f__fa9854b5a16e554f767894ca8598032f($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks,$_data)."			") : ("")) . "
...
{
$count_b0194ab0993ec69d269bf5dd10667774 = is_array($this->functionData['hookFacebookActivity']) ? count($this->functionData['hookFacebookActivity']) : 0;
}
...
{
$count_3dcca13db1a88a79e315497779f14546 = is_array($this->functionData['hookRecentTopics']) ? count($this->functionData['hookRecentTopics']) : 0;
$this->functionData['hookRecentTopics'][$count_3dcca13db1a88a79e315497779f14546]['topics'] = $topics;
}
...
<div class='ipsSideBlock clearfix'>
	...
	<div class='_sbcollapsable'>
		...
		".$this->__f__30cdd1ed02e330a5b7def76b82ed20e1($topics)."		</ul>
	</div>
</div>
") : ("")) . "";
return $IPBHTML;
...
function __f__30cdd1ed02e330a5b7def76b82ed20e1($topics)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $topics as $r )
...
{
$count_1886d7787896cac1769a2a050cf44cf0 = is_array($this->functionData['hookTagCloud']) ? count($this->functionData['hookTagCloud']) : 0;
$this->functionData['hookTagCloud'][$count_1886d7787896cac1769a2a050cf44cf0]['tags'] = $tags;
}
$IPBHTML .= "<div class='ipsSideBlock clearfix'>
	<h3>{$this->lang->words['popular_tags']}</h3>
	<div class='_sbcollapsable'>
		<ul class='ipsList_inline'>
		".$this->__f__15d5b18aa2edf849ebcb6ee18c8d045e($tags)."		</ul>
	</div>
</div>";
return $IPBHTML;
}
...
function __f__15d5b18aa2edf849ebcb6ee18c8d045e($tags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
$IPBHTML .= "" . ((is_array($topics) && count($topics)) ? ("
		<div class ='ipsSideBlock clearfix'>
			...
			<div class='_sbcollapsible'>			
				<ul class='ipsList_withminiphoto'>
					".$this->__f__5947a23a06f3076f02146431ae7690e5($topics)."				</ul>
			</div>
		</div> 
	") : ("")) . "";
return $IPBHTML;
...
function __f__5947a23a06f3076f02146431ae7690e5($topics)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_de570b479805be0763e71e24302d5815 = is_array($this->functionData['statusReplies']) ? count($this->functionData['statusReplies']) : 0;
$this->functionData['statusReplies'][$count_de570b479805be0763e71e24302d5815]['replies'] = $replies;
}
$IPBHTML .= "".$this->__f__49cb94e06479c2581b80bef8dea397ed($replies)."";
return $IPBHTML;
}


function __f__49cb94e06479c2581b80bef8dea397ed($replies=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_87405a68d13ab06830ea664da8e37c18 = is_array($this->functionData['statusUpdates']) ? count($this->functionData['statusUpdates']) : 0;
$this->functionData['statusUpdates'][$count_87405a68d13ab06830ea664da8e37c18]['updates'] = $updates;
$this->functionData['statusUpdates'][$count_87405a68d13ab06830ea664da8e37c18]['smallSpace'] = $smallSpace;
$this->functionData['statusUpdates'][$count_87405a68d13ab06830ea664da8e37c18]['latestOnly'] = $latestOnly;
}
...
</script>".$this->__f__b149bdfe848dc86bbee65f98b3910719($updates,$smallSpace,$latestOnly)."";
return $IPBHTML;
}


function __f__b149bdfe848dc86bbee65f98b3910719($updates=array(), $smallSpace=0, $latestOnly=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
