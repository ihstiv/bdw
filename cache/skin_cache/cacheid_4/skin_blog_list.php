...
{
$count_24ba0609cda0cfdaf21e741b3b0480da = is_array($this->functionData['blog_rating']) ? count($this->functionData['blog_rating']) : 0;
$this->functionData['blog_rating'][$count_24ba0609cda0cfdaf21e741b3b0480da]['number'] = $number;
}
$IPBHTML .= "".$this->__f__e9bb89ac5e99649ddd9be6baf7a1e574($number)."";
return $IPBHTML;
}


function __f__e9bb89ac5e99649ddd9be6baf7a1e574($number)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_04f76673ff63f63a0dda483407f97537 = is_array($this->functionData['blogAjaxSidebar']) ? count($this->functionData['blogAjaxSidebar']) : 0;
$this->functionData['blogAjaxSidebar'][$count_04f76673ff63f63a0dda483407f97537]['blogs'] = $blogs;
}
$IPBHTML .= "" . ((is_array( $blogs ) && count( $blogs )) ? ("
	".$this->__f__a9939ed87ae94d1843fb3162ef74d447($blogs)."") : ("
...
function __f__a9939ed87ae94d1843fb3162ef74d447($blogs)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_f8abf8986ea3455efbafeafd9eb2ca11 = is_array($this->functionData['blogAjaxSidebarREntries']) ? count($this->functionData['blogAjaxSidebarREntries']) : 0;
$this->functionData['blogAjaxSidebarREntries'][$count_f8abf8986ea3455efbafeafd9eb2ca11]['entries'] = $entries;
}
$IPBHTML .= "" . ((is_array( $entries ) && count( $entries )) ? ("
	".$this->__f__4e09e7c29e21a2121c0eee5b2c6efadc($entries)."") : ("
...
function __f__4e09e7c29e21a2121c0eee5b2c6efadc($entries)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_09799b0e8da2dba7e27a40b7b72cd7dc = is_array($this->functionData['blogFeaturedEntry']) ? count($this->functionData['blogFeaturedEntry']) : 0;
$this->functionData['blogFeaturedEntry'][$count_09799b0e8da2dba7e27a40b7b72cd7dc]['featured'] = $featured;
}
...
{
$count_980b103ce9867fd21df02e05f580728c = is_array($this->functionData['blogIndexPage']) ? count($this->functionData['blogIndexPage']) : 0;
$this->functionData['blogIndexPage'][$count_980b103ce9867fd21df02e05f580728c]['pages'] = $pages;
$this->functionData['blogIndexPage'][$count_980b103ce9867fd21df02e05f580728c]['featured'] = $featured;
$this->functionData['blogIndexPage'][$count_980b103ce9867fd21df02e05f580728c]['blogs'] = $blogs;
$this->functionData['blogIndexPage'][$count_980b103ce9867fd21df02e05f580728c]['extra'] = $extra;
$this->functionData['blogIndexPage'][$count_980b103ce9867fd21df02e05f580728c]['type'] = $type;
$this->functionData['blogIndexPage'][$count_980b103ce9867fd21df02e05f580728c]['sorting'] = $sorting;
$this->functionData['blogIndexPage'][$count_980b103ce9867fd21df02e05f580728c]['pinned'] = $pinned;
}
	...
	" . (($this->memberData['member_id']) ? ("<ul class='topic_buttons'>
		...
		" . ((is_array($this->memberData['has_blog']) && count($this->memberData['has_blog'])) ? ("
			<ul class=\"ipbmenu_content\" id='addentrylink_menucontent' style='display:none' >
				".$this->__f__ead2315fe8cc27a2de917aa115990946($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."			</ul>
		") : ("")) . "") : ("")) . "
		...
		" . ((is_array( $pinned ) AND count( $pinned )) ? ("
			<div class='ipsSideBlock clearfix'>
				...
				<ul class='ipsList_withminiphoto'>
					".$this->__f__401dab829b13fa52b940136758122305($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."				</ul>
			</div>
		") : ("")) . "
		...
		<div id='blogs_filter_menucontent' class='ipbmenu_content ipsPad' style='display: none'>
			<form id='filter_form' action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=blog&amp;type=all", "public",'' ), "false", "app=blog" ) . "\" method=\"post\">
				...
				<select name='filter' id='filter' class='input_select'>
					".$this->__f__6ec0651947dc07c20bead02919a4c556($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."				</select>
				<br /><br />
				
				<strong>{$this->lang->words['blist_sort_on']}</strong><br />
				<select name='sort_key' id='sort_key' class='input_select'>
					".$this->__f__f2ed9ce1fe11754d7f75d18dce36df17($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."				</select>
				<br /><br />
				
				<strong>{$this->lang->words['by_sort']}</strong><br />
				<select name='sort_order' id='sort_order' class='input_select'>
					".$this->__f__06b714094d8dcbce3d8aaeb7d46d8671($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."				</select>
				<br /><br />
				
				<strong>{$this->lang->words['blist_per_page']}</strong><br />
				<select name='max_results' id='max_results' class='input_select'>
					".$this->__f__043852aa7890cbeb5db71c2a37935a76($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."				</select>
				<br /><br />
		...
		") : ("<div class='ipsBox clear'>
				...
				" . (($type == 'dash') ? ("<!-- FEATURED -->
					" . ((is_array($featured) AND count($featured)) ? ("
						".$this->__f__1fdec4f0dcea8b1e500a032c98a3f593($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."					") : ("")) . "
					<!--NORMALS-->
					" . ((is_array( $blogs['normal'] ) && count( $blogs['normal'] )) ? ("
						".$this->__f__1c1443bb9d3f5bc44370019a5d4274a9($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."					") : ("")) . "") : ("<script type='text/javascript'>
					...
					<div class='ipsBox_container'>
						<table class='ipb_table'>
							...
							" . ((is_array($featured) AND count($featured)) ? ("
								".$this->__f__f69c49eb85b2cf01b9d00d951ae4532f($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."							") : ("")) . "
							" . ((is_array( $blogs['pinned'] ) && count( $blogs['pinned'] )) ? ("
								".$this->__f__3f57cb60d31217b86099f4df7a5bf037($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."							") : ("")) . "
							" . ((is_array( $blogs['normal'] ) && count( $blogs['normal'] )) ? ("
								".$this->__f__faccfba2a1c4274a61cda5bddc90fd84($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."							") : ("")) . "
						</table>
					</div>
					<script type='text/javascript'>
...
function __f__ead2315fe8cc27a2de917aa115990946($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__401dab829b13fa52b940136758122305($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__6ec0651947dc07c20bead02919a4c556($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__f2ed9ce1fe11754d7f75d18dce36df17($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__06b714094d8dcbce3d8aaeb7d46d8671($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__043852aa7890cbeb5db71c2a37935a76($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__1fdec4f0dcea8b1e500a032c98a3f593($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__1c1443bb9d3f5bc44370019a5d4274a9($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__f69c49eb85b2cf01b9d00d951ae4532f($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $featured as $fid => $entry )
...
function __f__3f57cb60d31217b86099f4df7a5bf037($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__faccfba2a1c4274a61cda5bddc90fd84($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_6e082d7746fb2d6e7939927d4ea34d93 = is_array($this->functionData['blogListRow']) ? count($this->functionData['blogListRow']) : 0;
$this->functionData['blogListRow'][$count_6e082d7746fb2d6e7939927d4ea34d93]['entry'] = $entry;
$this->functionData['blogListRow'][$count_6e082d7746fb2d6e7939927d4ea34d93]['outSideBlog'] = $outSideBlog;
}
...
{
$count_6604aa28263d4e5e96a7c4a6455184ba = is_array($this->functionData['blogTableRow']) ? count($this->functionData['blogTableRow']) : 0;
$this->functionData['blogTableRow'][$count_6604aa28263d4e5e96a7c4a6455184ba]['blog'] = $blog;
}
...
{
$count_a551ffa008a657f4dbd65a6e656c86cc = is_array($this->functionData['generateBlogIcon']) ? count($this->functionData['generateBlogIcon']) : 0;
$this->functionData['generateBlogIcon'][$count_a551ffa008a657f4dbd65a6e656c86cc]['data'] = $data;
}
