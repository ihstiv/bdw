...
{
$count_ca08d60347a9c7158b27c7c5b1132fb6 = is_array($this->functionData['ajaxSharePost']) ? count($this->functionData['ajaxSharePost']) : 0;
$this->functionData['ajaxSharePost'][$count_ca08d60347a9c7158b27c7c5b1132fb6]['topic'] = $topic;
$this->functionData['ajaxSharePost'][$count_ca08d60347a9c7158b27c7c5b1132fb6]['post'] = $post;
$this->functionData['ajaxSharePost'][$count_ca08d60347a9c7158b27c7c5b1132fb6]['url'] = $url;
$this->functionData['ajaxSharePost'][$count_ca08d60347a9c7158b27c7c5b1132fb6]['sharelinks'] = $sharelinks;
}
...
{
$count_b93315e06767eef3708e63725a2c2993 = is_array($this->functionData['announcement_show']) ? count($this->functionData['announcement_show']) : 0;
$this->functionData['announcement_show'][$count_b93315e06767eef3708e63725a2c2993]['announce'] = $announce;
$this->functionData['announcement_show'][$count_b93315e06767eef3708e63725a2c2993]['author'] = $author;
}
...
{
$count_ceafd1f2d391c5751c6f7a48061b5443 = is_array($this->functionData['archiveStatusMessage']) ? count($this->functionData['archiveStatusMessage']) : 0;
$this->functionData['archiveStatusMessage'][$count_ceafd1f2d391c5751c6f7a48061b5443]['topic'] = $topic;
$this->functionData['archiveStatusMessage'][$count_ceafd1f2d391c5751c6f7a48061b5443]['forum'] = $forum;
}
...
{
$count_1becdf8f2138e7e22553a5b5717b4f44 = is_array($this->functionData['hookFacebookLike']) ? count($this->functionData['hookFacebookLike']) : 0;
}
...
{
$count_fe3086d012030cb49186a947a4d9599a = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_fe3086d012030cb49186a947a4d9599a]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_fe3086d012030cb49186a947a4d9599a]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_fe3086d012030cb49186a947a4d9599a]['opts'] = $opts;
}
...
{
$count_03abbe6e8b6c2205fc84b48120cb5622 = is_array($this->functionData['pollDisplay']) ? count($this->functionData['pollDisplay']) : 0;
$this->functionData['pollDisplay'][$count_03abbe6e8b6c2205fc84b48120cb5622]['poll'] = $poll;
$this->functionData['pollDisplay'][$count_03abbe6e8b6c2205fc84b48120cb5622]['topicData'] = $topicData;
$this->functionData['pollDisplay'][$count_03abbe6e8b6c2205fc84b48120cb5622]['forumData'] = $forumData;
$this->functionData['pollDisplay'][$count_03abbe6e8b6c2205fc84b48120cb5622]['pollData'] = $pollData;
$this->functionData['pollDisplay'][$count_03abbe6e8b6c2205fc84b48120cb5622]['showResults'] = $showResults;
$this->functionData['pollDisplay'][$count_03abbe6e8b6c2205fc84b48120cb5622]['editPoll'] = $editPoll;
}
...
<div class='general_box alt poll' id='poll_{$poll['pid']}'>
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=extras&amp;section=vote&amp;t={$topicData['tid']}&amp;page={$this->request['page']}&amp;do=add&amp;secure_key={$this->member->form_hash}", "public",'' ), "", "" ) . "\" name='pollForm' method=\"post\">
		...
		") : ("")) . "
		".$this->__f__79971d0d155743e20aa21d2eee925550($poll,$topicData,$forumData,$pollData,$showResults,$editPoll)."		<fieldset class='submit'>
...
function __f__158abf8338ba6c9fdc14ce2d0edc9ada($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='',$choiceID='',$choiceData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__de5515e209869473b4ad3681325f2dd5($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
							...
							" . (($showResults) ? ("<li>
									...
									" . (($poll['poll_view_voters'] AND is_array( $choiceData['voters'] ) AND $this->settings['poll_allow_public'] AND $choiceData['votes']) ? ("
										<script type='text/javascript'>
											...
											".$this->__f__158abf8338ba6c9fdc14ce2d0edc9ada($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData,$choiceID,$choiceData)."											ipb.topic.poll[ $questionID ][ $choiceID ] = { name: \"{$choiceData['choice']}\", users: users};
										</script>
									") : ("")) . "
...
function __f__79971d0d155743e20aa21d2eee925550($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $pollData as $questionID => $questionData )
	{
		...
		$_ips___x_retval .= "
			<div class='poll_question" . (($showResults) ? (" voted") : ("")) . "'>
				...
				") : ("
					<ol>
						".$this->__f__de5515e209869473b4ad3681325f2dd5($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData)."					</ol>
				")) . "
			</div>
...
{
$count_ee9126d679f7168666c4146854339556 = is_array($this->functionData['post']) ? count($this->functionData['post']) : 0;
$this->functionData['post'][$count_ee9126d679f7168666c4146854339556]['post'] = $post;
$this->functionData['post'][$count_ee9126d679f7168666c4146854339556]['displayData'] = $displayData;
$this->functionData['post'][$count_ee9126d679f7168666c4146854339556]['topic'] = $topic;
$this->functionData['post'][$count_ee9126d679f7168666c4146854339556]['forum'] = $forum;
}
...
{
$count_b82d16f0bc9c6b7e07b9b00afda97289 = is_array($this->functionData['quickEditPost']) ? count($this->functionData['quickEditPost']) : 0;
$this->functionData['quickEditPost'][$count_b82d16f0bc9c6b7e07b9b00afda97289]['post'] = $post;
}
$IPBHTML .= "{$post['post']}
    {$post['attachmentHtml']}
	<br />
...
{
$count_4df67c8813f003170e7ac03ac66a1f0d = is_array($this->functionData['show_attachment_title']) ? count($this->functionData['show_attachment_title']) : 0;
$this->functionData['show_attachment_title'][$count_4df67c8813f003170e7ac03ac66a1f0d]['title'] = $title;
$this->functionData['show_attachment_title'][$count_4df67c8813f003170e7ac03ac66a1f0d]['data'] = $data;
$this->functionData['show_attachment_title'][$count_4df67c8813f003170e7ac03ac66a1f0d]['type'] = $type;
}
$IPBHTML .= "<div id='attach_wrap' class='clearfix'>
	<h4>{$title}</h4>
	<ul>
		".$this->__f__3ab10971cd6c739af51ba6f028a39709($title,$data,$type)."	</ul>
</div>";
return $IPBHTML;
}


function __f__3ab10971cd6c739af51ba6f028a39709($title="",$data="",$type="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_3d9df54060c405533752578adfffbf14 = is_array($this->functionData['Show_attachments']) ? count($this->functionData['Show_attachments']) : 0;
$this->functionData['Show_attachments'][$count_3d9df54060c405533752578adfffbf14]['data'] = $data;
}
...
{
$count_74ed2993acb5af81a3c84dcf1365f1e2 = is_array($this->functionData['softDeletedPostBit']) ? count($this->functionData['softDeletedPostBit']) : 0;
$this->functionData['softDeletedPostBit'][$count_74ed2993acb5af81a3c84dcf1365f1e2]['post'] = $post;
$this->functionData['softDeletedPostBit'][$count_74ed2993acb5af81a3c84dcf1365f1e2]['sdData'] = $sdData;
$this->functionData['softDeletedPostBit'][$count_74ed2993acb5af81a3c84dcf1365f1e2]['topic'] = $topic;
}
...
$IPBHTML = "";
$IPBHTML .= "".$this->__f__6ec4736290832e66450abddbd463bb41($topic,$posts)."<br class='clear' />
...
function __f__6ec4736290832e66450abddbd463bb41($topic, $posts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_153116f883e24c6b3501b0def9dcc0db = is_array($this->functionData['topicViewTemplate']) ? count($this->functionData['topicViewTemplate']) : 0;
$this->functionData['topicViewTemplate'][$count_153116f883e24c6b3501b0def9dcc0db]['forum'] = $forum;
$this->functionData['topicViewTemplate'][$count_153116f883e24c6b3501b0def9dcc0db]['topic'] = $topic;
$this->functionData['topicViewTemplate'][$count_153116f883e24c6b3501b0def9dcc0db]['post_data'] = $post_data;
$this->functionData['topicViewTemplate'][$count_153116f883e24c6b3501b0def9dcc0db]['displayData'] = $displayData;
}
...
" . (($displayData['mod_links'] AND ( $this->memberData['is_mod'] OR $this->memberData['member_id'] == $topic['starter_id'] )) ? ("<ul class='ipbmenu_content' id='topic_mod_options_menucontent'  style='display:none'>
	".$this->__f__c6eb0ab90509067c035a6a080c221270($forum,$topic,$post_data,$displayData)."	" . (($topic['topic_queuedposts'] AND $this->registry->class_forums->canQueuePosts( $forum['id'] )) ? ("
	...
	" . ((is_array( $displayData['multi_mod'] ) AND count( $displayData['multi_mod'] )) ? ("
		".$this->__f__2419ee6fda63afba2f7f13f8e7a452e6($forum,$topic,$post_data,$displayData)."	") : ("")) . "
</ul>
<script type='text/javascript'>
...
" . (($this->settings['reputation_enabled'] && $this->settings['reputation_point_types'] != 'like' && $this->settings['reputation_show_content'] && $this->memberData['member_id'] != 0 && is_array($this->caches['reputation_levels'])) ? ("<ul id='rep_filter_menucontent' class='ipbmenu_content with_checks' style='display: none'>
		...
		" . ((is_array($this->caches['reputation_levels'])) ? ("
			".$this->__f__2a35f570b9be24867121c57ddabffeac($forum,$topic,$post_data,$displayData)."		") : ("")) . "
	</ul>
	<script type='text/javascript'>
...
<!--hook.if.skin_topic.topicViewTemplate.hasPosts.pre.startif-->" . ((is_array( $post_data ) AND count( $post_data )) ? ("
	<div class='ipsBox'>
		<div class='ipsBox_container' id='ips_Posts'>
			".$this->__f__289c9e0cfe0e69a904e228d7d7925d36($forum,$topic,$post_data,$displayData)."		</div>
	</div>
") : ("")) . "
<hr />
...
" . ((is_array( $displayData['same_tagged'] ) and count( $displayData['same_tagged'] )) ? ("
	...
	<div class='ipsBox'>
		...
		<div class='ipsBox_container'>
			...
			".$this->__f__d3d0af1cf94bfb4d93b8ebdc10199dd0($forum,$topic,$post_data,$displayData)."			</table>
		</div>
	</div>
") : ("")) . "
<!-- ACTIVE USERS -->
...
function __f__c6eb0ab90509067c035a6a080c221270($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__2419ee6fda63afba2f7f13f8e7a452e6($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__2a35f570b9be24867121c57ddabffeac($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__289c9e0cfe0e69a904e228d7d7925d36($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__d3d0af1cf94bfb4d93b8ebdc10199dd0($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
