...
/* CACHE FILE: Generated: Wed, 18 May 2016 17:28:37 GMT */
...
{
$count_9c25dbd17910dad518102e5d3b1a22ac = is_array($this->functionData['coreAttachments']) ? count($this->functionData['coreAttachments']) : 0;
$this->functionData['coreAttachments'][$count_9c25dbd17910dad518102e5d3b1a22ac]['info'] = $info;
$this->functionData['coreAttachments'][$count_9c25dbd17910dad518102e5d3b1a22ac]['pages'] = $pages;
$this->functionData['coreAttachments'][$count_9c25dbd17910dad518102e5d3b1a22ac]['attachments'] = $attachments;
}
...
<div class='row1'>	
	...
	<table class='ipb_table' summary=\"{$this->lang->words['ucp_user_attach']}\">
		<tr class='header'>
			...
			" . ((count($attachments)) ? ("
								".$this->__f__d7da52d11ec3f062214307442238f424($info,$pages,$attachments)."			") : ("
				<tr>
...
function __f__d7da52d11ec3f062214307442238f424($info="",$pages="",$attachments)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_439272b10d7969244cf2affb118a5225 = is_array($this->functionData['displayNameForm']) ? count($this->functionData['displayNameForm']) : 0;
$this->functionData['displayNameForm'][$count_439272b10d7969244cf2affb118a5225]['form'] = $form;
$this->functionData['displayNameForm'][$count_439272b10d7969244cf2affb118a5225]['error'] = $error;
$this->functionData['displayNameForm'][$count_439272b10d7969244cf2affb118a5225]['okmessage'] = $okmessage;
$this->functionData['displayNameForm'][$count_439272b10d7969244cf2affb118a5225]['isFB'] = $isFB;
}
$IPBHTML .= "" . (($okmessage != "") ? ("
...
{
$count_61a179e8718d320f3df71d438aa93ebc = is_array($this->functionData['emailPasswordChangeForm']) ? count($this->functionData['emailPasswordChangeForm']) : 0;
$this->functionData['emailPasswordChangeForm'][$count_61a179e8718d320f3df71d438aa93ebc]['txt'] = $txt;
$this->functionData['emailPasswordChangeForm'][$count_61a179e8718d320f3df71d438aa93ebc]['_message'] = $_message;
$this->functionData['emailPasswordChangeForm'][$count_61a179e8718d320f3df71d438aa93ebc]['isFB'] = $isFB;
}
...
{
$count_974150d0053289adbf89438974ae685a = is_array($this->functionData['field_entry']) ? count($this->functionData['field_entry']) : 0;
$this->functionData['field_entry'][$count_974150d0053289adbf89438974ae685a]['title'] = $title;
$this->functionData['field_entry'][$count_974150d0053289adbf89438974ae685a]['desc'] = $desc;
$this->functionData['field_entry'][$count_974150d0053289adbf89438974ae685a]['content'] = $content;
$this->functionData['field_entry'][$count_974150d0053289adbf89438974ae685a]['id'] = $id;
}
...
{
$count_7f9dcd4df35f042b2e9b19943c984e4a = is_array($this->functionData['membersFacebookConnect']) ? count($this->functionData['membersFacebookConnect']) : 0;
$this->functionData['membersFacebookConnect'][$count_7f9dcd4df35f042b2e9b19943c984e4a]['fbuid'] = $fbuid;
$this->functionData['membersFacebookConnect'][$count_7f9dcd4df35f042b2e9b19943c984e4a]['fbUserData'] = $fbUserData;
$this->functionData['membersFacebookConnect'][$count_7f9dcd4df35f042b2e9b19943c984e4a]['linkedMemberData'] = $linkedMemberData;
$this->functionData['membersFacebookConnect'][$count_7f9dcd4df35f042b2e9b19943c984e4a]['perms'] = $perms;
$this->functionData['membersFacebookConnect'][$count_7f9dcd4df35f042b2e9b19943c984e4a]['missingPerms'] = $missingPerms;
}
...
{
$count_2719befc95f3b89c31193d26903d0f46 = is_array($this->functionData['membersIgnoredUsersForm']) ? count($this->functionData['membersIgnoredUsersForm']) : 0;
$this->functionData['membersIgnoredUsersForm'][$count_2719befc95f3b89c31193d26903d0f46]['members'] = $members;
$this->functionData['membersIgnoredUsersForm'][$count_2719befc95f3b89c31193d26903d0f46]['pagination'] = $pagination;
}
...
<table class='ipb_table' summary=\"{$this->lang->words['ucp_ignored_users']}\">
	<tr class='header'>
		...
		" . ((count( $members )) ? ("".$this->__f__9d6658bc108ae7ea7fa2e06f0f6e7383($members,$pagination)."	") : ("<tr>
...
function __f__9d6658bc108ae7ea7fa2e06f0f6e7383($members, $pagination)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_18d51558317aa69b44b20c42890d3864 = is_array($this->functionData['membersProfileForm']) ? count($this->functionData['membersProfileForm']) : 0;
$this->functionData['membersProfileForm'][$count_18d51558317aa69b44b20c42890d3864]['custom_fields'] = $custom_fields;
$this->functionData['membersProfileForm'][$count_18d51558317aa69b44b20c42890d3864]['group_titles'] = $group_titles;
$this->functionData['membersProfileForm'][$count_18d51558317aa69b44b20c42890d3864]['day'] = $day;
$this->functionData['membersProfileForm'][$count_18d51558317aa69b44b20c42890d3864]['mon'] = $mon;
$this->functionData['membersProfileForm'][$count_18d51558317aa69b44b20c42890d3864]['year'] = $year;
$this->functionData['membersProfileForm'][$count_18d51558317aa69b44b20c42890d3864]['amEditor'] = $amEditor;
$this->functionData['membersProfileForm'][$count_18d51558317aa69b44b20c42890d3864]['times'] = $times;
}
...
<div class='ipsSettings'>
		...
		<div>
			<ul class='ipsForm ipsForm_horizontal'>
				<li class='ipsField'>
					...
					".$this->__f__38ab38d11d83d36cff1bcd73b42a6f92($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times)."					</select><br />
				...
				" . (($day AND $mon AND $year) ? ("
					...
					<ul>
						<li>
							...
							<select name=\"month\">&nbsp;
								".$this->__f__511f87ecb159491eef7b6b154754c896($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times)."							</select>			
							<select name=\"day\">&nbsp;
								".$this->__f__e4890409714310a45098fcc98ab0441e($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times)."							</select> 
							<select name=\"year\">&nbsp;
								".$this->__f__70aaee06776c6e2e5d2bdf28057f1d2d($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times)."							</select> <br />
	...
	" . ((count( $custom_fields )) ? ("".$this->__f__27eae04db12294087ffab13ea65ab943($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times)."	") : ("")) . "
...
function __f__38ab38d11d83d36cff1bcd73b42a6f92($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__511f87ecb159491eef7b6b154754c896($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $mon as $m )
...
function __f__e4890409714310a45098fcc98ab0441e($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $day as $d )
...
function __f__70aaee06776c6e2e5d2bdf28057f1d2d($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $year as $y )
...
function __f__010928a9e3662e765a7d9326e1669a3d($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array(),$cgroup='',$cfields='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__27eae04db12294087ffab13ea65ab943($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		$_ips___x_retval .= "
			" . ((count( $cfields )) ? ("
				<fieldset class='ipsSettings_section'>
					...
					<div>
						<ul>
							".$this->__f__010928a9e3662e765a7d9326e1669a3d($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times,$cgroup,$cfields)."						</ul>
					</div>
				</fieldset>
			") : ("")) . "
...
{
$count_57e14fa971bd62388934e8b8b91a12db = is_array($this->functionData['membersSignatureForm']) ? count($this->functionData['membersSignatureForm']) : 0;
$this->functionData['membersSignatureForm'][$count_57e14fa971bd62388934e8b8b91a12db]['editor_html'] = $editor_html;
$this->functionData['membersSignatureForm'][$count_57e14fa971bd62388934e8b8b91a12db]['sig_restrictions'] = $sig_restrictions;
$this->functionData['membersSignatureForm'][$count_57e14fa971bd62388934e8b8b91a12db]['signature'] = $signature;
}
...
{
$count_fccb9fd4a605a6d7cc871ad9e3acb078 = is_array($this->functionData['membersTwitterConnect']) ? count($this->functionData['membersTwitterConnect']) : 0;
$this->functionData['membersTwitterConnect'][$count_fccb9fd4a605a6d7cc871ad9e3acb078]['isConnected'] = $isConnected;
$this->functionData['membersTwitterConnect'][$count_fccb9fd4a605a6d7cc871ad9e3acb078]['twitterUser'] = $twitterUser;
}
...
{
$count_f0d40e048e480e7c3395f46e4a959cd7 = is_array($this->functionData['notificationsForm']) ? count($this->functionData['notificationsForm']) : 0;
$this->functionData['notificationsForm'][$count_f0d40e048e480e7c3395f46e4a959cd7]['config'] = $config;
$this->functionData['notificationsForm'][$count_f0d40e048e480e7c3395f46e4a959cd7]['emailData'] = $emailData;
}
...
<fieldset class='row1'>
	<span class='desc'><strong>{$this->lang->words['notifications_info_acp']}</strong></span>
		...
		".$this->__f__ed22d78a0c7a090b1a385562aa4e2035($config,$emailData)."		".$this->__f__543b6579d1076a8eee9f3dcdf6c9bb7d($config,$emailData)."	</table>
</fieldset>";
return $IPBHTML;
}


function __f__8d39937c22f2236ddebcccc6a8f37ae4($config, $emailData,$groupKey='',$group='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__ed22d78a0c7a090b1a385562aa4e2035($config, $emailData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $this->notifyGroups as $groupKey => $group )
	{
		...
		$_ips___x_retval .= "
			...
			".$this->__f__8d39937c22f2236ddebcccc6a8f37ae4($config,$emailData,$groupKey,$group)."							
...
function __f__543b6579d1076a8eee9f3dcdf6c9bb7d($config, $emailData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_96479846993a070abc939819d140bc5d = is_array($this->functionData['notificationsLog']) ? count($this->functionData['notificationsLog']) : 0;
$this->functionData['notificationsLog'][$count_96479846993a070abc939819d140bc5d]['notifications'] = $notifications;
$this->functionData['notificationsLog'][$count_96479846993a070abc939819d140bc5d]['error'] = $error;
$this->functionData['notificationsLog'][$count_96479846993a070abc939819d140bc5d]['pages'] = $pages;
}
		...
		<table class='ipb_table' summary=\"{$this->lang->words['notifications_table_head']}\">
			<tr class='header hide'>
				...
				<th scope='col' align=\"center\" width=\"5%\" class='short'>&nbsp;</th>
						...
						".$this->__f__2b3a073f866962876bb9201abf9af0f3($notifications,$error,$pages)."		</table>
		<script type='text/javascript'>
...
function __f__2b3a073f866962876bb9201abf9af0f3($notifications, $error='', $pages='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_6d9c40cbf53ec419e7a4d69b4e0e6c89 = is_array($this->functionData['userCPTemplate']) ? count($this->functionData['userCPTemplate']) : 0;
$this->functionData['userCPTemplate'][$count_6d9c40cbf53ec419e7a4d69b4e0e6c89]['current_tab'] = $current_tab;
$this->functionData['userCPTemplate'][$count_6d9c40cbf53ec419e7a4d69b4e0e6c89]['html'] = $html;
$this->functionData['userCPTemplate'][$count_6d9c40cbf53ec419e7a4d69b4e0e6c89]['tabs'] = $tabs;
$this->functionData['userCPTemplate'][$count_6d9c40cbf53ec419e7a4d69b4e0e6c89]['current_area'] = $current_area;
$this->functionData['userCPTemplate'][$count_6d9c40cbf53ec419e7a4d69b4e0e6c89]['errors'] = $errors;
$this->functionData['userCPTemplate'][$count_6d9c40cbf53ec419e7a4d69b4e0e6c89]['hide_form'] = $hide_form;
$this->functionData['userCPTemplate'][$count_6d9c40cbf53ec419e7a4d69b4e0e6c89]['maxUpload'] = $maxUpload;
}
...
" . ((count($tabs) > 1) ? ("
	<div class='maintitle ipsFilterbar clearfix'>
		<ul class='ipsList_inline'>
			".$this->__f__29089f6e1683a044550d6025a1550fd8($current_tab,$html,$tabs,$current_area,$errors,$hide_form,$maxUpload)."		</ul>
	</div>
") : ("")) . "
<div class='ipsBox'>
	<div class='ipsLayout" . (($hasMoreTabs) ? (" ipsLayout_withleft ipsLayout_smallleft ipsVerticalTabbed") : ("")) . " clearfix usercp_body'>
		" . (($hasMoreTabs) ? ("
			<div class='ipsVerticalTabbed_tabs ipsLayout_left' id='usercp_tabs'>
				<ul>
					".$this->__f__c3f698b73771594040b3ca38145656d8($current_tab,$html,$tabs,$current_area,$errors,$hide_form,$maxUpload)."				</ul>
			</div>
		") : ("")) . "
		<div class='" . (($hasMoreTabs) ? ("ipsVerticalTabbed_content ") : ("")) . "ipsLayout_content ipsBox_container' id='usercp_content'>
			<div class='ipsPad'>
				" . ((is_array( $errors ) AND count( $errors )) ? ("
					<p class='message error'>
						".$this->__f__16c091461e282c75c27c266dc86bfe21($current_tab,$html,$tabs,$current_area,$errors,$hide_form,$maxUpload)."					</p>
					<br />
				") : ("")) . "
...
function __f__29089f6e1683a044550d6025a1550fd8($current_tab, $html, $tabs, $current_area, $errors=array(), $hide_form=0, $maxUpload=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__c3f698b73771594040b3ca38145656d8($current_tab, $html, $tabs, $current_area, $errors=array(), $hide_form=0, $maxUpload=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__16c091461e282c75c27c266dc86bfe21($current_tab, $html, $tabs, $current_area, $errors=array(), $hide_form=0, $maxUpload=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
