...
{
$count_4851fc1d0e19b6d0c3b6d98cc4868414 = is_array($this->functionData['asForumPosts']) ? count($this->functionData['asForumPosts']) : 0;
$this->functionData['asForumPosts'][$count_4851fc1d0e19b6d0c3b6d98cc4868414]['data'] = $data;
}
	...
	<div class='post_wrap'>
		...
		<div class='post_body'>
			<p class='posted_info desc lighter ipsType_small'>
				...
				" . (($data['_forum_trail']) ? ("
					{$this->lang->words['in']}
					".$this->__f__5d7ed8acf6d3d162cdcd1c75c180fbbd($data)."				") : ("")) . "
			</p>
...
function __f__5d7ed8acf6d3d162cdcd1c75c180fbbd($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_472fef8d1d8adf4ff2cb2bafcad79f8c = is_array($this->functionData['asForumTopics']) ? count($this->functionData['asForumTopics']) : 0;
$this->functionData['asForumTopics'][$count_472fef8d1d8adf4ff2cb2bafcad79f8c]['data'] = $data;
}
$IPBHTML .= "<tr class='_recordRow __topic __tid{$data['tid']} " . ((!$data['_icon']['is_read']) ? ("unread") : ("")) . " expandable " . (($data['approved'] != 1) ? (" moderated") : ("")) . "' id='trow_{$data['tid']}' data-tid=\"{$data['tid']}\">
	...
	<td>
		...
		<span class='desc blend_links'>
			".$this->__f__fc14c1fec42dfd824a9aa9cd0eb8d02e($data)."		</span>
		<span class='desc lighter blend_links toggle_notify_off'>
			...
			<!--hook.if.skin_search.asForumTopics.hasTags.pre.startif-->" . ((count($data['tags']['formatted'])) ? ("
		...
		" . ((isset( $data['pages'] ) AND is_array( $data['pages'] ) AND count( $data['pages'] )) ? ("
			...
			".$this->__f__2d9928b7a0195ca591be109291f7bf69($data)."			</ul>
		") : ("")) . "
...
function __f__fc14c1fec42dfd824a9aa9cd0eb8d02e($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data['_forum_trail'] as $i => $f )
...
function __f__2d9928b7a0195ca591be109291f7bf69($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_251faeb05589da38fb1befc046985056 = is_array($this->functionData['followData']) ? count($this->functionData['followData']) : 0;
$this->functionData['followData'][$count_251faeb05589da38fb1befc046985056]['followData'] = $followData;
}
...
{
$count_bd38371b929b803df8f0f25cacfd7abe = is_array($this->functionData['followedContentForumsWrapper']) ? count($this->functionData['followedContentForumsWrapper']) : 0;
$this->functionData['followedContentForumsWrapper'][$count_bd38371b929b803df8f0f25cacfd7abe]['results'] = $results;
}
...
<table class='ipb_table topic_list' id='forum_table'>
	" . ((count($results)) ? ("".$this->__f__42a6e717d8b30b7aa93509a82f3787cf($results)."	") : ("")) . "
</table>";
return $IPBHTML;
}


function __f__42a6e717d8b30b7aa93509a82f3787cf($results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_694c1ed3cc2159842a31d191f74d9112 = is_array($this->functionData['followedContentForumsWrapperForums']) ? count($this->functionData['followedContentForumsWrapperForums']) : 0;
$this->functionData['followedContentForumsWrapperForums'][$count_694c1ed3cc2159842a31d191f74d9112]['results'] = $results;
}
...
<table class='ipb_table topic_list' id='forum_table'>
	" . ((count($results)) ? ("".$this->__f__c5cb26a0388c8fc64bcd84c204c0fda1($results)."	") : ("")) . "
</table>";
return $IPBHTML;
}


function __f__e55ad1d21d527e3349c201d37976b555($results,$forum_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__c5cb26a0388c8fc64bcd84c204c0fda1($results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
				...
				<td class='col_c_forum'>
					...
					" . (($forum_data['show_subforums'] AND count( $forum_data['subforums'] ) AND $forum_data['show_subforums']) ? ("
						...
						<ol class='ipsList_inline ipsType_small subforums toggle_notify_off' id='subforums_{$forum_data['id']}'>
							".$this->__f__e55ad1d21d527e3349c201d37976b555($results,$forum_data)."						</ol>
					") : ("")) . "
...
{
$count_b283aa216e2f1bbf9bec54bac032db97 = is_array($this->functionData['followedContentView']) ? count($this->functionData['followedContentView']) : 0;
$this->functionData['followedContentView'][$count_b283aa216e2f1bbf9bec54bac032db97]['results'] = $results;
$this->functionData['followedContentView'][$count_b283aa216e2f1bbf9bec54bac032db97]['pagination'] = $pagination;
$this->functionData['followedContentView'][$count_b283aa216e2f1bbf9bec54bac032db97]['total'] = $total;
$this->functionData['followedContentView'][$count_b283aa216e2f1bbf9bec54bac032db97]['error'] = $error;
$this->functionData['followedContentView'][$count_b283aa216e2f1bbf9bec54bac032db97]['contentTypes'] = $contentTypes;
}
		...
		<div class='ipsBox'>
			<div class='ipsBox_container ipsSideMenu'>
				...
				<ul>
					...
					".$this->__f__8060627ff2470ec68a8d75a5e6a7197a($results,$pagination,$total,$error,$contentTypes)."				</ul>
				" . ((is_array($contentTypes) AND count( $contentTypes )) ? ("
					<h4>{$this->lang->words['filter_by_section']}</h4>
					<ul>
						".$this->__f__98cc21e5c454841b51373ec8873e05fb($results,$pagination,$total,$error,$contentTypes)."					</ul>
				") : ("")) . "
			</div>
		</div>
	</div>
...
function __f__8060627ff2470ec68a8d75a5e6a7197a($results, $pagination, $total, $error, $contentTypes)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__98cc21e5c454841b51373ec8873e05fb($results, $pagination, $total, $error, $contentTypes)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_0840d0f2b015871ddef6c08f982521f2 = is_array($this->functionData['forumAdvancedSearchFilters']) ? count($this->functionData['forumAdvancedSearchFilters']) : 0;
$this->functionData['forumAdvancedSearchFilters'][$count_0840d0f2b015871ddef6c08f982521f2]['forums'] = $forums;
$this->functionData['forumAdvancedSearchFilters'][$count_0840d0f2b015871ddef6c08f982521f2]['archivedPostCount'] = $archivedPostCount;
$this->functionData['forumAdvancedSearchFilters'][$count_0840d0f2b015871ddef6c08f982521f2]['topic'] = $topic;
}
...
{
$count_140d3b072ba9280393e5ea1207ce83ee = is_array($this->functionData['forumsVncFilters']) ? count($this->functionData['forumsVncFilters']) : 0;
$this->functionData['forumsVncFilters'][$count_140d3b072ba9280393e5ea1207ce83ee]['data'] = $data;
$this->functionData['forumsVncFilters'][$count_140d3b072ba9280393e5ea1207ce83ee]['currentPrefs'] = $currentPrefs;
}
$IPBHTML .= "<h3>
...
<div class='fixed_inner ipsBox ipsLayout clearfix'>
	<div class='ipsLayout_content ipsBox_container search_filter_container'>
		...
		<ul class='block_list'>
			...
			".$this->__f__553bf6082b43175bc670b7d878b013af($data,$currentPrefs)."		</ul>
	</div>
</div>";
return $IPBHTML;
}
...
function __f__553bf6082b43175bc670b7d878b013af($data, $currentPrefs)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_030ed8f130ac7aea5bc941e8eb4cc24c = is_array($this->functionData['helpSearchResult']) ? count($this->functionData['helpSearchResult']) : 0;
$this->functionData['helpSearchResult'][$count_030ed8f130ac7aea5bc941e8eb4cc24c]['r'] = $r;
$this->functionData['helpSearchResult'][$count_030ed8f130ac7aea5bc941e8eb4cc24c]['resultAsTitle'] = $resultAsTitle;
}
...
{
$count_816461dee5c96296ce479150fd572734 = is_array($this->functionData['memberCommentsSearchResult']) ? count($this->functionData['memberCommentsSearchResult']) : 0;
$this->functionData['memberCommentsSearchResult'][$count_816461dee5c96296ce479150fd572734]['r'] = $r;
$this->functionData['memberCommentsSearchResult'][$count_816461dee5c96296ce479150fd572734]['resultAsTitle'] = $resultAsTitle;
}
...
{
$count_1bd34a75ba6cf740e8d6ecb027db966e = is_array($this->functionData['newContentView']) ? count($this->functionData['newContentView']) : 0;
$this->functionData['newContentView'][$count_1bd34a75ba6cf740e8d6ecb027db966e]['results'] = $results;
$this->functionData['newContentView'][$count_1bd34a75ba6cf740e8d6ecb027db966e]['pagination'] = $pagination;
$this->functionData['newContentView'][$count_1bd34a75ba6cf740e8d6ecb027db966e]['total'] = $total;
$this->functionData['newContentView'][$count_1bd34a75ba6cf740e8d6ecb027db966e]['sortDropDown'] = $sortDropDown;
$this->functionData['newContentView'][$count_1bd34a75ba6cf740e8d6ecb027db966e]['sortIn'] = $sortIn;
$this->functionData['newContentView'][$count_1bd34a75ba6cf740e8d6ecb027db966e]['dateCutSet'] = $dateCutSet;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("search", "0" ) . "
...
function __f__c2ae6256c6e6aba33a322fe19ed57fc8($results, $pagination, $total, $sortDropDown, $sortIn, $dateCutSet=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $this->registry->getApplications() as $app )
...
function __f__45c0ef0dd30194007d2b00309fe2fbe9($results, $pagination, $total, $sortDropDown, $sortIn, $dateCutSet=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_fdb73f041f067db19da203f355dc5763 = is_array($this->functionData['searchAdvancedForm']) ? count($this->functionData['searchAdvancedForm']) : 0;
$this->functionData['searchAdvancedForm'][$count_fdb73f041f067db19da203f355dc5763]['filters'] = $filters;
$this->functionData['searchAdvancedForm'][$count_fdb73f041f067db19da203f355dc5763]['msg'] = $msg;
$this->functionData['searchAdvancedForm'][$count_fdb73f041f067db19da203f355dc5763]['current_app'] = $current_app;
$this->functionData['searchAdvancedForm'][$count_fdb73f041f067db19da203f355dc5763]['removed_search_terms'] = $removed_search_terms;
$this->functionData['searchAdvancedForm'][$count_fdb73f041f067db19da203f355dc5763]['isFT'] = $isFT;
$this->functionData['searchAdvancedForm'][$count_fdb73f041f067db19da203f355dc5763]['canTag'] = $canTag;
}
...
<div class='ipsBox' id='main_search_form'>
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=search&amp;section=search&amp;do=search", "public",'' ), "", "" ) . "&amp;fromsearch=1\" method=\"post\" id='search-box' >
						...
						<div class='ipsField_content'>
							<ul id='sapps'>
								" . ((IPSLib::appIsSearchable( 'forums', 'search' )) ? ("<li style='display: inline-block;' class='search_app' id='sapp_forums'>
									...
									</li>") : ("")) . "".$this->__f__de732fcfc7323b8e450ba8faaae9c4f3($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag)."							</ul>
						</div>
					</li>") : ("")) . "
			</ul>
		</fieldset>
		...
		" . ((count($filters)) ? ("".$this->__f__04f703533c3b65bbf732448b3ccc2cf3($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag)."		") : ("")) . "
...
function __f__de732fcfc7323b8e450ba8faaae9c4f3($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__2a20d64b6fc8b28f44c54ea5a19beeb0($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array(),$app='',$data='',$id='',$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b564d0078686a2e0dbd57866fb8770e2($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array(),$app='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
									...
									<ul class='ipsForm_horizontal'>
										<li class='ipsField ipsField_select'>
											...
											<p class='ipsField_content'>
												...
												".$this->__f__2a20d64b6fc8b28f44c54ea5a19beeb0($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag,$app,$data,$id,$_data)."												</select>
...
function __f__99c5c78c4c4872227f783448554b0cf9($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array(),$app='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__04f703533c3b65bbf732448b3ccc2cf3($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
				...
				<div id='app_filter_{$app}' class='ipsBox_container ipsPad' style='display: none'>
					...
					" . ((count($data['sortDropDown'])) ? ("<fieldset class='" .  IPSLib::next( $this->registry->templateStriping["search"] ) . "'>
							" . ((is_array($data['sortDropIn']) AND count( $data['sortDropIn'] )) ? ("
								".$this->__f__b564d0078686a2e0dbd57866fb8770e2($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag,$app,$data)."							") : ("<ul class='ipsForm_horizontal'>
									<li class='ipsField ipsField_select'>
										...
										<p class='ipsField_content'>
											...
											".$this->__f__99c5c78c4c4872227f783448554b0cf9($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag,$app,$data)."											</select>
...
{
$count_247492760a313ed43eb0fe7ff855cfb2 = is_array($this->functionData['searchResults']) ? count($this->functionData['searchResults']) : 0;
$this->functionData['searchResults'][$count_247492760a313ed43eb0fe7ff855cfb2]['results'] = $results;
$this->functionData['searchResults'][$count_247492760a313ed43eb0fe7ff855cfb2]['titlesOnly'] = $titlesOnly;
}
...
$IPBHTML .= "<div id='search_results'>
	<ol>
		" . ((is_array($results) && count($results)) ? ("
			".$this->__f__74295e09d45a9158a0511792ae8b7cae($results,$titlesOnly)."		") : ("")) . "
	</ol>
</div>";
return $IPBHTML;
}
...
function __f__74295e09d45a9158a0511792ae8b7cae($results, $titlesOnly)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $results as $result )
...
{
$count_79f077b00369a0f7db852aa0d4234b26 = is_array($this->functionData['searchResultsAsForum']) ? count($this->functionData['searchResultsAsForum']) : 0;
$this->functionData['searchResultsAsForum'][$count_79f077b00369a0f7db852aa0d4234b26]['results'] = $results;
$this->functionData['searchResultsAsForum'][$count_79f077b00369a0f7db852aa0d4234b26]['titlesOnly'] = $titlesOnly;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("forums", "0" ) . "
" . (($titlesOnly) ? ("
<script type='text/javascript' src='{$this->settings['public_dir']}js/ips.forums.js'></script>
...
") : ("")) . "
	" . ((count($results)) ? ("" . ((!$titlesOnly) ? ("<div class='ipsBox'>") : ("")) . "
		".$this->__f__d4a10c5c89a592a62376440808a774b1($results,$titlesOnly)."		" . ((!$titlesOnly) ? ("</div>") : ("")) . "") : ("")) . "
" . (($titlesOnly) ? ("</table>
...
function __f__d4a10c5c89a592a62376440808a774b1($results, $titlesOnly)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $results as $result )
...
{
$count_4dda561dea84ae78a264bb1379fdaa31 = is_array($this->functionData['searchResultsWrapper']) ? count($this->functionData['searchResultsWrapper']) : 0;
$this->functionData['searchResultsWrapper'][$count_4dda561dea84ae78a264bb1379fdaa31]['results'] = $results;
$this->functionData['searchResultsWrapper'][$count_4dda561dea84ae78a264bb1379fdaa31]['sortDropDown'] = $sortDropDown;
$this->functionData['searchResultsWrapper'][$count_4dda561dea84ae78a264bb1379fdaa31]['sortIn'] = $sortIn;
$this->functionData['searchResultsWrapper'][$count_4dda561dea84ae78a264bb1379fdaa31]['pagination'] = $pagination;
$this->functionData['searchResultsWrapper'][$count_4dda561dea84ae78a264bb1379fdaa31]['total'] = $total;
$this->functionData['searchResultsWrapper'][$count_4dda561dea84ae78a264bb1379fdaa31]['showing'] = $showing;
$this->functionData['searchResultsWrapper'][$count_4dda561dea84ae78a264bb1379fdaa31]['search_term'] = $search_term;
$this->functionData['searchResultsWrapper'][$count_4dda561dea84ae78a264bb1379fdaa31]['url_string'] = $url_string;
$this->functionData['searchResultsWrapper'][$count_4dda561dea84ae78a264bb1379fdaa31]['current_key'] = $current_key;
$this->functionData['searchResultsWrapper'][$count_4dda561dea84ae78a264bb1379fdaa31]['removed_search_terms'] = $removed_search_terms;
$this->functionData['searchResultsWrapper'][$count_4dda561dea84ae78a264bb1379fdaa31]['limited'] = $limited;
$this->functionData['searchResultsWrapper'][$count_4dda561dea84ae78a264bb1379fdaa31]['wasLimited'] = $wasLimited;
$this->functionData['searchResultsWrapper'][$count_4dda561dea84ae78a264bb1379fdaa31]['search_tags'] = $search_tags;
}
	...
	<div class='ipsLayout_content'>
			...
			" . ((IPSSearchRegistry::get('config.contentTypes') AND is_array( IPSSearchRegistry::get('config.contentTypes') )) ? ("" . ((count($sortDropDown)) ? ("<span class='ipsType_small'>{$this->lang->words['sort_by']}</span>&nbsp;&nbsp;
					" . ((count($sortDropDown) <= 4) ? ("
						<ul class='ipsList_inline ipsType_smaller' style='display: inline'>
							".$this->__f__e9b52bbb68f6627cc11e2b78d44dfab6($results,$sortDropDown,$sortIn,$pagination,$total,$showing,$search_term,$url_string,$current_key,$removed_search_terms,$limited,$wasLimited,$search_tags)."						</ul>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					") : ("
						<ul class='ipsList_inline ipsType_smaller' style='display: inline'>
							<li class='active'>
				...
				<ul class='ipsList_inline ipsType_smaller' style='display: inline'>
					...
					" . ((count($sortDropDown) <= 4) ? ("
						<ul class='ipsList_inline ipsType_smaller' style='display: inline'>
							".$this->__f__2638f6976648c4be3cb61834810a5a57($results,$sortDropDown,$sortIn,$pagination,$total,$showing,$search_term,$url_string,$current_key,$removed_search_terms,$limited,$wasLimited,$search_tags)."						</ul>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					") : ("
						<ul class='ipsList_inline ipsType_smaller' style='display: inline'>
							<li class='active'>
		...
		" . ((count($sortDropDown) && count($sortDropDown) >= 5) ? ("<!-- The menu for changing the sort field -->
			<ul id='search_sort_menucontent' class='ipbmenu_content with_checks' style='display: none'>
				" . ((IPSSearchRegistry::get('config.contentTypes') AND is_array( IPSSearchRegistry::get('config.contentTypes') )) ? ("".$this->__f__7a132979d8f44940a69f71907b1bc48b($results,$sortDropDown,$sortIn,$pagination,$total,$showing,$search_term,$url_string,$current_key,$removed_search_terms,$limited,$wasLimited,$search_tags)."				") : ("".$this->__f__697da5b127b89a3cda0c045b994dfc8d($results,$sortDropDown,$sortIn,$pagination,$total,$showing,$search_term,$url_string,$current_key,$removed_search_terms,$limited,$wasLimited,$search_tags)."				")) . "
			</ul>") : ("")) . "
...
function __f__ad85f2008355680a75d25e3d72f834f9($results, $sortDropDown, $sortIn, $pagination, $total, $showing, $search_term, $url_string, $current_key, $removed_search_terms=array(), $limited=0, $wasLimited=false, $search_tags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $this->registry->getApplications() as $app )
...
function __f__80d8dd101818abc32d280e746bd7c340($results, $sortDropDown, $sortIn, $pagination, $total, $showing, $search_term, $url_string, $current_key, $removed_search_terms=array(), $limited=0, $wasLimited=false, $search_tags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $sortIn as $id => $_data )
...
function __f__e9b52bbb68f6627cc11e2b78d44dfab6($results, $sortDropDown, $sortIn, $pagination, $total, $showing, $search_term, $url_string, $current_key, $removed_search_terms=array(), $limited=0, $wasLimited=false, $search_tags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__2638f6976648c4be3cb61834810a5a57($results, $sortDropDown, $sortIn, $pagination, $total, $showing, $search_term, $url_string, $current_key, $removed_search_terms=array(), $limited=0, $wasLimited=false, $search_tags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $sortDropDown as $k => $l )
...
function __f__7a132979d8f44940a69f71907b1bc48b($results, $sortDropDown, $sortIn, $pagination, $total, $showing, $search_term, $url_string, $current_key, $removed_search_terms=array(), $limited=0, $wasLimited=false, $search_tags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $sortDropDown as $k => $l )
...
function __f__697da5b127b89a3cda0c045b994dfc8d($results, $sortDropDown, $sortIn, $pagination, $total, $showing, $search_term, $url_string, $current_key, $removed_search_terms=array(), $limited=0, $wasLimited=false, $search_tags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $sortDropDown as $k => $l )
...
{
$count_57b67f37b8c8c753b294d98700351036 = is_array($this->functionData['searchRowGenericFormat']) ? count($this->functionData['searchRowGenericFormat']) : 0;
$this->functionData['searchRowGenericFormat'][$count_57b67f37b8c8c753b294d98700351036]['r'] = $r;
$this->functionData['searchRowGenericFormat'][$count_57b67f37b8c8c753b294d98700351036]['resultAsTitle'] = $resultAsTitle;
}
$IPBHTML .= "<div class='result_info'>
...
{
$count_51e591d201a43041758d5a08be86b7a0 = is_array($this->functionData['topicPostSearchResultAsForum']) ? count($this->functionData['topicPostSearchResultAsForum']) : 0;
$this->functionData['topicPostSearchResultAsForum'][$count_51e591d201a43041758d5a08be86b7a0]['data'] = $data;
$this->functionData['topicPostSearchResultAsForum'][$count_51e591d201a43041758d5a08be86b7a0]['resultAsTitle'] = $resultAsTitle;
}
...
{
$count_a7c5a4bb1feb4d31fb8dc9813ffb816e = is_array($this->functionData['userPostsView']) ? count($this->functionData['userPostsView']) : 0;
$this->functionData['userPostsView'][$count_a7c5a4bb1feb4d31fb8dc9813ffb816e]['results'] = $results;
$this->functionData['userPostsView'][$count_a7c5a4bb1feb4d31fb8dc9813ffb816e]['pagination'] = $pagination;
$this->functionData['userPostsView'][$count_a7c5a4bb1feb4d31fb8dc9813ffb816e]['total'] = $total;
$this->functionData['userPostsView'][$count_a7c5a4bb1feb4d31fb8dc9813ffb816e]['member'] = $member;
$this->functionData['userPostsView'][$count_a7c5a4bb1feb4d31fb8dc9813ffb816e]['limited'] = $limited;
$this->functionData['userPostsView'][$count_a7c5a4bb1feb4d31fb8dc9813ffb816e]['wasLimited'] = $wasLimited;
$this->functionData['userPostsView'][$count_a7c5a4bb1feb4d31fb8dc9813ffb816e]['beginTime'] = $beginTime;
$this->functionData['userPostsView'][$count_a7c5a4bb1feb4d31fb8dc9813ffb816e]['sortIn'] = $sortIn;
$this->functionData['userPostsView'][$count_a7c5a4bb1feb4d31fb8dc9813ffb816e]['sortDropDown'] = $sortDropDown;
}
		...
		<div class='ipsBox'>
			<div class='ipsBox_container ipsSideMenu'>
				...
				" . (($this->request['search_app'] == 'forums') ? ("<h4>{$this->lang->words['userposts_morefilters']}</h4>
					...
					<ul>
						".$this->__f__7ed54cbdafa283c12ab99b3c57dcea8f($results,$pagination,$total,$member,$limited,$wasLimited,$beginTime,$sortIn,$sortDropDown)."					</ul>
				") : ("")) . "
			</div>
		</div>
	</div>
	<div class='ipsLayout_content'>
		...
		<div class='maintitle ipsFilterbar'>
			...
			" . ((IPSSearchRegistry::get('config.contentTypes') AND is_array( IPSSearchRegistry::get('config.contentTypes') )) ? ("" . ((count($sortDropDown)) ? ("<span class='ipsType_small'>{$this->lang->words['sort_by']}</span>&nbsp;&nbsp;
					" . ((count($sortDropDown) <= 4) ? ("
						<ul class='ipsList_inline ipsType_smaller' style='display: inline'>
							".$this->__f__63744197433c78288e643f45482d598d($results,$pagination,$total,$member,$limited,$wasLimited,$beginTime,$sortIn,$sortDropDown)."						</ul>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					") : ("
						<ul class='ipsList_inline ipsType_smaller' style='display: inline'>
							<li class='active'>
				...
				<ul class='ipsList_inline ipsType_smaller' style='display: inline'>
					...
					" . ((count($sortDropDown) <= 4) ? ("
						<ul class='ipsList_inline ipsType_smaller' style='display: inline'>
							".$this->__f__0676f8a66df3c5925ca434a05f88c767($results,$pagination,$total,$member,$limited,$wasLimited,$beginTime,$sortIn,$sortDropDown)."						</ul>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					") : ("
						<ul class='ipsList_inline ipsType_smaller' style='display: inline'>
							<li class='active'>
		...
		" . ((count($sortDropDown) && count($sortDropDown) >= 5) ? ("<!-- The menu for changing the sort field -->
			<ul id='search_sort_menucontent' class='ipbmenu_content with_checks' style='display: none'>
				" . ((IPSSearchRegistry::get('config.contentTypes') AND is_array( IPSSearchRegistry::get('config.contentTypes') )) ? ("".$this->__f__fd254f49c625272f478bf72770067615($results,$pagination,$total,$member,$limited,$wasLimited,$beginTime,$sortIn,$sortDropDown)."				") : ("".$this->__f__c619352241289ac9d4ab57b97262d7cc($results,$pagination,$total,$member,$limited,$wasLimited,$beginTime,$sortIn,$sortDropDown)."				")) . "
			</ul>") : ("")) . "
		<div>
			" . (($total) ? ("
				{$results}
...
function __f__3b408808e343456caf29904d37d1713f($results, $pagination, $total, $member, $limited=0, $wasLimited=false, $beginTime=0, $sortIn=null, $sortDropDown=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $this->registry->getApplications() as $app )
...
function __f__7ed54cbdafa283c12ab99b3c57dcea8f($results, $pagination, $total, $member, $limited=0, $wasLimited=false, $beginTime=0, $sortIn=null, $sortDropDown=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $sortIn as $id => $_data )
...
function __f__63744197433c78288e643f45482d598d($results, $pagination, $total, $member, $limited=0, $wasLimited=false, $beginTime=0, $sortIn=null, $sortDropDown=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $sortDropDown as $k => $l )
...
function __f__0676f8a66df3c5925ca434a05f88c767($results, $pagination, $total, $member, $limited=0, $wasLimited=false, $beginTime=0, $sortIn=null, $sortDropDown=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $sortDropDown as $k => $l )
...
function __f__fd254f49c625272f478bf72770067615($results, $pagination, $total, $member, $limited=0, $wasLimited=false, $beginTime=0, $sortIn=null, $sortDropDown=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $sortDropDown as $k => $l )
...
function __f__c619352241289ac9d4ab57b97262d7cc($results, $pagination, $total, $member, $limited=0, $wasLimited=false, $beginTime=0, $sortIn=null, $sortDropDown=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $sortDropDown as $k => $l )
