...
$IPBHTML .= "<div id=\"header_banner\" align=\"right\">" . $this->registry->getClass('pageBuilder')->getBlock('header_banner')  . "
</div>";
return $IPBHTML;
}
...
{
$count_c53d180f546c67ea7b7990b936c0fd5d = is_array($this->functionData['globalTemplate']) ? count($this->functionData['globalTemplate']) : 0;
$this->functionData['globalTemplate'][$count_c53d180f546c67ea7b7990b936c0fd5d]['html'] = $html;
$this->functionData['globalTemplate'][$count_c53d180f546c67ea7b7990b936c0fd5d]['documentHeadItems'] = $documentHeadItems;
$this->functionData['globalTemplate'][$count_c53d180f546c67ea7b7990b936c0fd5d]['css'] = $css;
$this->functionData['globalTemplate'][$count_c53d180f546c67ea7b7990b936c0fd5d]['jsModules'] = $jsModules;
$this->functionData['globalTemplate'][$count_c53d180f546c67ea7b7990b936c0fd5d]['metaTags'] = $metaTags;
$this->functionData['globalTemplate'][$count_c53d180f546c67ea7b7990b936c0fd5d]['header_items'] = $header_items;
$this->functionData['globalTemplate'][$count_c53d180f546c67ea7b7990b936c0fd5d]['items'] = $items;
$this->functionData['globalTemplate'][$count_c53d180f546c67ea7b7990b936c0fd5d]['footer_items'] = $footer_items;
$this->functionData['globalTemplate'][$count_c53d180f546c67ea7b7990b936c0fd5d]['stats'] = $stats;
}
			...
			<div id='primary_nav' class='clearfix'>
					<ul class='ipsList_inline' id='community_app_menu'>
						...
						") : ("" . ((is_array($header_items['applications']) AND count($header_items['applications'])) ? ("
								".$this->__f__463329875719a97625a0116ee3e3f8e9($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."							") : ("")) . "")) . "
			...
			<div id='content' class='clearfix ipsMargin_top'>
				...
				" . ((count( $items['navigation'] )) ? ("<div id='secondary_navigation' class='clearfix'>
						<ol class='breadcrumb top ipsList_inline left'>
								...
								" . (($this->did_first=1) ? ("") : ("")) . "") : ("")) . "
							".$this->__f__5b003f1cc2a0ca340f410d111d6dde0b($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."						</ol>
					</div>") : ("")) . "
				<noscript>
				...
				<ol class='breadcrumb bottom ipsList_inline left clearfix clear'>
					" . ((count( $items['navigation'] )) ? ("						" . ((!$this->settings['remove_forums_nav'] OR ipsRegistry::$current_application == 'forums') ? ("<li><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "act=idx", "public",'' ), "false", "" ) . "'>{$this->settings['board_name']}</a></li>
						...
						".$this->__f__d25263940549cbf25ce2393050a3ff04($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."") : ("
						<li>&nbsp;</li>
					")) . "
							...
							" . ((count($footer_items['skin_chooser']) > 1) ? ("
								<li>
									...
									<ul id='new_skin_menucontent' class='ipbmenu_content with_checks' style='display: none'>
										".$this->__f__3e1ad9b2828e77aa691fd9c17d8726a3($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."									</ul>
								</li>
							") : ("")) . "")) . "") : ("")) . "
					" . ((! $this->member->is_not_human && count( $footer_items['lang_chooser']['options'] ) > 1) ? ("
						<li>
							...
							<ul id='new_language_menucontent' class='ipbmenu_content with_checks' style='display: none'>
								".$this->__f__70d84ab865dd8727c9ba38688e222488($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."							</ul>
						</li>
					...
					" . ((( ! $this->member->is_not_human ) && ( $this->memberData['member_id'] || $this->settings['topic_marking_guests'] )) ? ("
						<li>
							...
							<ul id='mark_all_read_menucontent' class='ipbmenu_content' style='display: none'>
								".$this->__f__e4fd1a7e1af332284d946cd9c32cdc3f($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."								<li>
...
function __f__463329875719a97625a0116ee3e3f8e9($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__5b003f1cc2a0ca340f410d111d6dde0b($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__d25263940549cbf25ce2393050a3ff04($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $items['navigation'] as $idx => $data )
...
function __f__3e1ad9b2828e77aa691fd9c17d8726a3($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__70d84ab865dd8727c9ba38688e222488($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e4fd1a7e1af332284d946cd9c32cdc3f($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_742df33651ac539405278f76d8907249 = is_array($this->functionData['includeCSS']) ? count($this->functionData['includeCSS']) : 0;
$this->functionData['includeCSS'][$count_742df33651ac539405278f76d8907249]['css'] = $css;
}

$this->minify = array();
$IPBHTML .= "" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
	".$this->__f__489bd2a158ad5a08b629219455b4c631($css)."	" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
...
" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
	".$this->__f__946fed221f2c126bd7e15ef0d954c95d($css)."") : ("")) . "<!--hook.if.skin_global.includeCSS.inlinecss.post.endif-->
<!--[if lte IE 7]>
...
function __f__489bd2a158ad5a08b629219455b4c631($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__946fed221f2c126bd7e15ef0d954c95d($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1496ed66a2cd46b8c4aa7e7e79909a05 = is_array($this->functionData['includeFeeds']) ? count($this->functionData['includeFeeds']) : 0;
$this->functionData['includeFeeds'][$count_1496ed66a2cd46b8c4aa7e7e79909a05]['documentHeadItems'] = $documentHeadItems;
}
$IPBHTML .= "" . ((count($documentHeadItems)) ? ("
	".$this->__f__66906e8f115b162d8a7a76c59782af46($documentHeadItems)."") : ("")) . "";
return $IPBHTML;
}


function __f__b851dcb18582063e63e9b3cb045bcc07($documentHeadItems,$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__66906e8f115b162d8a7a76c59782af46($documentHeadItems)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__b851dcb18582063e63e9b3cb045bcc07($documentHeadItems,$type,$idx)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_26d136086788f854f82ae7d4323cea6c = is_array($this->functionData['includeJS']) ? count($this->functionData['includeJS']) : 0;
$this->functionData['includeJS'][$count_26d136086788f854f82ae7d4323cea6c]['jsModules'] = $jsModules;
}
$IPBHTML .= "<!-- replace live domain with dev for testing. not working yet swright 082013-->
<script type=\"text/javascript\" src=\"http://ajax.googleapis.com/ajax/libs/jquery/1.3.2/jquery.min.js\"></script>
<script type=\"text/javascript\" src=\"http://www.bdwforum.com/js/jquery.ba-replacetext.min.js\"></script>
<script type=\"text/javascript\">
$(\"a.bbc_url\").replaceText(/bestdestinationwedding/g, \"bdwforum\" );  
</script>
...
var post_redirect = \"http://www.bdwforum.com/gateway_redirect.php?act=posts&id=\";
...
{
$count_e2d907fc038156fc9cdcc8b6cf0aa631 = is_array($this->functionData['includeMeta']) ? count($this->functionData['includeMeta']) : 0;
$this->functionData['includeMeta'][$count_e2d907fc038156fc9cdcc8b6cf0aa631]['metaTags'] = $metaTags;
}
$IPBHTML .= "<!--hook.if.skin_global.includeMeta.metatags.pre.startif-->" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
	".$this->__f__24c884863b6752429a8bf4ee131be766($metaTags)."") : ("")) . "
<meta property=\"og:image\" content=\"{$this->settings['meta_imagesrc']}\"/>";
return $IPBHTML;
}


function __f__67cd63f189f56ba2f2740b97cc73c5cc($metaTags,$tag='',$id='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__24c884863b6752429a8bf4ee131be766($metaTags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $metaTags as $tag => $id )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__67cd63f189f56ba2f2740b97cc73c5cc($metaTags,$tag,$id)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_2f6b1df4d50add79f03dd617e1932d9c = is_array($this->functionData['includeRTL']) ? count($this->functionData['includeRTL']) : 0;
}

$this->isRtlLang	= false;
$IPBHTML .= "".$this->__f__3100997eede7c45921529d9cd552a160()."" . (($this->isRtlLang AND is_file( DOC_IPS_ROOT_PATH . '/' . PUBLIC_DIRECTORY . '/style_css/' . $this->registry->output->skin['_csscacheid'] . '/ipb_rtl.css' )) ? ("
...
function __f__3100997eede7c45921529d9cd552a160()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1370c1bc40ed9c19ccb25022915a030e = is_array($this->functionData['includeVars']) ? count($this->functionData['includeVars']) : 0;
$this->functionData['includeVars'][$count_1370c1bc40ed9c19ccb25022915a030e]['header_items'] = $header_items;
}
...
{
$count_9a879c85ddb2305fd2e44c2060824124 = is_array($this->functionData['inlineLogin']) ? count($this->functionData['inlineLogin']) : 0;
}
				...
				" . ((IPSLib::loginMethod_enabled('facebook') || IPSLib::loginMethod_enabled('twitter') || IPSLib::loginMethod_enabled('live')) ? ("<div class='ipsBox_notice'>
						<ul class='ipsList_inline'>
							...
							" . ((is_array($this->_formFields) AND count($this->_formFields)) ? ("
								".$this->__f__656bcb3d81a6a5ad16b1bdd6761953d5()."							") : ("")) . "
						</ul>
					</div>") : ("")) . "
				<br />
...
function __f__656bcb3d81a6a5ad16b1bdd6761953d5()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_44483be593936dee12b885e205cb82f6 = is_array($this->functionData['liveEditJs']) ? count($this->functionData['liveEditJs']) : 0;
}
...
<div class='ipsBox ipsPad'>
	...
	<form action='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&module=global&section=meta&do=save", "public",'' ), "", "" ) . "' method='post'>
		...
		<table class='ipb_table'>
			".$this->__f__6f84c07e62f27020e70786e92514b70e($tags,$url)."		</table>
		</div>
		<table class='ipb_table'>
			<tr>
...
function __f__6f84c07e62f27020e70786e92514b70e($tags, $url)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tags as $k => $v )
...
{
$count_48e168313ecd2855c939bb0fe699af7a = is_array($this->functionData['nextPreviousTemplate']) ? count($this->functionData['nextPreviousTemplate']) : 0;
$this->functionData['nextPreviousTemplate'][$count_48e168313ecd2855c939bb0fe699af7a]['data'] = $data;
}
...
{
$count_5f963335899314c38e9a4ffc148b2668 = is_array($this->functionData['paginationTemplate']) ? count($this->functionData['paginationTemplate']) : 0;
$this->functionData['paginationTemplate'][$count_5f963335899314c38e9a4ffc148b2668]['work'] = $work;
$this->functionData['paginationTemplate'][$count_5f963335899314c38e9a4ffc148b2668]['data'] = $data;
}
$IPBHTML .= "" . (($work['pages'] > 1) ? ("<div class='pagination clearfix left " . ((!$data['showNumbers']) ? ("no_numbers") : ("")) . "'>
		...
		<ul class='ipsList_inline left pages'>
			...
			" . ((is_array( $work['_pageNumbers'] ) && count( $work['_pageNumbers'] )) ? ("
				".$this->__f__28bc0e07cd21a001492c4b5e8b3261c0($work,$data)."			") : ("")) . "
		</ul>
...
function __f__28bc0e07cd21a001492c4b5e8b3261c0($work, $data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_4112bf4091a0dbe2e1e7f21c0b074478 = is_array($this->functionData['quickSearch']) ? count($this->functionData['quickSearch']) : 0;
}
		...
		<fieldset>
			...
			<span id='search_wrap' class='right'>
				...
				<ul id='search_options_menucontent' class='ipbmenu_content ipsPad' style='display: none'>
					...
					".$this->__f__8d58d0e6dcc0c65094619371ffba9e64()."				</ul>
...
function __f__8d58d0e6dcc0c65094619371ffba9e64()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_9ea7d752b0b58315bdd36f85cbe70b41 = is_array($this->functionData['shareLinks']) ? count($this->functionData['shareLinks']) : 0;
$this->functionData['shareLinks'][$count_9ea7d752b0b58315bdd36f85cbe70b41]['links'] = $links;
$this->functionData['shareLinks'][$count_9ea7d752b0b58315bdd36f85cbe70b41]['title'] = $title;
$this->functionData['shareLinks'][$count_9ea7d752b0b58315bdd36f85cbe70b41]['url'] = $url;
$this->functionData['shareLinks'][$count_9ea7d752b0b58315bdd36f85cbe70b41]['cssClass'] = $cssClass;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("sharelinks", "0" ) . "
" . ((is_array( $links )) ? ("
	<ul class='{$cssClass} shareButtons ipsList_inline'>
	".$this->__f__0556ea2ea7510faeba2499cd4c760509($links,$title,$url,$cssClass)."	</ul>
	<script type=\"text/javascript\">
...
function __f__0556ea2ea7510faeba2499cd4c760509($links, $title='', $url='', $cssClass='topic_share left')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e7c059aab54d2b5605381c0089b1ac5c = is_array($this->functionData['signature_separator']) ? count($this->functionData['signature_separator']) : 0;
$this->functionData['signature_separator'][$count_e7c059aab54d2b5605381c0089b1ac5c]['sig'] = $sig;
$this->functionData['signature_separator'][$count_e7c059aab54d2b5605381c0089b1ac5c]['author_id'] = $author_id;
$this->functionData['signature_separator'][$count_e7c059aab54d2b5605381c0089b1ac5c]['can_ignore'] = $can_ignore;
}
...
{
$count_c07f6b6960501081b86eba1abd38b46e = is_array($this->functionData['userHoverCard']) ? count($this->functionData['userHoverCard']) : 0;
$this->functionData['userHoverCard'][$count_c07f6b6960501081b86eba1abd38b46e]['member'] = $member;
}
...
{
$count_a517c97eddc4882b5a5fc3b844fdfbb7 = is_array($this->functionData['userInfoPane']) ? count($this->functionData['userInfoPane']) : 0;
$this->functionData['userInfoPane'][$count_a517c97eddc4882b5a5fc3b844fdfbb7]['author'] = $author;
$this->functionData['userInfoPane'][$count_a517c97eddc4882b5a5fc3b844fdfbb7]['contentid'] = $contentid;
$this->functionData['userInfoPane'][$count_a517c97eddc4882b5a5fc3b844fdfbb7]['options'] = $options;
}
$IPBHTML .= "<div itemscope itemtype=\"http://schema.org/Person\" class='user_details'>
	...
	<!--hook.if.skin_global.userInfoPane.authorcfields.pre.startif-->" . (($author['custom_fields'] != "") ? ("
		<ul class='custom_fields'>
			".$this->__f__a1e02af62738cbf2763c19f4e06ce85b($author,$contentid,$options)."		</ul>
	") : ("")) . "
...
function __f__327fa96b666399716eb84d55df1377d1($author, $contentid, $options,$group='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a1e02af62738cbf2763c19f4e06ce85b($author, $contentid, $options)
{
	...
	foreach( $author['custom_fields'] as $group => $data )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__327fa96b666399716eb84d55df1377d1($author,$contentid,$options,$group,$data)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_cf46c6b1701dc74bc47a9228ad2e6dbb = is_array($this->functionData['userSmallPhoto']) ? count($this->functionData['userSmallPhoto']) : 0;
$this->functionData['userSmallPhoto'][$count_cf46c6b1701dc74bc47a9228ad2e6dbb]['member'] = $member;
}
...
{
$count_6ca05d24a2797972e0bbc53f80468e80 = is_array($this->functionData['warnDetails']) ? count($this->functionData['warnDetails']) : 0;
$this->functionData['warnDetails'][$count_6ca05d24a2797972e0bbc53f80468e80]['warning'] = $warning;
$this->functionData['warnDetails'][$count_6ca05d24a2797972e0bbc53f80468e80]['canSeeModNote'] = $canSeeModNote;
}
...
<div class='ipsBox'>
	<p class='message unspecific'>
		...
		") : ("" . (($warning['wl_points']) ? ("" . (($warning['wl_expire']) ? ("" . (($warning['wl_expire_date']) ? ("
				...
				")) . "") : ("")) . "
			".$this->__f__473eb818c09897366af1af9234ec676e($warning,$canSeeModNote)."")) . "
	</p>
...
function __f__473eb818c09897366af1af9234ec676e($warning, $canSeeModNote)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
