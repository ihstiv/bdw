...
{
$count_2e31476731712a49c9584f0e9849ccd2 = is_array($this->functionData['attachiFrameUpload']) ? count($this->functionData['attachiFrameUpload']) : 0;
$this->functionData['attachiFrameUpload'][$count_2e31476731712a49c9584f0e9849ccd2]['id'] = $id;
$this->functionData['attachiFrameUpload'][$count_2e31476731712a49c9584f0e9849ccd2]['JSON'] = $JSON;
}
$IPBHTML .= "<html>
	<head>
		<style type=\"text/css\">
...
{
$count_ad36c43128df5179714d13f6ad730a9d = is_array($this->functionData['editImageForm']) ? count($this->functionData['editImageForm']) : 0;
$this->functionData['editImageForm'][$count_ad36c43128df5179714d13f6ad730a9d]['image'] = $image;
$this->functionData['editImageForm'][$count_ad36c43128df5179714d13f6ad730a9d]['album'] = $album;
$this->functionData['editImageForm'][$count_ad36c43128df5179714d13f6ad730a9d]['category'] = $category;
$this->functionData['editImageForm'][$count_ad36c43128df5179714d13f6ad730a9d]['errors'] = $errors;
$this->functionData['editImageForm'][$count_ad36c43128df5179714d13f6ad730a9d]['preview'] = $preview;
}
...
{
$count_c77f1338cbaf073fd37f896354fa408d = is_array($this->functionData['review']) ? count($this->functionData['review']) : 0;
$this->functionData['review'][$count_c77f1338cbaf073fd37f896354fa408d]['images'] = $images;
$this->functionData['review'][$count_c77f1338cbaf073fd37f896354fa408d]['album'] = $album;
$this->functionData['review'][$count_c77f1338cbaf073fd37f896354fa408d]['category'] = $category;
$this->functionData['review'][$count_c77f1338cbaf073fd37f896354fa408d]['type'] = $type;
$this->functionData['review'][$count_c77f1338cbaf073fd37f896354fa408d]['opts'] = $opts;
}
...
<form method=\"post\" id='postingform' action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=gallery&amp;module=images&amp;section=review&amp;do=process", "public",'' ), "", "" ) . "\">
							...
							<li class='ipsField ipsField_select'>
								...
								<div class='ipsField_content'>
									<select name='album_category_id' id='album_category_id'>
										".$this->__f__1d7f7dbb8a9c7752de002bceb78e2a4a($images,$album,$category,$type,$opts)."									</select>
								</div>
							<li>
							<li class='ipsField'>
							...
							<li class='ipsField ipsField_select'>
								...
								<div class='ipsField_content'>
									<select name=\"album_sort_options__key\"" . ((!$album['_catDefaults']['album_sort_edit']) ? (" disabled='disabled'") : ("")) . ">
										".$this->__f__c95a01f80b51c750eaf98ab35ef769e2($images,$album,$category,$type,$opts)."									</select>
									<select name=\"album_sort_options__dir\"" . ((!$album['_catDefaults']['album_sort_edit']) ? (" disabled='disabled'") : ("")) . ">
										".$this->__f__58c31cd84228dd7a28a34e8985dddf3b($images,$album,$category,$type,$opts)."									</select>
								</div>
							<li>
	...
	" . ((is_array($images) && count($images)) ? ("<br />
		<div class='ipsBox'>
			".$this->__f__82e241d812eac314b12e59ded9df5f66($images,$album,$category,$type,$opts)."		</div>
...
function __f__1d7f7dbb8a9c7752de002bceb78e2a4a($images, $album, $category, $type, $opts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__c95a01f80b51c750eaf98ab35ef769e2($images, $album, $category, $type, $opts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__58c31cd84228dd7a28a34e8985dddf3b($images, $album, $category, $type, $opts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__82e241d812eac314b12e59ded9df5f66($images, $album, $category, $type, $opts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_162c9817ece4c93421f2ed64dcd0fb2f = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_162c9817ece4c93421f2ed64dcd0fb2f]['sessionKey'] = $sessionKey;
$this->functionData['uploadForm'][$count_162c9817ece4c93421f2ed64dcd0fb2f]['album'] = $album;
$this->functionData['uploadForm'][$count_162c9817ece4c93421f2ed64dcd0fb2f]['category'] = $category;
$this->functionData['uploadForm'][$count_162c9817ece4c93421f2ed64dcd0fb2f]['categories'] = $categories;
$this->functionData['uploadForm'][$count_162c9817ece4c93421f2ed64dcd0fb2f]['stats'] = $stats;
$this->functionData['uploadForm'][$count_162c9817ece4c93421f2ed64dcd0fb2f]['allowed_file_types'] = $allowed_file_types;
}
...
<div id='categorySelectorContent' style='display:none'>
	...
	<div class='ipsPad_double'>
		<table class='ipb_table' style=\"table-layout: auto;\">
			".$this->__f__7c2aa8bbd862e9754c1b07143905aa74($sessionKey,$album,$category,$categories,$stats,$allowed_file_types)."		</table>
	</div>
</div>
<script type='text/javascript'>
//<![CDATA[
...
function __f__7c2aa8bbd862e9754c1b07143905aa74($sessionKey='', $album=array(), $category=array(), $categories=array(), $stats=array(), $allowed_file_types='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
