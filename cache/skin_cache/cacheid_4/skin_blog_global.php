...
{
$count_1417234166c675cca290e7488b9bd284 = is_array($this->functionData['blog_header']) ? count($this->functionData['blog_header']) : 0;
$this->functionData['blog_header'][$count_1417234166c675cca290e7488b9bd284]['blog'] = $blog;
$this->functionData['blog_header'][$count_1417234166c675cca290e7488b9bd284]['cblock_control'] = $cblock_control;
$this->functionData['blog_header'][$count_1417234166c675cca290e7488b9bd284]['theme_js'] = $theme_js;
$this->functionData['blog_header'][$count_1417234166c675cca290e7488b9bd284]['header_js'] = $header_js;
$this->functionData['blog_header'][$count_1417234166c675cca290e7488b9bd284]['title'] = $title;
$this->functionData['blog_header'][$count_1417234166c675cca290e7488b9bd284]['headerButtons'] = $headerButtons;
}
...
{
$count_c3a0c75d1b34b3d629fb39078cbef38f = is_array($this->functionData['catsAsList']) ? count($this->functionData['catsAsList']) : 0;
$this->functionData['catsAsList'][$count_c3a0c75d1b34b3d629fb39078cbef38f]['blogId'] = $blogId;
$this->functionData['catsAsList'][$count_c3a0c75d1b34b3d629fb39078cbef38f]['categories'] = $categories;
}
...
$IPBHTML .= "" . ((is_array( $categories ) && count( $categories ) && !(count($categories) == 1 && array_key_exists(0, $categories))) ? ("
	...
	".$this->__f__8f1addf17550df2c4fea3e634b742f23($blogId,$categories)."") : ("")) . "";
return $IPBHTML;
}


function __f__8f1addf17550df2c4fea3e634b742f23($blogId, $categories)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
$IPBHTML .= "<ul class=\"ipbmenu_content\" id='content_blocks_menucontent' style='display: none'>
	...
	") : ("")) . "" . ((is_array( $cblocks ) && count( $cblocks )) ? ("".$this->__f__0a12e577207efb6ae4b5be5fed716a23($cblocks)."	") : ("")) . "
</ul>
<script type='text/javascript'>
...
function __f__0a12e577207efb6ae4b5be5fed716a23($cblocks)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_9a239f909be3cd1d8a4779719262dd11 = is_array($this->functionData['contextSearch']) ? count($this->functionData['contextSearch']) : 0;
}
...
{
$count_adbf6e0eac7c6e6adf4d852ff685e127 = is_array($this->functionData['hookTagCloud']) ? count($this->functionData['hookTagCloud']) : 0;
$this->functionData['hookTagCloud'][$count_adbf6e0eac7c6e6adf4d852ff685e127]['tags'] = $tags;
}
$IPBHTML .= "<ul class='ipsList_inline'>".$this->__f__088b9b929d5501744d4b66d8b013ed53($tags)."</ul>";
return $IPBHTML;
}


function __f__088b9b929d5501744d4b66d8b013ed53($tags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1a5976953155c3661f7767c9b770c8f4 = is_array($this->functionData['overwriteHeader']) ? count($this->functionData['overwriteHeader']) : 0;
}
...
{
$count_6da35965396aef4a7059fa4d8b6ded49 = is_array($this->functionData['short_img_tag']) ? count($this->functionData['short_img_tag']) : 0;
$this->functionData['short_img_tag'][$count_6da35965396aef4a7059fa4d8b6ded49]['matches'] = $matches;
}
...
{
$count_1008cc4b29c89651350c84e925e80abf = is_array($this->functionData['short_media_tag']) ? count($this->functionData['short_media_tag']) : 0;
$this->functionData['short_media_tag'][$count_1008cc4b29c89651350c84e925e80abf]['url'] = $url;
$this->functionData['short_media_tag'][$count_1008cc4b29c89651350c84e925e80abf]['type'] = $type;
}
...
{
$count_0997478056830dcc95200a3d74e63db8 = is_array($this->functionData['theme_menu']) ? count($this->functionData['theme_menu']) : 0;
$this->functionData['theme_menu'][$count_0997478056830dcc95200a3d74e63db8]['themes'] = $themes;
$this->functionData['theme_menu'][$count_0997478056830dcc95200a3d74e63db8]['blog'] = $blog;
$this->functionData['theme_menu'][$count_0997478056830dcc95200a3d74e63db8]['_customTheme'] = $_customTheme;
}
$IPBHTML .= "<ul class='ipbmenu_content' id='themes_menu_menucontent' style='display: none'>
	" . (($this->settings['blog_themes_custom'] OR (is_array($themes) AND count($themes))) ? ("" . (($this->settings['blog_themes_custom']) ? ("
		...
		") : ("")) . "" . ((is_array( $themes ) && count( $themes )) ? ("".$this->__f__059a15f892220dd45eacd12b36f76ce0($themes,$blog,$_customTheme)."		") : ("")) . "
...
function __f__059a15f892220dd45eacd12b36f76ce0($themes, $blog, $_customTheme='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
