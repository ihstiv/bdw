...
{
$count_d2602a42ea9cc28dfccd7f1993bf64e9 = is_array($this->functionData['acknowledgeWarning']) ? count($this->functionData['acknowledgeWarning']) : 0;
$this->functionData['acknowledgeWarning'][$count_d2602a42ea9cc28dfccd7f1993bf64e9]['warning'] = $warning;
}
	...
	<div class='ipsBox'>
		...
		<div class='ipsBox_container ipsPad'>
			...
			") : ("" . (($warning['wl_points']) ? ("" . (($warning['wl_expire']) ? ("" . (($warning['wl_expire_date']) ? ("
					...
					")) . "") : ("")) . "
				".$this->__f__f337aad467e846e47bed8881faa1ccf4($warning)."")) . "
		</div>
	</div>
...
function __f__f337aad467e846e47bed8881faa1ccf4($warning)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e76f72542cc472aaecf366bba53106e8 = is_array($this->functionData['addWarning']) ? count($this->functionData['addWarning']) : 0;
$this->functionData['addWarning'][$count_e76f72542cc472aaecf366bba53106e8]['member'] = $member;
$this->functionData['addWarning'][$count_e76f72542cc472aaecf366bba53106e8]['reasons'] = $reasons;
$this->functionData['addWarning'][$count_e76f72542cc472aaecf366bba53106e8]['errors'] = $errors;
$this->functionData['addWarning'][$count_e76f72542cc472aaecf366bba53106e8]['editor'] = $editor;
$this->functionData['addWarning'][$count_e76f72542cc472aaecf366bba53106e8]['currentPunishments'] = $currentPunishments;
}
			...
			<ul class='ipsForm ipsForm_vertical'>
				<li class='ipsField ipsField_select'>
					...
					<div class='ipsField_content'>
						<select name='reason' id='reason-select'>
							...
							".$this->__f__e999c991cb591f48d288fc2b999ac95a($member,$reasons,$errors,$editor,$currentPunishments)."							" . (($this->settings['warnings_enable_other'] or $this->memberData['g_access_cp']) ? ("
				...
				<li class='ipsField' style='display:none' id='suspend_li'>
					...
					<div class='ipsField_content'>
						...
						".$this->__f__3bb2d2f7506f7c4fdbaf9fe036b7868c($member,$reasons,$errors,$editor,$currentPunishments)."						</select>
					</div>
				</li>
...
function __f__e999c991cb591f48d288fc2b999ac95a($member, $reasons, $errors, $editor, $currentPunishments)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__3bb2d2f7506f7c4fdbaf9fe036b7868c($member, $reasons, $errors, $editor, $currentPunishments)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_4f665beaffaa12d31bef46f86e421611 = is_array($this->functionData['customField__gender']) ? count($this->functionData['customField__gender']) : 0;
$this->functionData['customField__gender'][$count_4f665beaffaa12d31bef46f86e421611]['f'] = $f;
}
...
{
$count_a84581c4dc5492876ab69afcfc06a0be = is_array($this->functionData['customField__generic']) ? count($this->functionData['customField__generic']) : 0;
$this->functionData['customField__generic'][$count_a84581c4dc5492876ab69afcfc06a0be]['f'] = $f;
}
...
{
$count_ed67503e4d457b327a05d23866314d68 = is_array($this->functionData['customFieldGroup__contact']) ? count($this->functionData['customFieldGroup__contact']) : 0;
$this->functionData['customFieldGroup__contact'][$count_ed67503e4d457b327a05d23866314d68]['f'] = $f;
}
$IPBHTML .= "" . (($f->parsed) ? ("<li>
	...
	<span class='row_data'>
		...
		" . ((is_array( $f->parsed )) ? ("
			".$this->__f__df9fcb084527599478d41a473d21fea6($f)."		") : ("" . (($f->raw_data['pf_key'] == 'aim') ? ("
...
function __f__df9fcb084527599478d41a473d21fea6($f)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_d277acdfc2e61bf8d1250c5296a28391 = is_array($this->functionData['customizeProfile']) ? count($this->functionData['customizeProfile']) : 0;
$this->functionData['customizeProfile'][$count_d277acdfc2e61bf8d1250c5296a28391]['member'] = $member;
}
...
{
$count_ed67bf7c6bad248e8dcbda36eaeee5ab = is_array($this->functionData['dnameWrapper']) ? count($this->functionData['dnameWrapper']) : 0;
$this->functionData['dnameWrapper'][$count_ed67bf7c6bad248e8dcbda36eaeee5ab]['member_name'] = $member_name;
$this->functionData['dnameWrapper'][$count_ed67bf7c6bad248e8dcbda36eaeee5ab]['records'] = $records;
}
...
<table class='ipb_table'>
	...
	" . ((is_array($records) AND count($records)) ? ("
		    	".$this->__f__ae8beab01d662bd3d033e26354bad403($member_name,$records)."	") : ("
		<tr>
...
function __f__ae8beab01d662bd3d033e26354bad403($member_name="",$records=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_cc0aa58ebf416b309d78b83c5e7fc17d = is_array($this->functionData['explainPoints']) ? count($this->functionData['explainPoints']) : 0;
$this->functionData['explainPoints'][$count_cc0aa58ebf416b309d78b83c5e7fc17d]['reasons'] = $reasons;
$this->functionData['explainPoints'][$count_cc0aa58ebf416b309d78b83c5e7fc17d]['actions'] = $actions;
}
...
<table class='ipb_table'>
	...
	".$this->__f__5375bc4e858bf7cf86ef23e329689441($reasons,$actions)."</table>
" . ((!empty( $actions )) ? ("
	<div class='ipsPad'>
	...
	<table class='ipb_table'>
		...
		".$this->__f__f6c5792ffb04656e70e63abca76b4514($reasons,$actions)."	</table>
") : ("")) . "";
return $IPBHTML;
}


function __f__5375bc4e858bf7cf86ef23e329689441($reasons, $actions)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $reasons as $r )
...
function __f__3d76028ddfae0e0f03caba153c11d139($reasons, $actions,$a='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( array( 'mq', 'rpa', 'suspend' ) as $k )
...
function __f__f6c5792ffb04656e70e63abca76b4514($reasons, $actions)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $actions as $a )
	{
		...
		$_ips___x_retval .= "
			<tr>
				<td>{$a['wa_points']}</td>
				<td>
					".$this->__f__3d76028ddfae0e0f03caba153c11d139($reasons,$actions,$a)."				</td>
			</tr>
...
{
$count_6432fa82e930e13ad2c66671d60e9e5f = is_array($this->functionData['friendsList']) ? count($this->functionData['friendsList']) : 0;
$this->functionData['friendsList'][$count_6432fa82e930e13ad2c66671d60e9e5f]['friends'] = $friends;
$this->functionData['friendsList'][$count_6432fa82e930e13ad2c66671d60e9e5f]['pages'] = $pages;
}
...
" . ((is_array($friends) and count($friends) && $this->settings['friends_enabled']) ? ("
		...
		".$this->__f__0c847596943fc1bbf29444084e934f72($friends,$pages)."	</ul>
") : ("<p class='no_messages'>
		" . (($this->request['tab'] == 'pending') ? ("
...
function __f__0c847596943fc1bbf29444084e934f72($friends, $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_010ea3a3df58e7dc18deae5e09ada152 = is_array($this->functionData['listWarnings']) ? count($this->functionData['listWarnings']) : 0;
$this->functionData['listWarnings'][$count_010ea3a3df58e7dc18deae5e09ada152]['member'] = $member;
$this->functionData['listWarnings'][$count_010ea3a3df58e7dc18deae5e09ada152]['warnings'] = $warnings;
$this->functionData['listWarnings'][$count_010ea3a3df58e7dc18deae5e09ada152]['pagination'] = $pagination;
$this->functionData['listWarnings'][$count_010ea3a3df58e7dc18deae5e09ada152]['reasons'] = $reasons;
$this->functionData['listWarnings'][$count_010ea3a3df58e7dc18deae5e09ada152]['canWarn'] = $canWarn;
}
	...
	<div class='ipsBox'>
		<div class='ipsBox_container'>
			<table class='ipb_table'>
				...
				<tbody>
					".$this->__f__ba8a772ade2f4157af0265165c626fc1($member,$warnings,$pagination,$reasons,$canWarn)."				</tbody>
			</table>
		</div>
	</div>
")) . "
...
function __f__ba8a772ade2f4157af0265165c626fc1($member, $warnings, $pagination, $reasons, $canWarn)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_226fe01b6b4fe474410b7691a21ad1b5 = is_array($this->functionData['photoEditor']) ? count($this->functionData['photoEditor']) : 0;
$this->functionData['photoEditor'][$count_226fe01b6b4fe474410b7691a21ad1b5]['data'] = $data;
$this->functionData['photoEditor'][$count_226fe01b6b4fe474410b7691a21ad1b5]['member'] = $member;
}
...
{
$count_e230f4550831aaf2972a9bc7d30d4a7d = is_array($this->functionData['profileModern']) ? count($this->functionData['profileModern']) : 0;
$this->functionData['profileModern'][$count_e230f4550831aaf2972a9bc7d30d4a7d]['tabs'] = $tabs;
$this->functionData['profileModern'][$count_e230f4550831aaf2972a9bc7d30d4a7d]['member'] = $member;
$this->functionData['profileModern'][$count_e230f4550831aaf2972a9bc7d30d4a7d]['visitors'] = $visitors;
$this->functionData['profileModern'][$count_e230f4550831aaf2972a9bc7d30d4a7d]['default_tab'] = $default_tab;
$this->functionData['profileModern'][$count_e230f4550831aaf2972a9bc7d30d4a7d]['default_tab_content'] = $default_tab_content;
$this->functionData['profileModern'][$count_e230f4550831aaf2972a9bc7d30d4a7d]['friends'] = $friends;
$this->functionData['profileModern'][$count_e230f4550831aaf2972a9bc7d30d4a7d]['status'] = $status;
$this->functionData['profileModern'][$count_e230f4550831aaf2972a9bc7d30d4a7d]['warns'] = $warns;
$this->functionData['profileModern'][$count_e230f4550831aaf2972a9bc7d30d4a7d]['show_contact'] = $show_contact;
}
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left' id='profile_tabs'>
			...
			<ul class='clear'>
				...
				".$this->__f__b67f7ea1b18f07801fe9683d17635053($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status,$warns,$show_contact)."			</ul>
		</div>
			...
			<div class='ipsPad'>
				<div id='profile_content_main'>
					<div id='user_info_cell'>
						...
						" . ((!empty( $warns )) ? ("
							".$this->__f__ebd5779e75ae194acb37b6355e41867b($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status,$warns,$show_contact)."						") : ("")) . "
							...
							<div class='general_box clearfix'>
								...
								<ul class='ipsList_data clearfix'>
									...
									<!--hook.if.skin_profile.profileModern.pcfields.pre.startif-->" . (($member['custom_fields']['profile_info'] != "") ? ("
										".$this->__f__25cadf37b99c0bece3a7226f44cc4fae($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status,$warns,$show_contact)."									") : ("")) . "
								</ul>
								<br />
							</div>
							
							" . (($member['custom_fields']) ? ("
								".$this->__f__42bddd2fac419bbab03650f419ed82fb($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status,$warns,$show_contact)."							") : ("")) . "
								...
								") : ("")) . "
									<ul class='ipsList_data clearfix'>
										...
										" . ((is_array( $member['custom_fields']['contact'])) ? ("
											".$this->__f__ef525d3e957a1571eb899087a55e2791($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status,$warns,$show_contact)."										") : ("")) . "
									</ul>
								</div>") : ("")) . "
						</div>
							...
							" . (($member['pp_setting_count_friends'] and $this->settings['friends_enabled']) ? ("<div class='general_box clearfix' id='friends_overview'>
									...
									<div class='ipsPad'>
										" . ((count($friends) AND is_array($friends)) ? ("
											".$this->__f__b80eff8481360483ae209a0de03f912e($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status,$warns,$show_contact)."										") : ("
											<p class='desc'>
							...
							" . (($member['pp_setting_count_visitors']) ? ("<div class='general_box clearfix'>
									...
									" . ((is_array( $visitors ) && count( $visitors )) ? ("
										<ul class='ipsList_withminiphoto ipsPad'>
											".$this->__f__471cae2f13cb32d31fd22cf3d9f6a291($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status,$warns,$show_contact)."										</ul>
									") : ("
...
function __f__b67f7ea1b18f07801fe9683d17635053($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array(), $warns=array(), $show_contact='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tabs as $tab )
...
function __f__ebd5779e75ae194acb37b6355e41867b($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array(), $warns=array(), $show_contact='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__25cadf37b99c0bece3a7226f44cc4fae($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array(), $warns=array(), $show_contact='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__8a6a70329f30715565c29624b1f41444($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array(), $warns=array(), $show_contact='',$group='',$mdata='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__42bddd2fac419bbab03650f419ed82fb($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array(), $warns=array(), $show_contact='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		$_ips___x_retval .= "
									" . (($group != 'profile_info' AND $group != 'contact') ? ("" . ((is_array( $member['custom_fields'][ $group ] ) AND count( $member['custom_fields'][ $group ] )) ? ("
											<div class='general_box clearfix' id='custom_fields_{$group}'>
												...
												<br />
												<ul class='ipsList_data clearfix'>
													".$this->__f__8a6a70329f30715565c29624b1f41444($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status,$warns,$show_contact,$group,$mdata)."												</ul>
												<br />
											</div>
										") : ("")) . "") : ("")) . "
...
function __f__ef525d3e957a1571eb899087a55e2791($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array(), $warns=array(), $show_contact='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b80eff8481360483ae209a0de03f912e($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array(), $warns=array(), $show_contact='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $friends as $friend )
...
function __f__471cae2f13cb32d31fd22cf3d9f6a291($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array(), $warns=array(), $show_contact='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_8fe8a1e52c0bbde45011310c3d438a2d = is_array($this->functionData['reputationPage']) ? count($this->functionData['reputationPage']) : 0;
$this->functionData['reputationPage'][$count_8fe8a1e52c0bbde45011310c3d438a2d]['langBit'] = $langBit;
$this->functionData['reputationPage'][$count_8fe8a1e52c0bbde45011310c3d438a2d]['currentApp'] = $currentApp;
$this->functionData['reputationPage'][$count_8fe8a1e52c0bbde45011310c3d438a2d]['supportedApps'] = $supportedApps;
$this->functionData['reputationPage'][$count_8fe8a1e52c0bbde45011310c3d438a2d]['processedResults'] = $processedResults;
}
	...
	" . ((count( $supportedApps ) > 1) ? ("
		<div class='maintitle ipsFilterbar clearfix'>
			<ul class='ipsList_inline ipsType_smaller left'>
				".$this->__f__78bf0ac837813d6e6ed4e8fe94cce525($langBit,$currentApp,$supportedApps,$processedResults)."			</ul>
		</div>
	") : ("")) . "
	" . (($processedResults) ? ("
		{$processedResults}
...
function __f__78bf0ac837813d6e6ed4e8fe94cce525($langBit, $currentApp='', $supportedApps=array(), $processedResults='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ddd041bc6063c2c975bf0b8fdcd810bf = is_array($this->functionData['showCard']) ? count($this->functionData['showCard']) : 0;
$this->functionData['showCard'][$count_ddd041bc6063c2c975bf0b8fdcd810bf]['member'] = $member;
$this->functionData['showCard'][$count_ddd041bc6063c2c975bf0b8fdcd810bf]['download'] = $download;
}
...
{
$count_4bd182fae7a9177b4c8509bfced6194c = is_array($this->functionData['statusReplies']) ? count($this->functionData['statusReplies']) : 0;
$this->functionData['statusReplies'][$count_4bd182fae7a9177b4c8509bfced6194c]['replies'] = $replies;
$this->functionData['statusReplies'][$count_4bd182fae7a9177b4c8509bfced6194c]['no_wrapper'] = $no_wrapper;
}
$IPBHTML .= "" . ((!$no_wrapper) ? ("
	<ul class='ipsList_withtinyphoto clear'>
") : ("")) . "".$this->__f__43b335a0e8eda0420f9f53d35ce959ba($replies,$no_wrapper)."" . ((!$no_wrapper) ? ("
	</ul>
") : ("")) . "";
return $IPBHTML;
}
...
function __f__43b335a0e8eda0420f9f53d35ce959ba($replies=array(), $no_wrapper=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_32838b07273cf1b7f68e32640006bcfb = is_array($this->functionData['statusUpdates']) ? count($this->functionData['statusUpdates']) : 0;
$this->functionData['statusUpdates'][$count_32838b07273cf1b7f68e32640006bcfb]['updates'] = $updates;
$this->functionData['statusUpdates'][$count_32838b07273cf1b7f68e32640006bcfb]['smallSpace'] = $smallSpace;
$this->functionData['statusUpdates'][$count_32838b07273cf1b7f68e32640006bcfb]['latestOnly'] = $latestOnly;
}
$IPBHTML .= "".$this->__f__375a9a87006871957c15d35fa28803e0($updates,$smallSpace,$latestOnly)."";
return $IPBHTML;
}


function __f__375a9a87006871957c15d35fa28803e0($updates=array(), $smallSpace=0, $latestOnly=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_7c4c38087ee59f8581f34d0177dcf4d7 = is_array($this->functionData['statusUpdatesPage']) ? count($this->functionData['statusUpdatesPage']) : 0;
$this->functionData['statusUpdatesPage'][$count_7c4c38087ee59f8581f34d0177dcf4d7]['updates'] = $updates;
$this->functionData['statusUpdatesPage'][$count_7c4c38087ee59f8581f34d0177dcf4d7]['pages'] = $pages;
}
...
{
$count_9b6c34149a0e0a600ca944bd6f2d123a = is_array($this->functionData['tabFriends']) ? count($this->functionData['tabFriends']) : 0;
$this->functionData['tabFriends'][$count_9b6c34149a0e0a600ca944bd6f2d123a]['friends'] = $friends;
$this->functionData['tabFriends'][$count_9b6c34149a0e0a600ca944bd6f2d123a]['member'] = $member;
$this->functionData['tabFriends'][$count_9b6c34149a0e0a600ca944bd6f2d123a]['pagination'] = $pagination;
}
$IPBHTML .= "<div class='general_box'>
	" . (($this->settings['friends_enabled'] AND $this->memberData['g_can_add_friends'] AND $member['pp_setting_count_friends']) ? ("<div class='friend_list clear' id='friend_list'>
			...
			" . ((is_array($friends) and count($friends)) ? ("
				<ul class='clearfix'>
				".$this->__f__d996472845c92a4aa902841c58cd3aa2($friends,$member,$pagination)."				</ul>
			") : ("
				<p>
...
function __f__d996472845c92a4aa902841c58cd3aa2($friends=array(), $member=array(), $pagination='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $friends as $friend )
...
{
$count_ef61e28dff3d3dc3a6e15410fd1b43b9 = is_array($this->functionData['tabReputation']) ? count($this->functionData['tabReputation']) : 0;
$this->functionData['tabReputation'][$count_ef61e28dff3d3dc3a6e15410fd1b43b9]['member'] = $member;
$this->functionData['tabReputation'][$count_ef61e28dff3d3dc3a6e15410fd1b43b9]['currentApp'] = $currentApp;
$this->functionData['tabReputation'][$count_ef61e28dff3d3dc3a6e15410fd1b43b9]['type'] = $type;
$this->functionData['tabReputation'][$count_ef61e28dff3d3dc3a6e15410fd1b43b9]['supportedApps'] = $supportedApps;
$this->functionData['tabReputation'][$count_ef61e28dff3d3dc3a6e15410fd1b43b9]['processedResults'] = $processedResults;
$this->functionData['tabReputation'][$count_ef61e28dff3d3dc3a6e15410fd1b43b9]['pagination'] = $pagination;
}
$IPBHTML .= "<div class='general_box'>
	<div class='maintitle ipsFilterbar clearfix'>
		" . ((count( $supportedApps ) > 1) ? ("
			<ul class='ipsList_inline ipsType_smaller left'>
				".$this->__f__a309b70c65a3e23022aa077dca9b65d4($member,$currentApp,$type,$supportedApps,$processedResults,$pagination)."			</ul>
		") : ("")) . "
...
function __f__a309b70c65a3e23022aa077dca9b65d4($member, $currentApp='', $type='', $supportedApps=array(), $processedResults='', $pagination='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $supportedApps as $_app )
...
{
$count_2dad443fe7a2a7f805e196b209fc768e = is_array($this->functionData['tabReputation_calendar']) ? count($this->functionData['tabReputation_calendar']) : 0;
$this->functionData['tabReputation_calendar'][$count_2dad443fe7a2a7f805e196b209fc768e]['results'] = $results;
}
$IPBHTML .= "<div class='ipsBox'>
	".$this->__f__9086c0b8dc4b6d84ef1ae86c9a090fbb($results)."</div>";
return $IPBHTML;
}


function __f__9086c0b8dc4b6d84ef1ae86c9a090fbb($results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_c13e11c57e477d5ca0c14af7b1d4589e = is_array($this->functionData['tabReputation_posts']) ? count($this->functionData['tabReputation_posts']) : 0;
$this->functionData['tabReputation_posts'][$count_c13e11c57e477d5ca0c14af7b1d4589e]['results'] = $results;
}
$IPBHTML .= "<div class='ipsBox'>
	".$this->__f__0784b20a66edaca1a1191e8395e472d8($results)."</div>";
return $IPBHTML;
}


function __f__4811c2401cf68172243ab3a92e39247d($results,$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__0784b20a66edaca1a1191e8395e472d8($results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $results as $data )
			...
			<div class='post_wrap'>
				...
				<div class='post_body'>
					<p class='posted_info desc lighter ipsType_small'>
						...
						" . (($data['_forum_trail']) ? ("
							in
							".$this->__f__4811c2401cf68172243ab3a92e39247d($results,$data)."						") : ("")) . "
					</p>
					<div class='post entry-content clearfix'>
						{$data['post']}
						<br />
...
{
$count_f64bf74fc96c03fb6c10838fa7433d44 = is_array($this->functionData['tabSingleColumn']) ? count($this->functionData['tabSingleColumn']) : 0;
$this->functionData['tabSingleColumn'][$count_f64bf74fc96c03fb6c10838fa7433d44]['row'] = $row;
$this->functionData['tabSingleColumn'][$count_f64bf74fc96c03fb6c10838fa7433d44]['read_more_link'] = $read_more_link;
$this->functionData['tabSingleColumn'][$count_f64bf74fc96c03fb6c10838fa7433d44]['url'] = $url;
$this->functionData['tabSingleColumn'][$count_f64bf74fc96c03fb6c10838fa7433d44]['title'] = $title;
}
...
{
$count_d148baf103d02298125a4ffd86cf5e56 = is_array($this->functionData['tabStatusUpdates']) ? count($this->functionData['tabStatusUpdates']) : 0;
$this->functionData['tabStatusUpdates'][$count_d148baf103d02298125a4ffd86cf5e56]['updates'] = $updates;
$this->functionData['tabStatusUpdates'][$count_d148baf103d02298125a4ffd86cf5e56]['actions'] = $actions;
$this->functionData['tabStatusUpdates'][$count_d148baf103d02298125a4ffd86cf5e56]['member'] = $member;
}
