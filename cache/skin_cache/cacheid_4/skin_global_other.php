...
{
$count_b61ef1767663679e28831fc8c145609c = is_array($this->functionData['ajaxPopUpNoPermission']) ? count($this->functionData['ajaxPopUpNoPermission']) : 0;
$this->functionData['ajaxPopUpNoPermission'][$count_b61ef1767663679e28831fc8c145609c]['msg'] = $msg;
}
...
{
$count_c842a2214a7dd8079d25e9e8000a6392 = is_array($this->functionData['displayBoardOffline']) ? count($this->functionData['displayBoardOffline']) : 0;
$this->functionData['displayBoardOffline'][$count_c842a2214a7dd8079d25e9e8000a6392]['message'] = $message;
}
...
{
$count_7c0b36f0a805fe384307e7b44f36b2f8 = is_array($this->functionData['displayPopUpWindow']) ? count($this->functionData['displayPopUpWindow']) : 0;
$this->functionData['displayPopUpWindow'][$count_7c0b36f0a805fe384307e7b44f36b2f8]['documentHeadItems'] = $documentHeadItems;
$this->functionData['displayPopUpWindow'][$count_7c0b36f0a805fe384307e7b44f36b2f8]['css'] = $css;
$this->functionData['displayPopUpWindow'][$count_7c0b36f0a805fe384307e7b44f36b2f8]['jsLoaderItems'] = $jsLoaderItems;
$this->functionData['displayPopUpWindow'][$count_7c0b36f0a805fe384307e7b44f36b2f8]['title'] = $title;
$this->functionData['displayPopUpWindow'][$count_7c0b36f0a805fe384307e7b44f36b2f8]['output'] = $output;
}
...
<html xml:lang=\"en\" lang=\"en\" xmlns=\"http://www.w3.org/1999/xhtml\">
	<head>
		...
		" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
			".$this->__f__b876375d937b7f7357ef52782c4b2f04($documentHeadItems,$css,$jsLoaderItems,$title,$output)."			" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
		...
		" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
			".$this->__f__5dc748e5e38c883fab999e8000b2889b($documentHeadItems,$css,$jsLoaderItems,$title,$output)."		") : ("")) . "
		<!--[if lte IE 7]>
		...
		" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
			".$this->__f__1920214903bbc92b56acc0712c1c7053($documentHeadItems,$css,$jsLoaderItems,$title,$output)."		") : ("")) . "
		<script type='text/javascript'>
		...
		" . ((count($documentHeadItems)) ? ("
			".$this->__f__26bcf9786c52b0152aa8e2c9cbad822f($documentHeadItems,$css,$jsLoaderItems,$title,$output)."		") : ("")) . "
...
function __f__b876375d937b7f7357ef52782c4b2f04($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__5dc748e5e38c883fab999e8000b2889b($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__1920214903bbc92b56acc0712c1c7053($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__da61ffc952a8ef64c089681f06bb0ce0($documentHeadItems, $css, $jsLoaderItems, $title="", $output="",$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__26bcf9786c52b0152aa8e2c9cbad822f($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__da61ffc952a8ef64c089681f06bb0ce0($documentHeadItems,$css,$jsLoaderItems,$title,$output,$type,$idx)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_51991d3528463ba1b44011d8b94989ca = is_array($this->functionData['Error']) ? count($this->functionData['Error']) : 0;
$this->functionData['Error'][$count_51991d3528463ba1b44011d8b94989ca]['message'] = $message;
$this->functionData['Error'][$count_51991d3528463ba1b44011d8b94989ca]['code'] = $code;
$this->functionData['Error'][$count_51991d3528463ba1b44011d8b94989ca]['ad_email_one'] = $ad_email_one;
$this->functionData['Error'][$count_51991d3528463ba1b44011d8b94989ca]['ad_email_two'] = $ad_email_two;
$this->functionData['Error'][$count_51991d3528463ba1b44011d8b94989ca]['title'] = $title;
}
...
{
$count_185a8004308b1b61aa212fa55cf05271 = is_array($this->functionData['facebookPop']) ? count($this->functionData['facebookPop']) : 0;
$this->functionData['facebookPop'][$count_185a8004308b1b61aa212fa55cf05271]['user'] = $user;
}
...
{
$count_a76c70113df226ed36ed35b9a5a9bcdb = is_array($this->functionData['generateTopicIcon']) ? count($this->functionData['generateTopicIcon']) : 0;
$this->functionData['generateTopicIcon'][$count_a76c70113df226ed36ed35b9a5a9bcdb]['imgArray'] = $imgArray;
$this->functionData['generateTopicIcon'][$count_a76c70113df226ed36ed35b9a5a9bcdb]['unreadUrl'] = $unreadUrl;
}
...
{
$count_bc740770e1249560af4e953840c3c40f = is_array($this->functionData['globalTemplateMinimal']) ? count($this->functionData['globalTemplateMinimal']) : 0;
$this->functionData['globalTemplateMinimal'][$count_bc740770e1249560af4e953840c3c40f]['html'] = $html;
$this->functionData['globalTemplateMinimal'][$count_bc740770e1249560af4e953840c3c40f]['documentHeadItems'] = $documentHeadItems;
$this->functionData['globalTemplateMinimal'][$count_bc740770e1249560af4e953840c3c40f]['css'] = $css;
$this->functionData['globalTemplateMinimal'][$count_bc740770e1249560af4e953840c3c40f]['jsModules'] = $jsModules;
$this->functionData['globalTemplateMinimal'][$count_bc740770e1249560af4e953840c3c40f]['metaTags'] = $metaTags;
$this->functionData['globalTemplateMinimal'][$count_bc740770e1249560af4e953840c3c40f]['header_items'] = $header_items;
$this->functionData['globalTemplateMinimal'][$count_bc740770e1249560af4e953840c3c40f]['items'] = $items;
$this->functionData['globalTemplateMinimal'][$count_bc740770e1249560af4e953840c3c40f]['footer_items'] = $footer_items;
$this->functionData['globalTemplateMinimal'][$count_bc740770e1249560af4e953840c3c40f]['stats'] = $stats;
}
...
{
$count_84d33cc74f1e1b5221637a1c170513d9 = is_array($this->functionData['inboxList']) ? count($this->functionData['inboxList']) : 0;
$this->functionData['inboxList'][$count_84d33cc74f1e1b5221637a1c170513d9]['topics'] = $topics;
}
...
<ul class='ipsList_withminiphoto'>
	" . ((count($topics)) ? ("
		".$this->__f__d7eeb9d25c4eaae706da3997f14aa9ab($topics)."	") : ("
...
function __f__d7eeb9d25c4eaae706da3997f14aa9ab($topics)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1af5c1388eb4bd418fdc91d169c2193c = is_array($this->functionData['likeMoreDialogue']) ? count($this->functionData['likeMoreDialogue']) : 0;
$this->functionData['likeMoreDialogue'][$count_1af5c1388eb4bd418fdc91d169c2193c]['data'] = $data;
$this->functionData['likeMoreDialogue'][$count_1af5c1388eb4bd418fdc91d169c2193c]['relId'] = $relId;
$this->functionData['likeMoreDialogue'][$count_1af5c1388eb4bd418fdc91d169c2193c]['cache'] = $cache;
}
$IPBHTML .= "<h3>{$this->lang->words['followed_by']}</h3>
<div class='likepop fixed_inner'>
	" . ((is_array($data) && count($data)) ? ("
		<ul class='ipsList_withminiphoto'>
			".$this->__f__82acdbf873f6403815134e8634acc869($data,$relId,$cache)."		</ul>
	") : ("")) . "
...
function __f__82acdbf873f6403815134e8634acc869($data, $relId, $cache)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		<li class='ipsField ipsField_checkbox'>
			...
			<p class='ipsField_content'>
				...
				<select name=\"freq\" id=\"like_freq\" class=\"input_select\">
					".$this->__f__dbf438476b60d04e4068b6570e749bb6($app,$area,$relid,$data)."				</select>
			</p>
		</li>
		<li class='ipsField ipsField_checkbox'>
...
function __f__dbf438476b60d04e4068b6570e749bb6($app, $area, $relid, $data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_24b40a0a715eb0f61580a7effb87150f = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_24b40a0a715eb0f61580a7effb87150f]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_24b40a0a715eb0f61580a7effb87150f]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_24b40a0a715eb0f61580a7effb87150f]['opts'] = $opts;
}
...
{
$count_5946e7b4769e8b3c5f90503c27e7ff11 = is_array($this->functionData['notificationsList']) ? count($this->functionData['notificationsList']) : 0;
$this->functionData['notificationsList'][$count_5946e7b4769e8b3c5f90503c27e7ff11]['notifications'] = $notifications;
}
...
<ul class='ipsList_withminiphoto'>
	" . ((count($notifications)) ? ("
		".$this->__f__ad0d0c483a1e7c32cdce2ae72417e3a8($notifications)."	") : ("
...
function __f__ad0d0c483a1e7c32cdce2ae72417e3a8($notifications)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_9e8eae88ceda2cb3934a653c93aec43d = is_array($this->functionData['questionAndAnswer']) ? count($this->functionData['questionAndAnswer']) : 0;
$this->functionData['questionAndAnswer'][$count_9e8eae88ceda2cb3934a653c93aec43d]['data'] = $data;
}
...
{
$count_7044a00f0f22d25684f561ee75bde854 = is_array($this->functionData['quickNavigationPanel']) ? count($this->functionData['quickNavigationPanel']) : 0;
$this->functionData['quickNavigationPanel'][$count_7044a00f0f22d25684f561ee75bde854]['data'] = $data;
$this->functionData['quickNavigationPanel'][$count_7044a00f0f22d25684f561ee75bde854]['currentApp'] = $currentApp;
}
$IPBHTML .= "<div>
	".$this->__f__b6ef6d71899c5db353e84b592c10aa53($data,$currentApp)."</div>";
return $IPBHTML;
}


function __f__16becf87afe7954ac8bec8448278cadd($data=array(), $currentApp='',$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b6ef6d71899c5db353e84b592c10aa53($data=array(), $currentApp='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data as $_data )
	{
		...
		" . ((is_array($_data['links']) AND count($_data['links'])) ? ("
			".$this->__f__16becf87afe7954ac8bec8448278cadd($data,$currentApp,$_data)."		") : ("")) . "
		</ul>
...
{
$count_9fd5dde20248ea16b09e2e8397939af3 = is_array($this->functionData['quickNavigationWrapper']) ? count($this->functionData['quickNavigationWrapper']) : 0;
$this->functionData['quickNavigationWrapper'][$count_9fd5dde20248ea16b09e2e8397939af3]['tabs'] = $tabs;
$this->functionData['quickNavigationWrapper'][$count_9fd5dde20248ea16b09e2e8397939af3]['data'] = $data;
$this->functionData['quickNavigationWrapper'][$count_9fd5dde20248ea16b09e2e8397939af3]['currentApp'] = $currentApp;
}
$IPBHTML .= "<h3>{$this->lang->words['navigation_title']}</h3>
<div class='fixed_inner ipsBox'>
	" . (($this->registry->output->isLargeTouchDevice()) ? ("
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left'>
			<ul>
				".$this->__f__64f9fcc5e33d16eb02a21ff109164ac4($tabs,$data,$currentApp)."			</ul>
		</div>
...
function __f__64f9fcc5e33d16eb02a21ff109164ac4($tabs=array(), $data=array(), $currentApp='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e778ac086bd1923d3e893ae0559d6860 = is_array($this->functionData['redirectTemplate']) ? count($this->functionData['redirectTemplate']) : 0;
$this->functionData['redirectTemplate'][$count_e778ac086bd1923d3e893ae0559d6860]['documentHeadItems'] = $documentHeadItems;
$this->functionData['redirectTemplate'][$count_e778ac086bd1923d3e893ae0559d6860]['css'] = $css;
$this->functionData['redirectTemplate'][$count_e778ac086bd1923d3e893ae0559d6860]['jsLoaderItems'] = $jsLoaderItems;
$this->functionData['redirectTemplate'][$count_e778ac086bd1923d3e893ae0559d6860]['text'] = $text;
$this->functionData['redirectTemplate'][$count_e778ac086bd1923d3e893ae0559d6860]['url'] = $url;
$this->functionData['redirectTemplate'][$count_e778ac086bd1923d3e893ae0559d6860]['full'] = $full;
}
$IPBHTML .= "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">
<html xml:lang=\"en\" lang=\"en\" xmlns=\"http://www.w3.org/1999/xhtml\">
	<head>
		...
		<link rel=\"shortcut icon\" href='" . (($this->registry->output->isHTTPS) ? ("{$this->settings['board_url_https']}") : ("{$this->settings['board_url']}")) . "/favicon.ico' />
		" . ((is_array( $css['import'] )) ? ("
			".$this->__f__542f1dd0b3b270c13c92d71c10853cf6($documentHeadItems,$css,$jsLoaderItems,$text,$url,$full)."		") : ("")) . "
		" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
			".$this->__f__b2e45d8ed5ecedd051ebbd091a09a1ef($documentHeadItems,$css,$jsLoaderItems,$text,$url,$full)."		") : ("")) . "
		<!--[if lte IE 7]>
			<link rel=\"stylesheet\" type=\"text/css\" title='Main' media=\"screen\" href=\"{$this->settings['public_dir']}style_css/{$this->registry->output->skin['_csscacheid']}/ipb_ie.css\" />
		<![endif]-->
		...
		" . ((count($documentHeadItems)) ? ("
			".$this->__f__8469b1c13575010871a86e12de4717d1($documentHeadItems,$css,$jsLoaderItems,$text,$url,$full)."		") : ("")) . "
		<!--/CSS-->
		<script type='text/javascript'>
		//<![CDATA[
...
function __f__542f1dd0b3b270c13c92d71c10853cf6($documentHeadItems, $css, $jsLoaderItems, $text="",$url="", $full=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $css['import'] as $data )
...
function __f__b2e45d8ed5ecedd051ebbd091a09a1ef($documentHeadItems, $css, $jsLoaderItems, $text="",$url="", $full=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $css['inline'] as $data )
...
function __f__4b0460ebf6c34758fec0891bf14280e3($documentHeadItems, $css, $jsLoaderItems, $text="",$url="", $full=false,$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems[ $type ] as $idx => $data )
...
function __f__8469b1c13575010871a86e12de4717d1($documentHeadItems, $css, $jsLoaderItems, $text="",$url="", $full=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__4b0460ebf6c34758fec0891bf14280e3($documentHeadItems,$css,$jsLoaderItems,$text,$url,$full,$type,$idx)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_7b23f2002ca4ee9b4a1ebf1a4d6c65a1 = is_array($this->functionData['repButtons']) ? count($this->functionData['repButtons']) : 0;
$this->functionData['repButtons'][$count_7b23f2002ca4ee9b4a1ebf1a4d6c65a1]['member'] = $member;
$this->functionData['repButtons'][$count_7b23f2002ca4ee9b4a1ebf1a4d6c65a1]['data'] = $data;
}
...
<div class='likepop fixed_inner'>
	<ul class='ipsList_withminiphoto'>
		".$this->__f__521de560fcb4f18e91d4bf7197b418b5($data,$relId)."	</ul>
</div>";
return $IPBHTML;
}


function __f__521de560fcb4f18e91d4bf7197b418b5($data, $relId)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data as $mid => $data )
...
$IPBHTML .= "<div>
	...
	<div class='ipsPad' style='min-height: 60px'>
		...
		") : ("".$this->__f__170a9ea460c75973d4756a551baa9a8c($reps)."		")) . "
	</div>
</div>";
return $IPBHTML;
}
...
function __f__170a9ea460c75973d4756a551baa9a8c($reps)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $reps as $r )
...
{
$count_16228fb81e249f808e09f7e1fac4b0db = is_array($this->functionData['socialSharePostStrip']) ? count($this->functionData['socialSharePostStrip']) : 0;
$this->functionData['socialSharePostStrip'][$count_16228fb81e249f808e09f7e1fac4b0db]['id'] = $id;
}
...
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("facebook", "0" ) . "" . (($this->settings['sm_autoshare'] && IPSMember::canSocialShare()) ? ("<div class='ipsBox_container ipsMargin_top ipsPad_top'>
	<ul class='ipsPad ipsForm_vertical ipsList_inline ipsType_small clearfix'>
		".$this->__f__9aa9be2cf3677b04105b0c033a7035e2($id)."		" . ((! $id) ? ("
...
function __f__9aa9be2cf3677b04105b0c033a7035e2($id=null)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_65c1e0c29dc89c895a3d571740f0c1d5 = is_array($this->functionData['tagCloud']) ? count($this->functionData['tagCloud']) : 0;
$this->functionData['tagCloud'][$count_65c1e0c29dc89c895a3d571740f0c1d5]['tags'] = $tags;
}
$IPBHTML .= "<h3 class='maintitle'>{$this->lang->words['mob_tags']}</h3>
<div class='ipsBox'>
	<div class='ipsBox_container ipsPad'>
		<ul class='ipsList_inline'>
		".$this->__f__384af343fbb2d3a44215a18e46bbf4b4($tags)."		</ul>
	</div>
</div>";
return $IPBHTML;
}
...
function __f__384af343fbb2d3a44215a18e46bbf4b4($tags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e20b27164a0f8229b00185536ededf29 = is_array($this->functionData['tagEntry']) ? count($this->functionData['tagEntry']) : 0;
$this->functionData['tagEntry'][$count_e20b27164a0f8229b00185536ededf29]['tag'] = $tag;
$this->functionData['tagEntry'][$count_e20b27164a0f8229b00185536ededf29]['noClass'] = $noClass;
$this->functionData['tagEntry'][$count_e20b27164a0f8229b00185536ededf29]['app'] = $app;
$this->functionData['tagEntry'][$count_e20b27164a0f8229b00185536ededf29]['section'] = $section;
}
...
{
$count_373b7776b02e360b3df62e45f6aa3c12 = is_array($this->functionData['tagPrefix']) ? count($this->functionData['tagPrefix']) : 0;
$this->functionData['tagPrefix'][$count_373b7776b02e360b3df62e45f6aa3c12]['tag'] = $tag;
$this->functionData['tagPrefix'][$count_373b7776b02e360b3df62e45f6aa3c12]['app'] = $app;
$this->functionData['tagPrefix'][$count_373b7776b02e360b3df62e45f6aa3c12]['section'] = $section;
}
...
{
$count_9cbf5360ecacef827269265ab5471417 = is_array($this->functionData['tagTextEntryBox']) ? count($this->functionData['tagTextEntryBox']) : 0;
$this->functionData['tagTextEntryBox'][$count_9cbf5360ecacef827269265ab5471417]['tags'] = $tags;
$this->functionData['tagTextEntryBox'][$count_9cbf5360ecacef827269265ab5471417]['options'] = $options;
$this->functionData['tagTextEntryBox'][$count_9cbf5360ecacef827269265ab5471417]['where'] = $where;
}
