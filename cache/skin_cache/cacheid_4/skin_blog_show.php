...
{
$count_23d2328bcae69b8a969c0003c6772f66 = is_array($this->functionData['blogArchive']) ? count($this->functionData['blogArchive']) : 0;
$this->functionData['blogArchive'][$count_23d2328bcae69b8a969c0003c6772f66]['blog'] = $blog;
$this->functionData['blogArchive'][$count_23d2328bcae69b8a969c0003c6772f66]['links'] = $links;
$this->functionData['blogArchive'][$count_23d2328bcae69b8a969c0003c6772f66]['entries'] = $entries;
$this->functionData['blogArchive'][$count_23d2328bcae69b8a969c0003c6772f66]['cb_left_html'] = $cb_left_html;
$this->functionData['blogArchive'][$count_23d2328bcae69b8a969c0003c6772f66]['cb_right_html'] = $cb_right_html;
$this->functionData['blogArchive'][$count_23d2328bcae69b8a969c0003c6772f66]['followData'] = $followData;
}
	...
	<div id='main_column'>
		...
		" . ((is_array( $entries ) && count( $entries )) ? ("
			<table class='ipb_table'>
								".$this->__f__d6725b042e6163202a4b865b6db89cd6($blog,$links,$entries,$cb_left_html,$cb_right_html,$followData)."			</table>
...
function __f__d6725b042e6163202a4b865b6db89cd6($blog, $links, $entries=array(), $cb_left_html="", $cb_right_html="", $followData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_a4dd1dc6bb6f5d4ff45765feef288264 = is_array($this->functionData['blogEntryView']) ? count($this->functionData['blogEntryView']) : 0;
$this->functionData['blogEntryView'][$count_a4dd1dc6bb6f5d4ff45765feef288264]['blog'] = $blog;
$this->functionData['blogEntryView'][$count_a4dd1dc6bb6f5d4ff45765feef288264]['comments_html'] = $comments_html;
$this->functionData['blogEntryView'][$count_a4dd1dc6bb6f5d4ff45765feef288264]['header'] = $header;
$this->functionData['blogEntryView'][$count_a4dd1dc6bb6f5d4ff45765feef288264]['entry'] = $entry;
$this->functionData['blogEntryView'][$count_a4dd1dc6bb6f5d4ff45765feef288264]['poll_html'] = $poll_html;
$this->functionData['blogEntryView'][$count_a4dd1dc6bb6f5d4ff45765feef288264]['trackbacks_html'] = $trackbacks_html;
$this->functionData['blogEntryView'][$count_a4dd1dc6bb6f5d4ff45765feef288264]['links'] = $links;
$this->functionData['blogEntryView'][$count_a4dd1dc6bb6f5d4ff45765feef288264]['cblocks'] = $cblocks;
$this->functionData['blogEntryView'][$count_a4dd1dc6bb6f5d4ff45765feef288264]['follow'] = $follow;
$this->functionData['blogEntryView'][$count_a4dd1dc6bb6f5d4ff45765feef288264]['tags'] = $tags;
}
				...
				<div class='entry" . (($entry['entry_status'] != 'published') ? (" moderated") : ("")) . "" . (($entry['hide_private']) ? (" private") : ("")) . "' id='entry_{$entry['entry_id']}'>
					<div class='entry_header row2 ipsPad_half'>
						...
						" . (($this->settings['blog_enable_rating']) ? ("" . (($blog['_allow_rating']) ? ("
							...
							") : ("")) . "
							".$this->__f__cb9c33ee4c3c840a48f231487d40eeaa($blog,$comments_html,$header,$entry,$poll_html,$trackbacks_html,$links,$cblocks,$follow,$tags)."							<span id='rating_text'>
...
function __f__cb9c33ee4c3c840a48f231487d40eeaa($blog, $comments_html, $header, $entry, $poll_html, $trackbacks_html, $links, $cblocks, $follow, $tags=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_fdcae21431336fd4e589eed05c42c4cf = is_array($this->functionData['blogView']) ? count($this->functionData['blogView']) : 0;
$this->functionData['blogView'][$count_fdcae21431336fd4e589eed05c42c4cf]['blog'] = $blog;
$this->functionData['blogView'][$count_fdcae21431336fd4e589eed05c42c4cf]['links'] = $links;
$this->functionData['blogView'][$count_fdcae21431336fd4e589eed05c42c4cf]['entries'] = $entries;
$this->functionData['blogView'][$count_fdcae21431336fd4e589eed05c42c4cf]['dates'] = $dates;
$this->functionData['blogView'][$count_fdcae21431336fd4e589eed05c42c4cf]['cblocks'] = $cblocks;
$this->functionData['blogView'][$count_fdcae21431336fd4e589eed05c42c4cf]['followData'] = $followData;
}
	...
	<div id='main_column'>
		...
		" . ((!is_array($entries) || !count($entries)) ? ("<p class='no_messages ipsType_subtitle short'>
				" . (($this->request['cat'] OR $this->request['tag']) ? ("{$this->lang->words['no_entry_matches']}") : ("{$blog['blog_name']} {$this->lang->words['no_entries_yet']}")) . "
						...
						<div class='ipsBox'>
				".$this->__f__33cf30a9088d940b6ffa9bfbc4b6806c($blog,$links,$entries,$dates,$cblocks,$followData)."				<br class='clear' />
			</div>
		")) . "
		<br />
		<!-- Pagination -->
...
function __f__33cf30a9088d940b6ffa9bfbc4b6806c($blog, $links, $entries=array(), $dates=array(), $cblocks=array(), $followData="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $entries as $entry )
...
{
$count_ae8e66d0388d7ce6c955a28eb9973248 = is_array($this->functionData['entryAlbum']) ? count($this->functionData['entryAlbum']) : 0;
$this->functionData['entryAlbum'][$count_ae8e66d0388d7ce6c955a28eb9973248]['album'] = $album;
$this->functionData['entryAlbum'][$count_ae8e66d0388d7ce6c955a28eb9973248]['album_id'] = $album_id;
}
$IPBHTML .= "<div id='attach_wrap' class='rounded clearfix'>
	<ul>
		".$this->__f__a52618d86b70d47a4a814d244da9ba0a($album,$album_id)."	</ul>
</div>
<br />";
return $IPBHTML;
}
...
function __f__a52618d86b70d47a4a814d244da9ba0a($album="",$album_id)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_8dc81ce117a0ad4f9fe01f2d8bb51103 = is_array($this->functionData['entryTrackbacks']) ? count($this->functionData['entryTrackbacks']) : 0;
$this->functionData['entryTrackbacks'][$count_8dc81ce117a0ad4f9fe01f2d8bb51103]['entry_id'] = $entry_id;
$this->functionData['entryTrackbacks'][$count_8dc81ce117a0ad4f9fe01f2d8bb51103]['rows'] = $rows;
}
...
" . ((is_array( $rows ) && count( $rows )) ? ("
	<div id='trackbacks'>
				".$this->__f__2ee230aba38648dd74243c51f2eb55f3($entry_id,$rows)."	</div>
") : ("
...
function __f__2ee230aba38648dd74243c51f2eb55f3($entry_id="",$rows=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_4f2f8f80a6ba984650ae36c218b17824 = is_array($this->functionData['pollDisplay']) ? count($this->functionData['pollDisplay']) : 0;
$this->functionData['pollDisplay'][$count_4f2f8f80a6ba984650ae36c218b17824]['poll'] = $poll;
$this->functionData['pollDisplay'][$count_4f2f8f80a6ba984650ae36c218b17824]['entry'] = $entry;
$this->functionData['pollDisplay'][$count_4f2f8f80a6ba984650ae36c218b17824]['pollData'] = $pollData;
$this->functionData['pollDisplay'][$count_4f2f8f80a6ba984650ae36c218b17824]['showResults'] = $showResults;
}
$IPBHTML .= "<script type='text/javascript'>
...
<div class='general_box alt poll' id='poll_{$poll['pid']}'>
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=blog&amp;module=actions&amp;section=dovote&amp;eid={$entry['entry_id']}&amp;blogid={$this->request['blogid']}&amp;st={$this->request['st']}&amp;auth_key={$this->member->form_hash}", "public",'' ), "", "" ) . "\" method=\"post\">
		...
		") : ("")) . "
		".$this->__f__a2058daa9a30dec0a6c642e4cc63d3f1($poll,$entry,$pollData,$showResults)."		" . ((!$entry['entry_locked']) ? ("<fieldset class='submit'>
...
function __f__8c0de7fabd536a44aabc3e6edf672687($poll, $entry, $pollData, $showResults,$questionID='',$questionData='',$choiceID='',$choiceData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__5c9975ba240b4a53b59873f5641e5f71($poll, $entry, $pollData, $showResults,$questionID='',$questionData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
							...
							" . (($showResults) ? ("<li>
									...
									" . (($poll['poll_view_voters'] AND is_array( $choiceData['voters'] ) AND $this->settings['poll_allow_public'] AND $choiceData['votes']) ? ("
										<script type='text/javascript'>
											...
											".$this->__f__8c0de7fabd536a44aabc3e6edf672687($poll,$entry,$pollData,$showResults,$questionID,$questionData,$choiceID,$choiceData)."											ipb.topic.poll[ $questionID ][ $choiceID ] = { name: \"{$choiceData['choice']}\", users: users};
										</script>
									") : ("")) . "
...
function __f__a2058daa9a30dec0a6c642e4cc63d3f1($poll, $entry, $pollData, $showResults)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $pollData as $questionID => $questionData )
	{
		...
		$_ips___x_retval .= "
			<div class='poll_question" . (($showResults) ? (" voted") : ("")) . "'>
				...
				") : ("
					<ol>
						".$this->__f__5c9975ba240b4a53b59873f5641e5f71($poll,$entry,$pollData,$showResults,$questionID,$questionData)."					</ol>
				")) . "
			</div>
...
{
$count_0a96902001c3ee1142cea7e0a0b5c532 = is_array($this->functionData['show_attachment_title']) ? count($this->functionData['show_attachment_title']) : 0;
$this->functionData['show_attachment_title'][$count_0a96902001c3ee1142cea7e0a0b5c532]['title'] = $title;
$this->functionData['show_attachment_title'][$count_0a96902001c3ee1142cea7e0a0b5c532]['data'] = $data;
$this->functionData['show_attachment_title'][$count_0a96902001c3ee1142cea7e0a0b5c532]['type'] = $type;
}
$IPBHTML .= "<div id='attach_wrap' class='rounded clearfix'>
	<h4>{$title}</h4>
	<ul>
		".$this->__f__93410bdbad2878ee9ef2810b33b1c234($title,$data,$type)."	</ul>
</div>";
return $IPBHTML;
}


function __f__93410bdbad2878ee9ef2810b33b1c234($title="",$data="",$type="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
