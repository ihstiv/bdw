...
{
$count_49c0af5e33d2305b93e3f2918d41a027 = is_array($this->functionData['ajax__inlineLogInForm']) ? count($this->functionData['ajax__inlineLogInForm']) : 0;
}
...
{
$count_baef1e87395f9295d2a987a4fa3b33b4 = is_array($this->functionData['showLogInForm']) ? count($this->functionData['showLogInForm']) : 0;
$this->functionData['showLogInForm'][$count_baef1e87395f9295d2a987a4fa3b33b4]['message'] = $message;
$this->functionData['showLogInForm'][$count_baef1e87395f9295d2a987a4fa3b33b4]['referer'] = $referer;
$this->functionData['showLogInForm'][$count_baef1e87395f9295d2a987a4fa3b33b4]['extra_form'] = $extra_form;
$this->functionData['showLogInForm'][$count_baef1e87395f9295d2a987a4fa3b33b4]['login_methods'] = $login_methods;
}
				...
				<div class='right ipsPad_double' id='other_signin'>
					<ul class='ipsList_data clear ipsType_small'>
						...
						" . ((is_array($extra_form) AND count($extra_form)) ? ("
							".$this->__f__f7390a889654f3b04e956b3a77ce7b64($message,$referer,$extra_form,$login_methods)."						") : ("")) . "
					</ul>
				</div>
			</div>
			" . ((IPSLib::loginMethod_enabled('live')) ? ("
...
function __f__f7390a889654f3b04e956b3a77ce7b64($message="",$referer="",$extra_form="", $login_methods=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
