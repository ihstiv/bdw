...
{
$count_72ffed8ee61b1398ac31b273861e1389 = is_array($this->functionData['blogPostForm']) ? count($this->functionData['blogPostForm']) : 0;
$this->functionData['blogPostForm'][$count_72ffed8ee61b1398ac31b273861e1389]['form_hiddens'] = $form_hiddens;
$this->functionData['blogPostForm'][$count_72ffed8ee61b1398ac31b273861e1389]['button'] = $button;
$this->functionData['blogPostForm'][$count_72ffed8ee61b1398ac31b273861e1389]['date'] = $date;
$this->functionData['blogPostForm'][$count_72ffed8ee61b1398ac31b273861e1389]['title'] = $title;
$this->functionData['blogPostForm'][$count_72ffed8ee61b1398ac31b273861e1389]['albums'] = $albums;
$this->functionData['blogPostForm'][$count_72ffed8ee61b1398ac31b273861e1389]['mod_options'] = $mod_options;
$this->functionData['blogPostForm'][$count_72ffed8ee61b1398ac31b273861e1389]['editor'] = $editor;
$this->functionData['blogPostForm'][$count_72ffed8ee61b1398ac31b273861e1389]['poll_box'] = $poll_box;
$this->functionData['blogPostForm'][$count_72ffed8ee61b1398ac31b273861e1389]['upload_field'] = $upload_field;
$this->functionData['blogPostForm'][$count_72ffed8ee61b1398ac31b273861e1389]['html_status'] = $html_status;
$this->functionData['blogPostForm'][$count_72ffed8ee61b1398ac31b273861e1389]['canPublish'] = $canPublish;
$this->functionData['blogPostForm'][$count_72ffed8ee61b1398ac31b273861e1389]['blogsdd'] = $blogsdd;
$this->functionData['blogPostForm'][$count_72ffed8ee61b1398ac31b273861e1389]['_extraData'] = $_extraData;
$this->functionData['blogPostForm'][$count_72ffed8ee61b1398ac31b273861e1389]['tagBox'] = $tagBox;
$this->functionData['blogPostForm'][$count_72ffed8ee61b1398ac31b273861e1389]['following'] = $following;
$this->functionData['blogPostForm'][$count_72ffed8ee61b1398ac31b273861e1389]['socialShare'] = $socialShare;
$this->functionData['blogPostForm'][$count_72ffed8ee61b1398ac31b273861e1389]['image'] = $image;
}
...
<form id='postingform' action='{$this->settings['base_url']}' method='post' name='postingform' enctype='multipart/form-data'>
					...
					<li class='ipsField ipsField_select'>
						...
						<p class='ipsField_content'>
							<select name='blogid' id='blog_chooser'>
								".$this->__f__219b53a72e8922cc1090e28e792f3f5c($form_hiddens,$button,$date,$title,$albums,$mod_options,$editor,$poll_box,$upload_field,$html_status,$canPublish,$blogsdd,$_extraData,$tagBox,$following,$socialShare,$image)."							</select>
						</p>
					</li>
				") : ("")) . "
	...
	<fieldset class='submit clear'>
		...
		" . ((is_array( $form_hiddens ) && count( $form_hiddens )) ? ("
			".$this->__f__6692429e6b8336929c0af182707ddcd6($form_hiddens,$button,$date,$title,$albums,$mod_options,$editor,$poll_box,$upload_field,$html_status,$canPublish,$blogsdd,$_extraData,$tagBox,$following,$socialShare,$image)."		") : ("")) . "
...
function __f__219b53a72e8922cc1090e28e792f3f5c($form_hiddens=array(), $button="", $date=array(), $title=array(), $albums="", $mod_options="", $editor="", $poll_box="", $upload_field='', $html_status=array(), $canPublish=0, $blogsdd='', $_extraData=array(), $tagBox='', $following = 0, $socialShare, $image='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__6692429e6b8336929c0af182707ddcd6($form_hiddens=array(), $button="", $date=array(), $title=array(), $albums="", $mod_options="", $editor="", $poll_box="", $upload_field='', $html_status=array(), $canPublish=0, $blogsdd='', $_extraData=array(), $tagBox='', $following = 0, $socialShare, $image='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_cf5d7ccd84b3c4b142451291e1bf3b9f = is_array($this->functionData['cBlockForm']) ? count($this->functionData['cBlockForm']) : 0;
$this->functionData['cBlockForm'][$count_cf5d7ccd84b3c4b142451291e1bf3b9f]['form_hiddens'] = $form_hiddens;
$this->functionData['cBlockForm'][$count_cf5d7ccd84b3c4b142451291e1bf3b9f]['button'] = $button;
$this->functionData['cBlockForm'][$count_cf5d7ccd84b3c4b142451291e1bf3b9f]['cbtitle'] = $cbtitle;
$this->functionData['cBlockForm'][$count_cf5d7ccd84b3c4b142451291e1bf3b9f]['editor'] = $editor;
$this->functionData['cBlockForm'][$count_cf5d7ccd84b3c4b142451291e1bf3b9f]['html_status'] = $html_status;
$this->functionData['cBlockForm'][$count_cf5d7ccd84b3c4b142451291e1bf3b9f]['upload_field'] = $upload_field;
$this->functionData['cBlockForm'][$count_cf5d7ccd84b3c4b142451291e1bf3b9f]['blogData'] = $blogData;
}
$IPBHTML .= "<br />
<form id='postingform' action='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=blog&amp;module=post&amp;section=post", "public",'' ), "", "" ) . "' method='post' enctype='multipart/form-data'>
	...
	<fieldset class='submit clear'>
		...
		<input type='hidden' name='removeattachid' value='0' />
		" . ((is_array( $form_hiddens ) && count( $form_hiddens )) ? ("
			".$this->__f__0ec6d20f5fae36ea8f292731e61590a2($form_hiddens,$button,$cbtitle,$editor,$html_status,$upload_field,$blogData)."		") : ("")) . "
...
function __f__0ec6d20f5fae36ea8f292731e61590a2($form_hiddens=array(), $button='', $cbtitle='', $editor='', $html_status=array(), $upload_field='', $blogData=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
