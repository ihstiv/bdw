...
class skin_contato_4 extends skinMaster{
...
{
$count_d7305f0ff11ce4003d9f9c722423b594 = is_array($this->functionData['fields']) ? count($this->functionData['fields']) : 0;
$this->functionData['fields'][$count_d7305f0ff11ce4003d9f9c722423b594]['dep'] = $dep;
$this->functionData['fields'][$count_d7305f0ff11ce4003d9f9c722423b594]['regra'] = $regra;
$this->functionData['fields'][$count_d7305f0ff11ce4003d9f9c722423b594]['pergunta'] = $pergunta;
$this->functionData['fields'][$count_d7305f0ff11ce4003d9f9c722423b594]['customfields'] = $customfields;
$this->functionData['fields'][$count_d7305f0ff11ce4003d9f9c722423b594]['captchaHTML'] = $captchaHTML;
$this->functionData['fields'][$count_d7305f0ff11ce4003d9f9c722423b594]['firstid'] = $firstid;
}
...
<ul class=\"ipsPad\">
				...
				" . ((is_array($customfields) and count($customfields)) ? ("".$this->__f__dce4a7e68d7d77b2b38c3367bd8a754f($dep,$regra,$pergunta,$customfields,$captchaHTML,$firstid)."				") : ("")) . "" . (($pergunta[question] != '') ? ("
					<li class='ipsField'>
...
function __f__dce4a7e68d7d77b2b38c3367bd8a754f($dep=array(), $regra, $pergunta=array(), $customfields=array(), $captchaHTML, $firstid)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_4f013a39c97988b68c576c9922f5aae8 = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_4f013a39c97988b68c576c9922f5aae8]['dep'] = $dep;
$this->functionData['form'][$count_4f013a39c97988b68c576c9922f5aae8]['regra'] = $regra;
$this->functionData['form'][$count_4f013a39c97988b68c576c9922f5aae8]['pergunta'] = $pergunta;
$this->functionData['form'][$count_4f013a39c97988b68c576c9922f5aae8]['customfields'] = $customfields;
$this->functionData['form'][$count_4f013a39c97988b68c576c9922f5aae8]['captchaHTML'] = $captchaHTML;
$this->functionData['form'][$count_4f013a39c97988b68c576c9922f5aae8]['firstid'] = $firstid;
}
$IPBHTML .= "{$regra}
...
<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left'>		
			...
			<ul>
				".$this->__f__0e9f241c84540db886dabfdfd8669aa8($dep,$regra,$pergunta,$customfields,$captchaHTML,$firstid)."						
			</ul>
		</div>
...
function __f__0e9f241c84540db886dabfdfd8669aa8($dep=array(), $regra, $pergunta=array(), $customfields=array(), $captchaHTML, $firstid)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $dep as $r )
