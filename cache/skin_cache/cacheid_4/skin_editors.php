...
{
$count_c1037b69a68ed41814afc3c109dff7df = is_array($this->functionData['ajaxEditBox']) ? count($this->functionData['ajaxEditBox']) : 0;
$this->functionData['ajaxEditBox'][$count_c1037b69a68ed41814afc3c109dff7df]['post'] = $post;
$this->functionData['ajaxEditBox'][$count_c1037b69a68ed41814afc3c109dff7df]['pid'] = $pid;
$this->functionData['ajaxEditBox'][$count_c1037b69a68ed41814afc3c109dff7df]['error_msg'] = $error_msg;
$this->functionData['ajaxEditBox'][$count_c1037b69a68ed41814afc3c109dff7df]['extraData'] = $extraData;
}
...
{
$count_f734c1707c5958bad18f0b29b67cb033 = is_array($this->functionData['editor']) ? count($this->functionData['editor']) : 0;
$this->functionData['editor'][$count_f734c1707c5958bad18f0b29b67cb033]['formField'] = $formField;
$this->functionData['editor'][$count_f734c1707c5958bad18f0b29b67cb033]['content'] = $content;
$this->functionData['editor'][$count_f734c1707c5958bad18f0b29b67cb033]['options'] = $options;
$this->functionData['editor'][$count_f734c1707c5958bad18f0b29b67cb033]['autoSaveData'] = $autoSaveData;
$this->functionData['editor'][$count_f734c1707c5958bad18f0b29b67cb033]['warningInfo'] = $warningInfo;
$this->functionData['editor'][$count_f734c1707c5958bad18f0b29b67cb033]['acknowledge'] = $acknowledge;
$this->functionData['editor'][$count_f734c1707c5958bad18f0b29b67cb033]['bbcodeVersion'] = $bbcodeVersion;
$this->functionData['editor'][$count_f734c1707c5958bad18f0b29b67cb033]['showEditor'] = $showEditor;
}
...
{
$count_f55ca2deced698213345279abc76b7e4 = is_array($this->functionData['editorLoadJs']) ? count($this->functionData['editorLoadJs']) : 0;
$this->functionData['editorLoadJs'][$count_f55ca2deced698213345279abc76b7e4]['options'] = $options;
$this->functionData['editorLoadJs'][$count_f55ca2deced698213345279abc76b7e4]['inlineLoad'] = $inlineLoad;
}
...
{
$count_861d1923ba2886aa93e75800c1f255fb = is_array($this->functionData['mediaGenericWrapper']) ? count($this->functionData['mediaGenericWrapper']) : 0;
$this->functionData['mediaGenericWrapper'][$count_861d1923ba2886aa93e75800c1f255fb]['rows'] = $rows;
$this->functionData['mediaGenericWrapper'][$count_861d1923ba2886aa93e75800c1f255fb]['pages'] = $pages;
$this->functionData['mediaGenericWrapper'][$count_861d1923ba2886aa93e75800c1f255fb]['app'] = $app;
$this->functionData['mediaGenericWrapper'][$count_861d1923ba2886aa93e75800c1f255fb]['plugin'] = $plugin;
}
...
<div>
	<ul class='media_results'>
		" . ((count($rows)) ? ("
			".$this->__f__4732bb28aecdeda48c7da7518e31a0da($rows,$pages,$app,$plugin)."		") : ("
...
function __f__4732bb28aecdeda48c7da7518e31a0da($rows, $pages, $app, $plugin)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_b44fd228f5920293708a073168d3096b = is_array($this->functionData['sharedMedia']) ? count($this->functionData['sharedMedia']) : 0;
$this->functionData['sharedMedia'][$count_b44fd228f5920293708a073168d3096b]['tabs'] = $tabs;
}
...
<div class='fixed_inner ipsBox'>
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left'>
			<ul id='mymedia_tabs'>
				".$this->__f__de14d2a511ea25c1f7aa084da205bc1b($tabs)."			</ul>
		</div>
...
function __f__de14d2a511ea25c1f7aa084da205bc1b($tabs)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tabs as $tab )
