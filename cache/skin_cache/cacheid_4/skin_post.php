...
{
$count_640a284bb5837045941a82b0bda1f1b4 = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_640a284bb5837045941a82b0bda1f1b4]['data'] = $data;
}
...
{
$count_a626216304793bfb25c93b4590f8760c = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_a626216304793bfb25c93b4590f8760c]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_a626216304793bfb25c93b4590f8760c]['form'] = $form;
}
...
{
$count_49b3fa0c1210e5dc179d8d0eefe9432b = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_49b3fa0c1210e5dc179d8d0eefe9432b]['data'] = $data;
}
...
{
$count_ebb22de4e40f0bb7a85e1640bd69d0ea = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_ebb22de4e40f0bb7a85e1640bd69d0ea]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__69e453b4d2ebc4fc11c61a5a0b140e47($posts)."") : ("")) . "
<p class='submit'>
...
function __f__69e453b4d2ebc4fc11c61a5a0b140e47($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1bf38a0a27e8237b6d8c1910cba8d32e = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_1bf38a0a27e8237b6d8c1910cba8d32e]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_1bf38a0a27e8237b6d8c1910cba8d32e]['type'] = $type;
$this->functionData['uploadForm'][$count_1bf38a0a27e8237b6d8c1910cba8d32e]['stats'] = $stats;
$this->functionData['uploadForm'][$count_1bf38a0a27e8237b6d8c1910cba8d32e]['id'] = $id;
$this->functionData['uploadForm'][$count_1bf38a0a27e8237b6d8c1910cba8d32e]['forum_id'] = $forum_id;
}
