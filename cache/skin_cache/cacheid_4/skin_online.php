...
{
$count_7b45949065388f2f6109d79cce1b0d5c = is_array($this->functionData['showOnlineList']) ? count($this->functionData['showOnlineList']) : 0;
$this->functionData['showOnlineList'][$count_7b45949065388f2f6109d79cce1b0d5c]['rows'] = $rows;
$this->functionData['showOnlineList'][$count_7b45949065388f2f6109d79cce1b0d5c]['links'] = $links;
$this->functionData['showOnlineList'][$count_7b45949065388f2f6109d79cce1b0d5c]['defaults'] = $defaults;
}
...
<div class='ipsBox'>
	<div class='ipsBox_container'>
		<table class='ipb_table ipsMemberList' summary=\"{$this->lang->words['users_online']}\">
			...
			" . ((count($rows)) ? ("
								".$this->__f__b93355efff3b94b6a13748c793e3f4e2($rows,$links,$defaults)."			") : ("")) . "
		</table>
	</div>
</div>
<div id='forum_filter' class='ipsForm_center ipsPad'>
	<form method=\"post\" action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=members&amp;section=online&amp;module=online", "public",'' ), "", "" ) . "\">
		...
		<select name=\"sort_key\" id='sort_key' class='input_select'>
			".$this->__f__dd2bd5e0419cb84aa952085904062b0d($rows,$links,$defaults)."		</select>
		<select name=\"show_mem\" class='input_select'>
			".$this->__f__aeecbde6397a469e742fd58fa0a0365a($rows,$links,$defaults)."		</select>
		<select name=\"sort_order\" class='input_select'>
			".$this->__f__5593e98ac179d66b356693323ed5a458($rows,$links,$defaults)."		</select>
...
function __f__b93355efff3b94b6a13748c793e3f4e2($rows, $links="", $defaults=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__dd2bd5e0419cb84aa952085904062b0d($rows, $links="", $defaults=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__aeecbde6397a469e742fd58fa0a0365a($rows, $links="", $defaults=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__5593e98ac179d66b356693323ed5a458($rows, $links="", $defaults=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
