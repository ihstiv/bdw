...
{
$count_be31a1d2bc836ae215847ea7ea022c45 = is_array($this->functionData['sendReplyForm']) ? count($this->functionData['sendReplyForm']) : 0;
$this->functionData['sendReplyForm'][$count_be31a1d2bc836ae215847ea7ea022c45]['displayData'] = $displayData;
}
$IPBHTML .= "<postingForm>
...
{
$count_e953125ceba90f7d62ed7aaf441b5585 = is_array($this->functionData['showConversation']) ? count($this->functionData['showConversation']) : 0;
$this->functionData['showConversation'][$count_e953125ceba90f7d62ed7aaf441b5585]['topic'] = $topic;
$this->functionData['showConversation'][$count_e953125ceba90f7d62ed7aaf441b5585]['replies'] = $replies;
$this->functionData['showConversation'][$count_e953125ceba90f7d62ed7aaf441b5585]['members'] = $members;
$this->functionData['showConversation'][$count_e953125ceba90f7d62ed7aaf441b5585]['jump'] = $jump;
}
...
<message>
	...
	".$this->__f__12353f925265c9b38a0bebf24050e19b($topic,$replies,$members,$jump)."</message>";
return $IPBHTML;
}


function __f__12353f925265c9b38a0bebf24050e19b($topic, $replies, $members, $jump="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_da2e16030ca0f9f4a2453541522093d9 = is_array($this->functionData['showFolder']) ? count($this->functionData['showFolder']) : 0;
$this->functionData['showFolder'][$count_da2e16030ca0f9f4a2453541522093d9]['messages'] = $messages;
$this->functionData['showFolder'][$count_da2e16030ca0f9f4a2453541522093d9]['dirname'] = $dirname;
$this->functionData['showFolder'][$count_da2e16030ca0f9f4a2453541522093d9]['pages'] = $pages;
$this->functionData['showFolder'][$count_da2e16030ca0f9f4a2453541522093d9]['currentFolderID'] = $currentFolderID;
$this->functionData['showFolder'][$count_da2e16030ca0f9f4a2453541522093d9]['jumpFolderHTML'] = $jumpFolderHTML;
}
$IPBHTML .= "<template>popoverMessages</template>
<messages>
	".$this->__f__6447d9756871dbebffdcd3b0f729951b($messages,$dirname,$pages,$currentFolderID,$jumpFolderHTML)."</messages>";
return $IPBHTML;
}


function __f__6447d9756871dbebffdcd3b0f729951b($messages, $dirname, $pages, $currentFolderID, $jumpFolderHTML)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
