...
{
$count_14949d8c333b4f8c63275195a13b8882 = is_array($this->functionData['forumIndexTemplate']) ? count($this->functionData['forumIndexTemplate']) : 0;
$this->functionData['forumIndexTemplate'][$count_14949d8c333b4f8c63275195a13b8882]['forum_data'] = $forum_data;
$this->functionData['forumIndexTemplate'][$count_14949d8c333b4f8c63275195a13b8882]['announce_data'] = $announce_data;
$this->functionData['forumIndexTemplate'][$count_14949d8c333b4f8c63275195a13b8882]['topic_data'] = $topic_data;
$this->functionData['forumIndexTemplate'][$count_14949d8c333b4f8c63275195a13b8882]['other_data'] = $other_data;
$this->functionData['forumIndexTemplate'][$count_14949d8c333b4f8c63275195a13b8882]['multi_mod_data'] = $multi_mod_data;
$this->functionData['forumIndexTemplate'][$count_14949d8c333b4f8c63275195a13b8882]['sub_forum_data'] = $sub_forum_data;
$this->functionData['forumIndexTemplate'][$count_14949d8c333b4f8c63275195a13b8882]['footer_filter'] = $footer_filter;
$this->functionData['forumIndexTemplate'][$count_14949d8c333b4f8c63275195a13b8882]['active_user_data'] = $active_user_data;
$this->functionData['forumIndexTemplate'][$count_14949d8c333b4f8c63275195a13b8882]['mod_data'] = $mod_data;
$this->functionData['forumIndexTemplate'][$count_14949d8c333b4f8c63275195a13b8882]['inforum'] = $inforum;
}
...
" . ((is_array( $sub_forum_data ) AND count( $sub_forum_data )) ? ("
		<subforums>			
	".$this->__f__02b152978efd3355aad0142a256c1b1d($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."		</subforums>
") : ("")) . "
" . ((is_array( $announce_data ) AND count( $announce_data )) ? ("
		<announcements>			
	".$this->__f__9e20539a318a4511f67586f584933e7b($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."		</announcements>
") : ("")) . "
		<topics>
" . ((is_array( $topic_data ) AND count( $topic_data )) ? ("".$this->__f__5ff9e75bd417eb2fc8e3af563157b8f2($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."") : ("")) . "
		</topics>
...
function __f__ccd0dcc9913fdf67236d01b5c48b6187($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1,$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__02b152978efd3355aad0142a256c1b1d($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $sub_forum_data as $_data )
	{
		...
		" . ((is_array( $_data['forum_data'] ) AND count( $_data['forum_data'] )) ? ("					
			".$this->__f__ccd0dcc9913fdf67236d01b5c48b6187($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum,$_data)."		") : ("")) . "
...
function __f__9e20539a318a4511f67586f584933e7b($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b72c50f1158c81b9428179ffdc5f6fa0($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1,$tid='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__5ff9e75bd417eb2fc8e3af563157b8f2($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $topic_data as $tid => $data )
	{
		...
		" . ((is_array( $data['pages'] ) AND count( $data['pages'] )) ? ("
			<pagination>
			".$this->__f__b72c50f1158c81b9428179ffdc5f6fa0($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum,$tid,$data)."		</pagination>
		") : ("")) . "		
			</topic>
