...
{
$count_680568ecb76c200cb963499a2e49b453 = is_array($this->functionData['post']) ? count($this->functionData['post']) : 0;
$this->functionData['post'][$count_680568ecb76c200cb963499a2e49b453]['post'] = $post;
$this->functionData['post'][$count_680568ecb76c200cb963499a2e49b453]['displayData'] = $displayData;
$this->functionData['post'][$count_680568ecb76c200cb963499a2e49b453]['topic'] = $topic;
$this->functionData['post'][$count_680568ecb76c200cb963499a2e49b453]['forum'] = $forum;
}
$IPBHTML .= "<post>
					<id>{$post['post']['pid']}</id>
		...
		" . ((! $topic['_isArchived']) ? ("
				...
				") : ("")) . "				
			<!--hook.if.skin_topic.post.canReportPost.pre.startif-->" . (($topic['_canReport'] and ( $this->memberData['member_id'] ) && ! $topic['_isArchived']) ? ("
...
{
$count_f5d027556fbf817aff90df9ed8987c79 = is_array($this->functionData['show_attachment_title']) ? count($this->functionData['show_attachment_title']) : 0;
$this->functionData['show_attachment_title'][$count_f5d027556fbf817aff90df9ed8987c79]['title'] = $title;
$this->functionData['show_attachment_title'][$count_f5d027556fbf817aff90df9ed8987c79]['data'] = $data;
$this->functionData['show_attachment_title'][$count_f5d027556fbf817aff90df9ed8987c79]['type'] = $type;
}
$IPBHTML .= "<div id='attach_wrap' class='clearfix'>
	<h4>{$title}</h4>
	<ul>
		".$this->__f__d60780e5b3ceaa9c0c8425aadee280c1($title,$data,$type)."	</ul>
</div>";
return $IPBHTML;
}


function __f__d60780e5b3ceaa9c0c8425aadee280c1($title="",$data="",$type="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_6a76c24c133caef3a8a46c6c96a372cb = is_array($this->functionData['Show_attachments']) ? count($this->functionData['Show_attachments']) : 0;
$this->functionData['Show_attachments'][$count_6a76c24c133caef3a8a46c6c96a372cb]['data'] = $data;
}
...
{
$count_475e06256632f528dd877349a7d0e27b = is_array($this->functionData['topicViewTemplate']) ? count($this->functionData['topicViewTemplate']) : 0;
$this->functionData['topicViewTemplate'][$count_475e06256632f528dd877349a7d0e27b]['forum'] = $forum;
$this->functionData['topicViewTemplate'][$count_475e06256632f528dd877349a7d0e27b]['topic'] = $topic;
$this->functionData['topicViewTemplate'][$count_475e06256632f528dd877349a7d0e27b]['post_data'] = $post_data;
$this->functionData['topicViewTemplate'][$count_475e06256632f528dd877349a7d0e27b]['displayData'] = $displayData;
}
...
") : ("")) . "
		...
		<topic>
			...
			<posts>				
" . ((is_array( $post_data ) AND count( $post_data )) ? ("".$this->__f__2d8529e3741d75ab958d48b867a1d1da($forum,$topic,$post_data,$displayData)."") : ("")) . "
			</posts>
		</topic>
	</forum>";
return $IPBHTML;
...
function __f__2d8529e3741d75ab958d48b867a1d1da($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
