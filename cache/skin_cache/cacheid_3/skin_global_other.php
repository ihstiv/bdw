...
{
$count_3f7b7c4fdae2547ad8c00dda41a3ddb8 = is_array($this->functionData['notificationsList']) ? count($this->functionData['notificationsList']) : 0;
$this->functionData['notificationsList'][$count_3f7b7c4fdae2547ad8c00dda41a3ddb8]['notifications'] = $notifications;
}
$IPBHTML .= "<template>popoverNotifications</template>
<notifications>
	".$this->__f__8b6f0da36ee5ea9acf78eb8f122b470e($notifications)."</notifications>";
return $IPBHTML;
}


function __f__8b6f0da36ee5ea9acf78eb8f122b470e($notifications)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ced19bc3639483f826596b51c7260683 = is_array($this->functionData['repButtons']) ? count($this->functionData['repButtons']) : 0;
$this->functionData['repButtons'][$count_ced19bc3639483f826596b51c7260683]['member'] = $member;
$this->functionData['repButtons'][$count_ced19bc3639483f826596b51c7260683]['data'] = $data;
}
