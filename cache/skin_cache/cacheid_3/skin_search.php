...
{
$count_045076ae75498c14c5a2a4748ce6b4b6 = is_array($this->functionData['asForumTopics']) ? count($this->functionData['asForumTopics']) : 0;
$this->functionData['asForumTopics'][$count_045076ae75498c14c5a2a4748ce6b4b6]['data'] = $data;
}
$IPBHTML .= "<searchResult>
	...
	".$this->__f__7e8ee773d1ce48cd852b4f54d688681a($data)."</searchResult>";
return $IPBHTML;
}


function __f__7e8ee773d1ce48cd852b4f54d688681a($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1b55d4225d82f219352a66fc4f5402e8 = is_array($this->functionData['searchResults']) ? count($this->functionData['searchResults']) : 0;
$this->functionData['searchResults'][$count_1b55d4225d82f219352a66fc4f5402e8]['results'] = $results;
$this->functionData['searchResults'][$count_1b55d4225d82f219352a66fc4f5402e8]['titlesOnly'] = $titlesOnly;
}
$IPBHTML .= "" . ((is_array( $results )) ? ("".$this->__f__13d51e5e9c19afeeb6d764152ab30fcb($results,$titlesOnly)."		") : ("")) . "";
return $IPBHTML;
}


function __f__13d51e5e9c19afeeb6d764152ab30fcb($results, $titlesOnly)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
