...
{
$count_95c20fd4f31f16399dd8c1bed8703296 = is_array($this->functionData['notificationsLog']) ? count($this->functionData['notificationsLog']) : 0;
$this->functionData['notificationsLog'][$count_95c20fd4f31f16399dd8c1bed8703296]['notifications'] = $notifications;
$this->functionData['notificationsLog'][$count_95c20fd4f31f16399dd8c1bed8703296]['error'] = $error;
$this->functionData['notificationsLog'][$count_95c20fd4f31f16399dd8c1bed8703296]['pages'] = $pages;
}
$IPBHTML .= "<template>popoverNotifications</template>
<notifications>
	".$this->__f__68a5938e4c56fdb27bfad92bf76df725($notifications,$error,$pages)."</notifications>";
return $IPBHTML;
}


function __f__68a5938e4c56fdb27bfad92bf76df725($notifications, $error='', $pages='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
