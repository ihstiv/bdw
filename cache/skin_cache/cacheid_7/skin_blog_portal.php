...
class skin_blog_portal_7 extends skinMaster{
...
{
$count_7f7f94d74a76db6f603df7019c5f5bb2 = is_array($this->functionData['blogFollowedWrapper']) ? count($this->functionData['blogFollowedWrapper']) : 0;
$this->functionData['blogFollowedWrapper'][$count_7f7f94d74a76db6f603df7019c5f5bb2]['rows'] = $rows;
}
$IPBHTML .= "" . ((is_array($rows) && count($rows)) ? ("
	<table class='ipb_table topic_list' id='forum_table'>
		".$this->__f__846d00254a80997438bcac0c194e79dd($rows)."	</table>
") : ("")) . "";
return $IPBHTML;
}


function __f__846d00254a80997438bcac0c194e79dd($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_a5d029d5f26b4d28614fd8288f4a6019 = is_array($this->functionData['commentSearchResult']) ? count($this->functionData['commentSearchResult']) : 0;
$this->functionData['commentSearchResult'][$count_a5d029d5f26b4d28614fd8288f4a6019]['r'] = $r;
$this->functionData['commentSearchResult'][$count_a5d029d5f26b4d28614fd8288f4a6019]['resultAsTitle'] = $resultAsTitle;
}
...
{
$count_10bacd34a3bc94e86d362e4aaf41d128 = is_array($this->functionData['entrySearchResult']) ? count($this->functionData['entrySearchResult']) : 0;
$this->functionData['entrySearchResult'][$count_10bacd34a3bc94e86d362e4aaf41d128]['r'] = $r;
$this->functionData['entrySearchResult'][$count_10bacd34a3bc94e86d362e4aaf41d128]['resultAsTitle'] = $resultAsTitle;
}
$IPBHTML .= "<tr class='_recordRow " . (($r['newpost']) ? (" unread") : ("")) . "" . (($r['entry_status'] != 'published') ? (" moderated") : ("")) . "'>
	...
	<td>
		" . (($this->settings['blog_enable_rating']) ? ("
			<div class='right'>
				".$this->__f__f70ad7ff853b83dbd6bb4423eff67af3($r,$resultAsTitle)."			</div>
		") : ("")) . "
...
function __f__f70ad7ff853b83dbd6bb4423eff67af3($r, $resultAsTitle=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_2533efb7da0b826ffa7063fd13ffe609 = is_array($this->functionData['followedContentBlogs']) ? count($this->functionData['followedContentBlogs']) : 0;
$this->functionData['followedContentBlogs'][$count_2533efb7da0b826ffa7063fd13ffe609]['rows'] = $rows;
}
$IPBHTML .= "<table class='ipb_table topic_list' id='forum_table'>
	".$this->__f__db510c0b57f2b8c6d39b70f017532259($rows)."</table>";
return $IPBHTML;
}


function __f__5956f8b0c86780a259349c798de967af($rows,$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( array(1,2,3,4,5) as $_rating )
...
function __f__db510c0b57f2b8c6d39b70f017532259($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $data )
	{
		...
		<tr class='_recordRow " . (($data['newpost']) ? ("unread") : ("")) . "'>
			...
			<td valign='top'>
				" . (($this->settings['blog_enable_rating']) ? ("
					<div class='right'>
						".$this->__f__5956f8b0c86780a259349c798de967af($rows,$data)."					</div>
				") : ("")) . "
				" . (($data['_hasDrafts']) ? ("
...
{
$count_54fd28e5a72134c3139b1fc84cc4e826 = is_array($this->functionData['moderatorPanel']) ? count($this->functionData['moderatorPanel']) : 0;
$this->functionData['moderatorPanel'][$count_54fd28e5a72134c3139b1fc84cc4e826]['results'] = $results;
$this->functionData['moderatorPanel'][$count_54fd28e5a72134c3139b1fc84cc4e826]['pages'] = $pages;
}
$IPBHTML .= "" . (($pages) ? ("
	<div>{$pages}</div>
") : ("")) . "
<div class='category_block block_wrap'>
	...
	<div class=\"ipsBox_container\">
		<table id=\"forum_table\" class=\"ipb_table topic_list\">
			" . ((count($results)) ? ("
				".$this->__f__bdffc5ac47ac1029ab65a78a1c1c635f($results,$pages)."			") : ("
				<tr>
...
function __f__bdffc5ac47ac1029ab65a78a1c1c635f($results, $pages='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
<div class='ipsBox'>
	<div class='ipsBox_container'>
		".$this->__f__19d868fc0b022cdb02a90479e127d05c($entries)."	</div>
</div>";
return $IPBHTML;
}


function __f__19d868fc0b022cdb02a90479e127d05c($entries)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_60cc11d90944783804ebb945e21d8600 = is_array($this->functionData['recentEntries']) ? count($this->functionData['recentEntries']) : 0;
$this->functionData['recentEntries'][$count_60cc11d90944783804ebb945e21d8600]['entries'] = $entries;
}
$IPBHTML .= "<div class='ipsSideBlock clearfix'>
	...
	<ul class='ipsList_withminiphoto'>
		" . ((is_array( $entries ) && count( $entries )) ? ("
			".$this->__f__cd45ce46e48f178129a153f849ab61e0($entries)."		") : ("
...
function __f__cd45ce46e48f178129a153f849ab61e0($entries=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_d42e82714cf4e3fda54e6c1b9faec8dd = is_array($this->functionData['tabReputation_entries']) ? count($this->functionData['tabReputation_entries']) : 0;
$this->functionData['tabReputation_entries'][$count_d42e82714cf4e3fda54e6c1b9faec8dd]['entries'] = $entries;
}
$IPBHTML .= "<div class='ipsBox'>
	".$this->__f__b5a6aab2f8198f21627657c8f69083c6($entries)."</div>";
return $IPBHTML;
}


function __f__b5a6aab2f8198f21627657c8f69083c6($entries)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $entries as $entry )
...
{
$count_06fd10b794729b54505ec72c37b72e72 = is_array($this->functionData['unapprovedComments']) ? count($this->functionData['unapprovedComments']) : 0;
$this->functionData['unapprovedComments'][$count_06fd10b794729b54505ec72c37b72e72]['comments'] = $comments;
$this->functionData['unapprovedComments'][$count_06fd10b794729b54505ec72c37b72e72]['pages'] = $pages;
}
$IPBHTML .= "" . (($pages) ? ("
	<div>{$pages}</div>
") : ("")) . "
...
<div class='clearfix'>
	" . ((is_array( $comments ) AND count( $comments )) ? ("
		<div id='ips_Posts2'>
			".$this->__f__d0d1803d20cd7f67c4bc67d86877361c($comments,$pages)."		</div>
	") : ("
...
function __f__d0d1803d20cd7f67c4bc67d86877361c($comments, $pages='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
