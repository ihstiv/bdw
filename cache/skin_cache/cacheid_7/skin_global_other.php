...
class skin_global_other_7 extends skinMaster{
...
{
$count_6f73f7b21574796290d958ded40f9018 = is_array($this->functionData['ajaxPopUpNoPermission']) ? count($this->functionData['ajaxPopUpNoPermission']) : 0;
$this->functionData['ajaxPopUpNoPermission'][$count_6f73f7b21574796290d958ded40f9018]['msg'] = $msg;
}
...
{
$count_9ba47cd14992dc59621997531dc5e338 = is_array($this->functionData['displayBoardOffline']) ? count($this->functionData['displayBoardOffline']) : 0;
$this->functionData['displayBoardOffline'][$count_9ba47cd14992dc59621997531dc5e338]['message'] = $message;
}
$IPBHTML .= "<center>
<img src=\"http://www.bestdestinationwedding.com/bdw-placeholder.jpg\" alt=\"BDW is being updated\">
<br><br>
Thank you for visiting Best Destination Wedding.
<br><br>
We're currently updating the site and expect to be back up and running later today (12/5/13).
<br><br>
We are working hard and getting close, thank you for your patience!
<br><br>
Sincerely,
The Best Destination Wedding team
<br><br>
</center>

<!--<h1 class='ipsType_pagetitle'>" . sprintf( $this->lang->words['board_offline_desc'], $this->settings['board_name']) . "</h1>
...
{
$count_763dae45d3bb0b8dd3b914c8c0847970 = is_array($this->functionData['displayPopUpWindow']) ? count($this->functionData['displayPopUpWindow']) : 0;
$this->functionData['displayPopUpWindow'][$count_763dae45d3bb0b8dd3b914c8c0847970]['documentHeadItems'] = $documentHeadItems;
$this->functionData['displayPopUpWindow'][$count_763dae45d3bb0b8dd3b914c8c0847970]['css'] = $css;
$this->functionData['displayPopUpWindow'][$count_763dae45d3bb0b8dd3b914c8c0847970]['jsLoaderItems'] = $jsLoaderItems;
$this->functionData['displayPopUpWindow'][$count_763dae45d3bb0b8dd3b914c8c0847970]['title'] = $title;
$this->functionData['displayPopUpWindow'][$count_763dae45d3bb0b8dd3b914c8c0847970]['output'] = $output;
}
...
<html xml:lang=\"en\" lang=\"en\" xmlns=\"http://www.w3.org/1999/xhtml\">
	<head>
		...
		" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
			".$this->__f__dcf3dde41e3567ce5227b6f6cfc743a8($documentHeadItems,$css,$jsLoaderItems,$title,$output)."			" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
		...
		" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
			".$this->__f__365f5790037f1204560b3713c9c4d754($documentHeadItems,$css,$jsLoaderItems,$title,$output)."		") : ("")) . "
		<!--[if lte IE 7]>
		...
		" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
			".$this->__f__7eeda3605c2c9590ab772115a47857e5($documentHeadItems,$css,$jsLoaderItems,$title,$output)."		") : ("")) . "
		<script type='text/javascript'>
		...
		" . ((count($documentHeadItems)) ? ("
			".$this->__f__739d60b436af4b917dccf37caaf6ef23($documentHeadItems,$css,$jsLoaderItems,$title,$output)."		") : ("")) . "
...
function __f__dcf3dde41e3567ce5227b6f6cfc743a8($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__365f5790037f1204560b3713c9c4d754($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__7eeda3605c2c9590ab772115a47857e5($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a314387f4bad25ed2610c5f6bbaf1156($documentHeadItems, $css, $jsLoaderItems, $title="", $output="",$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__739d60b436af4b917dccf37caaf6ef23($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__a314387f4bad25ed2610c5f6bbaf1156($documentHeadItems,$css,$jsLoaderItems,$title,$output,$type,$idx)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_aaf82d1c42dbe73bb92f711006bb5089 = is_array($this->functionData['Error']) ? count($this->functionData['Error']) : 0;
$this->functionData['Error'][$count_aaf82d1c42dbe73bb92f711006bb5089]['message'] = $message;
$this->functionData['Error'][$count_aaf82d1c42dbe73bb92f711006bb5089]['code'] = $code;
$this->functionData['Error'][$count_aaf82d1c42dbe73bb92f711006bb5089]['ad_email_one'] = $ad_email_one;
$this->functionData['Error'][$count_aaf82d1c42dbe73bb92f711006bb5089]['ad_email_two'] = $ad_email_two;
$this->functionData['Error'][$count_aaf82d1c42dbe73bb92f711006bb5089]['title'] = $title;
}
...
{
$count_322df03e865e83c3af253c882a11f02f = is_array($this->functionData['facebookPop']) ? count($this->functionData['facebookPop']) : 0;
$this->functionData['facebookPop'][$count_322df03e865e83c3af253c882a11f02f]['user'] = $user;
}
...
<div class='fixed_inner'>
	...
	" . (($user['id']) ? ("
		<ul class='ipsList_withminiphoto' id=\"fParent\">
			<li class='clearfix ipsPad_half'>
				<img src='{$user['photo']}' class='left ipsUserPhoto ipsUserPhoto_small'/>
	...
	<script>
		window.fbAsyncInit = function() {
			FB.init({appId: '{$this->settings['fbc_appid']}', status: true, cookie: true, xfbml: true,version: 'v2.1'});
			if ( $('fParent') )
			{
		...
		(function() {
		    ...
		    e.src = document.location.protocol + '//connect.facebook.net/{$this->settings['fb_locale']}/sdk.js';
...
{
$count_1da2f283bb1194e3b1ae774f4fbe0bd3 = is_array($this->functionData['generateTopicIcon']) ? count($this->functionData['generateTopicIcon']) : 0;
$this->functionData['generateTopicIcon'][$count_1da2f283bb1194e3b1ae774f4fbe0bd3]['imgArray'] = $imgArray;
$this->functionData['generateTopicIcon'][$count_1da2f283bb1194e3b1ae774f4fbe0bd3]['unreadUrl'] = $unreadUrl;
}
...
{
$count_8f98608b3833d5c273c8266d62cc7052 = is_array($this->functionData['globalTemplateMinimal']) ? count($this->functionData['globalTemplateMinimal']) : 0;
$this->functionData['globalTemplateMinimal'][$count_8f98608b3833d5c273c8266d62cc7052]['html'] = $html;
$this->functionData['globalTemplateMinimal'][$count_8f98608b3833d5c273c8266d62cc7052]['documentHeadItems'] = $documentHeadItems;
$this->functionData['globalTemplateMinimal'][$count_8f98608b3833d5c273c8266d62cc7052]['css'] = $css;
$this->functionData['globalTemplateMinimal'][$count_8f98608b3833d5c273c8266d62cc7052]['jsModules'] = $jsModules;
$this->functionData['globalTemplateMinimal'][$count_8f98608b3833d5c273c8266d62cc7052]['metaTags'] = $metaTags;
$this->functionData['globalTemplateMinimal'][$count_8f98608b3833d5c273c8266d62cc7052]['header_items'] = $header_items;
$this->functionData['globalTemplateMinimal'][$count_8f98608b3833d5c273c8266d62cc7052]['items'] = $items;
$this->functionData['globalTemplateMinimal'][$count_8f98608b3833d5c273c8266d62cc7052]['footer_items'] = $footer_items;
$this->functionData['globalTemplateMinimal'][$count_8f98608b3833d5c273c8266d62cc7052]['stats'] = $stats;
}
...
{
$count_aad292af3f846e53e8d242c2d783734d = is_array($this->functionData['inboxList']) ? count($this->functionData['inboxList']) : 0;
$this->functionData['inboxList'][$count_aad292af3f846e53e8d242c2d783734d]['topics'] = $topics;
}
...
<ul class='ipsList_withminiphoto'>
	" . ((count($topics)) ? ("
		".$this->__f__8401f2ee68e969ac099a17f7da80286f($topics)."	") : ("
		<li class='desc'>{$this->lang->words['inbox_list_none']}</li>
	")) . "
</ul>";
return $IPBHTML;
}
...
function __f__8401f2ee68e969ac099a17f7da80286f($topics)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $topics as $topic )
	{
		...
		<li class='" . (($topic['map_has_unread']) ? ("unread") : ("")) . " ipsType_small clearfix'>
			...
			<div class='list_content'>
				...
				<br />
				<span class='ipsType_smaller desc lighter'>{$topic['_starterMemberData']['members_display_name']} - " . IPSText::htmlspecialchars($this->registry->getClass('class_localization')->getDate($topic['msg_date'],"short", 0)) . "</span>
			</div>
		</li>
...
{
$count_17e08a7bbbd88124fc0cdc97160c7bbc = is_array($this->functionData['likeMoreDialogue']) ? count($this->functionData['likeMoreDialogue']) : 0;
$this->functionData['likeMoreDialogue'][$count_17e08a7bbbd88124fc0cdc97160c7bbc]['data'] = $data;
$this->functionData['likeMoreDialogue'][$count_17e08a7bbbd88124fc0cdc97160c7bbc]['relId'] = $relId;
$this->functionData['likeMoreDialogue'][$count_17e08a7bbbd88124fc0cdc97160c7bbc]['cache'] = $cache;
}
$IPBHTML .= "<h3>{$this->lang->words['followed_by']}</h3>
<div class='likepop fixed_inner'>
	" . ((is_array($data) && count($data)) ? ("
		<ul class='ipsList_withminiphoto'>
			".$this->__f__aabce0850d4934f76d53f804f1139c5a($data,$relId,$cache)."		</ul>
	") : ("")) . "
...
function __f__aabce0850d4934f76d53f804f1139c5a($data, $relId, $cache)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		<li class='ipsField ipsField_checkbox'>
			...
			<p class='ipsField_content'>
				...
				<select name=\"freq\" id=\"like_freq\" class=\"input_select\">
					".$this->__f__a3f2b736d2ec0857fb91037791e84e27($app,$area,$relid,$data)."				</select>
			</p>
		</li>
		<li class='ipsField ipsField_checkbox'>
...
function __f__a3f2b736d2ec0857fb91037791e84e27($app, $area, $relid, $data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_6d3b7c34d12484e7cf27aa1f4550c87f = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_6d3b7c34d12484e7cf27aa1f4550c87f]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_6d3b7c34d12484e7cf27aa1f4550c87f]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_6d3b7c34d12484e7cf27aa1f4550c87f]['opts'] = $opts;
}
...
{
$count_e267fd33e448bc05e4c331c2f0467336 = is_array($this->functionData['notificationsList']) ? count($this->functionData['notificationsList']) : 0;
$this->functionData['notificationsList'][$count_e267fd33e448bc05e4c331c2f0467336]['notifications'] = $notifications;
}
...
<ul class='ipsList_withminiphoto'>
	" . ((count($notifications)) ? ("
		".$this->__f__20450f52d586057b0223f2db49cc5afa($notifications)."	") : ("
...
function __f__20450f52d586057b0223f2db49cc5afa($notifications)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $notifications as $notify )
	{
		...
		<li class='" . ((!$notify['notify_read']) ? ("unread") : ("")) . " ipsType_small clearfix'>
			...
			<div class='list_content'>
				...
				") : ("")) . "
				<br />
				<span class='ipsType_smaller desc lighter'>" . IPSText::htmlspecialchars($this->registry->getClass('class_localization')->getDate($notify['notify_sent'],"short", 0)) . "</span>
			</div>
		</li>
...
{
$count_03a492663c37a991e6efea060590fe96 = is_array($this->functionData['questionAndAnswer']) ? count($this->functionData['questionAndAnswer']) : 0;
$this->functionData['questionAndAnswer'][$count_03a492663c37a991e6efea060590fe96]['data'] = $data;
}
...
{
$count_6f0d51a47d9c667a375dfb58f19eacc5 = is_array($this->functionData['quickNavigationPanel']) ? count($this->functionData['quickNavigationPanel']) : 0;
$this->functionData['quickNavigationPanel'][$count_6f0d51a47d9c667a375dfb58f19eacc5]['data'] = $data;
$this->functionData['quickNavigationPanel'][$count_6f0d51a47d9c667a375dfb58f19eacc5]['currentApp'] = $currentApp;
}
$IPBHTML .= "<div>
	".$this->__f__87a4ea99fe9fbdd4faa5fbe665b80279($data,$currentApp)."</div>";
return $IPBHTML;
}


function __f__85a3604126e05d379254adc31c80256e($data=array(), $currentApp='',$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__87a4ea99fe9fbdd4faa5fbe665b80279($data=array(), $currentApp='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data as $_data )
	{
		...
		" . ((is_array($_data['links']) AND count($_data['links'])) ? ("
			".$this->__f__85a3604126e05d379254adc31c80256e($data,$currentApp,$_data)."		") : ("")) . "
		</ul>
...
{
$count_63c3ab7136258aa0037ddac9007fd01c = is_array($this->functionData['quickNavigationWrapper']) ? count($this->functionData['quickNavigationWrapper']) : 0;
$this->functionData['quickNavigationWrapper'][$count