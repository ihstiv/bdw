...
class skin_blog_list_7 extends skinMaster{
...
{
$count_aa6f1aad3d67697a63cb349ac4b5b680 = is_array($this->functionData['blog_rating']) ? count($this->functionData['blog_rating']) : 0;
$this->functionData['blog_rating'][$count_aa6f1aad3d67697a63cb349ac4b5b680]['number'] = $number;
}
$IPBHTML .= "".$this->__f__fff92bd9fcfb2c6e375959fe8d9ea9c1($number)."";
return $IPBHTML;
}


function __f__fff92bd9fcfb2c6e375959fe8d9ea9c1($number)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_2458bc9226e364d7569bbe0f0446f040 = is_array($this->functionData['blogAjaxSidebar']) ? count($this->functionData['blogAjaxSidebar']) : 0;
$this->functionData['blogAjaxSidebar'][$count_2458bc9226e364d7569bbe0f0446f040]['blogs'] = $blogs;
}
$IPBHTML .= "" . ((is_array( $blogs ) && count( $blogs )) ? ("
	".$this->__f__a5575975d4a696d8fea7f50640c9cafa($blogs)."") : ("
...
function __f__a5575975d4a696d8fea7f50640c9cafa($blogs)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e793b3bbc6564ee36df789b39acf7846 = is_array($this->functionData['blogAjaxSidebarREntries']) ? count($this->functionData['blogAjaxSidebarREntries']) : 0;
$this->functionData['blogAjaxSidebarREntries'][$count_e793b3bbc6564ee36df789b39acf7846]['entries'] = $entries;
}
$IPBHTML .= "" . ((is_array( $entries ) && count( $entries )) ? ("
	".$this->__f__cea1c299a2c8ed2b6fed9ad2cd3d71ca($entries)."") : ("
...
function __f__cea1c299a2c8ed2b6fed9ad2cd3d71ca($entries)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_290f0ab2a0ce3f01954f8c9671bc8384 = is_array($this->functionData['blogFeaturedEntry']) ? count($this->functionData['blogFeaturedEntry']) : 0;
$this->functionData['blogFeaturedEntry'][$count_290f0ab2a0ce3f01954f8c9671bc8384]['featured'] = $featured;
}
...
{
$count_87c906d39bf2a4cde26085d7054659be = is_array($this->functionData['blogIndexPage']) ? count($this->functionData['blogIndexPage']) : 0;
$this->functionData['blogIndexPage'][$count_87c906d39bf2a4cde26085d7054659be]['pages'] = $pages;
$this->functionData['blogIndexPage'][$count_87c906d39bf2a4cde26085d7054659be]['featured'] = $featured;
$this->functionData['blogIndexPage'][$count_87c906d39bf2a4cde26085d7054659be]['blogs'] = $blogs;
$this->functionData['blogIndexPage'][$count_87c906d39bf2a4cde26085d7054659be]['extra'] = $extra;
$this->functionData['blogIndexPage'][$count_87c906d39bf2a4cde26085d7054659be]['type'] = $type;
$this->functionData['blogIndexPage'][$count_87c906d39bf2a4cde26085d7054659be]['sorting'] = $sorting;
$this->functionData['blogIndexPage'][$count_87c906d39bf2a4cde26085d7054659be]['pinned'] = $pinned;
}
	...
	" . (($this->memberData['member_id']) ? ("<ul class='topic_buttons'>
		...
		" . ((is_array($this->memberData['has_blog']) && count($this->memberData['has_blog'])) ? ("
			<ul class=\"ipbmenu_content\" id='addentrylink_menucontent' style='display:none' >
				".$this->__f__4f0491dec005bddc6417a51817d4f985($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."			</ul>
		") : ("")) . "") : ("")) . "
	<h1 class='ipsType_pagetitle left'>" . IPSLib::getAppTitle('blog') . "</h1>
</div>
<br class='clear' />
<br />
" . (($type == 'dash') ? ("<div class='ipsLayout ipsLayout_withright ipsLayout_bigright'>
		...
		" . ((is_array( $pinned ) AND count( $pinned )) ? ("
			<div class='ipsSideBlock clearfix'>
				...
				<ul class='ipsList_withminiphoto'>
					".$this->__f__b68a21c01fec766cb27114eb1d2447c7($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."				</ul>
			</div>
		") : ("")) . "
		...
		<div id='blogs_filter_menucontent' class='ipbmenu_content ipsPad' style='display: none'>
			<form id='filter_form' action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=blog&amp;type=all", "public",'' ), "false", "app=blog" ) . "\" method=\"post\">
				...
				<select name='filter' id='filter' class='input_select'>
					".$this->__f__eae8918ab49eb6c74bae3663f33117fd($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."				</select>
				<br /><br />
				
				<strong>{$this->lang->words['blist_sort_on']}</strong><br />
				<select name='sort_key' id='sort_key' class='input_select'>
					".$this->__f__c39c31a4ac24d2dca59a1dac1a13e95d($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."				</select>
				<br /><br />
				
				<strong>{$this->lang->words['by_sort']}</strong><br />
				<select name='sort_order' id='sort_order' class='input_select'>
					".$this->__f__58a2c907e387e96aa539564a95f61b10($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."				</select>
				<br /><br />
				
				<strong>{$this->lang->words['blist_per_page']}</strong><br />
				<select name='max_results' id='max_results' class='input_select'>
					".$this->__f__295324c57d66837601ff023c454547cc($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."				</select>
				<br /><br />
		...
		") : ("<div class='ipsBox clear'>
				...
				" . (($type == 'dash') ? ("<!-- FEATURED -->
					" . ((is_array($featured) AND count($featured)) ? ("
						".$this->__f__b2ab34d5ed31d9f1dcee67dd7a881b97($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."					") : ("")) . "
					<!--NORMALS-->
					" . ((is_array( $blogs['normal'] ) && count( $blogs['normal'] )) ? ("
						".$this->__f__9edd2872da6d561900978dbb9ae06b23($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."					") : ("")) . "") : ("<script type='text/javascript'>
					...
					<div class='ipsBox_container'>
						<table class='ipb_table'>
							...
							" . ((is_array($featured) AND count($featured)) ? ("
								".$this->__f__5a586bd3805a78dbba421f25f28dfddd($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."							") : ("")) . "
							" . ((is_array( $blogs['pinned'] ) && count( $blogs['pinned'] )) ? ("
								".$this->__f__73e234d37f7bfef42845519beded6b46($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."							") : ("")) . "
							" . ((is_array( $blogs['normal'] ) && count( $blogs['normal'] )) ? ("
								".$this->__f__deefaf1d458788d06219087b614b93c9($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."							") : ("")) . "
						</table>
					</div>
					<script type='text/javascript'>
...
function __f__4f0491dec005bddc6417a51817d4f985($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b68a21c01fec766cb27114eb1d2447c7($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__eae8918ab49eb6c74bae3663f33117fd($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__c39c31a4ac24d2dca59a1dac1a13e95d($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__58a2c907e387e96aa539564a95f61b10($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__295324c57d66837601ff023c454547cc($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b2ab34d5ed31d9f1dcee67dd7a881b97($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__9edd2872da6d561900978dbb9ae06b23($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__5a586bd3805a78dbba421f25f28dfddd($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $featured as $fid => $entry )
...
function __f__73e234d37f7bfef42845519beded6b46($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__deefaf1d458788d06219087b614b93c9($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_816a491566ab6102fcd8f80a3a9839d4 = is_array($this->functionData['blogListRow']) ? count($this->functionData['blogListRow']) : 0;
$this->functionData['blogListRow'][$count_816a491566ab6102fcd8f80a3a9839d4]['entry'] = $entry;
$this->functionData['blogListRow'][$count_816a491566ab6102fcd8f80a3a9839d4]['outSideBlog'] = $outSideBlog;
}
...
{
$count_068428fe007479698f603b7f6e6ed559 = is_array($this->functionData['blogTableRow']) ? count($this->functionData['blogTableRow']) : 0;
$this->functionData['blogTableRow'][$count_068428fe007479698f603b7f6e6ed559]['blog'] = $blog;
}
...
{
$count_932e01d7f0fa1875da4ef9c349095367 = is_array($this->functionData['generateBlogIcon']) ? count($this->functionData['generateBlogIcon']) : 0;
$this->functionData['generateBlogIcon'][$count_932e01d7f0fa1875da4ef9c349095367]['data'] = $data;
}
