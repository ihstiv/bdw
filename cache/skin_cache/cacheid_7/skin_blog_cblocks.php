...
class skin_blog_cblocks_7 extends skinMaster{
...
{
$count_f81f7f2df943f8fb44b12ba8636c497a = is_array($this->functionData['block_activeusers']) ? count($this->functionData['block_activeusers']) : 0;
$this->functionData['block_activeusers'][$count_f81f7f2df943f8fb44b12ba8636c497a]['active'] = $active;
}
...
")) . "" . ((is_array( $categories ) AND count( $categories )) ? ("".$this->__f__7c7383df7b08370b02fe8303801ce6e6($blogid,$categories)."	") : ("")) . "
</ul>";
return $IPBHTML;
}


function __f__7c7383df7b08370b02fe8303801ce6e6($blogid, $categories=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_96c4c8dda868b24ce3a7c1d628d48c55 = is_array($this->functionData['cblock_footer']) ? count($this->functionData['cblock_footer']) : 0;
$this->functionData['cblock_footer'][$count_96c4c8dda868b24ce3a7c1d628d48c55]['cblock'] = $cblock;
$this->functionData['cblock_footer'][$count_96c4c8dda868b24ce3a7c1d628d48c55]['auth_key'] = $auth_key;
}
$IPBHTML .= "</div>
...
{
$count_85a3d8d9b033c475db62993488621ca0 = is_array($this->functionData['cblock_friends']) ? count($this->functionData['cblock_friends']) : 0;
$this->functionData['cblock_friends'][$count_85a3d8d9b033c475db62993488621ca0]['friends'] = $friends;
}
$IPBHTML .= "" . ((is_array( $friends ) && count( $friends )) ? ("
	<ul class='ipsList_withminiphoto ipsPad_half'>
		".$this->__f__6f7516f5d3744d3a1c47ffb3d977e9fe($friends)."	</ul>
") : ("
...
function __f__6f7516f5d3744d3a1c47ffb3d977e9fe($friends=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_8f6715284b2ad30a53f15b7b86443fdf = is_array($this->functionData['cblock_header']) ? count($this->functionData['cblock_header']) : 0;
$this->functionData['cblock_header'][$count_8f6715284b2ad30a53f15b7b86443fdf]['cblock'] = $cblock;
$this->functionData['cblock_header'][$count_8f6715284b2ad30a53f15b7b86443fdf]['title'] = $title;
$this->functionData['cblock_header'][$count_8f6715284b2ad30a53f15b7b86443fdf]['configable'] = $configable;
$this->functionData['cblock_header'][$count_8f6715284b2ad30a53f15b7b86443fdf]['nopad'] = $nopad;
}
...
{
$count_e61dab364b996ccd7d8a278cee519759 = is_array($this->functionData['comments']) ? count($this->functionData['comments']) : 0;
$this->functionData['comments'][$count_e61dab364b996ccd7d8a278cee519759]['comments'] = $comments;
}
$IPBHTML .= "<ul class='ipsList_withminiphoto ipsPad_half'>
	" . ((is_array( $comments ) && count( $comments )) ? ("
		".$this->__f__5f801f47cbfd3a3bf0c8c82153c7445e($comments)."	") : ("
...
function __f__5f801f47cbfd3a3bf0c8c82153c7445e($comments=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_67f51619b59470deee59669187e30973 = is_array($this->functionData['latest_visitors']) ? count($this->functionData['latest_visitors']) : 0;
$this->functionData['latest_visitors'][$count_67f51619b59470deee59669187e30973]['visitors'] = $visitors;
}
$IPBHTML .= "" . ((is_array( $visitors ) && count( $visitors )) ? ("
	<ul class='ipsList_withminiphoto ipsPad_half'>
		".$this->__f__56e39753d3949d8243d3f8de84d87ec2($visitors)."	</ul>
") : ("
...
function __f__56e39753d3949d8243d3f8de84d87ec2($visitors=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_f4fd278615b0589417a3fefd5ae9fb4b = is_array($this->functionData['mini_cal_mini_wrap']) ? count($this->functionData['mini_cal_mini_wrap']) : 0;
$this->functionData['mini_cal_mini_wrap'][$count_f4fd278615b0589417a3fefd5ae9fb4b]['content'] = $content;
$this->functionData['mini_cal_mini_wrap'][$count_f4fd278615b0589417a3fefd5ae9fb4b]['days'] = $days;
}
$IPBHTML .= "<table class='mini_cal row1'>
	<tr class='header'>
		".$this->__f__67a497f6ada7281f3a08564468d605da($content,$days)."	</tr>
	<tr>
		{$content}
	</tr>
</table>";
...
function __f__67a497f6ada7281f3a08564468d605da($content="", $days)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $days as $day )
...
{
$count_68781bf581839b9ee8a073264b52081d = is_array($this->functionData['recentEntries']) ? count($this->functionData['recentEntries']) : 0;
$this->functionData['recentEntries'][$count_68781bf581839b9ee8a073264b52081d]['entries'] = $entries;
}
$IPBHTML .= "<ul class='ipsList_withminiphoto ipsPad_half'>
	" . ((is_array( $entries ) && count( $entries )) ? ("
		".$this->__f__a86fc0742e56bbffcfc73d986b1635f8($entries)."	") : ("
...
function __f__a86fc0742e56bbffcfc73d986b1635f8($entries=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
