...
class skin_calendar_7 extends skinMaster{
...
{
$count_4aa708ed088b88883daa50f229c670ab = is_array($this->functionData['bbCodeEvent']) ? count($this->functionData['bbCodeEvent']) : 0;
$this->functionData['bbCodeEvent'][$count_4aa708ed088b88883daa50f229c670ab]['event'] = $event;
$this->functionData['bbCodeEvent'][$count_4aa708ed088b88883daa50f229c670ab]['type'] = $type;
$this->functionData['bbCodeEvent'][$count_4aa708ed088b88883daa50f229c670ab]['ends'] = $ends;
}
...
{
$count_07dbf2a20914e8936333dc312cb0e324 = is_array($this->functionData['boardIndexBirthdays']) ? count($this->functionData['boardIndexBirthdays']) : 0;
$this->functionData['boardIndexBirthdays'][$count_07dbf2a20914e8936333dc312cb0e324]['birthdays'] = $birthdays;
$this->functionData['boardIndexBirthdays'][$count_07dbf2a20914e8936333dc312cb0e324]['data'] = $data;
}
		...
		<div class='_sbcollapsable'>
			" . ((count( $birthdays )) ? ("
				<ul class='ipsList_withminiphoto'>
					".$this->__f__979c1c91046401a644fdd2c8f0a7ab45($birthdays,$data)."				</ul>
			") : ("
...
function __f__979c1c91046401a644fdd2c8f0a7ab45($birthdays, $data=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_4158bba123537c1f1cf2dd152739f5c9 = is_array($this->functionData['boardIndexCalEvents']) ? count($this->functionData['boardIndexCalEvents']) : 0;
$this->functionData['boardIndexCalEvents'][$count_4158bba123537c1f1cf2dd152739f5c9]['events'] = $events;
}
		...
		<div class='_sbcollapsable'>
			" . ((is_array( $events )) ? ("
				<ul itemscope itemtype=\"http://schema.org/Event\" class='ipsList_withminiphoto'>
					".$this->__f__82a8a9e7373abd3c9a4d60f80ff94b34($events)."				</ul>
			") : ("
...
function __f__82a8a9e7373abd3c9a4d60f80ff94b34($events)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_c8ca802b6d1c0a8b0fef1e214117bf97 = is_array($this->functionData['cal_date_cell']) ? count($this->functionData['cal_date_cell']) : 0;
$this->functionData['cal_date_cell'][$count_c8ca802b6d1c0a8b0fef1e214117bf97]['day'] = $day;
$this->functionData['cal_date_cell'][$count_c8ca802b6d1c0a8b0fef1e214117bf97]['events'] = $events;
$this->functionData['cal_date_cell'][$count_c8ca802b6d1c0a8b0fef1e214117bf97]['cal_date_queued'] = $cal_date_queued;
$this->functionData['cal_date_cell'][$count_c8ca802b6d1c0a8b0fef1e214117bf97]['queued'] = $queued;
$this->functionData['cal_date_cell'][$count_c8ca802b6d1c0a8b0fef1e214117bf97]['js_id'] = $js_id;
}
$IPBHTML .= "<!--Day-->
...
{
$count_0da4fe5a1433a23ac6b57b2591fb73fe = is_array($this->functionData['cal_date_cell_today']) ? count($this->functionData['cal_date_cell_today']) : 0;
$this->functionData['cal_date_cell_today'][$count_0da4fe5a1433a23ac6b57b2591fb73fe]['day'] = $day;
$this->functionData['cal_date_cell_today'][$count_0da4fe5a1433a23ac6b57b2591fb73fe]['events'] = $events;
$this->functionData['cal_date_cell_today'][$count_0da4fe5a1433a23ac6b57b2591fb73fe]['cal_date_queued'] = $cal_date_queued;
$this->functionData['cal_date_cell_today'][$count_0da4fe5a1433a23ac6b57b2591fb73fe]['queued'] = $queued;
$this->functionData['cal_date_cell_today'][$count_0da4fe5a1433a23ac6b57b2591fb73fe]['js_id'] = $js_id;
}
$IPBHTML .= "<!--Day-->
...
{
$count_4a0ac80549bb3dfaf13783c426315aa8 = is_array($this->functionData['cal_week_dayentry']) ? count($this->functionData['cal_week_dayentry']) : 0;
$this->functionData['cal_week_dayentry'][$count_4a0ac80549bb3dfaf13783c426315aa8]['wday'] = $wday;
$this->functionData['cal_week_dayentry'][$count_4a0ac80549bb3dfaf13783c426315aa8]['date'] = $date;
$this->functionData['cal_week_dayentry'][$count_4a0ac80549bb3dfaf13783c426315aa8]['month'] = $month;
$this->functionData['cal_week_dayentry'][$count_4a0ac80549bb3dfaf13783c426315aa8]['mid'] = $mid;
$this->functionData['cal_week_dayentry'][$count_4a0ac80549bb3dfaf13783c426315aa8]['year'] = $year;
$this->functionData['cal_week_dayentry'][$count_4a0ac80549bb3dfaf13783c426315aa8]['events'] = $events;
$this->functionData['cal_week_dayentry'][$count_4a0ac80549bb3dfaf13783c426315aa8]['queued'] = $queued;
}
...
{
$count_9627f4570cbf6d3cfc58915c71d4f470 = is_array($this->functionData['calendar_likeSummaryContents']) ? count($this->functionData['calendar_likeSummaryContents']) : 0;
$this->functionData['calendar_likeSummaryContents'][$count_9627f4570cbf6d3cfc58915c71d4f470]['data'] = $data;
$this->functionData['calendar_likeSummaryContents'][$count_9627f4570cbf6d3cfc58915c71d4f470]['relId'] = $relId;
$this->functionData['calendar_likeSummaryContents'][$count_9627f4570cbf6d3cfc58915c71d4f470]['opts'] = $opts;
}
...
{
$count_b585f1f3e8bb4e169eb1fa21ecc69f02 = is_array($this->functionData['calendarBirthdayList']) ? count($this->functionData['calendarBirthdayList']) : 0;
$this->functionData['calendarBirthdayList'][$count_b585f1f3e8bb4e169eb1fa21ecc69f02]['rows'] = $rows;
}
$IPBHTML .= "<h2 class='ipsType_subtitle'>{$this->lang->words['celebrating_bday']}</h2>
<br />
" . ((is_array( $rows ) and count( $rows )) ? ("
	".$this->__f__39e797b8241ca7886fb60ea9e5f62210($rows)."") : ("
	<br />
...
function __f__39e797b8241ca7886fb60ea9e5f62210($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_db5980fe5a05de867982c2cc7ef03d1b = is_array($this->functionData['calendarEventForm']) ? count($this->functionData['calendarEventForm']) : 0;
$this->functionData['calendarEventForm'][$count_db5980fe5a05de867982c2cc7ef03d1b]['data'] = $data;
}
...
{
$count_807f7444a031fc37d41666d02575fdda = is_array($this->functionData['calendarEventsList']) ? count($this->functionData['calendarEventsList']) : 0;
$this->functionData['calendarEventsList'][$count_807f7444a031fc37d41666d02575fdda]['data'] = $data;
}
...
{
$count_eebae37a140816ad658c46050cd7302f = is_array($this->functionData['calendarJump']) ? count($this->functionData['calendarJump']) : 0;
$this->functionData['calendarJump'][$count_eebae37a140816ad658c46050cd7302f]['calendars'] = $calendars;
$this->functionData['calendarJump'][$count_eebae37a140816ad658c46050cd7302f]['calendar'] = $calendar;
$this->functionData['calendarJump'][$count_eebae37a140816ad658c46050cd7302f]['chosen_date'] = $chosen_date;
}
$IPBHTML .= "" . ((is_array( $calendars ) && count( $calendars ) > 1) ? ("
	...
	<ul class='ipbmenu_content' style='display: none' id='calendar_chooser_menucontent'>
		".$this->__f__1620583aa4b35ddab11f787af2311a7d($calendars,$calendar,$chosen_date)."	</ul>
	<script type='text/javascript'>
...
function __f__1620583aa4b35ddab11f787af2311a7d($calendars, $calendar, $chosen_date=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_83e3291747928ae2dca3a5cf09423546 = is_array($this->functionData['calendarMainContent']) ? count($this->functionData['calendarMainContent']) : 0;
$this->functionData['calendarMainContent'][$count_83e3291747928ae2dca3a5cf09423546]['data'] = $data;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("calendar", "0" ) . "
<script type='text/javascript'>
	ipb.vars['month_url'] = \"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=calendar&module=calendar&section=view&cal_id={$data['calendar']['cal_id']}", "public",'' ), "", "" ) . "\";
...
<div class='ipsBox'>
	<div class='ipsBox_container'>
		<table id='calendar_table' class='ipsCalendar ipb_table vcalendar' summary=\"{$this->lang->words['calendar_for']} {$data['month_title']} {$data['chosen_date']['year']}\">
			<tr class='header'>
				".$this->__f__13074d9d778008d6bbb20b7616011d48($data)."				{$data['events']}
			</tr>
		</table>
	</div>
</div>
...
function __f__13074d9d778008d6bbb20b7616011d48($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_6a6e52494861b6cc5bd717c15b89b3fa = is_array($this->functionData['calendarWeekView']) ? count($this->functionData['calendarWeekView']) : 0;
$this->functionData['calendarWeekView'][$count_6a6e52494861b6cc5bd717c15b89b3fa]['data'] = $data;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("calendar", "0" ) . "
<script type='text/javascript'>
	ipb.vars['month_url'] = \"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=calendar&module=calendar&section=view&cal_id={$data['calendar']['cal_id']}", "public",'' ), "", "" ) . "\";
...
{
$count_766e52b13eab23b4fc21991f36bcec12 = is_array($this->functionData['calEventFollowedWrapper']) ? count($this->functionData['calEventFollowedWrapper']) : 0;
$this->functionData['calEventFollowedWrapper'][$count_766e52b13eab23b4fc21991f36bcec12]['rows'] = $rows;
}
...
$IPBHTML .= "<div id='search_results'>
	<ol>
		" . ((is_array($rows) && count($rows)) ? ("
			".$this->__f__cca93408e4bdd87ddacb5c1610db5b00($rows)."		") : ("")) . "
	</ol>
</div>";
return $IPBHTML;
}
...
function __f__cca93408e4bdd87ddacb5c1610db5b00($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_8e44703edf1233e6c05ee399b26b7ea3 = is_array($this->functionData['calEventSearchResult']) ? count($this->functionData['calEventSearchResult']) : 0;
$this->functionData['calEventSearchResult'][$count_8e44703edf1233e6c05ee399b26b7ea3]['r'] = $r;
$this->functionData['calEventSearchResult'][$count_8e44703edf1233e6c05ee399b26b7ea3]['resultAsTitle'] = $resultAsTitle;
$this->functionData['calEventSearchResult'][$count_8e44703edf1233e6c05ee399b26b7ea3]['type'] = $type;
$this->functionData['calEventSearchResult'][$count_8e44703edf1233e6c05ee399b26b7ea3]['ends'] = $ends;
}
...
{
$count_fed82d843283ac771bb2520810424d26 = is_array($this->functionData['event_likeSummaryContents']) ? count($this->functionData['event_likeSummaryContents']) : 0;
$this->functionData['event_likeSummaryContents'][$count_fed82d843283ac771bb2520810424d26]['data'] = $data;
$this->functionData['event_likeSummaryContents'][$count_fed82d843283ac771bb2520810424d26]['relId'] = $relId;
$this->functionData['event_likeSummaryContents'][$count_fed82d843283ac771bb2520810424d26]['opts'] = $opts;
}
$IPBHTML .= "<span class='ipsButton_extra right " . (($data['totalCount']) ? ("_fmore clickable") : ("")) . "' title='" . sprintf( $this->lang->words['like_totalcount_' . $data['vernacular'] ], $data['totalCount'] ) . "' data-tooltip=\"" . sprintf( $this->lang->words['like_totalcount_' . $data['vernacular'] ], $data['totalCount'] ) . "\"><img src='{$this->settings['img_url']}/icon_users.png' /> <strong>{$data['totalCount']}</strong></span>
" . (($this->memberData['member_id']) ? ("<a href='#' title=\"" . (($data['iLike']) ? ("" . sprintf( $this->lang->words['fave_tt_on'], $this->lang->words['like_ucfirst_un' . $data['vernacular'] ]) . "") : ("" . sprintf( $this->lang->words['fave_tt_off'], $this->lang->words['like_ucfirst_' . $data['vernacular'] ]) . "")) . "\" class='ftoggle ipsButton_secondary'>" . (($data['iLike']) ? ("" . sprintf( $this->lang->words['unset_fave_button'], $this->lang->words['like_ucfirst_un' . $data['vernacular'] ]) . "") : ("" . sprintf( $this->lang->words['set_fave_button'], $this->lang->words['like_ucfirst_' . $data['vernacular'] ]) . "")) . "</a>") : ("")) . "";
return $IPBHTML;
...
{
$count_86cd0a53ef6cf6668d8d85adbb960942 = is_array($this->functionData['eventAttendee']) ? count($this->functionData['eventAttendee']) : 0;
$this->functionData['eventAttendee'][$count_86cd0a53ef6cf6668d8d85adbb960942]['member'] = $member;
$this->functionData['eventAttendee'][$count_86cd0a53ef6cf6668d8d85adbb960942]['event'] = $event;
}
...
{
$count_4ac77b2a2f1e2343249047343a19e607 = is_array($this->functionData['followedContentCalendars']) ? count($this->functionData['followedContentCalendars']) : 0;
$this->functionData['followedContentCalendars'][$count_4ac77b2a2f1e2343249047343a19e607]['rows'] = $rows;
}
$IPBHTML .= "<div id='search_results'>
	<ol>
		".$this->__f__cdbc768c20ef825d5b6a6b2822eec72b($rows)."	</ol>
</div>";
return $IPBHTML;
}


function __f__cdbc768c20ef825d5b6a6b2822eec72b($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $r )
...
{
$count_0df6f1574c3631baedcc9ea8764e480c = is_array($this->functionData['mini_cal_date_cell']) ? count($this->functionData['mini_cal_date_cell']) : 0;
$this->functionData['mini_cal_date_cell'][$count_0df6f1574c3631baedcc9ea8764e480c]['day'] = $day;
}
$IPBHTML .= "<td>
...
{
$count_fe2d1918eb5687717086fc7982979b5e = is_array($this->functionData['mini_cal_date_cell_today']) ? count($this->functionData['mini_cal_date_cell_today']) : 0;
$this->functionData['mini_cal_date_cell_today'][$count_fe2d1918eb5687717086fc7982979b5e]['day'] = $day;
}
...
{
$count_97989e17927f6c49b029b5eec002bcb9 = is_array($this->functionData['miniCalendarWrapper']) ? count($this->functionData['miniCalendarWrapper']) : 0;
$this->functionData['miniCalendarWrapper'][$count_97989e17927f6c49b029b5eec002bcb9]['data'] = $data;
}
$IPBHTML .= "<div class='mini_cal_wrap ipsBox'>
	<div class='ipsBox_container'>
		...
		<table class='mini_cal vcalendar'>
			<tr>
				".$this->__f__6fbe3f37a43be9497fa565735e70c8f0($data)."			
				{$data['events']}
			</tr>
		</table>
	</div>
...
function __f__6fbe3f37a43be9497fa565735e70c8f0($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data['day_words'] as $day )
...
{
$count_f31470af19c9dd2cb4874c02a1616791 = is_array($this->functionData['modEventsWrapper']) ? count($this->functionData['modEventsWrapper']) : 0;
$this->functionData['modEventsWrapper'][$count_f31470af19c9dd2cb4874c02a1616791]['events'] = $events;
$this->functionData['modEventsWrapper'][$count_f31470af19c9dd2cb4874c02a1616791]['pages'] = $pages;
}
...
<div class='clearfix'>
	" . ((count($events)) ? ("
		".$this->__f__a65998806410efd0c1965566607775a4($events,$pages)."	") : ("
...
function __f__a65998806410efd0c1965566607775a4($events, $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $events as $event )
...
{
$count_36987b5afcafcfc21ea41bdec0128c6d = is_array($this->functionData['showEvent']) ? count($this->functionData['showEvent']) : 0;
$this->functionData['showEvent'][$count_36987b5afcafcfc21ea41bdec0128c6d]['event'] = $event;
$this->functionData['showEvent'][$count_36987b5afcafcfc21ea41bdec0128c6d]['member'] = $member;
$this->functionData['showEvent'][$count_36987b5afcafcfc21ea41bdec0128c6d]['typeInfo'] = $typeInfo;
$this->functionData['showEvent'][$count_36987b5afcafcfc21ea41bdec0128c6d]['like'] = $like;
}
	...
	" . (($event['event_rsvp']) ? ("<div class='ipsBox_container ipsLayout_right'>
			<div id='event_rsvp' class='ipsPad'>
				...
				" . ((count($event['_rsvp_attendees_short'])) ? ("
					...
					".$this->__f__1ed1e305055c2f973c60bdc177dc9ca8($event,$member,$typeInfo,$like)."					</ul>
				") : ("
		...
		" . (($event['_rsvp_count'] > count( $event['_rsvp_attendees_short'] )) ? ("
			<div id='see_all_attendees_popup' style='display: none'>
				...
				<div class='fixed_inner'>
					...
					".$this->__f__b122f91ec70f08136ee9fd935187c576($event,$member,$typeInfo,$like)."					</ul>
				</div>
			</div>
			<script type='text/javascript'>
...
function __f__1ed1e305055c2f973c60bdc177dc9ca8($event, $member, $typeInfo, $like='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b122f91ec70f08136ee9fd935187c576($event, $member, $typeInfo, $like='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_047f415ed87281c653e0e21f68bfba56 = is_array($this->functionData['showEventSimple']) ? count($this->functionData['showEventSimple']) : 0;
$this->functionData['showEventSimple'][$count_047f415ed87281c653e0e21f68bfba56]['event'] = $event;
}
		...
		<div class='post_body'>
			...
			" . (($event['event_rsvp']) ? ("<div class='rsvp'>
					" . ((count( $event['_rsvp_attendees'] )) ? ("
						...
						<div class='clearfix'>
							".$this->__f__702a10bdc5a8ea3eea75f7fa63fa1bdf($event)."						</div>
					") : ("
...
function __f__702a10bdc5a8ea3eea75f7fa63fa1bdf($event)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
