...
class skin_blog_show_7 extends skinMaster{
...
{
$count_50720e64bdb261609ec292fbaf61eb9f = is_array($this->functionData['blogArchive']) ? count($this->functionData['blogArchive']) : 0;
$this->functionData['blogArchive'][$count_50720e64bdb261609ec292fbaf61eb9f]['blog'] = $blog;
$this->functionData['blogArchive'][$count_50720e64bdb261609ec292fbaf61eb9f]['links'] = $links;
$this->functionData['blogArchive'][$count_50720e64bdb261609ec292fbaf61eb9f]['entries'] = $entries;
$this->functionData['blogArchive'][$count_50720e64bdb261609ec292fbaf61eb9f]['cb_left_html'] = $cb_left_html;
$this->functionData['blogArchive'][$count_50720e64bdb261609ec292fbaf61eb9f]['cb_right_html'] = $cb_right_html;
$this->functionData['blogArchive'][$count_50720e64bdb261609ec292fbaf61eb9f]['followData'] = $followData;
}
	...
	<div id='main_column'>
		...
		" . ((is_array( $entries ) && count( $entries )) ? ("
			<table class='ipb_table'>
								".$this->__f__45a9bac9d2e5f6737cd134c49216230b($blog,$links,$entries,$cb_left_html,$cb_right_html,$followData)."			</table>
...
function __f__45a9bac9d2e5f6737cd134c49216230b($blog, $links, $entries=array(), $cb_left_html="", $cb_right_html="", $followData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_7c63cbfd5b6213d030cf59d35357b192 = is_array($this->functionData['blogEntryView']) ? count($this->functionData['blogEntryView']) : 0;
$this->functionData['blogEntryView'][$count_7c63cbfd5b6213d030cf59d35357b192]['blog'] = $blog;
$this->functionData['blogEntryView'][$count_7c63cbfd5b6213d030cf59d35357b192]['comments_html'] = $comments_html;
$this->functionData['blogEntryView'][$count_7c63cbfd5b6213d030cf59d35357b192]['header'] = $header;
$this->functionData['blogEntryView'][$count_7c63cbfd5b6213d030cf59d35357b192]['entry'] = $entry;
$this->functionData['blogEntryView'][$count_7c63cbfd5b6213d030cf59d35357b192]['poll_html'] = $poll_html;
$this->functionData['blogEntryView'][$count_7c63cbfd5b6213d030cf59d35357b192]['trackbacks_html'] = $trackbacks_html;
$this->functionData['blogEntryView'][$count_7c63cbfd5b6213d030cf59d35357b192]['links'] = $links;
$this->functionData['blogEntryView'][$count_7c63cbfd5b6213d030cf59d35357b192]['cblocks'] = $cblocks;
$this->functionData['blogEntryView'][$count_7c63cbfd5b6213d030cf59d35357b192]['follow'] = $follow;
$this->functionData['blogEntryView'][$count_7c63cbfd5b6213d030cf59d35357b192]['tags'] = $tags;
}
				...
				<div class='entry" . (($entry['entry_status'] != 'published') ? (" moderated") : ("")) . "" . (($entry['hide_private']) ? (" private") : ("")) . "' id='entry_{$entry['entry_id']}'>
					<div class='entry_header row2 ipsPad_half'>
						...
						" . (($this->settings['blog_enable_rating']) ? ("" . (($blog['_allow_rating']) ? ("
							...
							") : ("")) . "
							".$this->__f__77545c217387e0b08269fd80392a24a1($blog,$comments_html,$header,$entry,$poll_html,$trackbacks_html,$links,$cblocks,$follow,$tags)."							<span id='rating_text'>
...
function __f__77545c217387e0b08269fd80392a24a1($blog, $comments_html, $header, $entry, $poll_html, $trackbacks_html, $links, $cblocks, $follow, $tags=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_0717ce498b9b92c32cfbfc973b10197b = is_array($this->functionData['blogView']) ? count($this->functionData['blogView']) : 0;
$this->functionData['blogView'][$count_0717ce498b9b92c32cfbfc973b10197b]['blog'] = $blog;
$this->functionData['blogView'][$count_0717ce498b9b92c32cfbfc973b10197b]['links'] = $links;
$this->functionData['blogView'][$count_0717ce498b9b92c32cfbfc973b10197b]['entries'] = $entries;
$this->functionData['blogView'][$count_0717ce498b9b92c32cfbfc973b10197b]['dates'] = $dates;
$this->functionData['blogView'][$count_0717ce498b9b92c32cfbfc973b10197b]['cblocks'] = $cblocks;
$this->functionData['blogView'][$count_0717ce498b9b92c32cfbfc973b10197b]['followData'] = $followData;
}
	...
	<div id='main_column'>
		...
		" . ((!is_array($entries) || !count($entries)) ? ("<p class='no_messages ipsType_subtitle short'>
				" . (($this->request['cat'] OR $this->request['tag']) ? ("{$this->lang->words['no_entry_matches']}") : ("{$blog['blog_name']} {$this->lang->words['no_entries_yet']}")) . "
						...
						<div class='ipsBox'>
				".$this->__f__c3f519958afb738f1edc0f423cdef633($blog,$links,$entries,$dates,$cblocks,$followData)."				<br class='clear' />
			</div>
		")) . "
		<br />
		<!-- Pagination -->
...
function __f__c3f519958afb738f1edc0f423cdef633($blog, $links, $entries=array(), $dates=array(), $cblocks=array(), $followData="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $entries as $entry )
...
{
$count_4e599eb8553719dd68b9882405ea9a75 = is_array($this->functionData['entryAlbum']) ? count($this->functionData['entryAlbum']) : 0;
$this->functionData['entryAlbum'][$count_4e599eb8553719dd68b9882405ea9a75]['album'] = $album;
$this->functionData['entryAlbum'][$count_4e599eb8553719dd68b9882405ea9a75]['album_id'] = $album_id;
}
$IPBHTML .= "<div id='attach_wrap' class='rounded clearfix'>
	<ul>
		".$this->__f__d781d3125338942db86df836a23ad461($album,$album_id)."	</ul>
</div>
<br />";
return $IPBHTML;
}
...
function __f__d781d3125338942db86df836a23ad461($album="",$album_id)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_3f71c60dcac69f4b0f9f60b59b24c2ff = is_array($this->functionData['entryTrackbacks']) ? count($this->functionData['entryTrackbacks']) : 0;
$this->functionData['entryTrackbacks'][$count_3f71c60dcac69f4b0f9f60b59b24c2ff]['entry_id'] = $entry_id;
$this->functionData['entryTrackbacks'][$count_3f71c60dcac69f4b0f9f60b59b24c2ff]['rows'] = $rows;
}
...
" . ((is_array( $rows ) && count( $rows )) ? ("
	<div id='trackbacks'>
				".$this->__f__f55eaa77804640eb2de502f0bf131ce1($entry_id,$rows)."	</div>
") : ("
...
function __f__f55eaa77804640eb2de502f0bf131ce1($entry_id="",$rows=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_65a310e130123e432cb227625702912c = is_array($this->functionData['pollDisplay']) ? count($this->functionData['pollDisplay']) : 0;
$this->functionData['pollDisplay'][$count_65a310e130123e432cb227625702912c]['poll'] = $poll;
$this->functionData['pollDisplay'][$count_65a310e130123e432cb227625702912c]['entry'] = $entry;
$this->functionData['pollDisplay'][$count_65a310e130123e432cb227625702912c]['pollData'] = $pollData;
$this->functionData['pollDisplay'][$count_65a310e130123e432cb227625702912c]['showResults'] = $showResults;
}
$IPBHTML .= "<script type='text/javascript'>
...
<div class='general_box alt poll' id='poll_{$poll['pid']}'>
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=blog&amp;module=actions&amp;section=dovote&amp;eid={$entry['entry_id']}&amp;blogid={$this->request['blogid']}&amp;st={$this->request['st']}&amp;auth_key={$this->member->form_hash}", "public",'' ), "", "" ) . "\" method=\"post\">
		...
		") : ("")) . "
		".$this->__f__9e5c6249d30e9fa61eef14617725f602($poll,$entry,$pollData,$showResults)."		" . ((!$entry['entry_locked']) ? ("<fieldset class='submit'>
...
function __f__0c3710c2d8f6061ebb8c0db5e3694ee7($poll, $entry, $pollData, $showResults,$questionID='',$questionData='',$choiceID='',$choiceData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__5369001a2d0ee8aa7886d1ab99db9c76($poll, $entry, $pollData, $showResults,$questionID='',$questionData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
							...
							" . (($showResults) ? ("<li>
									...
									" . (($poll['poll_view_voters'] AND is_array( $choiceData['voters'] ) AND $this->settings['poll_allow_public'] AND $choiceData['votes']) ? ("
										<script type='text/javascript'>
											...
											".$this->__f__0c3710c2d8f6061ebb8c0db5e3694ee7($poll,$entry,$pollData,$showResults,$questionID,$questionData,$choiceID,$choiceData)."											ipb.topic.poll[ $questionID ][ $choiceID ] = { name: \"{$choiceData['choice']}\", users: users};
										</script>
									") : ("")) . "
...
function __f__9e5c6249d30e9fa61eef14617725f602($poll, $entry, $pollData, $showResults)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $pollData as $questionID => $questionData )
	{
		...
		$_ips___x_retval .= "
			<div class='poll_question" . (($showResults) ? (" voted") : ("")) . "'>
				...
				") : ("
					<ol>
						".$this->__f__5369001a2d0ee8aa7886d1ab99db9c76($poll,$entry,$pollData,$showResults,$questionID,$questionData)."					</ol>
				")) . "
			</div>
...
{
$count_7e8fa6cbb58206e7371e2276d8b27986 = is_array($this->functionData['show_attachment_title']) ? count($this->functionData['show_attachment_title']) : 0;
$this->functionData['show_attachment_title'][$count_7e8fa6cbb58206e7371e2276d8b27986]['title'] = $title;
$this->functionData['show_attachment_title'][$count_7e8fa6cbb58206e7371e2276d8b27986]['data'] = $data;
$this->functionData['show_attachment_title'][$count_7e8fa6cbb58206e7371e2276d8b27986]['type'] = $type;
}
$IPBHTML .= "<div id='attach_wrap' class='rounded clearfix'>
	<h4>{$title}</h4>
	<ul>
		".$this->__f__db879056f229446d83601862fa0a1c81($title,$data,$type)."	</ul>
</div>";
return $IPBHTML;
}


function __f__db879056f229446d83601862fa0a1c81($title="",$data="",$type="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
