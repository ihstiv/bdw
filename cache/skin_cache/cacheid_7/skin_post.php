...
class skin_post_7 extends skinMaster{
...
{
$count_54d41d14747ce2b86f1f3ac9529cdf17 = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_54d41d14747ce2b86f1f3ac9529cdf17]['data'] = $data;
}
...
{
$count_3efadbf563fdaa9dd97ab949f1aa3621 = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_3efadbf563fdaa9dd97ab949f1aa3621]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_3efadbf563fdaa9dd97ab949f1aa3621]['form'] = $form;
}
...
{
$count_d561afc9b978dc2874e83b9f0f0856c0 = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_d561afc9b978dc2874e83b9f0f0856c0]['data'] = $data;
}
...
{
$count_b99038626a4eb6087eb49ad526d74cf8 = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_b99038626a4eb6087eb49ad526d74cf8]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__3debee4146df3fc0a93dde3eea80e392($posts)."") : ("")) . "
<p class='submit'>
...
function __f__3debee4146df3fc0a93dde3eea80e392($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ecfeee3c5a8fe0b815116faee969c240 = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_ecfeee3c5a8fe0b815116faee969c240]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_ecfeee3c5a8fe0b815116faee969c240]['type'] = $type;
$this->functionData['uploadForm'][$count_ecfeee3c5a8fe0b815116faee969c240]['stats'] = $stats;
$this->functionData['uploadForm'][$count_ecfeee3c5a8fe0b815116faee969c240]['id'] = $id;
$this->functionData['uploadForm'][$count_ecfeee3c5a8fe0b815116faee969c240]['forum_id'] = $forum_id;
}
