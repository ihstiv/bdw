...
class skin_global_comments_7 extends skinMaster{
...
{
$count_59f9f502824466167c969a1359d8fff9 = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_59f9f502824466167c969a1359d8fff9]['r'] = $r;
$this->functionData['comment'][$count_59f9f502824466167c969a1359d8fff9]['parent'] = $parent;
$this->functionData['comment'][$count_59f9f502824466167c969a1359d8fff9]['settings'] = $settings;
}
...
{
$count_72e4b7377ac14597041598c30777f328 = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_72e4b7377ac14597041598c30777f328]['r'] = $r;
$this->functionData['commentHidden'][$count_72e4b7377ac14597041598c30777f328]['parent'] = $parent;
$this->functionData['commentHidden'][$count_72e4b7377ac14597041598c30777f328]['settings'] = $settings;
}
...
{
$count_32e70e8042dd485a2572a11e3aa4d76d = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_32e70e8042dd485a2572a11e3aa4d76d]['comments'] = $comments;
$this->functionData['commentsList'][$count_32e70e8042dd485a2572a11e3aa4d76d]['settings'] = $settings;
$this->functionData['commentsList'][$count_32e70e8042dd485a2572a11e3aa4d76d]['pages'] = $pages;
$this->functionData['commentsList'][$count_32e70e8042dd485a2572a11e3aa4d76d]['parent'] = $parent;
$this->functionData['commentsList'][$count_32e70e8042dd485a2572a11e3aa4d76d]['preReply'] = $preReply;
}
...
<div class='ipsComment_wrap' id='comment_wrap'>
	".$this->__f__3d104692138d61ea00057d3e3e56788c($comments,$settings,$pages,$parent,$preReply)."</div>
" . (($pages) ? ("
	<div class='topic_controls'>
		{$pages}
	</div>
...
function __f__3d104692138d61ea00057d3e3e56788c($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_add380ce8d5dffa0e7d09ba1f78685bd = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_add380ce8d5dffa0e7d09ba1f78685bd]['comment'] = $comment;
$this->functionData['form'][$count_add380ce8d5dffa0e7d09ba1f78685bd]['parent'] = $parent;
$this->functionData['form'][$count_add380ce8d5dffa0e7d09ba1f78685bd]['editor'] = $editor;
$this->functionData['form'][$count_add380ce8d5dffa0e7d09ba1f78685bd]['settings'] = $settings;
$this->functionData['form'][$count_add380ce8d5dffa0e7d09ba1f78685bd]['errors'] = $errors;
$this->functionData['form'][$count_add380ce8d5dffa0e7d09ba1f78685bd]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
