...
class skin_gallery_post_7 extends skinMaster{
...
{
$count_3a21dd53ed99668b499e490c51895464 = is_array($this->functionData['attachiFrameUpload']) ? count($this->functionData['attachiFrameUpload']) : 0;
$this->functionData['attachiFrameUpload'][$count_3a21dd53ed99668b499e490c51895464]['id'] = $id;
$this->functionData['attachiFrameUpload'][$count_3a21dd53ed99668b499e490c51895464]['JSON'] = $JSON;
}
$IPBHTML .= "<html>
	<head>
		<style type=\"text/css\">
...
{
$count_c5fa4d6019c227cfcf5e9f299b7541e1 = is_array($this->functionData['editImageForm']) ? count($this->functionData['editImageForm']) : 0;
$this->functionData['editImageForm'][$count_c5fa4d6019c227cfcf5e9f299b7541e1]['image'] = $image;
$this->functionData['editImageForm'][$count_c5fa4d6019c227cfcf5e9f299b7541e1]['album'] = $album;
$this->functionData['editImageForm'][$count_c5fa4d6019c227cfcf5e9f299b7541e1]['category'] = $category;
$this->functionData['editImageForm'][$count_c5fa4d6019c227cfcf5e9f299b7541e1]['errors'] = $errors;
$this->functionData['editImageForm'][$count_c5fa4d6019c227cfcf5e9f299b7541e1]['preview'] = $preview;
}
...
{
$count_58b67d28b4dd0951fabdfd547b35ed80 = is_array($this->functionData['review']) ? count($this->functionData['review']) : 0;
$this->functionData['review'][$count_58b67d28b4dd0951fabdfd547b35ed80]['images'] = $images;
$this->functionData['review'][$count_58b67d28b4dd0951fabdfd547b35ed80]['album'] = $album;
$this->functionData['review'][$count_58b67d28b4dd0951fabdfd547b35ed80]['category'] = $category;
$this->functionData['review'][$count_58b67d28b4dd0951fabdfd547b35ed80]['type'] = $type;
$this->functionData['review'][$count_58b67d28b4dd0951fabdfd547b35ed80]['opts'] = $opts;
}
...
<form method=\"post\" id='postingform' action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=gallery&amp;module=images&amp;section=review&amp;do=process", "public",'' ), "", "" ) . "\">
							...
							<li class='ipsField ipsField_select'>
								...
								<div class='ipsField_content'>
									<select name='album_category_id' id='album_category_id'>
										".$this->__f__217472b5acf533ea551df24a8f2d9076($images,$album,$category,$type,$opts)."									</select>
								</div>
							<li>
							<li class='ipsField'>
							...
							<li class='ipsField ipsField_select'>
								...
								<div class='ipsField_content'>
									<select name=\"album_sort_options__key\"" . ((!$album['_catDefaults']['album_sort_edit']) ? (" disabled='disabled'") : ("")) . ">
										".$this->__f__9c642cce964463b8612bfc077ce5790f($images,$album,$category,$type,$opts)."									</select>
									<select name=\"album_sort_options__dir\"" . ((!$album['_catDefaults']['album_sort_edit']) ? (" disabled='disabled'") : ("")) . ">
										".$this->__f__e08fa0f5e9b6066c29487bc39308bd14($images,$album,$category,$type,$opts)."									</select>
								</div>
							<li>
	...
	" . ((is_array($images) && count($images)) ? ("<br />
		<div class='ipsBox'>
			".$this->__f__7febf183a788a8c54c1e99d4e410b8c1($images,$album,$category,$type,$opts)."		</div>
...
function __f__217472b5acf533ea551df24a8f2d9076($images, $album, $category, $type, $opts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__9c642cce964463b8612bfc077ce5790f($images, $album, $category, $type, $opts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e08fa0f5e9b6066c29487bc39308bd14($images, $album, $category, $type, $opts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__7febf183a788a8c54c1e99d4e410b8c1($images, $album, $category, $type, $opts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_4862d6d7094c04bd465d8b1a210b9de1 = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_4862d6d7094c04bd465d8b1a210b9de1]['sessionKey'] = $sessionKey;
$this->functionData['uploadForm'][$count_4862d6d7094c04bd465d8b1a210b9de1]['album'] = $album;
$this->functionData['uploadForm'][$count_4862d6d7094c04bd465d8b1a210b9de1]['category'] = $category;
$this->functionData['uploadForm'][$count_4862d6d7094c04bd465d8b1a210b9de1]['categories'] = $categories;
$this->functionData['uploadForm'][$count_4862d6d7094c04bd465d8b1a210b9de1]['stats'] = $stats;
$this->functionData['uploadForm'][$count_4862d6d7094c04bd465d8b1a210b9de1]['allowed_file_types'] = $allowed_file_types;
}
...
<div id='categorySelectorContent' style='display:none'>
	...
	<div class='ipsPad_double'>
		<table class='ipb_table' style=\"table-layout: auto;\">
			".$this->__f__e8cca11441b8869bdc08529c72c2eef9($sessionKey,$album,$category,$categories,$stats,$allowed_file_types)."		</table>
	</div>
</div>
<script type='text/javascript'>
//<![CDATA[
...
function __f__e8cca11441b8869bdc08529c72c2eef9($sessionKey='', $album=array(), $category=array(), $categories=array(), $stats=array(), $allowed_file_types='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
