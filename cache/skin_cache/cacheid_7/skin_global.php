...
/* CACHE FILE: Generated: Thu, 26 Apr 2018 15:29:57 GMT */
/* DO NOT EDIT DIRECTLY - THE CHANGES WILL NOT BE   */
/* WRITTEN TO THE DATABASE AUTOMATICALLY            */
/*--------------------------------------------------*/

class skin_global_7 extends skinMaster{
...
$IPBHTML = "";
$IPBHTML .= "<div style=\"position:relative;\" align=\"center\" class=\"mobilehider tablethider\">
<div id='div-gpt-ad-1386988040007-7' style='width:728px; height:90px;' class=\"header_banner\" align=\"right\">
<script type='text/javascript'>
googletag.cmd.push(function() { googletag.display('div-gpt-ad-1386988040007-7'); });
</script>
</div>
</div>";
return $IPBHTML;
...
{
$count_1a9937121347ed39c31abb47390466b7 = is_array($this->functionData['globalTemplate']) ? count($this->functionData['globalTemplate']) : 0;
$this->functionData['globalTemplate'][$count_1a9937121347ed39c31abb47390466b7]['html'] = $html;
$this->functionData['globalTemplate'][$count_1a9937121347ed39c31abb47390466b7]['documentHeadItems'] = $documentHeadItems;
$this->functionData['globalTemplate'][$count_1a9937121347ed39c31abb47390466b7]['css'] = $css;
$this->functionData['globalTemplate'][$count_1a9937121347ed39c31abb47390466b7]['jsModules'] = $jsModules;
$this->functionData['globalTemplate'][$count_1a9937121347ed39c31abb47390466b7]['metaTags'] = $metaTags;
$this->functionData['globalTemplate'][$count_1a9937121347ed39c31abb47390466b7]['header_items'] = $header_items;
$this->functionData['globalTemplate'][$count_1a9937121347ed39c31abb47390466b7]['items'] = $items;
$this->functionData['globalTemplate'][$count_1a9937121347ed39c31abb47390466b7]['footer_items'] = $footer_items;
$this->functionData['globalTemplate'][$count_1a9937121347ed39c31abb47390466b7]['stats'] = $stats;
}
...
<meta name=\"msvalidate.01\" content=\"AE6E8FBD8F2AABF17485339D2E9AF542\" />
...
<a href='{$this->settings['board_url']}' title='Best Destination Wedding' rel=\"home\" accesskey='1'><div id=\"bdwlogo\" style=\"height:100px; position:absolute;\"><img src=\"https://bdw-stevewright.netdna-ssl.com/public/style_images/destination/logo.png\" width=\"135\" height=\"87\" alt=\"Best Destination Wedding\"/></div> </a> 
<div id='logo' style=\"width:150px!important; background:none;\">	
</div> 
			...
			<div id='primary_nav' class='clearfix'>
					<ul class='ipsList_inline' id='community_app_menu'>
						...
						<li id='nav_explore' class='right " . ((IPS_APP_COMPONENT=='core' && $this->request['module']=='search' && $this->request['do'] == 'viewNewContent') ? ("active") : ("")) . "'>
						...
						") : ("" . ((is_array($header_items['applications']) AND count($header_items['applications'])) ? ("
								".$this->__f__770a3f881c43ee083ca539e3ec6df2f7($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."							") : ("")) . "")) . "
...
<!-- GLOBAL ANNOUNCEMENT swright -->
<div style=\"border:solid 1px #999; padding:3px; text-align:center; font:normal 12px arial; background:#fafbdf; margin-bottom:3px;\">
...
<!-- /GLOBAL ANNOUNCEMENT -->
				...
				" . ((count( $items['navigation'] )) ? ("<div id='secondary_navigation' class='clearfix'>
						<ol class='breadcrumb top ipsList_inline left' itemscope itemtype=\"http://schema.org/BreadcrumbList\">
														" . ((!$this->settings['remove_forums_nav'] OR ipsRegistry::$current_application == 'forums') ? ("<li itemprop=\"itemListElement\" itemscope itemtype=\"http://schema.org/ListItem\">
									<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "act=idx", "public",'' ), "false", "" ) . "' itemscope itemtype=\"http://schema.org/Thing\" itemprop=\"item\">
										<span itemprop=\"name\">{$this->settings['board_name']}</span>
									</a>
								</li>
								" . (($this->did_first=1) ? ("") : ("")) . "") : ("")) . "
							".$this->__f__6139d011cd4ba5a709a1a89b81f14edc($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."						</ol>
					</div>") : ("")) . "
				<noscript>
				...
				<ol class='breadcrumb bottom ipsList_inline left clearfix clear'>
					" . ((count( $items['navigation'] )) ? ("						" . ((!$this->settings['remove_forums_nav'] OR ipsRegistry::$current_application == 'forums') ? ("<li><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "act=idx", "public",'' ), "false", "" ) . "'>{$this->settings['board_name']}</a></li>
						...
						".$this->__f__a9ad9d85bcc548f7059b70dda065d5ba($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."") : ("
						<li>&nbsp;</li>
					")) . "
							...
							" . ((count($footer_items['skin_chooser']) > 1) ? ("
								<li>
									...
									<ul id='new_skin_menucontent' class='ipbmenu_content with_checks' style='display: none'>
										".$this->__f__068f86ab3850002a580bb8cb83851353($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."									</ul>
								</li>
							") : ("")) . "")) . "") : ("")) . "
					...
					" . ((! $this->member->is_not_human && count( $footer_items['lang_chooser']['options'] ) > 1) ? ("
						<li>
							...
							<ul id='new_language_menucontent' class='ipbmenu_content with_checks' style='display: none'>
								".$this->__f__fdb4314d74c85810cbfb03cc04d6cbb2($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."							</ul>
						</li>
					") : ("")) . "<!--hook.if.skin_global.globalTemplate.langchooser.post.endif-->


" . (($this->request['f'] > 0) ? ("" . ((( ! $this->member->is_not_human ) && ( $this->memberData['member_id'] || $this->settings['topic_marking_guests'] )) ? ("
						<li>
							...
							<ul id='mark_all_read_menucontent' class='ipbmenu_content' style='display: none'>
								".$this->__f__a709e6d3a64e02d5a21feaa11c03051d($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."								<li>
...
<center>
<div id=\"globalfooter\" >
<table id=\"footer-table\" width=\"100%\"><tr>
<td width=\"29%\" valign=\"top\">" . $this->registry->getClass('pageBuilder')->getBlock('footer1')  . "</td>
<td width=\"22%\" valign=\"top\">" . $this->registry->getClass('pageBuilder')->getBlock('footer3')  . "</td>
<td width=\"22%\" valign=\"top\">" . $this->registry->getClass('pageBuilder')->getBlock('footer2')  . "</td>
<td width=\"22%\" valign=\"top\">" . $this->registry->getClass('pageBuilder')->getBlock('footer4')  . "</td>
</tr>
</table>

<!-- BDW-728x90-Footer-leaderboard -->
<center>
<div id='div-gpt-ad-1388897798616-0' style='width:728px; height:90px;' align=\"center\" class=\"mobilehider\">
<script type='text/javascript'>
googletag.cmd.push(function() { googletag.display('div-gpt-ad-1388897798616-0'); });
</script>
</div>
</center>
<br/><br/>
<div class=\"copy-foot\">&copy; <script>var today = new Date();document.write (today.getFullYear());</script> Best Destination Wedding &reg;. All Rights Reserved. CST# 2084813-40</div>
<a rel=\"nofollow\" href='#top' id='backtotop' title='{$this->lang->words['go_to_top']}'><img src='{$this->settings['img_url']}/top.png' alt='' /></a>
</div>
</center>

<script type=\"text/javascript\" src=\"//s.skimresources.com/js/62536X1409505.skimlinks.js\"></script>
</body>
</html>";
return $IPBHTML;
}
...
function __f__770a3f881c43ee083ca539e3ec6df2f7($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__6139d011cd4ba5a709a1a89b81f14edc($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		$_ips___x_retval .= "
								<li itemprop=\"itemListElement\" itemscope itemtype=\"http://schema.org/ListItem\">
									" . (($this->did_first) ? ("<span class='nav_sep'>" . $this->registry->getClass('output')->getReplacement("f_nav_sep") . "</span>") : ("")) . "
									 " . (($data[1]) ? ("<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "{$data[1]}", "$data[4]",'' ), "$data[2]", "$data[3]" ) . "' title='{$this->lang->words['nav_return_to']} " . IPSText::striptags( IPSText::htmlspecialchars( $data[0] ) ) . "' itemscope itemtype=\"http://schema.org/Thing\" itemprop=\"item\">") : ("")) . "<span itemprop=\"name\">{$data[0]}</span>" . (($data[1]) ? ("</a>") : ("")) . "
								</li>
								" . (($this->did_first=1) ? ("") : ("")) . "
...
function __f__a9ad9d85bcc548f7059b70dda065d5ba($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $items['navigation'] as $idx => $data )
...
function __f__068f86ab3850002a580bb8cb83851353($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__fdb4314d74c85810cbfb03cc04d6cbb2($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a709e6d3a64e02d5a21feaa11c03051d($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_199cf4f379bff474c033e5e9cc06f98f = is_array($this->functionData['includeCSS']) ? count($this->functionData['includeCSS']) : 0;
$this->functionData['includeCSS'][$count_199cf4f379bff474c033e5e9cc06f98f]['css'] = $css;
}

$this->minify = array();

list($width,$height) = explode('x',$this->settings['resize_img_force']);
$height = (intval($height)) ? $height : $width;
$IPBHTML .= "" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
	".$this->__f__48cc76adcbc0fef1a042eeee343091ad($css)."	" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
...
" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
	".$this->__f__ffc17db0364b1f630cb64584213bf0e8($css)."") : ("")) . "<!--hook.if.skin_global.includeCSS.inlinecss.post.endif-->
<!--[if lte IE 7]>
...
<![endif]-->
" . (($this->settings['resize_img_force']) ? ("	<!-- Forces resized images to an admin-defined size -->
	<style type='text/css'>
		img.bbc_img {
...
function __f__48cc76adcbc0fef1a042eeee343091ad($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__ffc17db0364b1f630cb64584213bf0e8($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_58f1652ac9493532b5c21614c35f09ea = is_array($this->functionData['includeFeeds']) ? count($this->functionData['includeFeeds']) : 0;
$this->functionData['includeFeeds'][$count_58f1652ac9493532b5c21614c35f09ea]['documentHeadItems'] = $documentHeadItems;
}
$IPBHTML .= "" . ((count($documentHeadItems)) ? ("
	".$this->__f__87946324ad945936a163823de9c50cca($documentHeadItems)."") : ("")) . "";
return $IPBHTML;
}


function __f__27720b8af33e65cedc4286e42d769e16($documentHeadItems,$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__87946324ad945936a163823de9c50cca($documentHeadItems)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__27720b8af33e65cedc4286e42d769e16($documentHeadItems,$type,$idx)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_885302a0787babc76ca20b64f3fd95f2 = is_array($this->functionData['includeJS']) ? count($this->functionData['includeJS']) : 0;
$this->functionData['includeJS'][$count_885302a0787babc76ca20b64f3fd95f2]['jsModules'] = $jsModules;
}
$IPBHTML .= "<!-- redirect for hash # in URL swright 082013-->
<script type=\"text/javascript\">
...
") : ("")) . "<!--hook.if.skin_global.includeJS.isLargeTouch.post.endif-->
...
{
$count_0c5047bd82b9827aee5645e463c80b2b = is_array($this->functionData['includeMeta']) ? count($this->functionData['includeMeta']) : 0;
$this->functionData['includeMeta'][$count_0c5047bd82b9827aee5645e463c80b2b]['metaTags'] = $metaTags;
}
$IPBHTML .= "<!--hook.if.skin_global.includeMeta.metatags.pre.startif-->" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
	".$this->__f__b17a68611a1126b13ef35ee52a13d709($metaTags)."") : ("")) . "
<meta property=\"og:image\" content=\"{$this->settings['meta_imagesrc']}\"/>";
return $IPBHTML;
}


function __f__d3f27916e4f04efe2b7a18f176d9b57f($metaTags,$tag='',$id='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b17a68611a1126b13ef35ee52a13d709($metaTags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $metaTags as $tag => $id )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__d3f27916e4f04efe2b7a18f176d9b57f($metaTags,$tag,$id)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_2dd6ccf2e1557df24ce2a882cb0164d9 = is_array($this->functionData['includeRTL']) ? count($this->functionData['includeRTL']) : 0;
}

$this->isRtlLang	= false;
$IPBHTML .= "".$this->__f__a37cddbbe9bae889b6684b030d5bb004()."" . (($this->isRtlLang AND is_file( DOC_IPS_ROOT_PATH . '/' . PUBLIC_DIRECTORY . '/style_css/' . $this->registry->output->skin['_csscacheid'] . '/ipb_rtl.css' )) ? ("
...
function __f__a37cddbbe9bae889b6684b030d5bb004()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e029f7b65349fcd98cb163621d9c62ac = is_array($this->functionData['includeVars']) ? count($this->functionData['includeVars']) : 0;
$this->functionData['includeVars'][$count_e029f7b65349fcd98cb163621d9c62ac]['header_items'] = $header_items;
}
...
{
$count_e609b63ba00019722f7291a2217e88ca = is_array($this->functionData['inlineLogin']) ? count($this->functionData['inlineLogin']) : 0;
}
...
<!--
							" . ((is_array($this->_formFields) AND count($this->_formFields)) ? ("
								".$this->__f__083687ca126b482fb6411809e161e007()."							") : ("")) . "
-->
						</ul>
					</div>") : ("")) . "
				<br />
...
function __f__083687ca126b482fb6411809e161e007()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_5f30c4931aeb6ad0b73963264cdce0af = is_array($this->functionData['liveEditJs']) ? count($this->functionData['liveEditJs']) : 0;
}
...
<div class='ipsBox ipsPad'>
	...
	<form action='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&module=global&section=meta&do=save", "public",'' ), "", "" ) . "' method='post'>
		...
		<table class='ipb_table'>
			".$this->__f__0ac9bc87835468b4285083a2d8d45642($tags,$url)."		</table>
		</div>
		<table class='ipb_table'>
			<tr>
...
function __f__0ac9bc87835468b4285083a2d8d45642($tags, $url)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tags as $k => $v )
...
{
$count_0830591185f584410dcc13848c2358be = is_array($this->functionData['nextPreviousTemplate']) ? count($this->functionData['nextPreviousTemplate']) : 0;
$this->functionData['nextPreviousTemplate'][$count_0830591185f584410dcc13848c2358be]['data'] = $data;
}
...
{
$count_d30fa5207d4ce371936a055ede533419 = is_array($this->functionData['paginationTemplate']) ? count($this->functionData['paginationTemplate']) : 0;
$this->functionData['paginationTemplate'][$count_d30fa5207d4ce371936a055ede533419]['work'] = $work;
$this->functionData['paginationTemplate'][$count_d30fa5207d4ce371936a055ede533419]['data'] = $data;
}
$IPBHTML .= "" . (($work['pages'] > 1) ? ("<div class='pagination clearfix left " . ((!$data['showNumbers']) ? ("no_numbers") : ("")) . "'>
		...
		<ul class='ipsList_inline left pages'>
			...
			" . ((is_array( $work['_pageNumbers'] ) && count( $work['_pageNumbers'] )) ? ("
				".$this->__f__d9d71b6fce69b2ccb21b82f2242d71a5($work,$data)."			") : ("")) . "
		</ul>
...
function __f__d9d71b6fce69b2ccb21b82f2242d71a5($work, $data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_7dfd6204a25cc5ce19085c0f69c07a16 = is_array($this->functionData['quickSearch']) ? count($this->functionData['quickSearch']) : 0;
}
		...
		<fieldset>
			...
			<span id='search_wrap' class='right'>
				...
				<ul id='search_options_menucontent' class='ipbmenu_content ipsPad' style='display: none'>
					...
					".$this->__f__c54c879338f90909ff22c546ddb80392()."				</ul>
...
function __f__c54c879338f90909ff22c546ddb80392()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ba40aaf424b2bd283f2ce9e94963ae8c = is_array($this->functionData['shareLinks']) ? count($this->functionData['shareLinks']) : 0;
$this->functionData['shareLinks'][$count_ba40aaf424b2bd283f2ce9e94963ae8c]['links'] = $links;
$this->functionData['shareLinks'][$count_ba40aaf424b2bd283f2ce9e94963ae8c]['title'] = $title;
$this->functionData['shareLinks'][$count_ba40aaf424b2bd283f2ce9e94963ae8c]['url'] = $url;
$this->functionData['shareLinks'][$count_ba40aaf424b2bd283f2ce9e94963ae8c]['cssClass'] = $cssClass;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("sharelinks", "0" ) . "
" . ((is_array( $links )) ? ("
	<ul class='{$cssClass} shareButtons ipsList_inline'>
	".$this->__f__95a364773ce66a287f234bfe3a57474f($links,$title,$url,$cssClass)."	</ul>
	<script type=\"text/javascript\">
...
function __f__95a364773ce66a287f234bfe3a57474f($links, $title='', $url='', $cssClass='topic_share left')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_f44dbf40e75c430178863efcc3f4228a = is_array($this->functionData['signature_separator']) ? count($this->functionData['signature_separator']) : 0;
$this->functionData['signature_separator'][$count_f44dbf40e75c430178863efcc3f4228a]['sig'] = $sig;
$this->functionData['signature_separator'][$count_f44dbf40e75c430178863efcc3f4228a]['author_id'] = $author_id;
$this->functionData['signature_separator'][$count_f44dbf40e75c430178863efcc3f4228a]['can_ignore'] = $can_ignore;
}
...
{
$count_b84e36f6db4b27a71da7e90942ede4ba = is_array($this->functionData['userHoverCard']) ? count($this->functionData['userHoverCard']) : 0;
$this->functionData['userHoverCard'][$count_b84e36f6db4b27a71da7e90942ede4ba]['member'] = $member;
}
...
{
$count_25d7408de0c4c74d2b8ba54cb902ea6c = is_array($this->functionData['userInfoPane']) ? count($this->functionData['userInfoPane']) : 0;
$this->functionData['userInfoPane'][$count_25d7408de0c4c74d2b8ba54cb902ea6c]['author'] = $author;
$this->functionData['userInfoPane'][$count_25d7408de0c4c74d2b8ba54cb902ea6c]['contentid'] = $contentid;
$this->functionData['userInfoPane'][$count_25d7408de0c4c74d2b8ba54cb902ea6c]['options'] = $options;
}
$IPBHTML .= "<div itemscope itemtype=\"http://schema.org/Person\" class='user_details'>
	...
	<!--hook.if.skin_global.userInfoPane.authorcfields.pre.startif-->" . (($author['custom_fields'] != "") ? ("
		<ul class='custom_fields'>
			".$this->__f__59cb19033e570053a8400277c56f3ed7($author,$contentid,$options)."		</ul>
	") : ("")) . "
...
function __f__f26af91661038b8d1314573c0bf70ca3($author, $contentid, $options,$group='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__59cb19033e570053a8400277c56f3ed7($author, $contentid, $options)
{
	...
	foreach( $author['custom_fields'] as $group => $data )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__f26af91661038b8d1314573c0bf70ca3($author,$contentid,$options,$group,$data)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_6e0458f1881dc7bf25380d0f66c8d64b = is_array($this->functionData['userSmallPhoto']) ? count($this->functionData['userSmallPhoto']) : 0;
$this->functionData['userSmallPhoto'][$count_6e0458f1881dc7bf25380d0f66c8d64b]['member'] = $member;
}
...
{
$count_7a218c3a7325254d32929f55745cee1f = is_array($this->functionData['warnDetails']) ? count($this->functionData['warnDetails']) : 0;
$this->functionData['warnDetails'][$count_7a218c3a7325254d32929f55745cee1f]['warning'] = $warning;
$this->functionData['warnDetails'][$count_7a218c3a7325254d32929f55745cee1f]['canSeeModNote'] = $canSeeModNote;
}
...
<div class='ipsBox'>
	<p class='message unspecific'>
		...
		") : ("" . (($warning['wl_points']) ? ("" . (($warning['wl_expire']) ? ("" . (($warning['wl_expire_date']) ? ("
				...
				")) . "") : ("")) . "
			".$this->__f__4fb3e38538c89a72ab697595d810b796($warning,$canSeeModNote)."")) . "
	</p>
...
function __f__4fb3e38538c89a72ab697595d810b796($warning, $canSeeModNote)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
