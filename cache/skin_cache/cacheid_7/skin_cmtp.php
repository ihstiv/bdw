...
class skin_cmtp_7 extends skinMaster{
...
{
$count_c49bde00fb5d1c98d4de9277d6cd515c = is_array($this->functionData['group_strip_fix']) ? count($this->functionData['group_strip_fix']) : 0;
$this->functionData['group_strip_fix'][$count_c49bde00fb5d1c98d4de9277d6cd515c]['group'] = $group;
$this->functionData['group_strip_fix'][$count_c49bde00fb5d1c98d4de9277d6cd515c]['members'] = $members;
$this->functionData['group_strip_fix'][$count_c49bde00fb5d1c98d4de9277d6cd515c]['pagination'] = $pagination;
}
...
<table class='ipb_table ipsMemberList'>
	...
	" . ((count($members) AND is_array($members)) ? ("
				".$this->__f__986f224e2defcd079212a72c2a6f459e($group,$members,$pagination)."	") : ("")) . "
</table>
" . (($pagination) ? ("
	<div class='topic_controls'>{$pagination}</div>
") : ("")) . "
...
function __f__84b79988c204b7a4d9828f916df3fce9($group='', $members=array(), $pagination='',$info='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b4e8da65db61a3518e35b288c1caaf2d($group='', $members=array(), $pagination='',$info='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $info['forums'] as $id => $name )
...
function __f__986f224e2defcd079212a72c2a6f459e($group='', $members=array(), $pagination='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
			...
			<tr class='" .  IPSLib::next( $this->registry->templateStriping["staff"] ) . "'>
				...
				<td class='altrow short'>
					" . ((is_array($info['forums'])) ? ("" . ((count( $info['forums'] ) == 1) ? ("
							".$this->__f__84b79988c204b7a4d9828f916df3fce9($group,$members,$pagination,$info)."						") : ("
							...
							".$this->__f__b4e8da65db61a3518e35b288c1caaf2d($group,$members,$pagination,$info)."							</ul>
