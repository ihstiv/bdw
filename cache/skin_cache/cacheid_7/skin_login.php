...
class skin_login_7 extends skinMaster{
...
{
$count_9e02178b7cf6864a4cd6846625533157 = is_array($this->functionData['ajax__inlineLogInForm']) ? count($this->functionData['ajax__inlineLogInForm']) : 0;
}
...
") : ("<div id='inline_login_form'>
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=global&amp;section=login&amp;do=process", "public",'' ), "", "" ) . "\" method=\"post\" id='login'>
		...
		" . ((IPSLib::loginMethod_enabled('facebook') || IPSLib::loginMethod_enabled('twitter') || IPSLib::loginMethod_enabled('live')) ? ("<div class='ipsBox_notice'>1
...
{
$count_a442aa9222ef531b1436d31805c080d4 = is_array($this->functionData['showLogInForm']) ? count($this->functionData['showLogInForm']) : 0;
$this->functionData['showLogInForm'][$count_a442aa9222ef531b1436d31805c080d4]['message'] = $message;
$this->functionData['showLogInForm'][$count_a442aa9222ef531b1436d31805c080d4]['referer'] = $referer;
$this->functionData['showLogInForm'][$count_a442aa9222ef531b1436d31805c080d4]['extra_form'] = $extra_form;
$this->functionData['showLogInForm'][$count_a442aa9222ef531b1436d31805c080d4]['login_methods'] = $login_methods;
}
				...
				<div class='right ipsPad_double' id='other_signin'>
					<ul class='ipsList_data clear ipsType_small'>
						...
						<!-- " . ((is_array($extra_form) AND count($extra_form)) ? ("
							".$this->__f__fb30014658528d9cd72a873e55464696($message,$referer,$extra_form,$login_methods)."						") : ("")) . " -->
					</ul>
				</div>
			</div>
			" . ((IPSLib::loginMethod_enabled('live')) ? ("
...
function __f__fb30014658528d9cd72a873e55464696($message="",$referer="",$extra_form="", $login_methods=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
