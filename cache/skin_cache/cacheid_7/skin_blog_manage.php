...
class skin_blog_manage_7 extends skinMaster{
...
{
$count_57881ae5e24a7539b51aa029401ba8a3 = is_array($this->functionData['create2']) ? count($this->functionData['create2']) : 0;
$this->functionData['create2'][$count_57881ae5e24a7539b51aa029401ba8a3]['blog'] = $blog;
$this->functionData['create2'][$count_57881ae5e24a7539b51aa029401ba8a3]['errors'] = $errors;
}
...
{
$count_61d0089a6b87b654a639e351bb234c34 = is_array($this->functionData['listCategories']) ? count($this->functionData['listCategories']) : 0;
$this->functionData['listCategories'][$count_61d0089a6b87b654a639e351bb234c34]['blog'] = $blog;
}
	...
	<table class=\"ipb_table\">
		<tr class=\"header\">
			...
			<th class='col_mod'></th>
				...
				".$this->__f__4a38e60e73c081db6dafb5b5da4aacad($blog)."	</table>
...
</script>".$this->__f__8e97d62ee1a8b542f11d9e9df9e93f28($blog)."";
return $IPBHTML;
}


function __f__4a38e60e73c081db6dafb5b5da4aacad($blog=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__8e97d62ee1a8b542f11d9e9df9e93f28($blog=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $blog['_categories'] as $id => $category )
...
{
$count_5295da76c105ac237e06b461c881f2e2 = is_array($this->functionData['manageComments']) ? count($this->functionData['manageComments']) : 0;
$this->functionData['manageComments'][$count_5295da76c105ac237e06b461c881f2e2]['comments'] = $comments;
$this->functionData['manageComments'][$count_5295da76c105ac237e06b461c881f2e2]['blog'] = $blog;
$this->functionData['manageComments'][$count_5295da76c105ac237e06b461c881f2e2]['pagination'] = $pagination;
}
...
" . ((is_array( $comments ) && count( $comments )) ? ("<div class='ipsBox'>
		".$this->__f__1319d06a91d4cedd92a4708caf85f5b8($comments,$blog,$pagination)."	</div>
	" . (($this->memberData['g_blog_allowownmod']) ? ("
			<div class='bar altbar moderation_bar with_action'>
...
function __f__1319d06a91d4cedd92a4708caf85f5b8($comments, $blog, $pagination)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_20fad7f83880720fb335d3f714d4538f = is_array($this->functionData['manageDashboard']) ? count($this->functionData['manageDashboard']) : 0;
$this->functionData['manageDashboard'][$count_20fad7f83880720fb335d3f714d4538f]['myBlogs'] = $myBlogs;
$this->functionData['manageDashboard'][$count_20fad7f83880720fb335d3f714d4538f]['latestComments'] = $latestComments;
$this->functionData['manageDashboard'][$count_20fad7f83880720fb335d3f714d4538f]['error'] = $error;
$this->functionData['manageDashboard'][$count_20fad7f83880720fb335d3f714d4538f]['dropdown'] = $dropdown;
}
...
<div class='ipsLayout " . ((is_array( $latestComments ) && count( $latestComments )) ? ("ipsLayout_withright ipsLayout_bigright") : ("")) . " clearfix'>
		...
		<table class='ipb_table' summary=\"{$this->lang->words['your_current_blogs']}\">
			<tr class='header'>
				...
				<th scope='col' class='short' width=\"10%\">{$this->lang->words['your_blogs_comments']}</th>
						...
						".$this->__f__17d8b02ca216999844c87f902b39cf4b($myBlogs,$latestComments,$error,$dropdown)."		</table>
		<br />
	</div>
	" . ((is_array( $latestComments ) && count( $latestComments )) ? ("<div class='ipsLayout_right'>
			...
			<div class='ipsBox'>
				".$this->__f__56e80ce15b375cebb02707b421cbeb26($myBlogs,$latestComments,$error,$dropdown)."			</div>
...
function __f__17d8b02ca216999844c87f902b39cf4b($myBlogs=array(), $latestComments=array(), $error='', $dropdown='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__56e80ce15b375cebb02707b421cbeb26($myBlogs=array(), $latestComments=array(), $error='', $dropdown='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_2342588507796769614415719cfc49f3 = is_array($this->functionData['rssImportForm']) ? count($this->functionData['rssImportForm']) : 0;
$this->functionData['rssImportForm'][$count_2342588507796769614415719cfc49f3]['blog'] = $blog;
$this->functionData['rssImportForm'][$count_2342588507796769614415719cfc49f3]['data'] = $data;
$this->functionData['rssImportForm'][$count_2342588507796769614415719cfc49f3]['error'] = $error;
$this->functionData['rssImportForm'][$count_2342588507796769614415719cfc49f3]['tagBox'] = $tagBox;
}
				...
				<li class='ipsField ipsField_select'>
					...
					<p class='ipsField_content'>
						<select name='rss_cats[]' id='rss_cats' multiple='true' size='5'>
							" . ((is_array($data['_cats']) AND count($data['_cats'])) ? ("".$this->__f__1553669f780997f099ed7c2f87f69f5a($blog,$data,$error,$tagBox)."							") : ("")) . "
						</select>
...
function __f__1553669f780997f099ed7c2f87f69f5a($blog, $data, $error, $tagBox)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_5c8be6edb3c9df00f675942ab84be97e = is_array($this->functionData['settingsForm']) ? count($this->functionData['settingsForm']) : 0;
$this->functionData['settingsForm'][$count_5c8be6edb3c9df00f675942ab84be97e]['blog'] = $blog;
$this->functionData['settingsForm'][$count_5c8be6edb3c9df00f675942ab84be97e]['error'] = $error;
}
$IPBHTML .= "<script type=\"text/javascript\">
								...
								<ul>
									...
									<li class='field' id='list_blog_view_level'>
										...
										<select class='input_select blogform' name='blog_view_level' id='blog_view_level'>
											".$this->__f__81dd398075c118a07bab490c6d2e503b($blog,$error)."										</select>
									</li>
								</ul>
								</fieldset>
							</td>
					...
					<tr class=\"row1\">
						<td valign=\"top\">
							...
							<fieldset>
								...
								<ul>
								".$this->__f__f06878f5919668a8b31b2b7f106864d8($blog,$error)."								</ul>
							</fieldset>
							") : ("
...
function __f__81dd398075c118a07bab490c6d2e503b($blog, $error='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__f06878f5919668a8b31b2b7f106864d8($blog, $error='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
