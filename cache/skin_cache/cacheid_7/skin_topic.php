...
class skin_topic_7 extends skinMaster{
...
{
$count_f133a108c70615fbc4fa0aeaa0909f10 = is_array($this->functionData['ajaxSharePost']) ? count($this->functionData['ajaxSharePost']) : 0;
$this->functionData['ajaxSharePost'][$count_f133a108c70615fbc4fa0aeaa0909f10]['topic'] = $topic;
$this->functionData['ajaxSharePost'][$count_f133a108c70615fbc4fa0aeaa0909f10]['post'] = $post;
$this->functionData['ajaxSharePost'][$count_f133a108c70615fbc4fa0aeaa0909f10]['url'] = $url;
$this->functionData['ajaxSharePost'][$count_f133a108c70615fbc4fa0aeaa0909f10]['sharelinks'] = $sharelinks;
}
...
{
$count_7d79cf26e6a5ff806ac6a1fcb47ebd6b = is_array($this->functionData['announcement_show']) ? count($this->functionData['announcement_show']) : 0;
$this->functionData['announcement_show'][$count_7d79cf26e6a5ff806ac6a1fcb47ebd6b]['announce'] = $announce;
$this->functionData['announcement_show'][$count_7d79cf26e6a5ff806ac6a1fcb47ebd6b]['author'] = $author;
}
...
{
$count_428af3828c0b0315ebbc4f8857c1a215 = is_array($this->functionData['archiveStatusMessage']) ? count($this->functionData['archiveStatusMessage']) : 0;
$this->functionData['archiveStatusMessage'][$count_428af3828c0b0315ebbc4f8857c1a215]['topic'] = $topic;
$this->functionData['archiveStatusMessage'][$count_428af3828c0b0315ebbc4f8857c1a215]['forum'] = $forum;
}
...
{
$count_bac8293f368b1b1df666b189385b0531 = is_array($this->functionData['hookFacebookLike']) ? count($this->functionData['hookFacebookLike']) : 0;
}
...
{
$count_03fffedb57bdf803dec996d4d77675fb = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_03fffedb57bdf803dec996d4d77675fb]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_03fffedb57bdf803dec996d4d77675fb]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_03fffedb57bdf803dec996d4d77675fb]['opts'] = $opts;
}
...
{
$count_d2a67e78564e1ac74720c28088867d64 = is_array($this->functionData['pollDisplay']) ? count($this->functionData['pollDisplay']) : 0;
$this->functionData['pollDisplay'][$count_d2a67e78564e1ac74720c28088867d64]['poll'] = $poll;
$this->functionData['pollDisplay'][$count_d2a67e78564e1ac74720c28088867d64]['topicData'] = $topicData;
$this->functionData['pollDisplay'][$count_d2a67e78564e1ac74720c28088867d64]['forumData'] = $forumData;
$this->functionData['pollDisplay'][$count_d2a67e78564e1ac74720c28088867d64]['pollData'] = $pollData;
$this->functionData['pollDisplay'][$count_d2a67e78564e1ac74720c28088867d64]['showResults'] = $showResults;
$this->functionData['pollDisplay'][$count_d2a67e78564e1ac74720c28088867d64]['editPoll'] = $editPoll;
}
...
<div class='general_box alt poll' id='poll_{$poll['pid']}'>
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=extras&amp;section=vote&amp;t={$topicData['tid']}&amp;page={$this->request['page']}&amp;do=add&amp;secure_key={$this->member->form_hash}", "public",'' ), "", "" ) . "\" name='pollForm' method=\"post\">
		...
		") : ("")) . "
		".$this->__f__75142fc435052132d49719505e94de32($poll,$topicData,$forumData,$pollData,$showResults,$editPoll)."		<fieldset class='submit'>
...
function __f__f6612693ef4422c1b9b32e0ba8b6bf8b($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='',$choiceID='',$choiceData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__6f12ea7aa8df09b1f2bdfa355eb8b18e($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
							...
							" . (($showResults) ? ("<li>
									...
									" . (($poll['poll_view_voters'] AND is_array( $choiceData['voters'] ) AND $this->settings['poll_allow_public'] AND $choiceData['votes']) ? ("
										<script type='text/javascript'>
											...
											".$this->__f__f6612693ef4422c1b9b32e0ba8b6bf8b($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData,$choiceID,$choiceData)."											ipb.topic.poll[ $questionID ][ $choiceID ] = { name: \"{$choiceData['choice']}\", users: users};
										</script>
									") : ("")) . "
...
function __f__75142fc435052132d49719505e94de32($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $pollData as $questionID => $questionData )
	{
		...
		$_ips___x_retval .= "
			<div class='poll_question" . (($showResults) ? (" voted") : ("")) . "'>
				...
				") : ("
					<ol>
						".$this->__f__6f12ea7aa8df09b1f2bdfa355eb8b18e($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData)."					</ol>
				")) . "
			</div>
...
{
$count_f22cb33672531bfc2612e9fbc7e5e7b0 = is_array($this->functionData['post']) ? count($this->functionData['post']) : 0;
$this->functionData['post'][$count_f22cb33672531bfc2612e9fbc7e5e7b0]['post'] = $post;
$this->functionData['post'][$count_f22cb33672531bfc2612e9fbc7e5e7b0]['displayData'] = $displayData;
$this->functionData['post'][$count_f22cb33672531bfc2612e9fbc7e5e7b0]['topic'] = $topic;
$this->functionData['post'][$count_f22cb33672531bfc2612e9fbc7e5e7b0]['forum'] = $forum;
}
...
{
$count_54a7be74bb624095bc0d2c267cb5272e = is_array($this->functionData['quickEditPost']) ? count($this->functionData['quickEditPost']) : 0;
$this->functionData['quickEditPost'][$count_54a7be74bb624095bc0d2c267cb5272e]['post'] = $post;
}
$IPBHTML .= "{$post['post']}
    {$post['attachmentHtml']}
	<br />
...
{
$count_039071ae0433fa8c91fdc427e91eafa4 = is_array($this->functionData['show_attachment_title']) ? count($this->functionData['show_attachment_title']) : 0;
$this->functionData['show_attachment_title'][$count_039071ae0433fa8c91fdc427e91eafa4]['title'] = $title;
$this->functionData['show_attachment_title'][$count_039071ae0433fa8c91fdc427e91eafa4]['data'] = $data;
$this->functionData['show_attachment_title'][$count_039071ae0433fa8c91fdc427e91eafa4]['type'] = $type;
}
$IPBHTML .= "<div id='attach_wrap' class='clearfix'>
	<h4>{$title}</h4>
	<ul>
		".$this->__f__5f113d587e81b59921b69610064bb80e($title,$data,$type)."	</ul>
</div>";
return $IPBHTML;
}


function __f__5f113d587e81b59921b69610064bb80e($title="",$data="",$type="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_71b719fc95d3fb538edb00de897e54ff = is_array($this->functionData['Show_attachments']) ? count($this->functionData['Show_attachments']) : 0;
$this->functionData['Show_attachments'][$count_71b719fc95d3fb538edb00de897e54ff]['data'] = $data;
}
...
{
$count_b4567a9df3a7dde5f127f46e6fc20f8c = is_array($this->functionData['softDeletedPostBit']) ? count($this->functionData['softDeletedPostBit']) : 0;
$this->functionData['softDeletedPostBit'][$count_b4567a9df3a7dde5f127f46e6fc20f8c]['post'] = $post;
$this->functionData['softDeletedPostBit'][$count_b4567a9df3a7dde5f127f46e6fc20f8c]['sdData'] = $sdData;
$this->functionData['softDeletedPostBit'][$count_b4567a9df3a7dde5f127f46e6fc20f8c]['topic'] = $topic;
}
...
$IPBHTML = "";
$IPBHTML .= "".$this->__f__f0f7dbd3e325e4012f36272ee567ef30($topic,$posts)."<br class='clear' />
...
function __f__f0f7dbd3e325e4012f36272ee567ef30($topic, $posts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_b127d32a7685d113c0baf15fc01195d9 = is_array($this->functionData['topicViewTemplate']) ? count($this->functionData['topicViewTemplate']) : 0;
$this->functionData['topicViewTemplate'][$count_b127d32a7685d113c0baf15fc01195d9]['forum'] = $forum;
$this->functionData['topicViewTemplate'][$count_b127d32a7685d113c0baf15fc01195d9]['topic'] = $topic;
$this->functionData['topicViewTemplate'][$count_b127d32a7685d113c0baf15fc01195d9]['post_data'] = $post_data;
$this->functionData['topicViewTemplate'][$count_b127d32a7685d113c0baf15fc01195d9]['displayData'] = $displayData;
}
...
" . (($displayData['mod_links'] AND ( $this->memberData['is_mod'] OR $this->memberData['member_id'] == $topic['starter_id'] )) ? ("<ul class='ipbmenu_content' id='topic_mod_options_menucontent'  style='display:none'>
	".$this->__f__44ed9794da687dd8b2b68f293decce8f($forum,$topic,$post_data,$displayData)."	" . (($topic['topic_queuedposts'] AND $this->registry->class_forums->canQueuePosts( $forum['id'] )) ? ("
	...
	" . ((is_array( $displayData['multi_mod'] ) AND count( $displayData['multi_mod'] )) ? ("
		".$this->__f__70a44114f7c51731e4ad092cc521cf7b($forum,$topic,$post_data,$displayData)."	") : ("")) . "
</ul>
<script type='text/javascript'>
...
" . (($this->settings['reputation_enabled'] && $this->settings['reputation_point_types'] != 'like' && $this->settings['reputation_show_content'] && $this->memberData['member_id'] != 0 && is_array($this->caches['reputation_levels'])) ? ("<ul id='rep_filter_menucontent' class='ipbmenu_content with_checks' style='display: none'>
		...
		" . ((is_array($this->caches['reputation_levels'])) ? ("
			".$this->__f__76f5d90198c6256f2e82743d4da94854($forum,$topic,$post_data,$displayData)."		") : ("")) . "
	</ul>
	<script type='text/javascript'>
...
<!--hook.if.skin_topic.topicViewTemplate.hasPosts.pre.startif-->" . ((is_array( $post_data ) AND count( $post_data )) ? ("
	<div class='ipsBox'>
		<div class='ipsBox_container' id='ips_Posts'>
			".$this->__f__3014ed71db19fa754a1a6f671aa117db($forum,$topic,$post_data,$displayData)."		</div>
	</div>
") : ("")) . "
<hr />
...
" . ((is_array( $displayData['same_tagged'] ) and count( $displayData['same_tagged'] )) ? ("
	...
	<div class='ipsBox'>
		...
		<div class='ipsBox_container'>
			...
			".$this->__f__04c02f42541da021faee653b66c26d74($forum,$topic,$post_data,$displayData)."			</table>
		</div>
	</div>
") : ("")) . "
<!-- ACTIVE USERS -->
...
function __f__44ed9794da687dd8b2b68f293decce8f($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__70a44114f7c51731e4ad092cc521cf7b($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__76f5d90198c6256f2e82743d4da94854($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__3014ed71db19fa754a1a6f671aa117db($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__04c02f42541da021faee653b66c26d74($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
