...
class skin_blog_post_7 extends skinMaster{
...
{
$count_406cbde9c67508baddd06c93562f5a1f = is_array($this->functionData['blogPostForm']) ? count($this->functionData['blogPostForm']) : 0;
$this->functionData['blogPostForm'][$count_406cbde9c67508baddd06c93562f5a1f]['form_hiddens'] = $form_hiddens;
$this->functionData['blogPostForm'][$count_406cbde9c67508baddd06c93562f5a1f]['button'] = $button;
$this->functionData['blogPostForm'][$count_406cbde9c67508baddd06c93562f5a1f]['date'] = $date;
$this->functionData['blogPostForm'][$count_406cbde9c67508baddd06c93562f5a1f]['title'] = $title;
$this->functionData['blogPostForm'][$count_406cbde9c67508baddd06c93562f5a1f]['albums'] = $albums;
$this->functionData['blogPostForm'][$count_406cbde9c67508baddd06c93562f5a1f]['mod_options'] = $mod_options;
$this->functionData['blogPostForm'][$count_406cbde9c67508baddd06c93562f5a1f]['editor'] = $editor;
$this->functionData['blogPostForm'][$count_406cbde9c67508baddd06c93562f5a1f]['poll_box'] = $poll_box;
$this->functionData['blogPostForm'][$count_406cbde9c67508baddd06c93562f5a1f]['upload_field'] = $upload_field;
$this->functionData['blogPostForm'][$count_406cbde9c67508baddd06c93562f5a1f]['html_status'] = $html_status;
$this->functionData['blogPostForm'][$count_406cbde9c67508baddd06c93562f5a1f]['canPublish'] = $canPublish;
$this->functionData['blogPostForm'][$count_406cbde9c67508baddd06c93562f5a1f]['blogsdd'] = $blogsdd;
$this->functionData['blogPostForm'][$count_406cbde9c67508baddd06c93562f5a1f]['_extraData'] = $_extraData;
$this->functionData['blogPostForm'][$count_406cbde9c67508baddd06c93562f5a1f]['tagBox'] = $tagBox;
$this->functionData['blogPostForm'][$count_406cbde9c67508baddd06c93562f5a1f]['following'] = $following;
$this->functionData['blogPostForm'][$count_406cbde9c67508baddd06c93562f5a1f]['socialShare'] = $socialShare;
$this->functionData['blogPostForm'][$count_406cbde9c67508baddd06c93562f5a1f]['image'] = $image;
}
...
<form id='postingform' action='{$this->settings['base_url']}' method='post' name='postingform' enctype='multipart/form-data'>
					...
					<li class='ipsField ipsField_select'>
						...
						<p class='ipsField_content'>
							<select name='blogid' id='blog_chooser'>
								".$this->__f__e3ca25df7dc127e9a2c6b8a81a8cdbcf($form_hiddens,$button,$date,$title,$albums,$mod_options,$editor,$poll_box,$upload_field,$html_status,$canPublish,$blogsdd,$_extraData,$tagBox,$following,$socialShare,$image)."							</select>
						</p>
					</li>
				") : ("")) . "
	...
	<fieldset class='submit clear'>
		...
		" . ((is_array( $form_hiddens ) && count( $form_hiddens )) ? ("
			".$this->__f__a4a46a84b94c24be261c286f0051c155($form_hiddens,$button,$date,$title,$albums,$mod_options,$editor,$poll_box,$upload_field,$html_status,$canPublish,$blogsdd,$_extraData,$tagBox,$following,$socialShare,$image)."		") : ("")) . "
...
function __f__e3ca25df7dc127e9a2c6b8a81a8cdbcf($form_hiddens=array(), $button="", $date=array(), $title=array(), $albums="", $mod_options="", $editor="", $poll_box="", $upload_field='', $html_status=array(), $canPublish=0, $blogsdd='', $_extraData=array(), $tagBox='', $following = 0, $socialShare, $image='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a4a46a84b94c24be261c286f0051c155($form_hiddens=array(), $button="", $date=array(), $title=array(), $albums="", $mod_options="", $editor="", $poll_box="", $upload_field='', $html_status=array(), $canPublish=0, $blogsdd='', $_extraData=array(), $tagBox='', $following = 0, $socialShare, $image='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_823a4faa1b208f547aa872407ddf0691 = is_array($this->functionData['cBlockForm']) ? count($this->functionData['cBlockForm']) : 0;
$this->functionData['cBlockForm'][$count_823a4faa1b208f547aa872407ddf0691]['form_hiddens'] = $form_hiddens;
$this->functionData['cBlockForm'][$count_823a4faa1b208f547aa872407ddf0691]['button'] = $button;
$this->functionData['cBlockForm'][$count_823a4faa1b208f547aa872407ddf0691]['cbtitle'] = $cbtitle;
$this->functionData['cBlockForm'][$count_823a4faa1b208f547aa872407ddf0691]['editor'] = $editor;
$this->functionData['cBlockForm'][$count_823a4faa1b208f547aa872407ddf0691]['html_status'] = $html_status;
$this->functionData['cBlockForm'][$count_823a4faa1b208f547aa872407ddf0691]['upload_field'] = $upload_field;
$this->functionData['cBlockForm'][$count_823a4faa1b208f547aa872407ddf0691]['blogData'] = $blogData;
}
$IPBHTML .= "<br />
<form id='postingform' action='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=blog&amp;module=post&amp;section=post", "public",'' ), "", "" ) . "' method='post' enctype='multipart/form-data'>
	...
	<fieldset class='submit clear'>
		...
		<input type='hidden' name='removeattachid' value='0' />
		" . ((is_array( $form_hiddens ) && count( $form_hiddens )) ? ("
			".$this->__f__cfd10aef450ccc572609013621002a80($form_hiddens,$button,$cbtitle,$editor,$html_status,$upload_field,$blogData)."		") : ("")) . "
...
function __f__cfd10aef450ccc572609013621002a80($form_hiddens=array(), $button='', $cbtitle='', $editor='', $html_status=array(), $upload_field='', $blogData=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
