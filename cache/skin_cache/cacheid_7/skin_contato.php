...
class skin_contato_7 extends skinMaster{
...
{
$count_388c2fe7c6cd6aabeccf0a8995b7f80e = is_array($this->functionData['fields']) ? count($this->functionData['fields']) : 0;
$this->functionData['fields'][$count_388c2fe7c6cd6aabeccf0a8995b7f80e]['dep'] = $dep;
$this->functionData['fields'][$count_388c2fe7c6cd6aabeccf0a8995b7f80e]['regra'] = $regra;
$this->functionData['fields'][$count_388c2fe7c6cd6aabeccf0a8995b7f80e]['pergunta'] = $pergunta;
$this->functionData['fields'][$count_388c2fe7c6cd6aabeccf0a8995b7f80e]['customfields'] = $customfields;
$this->functionData['fields'][$count_388c2fe7c6cd6aabeccf0a8995b7f80e]['captchaHTML'] = $captchaHTML;
$this->functionData['fields'][$count_388c2fe7c6cd6aabeccf0a8995b7f80e]['firstid'] = $firstid;
}
...
<ul class=\"ipsPad\">
				...
				" . ((is_array($customfields) and count($customfields)) ? ("".$this->__f__a18c5306e6d1f2ef8cb12997b4c3ee69($dep,$regra,$pergunta,$customfields,$captchaHTML,$firstid)."				") : ("")) . "" . (($pergunta[question] != '') ? ("
					<li class='ipsField'>
...
function __f__a18c5306e6d1f2ef8cb12997b4c3ee69($dep=array(), $regra, $pergunta=array(), $customfields=array(), $captchaHTML, $firstid)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_8847b53aa80a2ae4ed377f54e36b4e0c = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_8847b53aa80a2ae4ed377f54e36b4e0c]['dep'] = $dep;
$this->functionData['form'][$count_8847b53aa80a2ae4ed377f54e36b4e0c]['regra'] = $regra;
$this->functionData['form'][$count_8847b53aa80a2ae4ed377f54e36b4e0c]['pergunta'] = $pergunta;
$this->functionData['form'][$count_8847b53aa80a2ae4ed377f54e36b4e0c]['customfields'] = $customfields;
$this->functionData['form'][$count_8847b53aa80a2ae4ed377f54e36b4e0c]['captchaHTML'] = $captchaHTML;
$this->functionData['form'][$count_8847b53aa80a2ae4ed377f54e36b4e0c]['firstid'] = $firstid;
}
$IPBHTML .= "{$regra}
...
<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left'>		
			...
			<ul>
				".$this->__f__0a15589567db8d09c59e125af3583476($dep,$regra,$pergunta,$customfields,$captchaHTML,$firstid)."						
			</ul>
		</div>
...
function __f__0a15589567db8d09c59e125af3583476($dep=array(), $regra, $pergunta=array(), $customfields=array(), $captchaHTML, $firstid)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $dep as $r )
