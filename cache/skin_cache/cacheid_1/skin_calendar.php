...
{
$count_1abe576d84110dbeab90077211a32874 = is_array($this->functionData['bbCodeEvent']) ? count($this->functionData['bbCodeEvent']) : 0;
$this->functionData['bbCodeEvent'][$count_1abe576d84110dbeab90077211a32874]['event'] = $event;
$this->functionData['bbCodeEvent'][$count_1abe576d84110dbeab90077211a32874]['type'] = $type;
$this->functionData['bbCodeEvent'][$count_1abe576d84110dbeab90077211a32874]['ends'] = $ends;
}
...
{
$count_6e6bee0ab50a8015b5c2e1979a1bdd3f = is_array($this->functionData['boardIndexBirthdays']) ? count($this->functionData['boardIndexBirthdays']) : 0;
$this->functionData['boardIndexBirthdays'][$count_6e6bee0ab50a8015b5c2e1979a1bdd3f]['birthdays'] = $birthdays;
$this->functionData['boardIndexBirthdays'][$count_6e6bee0ab50a8015b5c2e1979a1bdd3f]['data'] = $data;
}
		...
		<div class='_sbcollapsable'>
			" . ((count( $birthdays )) ? ("
				<ul class='ipsList_withminiphoto'>
					".$this->__f__3766546f2889414f4ec3b2170964f8b6($birthdays,$data)."				</ul>
			") : ("
...
function __f__3766546f2889414f4ec3b2170964f8b6($birthdays, $data=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_5958db08992b37471676609f2158ff75 = is_array($this->functionData['boardIndexCalEvents']) ? count($this->functionData['boardIndexCalEvents']) : 0;
$this->functionData['boardIndexCalEvents'][$count_5958db08992b37471676609f2158ff75]['events'] = $events;
}
		...
		<div class='_sbcollapsable'>
			" . ((is_array( $events )) ? ("
				<ul itemscope itemtype=\"http://schema.org/Event\" class='ipsList_withminiphoto'>
					".$this->__f__2919d201b727a1a95aa7a04e44ed1323($events)."				</ul>
			") : ("
...
function __f__2919d201b727a1a95aa7a04e44ed1323($events)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_cbadaa5a81b83cafb4a48e2ee7c86135 = is_array($this->functionData['cal_date_cell']) ? count($this->functionData['cal_date_cell']) : 0;
$this->functionData['cal_date_cell'][$count_cbadaa5a81b83cafb4a48e2ee7c86135]['day'] = $day;
$this->functionData['cal_date_cell'][$count_cbadaa5a81b83cafb4a48e2ee7c86135]['events'] = $events;
$this->functionData['cal_date_cell'][$count_cbadaa5a81b83cafb4a48e2ee7c86135]['cal_date_queued'] = $cal_date_queued;
$this->functionData['cal_date_cell'][$count_cbadaa5a81b83cafb4a48e2ee7c86135]['queued'] = $queued;
$this->functionData['cal_date_cell'][$count_cbadaa5a81b83cafb4a48e2ee7c86135]['js_id'] = $js_id;
}
$IPBHTML .= "<!--Day-->
...
{
$count_5c44306fdffd1747edaeaab55e93aeb0 = is_array($this->functionData['cal_date_cell_today']) ? count($this->functionData['cal_date_cell_today']) : 0;
$this->functionData['cal_date_cell_today'][$count_5c44306fdffd1747edaeaab55e93aeb0]['day'] = $day;
$this->functionData['cal_date_cell_today'][$count_5c44306fdffd1747edaeaab55e93aeb0]['events'] = $events;
$this->functionData['cal_date_cell_today'][$count_5c44306fdffd1747edaeaab55e93aeb0]['cal_date_queued'] = $cal_date_queued;
$this->functionData['cal_date_cell_today'][$count_5c44306fdffd1747edaeaab55e93aeb0]['queued'] = $queued;
$this->functionData['cal_date_cell_today'][$count_5c44306fdffd1747edaeaab55e93aeb0]['js_id'] = $js_id;
}
$IPBHTML .= "<!--Day-->
...
{
$count_95946a5836a9c303e367b8f170c2e596 = is_array($this->functionData['cal_week_dayentry']) ? count($this->functionData['cal_week_dayentry']) : 0;
$this->functionData['cal_week_dayentry'][$count_95946a5836a9c303e367b8f170c2e596]['wday'] = $wday;
$this->functionData['cal_week_dayentry'][$count_95946a5836a9c303e367b8f170c2e596]['date'] = $date;
$this->functionData['cal_week_dayentry'][$count_95946a5836a9c303e367b8f170c2e596]['month'] = $month;
$this->functionData['cal_week_dayentry'][$count_95946a5836a9c303e367b8f170c2e596]['mid'] = $mid;
$this->functionData['cal_week_dayentry'][$count_95946a5836a9c303e367b8f170c2e596]['year'] = $year;
$this->functionData['cal_week_dayentry'][$count_95946a5836a9c303e367b8f170c2e596]['events'] = $events;
$this->functionData['cal_week_dayentry'][$count_95946a5836a9c303e367b8f170c2e596]['queued'] = $queued;
}
...
{
$count_47feee0968b6ab4227f6fa2c9f41e0ae = is_array($this->functionData['calendar_likeSummaryContents']) ? count($this->functionData['calendar_likeSummaryContents']) : 0;
$this->functionData['calendar_likeSummaryContents'][$count_47feee0968b6ab4227f6fa2c9f41e0ae]['data'] = $data;
$this->functionData['calendar_likeSummaryContents'][$count_47feee0968b6ab4227f6fa2c9f41e0ae]['relId'] = $relId;
$this->functionData['calendar_likeSummaryContents'][$count_47feee0968b6ab4227f6fa2c9f41e0ae]['opts'] = $opts;
}
...
{
$count_81480c5a4fc8b198c837fda070cf95b4 = is_array($this->functionData['calendarBirthdayList']) ? count($this->functionData['calendarBirthdayList']) : 0;
$this->functionData['calendarBirthdayList'][$count_81480c5a4fc8b198c837fda070cf95b4]['rows'] = $rows;
}
$IPBHTML .= "<h2 class='ipsType_subtitle'>{$this->lang->words['celebrating_bday']}</h2>
<br />
" . ((is_array( $rows ) and count( $rows )) ? ("
	".$this->__f__0aeabeff79e361cfe0b8414d3989ac78($rows)."") : ("
	<br />
...
function __f__0aeabeff79e361cfe0b8414d3989ac78($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_74bc13d3d02093b7d2272acaebbb47f2 = is_array($this->functionData['calendarEventForm']) ? count($this->functionData['calendarEventForm']) : 0;
$this->functionData['calendarEventForm'][$count_74bc13d3d02093b7d2272acaebbb47f2]['data'] = $data;
}
...
{
$count_7662b232c380e1582d85a3edc1f32a22 = is_array($this->functionData['calendarEventsList']) ? count($this->functionData['calendarEventsList']) : 0;
$this->functionData['calendarEventsList'][$count_7662b232c380e1582d85a3edc1f32a22]['data'] = $data;
}
...
{
$count_2ad45f81e0cf4b08d6df07b767e286fa = is_array($this->functionData['calendarJump']) ? count($this->functionData['calendarJump']) : 0;
$this->functionData['calendarJump'][$count_2ad45f81e0cf4b08d6df07b767e286fa]['calendars'] = $calendars;
$this->functionData['calendarJump'][$count_2ad45f81e0cf4b08d6df07b767e286fa]['calendar'] = $calendar;
$this->functionData['calendarJump'][$count_2ad45f81e0cf4b08d6df07b767e286fa]['chosen_date'] = $chosen_date;
}
$IPBHTML .= "" . ((is_array( $calendars ) && count( $calendars ) > 1) ? ("
	...
	<ul class='ipbmenu_content' style='display: none' id='calendar_chooser_menucontent'>
		".$this->__f__6c1e29bf71c5acaae1df3a8a8cdb3308($calendars,$calendar,$chosen_date)."	</ul>
	<script type='text/javascript'>
...
function __f__6c1e29bf71c5acaae1df3a8a8cdb3308($calendars, $calendar, $chosen_date=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_3c5884c2a97c011ef20839a34a27368a = is_array($this->functionData['calendarMainContent']) ? count($this->functionData['calendarMainContent']) : 0;
$this->functionData['calendarMainContent'][$count_3c5884c2a97c011ef20839a34a27368a]['data'] = $data;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("calendar", "0" ) . "
<script type='text/javascript'>
	ipb.vars['month_url'] = \"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=calendar&module=calendar&section=view&cal_id={$data['calendar']['cal_id']}", "public",'' ), "", "" ) . "\";
...
<div class='ipsBox'>
	<div class='ipsBox_container'>
		<table id='calendar_table' class='ipsCalendar ipb_table vcalendar' summary=\"{$this->lang->words['calendar_for']} {$data['month_title']} {$data['chosen_date']['year']}\">
			<tr class='header'>
				".$this->__f__04f5d53b35073315657a9c195a8a554e($data)."				{$data['events']}
			</tr>
		</table>
	</div>
</div>
...
function __f__04f5d53b35073315657a9c195a8a554e($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_c3539e0d9d38378ce47e84e44db1c702 = is_array($this->functionData['calendarWeekView']) ? count($this->functionData['calendarWeekView']) : 0;
$this->functionData['calendarWeekView'][$count_c3539e0d9d38378ce47e84e44db1c702]['data'] = $data;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("calendar", "0" ) . "
<script type='text/javascript'>
	ipb.vars['month_url'] = \"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=calendar&module=calendar&section=view&cal_id={$data['calendar']['cal_id']}", "public",'' ), "", "" ) . "\";
...
{
$count_6357ff8abd62b01a7605f92ab3bb5085 = is_array($this->functionData['calEventFollowedWrapper']) ? count($this->functionData['calEventFollowedWrapper']) : 0;
$this->functionData['calEventFollowedWrapper'][$count_6357ff8abd62b01a7605f92ab3bb5085]['rows'] = $rows;
}
...
$IPBHTML .= "<div id='search_results'>
	<ol>
		" . ((is_array($rows) && count($rows)) ? ("
			".$this->__f__63bd23fce4182d932ddd6e87e05eb31d($rows)."		") : ("")) . "
	</ol>
</div>";
return $IPBHTML;
}
...
function __f__63bd23fce4182d932ddd6e87e05eb31d($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_0b9f30f66260399dc3becfe286eb453b = is_array($this->functionData['calEventSearchResult']) ? count($this->functionData['calEventSearchResult']) : 0;
$this->functionData['calEventSearchResult'][$count_0b9f30f66260399dc3becfe286eb453b]['r'] = $r;
$this->functionData['calEventSearchResult'][$count_0b9f30f66260399dc3becfe286eb453b]['resultAsTitle'] = $resultAsTitle;
$this->functionData['calEventSearchResult'][$count_0b9f30f66260399dc3becfe286eb453b]['type'] = $type;
$this->functionData['calEventSearchResult'][$count_0b9f30f66260399dc3becfe286eb453b]['ends'] = $ends;
}
...
{
$count_8ad2596dbd47cb2eece79f87c78e58b4 = is_array($this->functionData['event_likeSummaryContents']) ? count($this->functionData['event_likeSummaryContents']) : 0;
$this->functionData['event_likeSummaryContents'][$count_8ad2596dbd47cb2eece79f87c78e58b4]['data'] = $data;
$this->functionData['event_likeSummaryContents'][$count_8ad2596dbd47cb2eece79f87c78e58b4]['relId'] = $relId;
$this->functionData['event_likeSummaryContents'][$count_8ad2596dbd47cb2eece79f87c78e58b4]['opts'] = $opts;
}
$IPBHTML .= "<span class='ipsButton_extra right " . (($data['totalCount']) ? ("_fmore clickable") : ("")) . "' title='" . sprintf( $this->lang->words['like_totalcount_' . $data['vernacular'] ], $data['totalCount'] ) . "' data-tooltip=\"" . sprintf( $this->lang->words['like_totalcount_' . $data['vernacular'] ], $data['totalCount'] ) . "\"><img src='{$this->settings['img_url']}/icon_users.png' /> <strong>{$data['totalCount']}</strong></span>
" . (($this->memberData['member_id']) ? ("<a href='#' title=\"" . (($data['iLike']) ? ("" . sprintf( $this->lang->words['fave_tt_on'], $this->lang->words['like_ucfirst_un' . $data['vernacular'] ]) . "") : ("" . sprintf( $this->lang->words['fave_tt_off'], $this->lang->words['like_ucfirst_' . $data['vernacular'] ]) . "")) . "\" class='ftoggle ipsButton_secondary'>" . (($data['iLike']) ? ("" . sprintf( $this->lang->words['unset_fave_button'], $this->lang->words['like_ucfirst_un' . $data['vernacular'] ]) . "") : ("" . sprintf( $this->lang->words['set_fave_button'], $this->lang->words['like_ucfirst_' . $data['vernacular'] ]) . "")) . "</a>") : ("")) . "";
return $IPBHTML;
...
{
$count_72d8004c1ad5c6ceb59a07e1acb72aa0 = is_array($this->functionData['eventAttendee']) ? count($this->functionData['eventAttendee']) : 0;
$this->functionData['eventAttendee'][$count_72d8004c1ad5c6ceb59a07e1acb72aa0]['member'] = $member;
$this->functionData['eventAttendee'][$count_72d8004c1ad5c6ceb59a07e1acb72aa0]['event'] = $event;
}
...
{
$count_831e0c45c797f5ad671f489454e90df4 = is_array($this->functionData['followedContentCalendars']) ? count($this->functionData['followedContentCalendars']) : 0;
$this->functionData['followedContentCalendars'][$count_831e0c45c797f5ad671f489454e90df4]['rows'] = $rows;
}
$IPBHTML .= "<div id='search_results'>
	<ol>
		".$this->__f__8c35c0847703e1322655f4ce9ed069a6($rows)."	</ol>
</div>";
return $IPBHTML;
}


function __f__8c35c0847703e1322655f4ce9ed069a6($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $r )
...
{
$count_50648d75663c5c6922185744aa45acf7 = is_array($this->functionData['mini_cal_date_cell']) ? count($this->functionData['mini_cal_date_cell']) : 0;
$this->functionData['mini_cal_date_cell'][$count_50648d75663c5c6922185744aa45acf7]['day'] = $day;
}
$IPBHTML .= "<td>
...
{
$count_2fd2a9bc0d70962668647f864294292b = is_array($this->functionData['mini_cal_date_cell_today']) ? count($this->functionData['mini_cal_date_cell_today']) : 0;
$this->functionData['mini_cal_date_cell_today'][$count_2fd2a9bc0d70962668647f864294292b]['day'] = $day;
}
...
{
$count_6b8fc7d7f348815f35f9ad2d3109d332 = is_array($this->functionData['miniCalendarWrapper']) ? count($this->functionData['miniCalendarWrapper']) : 0;
$this->functionData['miniCalendarWrapper'][$count_6b8fc7d7f348815f35f9ad2d3109d332]['data'] = $data;
}
$IPBHTML .= "<div class='mini_cal_wrap ipsBox'>
	<div class='ipsBox_container'>
		...
		<table class='mini_cal vcalendar'>
			<tr>
				".$this->__f__7a79d0dbc276fab93a87f2d5b7e8c4da($data)."			
				{$data['events']}
			</tr>
		</table>
	</div>
...
function __f__7a79d0dbc276fab93a87f2d5b7e8c4da($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data['day_words'] as $day )
...
{
$count_7f62bdd2de816066048da2934e486bd7 = is_array($this->functionData['modEventsWrapper']) ? count($this->functionData['modEventsWrapper']) : 0;
$this->functionData['modEventsWrapper'][$count_7f62bdd2de816066048da2934e486bd7]['events'] = $events;
$this->functionData['modEventsWrapper'][$count_7f62bdd2de816066048da2934e486bd7]['pages'] = $pages;
}
...
<div class='clearfix'>
	" . ((count($events)) ? ("
		".$this->__f__2ca3c05fc62ee0cd437775739d290f54($events,$pages)."	") : ("
...
function __f__2ca3c05fc62ee0cd437775739d290f54($events, $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $events as $event )
...
{
$count_11c6ea948ebb5fed85d3acfd9ca1b651 = is_array($this->functionData['showEvent']) ? count($this->functionData['showEvent']) : 0;
$this->functionData['showEvent'][$count_11c6ea948ebb5fed85d3acfd9ca1b651]['event'] = $event;
$this->functionData['showEvent'][$count_11c6ea948ebb5fed85d3acfd9ca1b651]['member'] = $member;
$this->functionData['showEvent'][$count_11c6ea948ebb5fed85d3acfd9ca1b651]['typeInfo'] = $typeInfo;
$this->functionData['showEvent'][$count_11c6ea948ebb5fed85d3acfd9ca1b651]['like'] = $like;
}
	...
	" . (($event['event_rsvp']) ? ("<div class='ipsBox_container ipsLayout_right'>
			<div id='event_rsvp' class='ipsPad'>
				...
				" . ((count($event['_rsvp_attendees_short'])) ? ("
					...
					".$this->__f__1199b96422da028cbcdd20860d40a069($event,$member,$typeInfo,$like)."					</ul>
				") : ("
		...
		" . (($event['_rsvp_count'] > count( $event['_rsvp_attendees_short'] )) ? ("
			<div id='see_all_attendees_popup' style='display: none'>
				...
				<div class='fixed_inner'>
					...
					".$this->__f__36dfd1713b15f75d544ba0d9ba1c47db($event,$member,$typeInfo,$like)."					</ul>
				</div>
			</div>
			<script type='text/javascript'>
...
function __f__1199b96422da028cbcdd20860d40a069($event, $member, $typeInfo, $like='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__36dfd1713b15f75d544ba0d9ba1c47db($event, $member, $typeInfo, $like='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_581e0a39fb4ec369d4004f035bbe5d1c = is_array($this->functionData['showEventSimple']) ? count($this->functionData['showEventSimple']) : 0;
$this->functionData['showEventSimple'][$count_581e0a39fb4ec369d4004f035bbe5d1c]['event'] = $event;
}
		...
		<div class='post_body'>
			...
			" . (($event['event_rsvp']) ? ("<div class='rsvp'>
					" . ((count( $event['_rsvp_attendees'] )) ? ("
						...
						<div class='clearfix'>
							".$this->__f__ab887d9162f14bafdc710f2491262e3a($event)."						</div>
					") : ("
...
function __f__ab887d9162f14bafdc710f2491262e3a($event)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
