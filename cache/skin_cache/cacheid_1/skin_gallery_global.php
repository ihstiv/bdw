...
class skin_gallery_global_1 extends skinMaster{
...
{
$count_f95fa615dbcab8df90077d933c749d3b = is_array($this->functionData['hookRecentGalleryImages']) ? count($this->functionData['hookRecentGalleryImages']) : 0;
$this->functionData['hookRecentGalleryImages'][$count_f95fa615dbcab8df90077d933c749d3b]['rows'] = $rows;
}
...
<div id='category_gallrecent' class='category_block block_wrap'>
	...
	<div id='appGallLatestHook' class='ipsBox table_wrap'>
		<ul class='ipsList_inline ipsList_nowrap'>
			".$this->__f__143a0fe21bc69af3a740ec814b4cbe72($rows)."		</ul>
	</div>
</div>
<br />";
return $IPBHTML;
...
function __f__143a0fe21bc69af3a740ec814b4cbe72($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $r )
...
{
$count_eaad4cd58924f553e41bde7424b2e018 = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_eaad4cd58924f553e41bde7424b2e018]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_eaad4cd58924f553e41bde7424b2e018]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_eaad4cd58924f553e41bde7424b2e018]['opts'] = $opts;
}
...
{
$count_e9e603aaee1c9c1e2f02d567638ada0b = is_array($this->functionData['listingLightbox']) ? count($this->functionData['listingLightbox']) : 0;
$this->functionData['listingLightbox'][$count_e9e603aaee1c9c1e2f02d567638ada0b]['loadInline'] = $loadInline;
$this->functionData['listingLightbox'][$count_e9e603aaee1c9c1e2f02d567638ada0b]['doAdvanced'] = $doAdvanced;
}
...
{
$count_b114c26658c595f1f90deb7b944b7abc = is_array($this->functionData['shareLinks']) ? count($this->functionData['shareLinks']) : 0;
$this->functionData['shareLinks'][$count_b114c26658c595f1f90deb7b944b7abc]['links'] = $links;
$this->functionData['shareLinks'][$count_b114c26658c595f1f90deb7b944b7abc]['title'] = $title;
$this->functionData['shareLinks'][$count_b114c26658c595f1f90deb7b944b7abc]['url'] = $url;
$this->functionData['shareLinks'][$count_b114c26658c595f1f90deb7b944b7abc]['cssClass'] = $cssClass;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("sharelinks", "0" ) . "
" . ((is_array( $links )) ? ("
	<ul class='{$cssClass} shareButtons ipsList_inline'>
	".$this->__f__1718f2ead83771641e6adac40242643f($links,$title,$url,$cssClass)."		" . ( method_exists( $this->registry->getClass('output')->getTemplate('gallery_global'), 'pinterestButton' ) ? $this->registry->getClass('output')->getTemplate('gallery_global')->pinterestButton($url, $title) : '' ) . "
	</ul>
	<script type=\"text/javascript\">
...
function __f__1718f2ead83771641e6adac40242643f($links, $title='', $url='', $cssClass='topic_share left')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_2ebb99c10d6d2e7047ec25ed89d8c02a = is_array($this->functionData['tagCloud']) ? count($this->functionData['tagCloud']) : 0;
$this->functionData['tagCloud'][$count_2ebb99c10d6d2e7047ec25ed89d8c02a]['tags'] = $tags;
}
	...
	<div class='ipsSideBlock clearfix'>
		...
		<div class='_sbcollapsable'>
			<ul class='ipsList_inline'>
				".$this->__f__51cf8ed7a9a296988d763b9ec9eed289($tags)."			</ul>
		</div>
	</div>
") : ("")) . "";
return $IPBHTML;
...
function __f__51cf8ed7a9a296988d763b9ec9eed289($tags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
