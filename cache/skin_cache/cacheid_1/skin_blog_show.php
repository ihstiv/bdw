...
class skin_blog_show_1 extends skinMaster{
...
{
$count_fb93a52da55f9764464204a0cecae518 = is_array($this->functionData['blogArchive']) ? count($this->functionData['blogArchive']) : 0;
$this->functionData['blogArchive'][$count_fb93a52da55f9764464204a0cecae518]['blog'] = $blog;
$this->functionData['blogArchive'][$count_fb93a52da55f9764464204a0cecae518]['links'] = $links;
$this->functionData['blogArchive'][$count_fb93a52da55f9764464204a0cecae518]['entries'] = $entries;
$this->functionData['blogArchive'][$count_fb93a52da55f9764464204a0cecae518]['cb_left_html'] = $cb_left_html;
$this->functionData['blogArchive'][$count_fb93a52da55f9764464204a0cecae518]['cb_right_html'] = $cb_right_html;
$this->functionData['blogArchive'][$count_fb93a52da55f9764464204a0cecae518]['followData'] = $followData;
}
	...
	<div id='main_column'>
		...
		" . ((is_array( $entries ) && count( $entries )) ? ("
			<table class='ipb_table'>
								".$this->__f__c76ebf357f8d371069b14a1306d24b49($blog,$links,$entries,$cb_left_html,$cb_right_html,$followData)."			</table>
...
function __f__c76ebf357f8d371069b14a1306d24b49($blog, $links, $entries=array(), $cb_left_html="", $cb_right_html="", $followData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_2e8035d76dc41fd692ebd1a96e9f34e5 = is_array($this->functionData['blogEntryView']) ? count($this->functionData['blogEntryView']) : 0;
$this->functionData['blogEntryView'][$count_2e8035d76dc41fd692ebd1a96e9f34e5]['blog'] = $blog;
$this->functionData['blogEntryView'][$count_2e8035d76dc41fd692ebd1a96e9f34e5]['comments_html'] = $comments_html;
$this->functionData['blogEntryView'][$count_2e8035d76dc41fd692ebd1a96e9f34e5]['header'] = $header;
$this->functionData['blogEntryView'][$count_2e8035d76dc41fd692ebd1a96e9f34e5]['entry'] = $entry;
$this->functionData['blogEntryView'][$count_2e8035d76dc41fd692ebd1a96e9f34e5]['poll_html'] = $poll_html;
$this->functionData['blogEntryView'][$count_2e8035d76dc41fd692ebd1a96e9f34e5]['trackbacks_html'] = $trackbacks_html;
$this->functionData['blogEntryView'][$count_2e8035d76dc41fd692ebd1a96e9f34e5]['links'] = $links;
$this->functionData['blogEntryView'][$count_2e8035d76dc41fd692ebd1a96e9f34e5]['cblocks'] = $cblocks;
$this->functionData['blogEntryView'][$count_2e8035d76dc41fd692ebd1a96e9f34e5]['follow'] = $follow;
$this->functionData['blogEntryView'][$count_2e8035d76dc41fd692ebd1a96e9f34e5]['tags'] = $tags;
}
				...
				<div class='entry" . (($entry['entry_status'] != 'published') ? (" moderated") : ("")) . "" . (($entry['hide_private']) ? (" private") : ("")) . "' id='entry_{$entry['entry_id']}'>
					<div class='entry_header row2 ipsPad_half'>
						...
						" . (($this->settings['blog_enable_rating']) ? ("" . (($blog['_allow_rating']) ? ("
							...
							") : ("")) . "
							".$this->__f__a73b9949da22a6293b1c695b2908651f($blog,$comments_html,$header,$entry,$poll_html,$trackbacks_html,$links,$cblocks,$follow,$tags)."							<span id='rating_text'>
...
function __f__a73b9949da22a6293b1c695b2908651f($blog, $comments_html, $header, $entry, $poll_html, $trackbacks_html, $links, $cblocks, $follow, $tags=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_efadd9fe7d1edc3fa3ab8c27f839891c = is_array($this->functionData['blogView']) ? count($this->functionData['blogView']) : 0;
$this->functionData['blogView'][$count_efadd9fe7d1edc3fa3ab8c27f839891c]['blog'] = $blog;
$this->functionData['blogView'][$count_efadd9fe7d1edc3fa3ab8c27f839891c]['links'] = $links;
$this->functionData['blogView'][$count_efadd9fe7d1edc3fa3ab8c27f839891c]['entries'] = $entries;
$this->functionData['blogView'][$count_efadd9fe7d1edc3fa3ab8c27f839891c]['dates'] = $dates;
$this->functionData['blogView'][$count_efadd9fe7d1edc3fa3ab8c27f839891c]['cblocks'] = $cblocks;
$this->functionData['blogView'][$count_efadd9fe7d1edc3fa3ab8c27f839891c]['followData'] = $followData;
}
	...
	<div id='main_column'>
		...
		" . ((!is_array($entries) || !count($entries)) ? ("<p class='no_messages ipsType_subtitle short'>
				" . (($this->request['cat'] OR $this->request['tag']) ? ("{$this->lang->words['no_entry_matches']}") : ("{$blog['blog_name']} {$this->lang->words['no_entries_yet']}")) . "
						...
						<div class='ipsBox'>
				".$this->__f__325630bd7f110abbe85e17fd18d19267($blog,$links,$entries,$dates,$cblocks,$followData)."				<br class='clear' />
			</div>
		")) . "
		<br />
		<!-- Pagination -->
...
function __f__325630bd7f110abbe85e17fd18d19267($blog, $links, $entries=array(), $dates=array(), $cblocks=array(), $followData="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $entries as $entry )
...
{
$count_39e068e0c8823c430ee908d1104f80d1 = is_array($this->functionData['entryAlbum']) ? count($this->functionData['entryAlbum']) : 0;
$this->functionData['entryAlbum'][$count_39e068e0c8823c430ee908d1104f80d1]['album'] = $album;
$this->functionData['entryAlbum'][$count_39e068e0c8823c430ee908d1104f80d1]['album_id'] = $album_id;
}
$IPBHTML .= "<div id='attach_wrap' class='rounded clearfix'>
	<ul>
		".$this->__f__c569cbe9ab95596ecb5fac2078b6e675($album,$album_id)."	</ul>
</div>
<br />";
return $IPBHTML;
}
...
function __f__c569cbe9ab95596ecb5fac2078b6e675($album="",$album_id)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_9b9feaf142c7bb79923bbabbbd26efec = is_array($this->functionData['entryTrackbacks']) ? count($this->functionData['entryTrackbacks']) : 0;
$this->functionData['entryTrackbacks'][$count_9b9feaf142c7bb79923bbabbbd26efec]['entry_id'] = $entry_id;
$this->functionData['entryTrackbacks'][$count_9b9feaf142c7bb79923bbabbbd26efec]['rows'] = $rows;
}
...
" . ((is_array( $rows ) && count( $rows )) ? ("
	<div id='trackbacks'>
				".$this->__f__c80187209d93c7e4c2f688fbb91bfaa7($entry_id,$rows)."	</div>
") : ("
...
function __f__c80187209d93c7e4c2f688fbb91bfaa7($entry_id="",$rows=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_9ae34f8906c70e75912bbac9fcec549f = is_array($this->functionData['pollDisplay']) ? count($this->functionData['pollDisplay']) : 0;
$this->functionData['pollDisplay'][$count_9ae34f8906c70e75912bbac9fcec549f]['poll'] = $poll;
$this->functionData['pollDisplay'][$count_9ae34f8906c70e75912bbac9fcec549f]['entry'] = $entry;
$this->functionData['pollDisplay'][$count_9ae34f8906c70e75912bbac9fcec549f]['pollData'] = $pollData;
$this->functionData['pollDisplay'][$count_9ae34f8906c70e75912bbac9fcec549f]['showResults'] = $showResults;
}
$IPBHTML .= "<script type='text/javascript'>
...
<div class='general_box alt poll' id='poll_{$poll['pid']}'>
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=blog&amp;module=actions&amp;section=dovote&amp;eid={$entry['entry_id']}&amp;blogid={$this->request['blogid']}&amp;st={$this->request['st']}&amp;auth_key={$this->member->form_hash}", "public",'' ), "", "" ) . "\" method=\"post\">
		...
		") : ("")) . "
		".$this->__f__da38b37a98a32ad2ac1ccb1620e652f6($poll,$entry,$pollData,$showResults)."		" . ((!$entry['entry_locked']) ? ("<fieldset class='submit'>
...
function __f__89055bf788976951efd0e8ce493dbbd2($poll, $entry, $pollData, $showResults,$questionID='',$questionData='',$choiceID='',$choiceData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b1f2bddc2c29a6e442be53948e4a86d4($poll, $entry, $pollData, $showResults,$questionID='',$questionData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
							...
							" . (($showResults) ? ("<li>
									...
									" . (($poll['poll_view_voters'] AND is_array( $choiceData['voters'] ) AND $this->settings['poll_allow_public'] AND $choiceData['votes']) ? ("
										<script type='text/javascript'>
											...
											".$this->__f__89055bf788976951efd0e8ce493dbbd2($poll,$entry,$pollData,$showResults,$questionID,$questionData,$choiceID,$choiceData)."											ipb.topic.poll[ $questionID ][ $choiceID ] = { name: \"{$choiceData['choice']}\", users: users};
										</script>
									") : ("")) . "
...
function __f__da38b37a98a32ad2ac1ccb1620e652f6($poll, $entry, $pollData, $showResults)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $pollData as $questionID => $questionData )
	{
		...
		$_ips___x_retval .= "
			<div class='poll_question" . (($showResults) ? (" voted") : ("")) . "'>
				...
				") : ("
					<ol>
						".$this->__f__b1f2bddc2c29a6e442be53948e4a86d4($poll,$entry,$pollData,$showResults,$questionID,$questionData)."					</ol>
				")) . "
			</div>
...
{
$count_1e17004ea84dca787a781d81a331af7c = is_array($this->functionData['show_attachment_title']) ? count($this->functionData['show_attachment_title']) : 0;
$this->functionData['show_attachment_title'][$count_1e17004ea84dca787a781d81a331af7c]['title'] = $title;
$this->functionData['show_attachment_title'][$count_1e17004ea84dca787a781d81a331af7c]['data'] = $data;
$this->functionData['show_attachment_title'][$count_1e17004ea84dca787a781d81a331af7c]['type'] = $type;
}
$IPBHTML .= "<div id='attach_wrap' class='rounded clearfix'>
	<h4>{$title}</h4>
	<ul>
		".$this->__f__5ba6d6b329546346b4451ecb485a3662($title,$data,$type)."	</ul>
</div>";
return $IPBHTML;
}


function __f__5ba6d6b329546346b4451ecb485a3662($title="",$data="",$type="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
