...
{
$count_922141b40e59857b21ec4b9257a7b7b8 = is_array($this->functionData['ajaxSharePost']) ? count($this->functionData['ajaxSharePost']) : 0;
$this->functionData['ajaxSharePost'][$count_922141b40e59857b21ec4b9257a7b7b8]['topic'] = $topic;
$this->functionData['ajaxSharePost'][$count_922141b40e59857b21ec4b9257a7b7b8]['post'] = $post;
$this->functionData['ajaxSharePost'][$count_922141b40e59857b21ec4b9257a7b7b8]['url'] = $url;
$this->functionData['ajaxSharePost'][$count_922141b40e59857b21ec4b9257a7b7b8]['sharelinks'] = $sharelinks;
}
...
{
$count_2acf21b99227dc3bf3d6cdbaed388837 = is_array($this->functionData['announcement_show']) ? count($this->functionData['announcement_show']) : 0;
$this->functionData['announcement_show'][$count_2acf21b99227dc3bf3d6cdbaed388837]['announce'] = $announce;
$this->functionData['announcement_show'][$count_2acf21b99227dc3bf3d6cdbaed388837]['author'] = $author;
}
...
{
$count_326392bffde00b17f5a2d79e7b5e835f = is_array($this->functionData['archiveStatusMessage']) ? count($this->functionData['archiveStatusMessage']) : 0;
$this->functionData['archiveStatusMessage'][$count_326392bffde00b17f5a2d79e7b5e835f]['topic'] = $topic;
$this->functionData['archiveStatusMessage'][$count_326392bffde00b17f5a2d79e7b5e835f]['forum'] = $forum;
}
...
{
$count_5e4b0e9f48248993decdb4a6b3d4eef4 = is_array($this->functionData['hookFacebookLike']) ? count($this->functionData['hookFacebookLike']) : 0;
}
...
{
$count_70932f92209cebed227f2e9d6db8b273 = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_70932f92209cebed227f2e9d6db8b273]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_70932f92209cebed227f2e9d6db8b273]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_70932f92209cebed227f2e9d6db8b273]['opts'] = $opts;
}
...
{
$count_888efea2cc6dd8096633b4a5c0be8d4e = is_array($this->functionData['pollDisplay']) ? count($this->functionData['pollDisplay']) : 0;
$this->functionData['pollDisplay'][$count_888efea2cc6dd8096633b4a5c0be8d4e]['poll'] = $poll;
$this->functionData['pollDisplay'][$count_888efea2cc6dd8096633b4a5c0be8d4e]['topicData'] = $topicData;
$this->functionData['pollDisplay'][$count_888efea2cc6dd8096633b4a5c0be8d4e]['forumData'] = $forumData;
$this->functionData['pollDisplay'][$count_888efea2cc6dd8096633b4a5c0be8d4e]['pollData'] = $pollData;
$this->functionData['pollDisplay'][$count_888efea2cc6dd8096633b4a5c0be8d4e]['showResults'] = $showResults;
$this->functionData['pollDisplay'][$count_888efea2cc6dd8096633b4a5c0be8d4e]['editPoll'] = $editPoll;
}
...
<div class='general_box alt poll' id='poll_{$poll['pid']}'>
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=extras&amp;section=vote&amp;t={$topicData['tid']}&amp;page={$this->request['page']}&amp;do=add&amp;secure_key={$this->member->form_hash}", "public",'' ), "", "" ) . "\" name='pollForm' method=\"post\">
		...
		") : ("")) . "
		".$this->__f__fcef809ac7813237c8dca61439d16320($poll,$topicData,$forumData,$pollData,$showResults,$editPoll)."		<fieldset class='submit'>
...
function __f__195a40169921d950613e4ffcaa0e8a99($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='',$choiceID='',$choiceData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__61c9565601f6be1a68c4c47813e0df89($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
							...
							" . (($showResults) ? ("<li>
									...
									" . (($poll['poll_view_voters'] AND is_array( $choiceData['voters'] ) AND $this->settings['poll_allow_public'] AND $choiceData['votes']) ? ("
										<script type='text/javascript'>
											...
											".$this->__f__195a40169921d950613e4ffcaa0e8a99($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData,$choiceID,$choiceData)."											ipb.topic.poll[ $questionID ][ $choiceID ] = { name: \"{$choiceData['choice']}\", users: users};
										</script>
									") : ("")) . "
...
function __f__fcef809ac7813237c8dca61439d16320($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $pollData as $questionID => $questionData )
	{
		...
		$_ips___x_retval .= "
			<div class='poll_question" . (($showResults) ? (" voted") : ("")) . "'>
				...
				") : ("
					<ol>
						".$this->__f__61c9565601f6be1a68c4c47813e0df89($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData)."					</ol>
				")) . "
			</div>
...
{
$count_b900961c575648feafa66644e4935d26 = is_array($this->functionData['post']) ? count($this->functionData['post']) : 0;
$this->functionData['post'][$count_b900961c575648feafa66644e4935d26]['post'] = $post;
$this->functionData['post'][$count_b900961c575648feafa66644e4935d26]['displayData'] = $displayData;
$this->functionData['post'][$count_b900961c575648feafa66644e4935d26]['topic'] = $topic;
$this->functionData['post'][$count_b900961c575648feafa66644e4935d26]['forum'] = $forum;
}
		...
		<div class='post_wrap' " . (($post['post']['_ignored'] == 1 || $post['post']['_repignored'] == 1) ? ("style='display: none'") : ("")) . ">
			...
			<div class='post_body'>
				<p class='posted_info desc lighter ipsType_small'>
					{$this->lang->words['posted']} <abbr class=\"published\" itemprop=\"commentTime\" title=\"" . date( 'c', $post['post']['post_date'] ) . "\">" . IPSText::htmlspecialchars($this->registry->getClass('class_localization')->getDate($post['post']['post_date'],"long", 0)) . "</abbr>
...
{
$count_306e79b7efa1cfcd908be923691a75eb = is_array($this->functionData['quickEditPost']) ? count($this->functionData['quickEditPost']) : 0;
$this->functionData['quickEditPost'][$count_306e79b7efa1cfcd908be923691a75eb]['post'] = $post;
}
$IPBHTML .= "{$post['post']}
    {$post['attachmentHtml']}
	<br />
...
{
$count_5db05f0f00cfb6d2d707a13b4e5cbd39 = is_array($this->functionData['show_attachment_title']) ? count($this->functionData['show_attachment_title']) : 0;
$this->functionData['show_attachment_title'][$count_5db05f0f00cfb6d2d707a13b4e5cbd39]['title'] = $title;
$this->functionData['show_attachment_title'][$count_5db05f0f00cfb6d2d707a13b4e5cbd39]['data'] = $data;
$this->functionData['show_attachment_title'][$count_5db05f0f00cfb6d2d707a13b4e5cbd39]['type'] = $type;
}
$IPBHTML .= "<div id='attach_wrap' class='clearfix'>
	<h4>{$title}</h4>
	<ul>
		".$this->__f__57518dd5d0acbe36c45d783bc12f731b($title,$data,$type)."	</ul>
</div>";
return $IPBHTML;
}


function __f__57518dd5d0acbe36c45d783bc12f731b($title="",$data="",$type="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_76dd3fc99fdf0577913cd23b356c0a10 = is_array($this->functionData['Show_attachments']) ? count($this->functionData['Show_attachments']) : 0;
$this->functionData['Show_attachments'][$count_76dd3fc99fdf0577913cd23b356c0a10]['data'] = $data;
}
...
{
$count_40478c733791b13110421b549f37b012 = is_array($this->functionData['softDeletedPostBit']) ? count($this->functionData['softDeletedPostBit']) : 0;
$this->functionData['softDeletedPostBit'][$count_40478c733791b13110421b549f37b012]['post'] = $post;
$this->functionData['softDeletedPostBit'][$count_40478c733791b13110421b549f37b012]['sdData'] = $sdData;
$this->functionData['softDeletedPostBit'][$count_40478c733791b13110421b549f37b012]['topic'] = $topic;
}
...
$IPBHTML = "";
$IPBHTML .= "".$this->__f__e83fa46194c6cadba8ea016cf8a1fabf($topic,$posts)."<br class='clear' />
...
function __f__e83fa46194c6cadba8ea016cf8a1fabf($topic, $posts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_35a1285d9f7fd2765b23988bece297e3 = is_array($this->functionData['topicViewTemplate']) ? count($this->functionData['topicViewTemplate']) : 0;
$this->functionData['topicViewTemplate'][$count_35a1285d9f7fd2765b23988bece297e3]['forum'] = $forum;
$this->functionData['topicViewTemplate'][$count_35a1285d9f7fd2765b23988bece297e3]['topic'] = $topic;
$this->functionData['topicViewTemplate'][$count_35a1285d9f7fd2765b23988bece297e3]['post_data'] = $post_data;
$this->functionData['topicViewTemplate'][$count_35a1285d9f7fd2765b23988bece297e3]['displayData'] = $displayData;
}
...
" . (($displayData['mod_links'] AND ( $this->memberData['is_mod'] OR $this->memberData['member_id'] == $topic['starter_id'] )) ? ("<ul class='ipbmenu_content' id='topic_mod_options_menucontent'  style='display:none'>
	".$this->__f__cd5e5e892120f417608fe83dbc90166a($forum,$topic,$post_data,$displayData)."	" . (($topic['topic_queuedposts'] AND $this->registry->class_forums->canQueuePosts( $forum['id'] )) ? ("
	...
	" . ((is_array( $displayData['multi_mod'] ) AND count( $displayData['multi_mod'] )) ? ("
		".$this->__f__68f5404f44e46d4d78da20e18498d0f4($forum,$topic,$post_data,$displayData)."	") : ("")) . "
</ul>
<script type='text/javascript'>
...
" . (($this->settings['reputation_enabled'] && $this->settings['reputation_point_types'] != 'like' && $this->settings['reputation_show_content'] && $this->memberData['member_id'] != 0 && is_array($this->caches['reputation_levels'])) ? ("<ul id='rep_filter_menucontent' class='ipbmenu_content with_checks' style='display: none'>
		...
		" . ((is_array($this->caches['reputation_levels'])) ? ("
			".$this->__f__665d35d8d6bfe233e31aae34f2df27f5($forum,$topic,$post_data,$displayData)."		") : ("")) . "
	</ul>
	<script type='text/javascript'>
...
<!--hook.if.skin_topic.topicViewTemplate.hasPosts.pre.startif-->" . ((is_array( $post_data ) AND count( $post_data )) ? ("
	<div class='ipsBox'>
		<div class='ipsBox_container' id='ips_Posts'>
			".$this->__f__1dea0aedd44f691a2e050c7270fea4aa($forum,$topic,$post_data,$displayData)."		</div>
	</div>
") : ("")) . "
<hr />
<div class='topic_controls clear ipsPad_top_bottom_half'>
	...
	<div class='ipsPad_top_slimmer right'>
		...
		" . (($forum['_hasUnreadTopics']) ? ("
			&middot; <a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "showtopic={$topic['tid']}&amp;view=getnextunread", "public",'' ), "{$topic['title_seo']}", "showtopicnextunread" ) . "' rel=\"nofollow\" class=\"ipsType_small desc\">{$this->lang->words['goto_next_unread_topic']}</a>
		") : ("")) . "
	</div>
</div>
...
" . ((is_array( $displayData['same_tagged'] ) and count( $displayData['same_tagged'] )) ? ("
	...
	<div class='ipsBox'>
		...
		<div class='ipsBox_container'>
			...
			".$this->__f__cc9885c44d29971fd63d397d0ec2b15e($forum,$topic,$post_data,$displayData)."			</table>
		</div>
	</div>
") : ("")) . "
<!-- ACTIVE USERS -->
...
function __f__cd5e5e892120f417608fe83dbc90166a($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__68f5404f44e46d4d78da20e18498d0f4($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__665d35d8d6bfe233e31aae34f2df27f5($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__1dea0aedd44f691a2e050c7270fea4aa($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__cc9885c44d29971fd63d397d0ec2b15e($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
