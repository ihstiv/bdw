...
class skin_blog_cblocks_1 extends skinMaster{
...
{
$count_09caccdb5d16fbba9ba3a4e6028869c1 = is_array($this->functionData['block_activeusers']) ? count($this->functionData['block_activeusers']) : 0;
$this->functionData['block_activeusers'][$count_09caccdb5d16fbba9ba3a4e6028869c1]['active'] = $active;
}
...
")) . "" . ((is_array( $categories ) AND count( $categories )) ? ("".$this->__f__fed70b599f4255f2d0f80a739052f6dd($blogid,$categories)."	") : ("")) . "
</ul>";
return $IPBHTML;
}


function __f__fed70b599f4255f2d0f80a739052f6dd($blogid, $categories=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_d7e229add6f071a58ca72b0fb52eded5 = is_array($this->functionData['cblock_footer']) ? count($this->functionData['cblock_footer']) : 0;
$this->functionData['cblock_footer'][$count_d7e229add6f071a58ca72b0fb52eded5]['cblock'] = $cblock;
$this->functionData['cblock_footer'][$count_d7e229add6f071a58ca72b0fb52eded5]['auth_key'] = $auth_key;
}
$IPBHTML .= "</div>
...
{
$count_dc0b0c24720cfe247bd1403de78b39e3 = is_array($this->functionData['cblock_friends']) ? count($this->functionData['cblock_friends']) : 0;
$this->functionData['cblock_friends'][$count_dc0b0c24720cfe247bd1403de78b39e3]['friends'] = $friends;
}
$IPBHTML .= "" . ((is_array( $friends ) && count( $friends )) ? ("
	<ul class='ipsList_withminiphoto ipsPad_half'>
		".$this->__f__6d6b58f22f4c4a1c4b04e5daf03b72b1($friends)."	</ul>
") : ("
...
function __f__6d6b58f22f4c4a1c4b04e5daf03b72b1($friends=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_cfbd9213e8cc1967a5248af56a62f3f4 = is_array($this->functionData['cblock_header']) ? count($this->functionData['cblock_header']) : 0;
$this->functionData['cblock_header'][$count_cfbd9213e8cc1967a5248af56a62f3f4]['cblock'] = $cblock;
$this->functionData['cblock_header'][$count_cfbd9213e8cc1967a5248af56a62f3f4]['title'] = $title;
$this->functionData['cblock_header'][$count_cfbd9213e8cc1967a5248af56a62f3f4]['configable'] = $configable;
$this->functionData['cblock_header'][$count_cfbd9213e8cc1967a5248af56a62f3f4]['nopad'] = $nopad;
}
...
{
$count_fee507c6cf16eb0252e98aa8c3b56522 = is_array($this->functionData['comments']) ? count($this->functionData['comments']) : 0;
$this->functionData['comments'][$count_fee507c6cf16eb0252e98aa8c3b56522]['comments'] = $comments;
}
$IPBHTML .= "<ul class='ipsList_withminiphoto ipsPad_half'>
	" . ((is_array( $comments ) && count( $comments )) ? ("
		".$this->__f__f4726a318366773318275066ff8191ec($comments)."	") : ("
...
function __f__f4726a318366773318275066ff8191ec($comments=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_110c6f1f9d444ba281c86870dfc76d16 = is_array($this->functionData['latest_visitors']) ? count($this->functionData['latest_visitors']) : 0;
$this->functionData['latest_visitors'][$count_110c6f1f9d444ba281c86870dfc76d16]['visitors'] = $visitors;
}
$IPBHTML .= "" . ((is_array( $visitors ) && count( $visitors )) ? ("
	<ul class='ipsList_withminiphoto ipsPad_half'>
		".$this->__f__bc3135310e8310bd44892090d10d6e51($visitors)."	</ul>
") : ("
...
function __f__bc3135310e8310bd44892090d10d6e51($visitors=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_6739d0b2635120785e8f0e0d194c606b = is_array($this->functionData['mini_cal_mini_wrap']) ? count($this->functionData['mini_cal_mini_wrap']) : 0;
$this->functionData['mini_cal_mini_wrap'][$count_6739d0b2635120785e8f0e0d194c606b]['content'] = $content;
$this->functionData['mini_cal_mini_wrap'][$count_6739d0b2635120785e8f0e0d194c606b]['days'] = $days;
}
$IPBHTML .= "<table class='mini_cal row1'>
	<tr class='header'>
		".$this->__f__4a30c12de5cfffb00db8bdc15fe4b3e8($content,$days)."	</tr>
	<tr>
		{$content}
	</tr>
</table>";
...
function __f__4a30c12de5cfffb00db8bdc15fe4b3e8($content="", $days)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $days as $day )
...
{
$count_23e61938966f089e03aee3e4109d3ce2 = is_array($this->functionData['recentEntries']) ? count($this->functionData['recentEntries']) : 0;
$this->functionData['recentEntries'][$count_23e61938966f089e03aee3e4109d3ce2]['entries'] = $entries;
}
$IPBHTML .= "<ul class='ipsList_withminiphoto ipsPad_half'>
	" . ((is_array( $entries ) && count( $entries )) ? ("
		".$this->__f__f7b7defab28f3510291772def367b9e1($entries)."	") : ("
...
function __f__f7b7defab28f3510291772def367b9e1($entries=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
