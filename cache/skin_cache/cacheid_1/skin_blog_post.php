...
class skin_blog_post_1 extends skinMaster{
...
{
$count_6bc8785b68f0417b6c4bc006ce5942fb = is_array($this->functionData['blogPostForm']) ? count($this->functionData['blogPostForm']) : 0;
$this->functionData['blogPostForm'][$count_6bc8785b68f0417b6c4bc006ce5942fb]['form_hiddens'] = $form_hiddens;
$this->functionData['blogPostForm'][$count_6bc8785b68f0417b6c4bc006ce5942fb]['button'] = $button;
$this->functionData['blogPostForm'][$count_6bc8785b68f0417b6c4bc006ce5942fb]['date'] = $date;
$this->functionData['blogPostForm'][$count_6bc8785b68f0417b6c4bc006ce5942fb]['title'] = $title;
$this->functionData['blogPostForm'][$count_6bc8785b68f0417b6c4bc006ce5942fb]['albums'] = $albums;
$this->functionData['blogPostForm'][$count_6bc8785b68f0417b6c4bc006ce5942fb]['mod_options'] = $mod_options;
$this->functionData['blogPostForm'][$count_6bc8785b68f0417b6c4bc006ce5942fb]['editor'] = $editor;
$this->functionData['blogPostForm'][$count_6bc8785b68f0417b6c4bc006ce5942fb]['poll_box'] = $poll_box;
$this->functionData['blogPostForm'][$count_6bc8785b68f0417b6c4bc006ce5942fb]['upload_field'] = $upload_field;
$this->functionData['blogPostForm'][$count_6bc8785b68f0417b6c4bc006ce5942fb]['html_status'] = $html_status;
$this->functionData['blogPostForm'][$count_6bc8785b68f0417b6c4bc006ce5942fb]['canPublish'] = $canPublish;
$this->functionData['blogPostForm'][$count_6bc8785b68f0417b6c4bc006ce5942fb]['blogsdd'] = $blogsdd;
$this->functionData['blogPostForm'][$count_6bc8785b68f0417b6c4bc006ce5942fb]['_extraData'] = $_extraData;
$this->functionData['blogPostForm'][$count_6bc8785b68f0417b6c4bc006ce5942fb]['tagBox'] = $tagBox;
$this->functionData['blogPostForm'][$count_6bc8785b68f0417b6c4bc006ce5942fb]['following'] = $following;
$this->functionData['blogPostForm'][$count_6bc8785b68f0417b6c4bc006ce5942fb]['socialShare'] = $socialShare;
$this->functionData['blogPostForm'][$count_6bc8785b68f0417b6c4bc006ce5942fb]['image'] = $image;
}
...
<form id='postingform' action='{$this->settings['base_url']}' method='post' name='postingform' enctype='multipart/form-data'>
					...
					<li class='ipsField ipsField_select'>
						...
						<p class='ipsField_content'>
							<select name='blogid' id='blog_chooser'>
								".$this->__f__088330adabca0bde925a2593529b7616($form_hiddens,$button,$date,$title,$albums,$mod_options,$editor,$poll_box,$upload_field,$html_status,$canPublish,$blogsdd,$_extraData,$tagBox,$following,$socialShare,$image)."							</select>
						</p>
					</li>
				") : ("")) . "
	...
	<fieldset class='submit clear'>
		...
		" . ((is_array( $form_hiddens ) && count( $form_hiddens )) ? ("
			".$this->__f__600746e59bfc0c1cb508155fb61a6d52($form_hiddens,$button,$date,$title,$albums,$mod_options,$editor,$poll_box,$upload_field,$html_status,$canPublish,$blogsdd,$_extraData,$tagBox,$following,$socialShare,$image)."		") : ("")) . "
...
function __f__088330adabca0bde925a2593529b7616($form_hiddens=array(), $button="", $date=array(), $title=array(), $albums="", $mod_options="", $editor="", $poll_box="", $upload_field='', $html_status=array(), $canPublish=0, $blogsdd='', $_extraData=array(), $tagBox='', $following = 0, $socialShare, $image='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__600746e59bfc0c1cb508155fb61a6d52($form_hiddens=array(), $button="", $date=array(), $title=array(), $albums="", $mod_options="", $editor="", $poll_box="", $upload_field='', $html_status=array(), $canPublish=0, $blogsdd='', $_extraData=array(), $tagBox='', $following = 0, $socialShare, $image='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_cd51cf0156ed606642a2b3f583c93263 = is_array($this->functionData['cBlockForm']) ? count($this->functionData['cBlockForm']) : 0;
$this->functionData['cBlockForm'][$count_cd51cf0156ed606642a2b3f583c93263]['form_hiddens'] = $form_hiddens;
$this->functionData['cBlockForm'][$count_cd51cf0156ed606642a2b3f583c93263]['button'] = $button;
$this->functionData['cBlockForm'][$count_cd51cf0156ed606642a2b3f583c93263]['cbtitle'] = $cbtitle;
$this->functionData['cBlockForm'][$count_cd51cf0156ed606642a2b3f583c93263]['editor'] = $editor;
$this->functionData['cBlockForm'][$count_cd51cf0156ed606642a2b3f583c93263]['html_status'] = $html_status;
$this->functionData['cBlockForm'][$count_cd51cf0156ed606642a2b3f583c93263]['upload_field'] = $upload_field;
$this->functionData['cBlockForm'][$count_cd51cf0156ed606642a2b3f583c93263]['blogData'] = $blogData;
}
$IPBHTML .= "<br />
<form id='postingform' action='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=blog&amp;module=post&amp;section=post", "public",'' ), "", "" ) . "' method='post' enctype='multipart/form-data'>
	...
	<fieldset class='submit clear'>
		...
		<input type='hidden' name='removeattachid' value='0' />
		" . ((is_array( $form_hiddens ) && count( $form_hiddens )) ? ("
			".$this->__f__aaac89f0ea311728d8a05d512720535a($form_hiddens,$button,$cbtitle,$editor,$html_status,$upload_field,$blogData)."		") : ("")) . "
...
function __f__aaac89f0ea311728d8a05d512720535a($form_hiddens=array(), $button='', $cbtitle='', $editor='', $html_status=array(), $upload_field='', $blogData=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
