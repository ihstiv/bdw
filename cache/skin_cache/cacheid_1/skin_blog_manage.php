...
class skin_blog_manage_1 extends skinMaster{
...
$this->_funcHooks['listCategories'] = array('isCategorizedEdit','isCategorized','managecategories','isCategorizedPopups','categoryPopups');
...
$this->_funcHooks['settingsForm'] = array('viewlevelloop','isCreating','hasError','alloweditors','allowprivateclub','islocal','isremote','localhiddensetting','allowcreate','allowguests','allowguestcomments','disablecomments','allowrss','rssallowed','ping_services','allowtrackbacks','approvetrackbacks','selectskin','listview','groupperdate','grouppermonth','xmlrpcenabled');
...
{
$count_e36fa16f62f1d7a42215165ca506d9d8 = is_array($this->functionData['create2']) ? count($this->functionData['create2']) : 0;
$this->functionData['create2'][$count_e36fa16f62f1d7a42215165ca506d9d8]['blog'] = $blog;
$this->functionData['create2'][$count_e36fa16f62f1d7a42215165ca506d9d8]['errors'] = $errors;
}
...
{
$count_4e7a1f5e847914169389278ffc2713cb = is_array($this->functionData['listCategories']) ? count($this->functionData['listCategories']) : 0;
$this->functionData['listCategories'][$count_4e7a1f5e847914169389278ffc2713cb]['blog'] = $blog;
}
	...
	<table class=\"ipb_table\">
		<tr class=\"header\">
			...
			<th class='col_mod'></th>
				...
				".$this->__f__d0c8dbcb977113a08f1ce50410c61e54($blog)."	</table>
...
</script>".$this->__f__f89aef666b2060d46876e1879368bbf9($blog)."";
return $IPBHTML;
}


function __f__d0c8dbcb977113a08f1ce50410c61e54($blog=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $blog['_categories'] as $id => $category )
	{
		...
		$_ips___x_retval .= "
			<tr class=\"" .  IPSLib::next( $this->registry->templateStriping["categories"] ) . "\">
				<td>" . $this->registry->getClass('output')->getReplacement("blog_category") . " <a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=blog&blogid={$blog['blog_id']}&cat={$id}", "public",'' ), "{$category['category_title_seo']}", "blogcatview" ) . "\">{$category['category_title']}</a>" . ((!empty($id)) ? (" <a id='editCategory_{$id}' class='expander right' href='#'><img src='{$this->settings['img_url']}/textfield_rename.png' alt=\"edit\" /></a>") : ("")) . "</td>
...
function __f__f89aef666b2060d46876e1879368bbf9($blog=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $blog['_categories'] as $id => $category )
	{
		...
		$_ips___x_retval .= "
	" . ((!empty($id)) ? ("
		<div id='editCategory_popup_{$id}' style='display:none'>
			<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=blog&module=manage&section=categories&act=edit&catid={$id}", "public",'' ), "false", "manageblog" ) . "\" method=\"post\">
				<input type=\"hidden\" name=\"form_hash\" value=\"{$this->member->form_hash}\" />
				<h3>{$this->lang->words['form_edit_cat']}</h3>
				<div class=\"ipsBox ipsPad\" style='text-align:center'>
					<input class='input_text' type=\"text\" name=\"title\" size=\"35\" maxlength=\"32\" value=\"{$category['category_title']}\" />
				</div>
				<fieldset class='submit'>
					<input type='submit' value='{$this->lang->words['blog_edit']}' class='input_submit' />
				</fieldset>
			</form>
		</div>
		
		<script type='text/javascript'>
			$('editCategory_{$id}').on('click', function(e){
				Event.stop(e);
				new ipb.Popup( 'see_all', {
								type: 'pane',
								initial: $('editCategory_popup_{$id}').show(),
								hideAtStart: false,
								stem: false,
								hideClose: false,
								w: '350px',
...
{
$count_98f61ad9da3f7f30e318c7760b9ead04 = is_array($this->functionData['manageComments']) ? count($this->functionData['manageComments']) : 0;
$this->functionData['manageComments'][$count_98f61ad9da3f7f30e318c7760b9ead04]['comments'] = $comments;
$this->functionData['manageComments'][$count_98f61ad9da3f7f30e318c7760b9ead04]['blog'] = $blog;
$this->functionData['manageComments'][$count_98f61ad9da3f7f30e318c7760b9ead04]['pagination'] = $pagination;
}
...
" . ((is_array( $comments ) && count( $comments )) ? ("<div class='ipsBox'>
		".$this->__f__5e142dea14a2a375669ffa4809171e98($comments,$blog,$pagination)."	</div>
	" . (($this->memberData['g_blog_allowownmod']) ? ("
			<div class='bar altbar moderation_bar with_action'>
...
function __f__5e142dea14a2a375669ffa4809171e98($comments, $blog, $pagination)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		$_ips___x_retval .= "
			<div class='ipsBox_container ipsPad " . ((!$comment['comment_approved']) ? (" moderated' style='background-color: #f8f1f3") : ("")) . "'>
				...
				<div class='ipsComment_author'>
					" . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'userSmallPhoto' ) ? $this->registry->getClass('output')->getTemplate('global')->userSmallPhoto(array_merge( $comment, array( '_customClass' => 'ipsUserPhoto_mini' ) )) : '' ) . "
...
{
$count_219cfc817a069f03a3b9326f4846609e = is_array($this->functionData['manageDashboard']) ? count($this->functionData['manageDashboard']) : 0;
$this->functionData['manageDashboard'][$count_219cfc817a069f03a3b9326f4846609e]['myBlogs'] = $myBlogs;
$this->functionData['manageDashboard'][$count_219cfc817a069f03a3b9326f4846609e]['latestComments'] = $latestComments;
$this->functionData['manageDashboard'][$count_219cfc817a069f03a3b9326f4846609e]['error'] = $error;
$this->functionData['manageDashboard'][$count_219cfc817a069f03a3b9326f4846609e]['dropdown'] = $dropdown;
}
		...
		<table class='ipb_table' summary=\"{$this->lang->words['your_current_blogs']}\">
			<tr class='header'>
				...
				<th scope='col' class='short' width=\"10%\">{$this->lang->words['your_blogs_comments']}</th>
						...
						".$this->__f__5dce8bc258640890f5d4aa23af1df542($myBlogs,$latestComments,$error,$dropdown)."		</table>
		<br />
	</div>
	" . ((is_array( $latestComments ) && count( $latestComments )) ? ("<div class='ipsLayout_right'>
			" . (($this->memberData['g_blog_allowownmod']) ? ("
				<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=blog&amp;module=manage&amp;section=comments&amp;act=moderate", "public",'' ), "false", "manageblog" ) . "\" id=\"checkBoxForm\" method=\"post\"> 
					<input type=\"hidden\" name=\"form_hash\" value=\"{$this->member->form_hash}\" />
			...
			<div class='ipsBox'>
				".$this->__f__404bd74ba35ede60a432add6c519245e($myBlogs,$latestComments,$error,$dropdown)."			</div>
...
function __f__5dce8bc258640890f5d4aa23af1df542($myBlogs=array(), $latestComments=array(), $error='', $dropdown='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__404bd74ba35ede60a432add6c519245e($myBlogs=array(), $latestComments=array(), $error='', $dropdown='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_eb64baed21c17206d7c02f48179b2dc1 = is_array($this->functionData['rssImportForm']) ? count($this->functionData['rssImportForm']) : 0;
$this->functionData['rssImportForm'][$count_eb64baed21c17206d7c02f48179b2dc1]['blog'] = $blog;
$this->functionData['rssImportForm'][$count_eb64baed21c17206d7c02f48179b2dc1]['data'] = $data;
$this->functionData['rssImportForm'][$count_eb64baed21c17206d7c02f48179b2dc1]['error'] = $error;
$this->functionData['rssImportForm'][$count_eb64baed21c17206d7c02f48179b2dc1]['tagBox'] = $tagBox;
}
				...
				<li class='ipsField ipsField_select'>
					...
					<p class='ipsField_content'>
						<select name='rss_cats[]' id='rss_cats' multiple='true' size='5'>
							" . ((is_array($data['_cats']) AND count($data['_cats'])) ? ("".$this->__f__c92586bd2bd46e051a95dea9b7beb054($blog,$data,$error,$tagBox)."							") : ("")) . "
						</select>
...
function __f__c92586bd2bd46e051a95dea9b7beb054($blog, $data, $error, $tagBox)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_3a15ec258f8243574118f2f0835739fa = is_array($this->functionData['settingsForm']) ? count($this->functionData['settingsForm']) : 0;
$this->functionData['settingsForm'][$count_3a15ec258f8243574118f2f0835739fa]['blog'] = $blog;
$this->functionData['settingsForm'][$count_3a15ec258f8243574118f2f0835739fa]['error'] = $error;
}
$IPBHTML .= "<script type=\"text/javascript\">
	var manageMembersBox = {
		...
		addName: function (managerId, name, check)
		{
			// No name?
			if ( name == '' )
			{
								...
								<ul>
									...
									<li class='field' id='list_blog_view_level'>
										...
										<select class='input_select blogform' name='blog_view_level' id='blog_view_level'>
											".$this->__f__1e55320167c7ee3be8d7f9c2f3f8b2fb($blog,$error)."										</select>
									</li>
								</ul>
								</fieldset>
							</td>
					...
					<tr class=\"row1\">
						<td valign=\"top\">
							...
							<fieldset>
								...
								<ul>
								".$this->__f__cc616df8bf15fec6ddf53da681412ea2($blog,$error)."								</ul>
							</fieldset>
							") : ("
...
function __f__1e55320167c7ee3be8d7f9c2f3f8b2fb($blog, $error='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__cc616df8bf15fec6ddf53da681412ea2($blog, $error='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
