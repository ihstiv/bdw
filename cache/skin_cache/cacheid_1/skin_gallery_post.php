...
class skin_gallery_post_1 extends skinMaster{
...
{
$count_73018bc02559ae051ad2236075d2fdcc = is_array($this->functionData['attachiFrameUpload']) ? count($this->functionData['attachiFrameUpload']) : 0;
$this->functionData['attachiFrameUpload'][$count_73018bc02559ae051ad2236075d2fdcc]['id'] = $id;
$this->functionData['attachiFrameUpload'][$count_73018bc02559ae051ad2236075d2fdcc]['JSON'] = $JSON;
}
$IPBHTML .= "<html>
	<head>
		<style type=\"text/css\">
...
{
$count_8dd11434bd3de9202ba529a98091b6bd = is_array($this->functionData['editImageForm']) ? count($this->functionData['editImageForm']) : 0;
$this->functionData['editImageForm'][$count_8dd11434bd3de9202ba529a98091b6bd]['image'] = $image;
$this->functionData['editImageForm'][$count_8dd11434bd3de9202ba529a98091b6bd]['album'] = $album;
$this->functionData['editImageForm'][$count_8dd11434bd3de9202ba529a98091b6bd]['category'] = $category;
$this->functionData['editImageForm'][$count_8dd11434bd3de9202ba529a98091b6bd]['errors'] = $errors;
$this->functionData['editImageForm'][$count_8dd11434bd3de9202ba529a98091b6bd]['preview'] = $preview;
}
...
{
$count_db1a333e6530f014dcaca8f44d9fbb40 = is_array($this->functionData['review']) ? count($this->functionData['review']) : 0;
$this->functionData['review'][$count_db1a333e6530f014dcaca8f44d9fbb40]['images'] = $images;
$this->functionData['review'][$count_db1a333e6530f014dcaca8f44d9fbb40]['album'] = $album;
$this->functionData['review'][$count_db1a333e6530f014dcaca8f44d9fbb40]['category'] = $category;
$this->functionData['review'][$count_db1a333e6530f014dcaca8f44d9fbb40]['type'] = $type;
$this->functionData['review'][$count_db1a333e6530f014dcaca8f44d9fbb40]['opts'] = $opts;
}
...
<form method=\"post\" id='postingform' action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=gallery&amp;module=images&amp;section=review&amp;do=process", "public",'' ), "", "" ) . "\">
							...
							<li class='ipsField ipsField_select'>
								...
								<div class='ipsField_content'>
									<select name='album_category_id' id='album_category_id'>
										".$this->__f__f80fb055b3695875b4961700d02babf0($images,$album,$category,$type,$opts)."									</select>
								</div>
							<li>
							<li class='ipsField'>
							...
							<li class='ipsField ipsField_select'>
								...
								<div class='ipsField_content'>
									<select name=\"album_sort_options__key\"" . ((!$album['_catDefaults']['album_sort_edit']) ? (" disabled='disabled'") : ("")) . ">
										".$this->__f__53a182346fa4d2cf7082071248fda0b0($images,$album,$category,$type,$opts)."									</select>
									<select name=\"album_sort_options__dir\"" . ((!$album['_catDefaults']['album_sort_edit']) ? (" disabled='disabled'") : ("")) . ">
										".$this->__f__c7a451a298c2682c58607ba2ca8ccba6($images,$album,$category,$type,$opts)."									</select>
								</div>
							<li>
	...
	" . ((is_array($images) && count($images)) ? ("<br />
		<div class='ipsBox'>
			".$this->__f__222b7eb22dfc607dc02a681bbe9f486b($images,$album,$category,$type,$opts)."		</div>
...
function __f__f80fb055b3695875b4961700d02babf0($images, $album, $category, $type, $opts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__53a182346fa4d2cf7082071248fda0b0($images, $album, $category, $type, $opts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__c7a451a298c2682c58607ba2ca8ccba6($images, $album, $category, $type, $opts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__222b7eb22dfc607dc02a681bbe9f486b($images, $album, $category, $type, $opts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1ec95304c8930697099ef863ac419d3a = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_1ec95304c8930697099ef863ac419d3a]['sessionKey'] = $sessionKey;
$this->functionData['uploadForm'][$count_1ec95304c8930697099ef863ac419d3a]['album'] = $album;
$this->functionData['uploadForm'][$count_1ec95304c8930697099ef863ac419d3a]['category'] = $category;
$this->functionData['uploadForm'][$count_1ec95304c8930697099ef863ac419d3a]['categories'] = $categories;
$this->functionData['uploadForm'][$count_1ec95304c8930697099ef863ac419d3a]['stats'] = $stats;
$this->functionData['uploadForm'][$count_1ec95304c8930697099ef863ac419d3a]['allowed_file_types'] = $allowed_file_types;
}
...
<div id='categorySelectorContent' style='display:none'>
	...
	<div class='ipsPad_double'>
		<table class='ipb_table' style=\"table-layout: auto;\">
			".$this->__f__a2141c5c007d8ac595a8faaf55f30b86($sessionKey,$album,$category,$categories,$stats,$allowed_file_types)."		</table>
	</div>
</div>
<script type='text/javascript'>
//<![CDATA[
...
function __f__a2141c5c007d8ac595a8faaf55f30b86($sessionKey='', $album=array(), $category=array(), $categories=array(), $stats=array(), $allowed_file_types='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
