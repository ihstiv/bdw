...
class skin_blog_portal_1 extends skinMaster{
...
{
$count_e2b29ffb204ea86e918002904fdc0958 = is_array($this->functionData['blogFollowedWrapper']) ? count($this->functionData['blogFollowedWrapper']) : 0;
$this->functionData['blogFollowedWrapper'][$count_e2b29ffb204ea86e918002904fdc0958]['rows'] = $rows;
}
$IPBHTML .= "" . ((is_array($rows) && count($rows)) ? ("
	<table class='ipb_table topic_list' id='forum_table'>
		".$this->__f__9a8c996b478db5aa1e0511209a54347b($rows)."	</table>
") : ("")) . "";
return $IPBHTML;
}


function __f__9a8c996b478db5aa1e0511209a54347b($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_e0f142ce4ad91eba265592b70ed0ae7a = is_array($this->functionData['commentSearchResult']) ? count($this->functionData['commentSearchResult']) : 0;
$this->functionData['commentSearchResult'][$count_e0f142ce4ad91eba265592b70ed0ae7a]['r'] = $r;
$this->functionData['commentSearchResult'][$count_e0f142ce4ad91eba265592b70ed0ae7a]['resultAsTitle'] = $resultAsTitle;
}
...
{
$count_d1075dac708a6e832cf58534f0228d22 = is_array($this->functionData['entrySearchResult']) ? count($this->functionData['entrySearchResult']) : 0;
$this->functionData['entrySearchResult'][$count_d1075dac708a6e832cf58534f0228d22]['r'] = $r;
$this->functionData['entrySearchResult'][$count_d1075dac708a6e832cf58534f0228d22]['resultAsTitle'] = $resultAsTitle;
}
$IPBHTML .= "<tr class='_recordRow " . (($r['newpost']) ? (" unread") : ("")) . "" . (($r['entry_status'] != 'published') ? (" moderated") : ("")) . "'>
	...
	<td>
		" . (($this->settings['blog_enable_rating']) ? ("
			<div class='right'>
				".$this->__f__26979a7ddc1f8a28fdba070a2d0a89d3($r,$resultAsTitle)."			</div>
		") : ("")) . "
...
function __f__26979a7ddc1f8a28fdba070a2d0a89d3($r, $resultAsTitle=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_5c8b92f8f5f72283a7a43b069becb9ab = is_array($this->functionData['followedContentBlogs']) ? count($this->functionData['followedContentBlogs']) : 0;
$this->functionData['followedContentBlogs'][$count_5c8b92f8f5f72283a7a43b069becb9ab]['rows'] = $rows;
}
$IPBHTML .= "<table class='ipb_table topic_list' id='forum_table'>
	".$this->__f__18e75046e91aa4c4950088de35d6f8fb($rows)."</table>";
return $IPBHTML;
}


function __f__c87ae5e0847671e50402a27e46a22abc($rows,$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( array(1,2,3,4,5) as $_rating )
...
function __f__18e75046e91aa4c4950088de35d6f8fb($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $data )
	{
		...
		<tr class='_recordRow " . (($data['newpost']) ? ("unread") : ("")) . "'>
			...
			<td valign='top'>
				" . (($this->settings['blog_enable_rating']) ? ("
					<div class='right'>
						".$this->__f__c87ae5e0847671e50402a27e46a22abc($rows,$data)."					</div>
				") : ("")) . "
				" . (($data['_hasDrafts']) ? ("
...
{
$count_bf7fa7e93f5b581bfd9a861b22ea34da = is_array($this->functionData['moderatorPanel']) ? count($this->functionData['moderatorPanel']) : 0;
$this->functionData['moderatorPanel'][$count_bf7fa7e93f5b581bfd9a861b22ea34da]['results'] = $results;
$this->functionData['moderatorPanel'][$count_bf7fa7e93f5b581bfd9a861b22ea34da]['pages'] = $pages;
}
$IPBHTML .= "" . (($pages) ? ("
	<div>{$pages}</div>
") : ("")) . "
<div class='category_block block_wrap'>
	...
	<div class=\"ipsBox_container\">
		<table id=\"forum_table\" class=\"ipb_table topic_list\">
			" . ((count($results)) ? ("
				".$this->__f__38d6dbc26eda82537e46d0511ec14492($results,$pages)."			") : ("
				<tr>
...
function __f__38d6dbc26eda82537e46d0511ec14492($results, $pages='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
<div class='ipsBox'>
	<div class='ipsBox_container'>
		".$this->__f__109fbb10e29276b39585b64cee30d351($entries)."	</div>
</div>";
return $IPBHTML;
}


function __f__109fbb10e29276b39585b64cee30d351($entries)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_763828a45c3c3ca00c4889826a08e75b = is_array($this->functionData['recentEntries']) ? count($this->functionData['recentEntries']) : 0;
$this->functionData['recentEntries'][$count_763828a45c3c3ca00c4889826a08e75b]['entries'] = $entries;
}
$IPBHTML .= "<div class='ipsSideBlock clearfix'>
	...
	<ul class='ipsList_withminiphoto'>
		" . ((is_array( $entries ) && count( $entries )) ? ("
			".$this->__f__c732a6f0ff5a1bdefbb0f10db298436e($entries)."		") : ("
...
function __f__c732a6f0ff5a1bdefbb0f10db298436e($entries=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_2a1b4110fd0142cd9e34e3699e1a9ed2 = is_array($this->functionData['tabReputation_entries']) ? count($this->functionData['tabReputation_entries']) : 0;
$this->functionData['tabReputation_entries'][$count_2a1b4110fd0142cd9e34e3699e1a9ed2]['entries'] = $entries;
}
$IPBHTML .= "<div class='ipsBox'>
	".$this->__f__b40102818261a6cd4b3a0b2303420db9($entries)."</div>";
return $IPBHTML;
}


function __f__b40102818261a6cd4b3a0b2303420db9($entries)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $entries as $entry )
...
{
$count_3dc2d913a0aa29e824afd5c1a02a9564 = is_array($this->functionData['unapprovedComments']) ? count($this->functionData['unapprovedComments']) : 0;
$this->functionData['unapprovedComments'][$count_3dc2d913a0aa29e824afd5c1a02a9564]['comments'] = $comments;
$this->functionData['unapprovedComments'][$count_3dc2d913a0aa29e824afd5c1a02a9564]['pages'] = $pages;
}
$IPBHTML .= "" . (($pages) ? ("
	<div>{$pages}</div>
") : ("")) . "
...
<div class='clearfix'>
	" . ((is_array( $comments ) AND count( $comments )) ? ("
		<div id='ips_Posts2'>
			".$this->__f__02c9c21e47519033551dd1f5d0b90274($comments,$pages)."		</div>
	") : ("
...
function __f__02c9c21e47519033551dd1f5d0b90274($comments, $pages='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
