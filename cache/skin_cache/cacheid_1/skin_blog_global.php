...
class skin_blog_global_1 extends skinMaster{
...
{
$count_31f58358a88151c4543d0d49376617bc = is_array($this->functionData['blog_header']) ? count($this->functionData['blog_header']) : 0;
$this->functionData['blog_header'][$count_31f58358a88151c4543d0d49376617bc]['blog'] = $blog;
$this->functionData['blog_header'][$count_31f58358a88151c4543d0d49376617bc]['cblock_control'] = $cblock_control;
$this->functionData['blog_header'][$count_31f58358a88151c4543d0d49376617bc]['theme_js'] = $theme_js;
$this->functionData['blog_header'][$count_31f58358a88151c4543d0d49376617bc]['header_js'] = $header_js;
$this->functionData['blog_header'][$count_31f58358a88151c4543d0d49376617bc]['title'] = $title;
$this->functionData['blog_header'][$count_31f58358a88151c4543d0d49376617bc]['headerButtons'] = $headerButtons;
}
...
{
$count_b093c5c943607e629177280d1cac6b8a = is_array($this->functionData['catsAsList']) ? count($this->functionData['catsAsList']) : 0;
$this->functionData['catsAsList'][$count_b093c5c943607e629177280d1cac6b8a]['blogId'] = $blogId;
$this->functionData['catsAsList'][$count_b093c5c943607e629177280d1cac6b8a]['categories'] = $categories;
}
...
$IPBHTML .= "" . ((is_array( $categories ) && count( $categories ) && !(count($categories) == 1 && array_key_exists(0, $categories))) ? ("
	...
	".$this->__f__fdf335086e5e27351efef07f569b24d5($blogId,$categories)."") : ("")) . "";
return $IPBHTML;
}


function __f__fdf335086e5e27351efef07f569b24d5($blogId, $categories)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
$IPBHTML .= "<ul class=\"ipbmenu_content\" id='content_blocks_menucontent' style='display: none'>
	...
	") : ("")) . "" . ((is_array( $cblocks ) && count( $cblocks )) ? ("".$this->__f__7cfd6464be0eed1063e4ba5a927352d1($cblocks)."	") : ("")) . "
</ul>
<script type='text/javascript'>
...
function __f__7cfd6464be0eed1063e4ba5a927352d1($cblocks)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_7616c7b45f93f8519f86a8c1bfd185de = is_array($this->functionData['contextSearch']) ? count($this->functionData['contextSearch']) : 0;
}
...
{
$count_5819002dc2c8ad1dc13d0bf5f31508bf = is_array($this->functionData['hookTagCloud']) ? count($this->functionData['hookTagCloud']) : 0;
$this->functionData['hookTagCloud'][$count_5819002dc2c8ad1dc13d0bf5f31508bf]['tags'] = $tags;
}
$IPBHTML .= "<ul class='ipsList_inline'>".$this->__f__10512cd6bb207a59cc1298f0e61073de($tags)."</ul>";
return $IPBHTML;
}


function __f__10512cd6bb207a59cc1298f0e61073de($tags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_07314b715c3e6a0a81ef4de167b35656 = is_array($this->functionData['overwriteHeader']) ? count($this->functionData['overwriteHeader']) : 0;
}
...
{
$count_13d761c86e88897a75333a0db1c99a79 = is_array($this->functionData['short_img_tag']) ? count($this->functionData['short_img_tag']) : 0;
$this->functionData['short_img_tag'][$count_13d761c86e88897a75333a0db1c99a79]['matches'] = $matches;
}
...
{
$count_edcba796bbbb53959ccdcb787d9e9a77 = is_array($this->functionData['short_media_tag']) ? count($this->functionData['short_media_tag']) : 0;
$this->functionData['short_media_tag'][$count_edcba796bbbb53959ccdcb787d9e9a77]['url'] = $url;
$this->functionData['short_media_tag'][$count_edcba796bbbb53959ccdcb787d9e9a77]['type'] = $type;
}
...
{
$count_3137d063f774e34b03b607d100522934 = is_array($this->functionData['theme_menu']) ? count($this->functionData['theme_menu']) : 0;
$this->functionData['theme_menu'][$count_3137d063f774e34b03b607d100522934]['themes'] = $themes;
$this->functionData['theme_menu'][$count_3137d063f774e34b03b607d100522934]['blog'] = $blog;
$this->functionData['theme_menu'][$count_3137d063f774e34b03b607d100522934]['_customTheme'] = $_customTheme;
}
$IPBHTML .= "<ul class='ipbmenu_content' id='themes_menu_menucontent' style='display: none'>
	" . (($this->settings['blog_themes_custom'] OR (is_array($themes) AND count($themes))) ? ("" . (($this->settings['blog_themes_custom']) ? ("
		...
		") : ("")) . "" . ((is_array( $themes ) && count( $themes )) ? ("".$this->__f__a7424250cf45e6cafd346fe92c78a887($themes,$blog,$_customTheme)."		") : ("")) . "
...
function __f__a7424250cf45e6cafd346fe92c78a887($themes, $blog, $_customTheme='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
