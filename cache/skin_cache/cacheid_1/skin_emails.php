...
{
$count_dd55def4d55c60b3291e189a4c4b00bf = is_array($this->functionData['forward_form']) ? count($this->functionData['forward_form']) : 0;
$this->functionData['forward_form'][$count_dd55def4d55c60b3291e189a4c4b00bf]['title'] = $title;
$this->functionData['forward_form'][$count_dd55def4d55c60b3291e189a4c4b00bf]['text'] = $text;
$this->functionData['forward_form'][$count_dd55def4d55c60b3291e189a4c4b00bf]['lang'] = $lang;
$this->functionData['forward_form'][$count_dd55def4d55c60b3291e189a4c4b00bf]['captchaHTML'] = $captchaHTML;
$this->functionData['forward_form'][$count_dd55def4d55c60b3291e189a4c4b00bf]['msg'] = $msg;
}
					...
					<li class='ipsField clear'>
						...
						<p class='ipsField_content'>
							<select name='lang' class='input_select' id='to_lang'>
								".$this->__f__ae67a98da2bf87f510cae6ed0135ead9($title,$text,$lang,$captchaHTML,$msg)."							</select>
						</p>
					</li>
				")) . "
				<li class='ipsField clear'>
...
function __f__ae67a98da2bf87f510cae6ed0135ead9($title="",$text="",$lang="", $captchaHTML='', $msg='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
