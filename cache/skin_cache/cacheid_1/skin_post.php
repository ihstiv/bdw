...
{
$count_6e213c4204e9f2d0c04b26b36aa28802 = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_6e213c4204e9f2d0c04b26b36aa28802]['data'] = $data;
}
...
{
$count_cd5387295cbcd7f2d4078cdfa2bab065 = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_cd5387295cbcd7f2d4078cdfa2bab065]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_cd5387295cbcd7f2d4078cdfa2bab065]['form'] = $form;
}
...
{
$count_ca5aa1c2a71751f18eebf6f7f0458009 = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_ca5aa1c2a71751f18eebf6f7f0458009]['data'] = $data;
}
...
{
$count_edc8fd1ce0dfba7de2e9c9f46af19654 = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_edc8fd1ce0dfba7de2e9c9f46af19654]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__563e8485c9494166552cbcd95a58a6fe($posts)."") : ("")) . "
<p class='submit'>
...
function __f__563e8485c9494166552cbcd95a58a6fe($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_c73e33ddd140743e6f47883b5390c4fc = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_c73e33ddd140743e6f47883b5390c4fc]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_c73e33ddd140743e6f47883b5390c4fc]['type'] = $type;
$this->functionData['uploadForm'][$count_c73e33ddd140743e6f47883b5390c4fc]['stats'] = $stats;
$this->functionData['uploadForm'][$count_c73e33ddd140743e6f47883b5390c4fc]['id'] = $id;
$this->functionData['uploadForm'][$count_c73e33ddd140743e6f47883b5390c4fc]['forum_id'] = $forum_id;
}
