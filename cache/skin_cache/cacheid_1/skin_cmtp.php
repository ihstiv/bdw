...
class skin_cmtp_1 extends skinMaster{
...
{
$count_cdfa3019c9a6496ed115a9300073fd24 = is_array($this->functionData['group_strip_fix']) ? count($this->functionData['group_strip_fix']) : 0;
$this->functionData['group_strip_fix'][$count_cdfa3019c9a6496ed115a9300073fd24]['group'] = $group;
$this->functionData['group_strip_fix'][$count_cdfa3019c9a6496ed115a9300073fd24]['members'] = $members;
$this->functionData['group_strip_fix'][$count_cdfa3019c9a6496ed115a9300073fd24]['pagination'] = $pagination;
}
...
<table class='ipb_table ipsMemberList'>
	...
	" . ((count($members) AND is_array($members)) ? ("
				".$this->__f__dddbc4cddab1b0fc7d06d95289990f23($group,$members,$pagination)."	") : ("")) . "
</table>
" . (($pagination) ? ("
	<div class='topic_controls'>{$pagination}</div>
") : ("")) . "
...
function __f__35916c211999e285e8dc31e40117151b($group='', $members=array(), $pagination='',$info='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a375c12f95486b8bddbb9d02504cef4b($group='', $members=array(), $pagination='',$info='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $info['forums'] as $id => $name )
...
function __f__dddbc4cddab1b0fc7d06d95289990f23($group='', $members=array(), $pagination='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
			...
			<tr class='" .  IPSLib::next( $this->registry->templateStriping["staff"] ) . "'>
				...
				<td class='altrow short'>
					" . ((is_array($info['forums'])) ? ("" . ((count( $info['forums'] ) == 1) ? ("
							".$this->__f__35916c211999e285e8dc31e40117151b($group,$members,$pagination,$info)."						") : ("
							...
							".$this->__f__a375c12f95486b8bddbb9d02504cef4b($group,$members,$pagination,$info)."							</ul>
