...
{
$count_88313564d195a07ca0dedb4a95d94c28 = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_88313564d195a07ca0dedb4a95d94c28]['r'] = $r;
$this->functionData['comment'][$count_88313564d195a07ca0dedb4a95d94c28]['parent'] = $parent;
$this->functionData['comment'][$count_88313564d195a07ca0dedb4a95d94c28]['settings'] = $settings;
}
...
{
$count_5440cf6b37bc459885bcd44b72d38bf7 = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_5440cf6b37bc459885bcd44b72d38bf7]['r'] = $r;
$this->functionData['commentHidden'][$count_5440cf6b37bc459885bcd44b72d38bf7]['parent'] = $parent;
$this->functionData['commentHidden'][$count_5440cf6b37bc459885bcd44b72d38bf7]['settings'] = $settings;
}
...
{
$count_2f0abefdda38a64aaf3be0d8591e45bd = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_2f0abefdda38a64aaf3be0d8591e45bd]['comments'] = $comments;
$this->functionData['commentsList'][$count_2f0abefdda38a64aaf3be0d8591e45bd]['settings'] = $settings;
$this->functionData['commentsList'][$count_2f0abefdda38a64aaf3be0d8591e45bd]['pages'] = $pages;
$this->functionData['commentsList'][$count_2f0abefdda38a64aaf3be0d8591e45bd]['parent'] = $parent;
$this->functionData['commentsList'][$count_2f0abefdda38a64aaf3be0d8591e45bd]['preReply'] = $preReply;
}
...
<div class='ipsComment_wrap' id='comment_wrap'>
	".$this->__f__f92fa6c4c52b48b58917ff59ed4f88de($comments,$settings,$pages,$parent,$preReply)."</div>
" . (($pages) ? ("
	<div class='topic_controls'>
		{$pages}
	</div>
...
function __f__f92fa6c4c52b48b58917ff59ed4f88de($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_8e359f7a05b4febcf950e453d32f1c15 = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_8e359f7a05b4febcf950e453d32f1c15]['comment'] = $comment;
$this->functionData['form'][$count_8e359f7a05b4febcf950e453d32f1c15]['parent'] = $parent;
$this->functionData['form'][$count_8e359f7a05b4febcf950e453d32f1c15]['editor'] = $editor;
$this->functionData['form'][$count_8e359f7a05b4febcf950e453d32f1c15]['settings'] = $settings;
$this->functionData['form'][$count_8e359f7a05b4febcf950e453d32f1c15]['errors'] = $errors;
$this->functionData['form'][$count_8e359f7a05b4febcf950e453d32f1c15]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
