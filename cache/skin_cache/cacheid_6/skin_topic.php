...
class skin_topic_6 extends skinMaster{
...
{
$count_0674e2ece8c81893c3ade2eb176b8c82 = is_array($this->functionData['ajaxSharePost']) ? count($this->functionData['ajaxSharePost']) : 0;
$this->functionData['ajaxSharePost'][$count_0674e2ece8c81893c3ade2eb176b8c82]['topic'] = $topic;
$this->functionData['ajaxSharePost'][$count_0674e2ece8c81893c3ade2eb176b8c82]['post'] = $post;
$this->functionData['ajaxSharePost'][$count_0674e2ece8c81893c3ade2eb176b8c82]['url'] = $url;
$this->functionData['ajaxSharePost'][$count_0674e2ece8c81893c3ade2eb176b8c82]['sharelinks'] = $sharelinks;
}
...
{
$count_7b264fa668a0ac3ff06ebf0084744019 = is_array($this->functionData['announcement_show']) ? count($this->functionData['announcement_show']) : 0;
$this->functionData['announcement_show'][$count_7b264fa668a0ac3ff06ebf0084744019]['announce'] = $announce;
$this->functionData['announcement_show'][$count_7b264fa668a0ac3ff06ebf0084744019]['author'] = $author;
}
...
{
$count_59ba21b0a92b1536124751f0d1b1cc60 = is_array($this->functionData['archiveStatusMessage']) ? count($this->functionData['archiveStatusMessage']) : 0;
$this->functionData['archiveStatusMessage'][$count_59ba21b0a92b1536124751f0d1b1cc60]['topic'] = $topic;
$this->functionData['archiveStatusMessage'][$count_59ba21b0a92b1536124751f0d1b1cc60]['forum'] = $forum;
}
...
" . (($this->registry->class_forums->fetchArchiveTopicType($topic) == 'working') ? ("
	<div class='message unspecific'>
		{$this->lang->words['top_archive_topic_working']}
	</div>
") : ("")) . "
" . (($this->registry->class_forums->fetchArchiveTopicType( $topic ) == 'archived') ? ("<div class='message unspecific'>
...
{
$count_64161b5151cd6f9a370cf3e731ad80b5 = is_array($this->functionData['hookFacebookLike']) ? count($this->functionData['hookFacebookLike']) : 0;
}
...
{
$count_3f7f0798812b9d10763e78dbd578931a = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_3f7f0798812b9d10763e78dbd578931a]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_3f7f0798812b9d10763e78dbd578931a]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_3f7f0798812b9d10763e78dbd578931a]['opts'] = $opts;
}
...
{
$count_04f51377ab340563abab435b666a2c7b = is_array($this->functionData['pollDisplay']) ? count($this->functionData['pollDisplay']) : 0;
$this->functionData['pollDisplay'][$count_04f51377ab340563abab435b666a2c7b]['poll'] = $poll;
$this->functionData['pollDisplay'][$count_04f51377ab340563abab435b666a2c7b]['topicData'] = $topicData;
$this->functionData['pollDisplay'][$count_04f51377ab340563abab435b666a2c7b]['forumData'] = $forumData;
$this->functionData['pollDisplay'][$count_04f51377ab340563abab435b666a2c7b]['pollData'] = $pollData;
$this->functionData['pollDisplay'][$count_04f51377ab340563abab435b666a2c7b]['showResults'] = $showResults;
$this->functionData['pollDisplay'][$count_04f51377ab340563abab435b666a2c7b]['editPoll'] = $editPoll;
}
...
<div class='general_box alt poll' id='poll_{$poll['pid']}'>
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=extras&amp;section=vote&amp;t={$topicData['tid']}&amp;page={$this->request['page']}&amp;do=add&amp;secure_key={$this->member->form_hash}", "public",'' ), "", "" ) . "\" name='pollForm' method=\"post\">
		...
		") : ("")) . "
		".$this->__f__ceb196238ca9e78064ed96647707f1b2($poll,$topicData,$forumData,$pollData,$showResults,$editPoll)."		<fieldset class='submit'>
...
function __f__15a01ee3061413547ad929e2cb79142d($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='',$choiceID='',$choiceData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__da0d2a205f91001ed1a50f82858b9bee($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
							...
							" . (($showResults) ? ("<li>
									...
									" . (($poll['poll_view_voters'] AND is_array( $choiceData['voters'] ) AND $this->settings['poll_allow_public'] AND $choiceData['votes']) ? ("
										<script type='text/javascript'>
											...
											".$this->__f__15a01ee3061413547ad929e2cb79142d($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData,$choiceID,$choiceData)."											ipb.topic.poll[ $questionID ][ $choiceID ] = { name: \"{$choiceData['choice']}\", users: users};
										</script>
									") : ("")) . "
...
function __f__ceb196238ca9e78064ed96647707f1b2($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $pollData as $questionID => $questionData )
	{
		...
		$_ips___x_retval .= "
			<div class='poll_question" . (($showResults) ? (" voted") : ("")) . "'>
				...
				") : ("
					<ol>
						".$this->__f__da0d2a205f91001ed1a50f82858b9bee($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData)."					</ol>
				")) . "
			</div>
...
{
$count_ea4441db70342e069e45f544dbcdc220 = is_array($this->functionData['post']) ? count($this->functionData['post']) : 0;
$this->functionData['post'][$count_ea4441db70342e069e45f544dbcdc220]['post'] = $post;
$this->functionData['post'][$count_ea4441db70342e069e45f544dbcdc220]['displayData'] = $displayData;
$this->functionData['post'][$count_ea4441db70342e069e45f544dbcdc220]['topic'] = $topic;
$this->functionData['post'][$count_ea4441db70342e069e45f544dbcdc220]['forum'] = $forum;
}
...
" . ((! $post['post']['_isDeleted']) ? ("<div class='post_block hentry clear clearfix " . (($post['post']['_isMarkedAnswered']) ? ("solved") : ("")) . " " . (($post['post']['_isHidden']) ? ("moderated") : ("")) . "' id='post_id_{$post['post']['pid']}'>
		...
		<div class='post_wrap' " . (($post['post']['_ignored'] == 1 || $post['post']['_repignored'] == 1) ? ("style='display: none'") : ("")) . ">
			...
			")) . "
				...
				" . (($post['author']['member_id']) ? ("
					<span itemprop=\"creator name\" class=\"author vcard entry-title\">" . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'userHoverCard' ) ? $this->registry->getClass('output')->getTemplate('global')->userHoverCard($post['author']) : '' ) . "</span>
				") : ("
			...
			<div class='post_body'>
				<p class='posted_info desc lighter ipsType_small'>
					{$this->lang->words['posted']} <abbr class=\"published date updated\" itemprop=\"commentTime\" title=\"" . date( 'c', $post['post']['post_date'] ) . "\">" . IPSText::htmlspecialchars($this->registry->getClass('class_localization')->getDate($post['post']['post_date'],"long", 0)) . "</abbr>
				...
				<ul id='postControlsNormal_{$post['post']['pid']}' class='post_controls clear clearfix' " . (($this->memberData['is_mod'] && ! $topic['_isArchived'] && $post['post']['queued']) ? ("style='display:none'") : ("")) . ">
					...
					") : ("")) . "
					<!--hook.if.skin_topic.post.canReportPost.pre.startif-->" . (($topic['_canReport'] and ! $topic['_isArchived']) ? ("<li class='report'>
						...
						") : ("")) . "") : ("")) . "<!--hook.if.skin_topic.post.canReportPost.post.endif-->
				</ul>
...
{
$count_f048496de22e33a54fc932aac4d40755 = is_array($this->functionData['quickEditPost']) ? count($this->functionData['quickEditPost']) : 0;
$this->functionData['quickEditPost'][$count_f048496de22e33a54fc932aac4d40755]['post'] = $post;
}
$IPBHTML .= "{$post['post']}
    {$post['attachmentHtml']}
	<br />
...
{
$count_f2dab36a80baa587fad490dc2e1e7605 = is_array($this->functionData['show_attachment_title']) ? count($this->functionData['show_attachment_title']) : 0;
$this->functionData['show_attachment_title'][$count_f2dab36a80baa587fad490dc2e1e7605]['title'] = $title;
$this->functionData['show_attachment_title'][$count_f2dab36a80baa587fad490dc2e1e7605]['data'] = $data;
$this->functionData['show_attachment_title'][$count_f2dab36a80baa587fad490dc2e1e7605]['type'] = $type;
}
$IPBHTML .= "<div id='attach_wrap' class='clearfix'>
	<h4>{$title}</h4>
	<ul>
		".$this->__f__47e0ba275ad39832541ba8f559be351f($title,$data,$type)."	</ul>
</div>";
return $IPBHTML;
}


function __f__47e0ba275ad39832541ba8f559be351f($title="",$data="",$type="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_6032beb5a9c6b7bda78cd167c7508af4 = is_array($this->functionData['Show_attachments']) ? count($this->functionData['Show_attachments']) : 0;
$this->functionData['Show_attachments'][$count_6032beb5a9c6b7bda78cd167c7508af4]['data'] = $data;
}
...
{
$count_6eb6b3f385f347f9ca75a7e18b734008 = is_array($this->functionData['softDeletedPostBit']) ? count($this->functionData['softDeletedPostBit']) : 0;
$this->functionData['softDeletedPostBit'][$count_6eb6b3f385f347f9ca75a7e18b734008]['post'] = $post;
$this->functionData['softDeletedPostBit'][$count_6eb6b3f385f347f9ca75a7e18b734008]['sdData'] = $sdData;
$this->functionData['softDeletedPostBit'][$count_6eb6b3f385f347f9ca75a7e18b734008]['topic'] = $topic;
}
...
$IPBHTML .= "<div class='post_block hentry clear moderated' id='post_id_{$post['post']['pid']}'>
	...
	<div class='post_wrap'>
			...
			" . (($post['post']['moddable']) ? ("<span class='post_id right'>
				...
				" . (($post['post']['_show_ip']) ? ("<span class='ip right ipsType_small'>({$this->lang->words['ip']}:
					" . (($post['author']['g_access_cp']) ? ("
						<em>{$this->lang->words['ip_private']}</em>
					") : ("
						<a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=modcp&amp;fromapp=members&amp;tab=iplookup&amp;ip={$post['post']['ip_address']}", "public",'' ), "", "" ) . "\" title='{$this->lang->words['info_about_this_ip']}'>{$post['post']['ip_address']}</a>
					")) . "
					)</span>") : ("")) . "
			</h3>
		<div class='post_body' id='postsDelete_{$post['post']['pid']}' style='margin-left: 0;'>
			<div class='post entry-content' style='padding:10px'>
				{$this->lang->words['post_deleted_by']} " . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'userHoverCard' ) ? $this->registry->getClass('output')->getTemplate('global')->userHoverCard($_sD) : '' ) . " " . IPSText::htmlspecialchars($this->registry->getClass('class_localization')->getDate($_sD['sdl_obj_date'],"long", 0)) . ".
		...
		" . (($post['post']['_softDeleteContent']) ? ("<div id='postsDeleteShow_{$post['post']['pid']}' style='display:none'>
			...
			<div class='post_body'>
				<p class='posted_info'>
					{$this->lang->words['posted']} <abbr class=\"published\" title=\"" . @date( 'c', $post['post']['post_date'] ) . "\">" . IPSText::htmlspecialchars($this->registry->getClass('class_localization')->getDate($post['post']['post_date'],"long", 0)) . "</abbr>
				</p>
				<div class='post entry-content'>
					{$post['post']['post']}
					{$post['post']['attachmentHtml']}
...
$IPBHTML = "";
$IPBHTML .= "".$this->__f__f950294b4ad4814388ff9c58b9d02a3c($topic,$posts)."<br class='clear' />
...
function __f__f950294b4ad4814388ff9c58b9d02a3c($topic, $posts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_aec816af7025ad82dd2588ef144b9ebf = is_array($this->functionData['topicViewTemplate']) ? count($this->functionData['topicViewTemplate']) : 0;
$this->functionData['topicViewTemplate'][$count_aec816af7025ad82dd2588ef144b9ebf]['forum'] = $forum;
$this->functionData['topicViewTemplate'][$count_aec816af7025ad82dd2588ef144b9ebf]['topic'] = $topic;
$this->functionData['topicViewTemplate'][$count_aec816af7025ad82dd2588ef144b9ebf]['post_data'] = $post_data;
$this->functionData['topicViewTemplate'][$count_aec816af7025ad82dd2588ef144b9ebf]['displayData'] = $displayData;
}
...
<div class='topic_controls'>
	...
	" . ((!$topic['_isArchived']) ? ("<ul class='topic_buttons'>
			" . (($displayData['reply_button']['image'] == 'locked') ? ("<li class='important'>
					" . ((isset($displayData['poll_data']['poll']['poll_only']) && $displayData['poll_data']['poll']['poll_only']) ? ("" . (($displayData['reply_button']['url']) ? ("
						...
						")) . "")) . "
				</li>") : ("<!--hook.if.skin_topic.topicViewTemplate.replyButton.pre.startif-->" . (($displayData['reply_button']['image']) ? ("" . (($displayData['reply_button']['url']) ? ("
...
" . (($displayData['mod_links'] AND ( $this->memberData['is_mod'] OR $this->memberData['member_id'] == $topic['starter_id'] )) ? ("<ul class='ipbmenu_content' id='topic_mod_options_menucontent'  style='display:none'>
	".$this->__f__d19baa114b87b5226ec4c043c4c30fdd($forum,$topic,$post_data,$displayData)."	" . (($topic['topic_queuedposts'] AND $this->registry->class_forums->canQueuePosts( $forum['id'] )) ? ("
	...
	" . ((is_array( $displayData['multi_mod'] ) AND count( $displayData['multi_mod'] )) ? ("
		".$this->__f__97c0a6825ab9aab7c0fb141d3f467a16($forum,$topic,$post_data,$displayData)."	") : ("")) . "
</ul>
<script type='text/javascript'>
...
" . (($this->settings['reputation_enabled'] && $this->settings['reputation_point_types'] != 'like' && $this->settings['reputation_show_content'] && $this->memberData['member_id'] != 0 && is_array($this->caches['reputation_levels'])) ? ("<ul id='rep_filter_menucontent' class='ipbmenu_content with_checks' style='display: none'>
		...
		" . ((is_array($this->caches['reputation_levels'])) ? ("
			".$this->__f__41cf253dc02654a8c2db3ceb88d983b7($forum,$topic,$post_data,$displayData)."		") : ("")) . "
	</ul>
	<script type='text/javascript'>
...
<!--hook.if.skin_topic.topicViewTemplate.hasPosts.pre.startif-->" . ((is_array( $post_data ) AND count( $post_data )) ? ("
	<div class='ipsBox'>
		<div class='ipsBox_container' id='ips_Posts'>
			".$this->__f__22daff5a0ec716ddea20fda81070d5b0($forum,$topic,$post_data,$displayData)."		</div>
	</div>
") : ("")) . "
<hr />
...
" . ((is_array( $displayData['same_tagged'] ) and count( $displayData['same_tagged'] )) ? ("
	...
	<div class='ipsBox'>
		...
		<div class='ipsBox_container'>
			...
			".$this->__f__cfc28e9c980d334c3a0ad4ab570e822b($forum,$topic,$post_data,$displayData)."			</table>
		</div>
	</div>
") : ("")) . "
<!-- ACTIVE USERS -->
<!--hook.if.skin_topic.topicViewTemplate.topicActiveUsers.pre.startif-->" . ((is_array( $displayData['active_users'] ) AND count( $displayData['active_users'] )) ? ("<div id='topic_stats' class='statistics clear clearfix'>
...
function __f__d19baa114b87b5226ec4c043c4c30fdd($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__97c0a6825ab9aab7c0fb141d3f467a16($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__41cf253dc02654a8c2db3ceb88d983b7($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__22daff5a0ec716ddea20fda81070d5b0($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__cfc28e9c980d334c3a0ad4ab570e822b($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
