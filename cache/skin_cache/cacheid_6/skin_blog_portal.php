...
class skin_blog_portal_6 extends skinMaster{
...
{
$count_de883c6d9386533e8d3d4f8ac705085f = is_array($this->functionData['blogFollowedWrapper']) ? count($this->functionData['blogFollowedWrapper']) : 0;
$this->functionData['blogFollowedWrapper'][$count_de883c6d9386533e8d3d4f8ac705085f]['rows'] = $rows;
}
$IPBHTML .= "" . ((is_array($rows) && count($rows)) ? ("
	<table class='ipb_table topic_list' id='forum_table'>
		".$this->__f__6ce5b7e679f5238a4217fc0c8d7ce355($rows)."	</table>
") : ("")) . "";
return $IPBHTML;
}


function __f__6ce5b7e679f5238a4217fc0c8d7ce355($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_36102aba9b85ee0129b1660aa2f1ed44 = is_array($this->functionData['commentSearchResult']) ? count($this->functionData['commentSearchResult']) : 0;
$this->functionData['commentSearchResult'][$count_36102aba9b85ee0129b1660aa2f1ed44]['r'] = $r;
$this->functionData['commentSearchResult'][$count_36102aba9b85ee0129b1660aa2f1ed44]['resultAsTitle'] = $resultAsTitle;
}
...
{
$count_ea7c8f18b55cd9af319afb74a9175506 = is_array($this->functionData['entrySearchResult']) ? count($this->functionData['entrySearchResult']) : 0;
$this->functionData['entrySearchResult'][$count_ea7c8f18b55cd9af319afb74a9175506]['r'] = $r;
$this->functionData['entrySearchResult'][$count_ea7c8f18b55cd9af319afb74a9175506]['resultAsTitle'] = $resultAsTitle;
}
$IPBHTML .= "<tr class='_recordRow " . (($r['newpost']) ? (" unread") : ("")) . "" . (($r['entry_status'] != 'published') ? (" moderated") : ("")) . "'>
	...
	<td>
		" . (($this->settings['blog_enable_rating']) ? ("
			<div class='right'>
				".$this->__f__eb67275c3ed0b24cac74284c9c90e4c4($r,$resultAsTitle)."			</div>
		") : ("")) . "
...
function __f__eb67275c3ed0b24cac74284c9c90e4c4($r, $resultAsTitle=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_2d4dacebb94d3b5faa4389a612f90dc7 = is_array($this->functionData['followedContentBlogs']) ? count($this->functionData['followedContentBlogs']) : 0;
$this->functionData['followedContentBlogs'][$count_2d4dacebb94d3b5faa4389a612f90dc7]['rows'] = $rows;
}
$IPBHTML .= "<table class='ipb_table topic_list' id='forum_table'>
	".$this->__f__b93e22a45897030efdcc3a60a97614c6($rows)."</table>";
return $IPBHTML;
}


function __f__758fcd3ebd2cea0e69b88d5622217904($rows,$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( array(1,2,3,4,5) as $_rating )
...
function __f__b93e22a45897030efdcc3a60a97614c6($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $data )
	{
		...
		<tr class='_recordRow " . (($data['newpost']) ? ("unread") : ("")) . "'>
			...
			<td valign='top'>
				" . (($this->settings['blog_enable_rating']) ? ("
					<div class='right'>
						".$this->__f__758fcd3ebd2cea0e69b88d5622217904($rows,$data)."					</div>
				") : ("")) . "
				" . (($data['_hasDrafts']) ? ("
...
{
$count_3d5a4ea7b242928760e332c4b6bc5fd9 = is_array($this->functionData['moderatorPanel']) ? count($this->functionData['moderatorPanel']) : 0;
$this->functionData['moderatorPanel'][$count_3d5a4ea7b242928760e332c4b6bc5fd9]['results'] = $results;
$this->functionData['moderatorPanel'][$count_3d5a4ea7b242928760e332c4b6bc5fd9]['pages'] = $pages;
}
$IPBHTML .= "" . (($pages) ? ("
	<div>{$pages}</div>
") : ("")) . "
<div class='category_block block_wrap'>
	...
	<div class=\"ipsBox_container\">
		<table id=\"forum_table\" class=\"ipb_table topic_list\">
			" . ((count($results)) ? ("
				".$this->__f__d12b7dc9ab8f3b3c2cecaac1b09a4e03($results,$pages)."			") : ("
				<tr>
...
function __f__d12b7dc9ab8f3b3c2cecaac1b09a4e03($results, $pages='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
<div class='ipsBox'>
	<div class='ipsBox_container'>
		".$this->__f__1b489f2f30036ec524310ff1a7214432($entries)."	</div>
</div>";
return $IPBHTML;
}


function __f__1b489f2f30036ec524310ff1a7214432($entries)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ffeccfd3d06a2a47f5c21d0f848ef8d2 = is_array($this->functionData['recentEntries']) ? count($this->functionData['recentEntries']) : 0;
$this->functionData['recentEntries'][$count_ffeccfd3d06a2a47f5c21d0f848ef8d2]['entries'] = $entries;
}
$IPBHTML .= "<div class='ipsSideBlock clearfix'>
	...
	<ul class='ipsList_withminiphoto'>
		" . ((is_array( $entries ) && count( $entries )) ? ("
			".$this->__f__4ab0918246ed2358a112749971aef094($entries)."		") : ("
...
function __f__4ab0918246ed2358a112749971aef094($entries=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_f76be15592812a8bf366ece5135f3eaa = is_array($this->functionData['tabReputation_entries']) ? count($this->functionData['tabReputation_entries']) : 0;
$this->functionData['tabReputation_entries'][$count_f76be15592812a8bf366ece5135f3eaa]['entries'] = $entries;
}
$IPBHTML .= "<div class='ipsBox'>
	".$this->__f__9de8d6679e1feaf35708018fdbc45c41($entries)."</div>";
return $IPBHTML;
}


function __f__9de8d6679e1feaf35708018fdbc45c41($entries)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $entries as $entry )
...
{
$count_7d5aaba85377df66f0b8573a4bc436d3 = is_array($this->functionData['unapprovedComments']) ? count($this->functionData['unapprovedComments']) : 0;
$this->functionData['unapprovedComments'][$count_7d5aaba85377df66f0b8573a4bc436d3]['comments'] = $comments;
$this->functionData['unapprovedComments'][$count_7d5aaba85377df66f0b8573a4bc436d3]['pages'] = $pages;
}
$IPBHTML .= "" . (($pages) ? ("
	<div>{$pages}</div>
") : ("")) . "
...
<div class='clearfix'>
	" . ((is_array( $comments ) AND count( $comments )) ? ("
		<div id='ips_Posts2'>
			".$this->__f__b36c858911d66e20fe3b9c34f34c5c2a($comments,$pages)."		</div>
	") : ("
...
function __f__b36c858911d66e20fe3b9c34f34c5c2a($comments, $pages='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
