...
class skin_gallery_post_6 extends skinMaster{
...
{
$count_504c0d15871b168bd48c24bb4387b647 = is_array($this->functionData['attachiFrameUpload']) ? count($this->functionData['attachiFrameUpload']) : 0;
$this->functionData['attachiFrameUpload'][$count_504c0d15871b168bd48c24bb4387b647]['id'] = $id;
$this->functionData['attachiFrameUpload'][$count_504c0d15871b168bd48c24bb4387b647]['JSON'] = $JSON;
}
$IPBHTML .= "<html>
	<head>
		<style type=\"text/css\">
...
{
$count_074918964a1f55714752983f93f786a5 = is_array($this->functionData['editImageForm']) ? count($this->functionData['editImageForm']) : 0;
$this->functionData['editImageForm'][$count_074918964a1f55714752983f93f786a5]['image'] = $image;
$this->functionData['editImageForm'][$count_074918964a1f55714752983f93f786a5]['album'] = $album;
$this->functionData['editImageForm'][$count_074918964a1f55714752983f93f786a5]['category'] = $category;
$this->functionData['editImageForm'][$count_074918964a1f55714752983f93f786a5]['errors'] = $errors;
$this->functionData['editImageForm'][$count_074918964a1f55714752983f93f786a5]['preview'] = $preview;
}
...
{
$count_1753cab2570d86cf15d3c6021c87dbee = is_array($this->functionData['review']) ? count($this->functionData['review']) : 0;
$this->functionData['review'][$count_1753cab2570d86cf15d3c6021c87dbee]['images'] = $images;
$this->functionData['review'][$count_1753cab2570d86cf15d3c6021c87dbee]['album'] = $album;
$this->functionData['review'][$count_1753cab2570d86cf15d3c6021c87dbee]['category'] = $category;
$this->functionData['review'][$count_1753cab2570d86cf15d3c6021c87dbee]['type'] = $type;
$this->functionData['review'][$count_1753cab2570d86cf15d3c6021c87dbee]['opts'] = $opts;
}
...
<form method=\"post\" id='postingform' action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=gallery&amp;module=images&amp;section=review&amp;do=process", "public",'' ), "", "" ) . "\">
							...
							<li class='ipsField ipsField_select'>
								...
								<div class='ipsField_content'>
									<select name='album_category_id' id='album_category_id'>
										".$this->__f__581991c900466e487b9b68132515807b($images,$album,$category,$type,$opts)."									</select>
								</div>
							<li>
							<li class='ipsField'>
							...
							<li class='ipsField ipsField_select'>
								...
								<div class='ipsField_content'>
									<select name=\"album_sort_options__key\"" . ((!$album['_catDefaults']['album_sort_edit']) ? (" disabled='disabled'") : ("")) . ">
										".$this->__f__3e0f75b0ace7e4a2c88f7ceed767293f($images,$album,$category,$type,$opts)."									</select>
									<select name=\"album_sort_options__dir\"" . ((!$album['_catDefaults']['album_sort_edit']) ? (" disabled='disabled'") : ("")) . ">
										".$this->__f__b4a2f7061a4f48b8a58598a9d376d176($images,$album,$category,$type,$opts)."									</select>
								</div>
							<li>
	...
	" . ((is_array($images) && count($images)) ? ("<br />
		<div class='ipsBox'>
			".$this->__f__de926df3dc4766eed5f48bea530f2d9f($images,$album,$category,$type,$opts)."		</div>
...
function __f__581991c900466e487b9b68132515807b($images, $album, $category, $type, $opts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__3e0f75b0ace7e4a2c88f7ceed767293f($images, $album, $category, $type, $opts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b4a2f7061a4f48b8a58598a9d376d176($images, $album, $category, $type, $opts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__de926df3dc4766eed5f48bea530f2d9f($images, $album, $category, $type, $opts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_b4e7bcfff295f4682339ab88b325935c = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_b4e7bcfff295f4682339ab88b325935c]['sessionKey'] = $sessionKey;
$this->functionData['uploadForm'][$count_b4e7bcfff295f4682339ab88b325935c]['album'] = $album;
$this->functionData['uploadForm'][$count_b4e7bcfff295f4682339ab88b325935c]['category'] = $category;
$this->functionData['uploadForm'][$count_b4e7bcfff295f4682339ab88b325935c]['categories'] = $categories;
$this->functionData['uploadForm'][$count_b4e7bcfff295f4682339ab88b325935c]['stats'] = $stats;
$this->functionData['uploadForm'][$count_b4e7bcfff295f4682339ab88b325935c]['allowed_file_types'] = $allowed_file_types;
}
...
<div id='categorySelectorContent' style='display:none'>
	...
	<div class='ipsPad_double'>
		<table class='ipb_table' style=\"table-layout: auto;\">
			".$this->__f__a83768c2a3a874c925a7cf5c1e95e76f($sessionKey,$album,$category,$categories,$stats,$allowed_file_types)."		</table>
	</div>
</div>
<script type='text/javascript'>
//<![CDATA[
...
function __f__a83768c2a3a874c925a7cf5c1e95e76f($sessionKey='', $album=array(), $category=array(), $categories=array(), $stats=array(), $allowed_file_types='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
