...
{
$count_8f8c5c7070ed960b71d3e0cde3852588 = is_array($this->functionData['globalTemplate']) ? count($this->functionData['globalTemplate']) : 0;
$this->functionData['globalTemplate'][$count_8f8c5c7070ed960b71d3e0cde3852588]['html'] = $html;
$this->functionData['globalTemplate'][$count_8f8c5c7070ed960b71d3e0cde3852588]['documentHeadItems'] = $documentHeadItems;
$this->functionData['globalTemplate'][$count_8f8c5c7070ed960b71d3e0cde3852588]['css'] = $css;
$this->functionData['globalTemplate'][$count_8f8c5c7070ed960b71d3e0cde3852588]['jsModules'] = $jsModules;
$this->functionData['globalTemplate'][$count_8f8c5c7070ed960b71d3e0cde3852588]['metaTags'] = $metaTags;
$this->functionData['globalTemplate'][$count_8f8c5c7070ed960b71d3e0cde3852588]['header_items'] = $header_items;
$this->functionData['globalTemplate'][$count_8f8c5c7070ed960b71d3e0cde3852588]['items'] = $items;
$this->functionData['globalTemplate'][$count_8f8c5c7070ed960b71d3e0cde3852588]['footer_items'] = $footer_items;
$this->functionData['globalTemplate'][$count_8f8c5c7070ed960b71d3e0cde3852588]['stats'] = $stats;
}
...
<a href='{$this->settings['board_url']}' title='Best Destination Wedding' rel=\"home\" accesskey='1'><div id=\"bdwlogo\" style=\"height:100px; position:absolute;\"><img src=\"http://bdw.stevewright.netdna-cdn.com/public/style_images/destination/logo.png\" width=\"135\" height=\"87\" alt=\"Best Destination Wedding\"/></div> </a> 
			...
			<div id='primary_nav' class='clearfix'>
					<ul class='ipsList_inline' id='community_app_menu'>
						...
						") : ("" . ((is_array($header_items['applications']) AND count($header_items['applications'])) ? ("
								".$this->__f__9aaadd6e3d26e1fa74143c13cb108fe3($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."							") : ("")) . "")) . "
			...
			<div id='content' class='clearfix ipsMargin_top'>
				...
				" . ((count( $items['navigation'] )) ? ("<div id='secondary_navigation' class='clearfix'>
						<ol class='breadcrumb top ipsList_inline left'>
								...
								" . (($this->did_first=1) ? ("") : ("")) . "") : ("")) . "
							".$this->__f__4e4c759e53cbf0145a75642f4e758326($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."						</ol>
					</div>") : ("")) . "
				<noscript>
				...
				<ol class='breadcrumb bottom ipsList_inline left clearfix clear'>
					" . ((count( $items['navigation'] )) ? ("						" . ((!$this->settings['remove_forums_nav'] OR ipsRegistry::$current_application == 'forums') ? ("<li><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "act=idx", "public",'' ), "false", "" ) . "'>{$this->settings['board_name']}</a></li>
						...
						".$this->__f__05af447dbc4eddd14f737aa4f0d5e454($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."") : ("
						<li>&nbsp;</li>
					")) . "
							...
							" . ((count($footer_items['skin_chooser']) > 1) ? ("
								<li>
									...
									<ul id='new_skin_menucontent' class='ipbmenu_content with_checks' style='display: none'>
										".$this->__f__668dba238a97feef98bc9e4a3a931f7e($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."									</ul>
								</li>
							") : ("")) . "")) . "") : ("")) . "
					...
					" . ((! $this->member->is_not_human && count( $footer_items['lang_chooser']['options'] ) > 1) ? ("
						<li>
							...
							<ul id='new_language_menucontent' class='ipbmenu_content with_checks' style='display: none'>
								".$this->__f__0c85cbb306535dc166ec5de80943d93f($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."							</ul>
						</li>
...
" . (($this->request['f'] > 0) ? ("" . ((( ! $this->member->is_not_human ) && ( $this->memberData['member_id'] || $this->settings['topic_marking_guests'] )) ? ("
						<li>
							...
							<ul id='mark_all_read_menucontent' class='ipbmenu_content' style='display: none'>
								".$this->__f__c0dfb2d47ba5646db77a4c6e53523e69($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."								<li>
...
function __f__9aaadd6e3d26e1fa74143c13cb108fe3($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__4e4c759e53cbf0145a75642f4e758326($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__05af447dbc4eddd14f737aa4f0d5e454($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $items['navigation'] as $idx => $data )
...
function __f__668dba238a97feef98bc9e4a3a931f7e($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__0c85cbb306535dc166ec5de80943d93f($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__c0dfb2d47ba5646db77a4c6e53523e69($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_3377bb25cf9a65aa969545a716519304 = is_array($this->functionData['includeCSS']) ? count($this->functionData['includeCSS']) : 0;
$this->functionData['includeCSS'][$count_3377bb25cf9a65aa969545a716519304]['css'] = $css;
}
...
$IPBHTML .= "" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
	".$this->__f__35484427d16df91c5e82b4661dc1299b($css)."	" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
...
" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
	".$this->__f__32fa7350b334fd09d34e9c150594d457($css)."") : ("")) . "<!--hook.if.skin_global.includeCSS.inlinecss.post.endif-->
<!--[if lte IE 7]>
...
function __f__35484427d16df91c5e82b4661dc1299b($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__32fa7350b334fd09d34e9c150594d457($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_c2721fc59aaa1ae0d6d3346a54bcbf7a = is_array($this->functionData['includeFeeds']) ? count($this->functionData['includeFeeds']) : 0;
$this->functionData['includeFeeds'][$count_c2721fc59aaa1ae0d6d3346a54bcbf7a]['documentHeadItems'] = $documentHeadItems;
}
$IPBHTML .= "" . ((count($documentHeadItems)) ? ("
	".$this->__f__9999cc6d866db9e4d201b1926f966b64($documentHeadItems)."") : ("")) . "";
return $IPBHTML;
}


function __f__48355ad7f778dc610b14d7b07d2bd54a($documentHeadItems,$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__9999cc6d866db9e4d201b1926f966b64($documentHeadItems)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__48355ad7f778dc610b14d7b07d2bd54a($documentHeadItems,$type,$idx)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_0b6cf481793f85c1c72638f342c97045 = is_array($this->functionData['includeJS']) ? count($this->functionData['includeJS']) : 0;
$this->functionData['includeJS'][$count_0b6cf481793f85c1c72638f342c97045]['jsModules'] = $jsModules;
}
...
{
$count_06100ab2153733e918f3ea6c045f456b = is_array($this->functionData['includeMeta']) ? count($this->functionData['includeMeta']) : 0;
$this->functionData['includeMeta'][$count_06100ab2153733e918f3ea6c045f456b]['metaTags'] = $metaTags;
}
$IPBHTML .= "<!--hook.if.skin_global.includeMeta.metatags.pre.startif-->" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
	".$this->__f__60dbafba5a9cc2578f5509c1bcede686($metaTags)."") : ("")) . "
<meta property=\"og:image\" content=\"{$this->settings['meta_imagesrc']}\"/>";
return $IPBHTML;
}


function __f__dd757797603c21860278bc37c523a106($metaTags,$tag='',$id='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__60dbafba5a9cc2578f5509c1bcede686($metaTags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $metaTags as $tag => $id )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__dd757797603c21860278bc37c523a106($metaTags,$tag,$id)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_b037ef34e782bb9811e1bca7e05ce38b = is_array($this->functionData['includeRTL']) ? count($this->functionData['includeRTL']) : 0;
}

$this->isRtlLang	= false;
$IPBHTML .= "".$this->__f__e22bfdce43d1c98075f9497e3c1ec4e8()."" . (($this->isRtlLang AND is_file( DOC_IPS_ROOT_PATH . '/' . PUBLIC_DIRECTORY . '/style_css/' . $this->registry->output->skin['_csscacheid'] . '/ipb_rtl.css' )) ? ("
...
function __f__e22bfdce43d1c98075f9497e3c1ec4e8()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_6fe88ec331246e58db1166bbb622cf82 = is_array($this->functionData['includeVars']) ? count($this->functionData['includeVars']) : 0;
$this->functionData['includeVars'][$count_6fe88ec331246e58db1166bbb622cf82]['header_items'] = $header_items;
}
...
{
$count_70f6bf947245b4ddff6129d88fc8b597 = is_array($this->functionData['inlineLogin']) ? count($this->functionData['inlineLogin']) : 0;
}
...
<!--
							" . ((is_array($this->_formFields) AND count($this->_formFields)) ? ("
								".$this->__f__06726308cb3b6844221b4651e8299613()."							") : ("")) . "
-->
						</ul>
					</div>") : ("")) . "
				<br />
...
function __f__06726308cb3b6844221b4651e8299613()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_f9bcb095d2a97ffcfa3f4571f518961c = is_array($this->functionData['liveEditJs']) ? count($this->functionData['liveEditJs']) : 0;
}
...
<div class='ipsBox ipsPad'>
	...
	<form action='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&module=global&section=meta&do=save", "public",'' ), "", "" ) . "' method='post'>
		...
		<table class='ipb_table'>
			".$this->__f__8563d5a1186f64881d2b3913c44b5c7a($tags,$url)."		</table>
		</div>
		<table class='ipb_table'>
			<tr>
...
function __f__8563d5a1186f64881d2b3913c44b5c7a($tags, $url)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tags as $k => $v )
...
{
$count_647a5bc26a51ecba2b8cea7350fa23eb = is_array($this->functionData['nextPreviousTemplate']) ? count($this->functionData['nextPreviousTemplate']) : 0;
$this->functionData['nextPreviousTemplate'][$count_647a5bc26a51ecba2b8cea7350fa23eb]['data'] = $data;
}
...
{
$count_57073535835af4ddb581232f6894602d = is_array($this->functionData['paginationTemplate']) ? count($this->functionData['paginationTemplate']) : 0;
$this->functionData['paginationTemplate'][$count_57073535835af4ddb581232f6894602d]['work'] = $work;
$this->functionData['paginationTemplate'][$count_57073535835af4ddb581232f6894602d]['data'] = $data;
}
$IPBHTML .= "" . (($work['pages'] > 1) ? ("<div class='pagination clearfix left " . ((!$data['showNumbers']) ? ("no_numbers") : ("")) . "'>
		...
		<ul class='ipsList_inline left pages'>
			...
			" . ((is_array( $work['_pageNumbers'] ) && count( $work['_pageNumbers'] )) ? ("
				".$this->__f__a4440f63d10a9c1cf948ea0ed6892227($work,$data)."			") : ("")) . "
		</ul>
...
function __f__a4440f63d10a9c1cf948ea0ed6892227($work, $data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_02f4ad53e95a72dc4c5388eaf271e226 = is_array($this->functionData['quickSearch']) ? count($this->functionData['quickSearch']) : 0;
}
		...
		<fieldset>
			...
			<span id='search_wrap' class='right'>
				...
				<ul id='search_options_menucontent' class='ipbmenu_content ipsPad' style='display: none'>
					...
					".$this->__f__89032c82249e97b120405d167b80884f()."				</ul>
...
function __f__89032c82249e97b120405d167b80884f()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_a9de136dd715e1a0198eb1bd9c28939d = is_array($this->functionData['shareLinks']) ? count($this->functionData['shareLinks']) : 0;
$this->functionData['shareLinks'][$count_a9de136dd715e1a0198eb1bd9c28939d]['links'] = $links;
$this->functionData['shareLinks'][$count_a9de136dd715e1a0198eb1bd9c28939d]['title'] = $title;
$this->functionData['shareLinks'][$count_a9de136dd715e1a0198eb1bd9c28939d]['url'] = $url;
$this->functionData['shareLinks'][$count_a9de136dd715e1a0198eb1bd9c28939d]['cssClass'] = $cssClass;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("sharelinks", "0" ) . "
" . ((is_array( $links )) ? ("
	<ul class='{$cssClass} shareButtons ipsList_inline'>
	".$this->__f__1ddba2c09d9dbbe006996c539e0f017b($links,$title,$url,$cssClass)."	</ul>
	<script type=\"text/javascript\">
...
function __f__1ddba2c09d9dbbe006996c539e0f017b($links, $title='', $url='', $cssClass='topic_share left')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_803ac79c6e3dae28d3f22c1ee5dc3bb8 = is_array($this->functionData['signature_separator']) ? count($this->functionData['signature_separator']) : 0;
$this->functionData['signature_separator'][$count_803ac79c6e3dae28d3f22c1ee5dc3bb8]['sig'] = $sig;
$this->functionData['signature_separator'][$count_803ac79c6e3dae28d3f22c1ee5dc3bb8]['author_id'] = $author_id;
$this->functionData['signature_separator'][$count_803ac79c6e3dae28d3f22c1ee5dc3bb8]['can_ignore'] = $can_ignore;
}
...
{
$count_cdef5f1897414715d6b9856cb957eefc = is_array($this->functionData['userHoverCard']) ? count($this->functionData['userHoverCard']) : 0;
$this->functionData['userHoverCard'][$count_cdef5f1897414715d6b9856cb957eefc]['member'] = $member;
}
...
{
$count_d764baab162ffc0d2d6009cf23e1505d = is_array($this->functionData['userInfoPane']) ? count($this->functionData['userInfoPane']) : 0;
$this->functionData['userInfoPane'][$count_d764baab162ffc0d2d6009cf23e1505d]['author'] = $author;
$this->functionData['userInfoPane'][$count_d764baab162ffc0d2d6009cf23e1505d]['contentid'] = $contentid;
$this->functionData['userInfoPane'][$count_d764baab162ffc0d2d6009cf23e1505d]['options'] = $options;
}
$IPBHTML .= "<div itemscope itemtype=\"http://schema.org/Person\" class='user_details'>
	...
	<!--hook.if.skin_global.userInfoPane.authorcfields.pre.startif-->" . (($author['custom_fields'] != "") ? ("
		<ul class='custom_fields'>
			".$this->__f__bfc1f4361daf8c2f44efc3ec39d70e09($author,$contentid,$options)."		</ul>
	") : ("")) . "
...
function __f__c6ddb154b6541defdff88d8c0849f5e8($author, $contentid, $options,$group='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__bfc1f4361daf8c2f44efc3ec39d70e09($author, $contentid, $options)
{
	...
	foreach( $author['custom_fields'] as $group => $data )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__c6ddb154b6541defdff88d8c0849f5e8($author,$contentid,$options,$group,$data)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_8a4bfb917d6908d55ba1145cba93c01f = is_array($this->functionData['userSmallPhoto']) ? count($this->functionData['userSmallPhoto']) : 0;
$this->functionData['userSmallPhoto'][$count_8a4bfb917d6908d55ba1145cba93c01f]['member'] = $member;
}
...
{
$count_8782f5b27647e82cb4ee384825032c31 = is_array($this->functionData['warnDetails']) ? count($this->functionData['warnDetails']) : 0;
$this->functionData['warnDetails'][$count_8782f5b27647e82cb4ee384825032c31]['warning'] = $warning;
$this->functionData['warnDetails'][$count_8782f5b27647e82cb4ee384825032c31]['canSeeModNote'] = $canSeeModNote;
}
...
<div class='ipsBox'>
	<p class='message unspecific'>
		...
		") : ("" . (($warning['wl_points']) ? ("" . (($warning['wl_expire']) ? ("" . (($warning['wl_expire_date']) ? ("
				...
				")) . "") : ("")) . "
			".$this->__f__4d795d720e1fc257cc308ed405a6845c($warning,$canSeeModNote)."")) . "
	</p>
...
function __f__4d795d720e1fc257cc308ed405a6845c($warning, $canSeeModNote)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
