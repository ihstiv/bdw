...
class skin_blog_post_6 extends skinMaster{
...
{
$count_33044bf34a948dcb703745f6377a3a9e = is_array($this->functionData['blogPostForm']) ? count($this->functionData['blogPostForm']) : 0;
$this->functionData['blogPostForm'][$count_33044bf34a948dcb703745f6377a3a9e]['form_hiddens'] = $form_hiddens;
$this->functionData['blogPostForm'][$count_33044bf34a948dcb703745f6377a3a9e]['button'] = $button;
$this->functionData['blogPostForm'][$count_33044bf34a948dcb703745f6377a3a9e]['date'] = $date;
$this->functionData['blogPostForm'][$count_33044bf34a948dcb703745f6377a3a9e]['title'] = $title;
$this->functionData['blogPostForm'][$count_33044bf34a948dcb703745f6377a3a9e]['albums'] = $albums;
$this->functionData['blogPostForm'][$count_33044bf34a948dcb703745f6377a3a9e]['mod_options'] = $mod_options;
$this->functionData['blogPostForm'][$count_33044bf34a948dcb703745f6377a3a9e]['editor'] = $editor;
$this->functionData['blogPostForm'][$count_33044bf34a948dcb703745f6377a3a9e]['poll_box'] = $poll_box;
$this->functionData['blogPostForm'][$count_33044bf34a948dcb703745f6377a3a9e]['upload_field'] = $upload_field;
$this->functionData['blogPostForm'][$count_33044bf34a948dcb703745f6377a3a9e]['html_status'] = $html_status;
$this->functionData['blogPostForm'][$count_33044bf34a948dcb703745f6377a3a9e]['canPublish'] = $canPublish;
$this->functionData['blogPostForm'][$count_33044bf34a948dcb703745f6377a3a9e]['blogsdd'] = $blogsdd;
$this->functionData['blogPostForm'][$count_33044bf34a948dcb703745f6377a3a9e]['_extraData'] = $_extraData;
$this->functionData['blogPostForm'][$count_33044bf34a948dcb703745f6377a3a9e]['tagBox'] = $tagBox;
$this->functionData['blogPostForm'][$count_33044bf34a948dcb703745f6377a3a9e]['following'] = $following;
$this->functionData['blogPostForm'][$count_33044bf34a948dcb703745f6377a3a9e]['socialShare'] = $socialShare;
$this->functionData['blogPostForm'][$count_33044bf34a948dcb703745f6377a3a9e]['image'] = $image;
}
...
<form id='postingform' action='{$this->settings['base_url']}' method='post' name='postingform' enctype='multipart/form-data'>
					...
					<li class='ipsField ipsField_select'>
						...
						<p class='ipsField_content'>
							<select name='blogid' id='blog_chooser'>
								".$this->__f__060bb84e310e57056870176f61b24570($form_hiddens,$button,$date,$title,$albums,$mod_options,$editor,$poll_box,$upload_field,$html_status,$canPublish,$blogsdd,$_extraData,$tagBox,$following,$socialShare,$image)."							</select>
						</p>
					</li>
				") : ("")) . "
	...
	<fieldset class='submit clear'>
		...
		" . ((is_array( $form_hiddens ) && count( $form_hiddens )) ? ("
			".$this->__f__1042215a2de86076a7d089a7abec1e43($form_hiddens,$button,$date,$title,$albums,$mod_options,$editor,$poll_box,$upload_field,$html_status,$canPublish,$blogsdd,$_extraData,$tagBox,$following,$socialShare,$image)."		") : ("")) . "
...
function __f__060bb84e310e57056870176f61b24570($form_hiddens=array(), $button="", $date=array(), $title=array(), $albums="", $mod_options="", $editor="", $poll_box="", $upload_field='', $html_status=array(), $canPublish=0, $blogsdd='', $_extraData=array(), $tagBox='', $following = 0, $socialShare, $image='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__1042215a2de86076a7d089a7abec1e43($form_hiddens=array(), $button="", $date=array(), $title=array(), $albums="", $mod_options="", $editor="", $poll_box="", $upload_field='', $html_status=array(), $canPublish=0, $blogsdd='', $_extraData=array(), $tagBox='', $following = 0, $socialShare, $image='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_baa590676cd6df4619ba758bddc59c08 = is_array($this->functionData['cBlockForm']) ? count($this->functionData['cBlockForm']) : 0;
$this->functionData['cBlockForm'][$count_baa590676cd6df4619ba758bddc59c08]['form_hiddens'] = $form_hiddens;
$this->functionData['cBlockForm'][$count_baa590676cd6df4619ba758bddc59c08]['button'] = $button;
$this->functionData['cBlockForm'][$count_baa590676cd6df4619ba758bddc59c08]['cbtitle'] = $cbtitle;
$this->functionData['cBlockForm'][$count_baa590676cd6df4619ba758bddc59c08]['editor'] = $editor;
$this->functionData['cBlockForm'][$count_baa590676cd6df4619ba758bddc59c08]['html_status'] = $html_status;
$this->functionData['cBlockForm'][$count_baa590676cd6df4619ba758bddc59c08]['upload_field'] = $upload_field;
$this->functionData['cBlockForm'][$count_baa590676cd6df4619ba758bddc59c08]['blogData'] = $blogData;
}
$IPBHTML .= "<br />
<form id='postingform' action='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=blog&amp;module=post&amp;section=post", "public",'' ), "", "" ) . "' method='post' enctype='multipart/form-data'>
	...
	<fieldset class='submit clear'>
		...
		<input type='hidden' name='removeattachid' value='0' />
		" . ((is_array( $form_hiddens ) && count( $form_hiddens )) ? ("
			".$this->__f__43f643f7db75f1bd15f21ddf5e82f0c3($form_hiddens,$button,$cbtitle,$editor,$html_status,$upload_field,$blogData)."		") : ("")) . "
...
function __f__43f643f7db75f1bd15f21ddf5e82f0c3($form_hiddens=array(), $button='', $cbtitle='', $editor='', $html_status=array(), $upload_field='', $blogData=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
