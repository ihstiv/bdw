...
class skin_cmtp_6 extends skinMaster{
...
{
$count_9e667680320f99bea3e001c398ebd9bf = is_array($this->functionData['group_strip_fix']) ? count($this->functionData['group_strip_fix']) : 0;
$this->functionData['group_strip_fix'][$count_9e667680320f99bea3e001c398ebd9bf]['group'] = $group;
$this->functionData['group_strip_fix'][$count_9e667680320f99bea3e001c398ebd9bf]['members'] = $members;
$this->functionData['group_strip_fix'][$count_9e667680320f99bea3e001c398ebd9bf]['pagination'] = $pagination;
}
...
<table class='ipb_table ipsMemberList'>
	...
	" . ((count($members) AND is_array($members)) ? ("
				".$this->__f__55b6a50b61ac134fd3cdf5f5e29f2394($group,$members,$pagination)."	") : ("")) . "
</table>
" . (($pagination) ? ("
	<div class='topic_controls'>{$pagination}</div>
") : ("")) . "
...
function __f__2284b8db0cdabc2e8fca9da5c3334907($group='', $members=array(), $pagination='',$info='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__688915bf7abaa84e1e60d9202ac1d8eb($group='', $members=array(), $pagination='',$info='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $info['forums'] as $id => $name )
...
function __f__55b6a50b61ac134fd3cdf5f5e29f2394($group='', $members=array(), $pagination='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
			...
			<tr class='" .  IPSLib::next( $this->registry->templateStriping["staff"] ) . "'>
				...
				<td class='altrow short'>
					" . ((is_array($info['forums'])) ? ("" . ((count( $info['forums'] ) == 1) ? ("
							".$this->__f__2284b8db0cdabc2e8fca9da5c3334907($group,$members,$pagination,$info)."						") : ("
							...
							".$this->__f__688915bf7abaa84e1e60d9202ac1d8eb($group,$members,$pagination,$info)."							</ul>
