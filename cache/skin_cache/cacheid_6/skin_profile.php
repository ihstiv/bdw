...
class skin_profile_6 extends skinMaster{
...
{
$count_a277b59b402df9df3c88d50133e03fc2 = is_array($this->functionData['acknowledgeWarning']) ? count($this->functionData['acknowledgeWarning']) : 0;
$this->functionData['acknowledgeWarning'][$count_a277b59b402df9df3c88d50133e03fc2]['warning'] = $warning;
}
	...
	<div class='ipsBox'>
		...
		<div class='ipsBox_container ipsPad'>
			...
			") : ("" . (($warning['wl_points']) ? ("" . (($warning['wl_expire']) ? ("" . (($warning['wl_expire_date']) ? ("
					...
					")) . "") : ("")) . "
				".$this->__f__eff5a013233cedf63c54a991ae8f142f($warning)."")) . "
		</div>
	</div>
...
function __f__eff5a013233cedf63c54a991ae8f142f($warning)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_371d00b6fcde634083c50fcf7a8bc4fa = is_array($this->functionData['addWarning']) ? count($this->functionData['addWarning']) : 0;
$this->functionData['addWarning'][$count_371d00b6fcde634083c50fcf7a8bc4fa]['member'] = $member;
$this->functionData['addWarning'][$count_371d00b6fcde634083c50fcf7a8bc4fa]['reasons'] = $reasons;
$this->functionData['addWarning'][$count_371d00b6fcde634083c50fcf7a8bc4fa]['errors'] = $errors;
$this->functionData['addWarning'][$count_371d00b6fcde634083c50fcf7a8bc4fa]['editor'] = $editor;
$this->functionData['addWarning'][$count_371d00b6fcde634083c50fcf7a8bc4fa]['currentPunishments'] = $currentPunishments;
}
			...
			<ul class='ipsForm ipsForm_vertical'>
				<li class='ipsField ipsField_select'>
					...
					<div class='ipsField_content'>
						<select name='reason' id='reason-select'>
							...
							".$this->__f__32f96434308a99cfa7e1f4e321dc06a9($member,$reasons,$errors,$editor,$currentPunishments)."							" . (($this->settings['warnings_enable_other'] or $this->memberData['g_access_cp']) ? ("
				...
				<li class='ipsField' style='display:none' id='suspend_li'>
					...
					<div class='ipsField_content'>
						...
						".$this->__f__a38e9f78700c425a89b6a022f1116228($member,$reasons,$errors,$editor,$currentPunishments)."						</select>
					</div>
				</li>
...
function __f__32f96434308a99cfa7e1f4e321dc06a9($member, $reasons, $errors, $editor, $currentPunishments)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a38e9f78700c425a89b6a022f1116228($member, $reasons, $errors, $editor, $currentPunishments)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_9a8bacc5b5fb877a81c991048765b0e8 = is_array($this->functionData['customField__gender']) ? count($this->functionData['customField__gender']) : 0;
$this->functionData['customField__gender'][$count_9a8bacc5b5fb877a81c991048765b0e8]['f'] = $f;
}
...
{
$count_813370d72c6505d24507bbfb982fa37f = is_array($this->functionData['customField__generic']) ? count($this->functionData['customField__generic']) : 0;
$this->functionData['customField__generic'][$count_813370d72c6505d24507bbfb982fa37f]['f'] = $f;
}
...
{
$count_ef46de71c1acc59f4f7af2079fc83d32 = is_array($this->functionData['customFieldGroup__contact']) ? count($this->functionData['customFieldGroup__contact']) : 0;
$this->functionData['customFieldGroup__contact'][$count_ef46de71c1acc59f4f7af2079fc83d32]['f'] = $f;
}
$IPBHTML .= "" . (($f->parsed) ? ("<li>
	...
	<span class='row_data'>
		...
		" . ((is_array( $f->parsed )) ? ("
			".$this->__f__a6157b6fd6b7607c7c42ba8ce62c0118($f)."		") : ("" . (($f->raw_data['pf_key'] == 'aim') ? ("
...
function __f__a6157b6fd6b7607c7c42ba8ce62c0118($f)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_b93d3bbca641baa96228c82c5088ee8d = is_array($this->functionData['customizeProfile']) ? count($this->functionData['customizeProfile']) : 0;
$this->functionData['customizeProfile'][$count_b93d3bbca641baa96228c82c5088ee8d]['member'] = $member;
}
...
{
$count_0370ae06ed9e73c3f8a26b56ac5e34a6 = is_array($this->functionData['dnameWrapper']) ? count($this->functionData['dnameWrapper']) : 0;
$this->functionData['dnameWrapper'][$count_0370ae06ed9e73c3f8a26b56ac5e34a6]['member_name'] = $member_name;
$this->functionData['dnameWrapper'][$count_0370ae06ed9e73c3f8a26b56ac5e34a6]['records'] = $records;
}
...
<table class='ipb_table'>
	...
	" . ((is_array($records) AND count($records)) ? ("
		    	".$this->__f__0ded012216246aa6b632448b574478fc($member_name,$records)."	") : ("
		<tr>
...
function __f__0ded012216246aa6b632448b574478fc($member_name="",$records=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_5e5eb987cb62aeb4016b2aa0cb3680a0 = is_array($this->functionData['explainPoints']) ? count($this->functionData['explainPoints']) : 0;
$this->functionData['explainPoints'][$count_5e5eb987cb62aeb4016b2aa0cb3680a0]['reasons'] = $reasons;
$this->functionData['explainPoints'][$count_5e5eb987cb62aeb4016b2aa0cb3680a0]['actions'] = $actions;
}
...
<table class='ipb_table'>
	...
	".$this->__f__87c9d8f4c0763115c9dc2dc237718a34($reasons,$actions)."</table>
" . ((!empty( $actions )) ? ("
	<div class='ipsPad'>
	...
	<table class='ipb_table'>
		...
		".$this->__f__3fc15b1aa9b891ebdb62e492b30f56a8($reasons,$actions)."	</table>
") : ("")) . "";
return $IPBHTML;
}


function __f__87c9d8f4c0763115c9dc2dc237718a34($reasons, $actions)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $reasons as $r )
...
function __f__73e1425991e0d40f445355025eac4c75($reasons, $actions,$a='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( array( 'mq', 'rpa', 'suspend' ) as $k )
...
function __f__3fc15b1aa9b891ebdb62e492b30f56a8($reasons, $actions)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $actions as $a )
	{
		...
		$_ips___x_retval .= "
			<tr>
				<td>{$a['wa_points']}</td>
				<td>
					".$this->__f__73e1425991e0d40f445355025eac4c75($reasons,$actions,$a)."				</td>
			</tr>
...
{
$count_5e494bc1614597343c786f03f3d628c3 = is_array($this->functionData['friendsList']) ? count($this->functionData['friendsList']) : 0;
$this->functionData['friendsList'][$count_5e494bc1614597343c786f03f3d628c3]['friends'] = $friends;
$this->functionData['friendsList'][$count_5e494bc1614597343c786f03f3d628c3]['pages'] = $pages;
}
...
" . ((is_array($friends) and count($friends) && $this->settings['friends_enabled']) ? ("
		...
		".$this->__f__547091c4874657dda331bb941a97c443($friends,$pages)."	</ul>
") : ("<p class='no_messages'>
		" . (($this->request['tab'] == 'pending') ? ("
...
function __f__547091c4874657dda331bb941a97c443($friends, $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
					...
					<div class='ipsBox_withphoto'>
						<ul class='ipsList_inline right'>
							" . (($this->memberData['g_is_supmod'] == 1 && $friend['member_id'] != $this->memberData['member_id']) ? ("
								<li><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=modcp&amp;do=editmember&amp;mid={$friend['member_id']}&amp;pf={$friend['member_id']}", "public",'' ), "", "" ) . "' class='ipsButton_secondary'>{$this->lang->words['supmod_edit_member']}</a></li>
							") : ("")) . "
...
{
$count_6b0066065077bf4ac92e99b138907d9e = is_array($this->functionData['listWarnings']) ? count($this->functionData['listWarnings']) : 0;
$this->functionData['listWarnings'][$count_6b0066065077bf4ac92e99b138907d9e]['member'] = $member;
$this->functionData['listWarnings'][$count_6b0066065077bf4ac92e99b138907d9e]['warnings'] = $warnings;
$this->functionData['listWarnings'][$count_6b0066065077bf4ac92e99b138907d9e]['pagination'] = $pagination;
$this->functionData['listWarnings'][$count_6b0066065077bf4ac92e99b138907d9e]['reasons'] = $reasons;
$this->functionData['listWarnings'][$count_6b0066065077bf4ac92e99b138907d9e]['canWarn'] = $canWarn;
}
	...
	<div class='ipsBox'>
		<div class='ipsBox_container'>
			<table class='ipb_table'>
				...
				<tbody>
					".$this->__f__5c69cd2e1e63990c8fb182f9af27ede8($member,$warnings,$pagination,$reasons,$canWarn)."				</tbody>
			</table>
		</div>
	</div>
")) . "
...
function __f__5c69cd2e1e63990c8fb182f9af27ede8($member, $warnings, $pagination, $reasons, $canWarn)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_c7db336ead4c208654b8b32dc157f9ef = is_array($this->functionData['photoEditor']) ? count($this->functionData['photoEditor']) : 0;
$this->functionData['photoEditor'][$count_c7db336ead4c208654b8b32dc157f9ef]['data'] = $data;
$this->functionData['photoEditor'][$count_c7db336ead4c208654b8b32dc157f9ef]['member'] = $member;
}
...
{
$count_5e3f61acbe574ceabb9620f25964cb50 = is_array($this->functionData['profileModern']) ? count($this->functionData['profileModern']) : 0;
$this->functionData['profileModern'][$count_5e3f61acbe574ceabb9620f25964cb50]['tabs'] = $tabs;
$this->functionData['profileModern'][$count_5e3f61acbe574ceabb9620f25964cb50]['member'] = $member;
$this->functionData['profileModern'][$count_5e3f61acbe574ceabb9620f25964cb50]['visitors'] = $visitors;
$this->functionData['profileModern'][$count_5e3f61acbe574ceabb9620f25964cb50]['default_tab'] = $default_tab;
$this->functionData['profileModern'][$count_5e3f61acbe574ceabb9620f25964cb50]['default_tab_content'] = $default_tab_content;
$this->functionData['profileModern'][$count_5e3f61acbe574ceabb9620f25964cb50]['friends'] = $friends;
$this->functionData['profileModern'][$count_5e3f61acbe574ceabb9620f25964cb50]['status'] = $status;
$this->functionData['profileModern'][$count_5e3f61acbe574ceabb9620f25964cb50]['warns'] = $warns;
$this->functionData['profileModern'][$count_5e3f61acbe574ceabb9620f25964cb50]['show_contact'] = $show_contact;
}
...
<!--hook.if.skin_profile.profileModern.hasCustomization.pre.startif-->" . ((is_array($member['customization']) AND $member['customization']['type']) ? ("
...
" . ((($this->memberData['member_id'] && $member['member_id'] == $this->memberData['member_id']) || $this->memberData['g_is_supmod'] == 1 || ($this->memberData['member_id'] && $member['member_id'] != $this->memberData['member_id'])) ? ("<ul class='topic_buttons'>
		" . (($this->memberData['g_is_supmod'] == 1 && $member['member_id'] != $this->memberData['member_id']) ? ("
			<li><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=modcp&amp;do=editmember&amp;mid={$member['member_id']}&amp;pf={$member['member_id']}", "public",'' ), "", "" ) . "'>{$this->lang->words['supmod_edit_member']}</a></li>
		") : ("")) . "
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left' id='profile_tabs'>
			...
			<ul class='clear'>
				...
				".$this->__f__cdb1d9ab2d3a5a7cef4b722bb8fc8391($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status,$warns,$show_contact)."			</ul>
		</div>
			...
			<div class='ipsPad'>
				<div id='profile_content_main'>
					<div id='user_info_cell'>
						...
						" . ((!empty( $warns )) ? ("
							".$this->__f__e0ef1eac96dbc77fc648115559f8299a($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status,$warns,$show_contact)."						") : ("")) . "
						...
						<div class='ipsLayout_content'>
							...
							<div class='general_box clearfix'>
								...
								<ul class='ipsList_data clearfix'>
									...
									<!--hook.if.skin_profile.profileModern.member_title.pre.startif-->" . (($member['title'] != '') ? ("
										<li class='clear clearfix'>
									...
									<!--hook.if.skin_profile.profileModern.pcfields.pre.startif-->" . (($member['custom_fields']['profile_info'] != "") ? ("
										".$this->__f__68ab2e6b0326096a96b6091c4ebb5f84($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status,$warns,$show_contact)."									") : ("")) . "
								</ul>
								<br />
							</div>
							
							" . (($member['custom_fields']) ? ("
								".$this->__f__a9b3939bc7fc10ac8e5fb40e610a40f2($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status,$warns,$show_contact)."							") : ("")) . "
								...
								") : ("")) . "
									<ul class='ipsList_data clearfix'>
										...
										" . ((is_array( $member['custom_fields']['contact'])) ? ("
											".$this->__f__2b9f0a85e2c90e87e220af3dcbab9a0a($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status,$warns,$show_contact)."										") : ("")) . "
									</ul>
								</div>") : ("")) . "
						</div>
							...
							" . (($member['pp_setting_count_friends'] and $this->settings['friends_enabled']) ? ("<div class='general_box clearfix' id='friends_overview'>
									...
									<div class='ipsPad'>
										" . ((count($friends) AND is_array($friends)) ? ("
											".$this->__f__f8ee1e663f323e215d988486fe24a5c6($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status,$warns,$show_contact)."										") : ("
											<p class='desc'>
							...
							" . (($member['pp_setting_count_visitors']) ? ("<div class='general_box clearfix'>
									...
									" . ((is_array( $visitors ) && count( $visitors )) ? ("
										<ul class='ipsList_withminiphoto ipsPad'>
											".$this->__f__4f7630914fdfffeac9d34718f1fdf528($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status,$warns,$show_contact)."										</ul>
									") : ("
...
function __f__cdb1d9ab2d3a5a7cef4b722bb8fc8391($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array(), $warns=array(), $show_contact='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tabs as $tab )
...
function __f__e0ef1eac96dbc77fc648115559f8299a($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array(), $warns=array(), $show_contact='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__68ab2e6b0326096a96b6091c4ebb5f84($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array(), $warns=array(), $show_contact='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a3bb9dc16685290fd4b39b327518173d($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array(), $warns=array(), $show_contact='',$group='',$mdata='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a9b3939bc7fc10ac8e5fb40e610a40f2($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array(), $warns=array(), $show_contact='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		$_ips___x_retval .= "
									" . (($group != 'profile_info' AND $group != 'contact') ? ("" . ((is_array( $member['custom_fields'][ $group ] ) AND count( $member['custom_fields'][ $group ] )) ? ("
											<div class='general_box clearfix' id='custom_fields_{$group}'>
												...
												<br />
												<ul class='ipsList_data clearfix'>
													".$this->__f__a3bb9dc16685290fd4b39b327518173d($tabs,$member,$visitors,$default_tab,$default_tab_content,$friends,$status,$warns,$show_contact,$group,$mdata)."												</ul>
												<br />
											</div>
										") : ("")) . "") : ("")) . "
...
function __f__2b9f0a85e2c90e87e220af3dcbab9a0a($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array(), $warns=array(), $show_contact='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__f8ee1e663f323e215d988486fe24a5c6($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array(), $warns=array(), $show_contact='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $friends as $friend )
...
function __f__4f7630914fdfffeac9d34718f1fdf528($tabs=array(), $member=array(), $visitors=array(), $default_tab='status', $default_tab_content='', $friends=array(), $status=array(), $warns=array(), $show_contact='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_a4d756f455fc4bc58a2c443bbc57b0b0 = is_array($this->functionData['reputationPage']) ? count($this->functionData['reputationPage']) : 0;
$this->functionData['reputationPage'][$count_a4d756f455fc4bc58a2c443bbc57b0b0]['langBit'] = $langBit;
$this->functionData['reputationPage'][$count_a4d756f455fc4bc58a2c443bbc57b0b0]['currentApp'] = $currentApp;
$this->functionData['reputationPage'][$count_a4d756f455fc4bc58a2c443bbc57b0b0]['supportedApps'] = $supportedApps;
$this->functionData['reputationPage'][$count_a4d756f455fc4bc58a2c443bbc57b0b0]['processedResults'] = $processedResults;
}
	...
	" . ((count( $supportedApps ) > 1) ? ("
		<div class='maintitle ipsFilterbar clearfix'>
			<ul class='ipsList_inline ipsType_smaller left'>
				".$this->__f__320c2d88f6c9e33240bced050f33d04a($langBit,$currentApp,$supportedApps,$processedResults)."			</ul>
		</div>
	") : ("")) . "
	" . (($processedResults) ? ("
		{$processedResults}
...
function __f__320c2d88f6c9e33240bced050f33d04a($langBit, $currentApp='', $supportedApps=array(), $processedResults='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_d70ef6ef2b1b8d3968186d13ecae7e10 = is_array($this->functionData['showCard']) ? count($this->functionData['showCard']) : 0;
$this->functionData['showCard'][$count_d70ef6ef2b1b8d3968186d13ecae7e10]['member'] = $member;
$this->functionData['showCard'][$count_d70ef6ef2b1b8d3968186d13ecae7e10]['download'] = $download;
}
	...
	<div class='ipsPad'>
		...
		<div class='info'>
			<dl>
				...
				") : ("")) . "
				<!--hook.if.skin_profile.showCard.isadmin.pre.startif-->" . (($this->memberData['g_access_cp'] == 1) ? ("
...
{
$count_53eb09d23a120a21526569cea533f6af = is_array($this->functionData['statusReplies']) ? count($this->functionData['statusReplies']) : 0;
$this->functionData['statusReplies'][$count_53eb09d23a120a21526569cea533f6af]['replies'] = $replies;
$this->functionData['statusReplies'][$count_53eb09d23a120a21526569cea533f6af]['no_wrapper'] = $no_wrapper;
}
$IPBHTML .= "" . ((!$no_wrapper) ? ("
	<ul class='ipsList_withtinyphoto clear'>
") : ("")) . "".$this->__f__bc0a987309f1642432f54108a184e324($replies,$no_wrapper)."" . ((!$no_wrapper) ? ("
	</ul>
") : ("")) . "";
return $IPBHTML;
}
...
function __f__bc0a987309f1642432f54108a184e324($replies=array(), $no_wrapper=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_2f6d4fcafb03308e0e82504c5617fa67 = is_array($this->functionData['statusUpdates']) ? count($this->functionData['statusUpdates']) : 0;
$this->functionData['statusUpdates'][$count_2f6d4fcafb03308e0e82504c5617fa67]['updates'] = $updates;
$this->functionData['statusUpdates'][$count_2f6d4fcafb03308e0e82504c5617fa67]['smallSpace'] = $smallSpace;
$this->functionData['statusUpdates'][$count_2f6d4fcafb03308e0e82504c5617fa67]['latestOnly'] = $latestOnly;
}
$IPBHTML .= "".$this->__f__9a82c1dbc6090e99bc22ae793a3ceaa6($updates,$smallSpace,$latestOnly)."";
return $IPBHTML;
}


function __f__9a82c1dbc6090e99bc22ae793a3ceaa6($updates=array(), $smallSpace=0, $latestOnly=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_3faf17aa690711df63b16113fb4ee065 = is_array($this->functionData['statusUpdatesPage']) ? count($this->functionData['statusUpdatesPage']) : 0;
$this->functionData['statusUpdatesPage'][$count_3faf17aa690711df63b16113fb4ee065]['updates'] = $updates;
$this->functionData['statusUpdatesPage'][$count_3faf17aa690711df63b16113fb4ee065]['pages'] = $pages;
}
...
{
$count_1616bcbffd264063a652e84a9ad28677 = is_array($this->functionData['tabFriends']) ? count($this->functionData['tabFriends']) : 0;
$this->functionData['tabFriends'][$count_1616bcbffd264063a652e84a9ad28677]['friends'] = $friends;
$this->functionData['tabFriends'][$count_1616bcbffd264063a652e84a9ad28677]['member'] = $member;
$this->functionData['tabFriends'][$count_1616bcbffd264063a652e84a9ad28677]['pagination'] = $pagination;
}
$IPBHTML .= "<div class='general_box'>
	" . (($this->settings['friends_enabled'] AND $this->memberData['g_can_add_friends'] AND $member['pp_setting_count_friends']) ? ("<div class='friend_list clear' id='friend_list'>
			...
			" . ((is_array($friends) and count($friends)) ? ("
				<ul class='clearfix'>
				".$this->__f__b395ed205857afdadccd77ba63d2f232($friends,$member,$pagination)."				</ul>
			") : ("
				<p>
...
function __f__b395ed205857afdadccd77ba63d2f232($friends=array(), $member=array(), $pagination='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $friends as $friend )
...
{
$count_407ec8da52a73dd267094b04c5c91029 = is_array($this->functionData['tabReputation']) ? count($this->functionData['tabReputation']) : 0;
$this->functionData['tabReputation'][$count_407ec8da52a73dd267094b04c5c91029]['member'] = $member;
$this->functionData['tabReputation'][$count_407ec8da52a73dd267094b04c5c91029]['currentApp'] = $currentApp;
$this->functionData['tabReputation'][$count_407ec8da52a73dd267094b04c5c91029]['type'] = $type;
$this->functionData['tabReputation'][$count_407ec8da52a73dd267094b04c5c91029]['supportedApps'] = $supportedApps;
$this->functionData['tabReputation'][$count_407ec8da52a73dd267094b04c5c91029]['processedResults'] = $processedResults;
$this->functionData['tabReputation'][$count_407ec8da52a73dd267094b04c5c91029]['pagination'] = $pagination;
}
$IPBHTML .= "<div class='general_box'>
	<div class='maintitle ipsFilterbar clearfix'>
		" . ((count( $supportedApps ) > 1) ? ("
			<ul class='ipsList_inline ipsType_smaller left'>
				".$this->__f__93a1a5f3902b830a6d5329f6009651d6($member,$currentApp,$type,$supportedApps,$processedResults,$pagination)."			</ul>
		") : ("")) . "
...
function __f__93a1a5f3902b830a6d5329f6009651d6($member, $currentApp='', $type='', $supportedApps=array(), $processedResults='', $pagination='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $supportedApps as $_app )
...
{
$count_4357bb0ec5921fd879afb4e5af9efe6b = is_array($this->functionData['tabReputation_calendar']) ? count($this->functionData['tabReputation_calendar']) : 0;
$this->functionData['tabReputation_calendar'][$count_4357bb0ec5921fd879afb4e5af9efe6b]['results'] = $results;
}
$IPBHTML .= "<div class='ipsBox'>
	".$this->__f__19d0f03644579a9e8f0cdb8197210080($results)."</div>";
return $IPBHTML;
}


function __f__19d0f03644579a9e8f0cdb8197210080($results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_244b8f36dcd2e38ed6e8a15f4933da12 = is_array($this->functionData['tabReputation_posts']) ? count($this->functionData['tabReputation_posts']) : 0;
$this->functionData['tabReputation_posts'][$count_244b8f36dcd2e38ed6e8a15f4933da12]['results'] = $results;
}
$IPBHTML .= "<div class='ipsBox'>
	".$this->__f__72a55f75f17cfd67be7f83ebf4a0bd8b($results)."</div>";
return $IPBHTML;
}


function __f__ea1a5cb8c61c58e304cec2b232dd5667($results,$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__72a55f75f17cfd67be7f83ebf4a0bd8b($results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $results as $data )
			...
			<div class='post_wrap'>
				...
				<div class='post_body'>
					<p class='posted_info desc lighter ipsType_small'>
						...
						" . (($data['_forum_trail']) ? ("
							in
							".$this->__f__ea1a5cb8c61c58e304cec2b232dd5667($results,$data)."						") : ("")) . "
					</p>
					<div class='post entry-content clearfix'>
						{$data['post']}
						<br />
...
{
$count_b8d43e1c25c44dffffe158141a76711d = is_array($this->functionData['tabSingleColumn']) ? count($this->functionData['tabSingleColumn']) : 0;
$this->functionData['tabSingleColumn'][$count_b8d43e1c25c44dffffe158141a76711d]['row'] = $row;
$this->functionData['tabSingleColumn'][$count_b8d43e1c25c44dffffe158141a76711d]['read_more_link'] = $read_more_link;
$this->functionData['tabSingleColumn'][$count_b8d43e1c25c44dffffe158141a76711d]['url'] = $url;
$this->functionData['tabSingleColumn'][$count_b8d43e1c25c44dffffe158141a76711d]['title'] = $title;
}
...
{
$count_c4bbf4e65a9aa16a589b208d65d60eb1 = is_array($this->functionData['tabStatusUpdates']) ? count($this->functionData['tabStatusUpdates']) : 0;
$this->functionData['tabStatusUpdates'][$count_c4bbf4e65a9aa16a589b208d65d60eb1]['updates'] = $updates;
$this->functionData['tabStatusUpdates'][$count_c4bbf4e65a9aa16a589b208d65d60eb1]['actions'] = $actions;
$this->functionData['tabStatusUpdates'][$count_c4bbf4e65a9aa16a589b208d65d60eb1]['member'] = $member;
}
