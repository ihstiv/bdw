...
class skin_post_6 extends skinMaster{
...
{
$count_2e6a185f1e0c514bd12afafce82684e3 = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_2e6a185f1e0c514bd12afafce82684e3]['data'] = $data;
}
...
{
$count_10a94c6667d5371a4e2ea0f06a9e52d9 = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_10a94c6667d5371a4e2ea0f06a9e52d9]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_10a94c6667d5371a4e2ea0f06a9e52d9]['form'] = $form;
}
...
{
$count_1fca877b05e42826d87d5e7dbedf9cb4 = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_1fca877b05e42826d87d5e7dbedf9cb4]['data'] = $data;
}
...
{
$count_c5b277185a5f888ad8036d1f7daf6e75 = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_c5b277185a5f888ad8036d1f7daf6e75]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__69fcaca282408aa0b38ac3046f85d4da($posts)."") : ("")) . "
<p class='submit'>
...
function __f__69fcaca282408aa0b38ac3046f85d4da($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_df484e04355475023d8f8a3c32b86a03 = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_df484e04355475023d8f8a3c32b86a03]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_df484e04355475023d8f8a3c32b86a03]['type'] = $type;
$this->functionData['uploadForm'][$count_df484e04355475023d8f8a3c32b86a03]['stats'] = $stats;
$this->functionData['uploadForm'][$count_df484e04355475023d8f8a3c32b86a03]['id'] = $id;
$this->functionData['uploadForm'][$count_df484e04355475023d8f8a3c32b86a03]['forum_id'] = $forum_id;
}
