...
class skin_blog_list_6 extends skinMaster{
...
{
$count_4419911c5f6cd7fdaf2367a77377a8fa = is_array($this->functionData['blog_rating']) ? count($this->functionData['blog_rating']) : 0;
$this->functionData['blog_rating'][$count_4419911c5f6cd7fdaf2367a77377a8fa]['number'] = $number;
}
$IPBHTML .= "".$this->__f__9a3e75086e2e66e551c1cdf6f0a0a853($number)."";
return $IPBHTML;
}


function __f__9a3e75086e2e66e551c1cdf6f0a0a853($number)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_6e1b9847aea5caf8e6fc3be6a5682579 = is_array($this->functionData['blogAjaxSidebar']) ? count($this->functionData['blogAjaxSidebar']) : 0;
$this->functionData['blogAjaxSidebar'][$count_6e1b9847aea5caf8e6fc3be6a5682579]['blogs'] = $blogs;
}
$IPBHTML .= "" . ((is_array( $blogs ) && count( $blogs )) ? ("
	".$this->__f__27ea51ca20fe908a7021285fd211b888($blogs)."") : ("
...
function __f__27ea51ca20fe908a7021285fd211b888($blogs)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_de608871529249327123a90d4392ea30 = is_array($this->functionData['blogAjaxSidebarREntries']) ? count($this->functionData['blogAjaxSidebarREntries']) : 0;
$this->functionData['blogAjaxSidebarREntries'][$count_de608871529249327123a90d4392ea30]['entries'] = $entries;
}
$IPBHTML .= "" . ((is_array( $entries ) && count( $entries )) ? ("
	".$this->__f__faf9e22061c1f3d2293d5e9493f70f87($entries)."") : ("
...
function __f__faf9e22061c1f3d2293d5e9493f70f87($entries)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_93af2dbdcb6de175990904191ef734db = is_array($this->functionData['blogFeaturedEntry']) ? count($this->functionData['blogFeaturedEntry']) : 0;
$this->functionData['blogFeaturedEntry'][$count_93af2dbdcb6de175990904191ef734db]['featured'] = $featured;
}
...
{
$count_f9a613432cdc315b5cbde2bea10af209 = is_array($this->functionData['blogIndexPage']) ? count($this->functionData['blogIndexPage']) : 0;
$this->functionData['blogIndexPage'][$count_f9a613432cdc315b5cbde2bea10af209]['pages'] = $pages;
$this->functionData['blogIndexPage'][$count_f9a613432cdc315b5cbde2bea10af209]['featured'] = $featured;
$this->functionData['blogIndexPage'][$count_f9a613432cdc315b5cbde2bea10af209]['blogs'] = $blogs;
$this->functionData['blogIndexPage'][$count_f9a613432cdc315b5cbde2bea10af209]['extra'] = $extra;
$this->functionData['blogIndexPage'][$count_f9a613432cdc315b5cbde2bea10af209]['type'] = $type;
$this->functionData['blogIndexPage'][$count_f9a613432cdc315b5cbde2bea10af209]['sorting'] = $sorting;
$this->functionData['blogIndexPage'][$count_f9a613432cdc315b5cbde2bea10af209]['pinned'] = $pinned;
}
	...
	" . (($this->memberData['member_id']) ? ("<ul class='topic_buttons'>
		...
		" . ((is_array($this->memberData['has_blog']) && count($this->memberData['has_blog'])) ? ("
			<ul class=\"ipbmenu_content\" id='addentrylink_menucontent' style='display:none' >
				".$this->__f__d18aa7c1079b6bf83ae973f7dfedd9a7($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."			</ul>
		") : ("")) . "") : ("")) . "
		...
		" . ((is_array( $pinned ) AND count( $pinned )) ? ("
			<div class='ipsSideBlock clearfix'>
				...
				<ul class='ipsList_withminiphoto'>
					".$this->__f__533f5aa36a189fbfcd38f904c0cf95a3($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."				</ul>
			</div>
		") : ("")) . "
		...
		<div id='blogs_filter_menucontent' class='ipbmenu_content ipsPad' style='display: none'>
			<form id='filter_form' action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=blog&amp;type=all", "public",'' ), "false", "app=blog" ) . "\" method=\"post\">
				...
				<select name='filter' id='filter' class='input_select'>
					".$this->__f__a2ae968ed282125354a9e7d103e1ef1f($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."				</select>
				<br /><br />
				
				<strong>{$this->lang->words['blist_sort_on']}</strong><br />
				<select name='sort_key' id='sort_key' class='input_select'>
					".$this->__f__58c7130e54f38617e2d6fb50eaa64fe6($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."				</select>
				<br /><br />
				
				<strong>{$this->lang->words['by_sort']}</strong><br />
				<select name='sort_order' id='sort_order' class='input_select'>
					".$this->__f__58c4bfab0888c07df964d2e07d58d5e0($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."				</select>
				<br /><br />
				
				<strong>{$this->lang->words['blist_per_page']}</strong><br />
				<select name='max_results' id='max_results' class='input_select'>
					".$this->__f__70e39b329ac6f05643875c1834900ca3($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."				</select>
				<br /><br />
		...
		") : ("<div class='ipsBox clear'>
				...
				" . (($type == 'dash') ? ("<!-- FEATURED -->
					" . ((is_array($featured) AND count($featured)) ? ("
						".$this->__f__f30ccea7b656f27faecb75e10c66e98e($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."					") : ("")) . "
					<!--NORMALS-->
					" . ((is_array( $blogs['normal'] ) && count( $blogs['normal'] )) ? ("
						".$this->__f__13363e716d0e5da3e1fd684ac35fc839($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."					") : ("")) . "") : ("<script type='text/javascript'>
					...
					<div class='ipsBox_container'>
						<table class='ipb_table'>
							...
							" . ((is_array($featured) AND count($featured)) ? ("
								".$this->__f__1862d1fc5f219ef564bfa9bf86b13f64($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."							") : ("")) . "
							" . ((is_array( $blogs['pinned'] ) && count( $blogs['pinned'] )) ? ("
								".$this->__f__e9ccdc628506fda4019cd8ea711e9a1d($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."							") : ("")) . "
							" . ((is_array( $blogs['normal'] ) && count( $blogs['normal'] )) ? ("
								".$this->__f__5fa6a0083fa6ebf88e5faab3f94e80c8($pages,$featured,$blogs,$extra,$type,$sorting,$pinned)."							") : ("")) . "
						</table>
					</div>
					<script type='text/javascript'>
...
function __f__d18aa7c1079b6bf83ae973f7dfedd9a7($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__533f5aa36a189fbfcd38f904c0cf95a3($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a2ae968ed282125354a9e7d103e1ef1f($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__58c7130e54f38617e2d6fb50eaa64fe6($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__58c4bfab0888c07df964d2e07d58d5e0($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__70e39b329ac6f05643875c1834900ca3($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__f30ccea7b656f27faecb75e10c66e98e($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__13363e716d0e5da3e1fd684ac35fc839($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__1862d1fc5f219ef564bfa9bf86b13f64($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $featured as $fid => $entry )
...
function __f__e9ccdc628506fda4019cd8ea711e9a1d($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__5fa6a0083fa6ebf88e5faab3f94e80c8($pages, $featured=array(), $blogs=array(), $extra='', $type='dash', $sorting='', $pinned=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_b9d4ab8c88f5a1bf38e80c29acf1ed4c = is_array($this->functionData['blogListRow']) ? count($this->functionData['blogListRow']) : 0;
$this->functionData['blogListRow'][$count_b9d4ab8c88f5a1bf38e80c29acf1ed4c]['entry'] = $entry;
$this->functionData['blogListRow'][$count_b9d4ab8c88f5a1bf38e80c29acf1ed4c]['outSideBlog'] = $outSideBlog;
}
...
{
$count_6b13332813c7eef95558c8ead755e4fe = is_array($this->functionData['blogTableRow']) ? count($this->functionData['blogTableRow']) : 0;
$this->functionData['blogTableRow'][$count_6b13332813c7eef95558c8ead755e4fe]['blog'] = $blog;
}
...
{
$count_ac7b2bc4a67e7e22acb4ee3d3975d75f = is_array($this->functionData['generateBlogIcon']) ? count($this->functionData['generateBlogIcon']) : 0;
$this->functionData['generateBlogIcon'][$count_ac7b2bc4a67e7e22acb4ee3d3975d75f]['data'] = $data;
}
