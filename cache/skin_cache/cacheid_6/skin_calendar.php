...
class skin_calendar_6 extends skinMaster{
...
{
$count_da4b9ee1e9a25338f547b58ddf8c3e9d = is_array($this->functionData['bbCodeEvent']) ? count($this->functionData['bbCodeEvent']) : 0;
$this->functionData['bbCodeEvent'][$count_da4b9ee1e9a25338f547b58ddf8c3e9d]['event'] = $event;
$this->functionData['bbCodeEvent'][$count_da4b9ee1e9a25338f547b58ddf8c3e9d]['type'] = $type;
$this->functionData['bbCodeEvent'][$count_da4b9ee1e9a25338f547b58ddf8c3e9d]['ends'] = $ends;
}
...
{
$count_9844fbe0bd342f4d6c6eea00be669d84 = is_array($this->functionData['boardIndexBirthdays']) ? count($this->functionData['boardIndexBirthdays']) : 0;
$this->functionData['boardIndexBirthdays'][$count_9844fbe0bd342f4d6c6eea00be669d84]['birthdays'] = $birthdays;
$this->functionData['boardIndexBirthdays'][$count_9844fbe0bd342f4d6c6eea00be669d84]['data'] = $data;
}
		...
		<div class='_sbcollapsable'>
			" . ((count( $birthdays )) ? ("
				<ul class='ipsList_withminiphoto'>
					".$this->__f__9474d4a9d6f6866858d596cfc98423fa($birthdays,$data)."				</ul>
			") : ("
...
function __f__9474d4a9d6f6866858d596cfc98423fa($birthdays, $data=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_f6e16119c4d18a9d78b0a7749a155f3b = is_array($this->functionData['boardIndexCalEvents']) ? count($this->functionData['boardIndexCalEvents']) : 0;
$this->functionData['boardIndexCalEvents'][$count_f6e16119c4d18a9d78b0a7749a155f3b]['events'] = $events;
}
		...
		<div class='_sbcollapsable'>
			" . ((is_array( $events )) ? ("
				<ul itemscope itemtype=\"http://schema.org/Event\" class='ipsList_withminiphoto'>
					".$this->__f__877b1f084cc464063ab8916ea7684b04($events)."				</ul>
			") : ("
...
function __f__877b1f084cc464063ab8916ea7684b04($events)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_4d7dcf59387db1ce97bdf00d2f703657 = is_array($this->functionData['cal_date_cell']) ? count($this->functionData['cal_date_cell']) : 0;
$this->functionData['cal_date_cell'][$count_4d7dcf59387db1ce97bdf00d2f703657]['day'] = $day;
$this->functionData['cal_date_cell'][$count_4d7dcf59387db1ce97bdf00d2f703657]['events'] = $events;
$this->functionData['cal_date_cell'][$count_4d7dcf59387db1ce97bdf00d2f703657]['cal_date_queued'] = $cal_date_queued;
$this->functionData['cal_date_cell'][$count_4d7dcf59387db1ce97bdf00d2f703657]['queued'] = $queued;
$this->functionData['cal_date_cell'][$count_4d7dcf59387db1ce97bdf00d2f703657]['js_id'] = $js_id;
}
$IPBHTML .= "<!--Day-->
...
{
$count_8161998e409414de172b4e5ebb33ac18 = is_array($this->functionData['cal_date_cell_today']) ? count($this->functionData['cal_date_cell_today']) : 0;
$this->functionData['cal_date_cell_today'][$count_8161998e409414de172b4e5ebb33ac18]['day'] = $day;
$this->functionData['cal_date_cell_today'][$count_8161998e409414de172b4e5ebb33ac18]['events'] = $events;
$this->functionData['cal_date_cell_today'][$count_8161998e409414de172b4e5ebb33ac18]['cal_date_queued'] = $cal_date_queued;
$this->functionData['cal_date_cell_today'][$count_8161998e409414de172b4e5ebb33ac18]['queued'] = $queued;
$this->functionData['cal_date_cell_today'][$count_8161998e409414de172b4e5ebb33ac18]['js_id'] = $js_id;
}
$IPBHTML .= "<!--Day-->
...
{
$count_e224c562a0412a96e7e90ac8e9cff7b2 = is_array($this->functionData['cal_week_dayentry']) ? count($this->functionData['cal_week_dayentry']) : 0;
$this->functionData['cal_week_dayentry'][$count_e224c562a0412a96e7e90ac8e9cff7b2]['wday'] = $wday;
$this->functionData['cal_week_dayentry'][$count_e224c562a0412a96e7e90ac8e9cff7b2]['date'] = $date;
$this->functionData['cal_week_dayentry'][$count_e224c562a0412a96e7e90ac8e9cff7b2]['month'] = $month;
$this->functionData['cal_week_dayentry'][$count_e224c562a0412a96e7e90ac8e9cff7b2]['mid'] = $mid;
$this->functionData['cal_week_dayentry'][$count_e224c562a0412a96e7e90ac8e9cff7b2]['year'] = $year;
$this->functionData['cal_week_dayentry'][$count_e224c562a0412a96e7e90ac8e9cff7b2]['events'] = $events;
$this->functionData['cal_week_dayentry'][$count_e224c562a0412a96e7e90ac8e9cff7b2]['queued'] = $queued;
}
...
{
$count_22d15e2140ed2129dc705fd73ed98b64 = is_array($this->functionData['calendar_likeSummaryContents']) ? count($this->functionData['calendar_likeSummaryContents']) : 0;
$this->functionData['calendar_likeSummaryContents'][$count_22d15e2140ed2129dc705fd73ed98b64]['data'] = $data;
$this->functionData['calendar_likeSummaryContents'][$count_22d15e2140ed2129dc705fd73ed98b64]['relId'] = $relId;
$this->functionData['calendar_likeSummaryContents'][$count_22d15e2140ed2129dc705fd73ed98b64]['opts'] = $opts;
}
...
{
$count_9320b23998ae2a6a07b0484d9a23bc46 = is_array($this->functionData['calendarBirthdayList']) ? count($this->functionData['calendarBirthdayList']) : 0;
$this->functionData['calendarBirthdayList'][$count_9320b23998ae2a6a07b0484d9a23bc46]['rows'] = $rows;
}
$IPBHTML .= "<h2 class='ipsType_subtitle'>{$this->lang->words['celebrating_bday']}</h2>
<br />
" . ((is_array( $rows ) and count( $rows )) ? ("
	".$this->__f__2d0c5b560f00ecf4be1169a27f53395b($rows)."") : ("
	<br />
...
function __f__2d0c5b560f00ecf4be1169a27f53395b($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e75c99373ea53de84aa9578c8abdd843 = is_array($this->functionData['calendarEventForm']) ? count($this->functionData['calendarEventForm']) : 0;
$this->functionData['calendarEventForm'][$count_e75c99373ea53de84aa9578c8abdd843]['data'] = $data;
}
...
{
$count_26195b12387c7411353e2e6cce57938f = is_array($this->functionData['calendarEventsList']) ? count($this->functionData['calendarEventsList']) : 0;
$this->functionData['calendarEventsList'][$count_26195b12387c7411353e2e6cce57938f]['data'] = $data;
}
...
{
$count_6babbc0a3653d367a93b475e9d1f5eed = is_array($this->functionData['calendarJump']) ? count($this->functionData['calendarJump']) : 0;
$this->functionData['calendarJump'][$count_6babbc0a3653d367a93b475e9d1f5eed]['calendars'] = $calendars;
$this->functionData['calendarJump'][$count_6babbc0a3653d367a93b475e9d1f5eed]['calendar'] = $calendar;
$this->functionData['calendarJump'][$count_6babbc0a3653d367a93b475e9d1f5eed]['chosen_date'] = $chosen_date;
}
$IPBHTML .= "" . ((is_array( $calendars ) && count( $calendars ) > 1) ? ("
	...
	<ul class='ipbmenu_content' style='display: none' id='calendar_chooser_menucontent'>
		".$this->__f__6ee46d1266a3eccc00e6639f5ee59c44($calendars,$calendar,$chosen_date)."	</ul>
	<script type='text/javascript'>
...
function __f__6ee46d1266a3eccc00e6639f5ee59c44($calendars, $calendar, $chosen_date=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_90d96cd2d6a142e5b5813f44f147d0d0 = is_array($this->functionData['calendarMainContent']) ? count($this->functionData['calendarMainContent']) : 0;
$this->functionData['calendarMainContent'][$count_90d96cd2d6a142e5b5813f44f147d0d0]['data'] = $data;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("calendar", "0" ) . "
<script type='text/javascript'>
	ipb.vars['month_url'] = \"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=calendar&module=calendar&section=view&cal_id={$data['calendar']['cal_id']}", "public",'' ), "", "" ) . "\";
...
<div class='ipsBox'>
	<div class='ipsBox_container'>
		<table id='calendar_table' class='ipsCalendar ipb_table vcalendar' summary=\"{$this->lang->words['calendar_for']} {$data['month_title']} {$data['chosen_date']['year']}\">
			<tr class='header'>
				".$this->__f__4fca8c28381c59599e773739d56cafe5($data)."				{$data['events']}
			</tr>
		</table>
	</div>
</div>
...
function __f__4fca8c28381c59599e773739d56cafe5($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_7dbf63f0748d194752738ebfbca3a043 = is_array($this->functionData['calendarWeekView']) ? count($this->functionData['calendarWeekView']) : 0;
$this->functionData['calendarWeekView'][$count_7dbf63f0748d194752738ebfbca3a043]['data'] = $data;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("calendar", "0" ) . "
<script type='text/javascript'>
	ipb.vars['month_url'] = \"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=calendar&module=calendar&section=view&cal_id={$data['calendar']['cal_id']}", "public",'' ), "", "" ) . "\";
...
{
$count_b3356315024264a24b22716468163663 = is_array($this->functionData['calEventFollowedWrapper']) ? count($this->functionData['calEventFollowedWrapper']) : 0;
$this->functionData['calEventFollowedWrapper'][$count_b3356315024264a24b22716468163663]['rows'] = $rows;
}
...
$IPBHTML .= "<div id='search_results'>
	<ol>
		" . ((is_array($rows) && count($rows)) ? ("
			".$this->__f__00831f7f140793f043ec063f11ee20d7($rows)."		") : ("")) . "
	</ol>
</div>";
return $IPBHTML;
}
...
function __f__00831f7f140793f043ec063f11ee20d7($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_03020597e19d98eb57702fb3ed82b15c = is_array($this->functionData['calEventSearchResult']) ? count($this->functionData['calEventSearchResult']) : 0;
$this->functionData['calEventSearchResult'][$count_03020597e19d98eb57702fb3ed82b15c]['r'] = $r;
$this->functionData['calEventSearchResult'][$count_03020597e19d98eb57702fb3ed82b15c]['resultAsTitle'] = $resultAsTitle;
$this->functionData['calEventSearchResult'][$count_03020597e19d98eb57702fb3ed82b15c]['type'] = $type;
$this->functionData['calEventSearchResult'][$count_03020597e19d98eb57702fb3ed82b15c]['ends'] = $ends;
}
...
{
$count_048e4cdf4df8f056563a52fd99d4cb6f = is_array($this->functionData['event_likeSummaryContents']) ? count($this->functionData['event_likeSummaryContents']) : 0;
$this->functionData['event_likeSummaryContents'][$count_048e4cdf4df8f056563a52fd99d4cb6f]['data'] = $data;
$this->functionData['event_likeSummaryContents'][$count_048e4cdf4df8f056563a52fd99d4cb6f]['relId'] = $relId;
$this->functionData['event_likeSummaryContents'][$count_048e4cdf4df8f056563a52fd99d4cb6f]['opts'] = $opts;
}
$IPBHTML .= "<span class='ipsButton_extra right " . (($data['totalCount']) ? ("_fmore clickable") : ("")) . "' title='" . sprintf( $this->lang->words['like_totalcount_' . $data['vernacular'] ], $data['totalCount'] ) . "' data-tooltip=\"" . sprintf( $this->lang->words['like_totalcount_' . $data['vernacular'] ], $data['totalCount'] ) . "\"><img src='{$this->settings['img_url']}/icon_users.png' /> <strong>{$data['totalCount']}</strong></span>
" . (($this->memberData['member_id']) ? ("<a href='#' title=\"" . (($data['iLike']) ? ("" . sprintf( $this->lang->words['fave_tt_on'], $this->lang->words['like_ucfirst_un' . $data['vernacular'] ]) . "") : ("" . sprintf( $this->lang->words['fave_tt_off'], $this->lang->words['like_ucfirst_' . $data['vernacular'] ]) . "")) . "\" class='ftoggle ipsButton_secondary'>" . (($data['iLike']) ? ("" . sprintf( $this->lang->words['unset_fave_button'], $this->lang->words['like_ucfirst_un' . $data['vernacular'] ]) . "") : ("" . sprintf( $this->lang->words['set_fave_button'], $this->lang->words['like_ucfirst_' . $data['vernacular'] ]) . "")) . "</a>") : ("")) . "";
return $IPBHTML;
...
{
$count_17999ad95adba4832c9c3860cfc73a3d = is_array($this->functionData['eventAttendee']) ? count($this->functionData['eventAttendee']) : 0;
$this->functionData['eventAttendee'][$count_17999ad95adba4832c9c3860cfc73a3d]['member'] = $member;
$this->functionData['eventAttendee'][$count_17999ad95adba4832c9c3860cfc73a3d]['event'] = $event;
}
...
{
$count_4c871425e6a5c803af771bbea3559f06 = is_array($this->functionData['followedContentCalendars']) ? count($this->functionData['followedContentCalendars']) : 0;
$this->functionData['followedContentCalendars'][$count_4c871425e6a5c803af771bbea3559f06]['rows'] = $rows;
}
$IPBHTML .= "<div id='search_results'>
	<ol>
		".$this->__f__7f1c6fa18eedf971deb25b55d407e3ab($rows)."	</ol>
</div>";
return $IPBHTML;
}


function __f__7f1c6fa18eedf971deb25b55d407e3ab($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $r )
...
{
$count_85cdc0dca9282a32ad47baa6c3f90606 = is_array($this->functionData['mini_cal_date_cell']) ? count($this->functionData['mini_cal_date_cell']) : 0;
$this->functionData['mini_cal_date_cell'][$count_85cdc0dca9282a32ad47baa6c3f90606]['day'] = $day;
}
$IPBHTML .= "<td>
...
{
$count_1f1f0f61e319bb3badba5d415abd3d2a = is_array($this->functionData['mini_cal_date_cell_today']) ? count($this->functionData['mini_cal_date_cell_today']) : 0;
$this->functionData['mini_cal_date_cell_today'][$count_1f1f0f61e319bb3badba5d415abd3d2a]['day'] = $day;
}
...
{
$count_5e10163bf9f1642c4db18582599c10e8 = is_array($this->functionData['miniCalendarWrapper']) ? count($this->functionData['miniCalendarWrapper']) : 0;
$this->functionData['miniCalendarWrapper'][$count_5e10163bf9f1642c4db18582599c10e8]['data'] = $data;
}
$IPBHTML .= "<div class='mini_cal_wrap ipsBox'>
	<div class='ipsBox_container'>
		...
		<table class='mini_cal vcalendar'>
			<tr>
				".$this->__f__9b9b907f9c66b2e8bf275a5bb4641bab($data)."			
				{$data['events']}
			</tr>
		</table>
	</div>
...
function __f__9b9b907f9c66b2e8bf275a5bb4641bab($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data['day_words'] as $day )
...
{
$count_3f3e60dbf5025493ee108186f77e2e0a = is_array($this->functionData['modEventsWrapper']) ? count($this->functionData['modEventsWrapper']) : 0;
$this->functionData['modEventsWrapper'][$count_3f3e60dbf5025493ee108186f77e2e0a]['events'] = $events;
$this->functionData['modEventsWrapper'][$count_3f3e60dbf5025493ee108186f77e2e0a]['pages'] = $pages;
}
...
<div class='clearfix'>
	" . ((count($events)) ? ("
		".$this->__f__e9b94d0e346a4973f1aaf7ceb000fce4($events,$pages)."	") : ("
...
function __f__e9b94d0e346a4973f1aaf7ceb000fce4($events, $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $events as $event )
...
{
$count_d9db58f9300d48b86ed8af0b6e71c079 = is_array($this->functionData['showEvent']) ? count($this->functionData['showEvent']) : 0;
$this->functionData['showEvent'][$count_d9db58f9300d48b86ed8af0b6e71c079]['event'] = $event;
$this->functionData['showEvent'][$count_d9db58f9300d48b86ed8af0b6e71c079]['member'] = $member;
$this->functionData['showEvent'][$count_d9db58f9300d48b86ed8af0b6e71c079]['typeInfo'] = $typeInfo;
$this->functionData['showEvent'][$count_d9db58f9300d48b86ed8af0b6e71c079]['like'] = $like;
}
	...
	" . (($event['event_rsvp']) ? ("<div class='ipsBox_container ipsLayout_right'>
			<div id='event_rsvp' class='ipsPad'>
				...
				" . ((count($event['_rsvp_attendees_short'])) ? ("
					...
					".$this->__f__3c39f60b097abb7347ac2fdcf01aaceb($event,$member,$typeInfo,$like)."					</ul>
				") : ("
		...
		" . (($event['_rsvp_count'] > count( $event['_rsvp_attendees_short'] )) ? ("
			<div id='see_all_attendees_popup' style='display: none'>
				...
				<div class='fixed_inner'>
					...
					".$this->__f__138caf5662fd500ec939dd9e1c9fd239($event,$member,$typeInfo,$like)."					</ul>
				</div>
			</div>
			<script type='text/javascript'>
...
function __f__3c39f60b097abb7347ac2fdcf01aaceb($event, $member, $typeInfo, $like='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__138caf5662fd500ec939dd9e1c9fd239($event, $member, $typeInfo, $like='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_139ca9ae9e431a762acd98c9013e4382 = is_array($this->functionData['showEventSimple']) ? count($this->functionData['showEventSimple']) : 0;
$this->functionData['showEventSimple'][$count_139ca9ae9e431a762acd98c9013e4382]['event'] = $event;
}
		...
		<div class='post_body'>
			...
			" . (($event['event_rsvp']) ? ("<div class='rsvp'>
					" . ((count( $event['_rsvp_attendees'] )) ? ("
						...
						<div class='clearfix'>
							".$this->__f__c81309184e29b79f9f21d364f098f385($event)."						</div>
					") : ("
...
function __f__c81309184e29b79f9f21d364f098f385($event)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
