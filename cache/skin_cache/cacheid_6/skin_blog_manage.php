...
class skin_blog_manage_6 extends skinMaster{
...
{
$count_cc619186c0eb44f072531e22f8f2af8c = is_array($this->functionData['create2']) ? count($this->functionData['create2']) : 0;
$this->functionData['create2'][$count_cc619186c0eb44f072531e22f8f2af8c]['blog'] = $blog;
$this->functionData['create2'][$count_cc619186c0eb44f072531e22f8f2af8c]['errors'] = $errors;
}
...
{
$count_6f6e6d36b73a1ec3eefb6e3a32bdc35d = is_array($this->functionData['listCategories']) ? count($this->functionData['listCategories']) : 0;
$this->functionData['listCategories'][$count_6f6e6d36b73a1ec3eefb6e3a32bdc35d]['blog'] = $blog;
}
	...
	<table class=\"ipb_table\">
		<tr class=\"header\">
			...
			<th class='col_mod'></th>
				...
				".$this->__f__d074d10b53a439f0b350bf11f405ab50($blog)."	</table>
...
</script>".$this->__f__ea431433fda4bd250a2786e2f4f7db6a($blog)."";
return $IPBHTML;
}


function __f__d074d10b53a439f0b350bf11f405ab50($blog=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__ea431433fda4bd250a2786e2f4f7db6a($blog=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $blog['_categories'] as $id => $category )
...
{
$count_f6db2db49a6d4253acdfa2ff4c21e110 = is_array($this->functionData['manageComments']) ? count($this->functionData['manageComments']) : 0;
$this->functionData['manageComments'][$count_f6db2db49a6d4253acdfa2ff4c21e110]['comments'] = $comments;
$this->functionData['manageComments'][$count_f6db2db49a6d4253acdfa2ff4c21e110]['blog'] = $blog;
$this->functionData['manageComments'][$count_f6db2db49a6d4253acdfa2ff4c21e110]['pagination'] = $pagination;
}
...
" . ((is_array( $comments ) && count( $comments )) ? ("<div class='ipsBox'>
		".$this->__f__833dea248cc7327c45151ebc054e6205($comments,$blog,$pagination)."	</div>
	" . (($this->memberData['g_blog_allowownmod']) ? ("
			<div class='bar altbar moderation_bar with_action'>
...
function __f__833dea248cc7327c45151ebc054e6205($comments, $blog, $pagination)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_cdcc08b020cf2111ae57de75409fa53f = is_array($this->functionData['manageDashboard']) ? count($this->functionData['manageDashboard']) : 0;
$this->functionData['manageDashboard'][$count_cdcc08b020cf2111ae57de75409fa53f]['myBlogs'] = $myBlogs;
$this->functionData['manageDashboard'][$count_cdcc08b020cf2111ae57de75409fa53f]['latestComments'] = $latestComments;
$this->functionData['manageDashboard'][$count_cdcc08b020cf2111ae57de75409fa53f]['error'] = $error;
$this->functionData['manageDashboard'][$count_cdcc08b020cf2111ae57de75409fa53f]['dropdown'] = $dropdown;
}
...
<div class='ipsLayout " . ((is_array( $latestComments ) && count( $latestComments )) ? ("ipsLayout_withright ipsLayout_bigright") : ("")) . " clearfix'>
		...
		<table class='ipb_table' summary=\"{$this->lang->words['your_current_blogs']}\">
			<tr class='header'>
				...
				<th scope='col' class='short' width=\"10%\">{$this->lang->words['your_blogs_comments']}</th>
						...
						".$this->__f__5a9ea61313d1a6ecbfc0234e8774ea56($myBlogs,$latestComments,$error,$dropdown)."		</table>
		<br />
	</div>
	" . ((is_array( $latestComments ) && count( $latestComments )) ? ("<div class='ipsLayout_right'>
			...
			<div class='ipsBox'>
				".$this->__f__5c6197508f87cd19e16b320565bec1b2($myBlogs,$latestComments,$error,$dropdown)."			</div>
...
function __f__5a9ea61313d1a6ecbfc0234e8774ea56($myBlogs=array(), $latestComments=array(), $error='', $dropdown='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__5c6197508f87cd19e16b320565bec1b2($myBlogs=array(), $latestComments=array(), $error='', $dropdown='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1eed964dda67feff77146acb8c99de84 = is_array($this->functionData['rssImportForm']) ? count($this->functionData['rssImportForm']) : 0;
$this->functionData['rssImportForm'][$count_1eed964dda67feff77146acb8c99de84]['blog'] = $blog;
$this->functionData['rssImportForm'][$count_1eed964dda67feff77146acb8c99de84]['data'] = $data;
$this->functionData['rssImportForm'][$count_1eed964dda67feff77146acb8c99de84]['error'] = $error;
$this->functionData['rssImportForm'][$count_1eed964dda67feff77146acb8c99de84]['tagBox'] = $tagBox;
}
				...
				<li class='ipsField ipsField_select'>
					...
					<p class='ipsField_content'>
						<select name='rss_cats[]' id='rss_cats' multiple='true' size='5'>
							" . ((is_array($data['_cats']) AND count($data['_cats'])) ? ("".$this->__f__fc344aebaefd5e9f2515cdbdd86e2092($blog,$data,$error,$tagBox)."							") : ("")) . "
						</select>
...
function __f__fc344aebaefd5e9f2515cdbdd86e2092($blog, $data, $error, $tagBox)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_b475e92e64a9014f38721ae4a76b282c = is_array($this->functionData['settingsForm']) ? count($this->functionData['settingsForm']) : 0;
$this->functionData['settingsForm'][$count_b475e92e64a9014f38721ae4a76b282c]['blog'] = $blog;
$this->functionData['settingsForm'][$count_b475e92e64a9014f38721ae4a76b282c]['error'] = $error;
}
$IPBHTML .= "<script type=\"text/javascript\">
								...
								<ul>
									...
									<li class='field' id='list_blog_view_level'>
										...
										<select class='input_select blogform' name='blog_view_level' id='blog_view_level'>
											".$this->__f__abc095799e97bbc0f77fc87b30fddff6($blog,$error)."										</select>
									</li>
								</ul>
								</fieldset>
							</td>
					...
					<tr class=\"row1\">
						<td valign=\"top\">
							...
							<fieldset>
								...
								<ul>
								".$this->__f__623c20b38dfdf37002d7c8a373f682fa($blog,$error)."								</ul>
							</fieldset>
							") : ("
...
function __f__abc095799e97bbc0f77fc87b30fddff6($blog, $error='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__623c20b38dfdf37002d7c8a373f682fa($blog, $error='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
