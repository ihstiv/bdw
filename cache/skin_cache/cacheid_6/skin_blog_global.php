...
class skin_blog_global_6 extends skinMaster{
...
{
$count_44913734d85f7afbc79783e1d8108af0 = is_array($this->functionData['blog_header']) ? count($this->functionData['blog_header']) : 0;
$this->functionData['blog_header'][$count_44913734d85f7afbc79783e1d8108af0]['blog'] = $blog;
$this->functionData['blog_header'][$count_44913734d85f7afbc79783e1d8108af0]['cblock_control'] = $cblock_control;
$this->functionData['blog_header'][$count_44913734d85f7afbc79783e1d8108af0]['theme_js'] = $theme_js;
$this->functionData['blog_header'][$count_44913734d85f7afbc79783e1d8108af0]['header_js'] = $header_js;
$this->functionData['blog_header'][$count_44913734d85f7afbc79783e1d8108af0]['title'] = $title;
$this->functionData['blog_header'][$count_44913734d85f7afbc79783e1d8108af0]['headerButtons'] = $headerButtons;
}
...
{
$count_eda910326839654b911e4f833da7c2ad = is_array($this->functionData['catsAsList']) ? count($this->functionData['catsAsList']) : 0;
$this->functionData['catsAsList'][$count_eda910326839654b911e4f833da7c2ad]['blogId'] = $blogId;
$this->functionData['catsAsList'][$count_eda910326839654b911e4f833da7c2ad]['categories'] = $categories;
}
...
$IPBHTML .= "" . ((is_array( $categories ) && count( $categories ) && !(count($categories) == 1 && array_key_exists(0, $categories))) ? ("
	...
	".$this->__f__3c7ee97c7cb6a4feaf5f384f24746d97($blogId,$categories)."") : ("")) . "";
return $IPBHTML;
}


function __f__3c7ee97c7cb6a4feaf5f384f24746d97($blogId, $categories)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
$IPBHTML .= "<ul class=\"ipbmenu_content\" id='content_blocks_menucontent' style='display: none'>
	...
	") : ("")) . "" . ((is_array( $cblocks ) && count( $cblocks )) ? ("".$this->__f__2befa84dd6a4fb14cecf75877e264763($cblocks)."	") : ("")) . "
</ul>
<script type='text/javascript'>
...
function __f__2befa84dd6a4fb14cecf75877e264763($cblocks)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_6b4dcf94e4fa3f0410dc668280497646 = is_array($this->functionData['contextSearch']) ? count($this->functionData['contextSearch']) : 0;
}
...
{
$count_fde7326308138ac87f6a47e73e585c6a = is_array($this->functionData['hookTagCloud']) ? count($this->functionData['hookTagCloud']) : 0;
$this->functionData['hookTagCloud'][$count_fde7326308138ac87f6a47e73e585c6a]['tags'] = $tags;
}
$IPBHTML .= "<ul class='ipsList_inline'>".$this->__f__62edbfdfba4c35d39cb2046be9e5b222($tags)."</ul>";
return $IPBHTML;
}


function __f__62edbfdfba4c35d39cb2046be9e5b222($tags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_b252bdddd0a685ee5a39beffe2894252 = is_array($this->functionData['overwriteHeader']) ? count($this->functionData['overwriteHeader']) : 0;
}
...
{
$count_d1ac2dd5fa0cd239f829ac89f1376b2f = is_array($this->functionData['short_img_tag']) ? count($this->functionData['short_img_tag']) : 0;
$this->functionData['short_img_tag'][$count_d1ac2dd5fa0cd239f829ac89f1376b2f]['matches'] = $matches;
}
...
{
$count_a23e5c32d83b26433a39f477c19edaf5 = is_array($this->functionData['short_media_tag']) ? count($this->functionData['short_media_tag']) : 0;
$this->functionData['short_media_tag'][$count_a23e5c32d83b26433a39f477c19edaf5]['url'] = $url;
$this->functionData['short_media_tag'][$count_a23e5c32d83b26433a39f477c19edaf5]['type'] = $type;
}
...
{
$count_362ba2cd1a1348f79e6b93d0214950b2 = is_array($this->functionData['theme_menu']) ? count($this->functionData['theme_menu']) : 0;
$this->functionData['theme_menu'][$count_362ba2cd1a1348f79e6b93d0214950b2]['themes'] = $themes;
$this->functionData['theme_menu'][$count_362ba2cd1a1348f79e6b93d0214950b2]['blog'] = $blog;
$this->functionData['theme_menu'][$count_362ba2cd1a1348f79e6b93d0214950b2]['_customTheme'] = $_customTheme;
}
$IPBHTML .= "<ul class='ipbmenu_content' id='themes_menu_menucontent' style='display: none'>
	" . (($this->settings['blog_themes_custom'] OR (is_array($themes) AND count($themes))) ? ("" . (($this->settings['blog_themes_custom']) ? ("
		...
		") : ("")) . "" . ((is_array( $themes ) && count( $themes )) ? ("".$this->__f__59e921017cdedf88b38e9f9d769c23f7($themes,$blog,$_customTheme)."		") : ("")) . "
...
function __f__59e921017cdedf88b38e9f9d769c23f7($themes, $blog, $_customTheme='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
