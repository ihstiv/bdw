...
/* CACHE FILE: Generated: Wed, 18 May 2016 17:28:39 GMT */
/* DO NOT EDIT DIRECTLY - THE CHANGES WILL NOT BE   */
/* WRITTEN TO THE DATABASE AUTOMATICALLY            */
/*--------------------------------------------------*/

class skin_blog_cblocks_6 extends skinMaster{
...
{
$count_181e3738f164c8ba921f09ea7c02f44b = is_array($this->functionData['block_activeusers']) ? count($this->functionData['block_activeusers']) : 0;
$this->functionData['block_activeusers'][$count_181e3738f164c8ba921f09ea7c02f44b]['active'] = $active;
}
...
")) . "" . ((is_array( $categories ) AND count( $categories )) ? ("".$this->__f__33606e0a8f939ad4a3bf26c4ca834e82($blogid,$categories)."	") : ("")) . "
</ul>";
return $IPBHTML;
}


function __f__33606e0a8f939ad4a3bf26c4ca834e82($blogid, $categories=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_a2570c9262c66ebd6d95467994ed255d = is_array($this->functionData['cblock_footer']) ? count($this->functionData['cblock_footer']) : 0;
$this->functionData['cblock_footer'][$count_a2570c9262c66ebd6d95467994ed255d]['cblock'] = $cblock;
$this->functionData['cblock_footer'][$count_a2570c9262c66ebd6d95467994ed255d]['auth_key'] = $auth_key;
}
$IPBHTML .= "</div>
...
{
$count_7d4c730a6799433e1feb9d18234e9ae3 = is_array($this->functionData['cblock_friends']) ? count($this->functionData['cblock_friends']) : 0;
$this->functionData['cblock_friends'][$count_7d4c730a6799433e1feb9d18234e9ae3]['friends'] = $friends;
}
$IPBHTML .= "" . ((is_array( $friends ) && count( $friends )) ? ("
	<ul class='ipsList_withminiphoto ipsPad_half'>
		".$this->__f__198bcd9ca4032a7c35c626058494f18a($friends)."	</ul>
") : ("
...
function __f__198bcd9ca4032a7c35c626058494f18a($friends=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1c91930b9c1e4219d54ae1da3dc1f024 = is_array($this->functionData['cblock_header']) ? count($this->functionData['cblock_header']) : 0;
$this->functionData['cblock_header'][$count_1c91930b9c1e4219d54ae1da3dc1f024]['cblock'] = $cblock;
$this->functionData['cblock_header'][$count_1c91930b9c1e4219d54ae1da3dc1f024]['title'] = $title;
$this->functionData['cblock_header'][$count_1c91930b9c1e4219d54ae1da3dc1f024]['configable'] = $configable;
$this->functionData['cblock_header'][$count_1c91930b9c1e4219d54ae1da3dc1f024]['nopad'] = $nopad;
}
...
{
$count_f80d7cb7c1ad0fe47c88abffb778754c = is_array($this->functionData['comments']) ? count($this->functionData['comments']) : 0;
$this->functionData['comments'][$count_f80d7cb7c1ad0fe47c88abffb778754c]['comments'] = $comments;
}
$IPBHTML .= "<ul class='ipsList_withminiphoto ipsPad_half'>
	" . ((is_array( $comments ) && count( $comments )) ? ("
		".$this->__f__9a0b32b2d4a0d9c2019b43107cfdfff9($comments)."	") : ("
...
function __f__9a0b32b2d4a0d9c2019b43107cfdfff9($comments=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_77451ba08c8728d55d0fcfb222af3e67 = is_array($this->functionData['latest_visitors']) ? count($this->functionData['latest_visitors']) : 0;
$this->functionData['latest_visitors'][$count_77451ba08c8728d55d0fcfb222af3e67]['visitors'] = $visitors;
}
$IPBHTML .= "" . ((is_array( $visitors ) && count( $visitors )) ? ("
	<ul class='ipsList_withminiphoto ipsPad_half'>
		".$this->__f__b6416ba48de258eae0eb3a272789c4af($visitors)."	</ul>
") : ("
...
function __f__b6416ba48de258eae0eb3a272789c4af($visitors=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_644fbecfb12b7954cea17c466b2c7112 = is_array($this->functionData['mini_cal_mini_wrap']) ? count($this->functionData['mini_cal_mini_wrap']) : 0;
$this->functionData['mini_cal_mini_wrap'][$count_644fbecfb12b7954cea17c466b2c7112]['content'] = $content;
$this->functionData['mini_cal_mini_wrap'][$count_644fbecfb12b7954cea17c466b2c7112]['days'] = $days;
}
$IPBHTML .= "<table class='mini_cal row1'>
	<tr class='header'>
		".$this->__f__28eb3c2c75b4941b4e9d81aa4a319595($content,$days)."	</tr>
	<tr>
		{$content}
	</tr>
</table>";
...
function __f__28eb3c2c75b4941b4e9d81aa4a319595($content="", $days)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $days as $day )
...
{
$count_870ab4eaba00f0e2571660b997d811a0 = is_array($this->functionData['recentEntries']) ? count($this->functionData['recentEntries']) : 0;
$this->functionData['recentEntries'][$count_870ab4eaba00f0e2571660b997d811a0]['entries'] = $entries;
}
$IPBHTML .= "<ul class='ipsList_withminiphoto ipsPad_half'>
	" . ((is_array( $entries ) && count( $entries )) ? ("
		".$this->__f__b6481dd9e3c300d6a6c1c2085fe7f996($entries)."	") : ("
...
function __f__b6481dd9e3c300d6a6c1c2085fe7f996($entries=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
