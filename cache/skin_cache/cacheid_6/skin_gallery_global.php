...
class skin_gallery_global_6 extends skinMaster{
...
{
$count_d4b1791199bb3c9f8ce1161689bd4730 = is_array($this->functionData['hookRecentGalleryImages']) ? count($this->functionData['hookRecentGalleryImages']) : 0;
$this->functionData['hookRecentGalleryImages'][$count_d4b1791199bb3c9f8ce1161689bd4730]['rows'] = $rows;
}
...
<div id='category_gallrecent' class='category_block block_wrap'>
	...
	<div id='appGallLatestHook' class='ipsBox table_wrap'>
		<ul class='ipsList_inline ipsList_nowrap'>
			".$this->__f__e7695a9dfe318e909d38a3ee209e1622($rows)."		</ul>
	</div>
</div>
<br />";
return $IPBHTML;
...
function __f__e7695a9dfe318e909d38a3ee209e1622($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $r )
...
{
$count_732dbafaa3d43803cd38712c575959f2 = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_732dbafaa3d43803cd38712c575959f2]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_732dbafaa3d43803cd38712c575959f2]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_732dbafaa3d43803cd38712c575959f2]['opts'] = $opts;
}
...
{
$count_c006444ebd01fc2c48ad9c71c3b5ac5f = is_array($this->functionData['listingLightbox']) ? count($this->functionData['listingLightbox']) : 0;
$this->functionData['listingLightbox'][$count_c006444ebd01fc2c48ad9c71c3b5ac5f]['loadInline'] = $loadInline;
$this->functionData['listingLightbox'][$count_c006444ebd01fc2c48ad9c71c3b5ac5f]['doAdvanced'] = $doAdvanced;
}
...
{
$count_249e4f1b3919fe7d3356597a2ed6c0c1 = is_array($this->functionData['shareLinks']) ? count($this->functionData['shareLinks']) : 0;
$this->functionData['shareLinks'][$count_249e4f1b3919fe7d3356597a2ed6c0c1]['links'] = $links;
$this->functionData['shareLinks'][$count_249e4f1b3919fe7d3356597a2ed6c0c1]['title'] = $title;
$this->functionData['shareLinks'][$count_249e4f1b3919fe7d3356597a2ed6c0c1]['url'] = $url;
$this->functionData['shareLinks'][$count_249e4f1b3919fe7d3356597a2ed6c0c1]['cssClass'] = $cssClass;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("sharelinks", "0" ) . "
" . ((is_array( $links )) ? ("
	<ul class='{$cssClass} shareButtons ipsList_inline'>
	".$this->__f__0742942eb7eff37ecf500791264a0975($links,$title,$url,$cssClass)."		" . ( method_exists( $this->registry->getClass('output')->getTemplate('gallery_global'), 'pinterestButton' ) ? $this->registry->getClass('output')->getTemplate('gallery_global')->pinterestButton($url, $title) : '' ) . "
	</ul>
	<script type=\"text/javascript\">
...
function __f__0742942eb7eff37ecf500791264a0975($links, $title='', $url='', $cssClass='topic_share left')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_51d2c01e9ec5ed609650845ab0e98009 = is_array($this->functionData['tagCloud']) ? count($this->functionData['tagCloud']) : 0;
$this->functionData['tagCloud'][$count_51d2c01e9ec5ed609650845ab0e98009]['tags'] = $tags;
}
	...
	<div class='ipsSideBlock clearfix'>
		...
		<div class='_sbcollapsable'>
			<ul class='ipsList_inline'>
				".$this->__f__9b57f19e2a348cb1c573356ecc2232d5($tags)."			</ul>
		</div>
	</div>
") : ("")) . "";
return $IPBHTML;
...
function __f__9b57f19e2a348cb1c573356ecc2232d5($tags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
