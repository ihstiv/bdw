...
class skin_global_comments_6 extends skinMaster{
...
{
$count_a5fdd0fa706461b12d4ad3def7f591df = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_a5fdd0fa706461b12d4ad3def7f591df]['r'] = $r;
$this->functionData['comment'][$count_a5fdd0fa706461b12d4ad3def7f591df]['parent'] = $parent;
$this->functionData['comment'][$count_a5fdd0fa706461b12d4ad3def7f591df]['settings'] = $settings;
}
...
{
$count_7195690719d460cef29993de5b0f6943 = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_7195690719d460cef29993de5b0f6943]['r'] = $r;
$this->functionData['commentHidden'][$count_7195690719d460cef29993de5b0f6943]['parent'] = $parent;
$this->functionData['commentHidden'][$count_7195690719d460cef29993de5b0f6943]['settings'] = $settings;
}
...
{
$count_3cef8f7576064cfe0742c5180859fc96 = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_3cef8f7576064cfe0742c5180859fc96]['comments'] = $comments;
$this->functionData['commentsList'][$count_3cef8f7576064cfe0742c5180859fc96]['settings'] = $settings;
$this->functionData['commentsList'][$count_3cef8f7576064cfe0742c5180859fc96]['pages'] = $pages;
$this->functionData['commentsList'][$count_3cef8f7576064cfe0742c5180859fc96]['parent'] = $parent;
$this->functionData['commentsList'][$count_3cef8f7576064cfe0742c5180859fc96]['preReply'] = $preReply;
}
...
<div class='ipsComment_wrap' id='comment_wrap'>
	".$this->__f__bfb387605ea45074a16287080590ef1e($comments,$settings,$pages,$parent,$preReply)."</div>
" . (($pages) ? ("
	<div class='topic_controls'>
		{$pages}
	</div>
...
function __f__bfb387605ea45074a16287080590ef1e($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_2e880f3642276e4f8f851ee5460659cd = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_2e880f3642276e4f8f851ee5460659cd]['comment'] = $comment;
$this->functionData['form'][$count_2e880f3642276e4f8f851ee5460659cd]['parent'] = $parent;
$this->functionData['form'][$count_2e880f3642276e4f8f851ee5460659cd]['editor'] = $editor;
$this->functionData['form'][$count_2e880f3642276e4f8f851ee5460659cd]['settings'] = $settings;
$this->functionData['form'][$count_2e880f3642276e4f8f851ee5460659cd]['errors'] = $errors;
$this->functionData['form'][$count_2e880f3642276e4f8f851ee5460659cd]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
