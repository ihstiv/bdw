...
class skin_calendar_5 extends skinMaster{
...
{
$count_f1634db250439aa8628a2ff5ad859dd5 = is_array($this->functionData['bbCodeEvent']) ? count($this->functionData['bbCodeEvent']) : 0;
$this->functionData['bbCodeEvent'][$count_f1634db250439aa8628a2ff5ad859dd5]['event'] = $event;
$this->functionData['bbCodeEvent'][$count_f1634db250439aa8628a2ff5ad859dd5]['type'] = $type;
$this->functionData['bbCodeEvent'][$count_f1634db250439aa8628a2ff5ad859dd5]['ends'] = $ends;
}
...
{
$count_3f726de807b3f67500db28da215400f8 = is_array($this->functionData['boardIndexBirthdays']) ? count($this->functionData['boardIndexBirthdays']) : 0;
$this->functionData['boardIndexBirthdays'][$count_3f726de807b3f67500db28da215400f8]['birthdays'] = $birthdays;
$this->functionData['boardIndexBirthdays'][$count_3f726de807b3f67500db28da215400f8]['data'] = $data;
}
		...
		<div class='_sbcollapsable'>
			" . ((count( $birthdays )) ? ("
				<ul class='ipsList_withminiphoto'>
					".$this->__f__73912bd2279e28758c8002a40551d67e($birthdays,$data)."				</ul>
			") : ("
...
function __f__73912bd2279e28758c8002a40551d67e($birthdays, $data=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_f2593d8372a8f6b718ee5b6bf9f3692c = is_array($this->functionData['boardIndexCalEvents']) ? count($this->functionData['boardIndexCalEvents']) : 0;
$this->functionData['boardIndexCalEvents'][$count_f2593d8372a8f6b718ee5b6bf9f3692c]['events'] = $events;
}
		...
		<div class='_sbcollapsable'>
			" . ((is_array( $events )) ? ("
				<ul itemscope itemtype=\"http://schema.org/Event\" class='ipsList_withminiphoto'>
					".$this->__f__fbbaf95dd6836b0bab799db442c9d2ab($events)."				</ul>
			") : ("
...
function __f__fbbaf95dd6836b0bab799db442c9d2ab($events)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_a0445aded82456ad672bf84c9b32e1a4 = is_array($this->functionData['cal_date_cell']) ? count($this->functionData['cal_date_cell']) : 0;
$this->functionData['cal_date_cell'][$count_a0445aded82456ad672bf84c9b32e1a4]['day'] = $day;
$this->functionData['cal_date_cell'][$count_a0445aded82456ad672bf84c9b32e1a4]['events'] = $events;
$this->functionData['cal_date_cell'][$count_a0445aded82456ad672bf84c9b32e1a4]['cal_date_queued'] = $cal_date_queued;
$this->functionData['cal_date_cell'][$count_a0445aded82456ad672bf84c9b32e1a4]['queued'] = $queued;
$this->functionData['cal_date_cell'][$count_a0445aded82456ad672bf84c9b32e1a4]['js_id'] = $js_id;
}
$IPBHTML .= "<!--Day-->
...
{
$count_39c957d11d8d887da05ddaa54cc35d67 = is_array($this->functionData['cal_date_cell_today']) ? count($this->functionData['cal_date_cell_today']) : 0;
$this->functionData['cal_date_cell_today'][$count_39c957d11d8d887da05ddaa54cc35d67]['day'] = $day;
$this->functionData['cal_date_cell_today'][$count_39c957d11d8d887da05ddaa54cc35d67]['events'] = $events;
$this->functionData['cal_date_cell_today'][$count_39c957d11d8d887da05ddaa54cc35d67]['cal_date_queued'] = $cal_date_queued;
$this->functionData['cal_date_cell_today'][$count_39c957d11d8d887da05ddaa54cc35d67]['queued'] = $queued;
$this->functionData['cal_date_cell_today'][$count_39c957d11d8d887da05ddaa54cc35d67]['js_id'] = $js_id;
}
$IPBHTML .= "<!--Day-->
...
{
$count_3af6fc7d90d0b3cead1fe39fff5e6fb0 = is_array($this->functionData['cal_week_dayentry']) ? count($this->functionData['cal_week_dayentry']) : 0;
$this->functionData['cal_week_dayentry'][$count_3af6fc7d90d0b3cead1fe39fff5e6fb0]['wday'] = $wday;
$this->functionData['cal_week_dayentry'][$count_3af6fc7d90d0b3cead1fe39fff5e6fb0]['date'] = $date;
$this->functionData['cal_week_dayentry'][$count_3af6fc7d90d0b3cead1fe39fff5e6fb0]['month'] = $month;
$this->functionData['cal_week_dayentry'][$count_3af6fc7d90d0b3cead1fe39fff5e6fb0]['mid'] = $mid;
$this->functionData['cal_week_dayentry'][$count_3af6fc7d90d0b3cead1fe39fff5e6fb0]['year'] = $year;
$this->functionData['cal_week_dayentry'][$count_3af6fc7d90d0b3cead1fe39fff5e6fb0]['events'] = $events;
$this->functionData['cal_week_dayentry'][$count_3af6fc7d90d0b3cead1fe39fff5e6fb0]['queued'] = $queued;
}
...
{
$count_73f27b42a1c47ba8d39d6062621db8c1 = is_array($this->functionData['calendar_likeSummaryContents']) ? count($this->functionData['calendar_likeSummaryContents']) : 0;
$this->functionData['calendar_likeSummaryContents'][$count_73f27b42a1c47ba8d39d6062621db8c1]['data'] = $data;
$this->functionData['calendar_likeSummaryContents'][$count_73f27b42a1c47ba8d39d6062621db8c1]['relId'] = $relId;
$this->functionData['calendar_likeSummaryContents'][$count_73f27b42a1c47ba8d39d6062621db8c1]['opts'] = $opts;
}
...
{
$count_664a03d267ccbb55b3691414843ca6d2 = is_array($this->functionData['calendarBirthdayList']) ? count($this->functionData['calendarBirthdayList']) : 0;
$this->functionData['calendarBirthdayList'][$count_664a03d267ccbb55b3691414843ca6d2]['rows'] = $rows;
}
$IPBHTML .= "<h2 class='ipsType_subtitle'>{$this->lang->words['celebrating_bday']}</h2>
<br />
" . ((is_array( $rows ) and count( $rows )) ? ("
	".$this->__f__04e4c12623aff9fe3538e426f12a0b75($rows)."") : ("
	<br />
...
function __f__04e4c12623aff9fe3538e426f12a0b75($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e1ad3435c3c6b95afaa25d757bdd4372 = is_array($this->functionData['calendarEventForm']) ? count($this->functionData['calendarEventForm']) : 0;
$this->functionData['calendarEventForm'][$count_e1ad3435c3c6b95afaa25d757bdd4372]['data'] = $data;
}
...
{
$count_53585f98dee4f0ed2c5dced04f9be379 = is_array($this->functionData['calendarEventsList']) ? count($this->functionData['calendarEventsList']) : 0;
$this->functionData['calendarEventsList'][$count_53585f98dee4f0ed2c5dced04f9be379]['data'] = $data;
}
...
{
$count_9694a1417c99deffd45f8c90d142a62b = is_array($this->functionData['calendarJump']) ? count($this->functionData['calendarJump']) : 0;
$this->functionData['calendarJump'][$count_9694a1417c99deffd45f8c90d142a62b]['calendars'] = $calendars;
$this->functionData['calendarJump'][$count_9694a1417c99deffd45f8c90d142a62b]['calendar'] = $calendar;
$this->functionData['calendarJump'][$count_9694a1417c99deffd45f8c90d142a62b]['chosen_date'] = $chosen_date;
}
$IPBHTML .= "" . ((is_array( $calendars ) && count( $calendars ) > 1) ? ("
	...
	<ul class='ipbmenu_content' style='display: none' id='calendar_chooser_menucontent'>
		".$this->__f__1c9c81f2ef19f741cdcf80cddc1392f6($calendars,$calendar,$chosen_date)."	</ul>
	<script type='text/javascript'>
...
function __f__1c9c81f2ef19f741cdcf80cddc1392f6($calendars, $calendar, $chosen_date=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_29e102ca6c46d7dfbcf1cae5afb17286 = is_array($this->functionData['calendarMainContent']) ? count($this->functionData['calendarMainContent']) : 0;
$this->functionData['calendarMainContent'][$count_29e102ca6c46d7dfbcf1cae5afb17286]['data'] = $data;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("calendar", "0" ) . "
<script type='text/javascript'>
	ipb.vars['month_url'] = \"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=calendar&module=calendar&section=view&cal_id={$data['calendar']['cal_id']}", "public",'' ), "", "" ) . "\";
...
<div class='ipsBox'>
	<div class='ipsBox_container'>
		<table id='calendar_table' class='ipsCalendar ipb_table vcalendar' summary=\"{$this->lang->words['calendar_for']} {$data['month_title']} {$data['chosen_date']['year']}\">
			<tr class='header'>
				".$this->__f__7473ad6cecff79f44d2054df4a96b20b($data)."				{$data['events']}
			</tr>
		</table>
	</div>
</div>
...
function __f__7473ad6cecff79f44d2054df4a96b20b($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_800096eaaf07c55a5d47d3068e184506 = is_array($this->functionData['calendarWeekView']) ? count($this->functionData['calendarWeekView']) : 0;
$this->functionData['calendarWeekView'][$count_800096eaaf07c55a5d47d3068e184506]['data'] = $data;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("calendar", "0" ) . "
<script type='text/javascript'>
	ipb.vars['month_url'] = \"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=calendar&module=calendar&section=view&cal_id={$data['calendar']['cal_id']}", "public",'' ), "", "" ) . "\";
...
{
$count_89dade5d40e5518c7d6d7f869943573b = is_array($this->functionData['calEventFollowedWrapper']) ? count($this->functionData['calEventFollowedWrapper']) : 0;
$this->functionData['calEventFollowedWrapper'][$count_89dade5d40e5518c7d6d7f869943573b]['rows'] = $rows;
}
...
$IPBHTML .= "<div id='search_results'>
	<ol>
		" . ((is_array($rows) && count($rows)) ? ("
			".$this->__f__bc652c346cc2016e35661c0b37900677($rows)."		") : ("")) . "
	</ol>
</div>";
return $IPBHTML;
}
...
function __f__bc652c346cc2016e35661c0b37900677($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_3ada53f61d2075b6c15714b26d5f8746 = is_array($this->functionData['calEventSearchResult']) ? count($this->functionData['calEventSearchResult']) : 0;
$this->functionData['calEventSearchResult'][$count_3ada53f61d2075b6c15714b26d5f8746]['r'] = $r;
$this->functionData['calEventSearchResult'][$count_3ada53f61d2075b6c15714b26d5f8746]['resultAsTitle'] = $resultAsTitle;
$this->functionData['calEventSearchResult'][$count_3ada53f61d2075b6c15714b26d5f8746]['type'] = $type;
$this->functionData['calEventSearchResult'][$count_3ada53f61d2075b6c15714b26d5f8746]['ends'] = $ends;
}
...
{
$count_8a8a602ee48f65fde609752edc6596d1 = is_array($this->functionData['event_likeSummaryContents']) ? count($this->functionData['event_likeSummaryContents']) : 0;
$this->functionData['event_likeSummaryContents'][$count_8a8a602ee48f65fde609752edc6596d1]['data'] = $data;
$this->functionData['event_likeSummaryContents'][$count_8a8a602ee48f65fde609752edc6596d1]['relId'] = $relId;
$this->functionData['event_likeSummaryContents'][$count_8a8a602ee48f65fde609752edc6596d1]['opts'] = $opts;
}
$IPBHTML .= "<span class='ipsButton_extra right " . (($data['totalCount']) ? ("_fmore clickable") : ("")) . "' title='" . sprintf( $this->lang->words['like_totalcount_' . $data['vernacular'] ], $data['totalCount'] ) . "' data-tooltip=\"" . sprintf( $this->lang->words['like_totalcount_' . $data['vernacular'] ], $data['totalCount'] ) . "\"><img src='{$this->settings['img_url']}/icon_users.png' /> <strong>{$data['totalCount']}</strong></span>
" . (($this->memberData['member_id']) ? ("<a href='#' title=\"" . (($data['iLike']) ? ("" . sprintf( $this->lang->words['fave_tt_on'], $this->lang->words['like_ucfirst_un' . $data['vernacular'] ]) . "") : ("" . sprintf( $this->lang->words['fave_tt_off'], $this->lang->words['like_ucfirst_' . $data['vernacular'] ]) . "")) . "\" class='ftoggle ipsButton_secondary'>" . (($data['iLike']) ? ("" . sprintf( $this->lang->words['unset_fave_button'], $this->lang->words['like_ucfirst_un' . $data['vernacular'] ]) . "") : ("" . sprintf( $this->lang->words['set_fave_button'], $this->lang->words['like_ucfirst_' . $data['vernacular'] ]) . "")) . "</a>") : ("")) . "";
return $IPBHTML;
...
{
$count_ddcfede84e33dd2a866a8766d7195368 = is_array($this->functionData['eventAttendee']) ? count($this->functionData['eventAttendee']) : 0;
$this->functionData['eventAttendee'][$count_ddcfede84e33dd2a866a8766d7195368]['member'] = $member;
$this->functionData['eventAttendee'][$count_ddcfede84e33dd2a866a8766d7195368]['event'] = $event;
}
...
{
$count_ae3b4cf0d70015652a506c3aa75d7cfc = is_array($this->functionData['followedContentCalendars']) ? count($this->functionData['followedContentCalendars']) : 0;
$this->functionData['followedContentCalendars'][$count_ae3b4cf0d70015652a506c3aa75d7cfc]['rows'] = $rows;
}
$IPBHTML .= "<div id='search_results'>
	<ol>
		".$this->__f__49facab1bca28baf6032e9e0386e2778($rows)."	</ol>
</div>";
return $IPBHTML;
}


function __f__49facab1bca28baf6032e9e0386e2778($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $r )
...
{
$count_8817c244abc9b92922f8cb1015e738ff = is_array($this->functionData['mini_cal_date_cell']) ? count($this->functionData['mini_cal_date_cell']) : 0;
$this->functionData['mini_cal_date_cell'][$count_8817c244abc9b92922f8cb1015e738ff]['day'] = $day;
}
$IPBHTML .= "<td>
...
{
$count_e15e1b5dcd8ff8ba5d506819a2aafc7d = is_array($this->functionData['mini_cal_date_cell_today']) ? count($this->functionData['mini_cal_date_cell_today']) : 0;
$this->functionData['mini_cal_date_cell_today'][$count_e15e1b5dcd8ff8ba5d506819a2aafc7d]['day'] = $day;
}
...
{
$count_d042e4f310325d3acf9bc0f0713b2900 = is_array($this->functionData['miniCalendarWrapper']) ? count($this->functionData['miniCalendarWrapper']) : 0;
$this->functionData['miniCalendarWrapper'][$count_d042e4f310325d3acf9bc0f0713b2900]['data'] = $data;
}
$IPBHTML .= "<div class='mini_cal_wrap ipsBox'>
	<div class='ipsBox_container'>
		...
		<table class='mini_cal vcalendar'>
			<tr>
				".$this->__f__0e7da2df0b7e67531904c1d52d8c292f($data)."			
				{$data['events']}
			</tr>
		</table>
	</div>
...
function __f__0e7da2df0b7e67531904c1d52d8c292f($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data['day_words'] as $day )
...
{
$count_9653d5ec1ea60eceaf08a34fdbedcd42 = is_array($this->functionData['modEventsWrapper']) ? count($this->functionData['modEventsWrapper']) : 0;
$this->functionData['modEventsWrapper'][$count_9653d5ec1ea60eceaf08a34fdbedcd42]['events'] = $events;
$this->functionData['modEventsWrapper'][$count_9653d5ec1ea60eceaf08a34fdbedcd42]['pages'] = $pages;
}
...
<div class='clearfix'>
	" . ((count($events)) ? ("
		".$this->__f__68d6217bfa9a18ef877c7925861ed161($events,$pages)."	") : ("
...
function __f__68d6217bfa9a18ef877c7925861ed161($events, $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $events as $event )
...
{
$count_27888c6f443bb30a06a37ed7af28e773 = is_array($this->functionData['showEvent']) ? count($this->functionData['showEvent']) : 0;
$this->functionData['showEvent'][$count_27888c6f443bb30a06a37ed7af28e773]['event'] = $event;
$this->functionData['showEvent'][$count_27888c6f443bb30a06a37ed7af28e773]['member'] = $member;
$this->functionData['showEvent'][$count_27888c6f443bb30a06a37ed7af28e773]['typeInfo'] = $typeInfo;
$this->functionData['showEvent'][$count_27888c6f443bb30a06a37ed7af28e773]['like'] = $like;
}
	...
	" . (($event['event_rsvp']) ? ("<div class='ipsBox_container ipsLayout_right'>
			<div id='event_rsvp' class='ipsPad'>
				...
				" . ((count($event['_rsvp_attendees_short'])) ? ("
					...
					".$this->__f__c508cd3334d1a03847e758a9c7685cad($event,$member,$typeInfo,$like)."					</ul>
				") : ("
		...
		" . (($event['_rsvp_count'] > count( $event['_rsvp_attendees_short'] )) ? ("
			<div id='see_all_attendees_popup' style='display: none'>
				...
				<div class='fixed_inner'>
					...
					".$this->__f__e3c0f318ddc854b4bd7fe436cbf9d18c($event,$member,$typeInfo,$like)."					</ul>
				</div>
			</div>
			<script type='text/javascript'>
...
function __f__c508cd3334d1a03847e758a9c7685cad($event, $member, $typeInfo, $like='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e3c0f318ddc854b4bd7fe436cbf9d18c($event, $member, $typeInfo, $like='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_35aeb286ef7321428e42dc2b319453ab = is_array($this->functionData['showEventSimple']) ? count($this->functionData['showEventSimple']) : 0;
$this->functionData['showEventSimple'][$count_35aeb286ef7321428e42dc2b319453ab]['event'] = $event;
}
		...
		<div class='post_body'>
			...
			" . (($event['event_rsvp']) ? ("<div class='rsvp'>
					" . ((count( $event['_rsvp_attendees'] )) ? ("
						...
						<div class='clearfix'>
							".$this->__f__bc6da2462401b83ab0947494f90f7175($event)."						</div>
					") : ("
...
function __f__bc6da2462401b83ab0947494f90f7175($event)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
