...
class skin_blog_show_5 extends skinMaster{
...
{
$count_e092808617ca44ebceb9774a4d740c1f = is_array($this->functionData['blogArchive']) ? count($this->functionData['blogArchive']) : 0;
$this->functionData['blogArchive'][$count_e092808617ca44ebceb9774a4d740c1f]['blog'] = $blog;
$this->functionData['blogArchive'][$count_e092808617ca44ebceb9774a4d740c1f]['links'] = $links;
$this->functionData['blogArchive'][$count_e092808617ca44ebceb9774a4d740c1f]['entries'] = $entries;
$this->functionData['blogArchive'][$count_e092808617ca44ebceb9774a4d740c1f]['cb_left_html'] = $cb_left_html;
$this->functionData['blogArchive'][$count_e092808617ca44ebceb9774a4d740c1f]['cb_right_html'] = $cb_right_html;
$this->functionData['blogArchive'][$count_e092808617ca44ebceb9774a4d740c1f]['followData'] = $followData;
}
	...
	<div id='main_column'>
		...
		" . ((is_array( $entries ) && count( $entries )) ? ("
			<table class='ipb_table'>
								".$this->__f__6077205e775bb7e80bcd72ded97208cb($blog,$links,$entries,$cb_left_html,$cb_right_html,$followData)."			</table>
...
function __f__6077205e775bb7e80bcd72ded97208cb($blog, $links, $entries=array(), $cb_left_html="", $cb_right_html="", $followData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_645f7fccb7d0358f91a0cac411852f1a = is_array($this->functionData['blogEntryView']) ? count($this->functionData['blogEntryView']) : 0;
$this->functionData['blogEntryView'][$count_645f7fccb7d0358f91a0cac411852f1a]['blog'] = $blog;
$this->functionData['blogEntryView'][$count_645f7fccb7d0358f91a0cac411852f1a]['comments_html'] = $comments_html;
$this->functionData['blogEntryView'][$count_645f7fccb7d0358f91a0cac411852f1a]['header'] = $header;
$this->functionData['blogEntryView'][$count_645f7fccb7d0358f91a0cac411852f1a]['entry'] = $entry;
$this->functionData['blogEntryView'][$count_645f7fccb7d0358f91a0cac411852f1a]['poll_html'] = $poll_html;
$this->functionData['blogEntryView'][$count_645f7fccb7d0358f91a0cac411852f1a]['trackbacks_html'] = $trackbacks_html;
$this->functionData['blogEntryView'][$count_645f7fccb7d0358f91a0cac411852f1a]['links'] = $links;
$this->functionData['blogEntryView'][$count_645f7fccb7d0358f91a0cac411852f1a]['cblocks'] = $cblocks;
$this->functionData['blogEntryView'][$count_645f7fccb7d0358f91a0cac411852f1a]['follow'] = $follow;
$this->functionData['blogEntryView'][$count_645f7fccb7d0358f91a0cac411852f1a]['tags'] = $tags;
}
				...
				<div class='entry" . (($entry['entry_status'] != 'published') ? (" moderated") : ("")) . "" . (($entry['hide_private']) ? (" private") : ("")) . "' id='entry_{$entry['entry_id']}'>
					<div class='entry_header row2 ipsPad_half'>
						...
						" . (($this->settings['blog_enable_rating']) ? ("" . (($blog['_allow_rating']) ? ("
							...
							") : ("")) . "
							".$this->__f__da8e2e25ba6f357dbfdb273ee6b4aac5($blog,$comments_html,$header,$entry,$poll_html,$trackbacks_html,$links,$cblocks,$follow,$tags)."							<span id='rating_text'>
...
function __f__da8e2e25ba6f357dbfdb273ee6b4aac5($blog, $comments_html, $header, $entry, $poll_html, $trackbacks_html, $links, $cblocks, $follow, $tags=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_9664e9b349979eeacb97bd2cbb95d453 = is_array($this->functionData['blogView']) ? count($this->functionData['blogView']) : 0;
$this->functionData['blogView'][$count_9664e9b349979eeacb97bd2cbb95d453]['blog'] = $blog;
$this->functionData['blogView'][$count_9664e9b349979eeacb97bd2cbb95d453]['links'] = $links;
$this->functionData['blogView'][$count_9664e9b349979eeacb97bd2cbb95d453]['entries'] = $entries;
$this->functionData['blogView'][$count_9664e9b349979eeacb97bd2cbb95d453]['dates'] = $dates;
$this->functionData['blogView'][$count_9664e9b349979eeacb97bd2cbb95d453]['cblocks'] = $cblocks;
$this->functionData['blogView'][$count_9664e9b349979eeacb97bd2cbb95d453]['followData'] = $followData;
}
	...
	<div id='main_column'>
		...
		" . ((!is_array($entries) || !count($entries)) ? ("<p class='no_messages ipsType_subtitle short'>
				" . (($this->request['cat'] OR $this->request['tag']) ? ("{$this->lang->words['no_entry_matches']}") : ("{$blog['blog_name']} {$this->lang->words['no_entries_yet']}")) . "
						...
						<div class='ipsBox'>
				".$this->__f__49cc35e75c76a05e52c01d29ad6b09cd($blog,$links,$entries,$dates,$cblocks,$followData)."				<br class='clear' />
			</div>
		")) . "
		<br />
		<!-- Pagination -->
...
function __f__49cc35e75c76a05e52c01d29ad6b09cd($blog, $links, $entries=array(), $dates=array(), $cblocks=array(), $followData="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $entries as $entry )
...
{
$count_b1d77482187580dc23d56dfcdec831e4 = is_array($this->functionData['entryAlbum']) ? count($this->functionData['entryAlbum']) : 0;
$this->functionData['entryAlbum'][$count_b1d77482187580dc23d56dfcdec831e4]['album'] = $album;
$this->functionData['entryAlbum'][$count_b1d77482187580dc23d56dfcdec831e4]['album_id'] = $album_id;
}
$IPBHTML .= "<div id='attach_wrap' class='rounded clearfix'>
	<ul>
		".$this->__f__ecca00deb69e8fe0672674ae839d5455($album,$album_id)."	</ul>
</div>
<br />";
return $IPBHTML;
}
...
function __f__ecca00deb69e8fe0672674ae839d5455($album="",$album_id)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_9cf3ea92896c6e1bae0ab51be677a6a9 = is_array($this->functionData['entryTrackbacks']) ? count($this->functionData['entryTrackbacks']) : 0;
$this->functionData['entryTrackbacks'][$count_9cf3ea92896c6e1bae0ab51be677a6a9]['entry_id'] = $entry_id;
$this->functionData['entryTrackbacks'][$count_9cf3ea92896c6e1bae0ab51be677a6a9]['rows'] = $rows;
}
...
" . ((is_array( $rows ) && count( $rows )) ? ("
	<div id='trackbacks'>
				".$this->__f__b9ee9a6a2e444d20b791cf6440588988($entry_id,$rows)."	</div>
") : ("
...
function __f__b9ee9a6a2e444d20b791cf6440588988($entry_id="",$rows=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_44182be390ddebccce19b057254c7f44 = is_array($this->functionData['pollDisplay']) ? count($this->functionData['pollDisplay']) : 0;
$this->functionData['pollDisplay'][$count_44182be390ddebccce19b057254c7f44]['poll'] = $poll;
$this->functionData['pollDisplay'][$count_44182be390ddebccce19b057254c7f44]['entry'] = $entry;
$this->functionData['pollDisplay'][$count_44182be390ddebccce19b057254c7f44]['pollData'] = $pollData;
$this->functionData['pollDisplay'][$count_44182be390ddebccce19b057254c7f44]['showResults'] = $showResults;
}
$IPBHTML .= "<script type='text/javascript'>
...
<div class='general_box alt poll' id='poll_{$poll['pid']}'>
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=blog&amp;module=actions&amp;section=dovote&amp;eid={$entry['entry_id']}&amp;blogid={$this->request['blogid']}&amp;st={$this->request['st']}&amp;auth_key={$this->member->form_hash}", "public",'' ), "", "" ) . "\" method=\"post\">
		...
		") : ("")) . "
		".$this->__f__db1a2edb69457763931d1ec8d355eca5($poll,$entry,$pollData,$showResults)."		" . ((!$entry['entry_locked']) ? ("<fieldset class='submit'>
...
function __f__a87f973d9a0a8440445ff7933262936b($poll, $entry, $pollData, $showResults,$questionID='',$questionData='',$choiceID='',$choiceData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__301cd9ad04f0e5071e218350bec37d9c($poll, $entry, $pollData, $showResults,$questionID='',$questionData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
							...
							" . (($showResults) ? ("<li>
									...
									" . (($poll['poll_view_voters'] AND is_array( $choiceData['voters'] ) AND $this->settings['poll_allow_public'] AND $choiceData['votes']) ? ("
										<script type='text/javascript'>
											...
											".$this->__f__a87f973d9a0a8440445ff7933262936b($poll,$entry,$pollData,$showResults,$questionID,$questionData,$choiceID,$choiceData)."											ipb.topic.poll[ $questionID ][ $choiceID ] = { name: \"{$choiceData['choice']}\", users: users};
										</script>
									") : ("")) . "
...
function __f__db1a2edb69457763931d1ec8d355eca5($poll, $entry, $pollData, $showResults)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $pollData as $questionID => $questionData )
	{
		...
		$_ips___x_retval .= "
			<div class='poll_question" . (($showResults) ? (" voted") : ("")) . "'>
				...
				") : ("
					<ol>
						".$this->__f__301cd9ad04f0e5071e218350bec37d9c($poll,$entry,$pollData,$showResults,$questionID,$questionData)."					</ol>
				")) . "
			</div>
...
{
$count_3035e1cc8ae63ff2c0438df5dd0b6bd5 = is_array($this->functionData['show_attachment_title']) ? count($this->functionData['show_attachment_title']) : 0;
$this->functionData['show_attachment_title'][$count_3035e1cc8ae63ff2c0438df5dd0b6bd5]['title'] = $title;
$this->functionData['show_attachment_title'][$count_3035e1cc8ae63ff2c0438df5dd0b6bd5]['data'] = $data;
$this->functionData['show_attachment_title'][$count_3035e1cc8ae63ff2c0438df5dd0b6bd5]['type'] = $type;
}
$IPBHTML .= "<div id='attach_wrap' class='rounded clearfix'>
	<h4>{$title}</h4>
	<ul>
		".$this->__f__4f4f735d926a7fda5073a320ff440e70($title,$data,$type)."	</ul>
</div>";
return $IPBHTML;
}


function __f__4f4f735d926a7fda5073a320ff440e70($title="",$data="",$type="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
