...
class skin_blog_manage_5 extends skinMaster{
...
{
$count_985b85ea1ee1ed41e9da3c26aa53c3a3 = is_array($this->functionData['create2']) ? count($this->functionData['create2']) : 0;
$this->functionData['create2'][$count_985b85ea1ee1ed41e9da3c26aa53c3a3]['blog'] = $blog;
$this->functionData['create2'][$count_985b85ea1ee1ed41e9da3c26aa53c3a3]['errors'] = $errors;
}
...
{
$count_bc08f7bf75c7f58caba1bb3dbdb10738 = is_array($this->functionData['listCategories']) ? count($this->functionData['listCategories']) : 0;
$this->functionData['listCategories'][$count_bc08f7bf75c7f58caba1bb3dbdb10738]['blog'] = $blog;
}
	...
	<table class=\"ipb_table\">
		<tr class=\"header\">
			...
			<th class='col_mod'></th>
				...
				".$this->__f__d9c779dfde19800f676bb34182990baa($blog)."	</table>
...
</script>".$this->__f__dafea4669b9a63bf9a5af526d5605e31($blog)."";
return $IPBHTML;
}


function __f__d9c779dfde19800f676bb34182990baa($blog=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__dafea4669b9a63bf9a5af526d5605e31($blog=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $blog['_categories'] as $id => $category )
...
{
$count_772180c666b2df85048f46a55f5392f3 = is_array($this->functionData['manageComments']) ? count($this->functionData['manageComments']) : 0;
$this->functionData['manageComments'][$count_772180c666b2df85048f46a55f5392f3]['comments'] = $comments;
$this->functionData['manageComments'][$count_772180c666b2df85048f46a55f5392f3]['blog'] = $blog;
$this->functionData['manageComments'][$count_772180c666b2df85048f46a55f5392f3]['pagination'] = $pagination;
}
...
" . ((is_array( $comments ) && count( $comments )) ? ("<div class='ipsBox'>
		".$this->__f__3466d5b8bbf1c242abaeb33752df6286($comments,$blog,$pagination)."	</div>
	" . (($this->memberData['g_blog_allowownmod']) ? ("
			<div class='bar altbar moderation_bar with_action'>
...
function __f__3466d5b8bbf1c242abaeb33752df6286($comments, $blog, $pagination)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e0014eaff0238935dde44e5802bc8ac2 = is_array($this->functionData['manageDashboard']) ? count($this->functionData['manageDashboard']) : 0;
$this->functionData['manageDashboard'][$count_e0014eaff0238935dde44e5802bc8ac2]['myBlogs'] = $myBlogs;
$this->functionData['manageDashboard'][$count_e0014eaff0238935dde44e5802bc8ac2]['latestComments'] = $latestComments;
$this->functionData['manageDashboard'][$count_e0014eaff0238935dde44e5802bc8ac2]['error'] = $error;
$this->functionData['manageDashboard'][$count_e0014eaff0238935dde44e5802bc8ac2]['dropdown'] = $dropdown;
}
...
<div class='ipsLayout " . ((is_array( $latestComments ) && count( $latestComments )) ? ("ipsLayout_withright ipsLayout_bigright") : ("")) . " clearfix'>
		...
		<table class='ipb_table' summary=\"{$this->lang->words['your_current_blogs']}\">
			<tr class='header'>
				...
				<th scope='col' class='short' width=\"10%\">{$this->lang->words['your_blogs_comments']}</th>
						...
						".$this->__f__da0d8b10d1b44ae7f8b1d78acb548cf4($myBlogs,$latestComments,$error,$dropdown)."		</table>
		<br />
	</div>
	" . ((is_array( $latestComments ) && count( $latestComments )) ? ("<div class='ipsLayout_right'>
			...
			<div class='ipsBox'>
				".$this->__f__a2e126ea3679442f303cd8720fd4e4f4($myBlogs,$latestComments,$error,$dropdown)."			</div>
...
function __f__da0d8b10d1b44ae7f8b1d78acb548cf4($myBlogs=array(), $latestComments=array(), $error='', $dropdown='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a2e126ea3679442f303cd8720fd4e4f4($myBlogs=array(), $latestComments=array(), $error='', $dropdown='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_9b3de2dd8e5412c502c8d92ac463ccd3 = is_array($this->functionData['rssImportForm']) ? count($this->functionData['rssImportForm']) : 0;
$this->functionData['rssImportForm'][$count_9b3de2dd8e5412c502c8d92ac463ccd3]['blog'] = $blog;
$this->functionData['rssImportForm'][$count_9b3de2dd8e5412c502c8d92ac463ccd3]['data'] = $data;
$this->functionData['rssImportForm'][$count_9b3de2dd8e5412c502c8d92ac463ccd3]['error'] = $error;
$this->functionData['rssImportForm'][$count_9b3de2dd8e5412c502c8d92ac463ccd3]['tagBox'] = $tagBox;
}
				...
				<li class='ipsField ipsField_select'>
					...
					<p class='ipsField_content'>
						<select name='rss_cats[]' id='rss_cats' multiple='true' size='5'>
							" . ((is_array($data['_cats']) AND count($data['_cats'])) ? ("".$this->__f__fc01c23b2b9e35a06fa5aa50b29a0e7f($blog,$data,$error,$tagBox)."							") : ("")) . "
						</select>
...
function __f__fc01c23b2b9e35a06fa5aa50b29a0e7f($blog, $data, $error, $tagBox)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_c327b8e03feb916cde9b882c310f5cb4 = is_array($this->functionData['settingsForm']) ? count($this->functionData['settingsForm']) : 0;
$this->functionData['settingsForm'][$count_c327b8e03feb916cde9b882c310f5cb4]['blog'] = $blog;
$this->functionData['settingsForm'][$count_c327b8e03feb916cde9b882c310f5cb4]['error'] = $error;
}
$IPBHTML .= "<script type=\"text/javascript\">
								...
								<ul>
									...
									<li class='field' id='list_blog_view_level'>
										...
										<select class='input_select blogform' name='blog_view_level' id='blog_view_level'>
											".$this->__f__df2e0167f973163c39bb27cd1e843679($blog,$error)."										</select>
									</li>
								</ul>
								</fieldset>
							</td>
					...
					<tr class=\"row1\">
						<td valign=\"top\">
							...
							<fieldset>
								...
								<ul>
								".$this->__f__c703bf5c58a1c94c49bcaa0f1da4a85f($blog,$error)."								</ul>
							</fieldset>
							") : ("
...
function __f__df2e0167f973163c39bb27cd1e843679($blog, $error='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__c703bf5c58a1c94c49bcaa0f1da4a85f($blog, $error='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
