...
{
$count_0fa0ca27625bca3f17622fa5e63c044c = is_array($this->functionData['boardIndexTemplate']) ? count($this->functionData['boardIndexTemplate']) : 0;
$this->functionData['boardIndexTemplate'][$count_0fa0ca27625bca3f17622fa5e63c044c]['lastvisit'] = $lastvisit;
$this->functionData['boardIndexTemplate'][$count_0fa0ca27625bca3f17622fa5e63c044c]['stats'] = $stats;
$this->functionData['boardIndexTemplate'][$count_0fa0ca27625bca3f17622fa5e63c044c]['cat_data'] = $cat_data;
$this->functionData['boardIndexTemplate'][$count_0fa0ca27625bca3f17622fa5e63c044c]['show_side_blocks'] = $show_side_blocks;
$this->functionData['boardIndexTemplate'][$count_0fa0ca27625bca3f17622fa5e63c044c]['side_blocks'] = $side_blocks;
}
...
$this->templateVars['sidebar_disabled'] = "$show_side_blocks";
$this->__default__templateVars['sidebar_disabled'] = "$show_side_blocks";
...
<div id='board_index' class='ipsLayout " . (($this->templateVars['sidebar_enabled']) ? ("ipsLayout_withright") : ("")) . " ipsLayout_largeright clearfix " . ((IPSCookie::get('hide_sidebar') == '1') ? ("no_sidebar") : ("")) . "'>	
	...
	<!-- CATS AND FORUMS -->
		" . ((is_array( $cat_data ) AND count( $cat_data )) ? ("
			".$this->__f__9ed6d48ebb70cb7c78a66b35a71675f6($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks)."		") : ("")) . "
	</div>
	" . (($this->templateVars['sidebar_enabled']) ? ("<div id='index_stats' class='ipsLayout_right clearfix' " . ((IPSCookie::get('hide_sidebar') == '1') ? ("style='display: none'") : ("")) . ">
			".$this->__f__b53c0e294834a6692f4946bf79094c05($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks)."		</div>
...
//<![CDATA[
	...
	" . ((is_array( $cat_data ) AND count( $cat_data )) ? ("
		".$this->__f__22f47c66bca3378075f84a6b4dbe7eb6($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks)."	") : ("")) . "
//]]>
</script>
...
function __f__83f7f58a5ebd81fb1651028f1f6f9400($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array(),$_data='',$forum_id='',$forum_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__16261ec8c734d8748f97cf7b3c620d01($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array(),$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
												...
												<td class='col_c_forum'>
													...
													" . (($forum_data['show_subforums'] AND count( $forum_data['subforums'] ) AND $forum_data['show_subforums']) ? ("
														...
														<ol class='subforums' id='subforums_{$forum_data['id']}'>
															".$this->__f__83f7f58a5ebd81fb1651028f1f6f9400($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks,$_data,$forum_id,$forum_data)."														</ol>
													") : ("")) . "
...
function __f__9ed6d48ebb70cb7c78a66b35a71675f6($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
						...
						<div class='ipsBox table_wrap'>
							<div class='ipsBox_container'>
								<table class='ipb_table' summary=\"{$this->lang->words['forums_in_cat']} '{$_data['cat_data']['name']}'\">
									...
									<!-- / CAT HEADER -->
									".$this->__f__16261ec8c734d8748f97cf7b3c620d01($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks,$_data)."								</table>
							</div>
						</div>
						<br />
					</div>") : ("")) . "
...
function __f__b53c0e294834a6692f4946bf79094c05($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array())
{
...
function __f__b10096cd66d13bc831b23e3d3e7c2ff2($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array(),$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $_data['forum_data'] as $forum_id => $forum_data )
...
function __f__22f47c66bca3378075f84a6b4dbe7eb6($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $cat_data as $_data )
	{
		...
		$_ips___x_retval .= "
			" . ((is_array( $_data['forum_data'] ) AND count( $_data['forum_data'] )) ? ("
				".$this->__f__b10096cd66d13bc831b23e3d3e7c2ff2($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks,$_data)."			") : ("")) . "
...
{
$count_376becda19003fdb05bcc257c72b5091 = is_array($this->functionData['hookFacebookActivity']) ? count($this->functionData['hookFacebookActivity']) : 0;
}
...
{
$count_59bb82d17fd2ab36828a63dea05f7f35 = is_array($this->functionData['hookRecentTopics']) ? count($this->functionData['hookRecentTopics']) : 0;
$this->functionData['hookRecentTopics'][$count_59bb82d17fd2ab36828a63dea05f7f35]['topics'] = $topics;
}
...
<div class='ipsSideBlock clearfix'>
	...
	<div class='_sbcollapsable'>
		...
		".$this->__f__1d8bd02b9691bc51d04dbf9e0ed7469f($topics)."		</ul>
	</div>
</div>
") : ("")) . "";
return $IPBHTML;
...
function __f__1d8bd02b9691bc51d04dbf9e0ed7469f($topics)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $topics as $r )
...
{
$count_345c64074c3920b099ef218f48d6e63b = is_array($this->functionData['hookTagCloud']) ? count($this->functionData['hookTagCloud']) : 0;
$this->functionData['hookTagCloud'][$count_345c64074c3920b099ef218f48d6e63b]['tags'] = $tags;
}
$IPBHTML .= "<div class='ipsSideBlock clearfix'>
	<h3>{$this->lang->words['popular_tags']}</h3>
	<div class='_sbcollapsable'>
		<ul class='ipsList_inline'>
		".$this->__f__c075d0330b1ef9a912548821517d7243($tags)."		</ul>
	</div>
</div>";
return $IPBHTML;
}
...
function __f__c075d0330b1ef9a912548821517d7243($tags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
$IPBHTML .= "" . ((is_array($topics) && count($topics)) ? ("
		<div class ='ipsSideBlock clearfix'>
			<h3>{$this->settings['poptop_title']}</h3>
			<div class='_sbcollapsible'>			
				<ul class='ipsList_withminiphoto'>
					".$this->__f__fa639d2990a2e6dc05ac50563de782f3($topics)."				</ul>
			</div>
		</div> 
	") : ("")) . "";
return $IPBHTML;
...
function __f__fa639d2990a2e6dc05ac50563de782f3($topics)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $topics as $topic )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
						" . (($this->settings['poptop_compact']) ? ("<li class='clearfix'>
								<a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "showtopic={$topic['tid']}", "public",'' ), "{$topic['title_seo']}", "showtopic" ) . "\" rel='bookmark' class='ipsType_small' title='" . strip_tags($topic['topic_title']) . " {$this->lang->words['topic_started_on']} " . IPSText::htmlspecialchars($this->registry->getClass('class_localization')->getDate($topic['start_date'],"LONG", 0)) . "'>{$topic['topic_title']}</a>" . (($this->settings['poptop_count']) ? (" - ({$topic['stuff']})") : ("")) . "
							</li>") : ("<li class='clearfix'>
			                                        " . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'userSmallPhoto' ) ? $this->registry->getClass('output')->getTemplate('global')->userSmallPhoto($topic) : '' ) . "
			                                        <div class='list_content'>
			                                                <a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "showtopic={$topic['tid']}", "public",'' ), "{$topic['title_seo']}", "showtopic" ) . "\" rel='bookmark' class='ipsType_small' title='" . strip_tags($topic['topic_title']) . " {$this->lang->words['topic_started_on']} " . IPSText::htmlspecialchars($this->registry->getClass('class_localization')->getDate($topic['start_date'],"LONG", 0)) . "'>{$topic['topic_title']}</a>" . (($this->settings['poptop_count']) ? (" - ({$topic['stuff']})") : ("")) . "
			                                                <p class='desc ipsType_smaller'>
			                                                        " . (($topic['members_display_name']) ? ("" . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'userHoverCard' ) ? $this->registry->getClass('output')->getTemplate('global')->userHoverCard($topic) : '' ) . "") : ("{$this->settings['guest_name_pre']}{$topic['starter_name']}{$this->settings['guest_name_suf']}")) . "
			                                                        - " . IPSText::htmlspecialchars($this->registry->getClass('class_localization')->getDate($topic['start_date'],"short", 0)) . "
			                                                </p>
			                                        </div>
			                                </li>")) . "
...
{
$count_580b3d7ca2331392608f152eb20be29d = is_array($this->functionData['statusReplies']) ? count($this->functionData['statusReplies']) : 0;
$this->functionData['statusReplies'][$count_580b3d7ca2331392608f152eb20be29d]['replies'] = $replies;
}
$IPBHTML .= "".$this->__f__54f2db866c19878cf5349c3482eeabcb($replies)."";
return $IPBHTML;
}


function __f__54f2db866c19878cf5349c3482eeabcb($replies=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_45c5670f2e03221c95304cdf57890618 = is_array($this->functionData['statusUpdates']) ? count($this->functionData['statusUpdates']) : 0;
$this->functionData['statusUpdates'][$count_45c5670f2e03221c95304cdf57890618]['updates'] = $updates;
$this->functionData['statusUpdates'][$count_45c5670f2e03221c95304cdf57890618]['smallSpace'] = $smallSpace;
$this->functionData['statusUpdates'][$count_45c5670f2e03221c95304cdf57890618]['latestOnly'] = $latestOnly;
}
...
</script>".$this->__f__a0c9857a9a11f3c32aa27949261eed35($updates,$smallSpace,$latestOnly)."";
return $IPBHTML;
}


function __f__a0c9857a9a11f3c32aa27949261eed35($updates=array(), $smallSpace=0, $latestOnly=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
