...
class skin_ucp_5 extends skinMaster{
...
$this->_funcHooks['membersFacebookConnect'] = array('fbShowStatus','fbSyncPic','fbSyncStatus','canUpdateStatus','fbSyncStatus','statusImportGroup','fbLastSync','pImgE','pImgPS','pImgRS','fbPassword','fbMissingPerms','fbDefaultEmail','fbMismatch');
...
{
$count_ac50aedc7bbebf355644448fe051b300 = is_array($this->functionData['coreAttachments']) ? count($this->functionData['coreAttachments']) : 0;
$this->functionData['coreAttachments'][$count_ac50aedc7bbebf355644448fe051b300]['info'] = $info;
$this->functionData['coreAttachments'][$count_ac50aedc7bbebf355644448fe051b300]['pages'] = $pages;
$this->functionData['coreAttachments'][$count_ac50aedc7bbebf355644448fe051b300]['attachments'] = $attachments;
}
...
<div class='row1'>	
	...
	<table class='ipb_table' summary=\"{$this->lang->words['ucp_user_attach']}\">
		<tr class='header'>
			...
			" . ((count($attachments)) ? ("
								".$this->__f__76b82f8ef01394997a9c1004f7b44fe0($info,$pages,$attachments)."			") : ("
				<tr>
...
function __f__76b82f8ef01394997a9c1004f7b44fe0($info="",$pages="",$attachments)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_067fabf06d7128393fc1e81d9c9377a0 = is_array($this->functionData['displayNameForm']) ? count($this->functionData['displayNameForm']) : 0;
$this->functionData['displayNameForm'][$count_067fabf06d7128393fc1e81d9c9377a0]['form'] = $form;
$this->functionData['displayNameForm'][$count_067fabf06d7128393fc1e81d9c9377a0]['error'] = $error;
$this->functionData['displayNameForm'][$count_067fabf06d7128393fc1e81d9c9377a0]['okmessage'] = $okmessage;
$this->functionData['displayNameForm'][$count_067fabf06d7128393fc1e81d9c9377a0]['isFB'] = $isFB;
}
$IPBHTML .= "" . (($okmessage != "") ? ("
...
{
$count_daab41a4ee9af63ac694f7c55006cf57 = is_array($this->functionData['emailPasswordChangeForm']) ? count($this->functionData['emailPasswordChangeForm']) : 0;
$this->functionData['emailPasswordChangeForm'][$count_daab41a4ee9af63ac694f7c55006cf57]['txt'] = $txt;
$this->functionData['emailPasswordChangeForm'][$count_daab41a4ee9af63ac694f7c55006cf57]['_message'] = $_message;
$this->functionData['emailPasswordChangeForm'][$count_daab41a4ee9af63ac694f7c55006cf57]['isFB'] = $isFB;
}
...
{
$count_5d9d3499962c83f3c8e82933cd3b0cda = is_array($this->functionData['field_entry']) ? count($this->functionData['field_entry']) : 0;
$this->functionData['field_entry'][$count_5d9d3499962c83f3c8e82933cd3b0cda]['title'] = $title;
$this->functionData['field_entry'][$count_5d9d3499962c83f3c8e82933cd3b0cda]['desc'] = $desc;
$this->functionData['field_entry'][$count_5d9d3499962c83f3c8e82933cd3b0cda]['content'] = $content;
$this->functionData['field_entry'][$count_5d9d3499962c83f3c8e82933cd3b0cda]['id'] = $id;
}
...
function membersFacebookConnect($fbuid, $fbUserData, $linkedMemberData, $perms, $missingPerms=FALSE) {
$IPBHTML = "";
if( IPSLib::locationHasHooks( 'skin_ucp', $this->_funcHooks['membersFacebookConnect'] ) )
{
$count_cea75be54c45045d90d1faa977a7a7c2 = is_array($this->functionData['membersFacebookConnect']) ? count($this->functionData['membersFacebookConnect']) : 0;
$this->functionData['membersFacebookConnect'][$count_cea75be54c45045d90d1faa977a7a7c2]['fbuid'] = $fbuid;
$this->functionData['membersFacebookConnect'][$count_cea75be54c45045d90d1faa977a7a7c2]['fbUserData'] = $fbUserData;
$this->functionData['membersFacebookConnect'][$count_cea75be54c45045d90d1faa977a7a7c2]['linkedMemberData'] = $linkedMemberData;
$this->functionData['membersFacebookConnect'][$count_cea75be54c45045d90d1faa977a7a7c2]['perms'] = $perms;
$this->functionData['membersFacebookConnect'][$count_cea75be54c45045d90d1faa977a7a7c2]['missingPerms'] = $missingPerms;
}
	...
	") : ("<div>
			...
			<fieldset class='row1'>
				...
				<ul>
					...
					" . (($this->memberData['can_updated_status'] AND $perms['publish_actions']['data'][0]['status'] == 'granted') ? ("<li class='field checkbox'>
					...
					" . ((! $this->memberData['gbw_no_status_import'] AND $perms['user_status']['data'][0]['status'] == 'granted') ? ("<li class='field checkbox'>
			...
			<fieldset class='row1'>
				...
				<ul>
					<li class='field checkbox'>
						<img src=\"{$this->settings['img_url']}/" . (($perms['email']['data'][0]['status'] == 'granted') ? ("accept.png") : ("cross.png")) . "\" style='vertical-align:top' alt='' />&nbsp;{$this->lang->words['fbp_email_access']}
						<p class='desc' style='left:0px'>{$this->lang->words['fbp_email_access_desc']}</p>
					</li>
					<li class='field checkbox'>
						<img src=\"{$this->settings['img_url']}/" . (($perms['publish_actions']['data'][0]['status'] == 'granted') ? ("accept.png") : ("cross.png")) . "\" style='vertical-align:top' alt='' />&nbsp;{$this->lang->words['fbp_publish_stream']}
						<p class='desc' style='left:0px'>{$this->lang->words['fbp_publish_stream_desc']}</p>
					</li>
					<li class='field checkbox'>
						<img src=\"{$this->settings['img_url']}/" . (($perms['user_status']['data'][0]['status'] == 'granted') ? ("accept.png") : ("cross.png")) . "\" style='vertical-align:top' alt='' />&nbsp;{$this->lang->words['fbp_read_stream']}
...
{
$count_829790eb3feab617e60ef324278a5a2e = is_array($this->functionData['membersIgnoredUsersForm']) ? count($this->functionData['membersIgnoredUsersForm']) : 0;
$this->functionData['membersIgnoredUsersForm'][$count_829790eb3feab617e60ef324278a5a2e]['members'] = $members;
$this->functionData['membersIgnoredUsersForm'][$count_829790eb3feab617e60ef324278a5a2e]['pagination'] = $pagination;
}
...
<table class='ipb_table' summary=\"{$this->lang->words['ucp_ignored_users']}\">
	<tr class='header'>
		...
		" . ((count( $members )) ? ("".$this->__f__b30c4bf6b2f12d9a8acb84690a8d1576($members,$pagination)."	") : ("<tr>
...
function __f__b30c4bf6b2f12d9a8acb84690a8d1576($members, $pagination)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
			...
			<tr class='" .  IPSLib::next( $this->registry->templateStriping["members"] ) . "'>
				...
				<td class='short'>
					...
					") : ("" . (($member['ignoreData']['ignore_signatures'] == 1) ? ("
							<a class='ipsButton_secondary' href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=usercp&amp;tab=core&amp;area=toggleIgnoredUser&amp;do=saveIt&amp;id={$member['member_id']}&amp;field=signatures&amp;st={$this->request['st']}", "public",'' ), "", "" ) . "\" title=\"{$this->lang->words['click_toggle']}\"><span style='color:red'>{$this->lang->words['ucp_hide_disallow']}</span></a>
						") : ("
							<a class='ipsButton_secondary' href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=usercp&amp;tab=core&amp;area=toggleIgnoredUser&amp;do=saveIt&amp;id={$member['member_id']}&amp;field=signatures&amp;st={$this->request['st']}", "public",'' ), "", "" ) . "\" title=\"{$this->lang->words['click_toggle']}\"><span style='color:green'>{$this->lang->words['ucp_hide_allow']}</span></a>
						")) . "")) . "
				</td>
				<td class='short'>
					" . (($member['ignoreData']['ignore_messages'] == 1) ? ("
						<a class='ipsButton_secondary' href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=usercp&amp;tab=core&amp;area=toggleIgnoredUser&amp;do=saveIt&amp;id={$member['member_id']}&amp;field=messages&amp;st={$this->request['st']}", "public",'' ), "", "" ) . "\" title=\"{$this->lang->words['click_toggle']}\"><span style='color:red'>{$this->lang->words['ucp_hide_disallow_msg']}</span></a>
					") : ("
				...
				" . ((IPSLib::appIsInstalled('ipchat')) ? ("<td class='short'>
						" . (($member['ignoreData']['ignore_chats'] == 1) ? ("
							<a class='ipsButton_secondary' href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=usercp&amp;tab=core&amp;area=toggleIgnoredUser&amp;do=saveIt&amp;id={$member['member_id']}&amp;field=chats&amp;st={$this->request['st']}", "public",'' ), "", "" ) . "\" title=\"{$this->lang->words['click_toggle']}\"><span style='color:red'>{$this->lang->words['ucp_hide_disallow_msg']}</span></a>
						") : ("
							<a class='ipsButton_secondary' href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=usercp&amp;tab=core&amp;area=toggleIgnoredUser&amp;do=saveIt&amp;id={$member['member_id']}&amp;field=chats&amp;st={$this->request['st']}", "public",'' ), "", "" ) . "\" title=\"{$this->lang->words['click_toggle']}\"><span style='color:green'>{$this->lang->words['ucp_hide_allow_msg']}</span></a>
						")) . "
					</td>") : ("")) . "
...
" . (($input['_preview']) ? ("<fieldset class='ipsSettings_section'>
		...
		<div>
			<div style='width:98%; height: 100px; background-image:url(\"{$input['_preview']}?nc={$this->memberData['pp_profile_update']}\");" . ((!$options['bg_tile']) ? ("background-repeat:no-repeat") : ("")) . "'>&nbsp;</div>
		</div>
	</fieldset>") : ("")) . "
...
{
$count_44f5967038265b3c7d9408b5da45aac2 = is_array($this->functionData['membersProfileForm']) ? count($this->functionData['membersProfileForm']) : 0;
$this->functionData['membersProfileForm'][$count_44f5967038265b3c7d9408b5da45aac2]['custom_fields'] = $custom_fields;
$this->functionData['membersProfileForm'][$count_44f5967038265b3c7d9408b5da45aac2]['group_titles'] = $group_titles;
$this->functionData['membersProfileForm'][$count_44f5967038265b3c7d9408b5da45aac2]['day'] = $day;
$this->functionData['membersProfileForm'][$count_44f5967038265b3c7d9408b5da45aac2]['mon'] = $mon;
$this->functionData['membersProfileForm'][$count_44f5967038265b3c7d9408b5da45aac2]['year'] = $year;
$this->functionData['membersProfileForm'][$count_44f5967038265b3c7d9408b5da45aac2]['amEditor'] = $amEditor;
$this->functionData['membersProfileForm'][$count_44f5967038265b3c7d9408b5da45aac2]['times'] = $times;
}
		...
		<div>
			<ul class='ipsForm ipsForm_horizontal'>
				<li class='ipsField'>
					...
					".$this->__f__12fe65170a573394f47d856393c7fb5e($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times)."					</select><br />
				...
				" . (($day AND $mon AND $year) ? ("
					...
					<ul>
						<li>
							...
							<select name=\"month\">&nbsp;
								".$this->__f__4691a38d99df554d75d3bb4fc302c13d($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times)."							</select>			
							<select name=\"day\">&nbsp;
								".$this->__f__8edbd29be029c2b8414ee776e654e12a($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times)."							</select> 
							<select name=\"year\">&nbsp;
								".$this->__f__e75dab8200dae3e4e5f88431b3345058($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times)."							</select> <br />
							<span class='desc'>{$this->lang->words['ucp_birthday_optional']}</span>
						</li>
					</ul>
				") : ("")) . "<!--hook.if.skin_ucp.membersProfileForm.birthdayFields.post.endif-->
			</div>
		</fieldset>") : ("")) . "
	
	" . ((count( $custom_fields )) ? ("".$this->__f__e2c0952cc9c0f873991741beb28ba58e($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times)."	") : ("")) . "
...
function __f__12fe65170a573394f47d856393c7fb5e($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__4691a38d99df554d75d3bb4fc302c13d($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $mon as $m )
...
function __f__8edbd29be029c2b8414ee776e654e12a($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $day as $d )
...
function __f__e75dab8200dae3e4e5f88431b3345058($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $year as $y )
...
function __f__5ad2eb823f364a075f8a75d9d8818966($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array(),$cgroup='',$cfields='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e2c0952cc9c0f873991741beb28ba58e($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		$_ips___x_retval .= "
			" . ((count( $cfields )) ? ("
				<fieldset class='ipsSettings_section'>
					...
					<div>
						<ul>
							".$this->__f__5ad2eb823f364a075f8a75d9d8818966($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times,$cgroup,$cfields)."						</ul>
					</div>
				</fieldset>
			") : ("")) . "
...
{
$count_76f0bb718470b55f3dda1efd5982f757 = is_array($this->functionData['membersSignatureForm']) ? count($this->functionData['membersSignatureForm']) : 0;
$this->functionData['membersSignatureForm'][$count_76f0bb718470b55f3dda1efd5982f757]['editor_html'] = $editor_html;
$this->functionData['membersSignatureForm'][$count_76f0bb718470b55f3dda1efd5982f757]['sig_restrictions'] = $sig_restrictions;
$this->functionData['membersSignatureForm'][$count_76f0bb718470b55f3dda1efd5982f757]['signature'] = $signature;
}
...
<input type='hidden' name='removeattachid' value='0' /><fieldset class='" .  IPSLib::next( $this->registry->templateStriping["usercp"] ) . "'>
	...
	<div>
		{$editor_html}
		" . (($this->memberData['g_dohtml']) ? ("<p class='ipsPad_top_bottom'>
			<input type=\"checkbox\" name=\"sig_htmlstatus\" class=\"input_check\" value=\"1\" id='sig_htmlstatus' " . (($this->memberData['bw_html_sig']) ? ("checked='checked'") : ("")) . " />
...
{
$count_4f6613f77f12b680eca16023bc3b7b83 = is_array($this->functionData['membersTwitterConnect']) ? count($this->functionData['membersTwitterConnect']) : 0;
$this->functionData['membersTwitterConnect'][$count_4f6613f77f12b680eca16023bc3b7b83]['isConnected'] = $isConnected;
$this->functionData['membersTwitterConnect'][$count_4f6613f77f12b680eca16023bc3b7b83]['twitterUser'] = $twitterUser;
}
	...
	<div class='right row2 ipsPad clearfix' style='width: 250px'>
		<span class='ipsType_smaller'>
			...
			" . (($this->memberData['tc_lastsync']) ? ("
				" . IPSText::htmlspecialchars($this->registry->getClass('class_localization')->getDate($this->memberData['tc_lastsync'],"long", 0)) . "
			") : ("
				{$this->lang->words['fb_never']}
			")) . "
		</span>
...
{
$count_773cdc52e87a64f57cc7de03c3b37f26 = is_array($this->functionData['notificationsForm']) ? count($this->functionData['notificationsForm']) : 0;
$this->functionData['notificationsForm'][$count_773cdc52e87a64f57cc7de03c3b37f26]['config'] = $config;
$this->functionData['notificationsForm'][$count_773cdc52e87a64f57cc7de03c3b37f26]['emailData'] = $emailData;
}
...
<fieldset class='row1'>
	<span class='desc'><strong>{$this->lang->words['notifications_info_acp']}</strong></span>
		...
		".$this->__f__708ad22413bd45b0bbe42a1996cb1c42($config,$emailData)."		".$this->__f__a4341c56e27c35e1af09c95038269a13($config,$emailData)."	</table>
</fieldset>";
return $IPBHTML;
}


function __f__b6c1d20bf555cc1570363c573f8d4a89($config, $emailData,$groupKey='',$group='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__708ad22413bd45b0bbe42a1996cb1c42($config, $emailData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $this->notifyGroups as $groupKey => $group )
	{
		...
		$_ips___x_retval .= "
			...
			".$this->__f__b6c1d20bf555cc1570363c573f8d4a89($config,$emailData,$groupKey,$group)."							
...
function __f__a4341c56e27c35e1af09c95038269a13($config, $emailData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_d5c00796cf0c6fcb5be98e3a5d934c10 = is_array($this->functionData['notificationsLog']) ? count($this->functionData['notificationsLog']) : 0;
$this->functionData['notificationsLog'][$count_d5c00796cf0c6fcb5be98e3a5d934c10]['notifications'] = $notifications;
$this->functionData['notificationsLog'][$count_d5c00796cf0c6fcb5be98e3a5d934c10]['error'] = $error;
$this->functionData['notificationsLog'][$count_d5c00796cf0c6fcb5be98e3a5d934c10]['pages'] = $pages;
}
...
<div id='notificationlog'>
		...
		<table class='ipb_table' summary=\"{$this->lang->words['notifications_table_head']}\">
			<tr class='header hide'>
				...
				<th scope='col' align=\"center\" width=\"5%\" class='short'>&nbsp;</th>
						...
						".$this->__f__2a80831af84fcc529086112135f3d5f8($notifications,$error,$pages)."		</table>
		<script type='text/javascript'>
	...
	" . ((count($notifications)) ? ("
		<br />
		<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=usercp&amp;area=markNotification&amp;do=mark&amp;mark=all&amp;k={$this->member->form_hash}", "public",'' ), "", "" ) . "' id='ack_pm_notification' class='input_submit left'>{$this->lang->words['notificationlog_mar']}</a>
...
function __f__2a80831af84fcc529086112135f3d5f8($notifications, $error='', $pages='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
<p class='message' style='text-align: center'>
	{$this->lang->words['email_unsubscribed']}
</p>
<br /><br />";
return $IPBHTML;
}
...
{
$count_82f0f946621a3181b18c7bfb20dd9bfc = is_array($this->functionData['userCPTemplate']) ? count($this->functionData['userCPTemplate']) : 0;
$this->functionData['userCPTemplate'][$count_82f0f946621a3181b18c7bfb20dd9bfc]['current_tab'] = $current_tab;
$this->functionData['userCPTemplate'][$count_82f0f946621a3181b18c7bfb20dd9bfc]['html'] = $html;
$this->functionData['userCPTemplate'][$count_82f0f946621a3181b18c7bfb20dd9bfc]['tabs'] = $tabs;
$this->functionData['userCPTemplate'][$count_82f0f946621a3181b18c7bfb20dd9bfc]['current_area'] = $current_area;
$this->functionData['userCPTemplate'][$count_82f0f946621a3181b18c7bfb20dd9bfc]['errors'] = $errors;
$this->functionData['userCPTemplate'][$count_82f0f946621a3181b18c7bfb20dd9bfc]['hide_form'] = $hide_form;
$this->functionData['userCPTemplate'][$count_82f0f946621a3181b18c7bfb20dd9bfc]['maxUpload'] = $maxUpload;
}
...
" . ((count($tabs) > 1) ? ("
	<div class='maintitle ipsFilterbar clearfix'>
		<ul class='ipsList_inline'>
			".$this->__f__6be26e7422c2c99882d29f909f363d5d($current_tab,$html,$tabs,$current_area,$errors,$hide_form,$maxUpload)."		</ul>
	</div>
") : ("")) . "
<div class='ipsBox'>
	<div class='ipsLayout" . (($hasMoreTabs) ? (" ipsLayout_withleft ipsLayout_smallleft ipsVerticalTabbed") : ("")) . " clearfix usercp_body'>
		" . (($hasMoreTabs) ? ("
			<div class='ipsVerticalTabbed_tabs ipsLayout_left' id='usercp_tabs'>
				<ul>
					".$this->__f__47c8d07f424311ba63a72d4f111aafd8($current_tab,$html,$tabs,$current_area,$errors,$hide_form,$maxUpload)."				</ul>
			</div>
		") : ("")) . "
		<div class='" . (($hasMoreTabs) ? ("ipsVerticalTabbed_content ") : ("")) . "ipsLayout_content ipsBox_container' id='usercp_content'>
			<div class='ipsPad'>
				" . ((is_array( $errors ) AND count( $errors )) ? ("
					<p class='message error'>
						".$this->__f__4de9ebed92800cc873b727d30689dd8a($current_tab,$html,$tabs,$current_area,$errors,$hide_form,$maxUpload)."					</p>
					<br />
				") : ("")) . "
...
function __f__6be26e7422c2c99882d29f909f363d5d($current_tab, $html, $tabs, $current_area, $errors=array(), $hide_form=0, $maxUpload=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__47c8d07f424311ba63a72d4f111aafd8($current_tab, $html, $tabs, $current_area, $errors=array(), $hide_form=0, $maxUpload=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__4de9ebed92800cc873b727d30689dd8a($current_tab, $html, $tabs, $current_area, $errors=array(), $hide_form=0, $maxUpload=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
