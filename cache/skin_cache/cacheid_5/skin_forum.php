...
{
$count_681ba3566206b4d6c0baeb4bb37af6cd = is_array($this->functionData['forumAttachments']) ? count($this->functionData['forumAttachments']) : 0;
$this->functionData['forumAttachments'][$count_681ba3566206b4d6c0baeb4bb37af6cd]['title'] = $title;
$this->functionData['forumAttachments'][$count_681ba3566206b4d6c0baeb4bb37af6cd]['rows'] = $rows;
$this->functionData['forumAttachments'][$count_681ba3566206b4d6c0baeb4bb37af6cd]['pages'] = $pages;
}
...
<table class='ipb_table'>
	<tr class='header'>
		...
		" . ((count($rows)) ? ("".$this->__f__eac0c11b815636860f0ce102d98fefb4($title,$rows,$pages)."	") : ("")) . "
</table>
" . (($pages) ? ("
	<br />
	<div class='topic_controls'>{$pages}</div>
...
function __f__eac0c11b815636860f0ce102d98fefb4($title, $rows, $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_a5293edbde6e420331b7bc5abc95d5bd = is_array($this->functionData['forumIndexTemplate']) ? count($this->functionData['forumIndexTemplate']) : 0;
$this->functionData['forumIndexTemplate'][$count_a5293edbde6e420331b7bc5abc95d5bd]['forum_data'] = $forum_data;
$this->functionData['forumIndexTemplate'][$count_a5293edbde6e420331b7bc5abc95d5bd]['announce_data'] = $announce_data;
$this->functionData['forumIndexTemplate'][$count_a5293edbde6e420331b7bc5abc95d5bd]['topic_data'] = $topic_data;
$this->functionData['forumIndexTemplate'][$count_a5293edbde6e420331b7bc5abc95d5bd]['other_data'] = $other_data;
$this->functionData['forumIndexTemplate'][$count_a5293edbde6e420331b7bc5abc95d5bd]['multi_mod_data'] = $multi_mod_data;
$this->functionData['forumIndexTemplate'][$count_a5293edbde6e420331b7bc5abc95d5bd]['sub_forum_data'] = $sub_forum_data;
$this->functionData['forumIndexTemplate'][$count_a5293edbde6e420331b7bc5abc95d5bd]['footer_filter'] = $footer_filter;
$this->functionData['forumIndexTemplate'][$count_a5293edbde6e420331b7bc5abc95d5bd]['active_user_data'] = $active_user_data;
$this->functionData['forumIndexTemplate'][$count_a5293edbde6e420331b7bc5abc95d5bd]['mod_data'] = $mod_data;
$this->functionData['forumIndexTemplate'][$count_a5293edbde6e420331b7bc5abc95d5bd]['inforum'] = $inforum;
}
...
" . $this->registry->getClass('output')->addJSModule("forums", "0" ) . "
...
" . ((is_array( $announce_data ) AND count( $announce_data )) ? ("
	<table class='ipb_table topic_list hover_rows' summary='{$this->lang->words['forum_topic_list']} \"{$forum_data['name']}\"' id='announcements'>
		".$this->__f__10fb1b2a179f60f3aa9f628e74bceff9($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."	</table>
	<br />
") : ("")) . "
<!-- __-SUBFORUMS-__ -->
		...
		<div class='ipsBox table_wrap'>
			<div class='ipsBox_container'>
				<table class='ipb_table' summary=\"{$this->lang->words['cat_subforums']} '{$forum_data['name']}'\">
					".$this->__f__593731b0fb25659c9fe6db628308ac92($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."				</table>
			</div>
		</div>
	</div>
	<br /><br />
		...
		<div class='ipsBox_container'>
			<table class='ipb_table topic_list hover_rows " . (($this->memberData['is_mod'] == 1) ? ("is_mod") : ("")) . "' summary='{$this->lang->words['forum_topic_list']} \"{$forum_data['name']}\"' id='forum_table'>
				...
				" . ((is_array( $topic_data ) AND count( $topic_data )) ? ("
					".$this->__f__a159b891bfc70a28fe0956ae21094f24($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."				") : ("<tr> 
						" . (($this->memberData['is_mod'] == 1) ? ("
	...
	<div id='forum_footer' class='statistics clear clearfix'>
		" . ((is_array( $mod_data ) AND count( $mod_data )) ? ("
			<div id='forum_led_by' class='right ipsType_small'>
				...
				".$this->__f__07d40e7c5fab6ef8fa25a8e9439c7f37($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."			</div>
		") : ("")) . "
...
" . ((is_array( $multi_mod_data ) AND count( $multi_mod_data )) ? ("
	".$this->__f__e0e186b35ba1b9a757098924613d6317($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."") : ("")) . "
</select>
...
function __f__10fb1b2a179f60f3aa9f628e74bceff9($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e3a0e15573a72bc5935740c822fd6032($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1,$_data='',$forum_id='',$forum_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__8bf2e8e22e8eef1ef9b58b943adc25bc($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1,$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
										...
										<td class='col_c_forum'>
											...
											" . (($forum_data['show_subforums'] AND count( $forum_data['subforums'] ) AND $forum_data['show_subforums']) ? ("
												...
												<ol class='ipsList_inline ipsType_small subforums' id='subforums_{$forum_data['id']}'>
													".$this->__f__e3a0e15573a72bc5935740c822fd6032($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum,$_data,$forum_id,$forum_data)."												</ol>
											") : ("")) . "
											...
											") : ("" . (($forum_data['_hide_last_date']) ? ("
												...
												<ul class='last_post ipsType_small'>
													...
													") : ("<li>{$forum_data['last_topic_title']}</li>
														<!--hook.if.skin_forum.forumIndexTemplate.lastPosterID.pre.startif-->" . (($forum_data['last_poster_id']) ? ("
...
function __f__593731b0fb25659c9fe6db628308ac92($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $sub_forum_data as $_data )
	{
		...
		$_ips___x_retval .= "
						" . ((is_array( $_data['forum_data'] ) AND count( $_data['forum_data'] )) ? ("
							".$this->__f__8bf2e8e22e8eef1ef9b58b943adc25bc($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum,$_data)."						") : ("")) . "
...
function __f__a159b891bfc70a28fe0956ae21094f24($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__07d40e7c5fab6ef8fa25a8e9439c7f37($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e0e186b35ba1b9a757098924613d6317($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_909ffa3aa4aeae92d3459994138a43f7 = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_909ffa3aa4aeae92d3459994138a43f7]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_909ffa3aa4aeae92d3459994138a43f7]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_909ffa3aa4aeae92d3459994138a43f7]['opts'] = $opts;
}
...
{
$count_6620361bbc3436905d3f9e5ac14dd49e = is_array($this->functionData['topic']) ? count($this->functionData['topic']) : 0;
$this->functionData['topic'][$count_6620361bbc3436905d3f9e5ac14dd49e]['data'] = $data;
$this->functionData['topic'][$count_6620361bbc3436905d3f9e5ac14dd49e]['forum_data'] = $forum_data;
$this->functionData['topic'][$count_6620361bbc3436905d3f9e5ac14dd49e]['other_data'] = $other_data;
$this->functionData['topic'][$count_6620361bbc3436905d3f9e5ac14dd49e]['inforum'] = $inforum;
}
$IPBHTML .= "" . ((($this->memberData['is_mod'] AND ! $data['approved']) OR $data['_isDeleted']) ? ("<tr" . (($inforum) ? (" itemscope itemtype=\"http://schema.org/Article\"") : ("")) . " class='__topic " . ((!$data['folder_img']['is_read']) ? ("unread") : ("")) . " expandable moderated' id='trow_{$data['_tid']}' data-tid=\"{$data['_tid']}\">") : ("<tr" . (($inforum) ? (" itemscope itemtype=\"http://schema.org/Article\"") : ("")) . " class='__topic " . ((!$data['folder_img']['is_read']) ? ("unread") : ("")) . " expandable' id='trow_{$data['_tid']}' data-tid=\"{$data['_tid']}\">")) . "
	...
	<td class='col_f_content " . (($this->memberData['is_mod'] == 1 || $forum_data['permissions']['TopicSoftDelete']) ? (" with_mod_links") : ("")) . "'>
		...
		") : ("")) . "
		" . ((! $inforum && $data['nav']) ? ("
			".$this->__f__9d7da82ebdd72d5682aeb938bb588e7d($data,$forum_data,$other_data,$inforum)."		") : ("")) . "
		{$data['prefix']}
		<h4>
		...
		<span class='desc lighter blend_links'>
			...
			<!--hook.if.skin_forum.topic.hasTags.pre.startif-->" . ((isset($data['tags']) AND $data['tags']) ? ("
		...
		" . ((isset( $data['pages'] ) AND is_array( $data['pages'] ) AND count( $data['pages'] )) ? ("
			...
			".$this->__f__51b47ec7488d7f2e3cdef4fd1a9a9f5c($data,$forum_data,$other_data,$inforum)."			</ul>
		") : ("")) . "
	</td>
...
function __f__9d7da82ebdd72d5682aeb938bb588e7d($data, $forum_data, $other_data, $inforum)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__51b47ec7488d7f2e3cdef4fd1a9a9f5c($data, $forum_data, $other_data, $inforum)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_09635d87bcd606b004d0ef51b0fb3150 = is_array($this->functionData['topic_rating_image']) ? count($this->functionData['topic_rating_image']) : 0;
$this->functionData['topic_rating_image'][$count_09635d87bcd606b004d0ef51b0fb3150]['rating_id'] = $rating_id;
}
$IPBHTML .= "<span class='mini_rate'>".$this->__f__33932c6548b5a29dff0cea7e39ce7a16($rating_id)."</span>";
return $IPBHTML;
}


function __f__33932c6548b5a29dff0cea7e39ce7a16($rating_id=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_317ad91b0c998f9d40752628a4065fac = is_array($this->functionData['topicPrefixWrap']) ? count($this->functionData['topicPrefixWrap']) : 0;
$this->functionData['topicPrefixWrap'][$count_317ad91b0c998f9d40752628a4065fac]['text'] = $text;
}
$IPBHTML .= "" . (($text) ? ("
