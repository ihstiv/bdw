...
class skin_global_comments_5 extends skinMaster{
...
{
$count_2e0ae2ceab18a067a70b3fa7e5afe26f = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_2e0ae2ceab18a067a70b3fa7e5afe26f]['r'] = $r;
$this->functionData['comment'][$count_2e0ae2ceab18a067a70b3fa7e5afe26f]['parent'] = $parent;
$this->functionData['comment'][$count_2e0ae2ceab18a067a70b3fa7e5afe26f]['settings'] = $settings;
}
...
{
$count_cc092f4b5cbca143c27d8e61bb2d6325 = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_cc092f4b5cbca143c27d8e61bb2d6325]['r'] = $r;
$this->functionData['commentHidden'][$count_cc092f4b5cbca143c27d8e61bb2d6325]['parent'] = $parent;
$this->functionData['commentHidden'][$count_cc092f4b5cbca143c27d8e61bb2d6325]['settings'] = $settings;
}
...
{
$count_b8928417eaf792866371ea8ae2ed8b0e = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_b8928417eaf792866371ea8ae2ed8b0e]['comments'] = $comments;
$this->functionData['commentsList'][$count_b8928417eaf792866371ea8ae2ed8b0e]['settings'] = $settings;
$this->functionData['commentsList'][$count_b8928417eaf792866371ea8ae2ed8b0e]['pages'] = $pages;
$this->functionData['commentsList'][$count_b8928417eaf792866371ea8ae2ed8b0e]['parent'] = $parent;
$this->functionData['commentsList'][$count_b8928417eaf792866371ea8ae2ed8b0e]['preReply'] = $preReply;
}
...
<div class='ipsComment_wrap' id='comment_wrap'>
	".$this->__f__d95871c4c4e454bea3b7ba68280ee3c9($comments,$settings,$pages,$parent,$preReply)."</div>
" . (($pages) ? ("
	<div class='topic_controls'>
		{$pages}
	</div>
...
function __f__d95871c4c4e454bea3b7ba68280ee3c9($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_7ab5c82be467ccf1fb29fd0bd7bdcd47 = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_7ab5c82be467ccf1fb29fd0bd7bdcd47]['comment'] = $comment;
$this->functionData['form'][$count_7ab5c82be467ccf1fb29fd0bd7bdcd47]['parent'] = $parent;
$this->functionData['form'][$count_7ab5c82be467ccf1fb29fd0bd7bdcd47]['editor'] = $editor;
$this->functionData['form'][$count_7ab5c82be467ccf1fb29fd0bd7bdcd47]['settings'] = $settings;
$this->functionData['form'][$count_7ab5c82be467ccf1fb29fd0bd7bdcd47]['errors'] = $errors;
$this->functionData['form'][$count_7ab5c82be467ccf1fb29fd0bd7bdcd47]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
