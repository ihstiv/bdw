...
{
$count_368a9d3005a91eb2f403f7556508aacb = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_368a9d3005a91eb2f403f7556508aacb]['data'] = $data;
}
...
{
$count_5346b51d29523608b289dbe8b491c24c = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_5346b51d29523608b289dbe8b491c24c]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_5346b51d29523608b289dbe8b491c24c]['form'] = $form;
}
...
{
$count_205cb1a2c990d2644612860f226f265f = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_205cb1a2c990d2644612860f226f265f]['data'] = $data;
}
...
{
$count_c9c92c58ac1fef8af6d1516686e0f1f6 = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_c9c92c58ac1fef8af6d1516686e0f1f6]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__79609bfc4939a8926630764b2eb4b5ad($posts)."") : ("")) . "
<p class='submit'>
...
function __f__79609bfc4939a8926630764b2eb4b5ad($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_b59b33cb9945d6d3d8ef007b4c3f46a1 = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_b59b33cb9945d6d3d8ef007b4c3f46a1]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_b59b33cb9945d6d3d8ef007b4c3f46a1]['type'] = $type;
$this->functionData['uploadForm'][$count_b59b33cb9945d6d3d8ef007b4c3f46a1]['stats'] = $stats;
$this->functionData['uploadForm'][$count_b59b33cb9945d6d3d8ef007b4c3f46a1]['id'] = $id;
$this->functionData['uploadForm'][$count_b59b33cb9945d6d3d8ef007b4c3f46a1]['forum_id'] = $forum_id;
}
