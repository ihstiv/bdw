...
class skin_online_5 extends skinMaster{
...
{
$count_842cc94819d409eb3858f7f767c2fd9d = is_array($this->functionData['showOnlineList']) ? count($this->functionData['showOnlineList']) : 0;
$this->functionData['showOnlineList'][$count_842cc94819d409eb3858f7f767c2fd9d]['rows'] = $rows;
$this->functionData['showOnlineList'][$count_842cc94819d409eb3858f7f767c2fd9d]['links'] = $links;
$this->functionData['showOnlineList'][$count_842cc94819d409eb3858f7f767c2fd9d]['defaults'] = $defaults;
}
...
<div class='ipsBox'>
	<div class='ipsBox_container'>
		<table class='ipb_table ipsMemberList' summary=\"{$this->lang->words['users_online']}\">
			...
			" . ((count($rows)) ? ("
								".$this->__f__8135ff416fbd01c7e045cec0d248b002($rows,$links,$defaults)."			") : ("")) . "
		</table>
	</div>
</div>
<div id='forum_filter' class='ipsForm_center ipsPad'>
	<form method=\"post\" action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=members&amp;section=online&amp;module=online", "public",'' ), "", "" ) . "\">
		...
		<select name=\"sort_key\" id='sort_key' class='input_select'>
			".$this->__f__4dabbe38ec8121a6e5f4accab7df505a($rows,$links,$defaults)."		</select>
		<select name=\"show_mem\" class='input_select'>
			".$this->__f__cfd342f7140c99ade8c08e8f9f78389a($rows,$links,$defaults)."		</select>
		<select name=\"sort_order\" class='input_select'>
			".$this->__f__23fafefdb782415bcf462422d44fcd84($rows,$links,$defaults)."		</select>
...
function __f__8135ff416fbd01c7e045cec0d248b002($rows, $links="", $defaults=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $session )
	{
		...
		$_ips___x_retval .= "
					<tr class='" .  IPSLib::next( $this->registry->templateStriping["online"] ) . "'>
						...
						<td>
							<!--hook.if.skin_online.showOnlineList.nowhere.pre.startif-->" . ((!$session['where_line'] || $session['in_error']) ? ("
...
function __f__4dabbe38ec8121a6e5f4accab7df505a($rows, $links="", $defaults=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__cfd342f7140c99ade8c08e8f9f78389a($rows, $links="", $defaults=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__23fafefdb782415bcf462422d44fcd84($rows, $links="", $defaults=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
