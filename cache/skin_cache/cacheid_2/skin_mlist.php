...
{
$count_66afc3acd5507edbe144d29101241385 = is_array($this->functionData['member_list_show']) ? count($this->functionData['member_list_show']) : 0;
$this->functionData['member_list_show'][$count_66afc3acd5507edbe144d29101241385]['members'] = $members;
$this->functionData['member_list_show'][$count_66afc3acd5507edbe144d29101241385]['pages'] = $pages;
$this->functionData['member_list_show'][$count_66afc3acd5507edbe144d29101241385]['dropdowns'] = $dropdowns;
$this->functionData['member_list_show'][$count_66afc3acd5507edbe144d29101241385]['defaults'] = $defaults;
$this->functionData['member_list_show'][$count_66afc3acd5507edbe144d29101241385]['custom_fields'] = $custom_fields;
$this->functionData['member_list_show'][$count_66afc3acd5507edbe144d29101241385]['url'] = $url;
}
...
<div id=\"filter-letters\">
		".$this->__f__305e3b915c7ba2e329fd8a0fa37be269($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."</div>
</div>
	" . ((is_array( $members ) and count( $members )) ? ("
				".$this->__f__43751db87a844f8df740c380e06524b3($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."	") : ("
...
function __f__305e3b915c7ba2e329fd8a0fa37be269($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__43751db87a844f8df740c380e06524b3($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
