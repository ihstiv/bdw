...
{
$count_c1d7283e2f241de45dc168e9b6383850 = is_array($this->functionData['completePartialLogin']) ? count($this->functionData['completePartialLogin']) : 0;
$this->functionData['completePartialLogin'][$count_c1d7283e2f241de45dc168e9b6383850]['mid'] = $mid;
$this->functionData['completePartialLogin'][$count_c1d7283e2f241de45dc168e9b6383850]['key'] = $key;
$this->functionData['completePartialLogin'][$count_c1d7283e2f241de45dc168e9b6383850]['custom_fields'] = $custom_fields;
$this->functionData['completePartialLogin'][$count_c1d7283e2f241de45dc168e9b6383850]['errors'] = $errors;
$this->functionData['completePartialLogin'][$count_c1d7283e2f241de45dc168e9b6383850]['reg'] = $reg;
$this->functionData['completePartialLogin'][$count_c1d7283e2f241de45dc168e9b6383850]['userFromService'] = $userFromService;
}
	...
	<div class='post_form'>
		...
		" . (($custom_fields != '') ? ("<fieldset class='row1'>
				...
				" . ((is_array( $custom_fields['required'] ) && count( $custom_fields['required'] )) ? ("
					".$this->__f__0e5c26303f0dd2be71073641435dccb4($mid,$key,$custom_fields,$errors,$reg,$userFromService)."				") : ("")) . "
				
				" . ((is_array( $custom_fields['optional'] ) && count( $custom_fields['optional'] )) ? ("
					".$this->__f__3d83bf471e80bf944f0befaa4cffc84e($mid,$key,$custom_fields,$errors,$reg,$userFromService)."				") : ("")) . "
			</fieldset>") : ("")) . "
...
function __f__0e5c26303f0dd2be71073641435dccb4($mid="",$key="",$custom_fields="",$errors="", $reg="", $userFromService=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__3d83bf471e80bf944f0befaa4cffc84e($mid="",$key="",$custom_fields="",$errors="", $reg="", $userFromService=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_69a2aefb85c110fcda27f593e11822b3 = is_array($this->functionData['lostPasswordForm']) ? count($this->functionData['lostPasswordForm']) : 0;
$this->functionData['lostPasswordForm'][$count_69a2aefb85c110fcda27f593e11822b3]['errors'] = $errors;
}
...
{
$count_130b9f153588d9f95692bd3640410407 = is_array($this->functionData['registerCoppaForm']) ? count($this->functionData['registerCoppaForm']) : 0;
}
$IPBHTML .= "<html>
	<head>
...
{
$count_182a8a1323cbe93da43777a0afadcfae = is_array($this->functionData['registerCoppaStart']) ? count($this->functionData['registerCoppaStart']) : 0;
}
$IPBHTML .= "<form action='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=global&amp;section=register&amp;do=coppa_two", "public",'' ), "", "" ) . "' method='post'>
		...
		<div class='row post line_spacing'>
			...
			<br /><br />
				<select name='month' id='coppa_bday_m'>
					".$this->__f__cac82a6cbd3738035cc7df9d51556eb7()."				</select>
				&nbsp;
				<select name='day' id='coppa_bday_d'>
					".$this->__f__edaefc1ffb3e52c74741b1394290337a()."				</select>
				&nbsp;
				<select name='year' id='coppa_bday_y'>
					".$this->__f__96c3482999eab9e079f001e24ff9bec2()."				</select>
			</div>
		<div class='submit'>
...
function __f__cac82a6cbd3738035cc7df9d51556eb7()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__edaefc1ffb3e52c74741b1394290337a()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__96c3482999eab9e079f001e24ff9bec2()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_2125cb681aec34a8a11c487dbdcbaa76 = is_array($this->functionData['registerForm']) ? count($this->functionData['registerForm']) : 0;
$this->functionData['registerForm'][$count_2125cb681aec34a8a11c487dbdcbaa76]['general_errors'] = $general_errors;
$this->functionData['registerForm'][$count_2125cb681aec34a8a11c487dbdcbaa76]['data'] = $data;
$this->functionData['registerForm'][$count_2125cb681aec34a8a11c487dbdcbaa76]['inline_errors'] = $inline_errors;
$this->functionData['registerForm'][$count_2125cb681aec34a8a11c487dbdcbaa76]['time_select'] = $time_select;
$this->functionData['registerForm'][$count_2125cb681aec34a8a11c487dbdcbaa76]['custom_fields'] = $custom_fields;
$this->functionData['registerForm'][$count_2125cb681aec34a8a11c487dbdcbaa76]['nexusFields'] = $nexusFields;
$this->functionData['registerForm'][$count_2125cb681aec34a8a11c487dbdcbaa76]['nexusStates'] = $nexusStates;
}
	...
	") : ("<div class='master_list'>
			...
			" . ((is_array( $general_errors ) && count( $general_errors )) ? ("
				<div class='message error'>
					...
					".$this->__f__f6bae1277bd9c44bbf246185e285703e($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates)."				</div>
			") : ("")) . "
			...
			<form class='ipsForm_vertical' action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=global&amp;section=register", "public",'' ), "", "" ) . "\" method=\"post\" name=\"REG\" id='register'>
				...
				" . ((( is_array( $custom_fields['required'] ) && count( $custom_fields['required'] ) ) || ( is_array( $custom_fields['optional'] ) && count( $custom_fields['optional'] ) )) ? ("<div class='row line_spacing'>
						" . ((is_array( $custom_fields['required'] ) && count( $custom_fields['required'] )) ? ("
							".$this->__f__24719eca3f45e410241003f4caf80d7e($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates)."						") : ("")) . "
				
						" . ((is_array( $custom_fields['optional'] ) && count( $custom_fields['optional'] )) ? ("
							".$this->__f__966979e9a33c8efb2fd9cb488cb6efee($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates)."						") : ("")) . "
						<!--IBF.MODULES.EXTRA-->
					</div>") : ("")) . "
...
function __f__f6bae1277bd9c44bbf246185e285703e($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__24719eca3f45e410241003f4caf80d7e($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $custom_fields['required'] as $_field )
...
function __f__966979e9a33c8efb2fd9cb488cb6efee($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $custom_fields['optional'] as $_field )
...
{
$count_36187882c4980a56197e7074753b5246 = is_array($this->functionData['showLostpassForm']) ? count($this->functionData['showLostpassForm']) : 0;
$this->functionData['showLostpassForm'][$count_36187882c4980a56197e7074753b5246]['error'] = $error;
}
...
{
$count_f94def589ba78ae7490ed593085ec5cb = is_array($this->functionData['showRevalidateForm']) ? count($this->functionData['showRevalidateForm']) : 0;
$this->functionData['showRevalidateForm'][$count_f94def589ba78ae7490ed593085ec5cb]['name'] = $name;
$this->functionData['showRevalidateForm'][$count_f94def589ba78ae7490ed593085ec5cb]['error'] = $error;
}
$IPBHTML .= "<h2>{$this->lang->words['rv_title']}</h2>
" . (($error) ? ("
