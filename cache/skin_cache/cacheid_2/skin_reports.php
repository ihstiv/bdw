...
{
$count_3cf80c2df5b3962b6e85afb10a684066 = is_array($this->functionData['reportsIndex']) ? count($this->functionData['reportsIndex']) : 0;
$this->functionData['reportsIndex'][$count_3cf80c2df5b3962b6e85afb10a684066]['reports'] = $reports;
$this->functionData['reportsIndex'][$count_3cf80c2df5b3962b6e85afb10a684066]['acts'] = $acts;
$this->functionData['reportsIndex'][$count_3cf80c2df5b3962b6e85afb10a684066]['pages'] = $pages;
$this->functionData['reportsIndex'][$count_3cf80c2df5b3962b6e85afb10a684066]['statuses'] = $statuses;
}
...
<table class='ipb_table report_center' summary='{$this->lang->words['reported_content_summary']}'>
	...
	" . ((count($reports)) ? ("
				".$this->__f__e0797592ad66f7d7dec50f5ec943d43a($reports,$acts,$pages,$statuses)."	") : ("
		<tr>
...
function __f__947a23ac9bd4b481e722c66344d054fc($reports=array(), $acts="", $pages="", $statuses=array(),$report='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e0797592ad66f7d7dec50f5ec943d43a($reports=array(), $acts="", $pages="", $statuses=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
				...
				<td>
					...
					" . ((is_array( $statuses ) && count( $statuses )) ? ("
						<ul class='ipbmenu_content' id='change_status-{$report['id']}_menucontent'>
							".$this->__f__947a23ac9bd4b481e722c66344d054fc($reports,$acts,$pages,$statuses,$report)."						</ul>
					") : ("")) . "
				</td>
				<td class='altrow'>
...
{
$count_c5dba5d7fee05e20baa11b0c05c02a4b = is_array($this->functionData['viewReport']) ? count($this->functionData['viewReport']) : 0;
$this->functionData['viewReport'][$count_c5dba5d7fee05e20baa11b0c05c02a4b]['options'] = $options;
$this->functionData['viewReport'][$count_c5dba5d7fee05e20baa11b0c05c02a4b]['reports'] = $reports;
$this->functionData['viewReport'][$count_c5dba5d7fee05e20baa11b0c05c02a4b]['comments'] = $comments;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("reports", "0" ) . "
<div class='message'>
...
" . ((is_array( $options['statuses'] ) && count( $options['statuses'] )) ? ("
	<ul class='ipbmenu_content' id='change_status_menucontent'>
		".$this->__f__991e282c231c14f831b65c677475a783($options,$reports,$comments)."	</ul>
") : ("")) . "
<br />
...
" . ((is_array($reports) AND count($reports)) ? ("
	".$this->__f__56a31e9f9b83da1ab15fb6352470f170($options,$reports,$comments)."") : ("")) . "
</div>
<br /><hr /><br />
<div class='ipsBox'>
...
function __f__991e282c231c14f831b65c677475a783($options=array(), $reports=array(), $comments=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__56a31e9f9b83da1ab15fb6352470f170($options=array(), $reports=array(), $comments=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $reports as $report )
