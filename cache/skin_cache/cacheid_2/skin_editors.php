...
{
$count_9f7eb2841631fe4c7e1f181476ae4b75 = is_array($this->functionData['editor']) ? count($this->functionData['editor']) : 0;
$this->functionData['editor'][$count_9f7eb2841631fe4c7e1f181476ae4b75]['formField'] = $formField;
$this->functionData['editor'][$count_9f7eb2841631fe4c7e1f181476ae4b75]['content'] = $content;
$this->functionData['editor'][$count_9f7eb2841631fe4c7e1f181476ae4b75]['options'] = $options;
$this->functionData['editor'][$count_9f7eb2841631fe4c7e1f181476ae4b75]['autoSaveData'] = $autoSaveData;
$this->functionData['editor'][$count_9f7eb2841631fe4c7e1f181476ae4b75]['warningInfo'] = $warningInfo;
$this->functionData['editor'][$count_9f7eb2841631fe4c7e1f181476ae4b75]['acknowledge'] = $acknowledge;
$this->functionData['editor'][$count_9f7eb2841631fe4c7e1f181476ae4b75]['bbcodeVersion'] = $bbcodeVersion;
$this->functionData['editor'][$count_9f7eb2841631fe4c7e1f181476ae4b75]['showEditor'] = $showEditor;
}
...
{
$count_a19cf3b68088b9503ae1ad6609cd18b4 = is_array($this->functionData['editorSettings']) ? count($this->functionData['editorSettings']) : 0;
}
...
{
$count_dfe8905841d20b244a6aeb7291927f4c = is_array($this->functionData['mediaGenericWrapper']) ? count($this->functionData['mediaGenericWrapper']) : 0;
$this->functionData['mediaGenericWrapper'][$count_dfe8905841d20b244a6aeb7291927f4c]['rows'] = $rows;
$this->functionData['mediaGenericWrapper'][$count_dfe8905841d20b244a6aeb7291927f4c]['pages'] = $pages;
$this->functionData['mediaGenericWrapper'][$count_dfe8905841d20b244a6aeb7291927f4c]['app'] = $app;
$this->functionData['mediaGenericWrapper'][$count_dfe8905841d20b244a6aeb7291927f4c]['plugin'] = $plugin;
}
...
<div>
	<ul class='media_results'>
		" . ((count($rows)) ? ("
			".$this->__f__d5fda285c79a59989c1cad38b7a4d2ee($rows,$pages,$app,$plugin)."		") : ("
...
function __f__d5fda285c79a59989c1cad38b7a4d2ee($rows, $pages, $app, $plugin)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_15eed2874a8885f02dc5d88973ade299 = is_array($this->functionData['sharedMedia']) ? count($this->functionData['sharedMedia']) : 0;
$this->functionData['sharedMedia'][$count_15eed2874a8885f02dc5d88973ade299]['tabs'] = $tabs;
}
...
<div class='fixed_inner ipsBox'>
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left'>
			<ul id='mymedia_tabs'>
				".$this->__f__744709171a895a6c04bbdd37014ed7d7($tabs)."			</ul>
		</div>
...
function __f__744709171a895a6c04bbdd37014ed7d7($tabs)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tabs as $tab )
