...
{
$count_8918ff7ba422598daab1e1d01ef9e4b0 = is_array($this->functionData['showOnlineList']) ? count($this->functionData['showOnlineList']) : 0;
$this->functionData['showOnlineList'][$count_8918ff7ba422598daab1e1d01ef9e4b0]['rows'] = $rows;
$this->functionData['showOnlineList'][$count_8918ff7ba422598daab1e1d01ef9e4b0]['links'] = $links;
$this->functionData['showOnlineList'][$count_8918ff7ba422598daab1e1d01ef9e4b0]['defaults'] = $defaults;
}
...
<table class='ipb_table' summary=\"{$this->lang->words['users_online']}\">
	...
	" . ((count($rows)) ? ("
				".$this->__f__3661f538db9788eaf3fcff95aee718ad($rows,$links,$defaults)."	") : ("")) . "
</table>
<div id='forum_filter' class='filter_bar rounded'>
	<form method=\"post\" action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=members&amp;section=online&amp;module=online", "public",'' ), "", "" ) . "\">
		...
		<select name=\"sort_key\" id='sort_key' class='input_select'>
			".$this->__f__66d6466e9d36b0fdb26d5bdde146072b($rows,$links,$defaults)."		</select>
		<select name=\"show_mem\" class='input_select'>
			".$this->__f__44d3836942316b46f11876554230ed3c($rows,$links,$defaults)."		</select>
		<select name=\"sort_order\" class='input_select'>
			".$this->__f__ed1e37ec2f01dcd5c9fe14c73c63ee70($rows,$links,$defaults)."		</select>
...
function __f__3661f538db9788eaf3fcff95aee718ad($rows, $links="", $defaults=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__66d6466e9d36b0fdb26d5bdde146072b($rows, $links="", $defaults=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__44d3836942316b46f11876554230ed3c($rows, $links="", $defaults=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__ed1e37ec2f01dcd5c9fe14c73c63ee70($rows, $links="", $defaults=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
