...
$this->_funcHooks['acknowledgeWarning'] = array('valueIsPermanent','hasValue','options','warningsAcknowledgeMessage','memberNote','hasReasonAndContent','hasContent','hasReason','hasExpireDate','hasExpiration','hasPoints','isVerbalWarning','warningsAcknowledge');
...
{
$count_2046a263cbbbd4537f5a2e9bc206bd22 = is_array($this->functionData['acknowledgeWarning']) ? count($this->functionData['acknowledgeWarning']) : 0;
$this->functionData['acknowledgeWarning'][$count_2046a263cbbbd4537f5a2e9bc206bd22]['warning'] = $warning;
}
	...
	<div class='master_list'>
		...
		<div class='row'>
			...
			") : ("" . (($warning['wl_points']) ? ("" . (($warning['wl_expire']) ? ("" . (($warning['wl_expire_date']) ? ("
					...
					")) . "") : ("")) . "
				".$this->__f__e2918f7a81a70eec73927198dac57e2b($warning)."")) . "
		</div>
	</div>
	" . (($this->settings['warnings_acknowledge'] and !$warning['wl_acknowledged']) ? ("
		<div class='controls'>
...
function __f__e2918f7a81a70eec73927198dac57e2b($warning)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_a8f39b46ae407e54213ff3b197a10bac = is_array($this->functionData['addWarning']) ? count($this->functionData['addWarning']) : 0;
$this->functionData['addWarning'][$count_a8f39b46ae407e54213ff3b197a10bac]['member'] = $member;
$this->functionData['addWarning'][$count_a8f39b46ae407e54213ff3b197a10bac]['reasons'] = $reasons;
$this->functionData['addWarning'][$count_a8f39b46ae407e54213ff3b197a10bac]['errors'] = $errors;
$this->functionData['addWarning'][$count_a8f39b46ae407e54213ff3b197a10bac]['editor'] = $editor;
$this->functionData['addWarning'][$count_a8f39b46ae407e54213ff3b197a10bac]['currentPunishments'] = $currentPunishments;
}
			...
			<ul class='ipsForm ipsForm_vertical'>
				<li class='ipsField ipsField_select'>
					...
					<div class='ipsField_content'>
						<select name='reason' id='reason-select'>
							...
							".$this->__f__a47668fb0719747c28f768ec93a10e91($member,$reasons,$errors,$editor,$currentPunishments)."							" . (($this->settings['warnings_enable_other'] or $this->memberData['g_access_cp']) ? ("
				...
				<li class='ipsField' style='display:none' id='suspend_li'>
					...
					<div class='ipsField_content'>
						...
						".$this->__f__e99c05e02ace85676cfd689ee89ae2fb($member,$reasons,$errors,$editor,$currentPunishments)."						</select>
					</div>
				</li>
...
function __f__a47668fb0719747c28f768ec93a10e91($member, $reasons, $errors, $editor, $currentPunishments)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e99c05e02ace85676cfd689ee89ae2fb($member, $reasons, $errors, $editor, $currentPunishments)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_225bf49c0fc80d5b1f434e6d2894b8fb = is_array($this->functionData['customField__gender']) ? count($this->functionData['customField__gender']) : 0;
$this->functionData['customField__gender'][$count_225bf49c0fc80d5b1f434e6d2894b8fb]['f'] = $f;
}
...
{
$count_f54b690eb4c60fd008c195988cec6c0a = is_array($this->functionData['customField__generic']) ? count($this->functionData['customField__generic']) : 0;
$this->functionData['customField__generic'][$count_f54b690eb4c60fd008c195988cec6c0a]['f'] = $f;
}
...
{
$count_12b2ad80ff4a47d99bd5000085fe0a8b = is_array($this->functionData['customFieldGroup__contact']) ? count($this->functionData['customFieldGroup__contact']) : 0;
$this->functionData['customFieldGroup__contact'][$count_12b2ad80ff4a47d99bd5000085fe0a8b]['f'] = $f;
}
$IPBHTML .= "" . (($f->parsed) ? ("<dt>{$f->raw_data['pf_title']}:</dt>
<dd>
	" . (($f->raw_data['pf_icon']) ? ("<img src='{$this->settings['public_dir']}{$f->raw_data['pf_icon']}' alt='{$f->raw_data['pf_title']}' />&nbsp;") : ("")) . "
	" . ((is_array( $f->parsed )) ? ("
		".$this->__f__1edf15109da0eff400d1658e48d99f81($f)."	") : ("" . (($f->raw_data['pf_key'] == 'aim') ? ("
...
function __f__1edf15109da0eff400d1658e48d99f81($f)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_a9a486cc8ab1789d33e20357e7976964 = is_array($this->functionData['customizeProfile']) ? count($this->functionData['customizeProfile']) : 0;
$this->functionData['customizeProfile'][$count_a9a486cc8ab1789d33e20357e7976964]['member'] = $member;
}
...
{
$count_0c5ca4427833070b5c7aea573a69cb86 = is_array($this->functionData['dnameWrapper']) ? count($this->functionData['dnameWrapper']) : 0;
$this->functionData['dnameWrapper'][$count_0c5ca4427833070b5c7aea573a69cb86]['member_name'] = $member_name;
$this->functionData['dnameWrapper'][$count_0c5ca4427833070b5c7aea573a69cb86]['records'] = $records;
}
...
<table class='ipb_table'>
	...
	" . ((is_array($records) AND count($records)) ? ("
		    	".$this->__f__f15e9cfa5851b8b416f3a800bad2f1e6($member_name,$records)."	") : ("
		<tr>
...
function __f__f15e9cfa5851b8b416f3a800bad2f1e6($member_name="",$records=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_0b4e7e2ca4d4b839b6b021ecd1a0906a = is_array($this->functionData['explainPoints']) ? count($this->functionData['explainPoints']) : 0;
$this->functionData['explainPoints'][$count_0b4e7e2ca4d4b839b6b021ecd1a0906a]['reasons'] = $reasons;
$this->functionData['explainPoints'][$count_0b4e7e2ca4d4b839b6b021ecd1a0906a]['actions'] = $actions;
}
...
<table class='ipb_table'>
	...
	".$this->__f__2d425dec911a77e40a02a9d04fc272bc($reasons,$actions)."</table>
" . ((!empty( $actions )) ? ("
	<div class='ipsPad'>
	...
	<table class='ipb_table'>
		...
		".$this->__f__7fadfa7b426db9b618794a83e94e2f2a($reasons,$actions)."	</table>
") : ("")) . "";
return $IPBHTML;
}


function __f__2d425dec911a77e40a02a9d04fc272bc($reasons, $actions)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $reasons as $r )
...
function __f__6011325d8b3dcbf6ad801e48ada68b5f($reasons, $actions,$a='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( array( 'mq', 'rpa', 'suspend' ) as $k )
...
function __f__7fadfa7b426db9b618794a83e94e2f2a($reasons, $actions)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $actions as $a )
	{
		...
		$_ips___x_retval .= "
			<tr>
				<td>{$a['wa_points']}</td>
				<td>
					".$this->__f__6011325d8b3dcbf6ad801e48ada68b5f($reasons,$actions,$a)."				</td>
			</tr>
...
{
$count_2ec68d5942d7cdfb364e1f84c44e8bf8 = is_array($this->functionData['friendsList']) ? count($this->functionData['friendsList']) : 0;
$this->functionData['friendsList'][$count_2ec68d5942d7cdfb364e1f84c44e8bf8]['friends'] = $friends;
$this->functionData['friendsList'][$count_2ec68d5942d7cdfb364e1f84c44e8bf8]['pages'] = $pages;
}
...
" . ((is_array($friends) and count($friends) && $this->settings['friends_enabled']) ? ("
		<ul class='members'>
	".$this->__f__d892bbb8fc128a65b9da6c493518f1ac($friends,$pages)."	</ul>
") : ("<p class='no_messages'>
		" . (($this->request['tab'] == 'pending') ? ("
...
function __f__d892bbb8fc128a65b9da6c493518f1ac($friends, $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_83d47fc0cb9212c8729200844e8ae902 = is_array($this->functionData['listWarnings']) ? count($this->functionData['listWarnings']) : 0;
$this->functionData['listWarnings'][$count_83d47fc0cb9212c8729200844e8ae902]['member'] = $member;
$this->functionData['listWarnings'][$count_83d47fc0cb9212c8729200844e8ae902]['warnings'] = $warnings;
$this->functionData['listWarnings'][$count_83d47fc0cb9212c8729200844e8ae902]['pagination'] = $pagination;
$this->functionData['listWarnings'][$count_83d47fc0cb9212c8729200844e8ae902]['reasons'] = $reasons;
$this->functionData['listWarnings'][$count_83d47fc0cb9212c8729200844e8ae902]['canWarn'] = $canWarn;
}
...
") : ("
	<div class='ipsBox'>
		<div class='ipsBox_container'>
			<table class='ipb_table'>
				<tbody>
					".$this->__f__49157a968b5546a962c22f0aa3d539bd($member,$warnings,$pagination,$reasons,$canWarn)."				</tbody>
			</table>
		</div>
	</div>
")) . "
...
function __f__49157a968b5546a962c22f0aa3d539bd($member, $warnings, $pagination, $reasons, $canWarn)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_b198ba9034258d661045a3ef87c83e3c = is_array($this->functionData['profileModern']) ? count($this->functionData['profileModern']) : 0;
$this->functionData['profileModern'][$count_b198ba9034258d661045a3ef87c83e3c]['tabs'] = $tabs;
$this->functionData['profileModern'][$count_b198ba9034258d661045a3ef87c83e3c]['member'] = $member;
$this->functionData['profileModern'][$count_b198ba9034258d661045a3ef87c83e3c]['visitors'] = $visitors;
$this->functionData['profileModern'][$count_b198ba9034258d661045a3ef87c83e3c]['default_tab'] = $default_tab;
$this->functionData['profileModern'][$count_b198ba9034258d661045a3ef87c83e3c]['default_tab_content'] = $default_tab_content;
$this->functionData['profileModern'][$count_b198ba9034258d661045a3ef87c83e3c]['friends'] = $friends;
$this->functionData['profileModern'][$count_b198ba9034258d661045a3ef87c83e3c]['status'] = $status;
$this->functionData['profileModern'][$count_b198ba9034258d661045a3ef87c83e3c]['warns'] = $warns;
}
$IPBHTML .= "<div class='master_list'>
...
{
$count_fc98979122dfcf8e3aa4687d03e87423 = is_array($this->functionData['reputationPage']) ? count($this->functionData['reputationPage']) : 0;
$this->functionData['reputationPage'][$count_fc98979122dfcf8e3aa4687d03e87423]['langBit'] = $langBit;
$this->functionData['reputationPage'][$count_fc98979122dfcf8e3aa4687d03e87423]['currentApp'] = $currentApp;
$this->functionData['reputationPage'][$count_fc98979122dfcf8e3aa4687d03e87423]['supportedApps'] = $supportedApps;
$this->functionData['reputationPage'][$count_fc98979122dfcf8e3aa4687d03e87423]['processedResults'] = $processedResults;
}
	...
	" . ((count( $supportedApps ) > 1) ? ("
		<div class='maintitle ipsFilterbar clearfix'>
			<ul class='ipsList_inline ipsType_smaller left'>
				".$this->__f__bdca8029c7fb28299431d067f06cd989($langBit,$currentApp,$supportedApps,$processedResults)."			</ul>
		</div>
	") : ("")) . "
	" . (($processedResults) ? ("
		{$processedResults}
...
function __f__bdca8029c7fb28299431d067f06cd989($langBit, $currentApp='', $supportedApps=array(), $processedResults='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_c23222f7a84cc60e11d2d9bcbd5fc089 = is_array($this->functionData['showCard']) ? count($this->functionData['showCard']) : 0;
$this->functionData['showCard'][$count_c23222f7a84cc60e11d2d9bcbd5fc089]['member'] = $member;
$this->functionData['showCard'][$count_c23222f7a84cc60e11d2d9bcbd5fc089]['download'] = $download;
}
...
{
$count_dad6aa3a13028eb739010dfa11d85688 = is_array($this->functionData['statusReplies']) ? count($this->functionData['statusReplies']) : 0;
$this->functionData['statusReplies'][$count_dad6aa3a13028eb739010dfa11d85688]['replies'] = $replies;
$this->functionData['statusReplies'][$count_dad6aa3a13028eb739010dfa11d85688]['no_wrapper'] = $no_wrapper;
}
$IPBHTML .= "".$this->__f__d856e7dd3ae2be98535fc5e7193d25da($replies,$no_wrapper)."";
return $IPBHTML;
}


function __f__d856e7dd3ae2be98535fc5e7193d25da($replies=array(), $no_wrapper=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_9c4b81ff8d189850e97c62ca806b653a = is_array($this->functionData['statusUpdates']) ? count($this->functionData['statusUpdates']) : 0;
$this->functionData['statusUpdates'][$count_9c4b81ff8d189850e97c62ca806b653a]['updates'] = $updates;
$this->functionData['statusUpdates'][$count_9c4b81ff8d189850e97c62ca806b653a]['smallSpace'] = $smallSpace;
$this->functionData['statusUpdates'][$count_9c4b81ff8d189850e97c62ca806b653a]['latestOnly'] = $latestOnly;
}
$IPBHTML .= "".$this->__f__ebf8dbd1b32fe149bb185ef469c87198($updates,$smallSpace,$latestOnly)."";
return $IPBHTML;
}


function __f__ebf8dbd1b32fe149bb185ef469c87198($updates=array(), $smallSpace=0, $latestOnly=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_791657638ea1248d9eeda01b439c299b = is_array($this->functionData['statusUpdatesPage']) ? count($this->functionData['statusUpdatesPage']) : 0;
$this->functionData['statusUpdatesPage'][$count_791657638ea1248d9eeda01b439c299b]['updates'] = $updates;
$this->functionData['statusUpdatesPage'][$count_791657638ea1248d9eeda01b439c299b]['pages'] = $pages;
}
...
{
$count_bf4831ce7135b380f704d810c1feb3d7 = is_array($this->functionData['tabFriends']) ? count($this->functionData['tabFriends']) : 0;
$this->functionData['tabFriends'][$count_bf4831ce7135b380f704d810c1feb3d7]['friends'] = $friends;
$this->functionData['tabFriends'][$count_bf4831ce7135b380f704d810c1feb3d7]['member'] = $member;
$this->functionData['tabFriends'][$count_bf4831ce7135b380f704d810c1feb3d7]['pagination'] = $pagination;
}
$IPBHTML .= "<div class='general_box'>
	" . (($this->settings['friends_enabled'] AND $this->memberData['g_can_add_friends'] AND $member['pp_setting_count_friends']) ? ("<div class='friend_list clear' id='friend_list'>
			...
			" . ((is_array($friends) and count($friends)) ? ("
				<ul class='clearfix'>
				".$this->__f__a746bd8d588ff10f5d8afe483c71fdf1($friends,$member,$pagination)."				</ul>				
			") : ("
				<p>
...
function __f__a746bd8d588ff10f5d8afe483c71fdf1($friends=array(), $member=array(), $pagination='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $friends as $friend )
...
{
$count_8e899c676433e4370e1f476c1302c0e4 = is_array($this->functionData['tabReputation']) ? count($this->functionData['tabReputation']) : 0;
$this->functionData['tabReputation'][$count_8e899c676433e4370e1f476c1302c0e4]['member'] = $member;
$this->functionData['tabReputation'][$count_8e899c676433e4370e1f476c1302c0e4]['currentApp'] = $currentApp;
$this->functionData['tabReputation'][$count_8e899c676433e4370e1f476c1302c0e4]['type'] = $type;
$this->functionData['tabReputation'][$count_8e899c676433e4370e1f476c1302c0e4]['supportedApps'] = $supportedApps;
$this->functionData['tabReputation'][$count_8e899c676433e4370e1f476c1302c0e4]['processedResults'] = $processedResults;
$this->functionData['tabReputation'][$count_8e899c676433e4370e1f476c1302c0e4]['pagination'] = $pagination;
}
$IPBHTML .= "<div class='general_box'>
	<div class='maintitle ipsFilterbar clearfix'>
		" . ((count( $supportedApps ) > 1) ? ("
			<ul class='ipsList_inline ipsType_smaller left'>
				".$this->__f__55fe93313631dd63c68dd97498baacbe($member,$currentApp,$type,$supportedApps,$processedResults,$pagination)."			</ul>
		") : ("")) . "
...
function __f__55fe93313631dd63c68dd97498baacbe($member, $currentApp='', $type='', $supportedApps=array(), $processedResults='', $pagination='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $supportedApps as $_app )
...
{
$count_f589156699c6466104551730afe5cbd5 = is_array($this->functionData['tabReputation_calendar']) ? count($this->functionData['tabReputation_calendar']) : 0;
$this->functionData['tabReputation_calendar'][$count_f589156699c6466104551730afe5cbd5]['results'] = $results;
}
$IPBHTML .= "<div class='ipsBox'>
	".$this->__f__47a79d9da4105ca95bac775880724e3c($results)."</div>";
return $IPBHTML;
}


function __f__47a79d9da4105ca95bac775880724e3c($results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_4f9af9a9974a528a56cf9ba73e34686e = is_array($this->functionData['tabReputation_posts']) ? count($this->functionData['tabReputation_posts']) : 0;
$this->functionData['tabReputation_posts'][$count_4f9af9a9974a528a56cf9ba73e34686e]['results'] = $results;
}
$IPBHTML .= "<div class='ipsBox'>
	".$this->__f__75669c9aefc93cd325bb4ef15024d0f6($results)."</div>";
return $IPBHTML;
}


function __f__3aaa099165e07ba2e3f25612c4219043($results,$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__75669c9aefc93cd325bb4ef15024d0f6($results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $results as $data )
			...
			<div class='post_wrap'>
				...
				<div class='post_body'>
					<p class='posted_info desc lighter ipsType_small'>
						...
						" . (($data['_forum_trail']) ? ("
							in
							".$this->__f__3aaa099165e07ba2e3f25612c4219043($results,$data)."						") : ("")) . "
					</p>
					<div class='post entry-content clearfix'>
						{$data['post']}
						<br />
...
{
$count_4cb1cc8903f73543088252807e66fb9b = is_array($this->functionData['tabSingleColumn']) ? count($this->functionData['tabSingleColumn']) : 0;
$this->functionData['tabSingleColumn'][$count_4cb1cc8903f73543088252807e66fb9b]['row'] = $row;
$this->functionData['tabSingleColumn'][$count_4cb1cc8903f73543088252807e66fb9b]['read_more_link'] = $read_more_link;
$this->functionData['tabSingleColumn'][$count_4cb1cc8903f73543088252807e66fb9b]['url'] = $url;
$this->functionData['tabSingleColumn'][$count_4cb1cc8903f73543088252807e66fb9b]['title'] = $title;
}
...
{
$count_0996c99687bd458bad509bb3eddf1a6e = is_array($this->functionData['tabStatusUpdates']) ? count($this->functionData['tabStatusUpdates']) : 0;
$this->functionData['tabStatusUpdates'][$count_0996c99687bd458bad509bb3eddf1a6e]['updates'] = $updates;
$this->functionData['tabStatusUpdates'][$count_0996c99687bd458bad509bb3eddf1a6e]['actions'] = $actions;
$this->functionData['tabStatusUpdates'][$count_0996c99687bd458bad509bb3eddf1a6e]['member'] = $member;
}
...
<div class='status_profile_actions'>
	" . ((count( $actions )) ? ("".$this->__f__a8920ee279e1e8bfc9a6296ded5ccbdd($updates,$actions,$member)."		<br />
		<div class='right'>
...
function __f__a8920ee279e1e8bfc9a6296ded5ccbdd($updates=array(), $actions, $member=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
