...
{
$count_17c331deb6ed5906411d55129bcea71f = is_array($this->functionData['forward_form']) ? count($this->functionData['forward_form']) : 0;
$this->functionData['forward_form'][$count_17c331deb6ed5906411d55129bcea71f]['title'] = $title;
$this->functionData['forward_form'][$count_17c331deb6ed5906411d55129bcea71f]['text'] = $text;
$this->functionData['forward_form'][$count_17c331deb6ed5906411d55129bcea71f]['lang'] = $lang;
$this->functionData['forward_form'][$count_17c331deb6ed5906411d55129bcea71f]['captchaHTML'] = $captchaHTML;
$this->functionData['forward_form'][$count_17c331deb6ed5906411d55129bcea71f]['msg'] = $msg;
}
					...
					<li class='ipsField clear'>
						...
						<p class='ipsField_content'>
							<select name='lang' class='input_select' id='to_lang'>
								".$this->__f__fc22b7acb4b2f4779e3190bb393e7041($title,$text,$lang,$captchaHTML,$msg)."							</select>
						</p>
					</li>
				")) . "
				<li class='ipsField clear'>
...
function __f__fc22b7acb4b2f4779e3190bb393e7041($title="",$text="",$lang="", $captchaHTML='', $msg='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
