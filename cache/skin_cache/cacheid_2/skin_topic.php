...
$this->_funcHooks['topicViewTemplate'] = array('post_data','mod_links','hasPagesBA2','samePageBA2','bestAnswer','closedButtonLink','replyButtonLink','replyButton','closedButton','hasPosts','canShare','modOptionsDropdown','closedButtonLink','replyButtonLink','replyButton','closedButton','fastReply','scrollToPost','notexist','scrollToPost2');
...
{
$count_1c165a859227b4be11ba4c8601f83fec = is_array($this->functionData['archiveStatusMessage']) ? count($this->functionData['archiveStatusMessage']) : 0;
$this->functionData['archiveStatusMessage'][$count_1c165a859227b4be11ba4c8601f83fec]['topic'] = $topic;
$this->functionData['archiveStatusMessage'][$count_1c165a859227b4be11ba4c8601f83fec]['forum'] = $forum;
}
...
{
$count_ba2d0d750b40416b29e16c2b3452196d = is_array($this->functionData['pollDisplay']) ? count($this->functionData['pollDisplay']) : 0;
$this->functionData['pollDisplay'][$count_ba2d0d750b40416b29e16c2b3452196d]['poll'] = $poll;
$this->functionData['pollDisplay'][$count_ba2d0d750b40416b29e16c2b3452196d]['topicData'] = $topicData;
$this->functionData['pollDisplay'][$count_ba2d0d750b40416b29e16c2b3452196d]['forumData'] = $forumData;
$this->functionData['pollDisplay'][$count_ba2d0d750b40416b29e16c2b3452196d]['pollData'] = $pollData;
$this->functionData['pollDisplay'][$count_ba2d0d750b40416b29e16c2b3452196d]['showResults'] = $showResults;
$this->functionData['pollDisplay'][$count_ba2d0d750b40416b29e16c2b3452196d]['editPoll'] = $editPoll;
}
$IPBHTML .= "<div class='general_box alt poll' id='poll_{$poll['pid']}'>
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=extras&amp;section=vote&amp;t={$topicData['tid']}&amp;page={$this->request['page']}&amp;do=add&amp;secure_key={$this->member->form_hash}", "public",'' ), "", "" ) . "\" name='pollForm' method=\"post\">
		...
		") : ("")) . "
		".$this->__f__b7d48c761af50f1be38714538d4297c0($poll,$topicData,$forumData,$pollData,$showResults,$editPoll)."		<fieldset class='submit'>
...
function __f__c13a55c3497f4290b2d3244da67240d3($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b7d48c761af50f1be38714538d4297c0($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $pollData as $questionID => $questionData )
	{
		...
		$_ips___x_retval .= "
			<div class='" . (($showResults) ? (" voted") : ("")) . "'>
				...
				") : ("
					<ol>
						".$this->__f__c13a55c3497f4290b2d3244da67240d3($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData)."					</ol>
				")) . "
			</div>
...
{
$count_40956e0c2e7f4368bfea188158d2f96c = is_array($this->functionData['post']) ? count($this->functionData['post']) : 0;
$this->functionData['post'][$count_40956e0c2e7f4368bfea188158d2f96c]['post'] = $post;
$this->functionData['post'][$count_40956e0c2e7f4368bfea188158d2f96c]['displayData'] = $displayData;
$this->functionData['post'][$count_40956e0c2e7f4368bfea188158d2f96c]['topic'] = $topic;
$this->functionData['post'][$count_40956e0c2e7f4368bfea188158d2f96c]['forum'] = $forum;
}
...
{
$count_4b4b2e59bc6dfe6805432e5ca3db85ee = is_array($this->functionData['quickEditPost']) ? count($this->functionData['quickEditPost']) : 0;
$this->functionData['quickEditPost'][$count_4b4b2e59bc6dfe6805432e5ca3db85ee]['post'] = $post;
}
$IPBHTML .= "{$post['post']}
    {$post['attachmentHtml']}
	<br />
...
{
$count_49752fcfb45aaad55a77be2f2e8a8af1 = is_array($this->functionData['show_attachment_title']) ? count($this->functionData['show_attachment_title']) : 0;
$this->functionData['show_attachment_title'][$count_49752fcfb45aaad55a77be2f2e8a8af1]['title'] = $title;
$this->functionData['show_attachment_title'][$count_49752fcfb45aaad55a77be2f2e8a8af1]['data'] = $data;
$this->functionData['show_attachment_title'][$count_49752fcfb45aaad55a77be2f2e8a8af1]['type'] = $type;
}
$IPBHTML .= "<div id='attach_wrap' class='clearfix'>
	<h4>{$title}</h4>
	<ul>
		".$this->__f__63dbd24d2163dfc04f78ae18a743ef65($title,$data,$type)."	</ul>
</div>";
return $IPBHTML;
}


function __f__63dbd24d2163dfc04f78ae18a743ef65($title="",$data="",$type="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_5b07b5a29b0daf39b720a34261c82780 = is_array($this->functionData['Show_attachments']) ? count($this->functionData['Show_attachments']) : 0;
$this->functionData['Show_attachments'][$count_5b07b5a29b0daf39b720a34261c82780]['data'] = $data;
}
...
{
$count_d8040b76c310824f336821555a9da9ff = is_array($this->functionData['softDeletedPostBit']) ? count($this->functionData['softDeletedPostBit']) : 0;
$this->functionData['softDeletedPostBit'][$count_d8040b76c310824f336821555a9da9ff]['post'] = $post;
$this->functionData['softDeletedPostBit'][$count_d8040b76c310824f336821555a9da9ff]['sdData'] = $sdData;
$this->functionData['softDeletedPostBit'][$count_d8040b76c310824f336821555a9da9ff]['topic'] = $topic;
}
...
{
$count_eba473ce9170709f7094497f2d30e40e = is_array($this->functionData['topicViewTemplate']) ? count($this->functionData['topicViewTemplate']) : 0;
$this->functionData['topicViewTemplate'][$count_eba473ce9170709f7094497f2d30e40e]['forum'] = $forum;
$this->functionData['topicViewTemplate'][$count_eba473ce9170709f7094497f2d30e40e]['topic'] = $topic;
$this->functionData['topicViewTemplate'][$count_eba473ce9170709f7094497f2d30e40e]['post_data'] = $post_data;
$this->functionData['topicViewTemplate'][$count_eba473ce9170709f7094497f2d30e40e]['displayData'] = $displayData;
}
...
<div class='master_list'>
	...
	<div class='controls'>
		<div class='buttons'>
			" . (($displayData['reply_button']['image'] == 'locked') ? ("" . (($displayData['reply_button']['url']) ? ("
				...
				")) . "") : ("<!--hook.if.skin_topic.topicViewTemplate.replyButton.pre.startif-->" . (($displayData['reply_button']['image']) ? ("" . (($displayData['reply_button']['url']) ? ("
	...
	<!--hook.if.skin_topic.topicViewTemplate.hasPosts.pre.startif-->" . ((is_array( $post_data ) AND count( $post_data )) ? ("
		".$this->__f__45e20e0754551f7862172cdc5554b9f3($forum,$topic,$post_data,$displayData)."	") : ("")) . "
	...
	") : ("")) . "
		...
		<div style='text-align:center'>
			...
			<div id='mobileModOptions' style='display:none'>
				".$this->__f__b592674cf8152531836dbd97bcb64b35($forum,$topic,$post_data,$displayData)."			</div>
		</div>
	") : ("")) . "
	<div class='controls'>
		<div class='buttons'>
...
function __f__45e20e0754551f7862172cdc5554b9f3($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b592674cf8152531836dbd97bcb64b35($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
