...
/* CACHE FILE: Generated: Wed, 18 May 2016 17:28:30 GMT */
...
{
$count_5c59f1edd1048cc359ee9c848ce145ef = is_array($this->functionData['coreAttachments']) ? count($this->functionData['coreAttachments']) : 0;
$this->functionData['coreAttachments'][$count_5c59f1edd1048cc359ee9c848ce145ef]['info'] = $info;
$this->functionData['coreAttachments'][$count_5c59f1edd1048cc359ee9c848ce145ef]['pages'] = $pages;
$this->functionData['coreAttachments'][$count_5c59f1edd1048cc359ee9c848ce145ef]['attachments'] = $attachments;
}
...
$IPBHTML .= "<div class='row1'>	
	...
	<table class='ipb_table' summary=\"{$this->lang->words['ucp_user_attach']}\">
		<tr class='header'>
			...
			" . ((count($attachments)) ? ("
								".$this->__f__0b3a995a305117103ec77d26b06eb5b9($info,$pages,$attachments)."			") : ("
				<tr>
...
function __f__0b3a995a305117103ec77d26b06eb5b9($info="",$pages="",$attachments)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_f8bd02c483aa572fe2962aa847954155 = is_array($this->functionData['displayNameForm']) ? count($this->functionData['displayNameForm']) : 0;
$this->functionData['displayNameForm'][$count_f8bd02c483aa572fe2962aa847954155]['form'] = $form;
$this->functionData['displayNameForm'][$count_f8bd02c483aa572fe2962aa847954155]['error'] = $error;
$this->functionData['displayNameForm'][$count_f8bd02c483aa572fe2962aa847954155]['okmessage'] = $okmessage;
$this->functionData['displayNameForm'][$count_f8bd02c483aa572fe2962aa847954155]['isFB'] = $isFB;
}
$IPBHTML .= "" . (($okmessage != "") ? ("
...
{
$count_328a87c6c840e453f8d271cf8116dff9 = is_array($this->functionData['emailPasswordChangeForm']) ? count($this->functionData['emailPasswordChangeForm']) : 0;
$this->functionData['emailPasswordChangeForm'][$count_328a87c6c840e453f8d271cf8116dff9]['txt'] = $txt;
$this->functionData['emailPasswordChangeForm'][$count_328a87c6c840e453f8d271cf8116dff9]['_message'] = $_message;
$this->functionData['emailPasswordChangeForm'][$count_328a87c6c840e453f8d271cf8116dff9]['isFB'] = $isFB;
}
...
{
$count_2485b3a029463b491dd083b49f2f57c6 = is_array($this->functionData['field_entry']) ? count($this->functionData['field_entry']) : 0;
$this->functionData['field_entry'][$count_2485b3a029463b491dd083b49f2f57c6]['title'] = $title;
$this->functionData['field_entry'][$count_2485b3a029463b491dd083b49f2f57c6]['desc'] = $desc;
$this->functionData['field_entry'][$count_2485b3a029463b491dd083b49f2f57c6]['content'] = $content;
$this->functionData['field_entry'][$count_2485b3a029463b491dd083b49f2f57c6]['id'] = $id;
}
...
{
$count_4554fbc585498bcec9a5d9d1ce5315fa = is_array($this->functionData['membersFacebookConnect']) ? count($this->functionData['membersFacebookConnect']) : 0;
$this->functionData['membersFacebookConnect'][$count_4554fbc585498bcec9a5d9d1ce5315fa]['fbuid'] = $fbuid;
$this->functionData['membersFacebookConnect'][$count_4554fbc585498bcec9a5d9d1ce5315fa]['fbUserData'] = $fbUserData;
$this->functionData['membersFacebookConnect'][$count_4554fbc585498bcec9a5d9d1ce5315fa]['linkedMemberData'] = $linkedMemberData;
$this->functionData['membersFacebookConnect'][$count_4554fbc585498bcec9a5d9d1ce5315fa]['perms'] = $perms;
}
...
{
$count_ea109d136e643acf74fce2d02ae2e781 = is_array($this->functionData['membersIgnoredUsersForm']) ? count($this->functionData['membersIgnoredUsersForm']) : 0;
$this->functionData['membersIgnoredUsersForm'][$count_ea109d136e643acf74fce2d02ae2e781]['members'] = $members;
$this->functionData['membersIgnoredUsersForm'][$count_ea109d136e643acf74fce2d02ae2e781]['pagination'] = $pagination;
}
	...
	<table class='ipb_table' summary=\"{$this->lang->words['ucp_ignored_users']}\">
		<tr class='header'>
			...
			<th scope='col' width=\"10%\">&nbsp;</th>
				...
				".$this->__f__b40921b137d53eca1daa20e0ed5dcb1a($members,$pagination)."	</table>
    " . (($pagination) ? ("
	    <br />
	    {$pagination}
	    <br class='clear' />
...
function __f__b40921b137d53eca1daa20e0ed5dcb1a($members, $pagination)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_b3c5360844366734bc3de5880a23e11f = is_array($this->functionData['membersProfileForm']) ? count($this->functionData['membersProfileForm']) : 0;
$this->functionData['membersProfileForm'][$count_b3c5360844366734bc3de5880a23e11f]['custom_fields'] = $custom_fields;
$this->functionData['membersProfileForm'][$count_b3c5360844366734bc3de5880a23e11f]['group_titles'] = $group_titles;
$this->functionData['membersProfileForm'][$count_b3c5360844366734bc3de5880a23e11f]['day'] = $day;
$this->functionData['membersProfileForm'][$count_b3c5360844366734bc3de5880a23e11f]['mon'] = $mon;
$this->functionData['membersProfileForm'][$count_b3c5360844366734bc3de5880a23e11f]['year'] = $year;
$this->functionData['membersProfileForm'][$count_b3c5360844366734bc3de5880a23e11f]['amEditor'] = $amEditor;
$this->functionData['membersProfileForm'][$count_b3c5360844366734bc3de5880a23e11f]['times'] = $times;
}
	...
	<ul>
		...
		" . (($day AND $mon AND $year) ? ("
			<li class='field'>
				...
				<select name=\"month\">&nbsp;
					".$this->__f__6826bde4cb1370aecaf858e9ec0757ed($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times)."				</select>			
				<select name=\"day\">&nbsp;
					".$this->__f__0be910f7b95d599b5ca7239c8cf1d89d($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times)."				</select> 
				<select name=\"year\">&nbsp;
					".$this->__f__12a30c652e9999edfc3a317db0111304($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times)."				</select> <br />
...
function __f__6826bde4cb1370aecaf858e9ec0757ed($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $mon as $m )
...
function __f__0be910f7b95d599b5ca7239c8cf1d89d($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $day as $d )
...
function __f__12a30c652e9999edfc3a317db0111304($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $year as $y )
...
{
$count_9352e8e5e36ea650216622a594aaa9aa = is_array($this->functionData['membersSignatureForm']) ? count($this->functionData['membersSignatureForm']) : 0;
$this->functionData['membersSignatureForm'][$count_9352e8e5e36ea650216622a594aaa9aa]['editor_html'] = $editor_html;
$this->functionData['membersSignatureForm'][$count_9352e8e5e36ea650216622a594aaa9aa]['sig_restrictions'] = $sig_restrictions;
$this->functionData['membersSignatureForm'][$count_9352e8e5e36ea650216622a594aaa9aa]['signature'] = $signature;
}
...
{
$count_26c0866a4f67da058a453f92583e06b0 = is_array($this->functionData['notificationsForm']) ? count($this->functionData['notificationsForm']) : 0;
$this->functionData['notificationsForm'][$count_26c0866a4f67da058a453f92583e06b0]['config'] = $config;
$this->functionData['notificationsForm'][$count_26c0866a4f67da058a453f92583e06b0]['emailData'] = $emailData;
}
...
<fieldset class='row1'>
	<span class='desc'><strong>{$this->lang->words['notifications_info_acp']}</strong></span>
		...
		".$this->__f__d27580d349597e6c20493a1ae1c91845($config,$emailData)."		".$this->__f__a6238a7847ca239d22386b61f8ff4922($config,$emailData)."	</table>
</fieldset>";
return $IPBHTML;
}


function __f__11cae88522b83f8d58e29d32a78c94ee($config, $emailData,$groupKey='',$group='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__d27580d349597e6c20493a1ae1c91845($config, $emailData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $this->notifyGroups as $groupKey => $group )
	{
		...
		$_ips___x_retval .= "
			...
			".$this->__f__11cae88522b83f8d58e29d32a78c94ee($config,$emailData,$groupKey,$group)."							
...
function __f__a6238a7847ca239d22386b61f8ff4922($config, $emailData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_93506d6ff1c5e5c65f69db43862dd496 = is_array($this->functionData['notificationsLog']) ? count($this->functionData['notificationsLog']) : 0;
$this->functionData['notificationsLog'][$count_93506d6ff1c5e5c65f69db43862dd496]['notifications'] = $notifications;
$this->functionData['notificationsLog'][$count_93506d6ff1c5e5c65f69db43862dd496]['error'] = $error;
$this->functionData['notificationsLog'][$count_93506d6ff1c5e5c65f69db43862dd496]['pages'] = $pages;
}
...
$IPBHTML .= "<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=usercp&amp;tab=core&amp;area=removeNotifications&amp;do=remove", "public",'' ), "", "" ) . "\" id=\"checkBoxForm\" method=\"post\">
	...
	<div class='master_list' id='notifications'>
		...
		") : ("" . (($this->request['confirm']) ? ("
			...
			") : ("")) . "")) . "
		".$this->__f__bf72504ea7c7875ef96496a929be3546($notifications,$error,$pages)."	</div>
	" . ((count($notifications)) ? ("
		<div class='submit'>
			<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=usercp&amp;area=markNotification&amp;do=mark&amp;mark=all&amp;k={$this->member->form_hash}", "public",'' ), "", "" ) . "' id='ack_pm_notification' class='button secondary'>{$this->lang->words['notificationlog_mar']}</a>
		</div>
	") : ("")) . "
</form>";
return $IPBHTML;
...
function __f__bf72504ea7c7875ef96496a929be3546($notifications, $error='', $pages='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
