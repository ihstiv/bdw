...
class skin_post_2 extends skinMaster{
...
{
$count_4f350c295ff4729dcd4615d57cd066c9 = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_4f350c295ff4729dcd4615d57cd066c9]['data'] = $data;
}
...
{
$count_7af0b4ac65debec7146bc07e4bc2cab6 = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_7af0b4ac65debec7146bc07e4bc2cab6]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_7af0b4ac65debec7146bc07e4bc2cab6]['form'] = $form;
}
...
{
$count_b58d19788898f284e2df339d5fceca52 = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_b58d19788898f284e2df339d5fceca52]['data'] = $data;
}
...
{
$count_dc5546f2ce0d0ee6e84237afcd1e7e0c = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_dc5546f2ce0d0ee6e84237afcd1e7e0c]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__f7dbf871adf3332a20cd44476afe2331($posts)."") : ("")) . "
<p class='submit'>
...
function __f__f7dbf871adf3332a20cd44476afe2331($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_bfd18c0438f0d5b1bdc15677fb4c359e = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_bfd18c0438f0d5b1bdc15677fb4c359e]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_bfd18c0438f0d5b1bdc15677fb4c359e]['type'] = $type;
$this->functionData['uploadForm'][$count_bfd18c0438f0d5b1bdc15677fb4c359e]['stats'] = $stats;
$this->functionData['uploadForm'][$count_bfd18c0438f0d5b1bdc15677fb4c359e]['id'] = $id;
$this->functionData['uploadForm'][$count_bfd18c0438f0d5b1bdc15677fb4c359e]['forum_id'] = $forum_id;
}
