...
{
$count_84fbe5e8fd4674f316466c23573a5baf = is_array($this->functionData['boardIndexTemplate']) ? count($this->functionData['boardIndexTemplate']) : 0;
$this->functionData['boardIndexTemplate'][$count_84fbe5e8fd4674f316466c23573a5baf]['lastvisit'] = $lastvisit;
$this->functionData['boardIndexTemplate'][$count_84fbe5e8fd4674f316466c23573a5baf]['stats'] = $stats;
$this->functionData['boardIndexTemplate'][$count_84fbe5e8fd4674f316466c23573a5baf]['cat_data'] = $cat_data;
$this->functionData['boardIndexTemplate'][$count_84fbe5e8fd4674f316466c23573a5baf]['show_side_blocks'] = $show_side_blocks;
$this->functionData['boardIndexTemplate'][$count_84fbe5e8fd4674f316466c23573a5baf]['side_blocks'] = $side_blocks;
}
$IPBHTML .= "" . (($this->settings['_onIndex'] = 1) ? ("") : ("")) . "
<div class='master_list' id='board_index'>
	" . ((is_array( $cat_data ) AND count( $cat_data )) ? ("
		".$this->__f__acfbbea3e705a925800a64b1c3bb3ba0($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks)."	") : ("")) . "
</div>";
return $IPBHTML;
}


function __f__567d0a69100214f3766c19a0eaf9b7fc($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array(),$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__acfbbea3e705a925800a64b1c3bb3ba0($lastvisit="", $stats=array(), $cat_data=array(), $show_side_blocks=true, $side_blocks=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $cat_data as $_data )
	{
		...
		$_ips___x_retval .= "
			" . ((is_array( $_data['forum_data'] ) AND count( $_data['forum_data'] )) ? ("
				...
				".$this->__f__567d0a69100214f3766c19a0eaf9b7fc($lastvisit,$stats,$cat_data,$show_side_blocks,$side_blocks,$_data)."			") : ("")) . "
...
{
$count_6c93fe27365c07ea0b0d357ecc811e30 = is_array($this->functionData['hookRecentTopics']) ? count($this->functionData['hookRecentTopics']) : 0;
$this->functionData['hookRecentTopics'][$count_6c93fe27365c07ea0b0d357ecc811e30]['topics'] = $topics;
}
...
<div class='ipsSideBlock clearfix'>
	...
	<div class='_sbcollapsable'>
		...
		".$this->__f__ebfe65253ba7ddfcd8a06f633daf40aa($topics)."		</ul>
	</div>
</div>
") : ("")) . "";
return $IPBHTML;
...
function __f__ebfe65253ba7ddfcd8a06f633daf40aa($topics)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $topics as $r )
