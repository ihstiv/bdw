...
$this->_funcHooks['sendNewPersonalTopicForm'] = array('newtopicerrors','newTopicError','formReloadInvite','formReloadCopy','newTopicInvite');
$this->_funcHooks['sendReplyForm'] = array('newtopicerrors','replyForm','formErrors','formHeaderText','replyOptions');
...
{
$count_e321100573871fcd890caa35ba9c8677 = is_array($this->functionData['messengerDisabled']) ? count($this->functionData['messengerDisabled']) : 0;
}
...
{
$count_6b13d86a6756ff44ecb34f98a12693e6 = is_array($this->functionData['messengerTemplate']) ? count($this->functionData['messengerTemplate']) : 0;
$this->functionData['messengerTemplate'][$count_6b13d86a6756ff44ecb34f98a12693e6]['html'] = $html;
$this->functionData['messengerTemplate'][$count_6b13d86a6756ff44ecb34f98a12693e6]['jumpmenu'] = $jumpmenu;
$this->functionData['messengerTemplate'][$count_6b13d86a6756ff44ecb34f98a12693e6]['dirData'] = $dirData;
$this->functionData['messengerTemplate'][$count_6b13d86a6756ff44ecb34f98a12693e6]['totalData'] = $totalData;
$this->functionData['messengerTemplate'][$count_6b13d86a6756ff44ecb34f98a12693e6]['topicParticipants'] = $topicParticipants;
$this->functionData['messengerTemplate'][$count_6b13d86a6756ff44ecb34f98a12693e6]['inlineError'] = $inlineError;
$this->functionData['messengerTemplate'][$count_6b13d86a6756ff44ecb34f98a12693e6]['deletedTopic'] = $deletedTopic;
}
$IPBHTML .= "<div class='master_list'>
	...
	" . ((is_array( $topicParticipants ) and count( $topicParticipants )) ? ("
		...
		".$this->__f__ceb48ac616075f4c773f7707b71e88f8($html,$jumpmenu,$dirData,$totalData,$topicParticipants,$inlineError,$deletedTopic)."	") : ("")) . "				
	...
	" . (($this->settings['_hideFolders'] != 1) ? ("<h3>{$this->lang->words['folders']} " . (($this->memberData['g_max_messages'] > 0) ? ("<span class='subtext'>{$totalData['full_percent']}% {$this->lang->words['full']}</span>") : ("")) . "</h3>
		...
		" . ((count($dirData)) ? ("
			".$this->__f__616d9b6caf21610768b741dddf13844d($html,$jumpmenu,$dirData,$totalData,$topicParticipants,$inlineError,$deletedTopic)."		") : ("")) . "") : ("")) . "
</div>";
return $IPBHTML;
}


function __f__ceb48ac616075f4c773f7707b71e88f8($html, $jumpmenu, $dirData, $totalData=array(), $topicParticipants=array(), $inlineError='', $deletedTopic=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__616d9b6caf21610768b741dddf13844d($html, $jumpmenu, $dirData, $totalData=array(), $topicParticipants=array(), $inlineError='', $deletedTopic=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_82bdba53b8ccbe6499adccc1cca0499e = is_array($this->functionData['sendNewPersonalTopicForm']) ? count($this->functionData['sendNewPersonalTopicForm']) : 0;
$this->functionData['sendNewPersonalTopicForm'][$count_82bdba53b8ccbe6499adccc1cca0499e]['displayData'] = $displayData;
}
...
<form id='msgForm' class='ipsForm_vertical' action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "module=messaging&amp;section=send&amp;do=send", "publicWithApp",'' ), "", "" ) . "\" method=\"post\" enctype='multipart/form-data'>
	" . (($displayData['errors']) ? ("
		<div class='message error'>
			...
			".$this->__f__067e0c29fd7a0a68332f8e4bad50aa37($displayData)."			{$this->lang->words['pme_none_sent']}
		</div>
	") : ("")) . "
...
function __f__067e0c29fd7a0a68332f8e4bad50aa37($displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_4bd190c6b2fbb7e920ec6ce73af7c5a2 = is_array($this->functionData['sendReplyForm']) ? count($this->functionData['sendReplyForm']) : 0;
$this->functionData['sendReplyForm'][$count_4bd190c6b2fbb7e920ec6ce73af7c5a2]['displayData'] = $displayData;
}
$IPBHTML .= "" . (($this->settings['_hideFolders'] = 1) ? ("") : ("")) . "
...
" . (($displayData['errors']) ? ("
	<div class='message error'>
		<strong>{$this->lang->words['err_errors']}</strong><br />
		".$this->__f__5720956124153baa50e63477f141067a($displayData)."		{$this->lang->words['pme_none_sent']}
	</div>
") : ("")) . "
" . (($displayData['type'] == 'reply') ? ("
...
function __f__5720956124153baa50e63477f141067a($displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $displayData['errors'] as $_error )
...
{
$count_9bf5d41db2bc4fb39702827d042e6eef = is_array($this->functionData['showConversation']) ? count($this->functionData['showConversation']) : 0;
$this->functionData['showConversation'][$count_9bf5d41db2bc4fb39702827d042e6eef]['topic'] = $topic;
$this->functionData['showConversation'][$count_9bf5d41db2bc4fb39702827d042e6eef]['replies'] = $replies;
$this->functionData['showConversation'][$count_9bf5d41db2bc4fb39702827d042e6eef]['members'] = $members;
$this->functionData['showConversation'][$count_9bf5d41db2bc4fb39702827d042e6eef]['jump'] = $jump;
}
$IPBHTML .= "<div class='controls'>
	...
	{$topic['_pages']}
</div>".$this->__f__6ac531e20e4b67a2d37576ed1e25cf3b($topic,$replies,$members,$jump)."<div class='controls'>
	<div class='buttons'>
...
function __f__6ac531e20e4b67a2d37576ed1e25cf3b($topic, $replies, $members, $jump="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1c3d1d4ffc36ba39344b1da1907a1d3d = is_array($this->functionData['showConversationForArchive']) ? count($this->functionData['showConversationForArchive']) : 0;
$this->functionData['showConversationForArchive'][$count_1c3d1d4ffc36ba39344b1da1907a1d3d]['topic'] = $topic;
$this->functionData['showConversationForArchive'][$count_1c3d1d4ffc36ba39344b1da1907a1d3d]['replies'] = $replies;
$this->functionData['showConversationForArchive'][$count_1c3d1d4ffc36ba39344b1da1907a1d3d]['members'] = $members;
}
...
$IPBHTML .= "<html>
	...
	<body>
		...
		<br />
		<br />
		".$this->__f__273b5a2d6eb171e49a46d2eb713f2b33($topic,$replies,$members)."	</body>
</html>";
return $IPBHTML;
}


function __f__273b5a2d6eb171e49a46d2eb713f2b33($topic, $replies, $members)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $replies as $msg_id => $msg )
...
{
$count_176009a97f96512d3cffe39ec9b8e19d = is_array($this->functionData['showFolder']) ? count($this->functionData['showFolder']) : 0;
$this->functionData['showFolder'][$count_176009a97f96512d3cffe39ec9b8e19d]['messages'] = $messages;
$this->functionData['showFolder'][$count_176009a97f96512d3cffe39ec9b8e19d]['dirname'] = $dirname;
$this->functionData['showFolder'][$count_176009a97f96512d3cffe39ec9b8e19d]['pages'] = $pages;
$this->functionData['showFolder'][$count_176009a97f96512d3cffe39ec9b8e19d]['currentFolderID'] = $currentFolderID;
$this->functionData['showFolder'][$count_176009a97f96512d3cffe39ec9b8e19d]['jumpFolderHTML'] = $jumpFolderHTML;
}
...
" . ((count( $messages )) ? ("
		".$this->__f__c95730f6bf785718384e9ce5db08f3d1($messages,$dirname,$pages,$currentFolderID,$jumpFolderHTML)."") : ("
...
function __f__c95730f6bf785718384e9ce5db08f3d1($messages, $dirname, $pages, $currentFolderID, $jumpFolderHTML)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_6ff1755b841ce55f6e0651facc7048e1 = is_array($this->functionData['showSearchResults']) ? count($this->functionData['showSearchResults']) : 0;
$this->functionData['showSearchResults'][$count_6ff1755b841ce55f6e0651facc7048e1]['messages'] = $messages;
$this->functionData['showSearchResults'][$count_6ff1755b841ce55f6e0651facc7048e1]['pages'] = $pages;
$this->functionData['showSearchResults'][$count_6ff1755b841ce55f6e0651facc7048e1]['error'] = $error;
}
...
<div id='message_list'>
		<table class='ipb_table' id='message_table'>
			...
			" . ((count( $messages )) ? ("
								".$this->__f__fa5a021ce21efa8cff48439dc9b27885($messages,$pages,$error)."			") : ("
				<tr>
...
function __f__fa5a021ce21efa8cff48439dc9b27885($messages, $pages, $error)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $messages as $id => $msg )
