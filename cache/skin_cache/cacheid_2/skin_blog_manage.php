...
class skin_blog_manage_2 extends skinMaster{
...
{
$count_d8ac84d381f86342a46bcc887c2c7812 = is_array($this->functionData['create2']) ? count($this->functionData['create2']) : 0;
$this->functionData['create2'][$count_d8ac84d381f86342a46bcc887c2c7812]['blog'] = $blog;
$this->functionData['create2'][$count_d8ac84d381f86342a46bcc887c2c7812]['errors'] = $errors;
}
...
{
$count_a95232c290c9502a4b270935b2b6985c = is_array($this->functionData['listCategories']) ? count($this->functionData['listCategories']) : 0;
$this->functionData['listCategories'][$count_a95232c290c9502a4b270935b2b6985c]['blog'] = $blog;
}
	...
	<table class=\"ipb_table\">
		<tr class=\"header\">
			...
			<th class='col_mod'></th>
				...
				".$this->__f__d1d753800fb996395376640bc871a0a2($blog)."	</table>
...
function __f__d1d753800fb996395376640bc871a0a2($blog=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_66d87fa655d90e463d5d9bdf9bdea871 = is_array($this->functionData['manageComments']) ? count($this->functionData['manageComments']) : 0;
$this->functionData['manageComments'][$count_66d87fa655d90e463d5d9bdf9bdea871]['comments'] = $comments;
$this->functionData['manageComments'][$count_66d87fa655d90e463d5d9bdf9bdea871]['blog'] = $blog;
$this->functionData['manageComments'][$count_66d87fa655d90e463d5d9bdf9bdea871]['pagination'] = $pagination;
}
...
" . ((is_array( $comments ) && count( $comments )) ? ("<div class='ipsBox'>
		".$this->__f__f2a78b70580e8a832a74818792fa7c24($comments,$blog,$pagination)."	</div>
	" . (($this->memberData['g_blog_allowownmod']) ? ("
			<div class='bar altbar moderation_bar with_action'>
...
function __f__f2a78b70580e8a832a74818792fa7c24($comments, $blog, $pagination)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_c8444adcbff87d3abfe21bc90a0f4eb9 = is_array($this->functionData['manageDashboard']) ? count($this->functionData['manageDashboard']) : 0;
$this->functionData['manageDashboard'][$count_c8444adcbff87d3abfe21bc90a0f4eb9]['myBlogs'] = $myBlogs;
$this->functionData['manageDashboard'][$count_c8444adcbff87d3abfe21bc90a0f4eb9]['latestComments'] = $latestComments;
$this->functionData['manageDashboard'][$count_c8444adcbff87d3abfe21bc90a0f4eb9]['error'] = $error;
$this->functionData['manageDashboard'][$count_c8444adcbff87d3abfe21bc90a0f4eb9]['dropdown'] = $dropdown;
}
...
<div class='ipsLayout " . ((is_array( $latestComments ) && count( $latestComments )) ? ("ipsLayout_withright ipsLayout_bigright") : ("")) . " clearfix'>
		...
		<table class='ipb_table' summary=\"{$this->lang->words['your_current_blogs']}\">
			<tr class='header'>
				...
				<th scope='col' class='short' width=\"10%\">{$this->lang->words['your_blogs_comments']}</th>
						...
						".$this->__f__9ce25f1339f03353f9c3cb271a7782b7($myBlogs,$latestComments,$error,$dropdown)."		</table>
		<br />
	</div>
	" . ((is_array( $latestComments ) && count( $latestComments )) ? ("<div class='ipsLayout_right'>
			...
			<div class='ipsBox'>
				".$this->__f__1aa590a74c4a93a03d75a92ef77adcba($myBlogs,$latestComments,$error,$dropdown)."			</div>
...
function __f__9ce25f1339f03353f9c3cb271a7782b7($myBlogs=array(), $latestComments=array(), $error='', $dropdown='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__1aa590a74c4a93a03d75a92ef77adcba($myBlogs=array(), $latestComments=array(), $error='', $dropdown='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ca0a790286dd1083d523a8bfb9d86c91 = is_array($this->functionData['rssImportForm']) ? count($this->functionData['rssImportForm']) : 0;
$this->functionData['rssImportForm'][$count_ca0a790286dd1083d523a8bfb9d86c91]['blog'] = $blog;
$this->functionData['rssImportForm'][$count_ca0a790286dd1083d523a8bfb9d86c91]['data'] = $data;
$this->functionData['rssImportForm'][$count_ca0a790286dd1083d523a8bfb9d86c91]['error'] = $error;
$this->functionData['rssImportForm'][$count_ca0a790286dd1083d523a8bfb9d86c91]['tagBox'] = $tagBox;
}
				...
				<li class='ipsField ipsField_select'>
					...
					<p class='ipsField_content'>
						<select name='rss_cats[]' id='rss_cats' multiple='true' size='5'>
							" . ((is_array($data['_cats']) AND count($data['_cats'])) ? ("".$this->__f__58a730f5cc71119026dd89af9d7e41e0($blog,$data,$error,$tagBox)."							") : ("")) . "
						</select>
...
function __f__58a730f5cc71119026dd89af9d7e41e0($blog, $data, $error, $tagBox)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_126193a48c62201ac9e6f8b7b855f678 = is_array($this->functionData['settingsForm']) ? count($this->functionData['settingsForm']) : 0;
$this->functionData['settingsForm'][$count_126193a48c62201ac9e6f8b7b855f678]['blog'] = $blog;
$this->functionData['settingsForm'][$count_126193a48c62201ac9e6f8b7b855f678]['error'] = $error;
}
$IPBHTML .= "<script type=\"text/javascript\">
								...
								<ul>
									...
									<li class='field' id='list_blog_view_level'>
										...
										<select class='input_select blogform' name='blog_view_level' id='blog_view_level'>
											".$this->__f__51ace99bf035a5ed773046a6d336ced2($blog,$error)."										</select>
									</li>
								</ul>
								</fieldset>
							</td>
					...
					<tr class=\"row1\">
						<td valign=\"top\">
							...
							<fieldset>
								...
								<ul>
								".$this->__f__30ff5292ab5842e18147656d8d2b5208($blog,$error)."								</ul>
							</fieldset>
							") : ("
...
function __f__51ace99bf035a5ed773046a6d336ced2($blog, $error='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__30ff5292ab5842e18147656d8d2b5208($blog, $error='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
