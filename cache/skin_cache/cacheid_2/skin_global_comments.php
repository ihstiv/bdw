...
{
$count_8b292c41aaa4a51bea097c3867b6d653 = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_8b292c41aaa4a51bea097c3867b6d653]['comments'] = $comments;
$this->functionData['commentsList'][$count_8b292c41aaa4a51bea097c3867b6d653]['settings'] = $settings;
$this->functionData['commentsList'][$count_8b292c41aaa4a51bea097c3867b6d653]['pages'] = $pages;
$this->functionData['commentsList'][$count_8b292c41aaa4a51bea097c3867b6d653]['parent'] = $parent;
$this->functionData['commentsList'][$count_8b292c41aaa4a51bea097c3867b6d653]['preReply'] = $preReply;
}
...
<div class='comment_wrap' id='comment_wrap'>
	".$this->__f__4d913c2b541b49783a57a4d5fcfd5b96($comments,$settings,$pages,$parent,$preReply)."</div>
" . (($parent['_canComment']) ? ("
...
function __f__4d913c2b541b49783a57a4d5fcfd5b96($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_a48c264a98e80eba05172d72d319c123 = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_a48c264a98e80eba05172d72d319c123]['comment'] = $comment;
$this->functionData['form'][$count_a48c264a98e80eba05172d72d319c123]['parent'] = $parent;
$this->functionData['form'][$count_a48c264a98e80eba05172d72d319c123]['editor'] = $editor;
$this->functionData['form'][$count_a48c264a98e80eba05172d72d319c123]['settings'] = $settings;
$this->functionData['form'][$count_a48c264a98e80eba05172d72d319c123]['errors'] = $errors;
$this->functionData['form'][$count_a48c264a98e80eba05172d72d319c123]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
