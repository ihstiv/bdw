...
{
$count_f769fff933cab2e8952450dbaacac11d = is_array($this->functionData['showLogInForm']) ? count($this->functionData['showLogInForm']) : 0;
$this->functionData['showLogInForm'][$count_f769fff933cab2e8952450dbaacac11d]['message'] = $message;
$this->functionData['showLogInForm'][$count_f769fff933cab2e8952450dbaacac11d]['referer'] = $referer;
$this->functionData['showLogInForm'][$count_f769fff933cab2e8952450dbaacac11d]['extra_form'] = $extra_form;
$this->functionData['showLogInForm'][$count_f769fff933cab2e8952450dbaacac11d]['login_methods'] = $login_methods;
}
