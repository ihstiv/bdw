...
{
$count_7a044a5aacaf5f665371c609bb6e6efc = is_array($this->functionData['group_strip']) ? count($this->functionData['group_strip']) : 0;
$this->functionData['group_strip'][$count_7a044a5aacaf5f665371c609bb6e6efc]['group'] = $group;
$this->functionData['group_strip'][$count_7a044a5aacaf5f665371c609bb6e6efc]['members'] = $members;
$this->functionData['group_strip'][$count_7a044a5aacaf5f665371c609bb6e6efc]['pagination'] = $pagination;
}
...
<table class='ipb_table ipsMemberList'>
	...
	" . ((count($members) AND is_array($members)) ? ("
				".$this->__f__93867b8ab120b4e973dd73575c953614($group,$members,$pagination)."	") : ("")) . "
</table>
" . (($pagination) ? ("
	<div class='topic_controls'>{$pagination}</div>
") : ("")) . "
...
function __f__e52cf1849e4317d8565672ace025bea3($group="", $members=array(), $pagination='',$info='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__3b3b45e7041dc0f814c1b0a4365dafae($group="", $members=array(), $pagination='',$info='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $info['forums'] as $id => $name )
...
function __f__93867b8ab120b4e973dd73575c953614($group="", $members=array(), $pagination='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
			...
			<tr class='" .  IPSLib::next( $this->registry->templateStriping["staff"] ) . "'>
				...
				<td class='altrow short'>
					" . ((is_array($info['forums'])) ? ("" . ((empty( $info['forums'] )) ? ("
							--
						") : ("" . ((count( $info['forums'] ) == 1) ? ("
								".$this->__f__e52cf1849e4317d8565672ace025bea3($group,$members,$pagination,$info)."							") : ("
								...
								".$this->__f__3b3b45e7041dc0f814c1b0a4365dafae($group,$members,$pagination,$info)."								</ul>
...
{
$count_5a4e92f9ad39eaff4bef0008127e5a22 = is_array($this->functionData['top_posters']) ? count($this->functionData['top_posters']) : 0;
$this->functionData['top_posters'][$count_5a4e92f9ad39eaff4bef0008127e5a22]['rows'] = $rows;
}
...
<table class='ipb_table ipsMemberList'>
	...
	") : ("
				".$this->__f__815b56d2e6f203c61e7e475840d3a18d($rows)."	")) . "
</table>";
return $IPBHTML;
}


function __f__815b56d2e6f203c61e7e475840d3a18d($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_f5968ec126a36c0260403d1319474b59 = is_array($this->functionData['whoPosted']) ? count($this->functionData['whoPosted']) : 0;
$this->functionData['whoPosted'][$count_f5968ec126a36c0260403d1319474b59]['tid'] = $tid;
$this->functionData['whoPosted'][$count_f5968ec126a36c0260403d1319474b59]['title'] = $title;
$this->functionData['whoPosted'][$count_f5968ec126a36c0260403d1319474b59]['rows'] = $rows;
}
...
<div class='fixed_inner'>
	<table class='ipb_table'>
		...
		" . ((count($rows) AND is_array($rows)) ? ("
						".$this->__f__271fd23686dc841607cddfc0ea734885($tid,$title,$rows)."		") : ("")) . "
	</table>
</div>";
return $IPBHTML;
}
...
function __f__271fd23686dc841607cddfc0ea734885($tid=0, $title="", $rows=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
