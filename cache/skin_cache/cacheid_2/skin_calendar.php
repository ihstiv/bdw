...
{
$count_1ccf1c7294bd830747e30b27a2dd6028 = is_array($this->functionData['bbCodeEvent']) ? count($this->functionData['bbCodeEvent']) : 0;
$this->functionData['bbCodeEvent'][$count_1ccf1c7294bd830747e30b27a2dd6028]['event'] = $event;
$this->functionData['bbCodeEvent'][$count_1ccf1c7294bd830747e30b27a2dd6028]['type'] = $type;
$this->functionData['bbCodeEvent'][$count_1ccf1c7294bd830747e30b27a2dd6028]['ends'] = $ends;
}
...
{
$count_1b98096574377150c1d068fc5d640470 = is_array($this->functionData['boardIndexCalEvents']) ? count($this->functionData['boardIndexCalEvents']) : 0;
$this->functionData['boardIndexCalEvents'][$count_1b98096574377150c1d068fc5d640470]['events'] = $events;
}
		...
		<div class='_sbcollapsable'>
			" . ((is_array( $events )) ? ("
				<ul itemscope itemtype=\"http://schema.org/Event\" class='ipsList_withminiphoto'>
					".$this->__f__0289eea86c43bab084971054aa665b2c($events)."				</ul>
			") : ("
...
function __f__0289eea86c43bab084971054aa665b2c($events)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_74dfc131a76e4482cc0e50f6e7f38a05 = is_array($this->functionData['cal_date_cell']) ? count($this->functionData['cal_date_cell']) : 0;
$this->functionData['cal_date_cell'][$count_74dfc131a76e4482cc0e50f6e7f38a05]['day'] = $day;
$this->functionData['cal_date_cell'][$count_74dfc131a76e4482cc0e50f6e7f38a05]['events'] = $events;
$this->functionData['cal_date_cell'][$count_74dfc131a76e4482cc0e50f6e7f38a05]['cal_date_queued'] = $cal_date_queued;
$this->functionData['cal_date_cell'][$count_74dfc131a76e4482cc0e50f6e7f38a05]['queued'] = $queued;
$this->functionData['cal_date_cell'][$count_74dfc131a76e4482cc0e50f6e7f38a05]['js_id'] = $js_id;
}
$IPBHTML .= "<!--Day-->
...
{
$count_ba7de5e36930f1501bc59df29cbb0521 = is_array($this->functionData['cal_date_cell_today']) ? count($this->functionData['cal_date_cell_today']) : 0;
$this->functionData['cal_date_cell_today'][$count_ba7de5e36930f1501bc59df29cbb0521]['day'] = $day;
$this->functionData['cal_date_cell_today'][$count_ba7de5e36930f1501bc59df29cbb0521]['events'] = $events;
$this->functionData['cal_date_cell_today'][$count_ba7de5e36930f1501bc59df29cbb0521]['cal_date_queued'] = $cal_date_queued;
$this->functionData['cal_date_cell_today'][$count_ba7de5e36930f1501bc59df29cbb0521]['queued'] = $queued;
$this->functionData['cal_date_cell_today'][$count_ba7de5e36930f1501bc59df29cbb0521]['js_id'] = $js_id;
}
$IPBHTML .= "<!--Day-->
...
{
$count_392676d8337b06179723534b0cbbaa9c = is_array($this->functionData['cal_week_dayentry']) ? count($this->functionData['cal_week_dayentry']) : 0;
$this->functionData['cal_week_dayentry'][$count_392676d8337b06179723534b0cbbaa9c]['wday'] = $wday;
$this->functionData['cal_week_dayentry'][$count_392676d8337b06179723534b0cbbaa9c]['date'] = $date;
$this->functionData['cal_week_dayentry'][$count_392676d8337b06179723534b0cbbaa9c]['month'] = $month;
$this->functionData['cal_week_dayentry'][$count_392676d8337b06179723534b0cbbaa9c]['mid'] = $mid;
$this->functionData['cal_week_dayentry'][$count_392676d8337b06179723534b0cbbaa9c]['year'] = $year;
$this->functionData['cal_week_dayentry'][$count_392676d8337b06179723534b0cbbaa9c]['events'] = $events;
$this->functionData['cal_week_dayentry'][$count_392676d8337b06179723534b0cbbaa9c]['queued'] = $queued;
}
...
{
$count_75ea43f16d4acbd7251365d0b8cecfe3 = is_array($this->functionData['calendar_likeSummaryContents']) ? count($this->functionData['calendar_likeSummaryContents']) : 0;
$this->functionData['calendar_likeSummaryContents'][$count_75ea43f16d4acbd7251365d0b8cecfe3]['data'] = $data;
$this->functionData['calendar_likeSummaryContents'][$count_75ea43f16d4acbd7251365d0b8cecfe3]['relId'] = $relId;
$this->functionData['calendar_likeSummaryContents'][$count_75ea43f16d4acbd7251365d0b8cecfe3]['opts'] = $opts;
}
...
{
$count_8ace1eb5adf1f01b7e912ab424783f14 = is_array($this->functionData['calendarBirthdayList']) ? count($this->functionData['calendarBirthdayList']) : 0;
$this->functionData['calendarBirthdayList'][$count_8ace1eb5adf1f01b7e912ab424783f14]['rows'] = $rows;
}
	...
	<div id='member_wrap'>
		<ul class='members'>
			" . ((is_array( $rows ) and count( $rows )) ? ("
								".$this->__f__e0c18139634b0b5a635fe57ba3f3e53e($rows)."			") : ("
...
function __f__e0c18139634b0b5a635fe57ba3f3e53e($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_089d10242367b3f75370a7df18092d28 = is_array($this->functionData['calendarEventForm']) ? count($this->functionData['calendarEventForm']) : 0;
$this->functionData['calendarEventForm'][$count_089d10242367b3f75370a7df18092d28]['data'] = $data;
}
...
{
$count_438b4cde478094720f2783d34489cfc0 = is_array($this->functionData['calendarEventsList']) ? count($this->functionData['calendarEventsList']) : 0;
$this->functionData['calendarEventsList'][$count_438b4cde478094720f2783d34489cfc0]['data'] = $data;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("topic", "0" ) . "
...
<div id='mini_calendars' class='left calendar_wrap'>
	<div id='calendar_list' class='left general_box'>
		...
		<ol>
			".$this->__f__61181297748eb37e04d69c2f8253f4df($data)."		</ol>
		") : ("")) . "
...
function __f__61181297748eb37e04d69c2f8253f4df($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_6d2b8b0cb494ed64f72825bb758b3bb4 = is_array($this->functionData['calendarJump']) ? count($this->functionData['calendarJump']) : 0;
$this->functionData['calendarJump'][$count_6d2b8b0cb494ed64f72825bb758b3bb4]['calendars'] = $calendars;
$this->functionData['calendarJump'][$count_6d2b8b0cb494ed64f72825bb758b3bb4]['calendar'] = $calendar;
$this->functionData['calendarJump'][$count_6d2b8b0cb494ed64f72825bb758b3bb4]['chosen_date'] = $chosen_date;
}
$IPBHTML .= "" . ((is_array( $calendars ) && count( $calendars ) > 1) ? ("
	...
	<ul class='ipbmenu_content' style='display: none' id='calendar_chooser_menucontent'>
		".$this->__f__2ae42062c86f8acdb061b0d255a10fcb($calendars,$calendar,$chosen_date)."	</ul>
	<script type='text/javascript'>
...
function __f__2ae42062c86f8acdb061b0d255a10fcb($calendars, $calendar, $chosen_date=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_5a87197102d06b2e72aea2dd5fca736f = is_array($this->functionData['calendarMainContent']) ? count($this->functionData['calendarMainContent']) : 0;
$this->functionData['calendarMainContent'][$count_5a87197102d06b2e72aea2dd5fca736f]['data'] = $data;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("calendar", "0" ) . "
<h2>{$this->lang->words['calendars']}</h2>
<div id='current_calendar' class='right calendar_wrap'>
	...
	<table id='calendar_table' class='ipb_table vcalendar' summary=\"{$this->lang->words['calendar_for']} {$data['month_title']} {$data['chosen_date']['year']}\">
		...
		<tr class='header'>
			...
			".$this->__f__f618d91191c093c5a95f5a9a4d777dd6($data)."			{$data['events']}
		</tr>
	</table>
...
<div id='mini_calendars' class='left calendar_wrap'>
	<div id='calendar_list' class='general_box'>
		...
		<p><strong>{$this->lang->words['select_calendar']}</strong></p>
		<ol>
			".$this->__f__1531447995b636a869e4872ad38bf099($data)."		</ol>
		") : ("")) . "
		<strong>{$this->lang->words['jump_to']}</strong><br />
		<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=calendar&amp;module=calendar&amp;section=view&amp;cal_id={$data['calendar']['cal_id']}", "public",'' ), "{$data['calendar']['cal_title_seo']}", "cal_calendar" ) . "\" method=\"post\">
			<fieldset>
...
function __f__f618d91191c093c5a95f5a9a4d777dd6($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__1531447995b636a869e4872ad38bf099($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data['calendars'] as $cid => $cal )
...
{
$count_dd8371ab3384eeb5d3e46547bb97a209 = is_array($this->functionData['calendarWeekView']) ? count($this->functionData['calendarWeekView']) : 0;
$this->functionData['calendarWeekView'][$count_dd8371ab3384eeb5d3e46547bb97a209]['data'] = $data;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("calendar", "0" ) . "
<h2>{$this->lang->words['calendars']}</h2>
<div id='current_calendar' class='right calendar_wrap'>
...
<div id='mini_calendars' class='left calendar_wrap'>
	<div id='calendar_list' class='left general_box'>
		...
		<p><strong>{$this->lang->words['select_calendar']}</strong></p>
		<ol>
			".$this->__f__474108779f5c6a36b120f8621513c351($data)."		</ol>
		") : ("")) . "
		<strong>{$this->lang->words['jump_to']}</strong><br />
		<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=calendar&amp;module=calendar&amp;section=view&amp;cal_id={$data['calendar']['cal_id']}", "public",'' ), "{$data['calendar']['cal_title_seo']}", "cal_calendar" ) . "\" method=\"post\">
			<fieldset>
...
function __f__474108779f5c6a36b120f8621513c351($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data['calendars'] as $cid => $cal )
...
{
$count_775531b68a1009a6dd806b1dda911f63 = is_array($this->functionData['calEventFollowedWrapper']) ? count($this->functionData['calEventFollowedWrapper']) : 0;
$this->functionData['calEventFollowedWrapper'][$count_775531b68a1009a6dd806b1dda911f63]['rows'] = $rows;
}
$IPBHTML .= "<div id='search_results'>
	<ol>
		".$this->__f__5a9368a05ed06aede9c775ab8fc0baf9($rows)."	</ol>
</div>";
return $IPBHTML;
}


function __f__5a9368a05ed06aede9c775ab8fc0baf9($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_c8414458da80c5359b9f577ec6129bff = is_array($this->functionData['calEventSearchResult']) ? count($this->functionData['calEventSearchResult']) : 0;
$this->functionData['calEventSearchResult'][$count_c8414458da80c5359b9f577ec6129bff]['r'] = $r;
$this->functionData['calEventSearchResult'][$count_c8414458da80c5359b9f577ec6129bff]['resultAsTitle'] = $resultAsTitle;
$this->functionData['calEventSearchResult'][$count_c8414458da80c5359b9f577ec6129bff]['type'] = $type;
$this->functionData['calEventSearchResult'][$count_c8414458da80c5359b9f577ec6129bff]['ends'] = $ends;
}
...
{
$count_22185b165d1937a51a6de3324e82b8e4 = is_array($this->functionData['event_likeSummaryContents']) ? count($this->functionData['event_likeSummaryContents']) : 0;
$this->functionData['event_likeSummaryContents'][$count_22185b165d1937a51a6de3324e82b8e4]['data'] = $data;
$this->functionData['event_likeSummaryContents'][$count_22185b165d1937a51a6de3324e82b8e4]['relId'] = $relId;
$this->functionData['event_likeSummaryContents'][$count_22185b165d1937a51a6de3324e82b8e4]['opts'] = $opts;
}
$IPBHTML .= "<span class='ipsButton_extra right " . (($data['totalCount']) ? ("_fmore clickable") : ("")) . "' title='" . sprintf( $this->lang->words['like_totalcount_' . $data['vernacular'] ], $data['totalCount'] ) . "' data-tooltip=\"" . sprintf( $this->lang->words['like_totalcount_' . $data['vernacular'] ], $data['totalCount'] ) . "\"><img src='{$this->settings['img_url']}/icon_users.png' /> <strong>{$data['totalCount']}</strong></span>
" . (($this->memberData['member_id']) ? ("<a href='#' title=\"" . (($data['iLike']) ? ("" . sprintf( $this->lang->words['fave_tt_on'], $this->lang->words['like_ucfirst_un' . $data['vernacular'] ]) . "") : ("" . sprintf( $this->lang->words['fave_tt_off'], $this->lang->words['like_ucfirst_' . $data['vernacular'] ]) . "")) . "\" class='ftoggle ipsButton_secondary'>" . (($data['iLike']) ? ("" . sprintf( $this->lang->words['unset_fave_button'], $this->lang->words['like_ucfirst_un' . $data['vernacular'] ]) . "") : ("" . sprintf( $this->lang->words['set_fave_button'], $this->lang->words['like_ucfirst_' . $data['vernacular'] ]) . "")) . "</a>") : ("")) . "";
return $IPBHTML;
...
{
$count_597936ae4cf745fd921bc5e14ff94611 = is_array($this->functionData['eventAttendee']) ? count($this->functionData['eventAttendee']) : 0;
$this->functionData['eventAttendee'][$count_597936ae4cf745fd921bc5e14ff94611]['member'] = $member;
$this->functionData['eventAttendee'][$count_597936ae4cf745fd921bc5e14ff94611]['event'] = $event;
}
...
{
$count_e11db2a407aec5cb393fee3a9bfe9580 = is_array($this->functionData['followedContentCalendars']) ? count($this->functionData['followedContentCalendars']) : 0;
$this->functionData['followedContentCalendars'][$count_e11db2a407aec5cb393fee3a9bfe9580]['rows'] = $rows;
}
$IPBHTML .= "<div id='search_results'>
	<ol>
		".$this->__f__fa02fd9f7603cf7fb10a075116094bf5($rows)."	</ol>
</div>";
return $IPBHTML;
}


function __f__fa02fd9f7603cf7fb10a075116094bf5($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $r )
...
{
$count_d91ca87247e7eac17bb778b81ae0e21a = is_array($this->functionData['mini_cal_date_cell']) ? count($this->functionData['mini_cal_date_cell']) : 0;
$this->functionData['mini_cal_date_cell'][$count_d91ca87247e7eac17bb778b81ae0e21a]['day'] = $day;
}
$IPBHTML .= "<td>
...
{
$count_a51ccd97eaad456558e9059ab42c0c18 = is_array($this->functionData['mini_cal_date_cell_today']) ? count($this->functionData['mini_cal_date_cell_today']) : 0;
$this->functionData['mini_cal_date_cell_today'][$count_a51ccd97eaad456558e9059ab42c0c18]['day'] = $day;
}
...
{
$count_11963d5c55dedb852394320d4b5c7a15 = is_array($this->functionData['miniCalendarWrapper']) ? count($this->functionData['miniCalendarWrapper']) : 0;
$this->functionData['miniCalendarWrapper'][$count_11963d5c55dedb852394320d4b5c7a15]['data'] = $data;
}
...
$IPBHTML .= "<div class='mini-cal-wrap'>
	...
	<table class='mini_cal vcalendar'>
		<tr class='header'>
			...
			".$this->__f__afab6fce7f6c1447747e1286ef4366a7($data)."	
			{$data['events']}
		</tr>
	</table>
</div>";
...
function __f__afab6fce7f6c1447747e1286ef4366a7($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data['day_words'] as $day )
...
{
$count_91cdc79780520aa679f9eefc14d259b2 = is_array($this->functionData['modEventsWrapper']) ? count($this->functionData['modEventsWrapper']) : 0;
$this->functionData['modEventsWrapper'][$count_91cdc79780520aa679f9eefc14d259b2]['events'] = $events;
$this->functionData['modEventsWrapper'][$count_91cdc79780520aa679f9eefc14d259b2]['pages'] = $pages;
}
...
<div class='clearfix'>
	" . ((count($events)) ? ("
		".$this->__f__1ee64f4c8b62f394489ab77a94737990($events,$pages)."	") : ("
...
function __f__1ee64f4c8b62f394489ab77a94737990($events, $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $events as $event )
...
{
$count_29f9b6eea1e7b4c02e1f2103167ba7db = is_array($this->functionData['showEvent']) ? count($this->functionData['showEvent']) : 0;
$this->functionData['showEvent'][$count_29f9b6eea1e7b4c02e1f2103167ba7db]['event'] = $event;
$this->functionData['showEvent'][$count_29f9b6eea1e7b4c02e1f2103167ba7db]['member'] = $member;
$this->functionData['showEvent'][$count_29f9b6eea1e7b4c02e1f2103167ba7db]['typeInfo'] = $typeInfo;
$this->functionData['showEvent'][$count_29f9b6eea1e7b4c02e1f2103167ba7db]['like'] = $like;
}
			...
			" . (($event['event_rsvp']) ? ("<div class='event-rsvp'>
					...
					<ul id='attendee-list'>
						" . ((count($event['_rsvp_attendees'])) ? ("
														".$this->__f__af2a5772154c4b2812291625f482dc49($event,$member,$typeInfo,$like)."						") : ("
...
function __f__af2a5772154c4b2812291625f482dc49($event, $member, $typeInfo, $like='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ebe06f073721bae7de2f0ad78b16cb76 = is_array($this->functionData['showEventSimple']) ? count($this->functionData['showEventSimple']) : 0;
$this->functionData['showEventSimple'][$count_ebe06f073721bae7de2f0ad78b16cb76]['event'] = $event;
}
