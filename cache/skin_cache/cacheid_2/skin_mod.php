...
<br />".$this->__f__1b1ffb61f9f5ee39f6277c49c0a7eae7($polls,$tids)."";
return $IPBHTML;
}


function __f__dd5140f29d7d97469c6ffc7a5cbf1892($polls, $tids,$poll='',$questionID='',$questionData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__8810fb78b96c4ff6dbcbacd75f2666cd($polls, $tids,$poll='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( unserialize( stripslashes( $poll['choices'] ) ) as $questionID => $questionData )
	{
		...
		$_ips___x_retval .= "
			<div class='poll_question'>
				...
				<ol>
					".$this->__f__dd5140f29d7d97469c6ffc7a5cbf1892($polls,$tids,$poll,$questionID,$questionData)."				</ol>
			</div>
...
function __f__1b1ffb61f9f5ee39f6277c49c0a7eae7($polls, $tids)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	...
	<div class='general_box alt poll'>
		...
		".$this->__f__8810fb78b96c4ff6dbcbacd75f2666cd($polls,$tids,$poll)."		<fieldset class='submit'>
...
{
$count_f22af68b014a70461688ff1c47ff6ef6 = is_array($this->functionData['mergePostForm']) ? count($this->functionData['mergePostForm']) : 0;
$this->functionData['mergePostForm'][$count_f22af68b014a70461688ff1c47ff6ef6]['editor'] = $editor;
$this->functionData['mergePostForm'][$count_f22af68b014a70461688ff1c47ff6ef6]['dates'] = $dates;
$this->functionData['mergePostForm'][$count_f22af68b014a70461688ff1c47ff6ef6]['authors'] = $authors;
$this->functionData['mergePostForm'][$count_f22af68b014a70461688ff1c47ff6ef6]['uploads'] = $uploads;
$this->functionData['mergePostForm'][$count_f22af68b014a70461688ff1c47ff6ef6]['seoTitle'] = $seoTitle;
}
...
<input type='hidden' name='auth_key' value='{$this->member->form_hash}' />
<input type='hidden' name='do' value='postchoice' />".$this->__f__6b070914607d38c556bc650f6d16b1db($editor,$dates,$authors,$uploads,$seoTitle)."" . (($this->request['selectedpidsJS']) ? ("
	".$this->__f__715dda1c30e39bddbf159d94c3da3877($editor,$dates,$authors,$uploads,$seoTitle)."") : ("")) . "
...
<div class='post_form'>
			...
			<li class='field'>
				...
				<select name=\"postdate\" class=\"input_select\" id='post_date'>
					" . ((is_array($dates) AND count($dates)) ? ("
						".$this->__f__2d45afde75ed22c7f2377eb41d02686b($editor,$dates,$authors,$uploads,$seoTitle)."					") : ("")) . "
				</select>
			</li>
			<li class='field'>
				...
				<select name=\"postauthor\" class=\"input_select\" id='post_author'>
					" . ((is_array($authors) AND count($authors)) ? ("
						".$this->__f__a757c1b63813a785017eed11cd264a87($editor,$dates,$authors,$uploads,$seoTitle)."					") : ("")) . "
				</select>
			</li>
		</ul>
	...
	" . ((count($uploads)) ? ("
		<fieldset>
			...
			<table>
				".$this->__f__cde2f88119e5b08cfa2566adda79a2f4($editor,$dates,$authors,$uploads,$seoTitle)."			</table>
		</fieldset>
	") : ("")) . "
	<fieldset class='submit'>
...
function __f__6b070914607d38c556bc650f6d16b1db($editor, $dates, $authors, $uploads, $seoTitle)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__715dda1c30e39bddbf159d94c3da3877($editor, $dates, $authors, $uploads, $seoTitle)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__2d45afde75ed22c7f2377eb41d02686b($editor, $dates, $authors, $uploads, $seoTitle)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a757c1b63813a785017eed11cd264a87($editor, $dates, $authors, $uploads, $seoTitle)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__cde2f88119e5b08cfa2566adda79a2f4($editor, $dates, $authors, $uploads, $seoTitle)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_364bc4e9ed15b856ee06ef8139a8924b = is_array($this->functionData['movePostForm']) ? count($this->functionData['movePostForm']) : 0;
$this->functionData['movePostForm'][$count_364bc4e9ed15b856ee06ef8139a8924b]['forum'] = $forum;
$this->functionData['movePostForm'][$count_364bc4e9ed15b856ee06ef8139a8924b]['topic'] = $topic;
$this->functionData['movePostForm'][$count_364bc4e9ed15b856ee06ef8139a8924b]['posts'] = $posts;
$this->functionData['movePostForm'][$count_364bc4e9ed15b856ee06ef8139a8924b]['error'] = $error;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__3aed1872d808b483b9d13905152f8bed($forum,$topic,$posts,$error)."") : ("")) . "
<fieldset class='submit'>
...
function __f__3aed1872d808b483b9d13905152f8bed($forum, $topic, $posts, $error='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_834eb7c26c8f6d62d344dcda777d416b = is_array($this->functionData['moveTopicsForm']) ? count($this->functionData['moveTopicsForm']) : 0;
$this->functionData['moveTopicsForm'][$count_834eb7c26c8f6d62d344dcda777d416b]['forum'] = $forum;
$this->functionData['moveTopicsForm'][$count_834eb7c26c8f6d62d344dcda777d416b]['jump_html'] = $jump_html;
$this->functionData['moveTopicsForm'][$count_834eb7c26c8f6d62d344dcda777d416b]['topics'] = $topics;
}
$IPBHTML .= "<form action='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=moderate&amp;section=moderate", "public",'' ), "", "" ) . "' method='post'>
<input type='hidden' name='auth_key' value='{$this->member->form_hash}' />
	...
	<fieldset class='row1'>
		...
		<ul>
			" . ((count($topics) AND is_array($topics)) ? ("
				".$this->__f__735e5c983daaace6d0ac3caf66f9628b($forum,$jump_html,$topics)."			") : ("")) . "
		</ul>
	</fieldset>
	<fieldset class='row1'>
...
function __f__735e5c983daaace6d0ac3caf66f9628b($forum, $jump_html, $topics)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_44371948ba2481e021a8abe5f1528123 = is_array($this->functionData['pruneSplash']) ? count($this->functionData['pruneSplash']) : 0;
$this->functionData['pruneSplash'][$count_44371948ba2481e021a8abe5f1528123]['forum'] = $forum;
$this->functionData['pruneSplash'][$count_44371948ba2481e021a8abe5f1528123]['forums_html'] = $forums_html;
$this->functionData['pruneSplash'][$count_44371948ba2481e021a8abe5f1528123]['confirm_data'] = $confirm_data;
$this->functionData['pruneSplash'][$count_44371948ba2481e021a8abe5f1528123]['complete_html'] = $complete_html;
}
		...
		<ul>
			...
			<li class='field'>
				...
				<select class='input_select' name='topic_type' id=\"topic_type\">
					".$this->__f__cf0092f5f185109a64b361fdd4fb0297($forum,$forums_html,$confirm_data,$complete_html)."				</select>
			</li>
			<li class='field'>
...
function __f__cf0092f5f185109a64b361fdd4fb0297($forum="", $forums_html="", $confirm_data="", $complete_html="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
<form action='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=moderate&amp;section=moderate", "public",'' ), "", "" ) . "' id='mmForm' method='post'>
	...
	<input type='hidden' name='returnUrl' value='{$this->request['returnUrl']}' />
	<input type='hidden' name='return' value='{$this->request['return']}' />
	".$this->__f__9036edb4b66969168889e5bbaf4c3526($forum,$tids,$canHardDelete)."	<input type='hidden' name='tact' id='mmTact' value='sdelete' />
	<input type='hidden' name='f' value='{$forum['id']}' />
	<input type='hidden' name='st' value='{$this->request['st']}' />
...
function __f__9036edb4b66969168889e5bbaf4c3526($forum, $tids=array(), $canHardDelete=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tids as $t )
...
<input type='hidden' name='fromSearch' value='{$this->request['fromSearch']}' />
<input type='hidden' name='returnUrl' value='{$this->request['returnUrl']}' />
<input type='hidden' name='return' value='{$this->request['return']}' />".$this->__f__ab3b54e4f67092750ab81d0d11f134d2($forum,$topic,$pids,$canHardDelete)."<input type='hidden' name='tact' id='mmTact' value='sdelete' />
<input type='hidden' name='f' value='{$forum['id']}' />
<input type='hidden' name='t' value='{$topic['tid']}' />
<input type='hidden' name='st' value='{$this->request['st']}' />
...
function __f__ab3b54e4f67092750ab81d0d11f134d2($forum, $topic, $pids=array(), $canHardDelete=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $pids as $p )
...
{
$count_76650057eac522c27811a8dc1af54e80 = is_array($this->functionData['splitPostForm']) ? count($this->functionData['splitPostForm']) : 0;
$this->functionData['splitPostForm'][$count_76650057eac522c27811a8dc1af54e80]['forum'] = $forum;
$this->functionData['splitPostForm'][$count_76650057eac522c27811a8dc1af54e80]['topic'] = $topic;
$this->functionData['splitPostForm'][$count_76650057eac522c27811a8dc1af54e80]['posts'] = $posts;
$this->functionData['splitPostForm'][$count_76650057eac522c27811a8dc1af54e80]['jump'] = $jump;
}
...
<div class='generic_bar'></div>
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__5ec46eb22def779d82ee89213441b8fc($forum,$topic,$posts,$jump)."") : ("")) . "
<fieldset class='submit'>
...
function __f__5ec46eb22def779d82ee89213441b8fc($forum, $topic, $posts, $jump)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $posts as $row )
...
{
$count_636549a1763c31fd0653a203208ddd5b = is_array($this->functionData['topicHistory']) ? count($this->functionData['topicHistory']) : 0;
$this->functionData['topicHistory'][$count_636549a1763c31fd0653a203208ddd5b]['topic'] = $topic;
$this->functionData['topicHistory'][$count_636549a1763c31fd0653a203208ddd5b]['avg_post'] = $avg_post;
$this->functionData['topicHistory'][$count_636549a1763c31fd0653a203208ddd5b]['mod_logs'] = $mod_logs;
}
...
<table class='ipb_table' summary=\"{$this->lang->words['mod_logs_topic_summary']} '{$topic['title']}'\">
	...
	") : ("
				".$this->__f__a494471abaa754412f5336cdb837202a($topic,$avg_post,$mod_logs)."	")) . "
</table>";
return $IPBHTML;
}


function __f__a494471abaa754412f5336cdb837202a($topic, $avg_post, $mod_logs=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
