...
{
$count_e2a8ff97a6818cfb9de8f006f60553cd = is_array($this->functionData['asForumPosts']) ? count($this->functionData['asForumPosts']) : 0;
$this->functionData['asForumPosts'][$count_e2a8ff97a6818cfb9de8f006f60553cd]['data'] = $data;
}
$IPBHTML .= "<div class='row'>
	...
	{$this->lang->words['in']}
	".$this->__f__b085bfd2a6fcb10b6b76e37a13660844($data)."	
	" . ((isset( $data['pages'] ) AND is_array( $data['pages'] ) AND count( $data['pages'] )) ? ("
		<span class='mini_pagination'>
			".$this->__f__c68aaf451b410d7e6672ef214b919c97($data)."		</span>
	") : ("")) . "
	<br />
...
function __f__b085bfd2a6fcb10b6b76e37a13660844($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__c68aaf451b410d7e6672ef214b919c97($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_2b5b1926fde4dca5a38826997ef780cd = is_array($this->functionData['asForumTopics']) ? count($this->functionData['asForumTopics']) : 0;
$this->functionData['asForumTopics'][$count_2b5b1926fde4dca5a38826997ef780cd]['data'] = $data;
}
$IPBHTML .= "<div class='row touch-row " . ((!empty( $data['_unreadUrl'] )) ? ("unread") : ("")) . "' id=\"sr-{$data['type_id_2']}\">
	...
	<div class='rowContent'>
		...
		") : ("")) . "
		<div>
			" . ucfirst($this->lang->words['in']) . "".$this->__f__72a89fe56265ab7f13f3e449d9413517($data)."		</div>
...
function __f__72a89fe56265ab7f13f3e449d9413517($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data['_forum_trail'] as $i => $f )
...
{
$count_0a75bb72ed303fd2eb3c351275c713b2 = is_array($this->functionData['followData']) ? count($this->functionData['followData']) : 0;
$this->functionData['followData'][$count_0a75bb72ed303fd2eb3c351275c713b2]['followData'] = $followData;
}
...
{
$count_da3a0e3e5fc7056d9b613cf34e8ccc20 = is_array($this->functionData['followedContentForumsWrapper']) ? count($this->functionData['followedContentForumsWrapper']) : 0;
$this->functionData['followedContentForumsWrapper'][$count_da3a0e3e5fc7056d9b613cf34e8ccc20]['results'] = $results;
}
$IPBHTML .= "" . ((count($results)) ? ("".$this->__f__dbf104a05ec9209182f132bb2080341f($results)."") : ("")) . "";
return $IPBHTML;
}


function __f__dbf104a05ec9209182f132bb2080341f($results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_63aa0b984ab7b8738341d617c5beea41 = is_array($this->functionData['followedContentForumsWrapperForums']) ? count($this->functionData['followedContentForumsWrapperForums']) : 0;
$this->functionData['followedContentForumsWrapperForums'][$count_63aa0b984ab7b8738341d617c5beea41]['results'] = $results;
}
...
<div class='master_list'>
	".$this->__f__c5f8a6bb38a7141dfb99ad884b416367($results)."</div>";
return $IPBHTML;
}


function __f__c5f8a6bb38a7141dfb99ad884b416367($results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_7d903cbd1ed00fd3fadceb9c477c3e91 = is_array($this->functionData['followedContentView']) ? count($this->functionData['followedContentView']) : 0;
$this->functionData['followedContentView'][$count_7d903cbd1ed00fd3fadceb9c477c3e91]['results'] = $results;
$this->functionData['followedContentView'][$count_7d903cbd1ed00fd3fadceb9c477c3e91]['pagination'] = $pagination;
$this->functionData['followedContentView'][$count_7d903cbd1ed00fd3fadceb9c477c3e91]['total'] = $total;
$this->functionData['followedContentView'][$count_7d903cbd1ed00fd3fadceb9c477c3e91]['error'] = $error;
$this->functionData['followedContentView'][$count_7d903cbd1ed00fd3fadceb9c477c3e91]['contentTypes'] = $contentTypes;
}
$IPBHTML .= "" . (($pagination) ? ("
<div class='controls'>
...
<div class='master_list'>
	...
	<div class='ipsPad'>
		...
		".$this->__f__d9ea393338e14726b143c68485f4f011($results,$pagination,$total,$error,$contentTypes)."		</ul>
	</div>
</div>
<div class='master_list'>
	...
	<div class='ipsPad'>
		<ul>
			".$this->__f__8f70bdc64005e666533fee494c022e2e($results,$pagination,$total,$error,$contentTypes)."		</ul>
	</div>
</div>";
return $IPBHTML;
}
...
function __f__d9ea393338e14726b143c68485f4f011($results, $pagination, $total, $error, $contentTypes)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__8f70bdc64005e666533fee494c022e2e($results, $pagination, $total, $error, $contentTypes)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_91a9dd7112bfcc1b7d0598fa7bcde063 = is_array($this->functionData['forumAdvancedSearchFilters']) ? count($this->functionData['forumAdvancedSearchFilters']) : 0;
$this->functionData['forumAdvancedSearchFilters'][$count_91a9dd7112bfcc1b7d0598fa7bcde063]['forums'] = $forums;
$this->functionData['forumAdvancedSearchFilters'][$count_91a9dd7112bfcc1b7d0598fa7bcde063]['archivedPostCount'] = $archivedPostCount;
$this->functionData['forumAdvancedSearchFilters'][$count_91a9dd7112bfcc1b7d0598fa7bcde063]['topic'] = $topic;
}
...
{
$count_06938a25bdc1ed8113c74832c9d95334 = is_array($this->functionData['helpSearchResult']) ? count($this->functionData['helpSearchResult']) : 0;
$this->functionData['helpSearchResult'][$count_06938a25bdc1ed8113c74832c9d95334]['r'] = $r;
$this->functionData['helpSearchResult'][$count_06938a25bdc1ed8113c74832c9d95334]['resultAsTitle'] = $resultAsTitle;
}
...
{
$count_350ba80184c1525b6465e92c8830fcd6 = is_array($this->functionData['memberCommentsSearchResult']) ? count($this->functionData['memberCommentsSearchResult']) : 0;
$this->functionData['memberCommentsSearchResult'][$count_350ba80184c1525b6465e92c8830fcd6]['r'] = $r;
$this->functionData['memberCommentsSearchResult'][$count_350ba80184c1525b6465e92c8830fcd6]['resultAsTitle'] = $resultAsTitle;
}
...
{
$count_d078c2b3da1b7b8fc83300574097fe69 = is_array($this->functionData['newContentView']) ? count($this->functionData['newContentView']) : 0;
$this->functionData['newContentView'][$count_d078c2b3da1b7b8fc83300574097fe69]['results'] = $results;
$this->functionData['newContentView'][$count_d078c2b3da1b7b8fc83300574097fe69]['pagination'] = $pagination;
$this->functionData['newContentView'][$count_d078c2b3da1b7b8fc83300574097fe69]['total'] = $total;
$this->functionData['newContentView'][$count_d078c2b3da1b7b8fc83300574097fe69]['sortDropDown'] = $sortDropDown;
$this->functionData['newContentView'][$count_d078c2b3da1b7b8fc83300574097fe69]['sortIn'] = $sortIn;
$this->functionData['newContentView'][$count_d078c2b3da1b7b8fc83300574097fe69]['dateCutSet'] = $dateCutSet;
}
...
" . ((is_array($sortIn) AND count( $sortIn )) ? ("
	<div class='ipsFilterPane' id='filter_section_pane' style='display: none'>
		...
		<div>
			...
			<ul>
				".$this->__f__019abd450f8f62e649dc6cfcd92a249c($results,$pagination,$total,$sortDropDown,$sortIn,$dateCutSet)."			</ul>
		</div>
	</div>
") : ("")) . "
...
function __f__64e499a29b768a1021e330eb783bb6e3($results, $pagination, $total, $sortDropDown, $sortIn, $dateCutSet=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $this->registry->getApplications() as $app )
...
function __f__019abd450f8f62e649dc6cfcd92a249c($results, $pagination, $total, $sortDropDown, $sortIn, $dateCutSet=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_0f4889e9c326fffce2ef753ea14ca3df = is_array($this->functionData['searchAdvancedForm']) ? count($this->functionData['searchAdvancedForm']) : 0;
$this->functionData['searchAdvancedForm'][$count_0f4889e9c326fffce2ef753ea14ca3df]['filters'] = $filters;
$this->functionData['searchAdvancedForm'][$count_0f4889e9c326fffce2ef753ea14ca3df]['msg'] = $msg;
$this->functionData['searchAdvancedForm'][$count_0f4889e9c326fffce2ef753ea14ca3df]['current_app'] = $current_app;
$this->functionData['searchAdvancedForm'][$count_0f4889e9c326fffce2ef753ea14ca3df]['removed_search_terms'] = $removed_search_terms;
$this->functionData['searchAdvancedForm'][$count_0f4889e9c326fffce2ef753ea14ca3df]['isFT'] = $isFT;
$this->functionData['searchAdvancedForm'][$count_0f4889e9c326fffce2ef753ea14ca3df]['canTag'] = $canTag;
}
...
<div class='master_list ipsForm_vertical'>
	...
	" . ((count($filters)) ? ("".$this->__f__cee30fb4b85f33fae10c24d27fc30152($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag)."		") : ("")) . "
	<div class='submit'>
...
function __f__e047835275f8ec449cd5ee7b6702f79e($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array(),$app='',$data='',$id='',$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__7208198b3c7cac6f5c0ae07ee13ac1e8($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array(),$app='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		$_ips___x_retval .= "
							<ul>
								<li>
									...
									".$this->__f__e047835275f8ec449cd5ee7b6702f79e($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag,$app,$data,$id,$_data)."									</select>
...
function __f__4f3c54caf167d100bc4fc355653e7636($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array(),$app='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__cee30fb4b85f33fae10c24d27fc30152($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		$_ips___x_retval .= "
			" . (($app == 'forums') ? ("<div id='app_filter_{$app}'>
				...
				" . ((count($data['sortDropDown'])) ? ("" . ((is_array($data['sortDropIn']) AND count( $data['sortDropIn'] )) ? ("
						".$this->__f__7208198b3c7cac6f5c0ae07ee13ac1e8($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag,$app,$data)."					") : ("<div class='ipsField'>
							...
							<select name='search_app_filters[$app][sortKey]' id='search_sort_by_{$app}' class='input_select' style='width:auto'>
								".$this->__f__4f3c54caf167d100bc4fc355653e7636($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag,$app,$data)."							</select>
...
{
$count_85a8ffe91b3ddb1cf26d8adc9fc7ae08 = is_array($this->functionData['searchResults']) ? count($this->functionData['searchResults']) : 0;
$this->functionData['searchResults'][$count_85a8ffe91b3ddb1cf26d8adc9fc7ae08]['results'] = $results;
$this->functionData['searchResults'][$count_85a8ffe91b3ddb1cf26d8adc9fc7ae08]['titlesOnly'] = $titlesOnly;
}
...
$IPBHTML .= "<div id='search_results'>
	<ol>
		" . ((is_array($results) && count($results)) ? ("
			".$this->__f__2c38616bba6b38dd810c6bc72b796e5b($results,$titlesOnly)."		") : ("")) . "
	</ol>
</div>";
return $IPBHTML;
}
...
function __f__2c38616bba6b38dd810c6bc72b796e5b($results, $titlesOnly)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $results as $result )
...
{
$count_286f5d0837e411b6401ef39a9d34f1ce = is_array($this->functionData['searchResultsWrapper']) ? count($this->functionData['searchResultsWrapper']) : 0;
$this->functionData['searchResultsWrapper'][$count_286f5d0837e411b6401ef39a9d34f1ce]['results'] = $results;
$this->functionData['searchResultsWrapper'][$count_286f5d0837e411b6401ef39a9d34f1ce]['sortDropDown'] = $sortDropDown;
$this->functionData['searchResultsWrapper'][$count_286f5d0837e411b6401ef39a9d34f1ce]['sortIn'] = $sortIn;
$this->functionData['searchResultsWrapper'][$count_286f5d0837e411b6401ef39a9d34f1ce]['pagination'] = $pagination;
$this->functionData['searchResultsWrapper'][$count_286f5d0837e411b6401ef39a9d34f1ce]['total'] = $total;
$this->functionData['searchResultsWrapper'][$count_286f5d0837e411b6401ef39a9d34f1ce]['showing'] = $showing;
$this->functionData['searchResultsWrapper'][$count_286f5d0837e411b6401ef39a9d34f1ce]['search_term'] = $search_term;
$this->functionData['searchResultsWrapper'][$count_286f5d0837e411b6401ef39a9d34f1ce]['url_string'] = $url_string;
$this->functionData['searchResultsWrapper'][$count_286f5d0837e411b6401ef39a9d34f1ce]['current_key'] = $current_key;
$this->functionData['searchResultsWrapper'][$count_286f5d0837e411b6401ef39a9d34f1ce]['removed_search_terms'] = $removed_search_terms;
$this->functionData['searchResultsWrapper'][$count_286f5d0837e411b6401ef39a9d34f1ce]['limited'] = $limited;
$this->functionData['searchResultsWrapper'][$count_286f5d0837e411b6401ef39a9d34f1ce]['wasLimited'] = $wasLimited;
$this->functionData['searchResultsWrapper'][$count_286f5d0837e411b6401ef39a9d34f1ce]['search_tags'] = $search_tags;
}
...
{
$count_f29147e4ccd9fb70c850742d4e3d3199 = is_array($this->functionData['searchRowGenericFormat']) ? count($this->functionData['searchRowGenericFormat']) : 0;
$this->functionData['searchRowGenericFormat'][$count_f29147e4ccd9fb70c850742d4e3d3199]['r'] = $r;
$this->functionData['searchRowGenericFormat'][$count_f29147e4ccd9fb70c850742d4e3d3199]['resultAsTitle'] = $resultAsTitle;
}
$IPBHTML .= "<div class='result_info'>
...
{
$count_a649d44d6bf103a467766ad84b55e210 = is_array($this->functionData['topicPostSearchResultAsForum']) ? count($this->functionData['topicPostSearchResultAsForum']) : 0;
$this->functionData['topicPostSearchResultAsForum'][$count_a649d44d6bf103a467766ad84b55e210]['data'] = $data;
$this->functionData['topicPostSearchResultAsForum'][$count_a649d44d6bf103a467766ad84b55e210]['resultAsTitle'] = $resultAsTitle;
}
...
{
$count_39e6d6f8870abf20ed8084b89354e0d0 = is_array($this->functionData['userPostsView']) ? count($this->functionData['userPostsView']) : 0;
$this->functionData['userPostsView'][$count_39e6d6f8870abf20ed8084b89354e0d0]['results'] = $results;
$this->functionData['userPostsView'][$count_39e6d6f8870abf20ed8084b89354e0d0]['pagination'] = $pagination;
$this->functionData['userPostsView'][$count_39e6d6f8870abf20ed8084b89354e0d0]['total'] = $total;
$this->functionData['userPostsView'][$count_39e6d6f8870abf20ed8084b89354e0d0]['member'] = $member;
$this->functionData['userPostsView'][$count_39e6d6f8870abf20ed8084b89354e0d0]['limited'] = $limited;
$this->functionData['userPostsView'][$count_39e6d6f8870abf20ed8084b89354e0d0]['wasLimited'] = $wasLimited;
$this->functionData['userPostsView'][$count_39e6d6f8870abf20ed8084b89354e0d0]['beginTime'] = $beginTime;
$this->functionData['userPostsView'][$count_39e6d6f8870abf20ed8084b89354e0d0]['sortIn'] = $sortIn;
$this->functionData['userPostsView'][$count_39e6d6f8870abf20ed8084b89354e0d0]['sortDropDown'] = $sortDropDown;
}
