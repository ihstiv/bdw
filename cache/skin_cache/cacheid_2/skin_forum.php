...
{
$count_cd0818c27a78d021fc07a49112c99aaa = is_array($this->functionData['forumAttachments']) ? count($this->functionData['forumAttachments']) : 0;
$this->functionData['forumAttachments'][$count_cd0818c27a78d021fc07a49112c99aaa]['title'] = $title;
$this->functionData['forumAttachments'][$count_cd0818c27a78d021fc07a49112c99aaa]['rows'] = $rows;
$this->functionData['forumAttachments'][$count_cd0818c27a78d021fc07a49112c99aaa]['pages'] = $pages;
}
...
<table class='ipb_table'>
	<tr class='header'>
		...
		" . ((count($rows)) ? ("".$this->__f__88a2a096a37743bc72d124a5077b323f($title,$rows,$pages)."	") : ("")) . "
</table>
" . (($pages) ? ("
	<br />
	<div class='topic_controls'>{$pages}</div>
...
function __f__88a2a096a37743bc72d124a5077b323f($title, $rows, $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_5bdab36883413b1a233224c73e021ba3 = is_array($this->functionData['forumIndexTemplate']) ? count($this->functionData['forumIndexTemplate']) : 0;
$this->functionData['forumIndexTemplate'][$count_5bdab36883413b1a233224c73e021ba3]['forum_data'] = $forum_data;
$this->functionData['forumIndexTemplate'][$count_5bdab36883413b1a233224c73e021ba3]['announce_data'] = $announce_data;
$this->functionData['forumIndexTemplate'][$count_5bdab36883413b1a233224c73e021ba3]['topic_data'] = $topic_data;
$this->functionData['forumIndexTemplate'][$count_5bdab36883413b1a233224c73e021ba3]['other_data'] = $other_data;
$this->functionData['forumIndexTemplate'][$count_5bdab36883413b1a233224c73e021ba3]['multi_mod_data'] = $multi_mod_data;
$this->functionData['forumIndexTemplate'][$count_5bdab36883413b1a233224c73e021ba3]['sub_forum_data'] = $sub_forum_data;
$this->functionData['forumIndexTemplate'][$count_5bdab36883413b1a233224c73e021ba3]['footer_filter'] = $footer_filter;
$this->functionData['forumIndexTemplate'][$count_5bdab36883413b1a233224c73e021ba3]['active_user_data'] = $active_user_data;
$this->functionData['forumIndexTemplate'][$count_5bdab36883413b1a233224c73e021ba3]['mod_data'] = $mod_data;
$this->functionData['forumIndexTemplate'][$count_5bdab36883413b1a233224c73e021ba3]['inforum'] = $inforum;
}
...
" . ((is_array( $sub_forum_data ) AND count( $sub_forum_data )) ? ("
	<div class='master_list' id='board_index'>
		".$this->__f__c65fa738f5ac10f06124263afbb6c77f($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."	</div>
") : ("")) . "
<div class='master_list'>
	" . (($forum_data['sub_can_post']) ? ("<!--<h2>{$forum_data['name']}</h2>-->
		...
		" . ((is_array( $announce_data ) AND count( $announce_data )) ? ("
			".$this->__f__07d9808c1a05239ced6f5aba6d695dbf($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."		") : ("")) . "
		
		" . ((is_array( $topic_data ) AND count( $topic_data )) ? ("
			<h3>{$this->lang->words['forum_topic_list']}</h3>
			".$this->__f__91bcf50dd497b2ce74bbe48b75712dbb($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."		") : ("
...
function __f__c6e443b618e8bd03403e89ef1de59a17($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1,$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__c65fa738f5ac10f06124263afbb6c77f($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $sub_forum_data as $_data )
	{
		...
		$_ips___x_retval .= "
			" . ((is_array( $_data['forum_data'] ) AND count( $_data['forum_data'] )) ? ("
				".$this->__f__c6e443b618e8bd03403e89ef1de59a17($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum,$_data)."			") : ("")) . "
...
function __f__07d9808c1a05239ced6f5aba6d695dbf($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__91bcf50dd497b2ce74bbe48b75712dbb($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_51577e4fe86416ff484d92ee38263f74 = is_array($this->functionData['topic_rating_image']) ? count($this->functionData['topic_rating_image']) : 0;
$this->functionData['topic_rating_image'][$count_51577e4fe86416ff484d92ee38263f74]['rating_id'] = $rating_id;
}
$IPBHTML .= "<span class='mini_rate'>".$this->__f__aa876e9937d3d0929f84b03b7b70a622($rating_id)."</span>";
return $IPBHTML;
}


function __f__aa876e9937d3d0929f84b03b7b70a622($rating_id=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1ed09307b9cd72c08e86e558961827dd = is_array($this->functionData['topicPrefixWrap']) ? count($this->functionData['topicPrefixWrap']) : 0;
$this->functionData['topicPrefixWrap'][$count_1ed09307b9cd72c08e86e558961827dd]['text'] = $text;
}
$IPBHTML .= "" . (($text) ? ("
