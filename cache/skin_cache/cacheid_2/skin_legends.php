...
{
$count_8ffdd984d4b8b5325051c3e4cc6cb718 = is_array($this->functionData['bbcodePopUpList']) ? count($this->functionData['bbcodePopUpList']) : 0;
$this->functionData['bbcodePopUpList'][$count_8ffdd984d4b8b5325051c3e4cc6cb718]['rows'] = $rows;
}
...
<table class='ipb_table'>
	...
	".$this->__f__3d69a745e1ea72510c7c03db56a6d71b($rows)."</table>
...
function __f__3d69a745e1ea72510c7c03db56a6d71b($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_a5a58d23e2eedebda83991a3057496df = is_array($this->functionData['emoticonPopUpList']) ? count($this->functionData['emoticonPopUpList']) : 0;
$this->functionData['emoticonPopUpList'][$count_a5a58d23e2eedebda83991a3057496df]['editor_id'] = $editor_id;
$this->functionData['emoticonPopUpList'][$count_a5a58d23e2eedebda83991a3057496df]['rows'] = $rows;
$this->functionData['emoticonPopUpList'][$count_a5a58d23e2eedebda83991a3057496df]['legacy_editor'] = $legacy_editor;
}
...
")) . "<div class='full_emoticon'>
	<table class='ipb_table'>
		".$this->__f__af53cd46d9f4fa7b8221ea713bb26a0e($editor_id,$rows,$legacy_editor)."	</table>
</div>";
return $IPBHTML;
}


function __f__af53cd46d9f4fa7b8221ea713bb26a0e($editor_id, $rows, $legacy_editor=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
