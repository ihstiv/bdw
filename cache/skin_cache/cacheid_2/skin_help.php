...
{
$count_613dc62ac01d3511e561cd3cdb1de45e = is_array($this->functionData['helpShowSection']) ? count($this->functionData['helpShowSection']) : 0;
$this->functionData['helpShowSection'][$count_613dc62ac01d3511e561cd3cdb1de45e]['one_text'] = $one_text;
$this->functionData['helpShowSection'][$count_613dc62ac01d3511e561cd3cdb1de45e]['two_text'] = $two_text;
$this->functionData['helpShowSection'][$count_613dc62ac01d3511e561cd3cdb1de45e]['three_text'] = $three_text;
$this->functionData['helpShowSection'][$count_613dc62ac01d3511e561cd3cdb1de45e]['text'] = $text;
}
...
{
$count_2754de6d40c9bcf96d30540371cf1f07 = is_array($this->functionData['helpShowTopics']) ? count($this->functionData['helpShowTopics']) : 0;
$this->functionData['helpShowTopics'][$count_2754de6d40c9bcf96d30540371cf1f07]['one_text'] = $one_text;
$this->functionData['helpShowTopics'][$count_2754de6d40c9bcf96d30540371cf1f07]['two_text'] = $two_text;
$this->functionData['helpShowTopics'][$count_2754de6d40c9bcf96d30540371cf1f07]['three_text'] = $three_text;
$this->functionData['helpShowTopics'][$count_2754de6d40c9bcf96d30540371cf1f07]['rows'] = $rows;
}
...
<ol id='help_topics'>
		" . ((count($rows)) ? ("".$this->__f__8e11b1278f17c954f3bf33fd8522dbf6($one_text,$two_text,$three_text,$rows)."	") : ("
...
function __f__8e11b1278f17c954f3bf33fd8522dbf6($one_text="",$two_text="",$three_text="",$rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
