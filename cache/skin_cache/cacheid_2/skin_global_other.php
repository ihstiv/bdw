...
{
$count_f6f0ef9a725db551eabb27380e9dc6b7 = is_array($this->functionData['ajaxPopUpNoPermission']) ? count($this->functionData['ajaxPopUpNoPermission']) : 0;
$this->functionData['ajaxPopUpNoPermission'][$count_f6f0ef9a725db551eabb27380e9dc6b7]['msg'] = $msg;
}
...
{
$count_4581e89fedb7451ff50e43f67c033751 = is_array($this->functionData['displayBoardOffline']) ? count($this->functionData['displayBoardOffline']) : 0;
$this->functionData['displayBoardOffline'][$count_4581e89fedb7451ff50e43f67c033751]['message'] = $message;
}
...
{
$count_d1fffd69b27b48a018ec93ace2061e9d = is_array($this->functionData['displayPopUpWindow']) ? count($this->functionData['displayPopUpWindow']) : 0;
$this->functionData['displayPopUpWindow'][$count_d1fffd69b27b48a018ec93ace2061e9d]['documentHeadItems'] = $documentHeadItems;
$this->functionData['displayPopUpWindow'][$count_d1fffd69b27b48a018ec93ace2061e9d]['css'] = $css;
$this->functionData['displayPopUpWindow'][$count_d1fffd69b27b48a018ec93ace2061e9d]['jsLoaderItems'] = $jsLoaderItems;
$this->functionData['displayPopUpWindow'][$count_d1fffd69b27b48a018ec93ace2061e9d]['title'] = $title;
$this->functionData['displayPopUpWindow'][$count_d1fffd69b27b48a018ec93ace2061e9d]['output'] = $output;
}
...
<html xml:lang=\"en\" lang=\"en\" xmlns=\"http://www.w3.org/1999/xhtml\"> 
	<head>
		...
		" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
			".$this->__f__0c17aefbac0f823754ecfb901e9641e1($documentHeadItems,$css,$jsLoaderItems,$title,$output)."			" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
		...
		" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
			".$this->__f__5ef5dfeb805f4c764767a858774ceaed($documentHeadItems,$css,$jsLoaderItems,$title,$output)."		") : ("")) . "
		<!--[if lte IE 7]>
		...
		" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
			".$this->__f__8c6efa682256873fe7713faea16b918d($documentHeadItems,$css,$jsLoaderItems,$title,$output)."		") : ("")) . "
		...
		" . ((count($documentHeadItems)) ? ("
			".$this->__f__aca0baabced47f44ed71fdf50966abce($documentHeadItems,$css,$jsLoaderItems,$title,$output)."		") : ("")) . "
...
function __f__0c17aefbac0f823754ecfb901e9641e1($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__5ef5dfeb805f4c764767a858774ceaed($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__8c6efa682256873fe7713faea16b918d($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__4c46f0a57be6d30de3b7d144cb5b5b93($documentHeadItems, $css, $jsLoaderItems, $title="", $output="",$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__aca0baabced47f44ed71fdf50966abce($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__4c46f0a57be6d30de3b7d144cb5b5b93($documentHeadItems,$css,$jsLoaderItems,$title,$output,$type,$idx)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_9aaef975fcb8dbb76b1e35aa450ff221 = is_array($this->functionData['Error']) ? count($this->functionData['Error']) : 0;
$this->functionData['Error'][$count_9aaef975fcb8dbb76b1e35aa450ff221]['message'] = $message;
$this->functionData['Error'][$count_9aaef975fcb8dbb76b1e35aa450ff221]['code'] = $code;
$this->functionData['Error'][$count_9aaef975fcb8dbb76b1e35aa450ff221]['ad_email_one'] = $ad_email_one;
$this->functionData['Error'][$count_9aaef975fcb8dbb76b1e35aa450ff221]['ad_email_two'] = $ad_email_two;
$this->functionData['Error'][$count_9aaef975fcb8dbb76b1e35aa450ff221]['title'] = $title;
}
...
{
$count_0e3c74986360e2135bfd3667988d9a8d = is_array($this->functionData['generateTopicIcon']) ? count($this->functionData['generateTopicIcon']) : 0;
$this->functionData['generateTopicIcon'][$count_0e3c74986360e2135bfd3667988d9a8d]['imgArray'] = $imgArray;
$this->functionData['generateTopicIcon'][$count_0e3c74986360e2135bfd3667988d9a8d]['unreadUrl'] = $unreadUrl;
}
...
{
$count_b119379e20e1f59fd898a0d99f2f70c9 = is_array($this->functionData['globalTemplateMinimal']) ? count($this->functionData['globalTemplateMinimal']) : 0;
$this->functionData['globalTemplateMinimal'][$count_b119379e20e1f59fd898a0d99f2f70c9]['html'] = $html;
$this->functionData['globalTemplateMinimal'][$count_b119379e20e1f59fd898a0d99f2f70c9]['documentHeadItems'] = $documentHeadItems;
$this->functionData['globalTemplateMinimal'][$count_b119379e20e1f59fd898a0d99f2f70c9]['css'] = $css;
$this->functionData['globalTemplateMinimal'][$count_b119379e20e1f59fd898a0d99f2f70c9]['jsModules'] = $jsModules;
$this->functionData['globalTemplateMinimal'][$count_b119379e20e1f59fd898a0d99f2f70c9]['metaTags'] = $metaTags;
$this->functionData['globalTemplateMinimal'][$count_b119379e20e1f59fd898a0d99f2f70c9]['header_items'] = $header_items;
$this->functionData['globalTemplateMinimal'][$count_b119379e20e1f59fd898a0d99f2f70c9]['items'] = $items;
$this->functionData['globalTemplateMinimal'][$count_b119379e20e1f59fd898a0d99f2f70c9]['footer_items'] = $footer_items;
$this->functionData['globalTemplateMinimal'][$count_b119379e20e1f59fd898a0d99f2f70c9]['stats'] = $stats;
}
						...
						<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "{$this->settings['query_string_formatted']}", "public",'' ), "", "" ) . "\" method=\"post\">
							<fieldset>
								...
								<select name=\"langid\" id='newLang'>
									".$this->__f__6621812e865ba12254b35e22a5dd83a4($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."								</select>
...
function __f__6621812e865ba12254b35e22a5dd83a4($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_d3e651d5bb3ccf620088f16de8052d16 = is_array($this->functionData['redirectTemplate']) ? count($this->functionData['redirectTemplate']) : 0;
$this->functionData['redirectTemplate'][$count_d3e651d5bb3ccf620088f16de8052d16]['documentHeadItems'] = $documentHeadItems;
$this->functionData['redirectTemplate'][$count_d3e651d5bb3ccf620088f16de8052d16]['css'] = $css;
$this->functionData['redirectTemplate'][$count_d3e651d5bb3ccf620088f16de8052d16]['jsLoaderItems'] = $jsLoaderItems;
$this->functionData['redirectTemplate'][$count_d3e651d5bb3ccf620088f16de8052d16]['text'] = $text;
$this->functionData['redirectTemplate'][$count_d3e651d5bb3ccf620088f16de8052d16]['url'] = $url;
$this->functionData['redirectTemplate'][$count_d3e651d5bb3ccf620088f16de8052d16]['full'] = $full;
}
$IPBHTML .= "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\"> 
<html xml:lang=\"en\" lang=\"en\" xmlns=\"http://www.w3.org/1999/xhtml\"> 
	<head>
		...
		<link rel=\"shortcut icon\" href='" . (($this->registry->output->isHTTPS) ? ("{$this->settings['board_url_https']}") : ("{$this->settings['board_url']}")) . "/favicon.ico' />
		" . ((is_array( $css['import'] )) ? ("
			".$this->__f__22f23b4fe5af3554dfa1ccc799b89222($documentHeadItems,$css,$jsLoaderItems,$text,$url,$full)."		") : ("")) . "
		" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
			".$this->__f__c75c06fd3ea2b01b440421c2054e5d9e($documentHeadItems,$css,$jsLoaderItems,$text,$url,$full)."		") : ("")) . "
		<!--[if lte IE 7]>
			<link rel=\"stylesheet\" type=\"text/css\" title='Main' media=\"screen\" href=\"{$this->settings['public_dir']}style_css/{$this->registry->output->skin['_csscacheid']}/ipb_ie.css\" />
		<![endif]-->
		...
		" . ((count($documentHeadItems)) ? ("
			".$this->__f__cc0c93ae45691153abd2e091c2d22d3e($documentHeadItems,$css,$jsLoaderItems,$text,$url,$full)."		") : ("")) . "
		<!--/CSS-->
		<script type='text/javascript'>
		//<![CDATA[
...
function __f__22f23b4fe5af3554dfa1ccc799b89222($documentHeadItems, $css, $jsLoaderItems, $text="",$url="", $full=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $css['import'] as $data )
...
function __f__c75c06fd3ea2b01b440421c2054e5d9e($documentHeadItems, $css, $jsLoaderItems, $text="",$url="", $full=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $css['inline'] as $data )
...
function __f__6219871e1d87ea391c541f8bbd864230($documentHeadItems, $css, $jsLoaderItems, $text="",$url="", $full=false,$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems[ $type ] as $idx => $data )
...
function __f__cc0c93ae45691153abd2e091c2d22d3e($documentHeadItems, $css, $jsLoaderItems, $text="",$url="", $full=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__6219871e1d87ea391c541f8bbd864230($documentHeadItems,$css,$jsLoaderItems,$text,$url,$full,$type,$idx)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_89ebb4c2ae3e9bacf6bb2396a741e5a3 = is_array($this->functionData['repButtons']) ? count($this->functionData['repButtons']) : 0;
$this->functionData['repButtons'][$count_89ebb4c2ae3e9bacf6bb2396a741e5a3]['member'] = $member;
$this->functionData['repButtons'][$count_89ebb4c2ae3e9bacf6bb2396a741e5a3]['data'] = $data;
}
...
<div class='likepop fixed_inner'>
	<ul class='ipsList_withminiphoto'>
		".$this->__f__c34ab985c142eb6f6328dea19596a529($data,$relId)."	</ul>
</div>";
return $IPBHTML;
}


function __f__c34ab985c142eb6f6328dea19596a529($data, $relId)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
$IPBHTML .= "<div>
	...
	<div class='ipsPad' style='min-height: 60px'>
		...
		") : ("".$this->__f__f9d4a7d82a1e26dc2816bcae71d200f4($reps)."		")) . "
	</div>
</div>";
return $IPBHTML;
}
...
function __f__f9d4a7d82a1e26dc2816bcae71d200f4($reps)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $reps as $r )
...
{
$count_5def0d4badd12ee15a05407bb69152fd = is_array($this->functionData['tagCloud']) ? count($this->functionData['tagCloud']) : 0;
$this->functionData['tagCloud'][$count_5def0d4badd12ee15a05407bb69152fd]['tags'] = $tags;
}
$IPBHTML .= "<h3 class='maintitle'>{$this->lang->words['mob_tags']}</h3>
<div class='ipsBox'>
	<div class='ipsBox_container ipsPad'>
		<ul class='ipsList_inline'>
		".$this->__f__b293ad778d4bd5ef0f20e0bf1cadcf6a($tags)."		</ul>
	</div>
</div>";
return $IPBHTML;
}
...
function __f__b293ad778d4bd5ef0f20e0bf1cadcf6a($tags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_43ce008f3e6b45c1aab09da13d59f83a = is_array($this->functionData['tagEntry']) ? count($this->functionData['tagEntry']) : 0;
$this->functionData['tagEntry'][$count_43ce008f3e6b45c1aab09da13d59f83a]['tag'] = $tag;
$this->functionData['tagEntry'][$count_43ce008f3e6b45c1aab09da13d59f83a]['noClass'] = $noClass;
$this->functionData['tagEntry'][$count_43ce008f3e6b45c1aab09da13d59f83a]['app'] = $app;
$this->functionData['tagEntry'][$count_43ce008f3e6b45c1aab09da13d59f83a]['section'] = $section;
}
...
{
$count_a7956001056e3c2551d41cb93058b76e = is_array($this->functionData['tagPrefix']) ? count($this->functionData['tagPrefix']) : 0;
$this->functionData['tagPrefix'][$count_a7956001056e3c2551d41cb93058b76e]['tag'] = $tag;
$this->functionData['tagPrefix'][$count_a7956001056e3c2551d41cb93058b76e]['app'] = $app;
$this->functionData['tagPrefix'][$count_a7956001056e3c2551d41cb93058b76e]['section'] = $section;
}
			...
			<div class='ipsTagBox_editor'>
				<span id='{$options['fieldId']}_addwrap'>
					" . ((!$options['isOpenSystem']) ? ("<select id='{$options['fieldId']}_tag_select' class='input_select'>
							" . ((!empty( $options['predefinedTags'] )) ? ("".$this->__f__b5757f07b63c6e6a5df6e9bcd18d16fc($tags,$options,$where)."							") : ("")) . "
						</select>") : ("
...
function __f__b5757f07b63c6e6a5df6e9bcd18d16fc($tags, $options, $where)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
