...
{
$count_d1be5b5d6f8af206a4bf85b8d242d51b = is_array($this->functionData['deletedPosts']) ? count($this->functionData['deletedPosts']) : 0;
$this->functionData['deletedPosts'][$count_d1be5b5d6f8af206a4bf85b8d242d51b]['posts'] = $posts;
$this->functionData['deletedPosts'][$count_d1be5b5d6f8af206a4bf85b8d242d51b]['other_data'] = $other_data;
$this->functionData['deletedPosts'][$count_d1be5b5d6f8af206a4bf85b8d242d51b]['pagelinks'] = $pagelinks;
}
...
<div class='clearfix'>
	" . ((is_array( $posts ) AND count( $posts )) ? ("
		<div id='ips_Posts'>
			".$this->__f__f88e1658c55c84e3c92e7c39ab01c4f5($posts,$other_data,$pagelinks)."		</div>
	") : ("
...
function __f__f88e1658c55c84e3c92e7c39ab01c4f5($posts, $other_data=array(), $pagelinks='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_5ca36608173ea40871accd321337382f = is_array($this->functionData['deletedTopics']) ? count($this->functionData['deletedTopics']) : 0;
$this->functionData['deletedTopics'][$count_5ca36608173ea40871accd321337382f]['topics'] = $topics;
$this->functionData['deletedTopics'][$count_5ca36608173ea40871accd321337382f]['sdelete'] = $sdelete;
$this->functionData['deletedTopics'][$count_5ca36608173ea40871accd321337382f]['pagelinks'] = $pagelinks;
}
...
{
$count_9d4dddcb2d880b4fef82dbafd229ed41 = is_array($this->functionData['editUserForm']) ? count($this->functionData['editUserForm']) : 0;
$this->functionData['editUserForm'][$count_9d4dddcb2d880b4fef82dbafd229ed41]['profile'] = $profile;
$this->functionData['editUserForm'][$count_9d4dddcb2d880b4fef82dbafd229ed41]['custom_fields'] = $custom_fields;
}
	...
	<fieldset>
		...
		" . ((count($custom_fields->out_fields)) ? ("
			...
			<ul class='ipsForm ipsForm_horizontal'>
				...
				".$this->__f__5597e4271a68fa95b321caff8726c331($profile,$custom_fields)."			</ul>
		") : ("")) . "
...
function __f__5597e4271a68fa95b321caff8726c331($profile, $custom_fields=null)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_6dfeebe0d0d90b25865fe82408267fd1 = is_array($this->functionData['latestWarnLogs']) ? count($this->functionData['latestWarnLogs']) : 0;
$this->functionData['latestWarnLogs'][$count_6dfeebe0d0d90b25865fe82408267fd1]['warnings'] = $warnings;
$this->functionData['latestWarnLogs'][$count_6dfeebe0d0d90b25865fe82408267fd1]['pagelinks'] = $pagelinks;
}
...
<div class='clearfix'>
	<table class='ipb_table'>
		...
		" . ((is_array( $warnings ) AND count( $warnings )) ? ("
						".$this->__f__8b0a6237c9b626127fac3dbab983a202($warnings,$pagelinks)."		") : ("
			<tr>
...
function __f__8b0a6237c9b626127fac3dbab983a202($warnings, $pagelinks)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_f14c19947efb639c4b2e5c053ba39430 = is_array($this->functionData['membersList']) ? count($this->functionData['membersList']) : 0;
$this->functionData['membersList'][$count_f14c19947efb639c4b2e5c053ba39430]['type'] = $type;
$this->functionData['membersList'][$count_f14c19947efb639c4b2e5c053ba39430]['members'] = $members;
$this->functionData['membersList'][$count_f14c19947efb639c4b2e5c053ba39430]['pagelinks'] = $pagelinks;
}
		...
		<div id='member_wrap'>
			<ul class='ipsMemberList'>
				" . ((is_array( $members ) and count( $members )) ? ("
										".$this->__f__ffd937db7f592553475a7aeffee14e2c($type,$members,$pagelinks)."				") : ("
...
function __f__ffd937db7f592553475a7aeffee14e2c($type, $members, $pagelinks='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e6d8391d3c220bfdfadb5d9f97fc3e90 = is_array($this->functionData['membersModIPForm']) ? count($this->functionData['membersModIPForm']) : 0;
$this->functionData['membersModIPForm'][$count_e6d8391d3c220bfdfadb5d9f97fc3e90]['ip'] = $ip;
$this->functionData['membersModIPForm'][$count_e6d8391d3c220bfdfadb5d9f97fc3e90]['inlineMsg'] = $inlineMsg;
}
...
{
$count_b832fd5204fbe5b5e613dd851e666eb3 = is_array($this->functionData['membersModIPFormMembers']) ? count($this->functionData['membersModIPFormMembers']) : 0;
$this->functionData['membersModIPFormMembers'][$count_b832fd5204fbe5b5e613dd851e666eb3]['pages'] = $pages;
$this->functionData['membersModIPFormMembers'][$count_b832fd5204fbe5b5e613dd851e666eb3]['members'] = $members;
}
...
<table class='ipb_table'>
	...
	" . ((is_array( $members ) AND count( $members )) ? ("
				".$this->__f__4cd65bf7c582883424aeab40c261bb89($pages,$members)."	") : ("")) . "
</table>
<br />
...
function __f__4cd65bf7c582883424aeab40c261bb89($pages="",$members)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1931a3415fd92ec8def3ec12e6d8ef3d = is_array($this->functionData['membersModIPFormPosts']) ? count($this->functionData['membersModIPFormPosts']) : 0;
$this->functionData['membersModIPFormPosts'][$count_1931a3415fd92ec8def3ec12e6d8ef3d]['count'] = $count;
$this->functionData['membersModIPFormPosts'][$count_1931a3415fd92ec8def3ec12e6d8ef3d]['pageLinks'] = $pageLinks;
$this->functionData['membersModIPFormPosts'][$count_1931a3415fd92ec8def3ec12e6d8ef3d]['results'] = $results;
}
...
<br />
" . ((count($results)) ? ("
		".$this->__f__e1d1328a406b0ee02e2dd1ea8369de7f($count,$pageLinks,$results)."") : ("")) . "
<br />
<div class='topic_controls'>
	{$pageLinks}
</div>";
...
function __f__e1d1328a406b0ee02e2dd1ea8369de7f($count=0, $pageLinks='', $results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_591ae0c1ebaacb940c07db8836143f89 = is_array($this->functionData['modAnnounceForm']) ? count($this->functionData['modAnnounceForm']) : 0;
$this->functionData['modAnnounceForm'][$count_591ae0c1ebaacb940c07db8836143f89]['announce'] = $announce;
$this->functionData['modAnnounceForm'][$count_591ae0c1ebaacb940c07db8836143f89]['forum_html'] = $forum_html;
$this->functionData['modAnnounceForm'][$count_591ae0c1ebaacb940c07db8836143f89]['type'] = $type;
$this->functionData['modAnnounceForm'][$count_591ae0c1ebaacb940c07db8836143f89]['editor_html'] = $editor_html;
$this->functionData['modAnnounceForm'][$count_591ae0c1ebaacb940c07db8836143f89]['msg'] = $msg;
}
...
{
$count_d60be7595df0f1a0f1d6b1d932e0c314 = is_array($this->functionData['modAnnouncements']) ? count($this->functionData['modAnnouncements']) : 0;
$this->functionData['modAnnouncements'][$count_d60be7595df0f1a0f1d6b1d932e0c314]['announcements'] = $announcements;
}
...
<div class='topic_buttons'>
	...
	<table class='ipb_table' summary=\"{$this->lang->words['ucp_announcements']}\">
		...
		" . ((is_array( $announcements ) AND count( $announcements )) ? ("
						".$this->__f__8a2fa625801c4a6a16aad618ea0036ad($announcements)."		") : ("
			<tr>
...
function __f__96a45d285794a119ce13dcbed866652e($announcements,$announce='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__8a2fa625801c4a6a16aad618ea0036ad($announcements)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
					...
					<td>
						<div class=\"forumdesc\">
							...
							") : ("" . ((is_array( $announce['_forums'] ) and count( $announce['_forums'] )) ? ("
									<ul>
									".$this->__f__96a45d285794a119ce13dcbed866652e($announcements,$announce)."									</ul>
								") : ("
...
{
$count_381a7e28ae48cb44fd98251a7abf776f = is_array($this->functionData['modcpMessage']) ? count($this->functionData['modcpMessage']) : 0;
$this->functionData['modcpMessage'][$count_381a7e28ae48cb44fd98251a7abf776f]['message'] = $message;
}
...
{
$count_6cc82c5614ca6e90c7f69a72c2f42df4 = is_array($this->functionData['modCPpost']) ? count($this->functionData['modCPpost']) : 0;
$this->functionData['modCPpost'][$count_6cc82c5614ca6e90c7f69a72c2f42df4]['post'] = $post;
$this->functionData['modCPpost'][$count_6cc82c5614ca6e90c7f69a72c2f42df4]['displayData'] = $displayData;
$this->functionData['modCPpost'][$count_6cc82c5614ca6e90c7f69a72c2f42df4]['topic'] = $topic;
$this->functionData['modCPpost'][$count_6cc82c5614ca6e90c7f69a72c2f42df4]['type'] = $type;
}
...
{
$count_13af26a2846b27422b861126b39dbfec = is_array($this->functionData['modCPtopic']) ? count($this->functionData['modCPtopic']) : 0;
$this->functionData['modCPtopic'][$count_13af26a2846b27422b861126b39dbfec]['topics'] = $topics;
$this->functionData['modCPtopic'][$count_13af26a2846b27422b861126b39dbfec]['pagelinks'] = $pagelinks;
$this->functionData['modCPtopic'][$count_13af26a2846b27422b861126b39dbfec]['type'] = $type;
$this->functionData['modCPtopic'][$count_13af26a2846b27422b861126b39dbfec]['sdelete'] = $sdelete;
}
$IPBHTML .= "".$this->__f__49b65796157cda4aa52ba65ea864d9e4($topics,$pagelinks,$type,$sdelete)."";
return $IPBHTML;
}


function __f__9f20b43bd4ce62ce6a2e145823a0a090($topics, $pagelinks, $type, $sdelete=array(),$tid='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__49b65796157cda4aa52ba65ea864d9e4($topics, $pagelinks, $type, $sdelete=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	...
	<tr class='__topic' id='trow_{$data['tid']}' data-tid=\"{$data['tid']}\">
		<td class='__tid{$data['tid']} with_mod_links'>	
			...
			" . ((isset( $data['pages'] ) AND is_array( $data['pages'] ) AND count( $data['pages'] )) ? ("
				...
				".$this->__f__9f20b43bd4ce62ce6a2e145823a0a090($topics,$pagelinks,$type,$sdelete,$tid,$data)."				</ul>
			") : ("")) . "
			<br />
...
{
$count_ba96820b5f06ac35dba6eed7acf824c5 = is_array($this->functionData['overview']) ? count($this->functionData['overview']) : 0;
}
$IPBHTML .= "<div class='clearfix '>
	<div class='ipsBox_container ipsPad'>
...
{
$count_470bdfa7fc5166123e1796d4da6248f3 = is_array($this->functionData['portalPage']) ? count($this->functionData['portalPage']) : 0;
$this->functionData['portalPage'][$count_470bdfa7fc5166123e1796d4da6248f3]['output'] = $output;
$this->functionData['portalPage'][$count_470bdfa7fc5166123e1796d4da6248f3]['tabs'] = $tabs;
$this->functionData['portalPage'][$count_470bdfa7fc5166123e1796d4da6248f3]['_activeNav'] = $_activeNav;
}
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left' id='modcp_tabs'>
			<ul class='clear'>
				...
				".$this->__f__d803d470952c52246ce85aa331230819($output,$tabs,$_activeNav)."			</ul>
		</div>
...
function __f__d803d470952c52246ce85aa331230819($output, $tabs=array(), $_activeNav=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_a027b1c2f2eeb5575613b37265512976 = is_array($this->functionData['subTabLoop']) ? count($this->functionData['subTabLoop']) : 0;
}
$IPBHTML .= "".$this->__f__abcfbc0402fdfa95d1fc74cbda34c37e()."";
return $IPBHTML;
}


function __f__3f9c00734dbed8ccafa6bd4322f4b2fe($mainTabKey='',$subTabs='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__abcfbc0402fdfa95d1fc74cbda34c37e()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	...
	" . (($mainTabKey == $this->templateVars['activeNav']['primary']) ? ("" . ((count( $subTabs ) > 1) ? ("
			<div class='maintitle ipsFilterbar clear'>
				<ul class='ipsList_inline'>									
					".$this->__f__3f9c00734dbed8ccafa6bd4322f4b2fe($mainTabKey,$subTabs)."				</ul>
			</div>
		") : ("")) . "") : ("")) . "
...
{
$count_da934267a479761a6434e3b9a42861ab = is_array($this->functionData['unapprovedPosts']) ? count($this->functionData['unapprovedPosts']) : 0;
$this->functionData['unapprovedPosts'][$count_da934267a479761a6434e3b9a42861ab]['posts'] = $posts;
$this->functionData['unapprovedPosts'][$count_da934267a479761a6434e3b9a42861ab]['pagelinks'] = $pagelinks;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("topic", "0" ) . "
" . ((!$this->settings['disable_lightbox']) ? ("
" . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'include_lightbox' ) ? $this->registry->getClass('output')->getTemplate('global')->include_lightbox() : '' ) . "
...
<div class='clearfix'>
	" . ((is_array( $posts ) AND count( $posts )) ? ("
		<div id='ips_Posts2'>
			".$this->__f__fb138816fe918d5f2447c887dd5bc92f($posts,$pagelinks)."		</div>
	") : ("
		<div class='no_messages'>
...
function __f__fb138816fe918d5f2447c887dd5bc92f($posts, $pagelinks)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $posts as $post )
...
{
$count_b1e02b47faaa378b8e5c9c96e5a6f4c3 = is_array($this->functionData['unapprovedTopics']) ? count($this->functionData['unapprovedTopics']) : 0;
$this->functionData['unapprovedTopics'][$count_b1e02b47faaa378b8e5c9c96e5a6f4c3]['topics'] = $topics;
$this->functionData['unapprovedTopics'][$count_b1e02b47faaa378b8e5c9c96e5a6f4c3]['pagelinks'] = $pagelinks;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("forums", "0" ) . "
<div>{$pagelinks}</div>
" . ( method_exists( $this->registry->getClass('output')->getTemplate('modcp'), 'subTabLoop' ) ? $this->registry->getClass('output')->getTemplate('modcp')->subTabLoop() : '' ) . "
