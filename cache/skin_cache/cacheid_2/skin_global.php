...
$this->_funcHooks['globalTemplate'] = array('fbcenabled','pagenumberintitle','brandingBar','memberbox','notifications','messengerlink','notificationsCount','notificationsLink','hasMemberList','hasForums','hasBlog','hasGallery','hasNexus','viewnewcontentapp','mainpageContent','skinchanger','langchooser','vigLinkEnabled');
...
{
$count_e0787991ae8ff562ff572ba70988b579 = is_array($this->functionData['globalTemplate']) ? count($this->functionData['globalTemplate']) : 0;
$this->functionData['globalTemplate'][$count_e0787991ae8ff562ff572ba70988b579]['html'] = $html;
$this->functionData['globalTemplate'][$count_e0787991ae8ff562ff572ba70988b579]['documentHeadItems'] = $documentHeadItems;
$this->functionData['globalTemplate'][$count_e0787991ae8ff562ff572ba70988b579]['css'] = $css;
$this->functionData['globalTemplate'][$count_e0787991ae8ff562ff572ba70988b579]['jsModules'] = $jsModules;
$this->functionData['globalTemplate'][$count_e0787991ae8ff562ff572ba70988b579]['metaTags'] = $metaTags;
$this->functionData['globalTemplate'][$count_e0787991ae8ff562ff572ba70988b579]['header_items'] = $header_items;
$this->functionData['globalTemplate'][$count_e0787991ae8ff562ff572ba70988b579]['items'] = $items;
$this->functionData['globalTemplate'][$count_e0787991ae8ff562ff572ba70988b579]['footer_items'] = $footer_items;
$this->functionData['globalTemplate'][$count_e0787991ae8ff562ff572ba70988b579]['stats'] = $stats;
}
$IPBHTML .= "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Strict//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd\">
	<html xml:lang=\"en\" lang=\"en\" xmlns=\"http://www.w3.org/1999/xhtml\"<!--hook.if.skin_global.globalTemplate.fbcenabled.pre.startif-->" . ((IPSLib::fbc_enabled() === TRUE || $this->settings['fbc_appid']) ? (" xmlns:fb=\"http://www.facebook.com/2008/fbml\"") : ("")) . ">
	<head>
						...
						<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "{$this->settings['query_string_formatted']}", "public",'' ), "", "" ) . "\" method=\"post\">
							<fieldset>
								...
								<select name=\"langid\" id='newLang'>
									".$this->__f__19fa0a8d0a2373839daa9b20a7f8f3b7($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."								</select>
...
function __f__19fa0a8d0a2373839daa9b20a7f8f3b7($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_56a36e079b8fd60fb7b1e3c9713a5e1d = is_array($this->functionData['includeCSS']) ? count($this->functionData['includeCSS']) : 0;
$this->functionData['includeCSS'][$count_56a36e079b8fd60fb7b1e3c9713a5e1d]['css'] = $css;
}

$this->minify = array();
$IPBHTML .= "" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
	".$this->__f__b6f547ea2e84d0136f20b2c7c154ff4a($css)."	" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
...
" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
	".$this->__f__b8f8876d6672a9a9cc0103e7418ae8db($css)."") : ("")) . "<!--hook.if.skin_global.includeCSS.inlinecss.post.endif-->";
return $IPBHTML;
}


function __f__b6f547ea2e84d0136f20b2c7c154ff4a($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b8f8876d6672a9a9cc0103e7418ae8db($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_4bdef1eb98a45683f7f7670c3f889985 = is_array($this->functionData['includeFeeds']) ? count($this->functionData['includeFeeds']) : 0;
$this->functionData['includeFeeds'][$count_4bdef1eb98a45683f7f7670c3f889985]['documentHeadItems'] = $documentHeadItems;
}
$IPBHTML .= "" . ((count($documentHeadItems)) ? ("
	".$this->__f__fb392200f39876ff897247852b12207c($documentHeadItems)."") : ("")) . "";
return $IPBHTML;
}


function __f__0a998a6907caeaa98bf6ebb883e8fdff($documentHeadItems,$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__fb392200f39876ff897247852b12207c($documentHeadItems)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__0a998a6907caeaa98bf6ebb883e8fdff($documentHeadItems,$type,$idx)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_cd67c880f93b4b37338e598b6cfda786 = is_array($this->functionData['includeJS']) ? count($this->functionData['includeJS']) : 0;
$this->functionData['includeJS'][$count_cd67c880f93b4b37338e598b6cfda786]['jsModules'] = $jsModules;
}
...
")) . "<!--hook.if.skin_global.includeJS.minifyjs.post.endif-->
<script type=\"text/javascript\" >
...
{
$count_4e715564a1474be130de87ba9bf6cfe5 = is_array($this->functionData['includeMeta']) ? count($this->functionData['includeMeta']) : 0;
$this->functionData['includeMeta'][$count_4e715564a1474be130de87ba9bf6cfe5]['metaTags'] = $metaTags;
}
$IPBHTML .= "<!--hook.if.skin_global.includeMeta.metatags.pre.startif-->" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
	".$this->__f__16a6ec575c46d9c0f31ae41f1b5af1f1($metaTags)."") : ("")) . "
<meta property=\"og:image\" content=\"{$this->settings['meta_imagesrc']}\"/>";
return $IPBHTML;
}


function __f__efb9ec924c96b472b09bae24b9803888($metaTags,$tag='',$id='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__16a6ec575c46d9c0f31ae41f1b5af1f1($metaTags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $metaTags as $tag => $id )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__efb9ec924c96b472b09bae24b9803888($metaTags,$tag,$id)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_0f2493cebb51eb52256cdc0b08f2a822 = is_array($this->functionData['includeRTL']) ? count($this->functionData['includeRTL']) : 0;
}

$this->isRtlLang	= false;
$IPBHTML .= "".$this->__f__c8245817c45c353dea99e3c9372b4511()."<script type='text/javascript'>
	var isRTL	= false;
	var rtlIe	= '';
	var rtlFull	= '';
</script>
...
function __f__c8245817c45c353dea99e3c9372b4511()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_bee321a01509b023d1f4d9617c087aed = is_array($this->functionData['nextPreviousTemplate']) ? count($this->functionData['nextPreviousTemplate']) : 0;
$this->functionData['nextPreviousTemplate'][$count_bee321a01509b023d1f4d9617c087aed]['data'] = $data;
}
...
{
$count_34bca087ca4cb84b59f5bfa46cf5bb12 = is_array($this->functionData['paginationTemplate']) ? count($this->functionData['paginationTemplate']) : 0;
$this->functionData['paginationTemplate'][$count_34bca087ca4cb84b59f5bfa46cf5bb12]['work'] = $work;
$this->functionData['paginationTemplate'][$count_34bca087ca4cb84b59f5bfa46cf5bb12]['data'] = $data;
}
...
{
$count_a0b89ab42ca805d761e4e70bbf8ec90f = is_array($this->functionData['userHoverCard']) ? count($this->functionData['userHoverCard']) : 0;
$this->functionData['userHoverCard'][$count_a0b89ab42ca805d761e4e70bbf8ec90f]['member'] = $member;
}
...
{
$count_b60dfa4f51adc072464b0701f4f5b796 = is_array($this->functionData['userInfoPane']) ? count($this->functionData['userInfoPane']) : 0;
$this->functionData['userInfoPane'][$count_b60dfa4f51adc072464b0701f4f5b796]['author'] = $author;
$this->functionData['userInfoPane'][$count_b60dfa4f51adc072464b0701f4f5b796]['contentid'] = $contentid;
$this->functionData['userInfoPane'][$count_b60dfa4f51adc072464b0701f4f5b796]['options'] = $options;
}
$IPBHTML .= "<ul class='user_details'>
	...
	<ul class='user_fields'>
		...
		<!--hook.if.skin_global.userInfoPane.authorcfields.pre.startif-->" . (($author['custom_fields'] != "") ? ("
			".$this->__f__d83c2ed2366174e776921f10b32cfa57($author,$contentid,$options)."		") : ("")) . "
	</ul>
...
function __f__f6e8016cdf74b1f621b14c199ebbcd9c($author, $contentid, $options,$group='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__d83c2ed2366174e776921f10b32cfa57($author, $contentid, $options)
{
	...
	foreach( $author['custom_fields'] as $group => $data )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__f6e8016cdf74b1f621b14c199ebbcd9c($author,$contentid,$options,$group,$data)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_0d27757ef23b304863df9fcaaaf460b4 = is_array($this->functionData['userSmallPhoto']) ? count($this->functionData['userSmallPhoto']) : 0;
$this->functionData['userSmallPhoto'][$count_0d27757ef23b304863df9fcaaaf460b4]['member'] = $member;
}
...
{
$count_1639221f6f178bbfd537891bcc0302fd = is_array($this->functionData['warnDetails']) ? count($this->functionData['warnDetails']) : 0;
$this->functionData['warnDetails'][$count_1639221f6f178bbfd537891bcc0302fd]['warning'] = $warning;
$this->functionData['warnDetails'][$count_1639221f6f178bbfd537891bcc0302fd]['canSeeModNote'] = $canSeeModNote;
}
...
<div class='ipsBox'>
	<p class='message unspecific'>
		...
		") : ("" . (($warning['wl_points']) ? ("" . (($warning['wl_expire']) ? ("" . (($warning['wl_expire_date']) ? ("
				...
				")) . "") : ("")) . "
			".$this->__f__46dbb99cd283900667575022811e7344($warning,$canSeeModNote)."")) . "
	</p>
...
function __f__46dbb99cd283900667575022811e7344($warning, $canSeeModNote)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
