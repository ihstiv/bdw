...
'altcontacts' => "Alternative Contacts",
'altcontacts_add' => "Add new alternative contact",
...
'altcontacts_blurb' => "Alternative contacts allow other users to contact support and pay invoices on your behalf.",
...
'altcontacts_edit_title' => "Edit alternative contact",
'altcontacts_enter_name' => "Username or email address",
'altcontacts_name' => "Name",
'altcontacts_none' => "You don't have any alternative contacts yet",
'altcontacts_purchase' => "You must have at least one purchase to assign an alternative contact.",
'altcontacts_purchases' => "Purchases",
'altcontacts_remove' => "Remove",
'altcontacts_save' => "Save alternative contact",
...
'alternates' => "alternative contacts",
'alt_added' => "alternative contact added",
'alt_exists' => "That user is already one of your alternative contacts",
'alt_no_user' => "No user found with that username",
'alt_removed' => "alternative contact removed",
'alt_you' => "You cannot add yourself as an alternative contact",
'and' => "and",
'attach_hits' => "Number of downloads",
'authnet_hash' => "The Authorize.Net hash was not valid.",
...
'canceled' => "Canceled",
'cancel_blurb' => "This will cancel renewals on the purchase. The purchase will remain active until the expiry date and then will expire with no further renewals.",
'cancel_g_blurb' => "The child purchases which have their renewal terms grouped to this purchase will be immediately canceled.",
'cancel_title' => "Cancel: %s",
...
'change_package_blurb' => "This package has upgrade or downgrade options available. Review the available packages and pricing options below, and select the package you'd like to change to. If your package is currently active you will receive an account credit or an invoice will be generated for you to pay, depending upon your selection. If your package is currently inactive, <em>this will not reactivate your purchase</em>.",
...
'checkout_doubleclick' => "Please only click once to prevent multiple orders",
...
'checkout_update_shipping' => "Update Shipping Address",
...
'credit_balance' => "Your account credit balance:",
'credit_blurb' => "Your account credit will automatically be used for any renewal invoices or can be used for new purchases.",
'credit_payout' => "Request Payout",
'credit_payouts_cancel' => "Cancel",
'credit_payouts_pending' => "Pending Payout Request",
'credit_payout_amount' => "Amount to Withdraw",
'credit_payout_amount_minimum' => "Minimum %s",
'credit_payout_blurb' => "You can request a payout of the credit that is on your account.",
'credit_payout_errmax' => "You must enter an amount less than your balance.",
'credit_payout_errmin' => "You must enter an amount greater than %s.",
'credit_payout_errnoval' => "You must enter an amount to withdraw.",
'credit_payout_gateway' => "Payout Via",
'credit_payout_min' => "When you have at least %s in your account, you can request a payout of your credit.",
'credit_topup' => "Add to Account Credit",
'credit_topup_amount' => "Amount to credit",
'credit_topup_amount_maximum' => "Maximum %s",
'credit_topup_amount_minimum' => "Minimum %s",
'credit_topup_blurb' => "You can add funds to your account so that future payments can be paid for with the credit on your account. Note that all renewal charges will automatically use your account credit.",
'credit_topup_errmax' => "Your account credit cannot exceed %s.",
'credit_topup_errmin' => "You must enter an amount greater than %s.",
'credit_topup_errnoval' => "You must enter an amount to credit your account with.",
'credit_topup_invoice' => "Account Credit Increase",
'custom_packages' => "Custom Packages",
'delivery_estimate' => "Est. delivery: %s",
'donations' => "Donations",
...
'err_already_got_one' => "This invoice contains items you have already purchased which cannot be purchased again. Please contact an administrator for assistance.",
...
'err_bad_gv_email' => "That is not a valid email address.",
...
'err_cannot_purchase' => "You have already purchased this item and it cannot be purchased again. A renewal invoice for your existing purchase was generated which has since expired. Please contact an administrator for assistance.",
...
'err_gr_inactive' => "You cannot associate this product with an expired or canceled parent purchase. Please <a href='%s' target='_blank'>renew</a> the purchase first, then try again.",
...
'err_icbp_cancel' => "Cancel this invoice &rarr;",
'err_icbp_cancelandgenerate' => "Cancel this invoice and generate a new renewal invoice &rarr;",
'err_icbp_reacexpparent' => "The invoice contains reactivation fees for purchases whose parent purchases have expired, and so reactivating will have no effect unless the parent purchase is first renewed.",
'err_icbp_reacts' => "The invoice contains reactivation fees for purchases which are already active.",
'err_icbp_renewcosts' => "The invoice contains renewals for purchases which have since had their renewal costs changed.",
'err_icbp_renewparent' => "Renew parent &rarr;",
'err_icbp_renews' => "The invoice contains renewals for purchases which can no longer be renewed. Please contact us for assistance.",
'err_invalid_coupon' => "You cannot use that coupon with this purchase.",
'err_invalid_gv_amount' => "You must enter a valid amount if you would like to choose your own gift voucher amount.",
...
'err_no_cvv2' => "You must enter your security code.",
'err_no_email' => "You did not enter your EMail address",
'err_no_gv_amount' => "You must select a gift voucher amount.",
'err_no_gv_email' => "If sending the voucher by email, you must provide the recipients's email address.",
'err_no_gv_method' => "You must choose how you would like to send this gift voucher.",
...
'err_no_methods2' => "We are unable to process a purchase with those items in combination. Please contact an administrator for assistance.",
...
'err_no_purchase_renew' => "This purchase has no renewal charge to pay.",
'err_no_purchase_renewals' => "This purchase does not have any renewal terms and so cannot be canceled",
'err_no_purchase_view' => "Could not load the purchase you are trying to view.",
'err_no_rate' => "Only the account owner can rate support responses.",
'err_no_support_title' => "You did not enter a title for the request.",
'err_no_trans' => "Could not locate transaction.",
'err_no_vouchers' => "We are not currently offering gift vouchers.",
'err_perm_coupon' => "You are not allowed to use that coupon.",
'err_perm_package' => "You are not allowed to purchase that item",
'err_purchase_cannot_be_renewed' => "The purchase you are trying to renew already has a pending invoice which has expired. Please contact us for further assistance.",
'err_redeem_badcode' => "The code entered was not valid or has already been redeemed. Please check the code entered and try again.",
'err_redeem_expired' => "The code entered has expired.",
'err_redeem_login' => "You must be logged in to redeem a gift voucher.",
'err_redeem_nocode' => "Please enter the redemption code on your gift voucher.",
'err_reg_code' => "The verification code provided was not correct.",
'err_renew_invalid' => "You have to enter the period you want to renew for.",
...
'err_sf_required' => "The field '%s' is required.",
...
'expired' => "Expired",
'expires' => "Expires",
'external_redirect' => "Redirecting you to external site...",
'FEDEX_1_DAY_FREIGHT' => "FedEx 1Day&reg; Freight",
'FEDEX_2_DAY' => "FedEx 2Day&reg;",
'FEDEX_2_DAY_AM' => "FedEx 2Day&reg; A.M.",
'FEDEX_2_DAY_FREIGHT' => "FedEx 2Day&reg; Freight",
'FEDEX_3_DAY_FREIGHT' => "FedEx 3Day&reg; Freight",
'FEDEX_EXPRESS_SAVER' => "FedEx Express Saver&reg;",
'FEDEX_FIRST_FREIGHT' => "FedEx First Overnight&reg; Freight",
'FEDEX_FREIGHT_ECONOMY' => "FedEx Freight&reg; Economy",
'FEDEX_FREIGHT_PRIORITY' => "FedEx Freight&reg; Priority",
'FEDEX_GROUND' => "FedEx Ground&reg;",
'FIRST_OVERNIGHT' => "FedEx First Overnight&reg;",
...
'fraud_reject_public' => "Your payment could not be processed as it did not pass our anti-fraud requirements. Please select a different payment method, or contact us for more information.",
'gateway_2checkout_ins_update' => "You have not updated your 2CheckOut account for INS support. Go to Payment Gateways in the IP.Nexus Admin CP, click your 2CheckOut payment method and follow the instructions in the green box.",
'gateway_alertpay_invalid_token' => "AlertPay did not verify data passed back.",
...
'gateway_paypal_bad_amount' => "The amount received is incorrect.",
...
'go_back' => "Go back",
'grdiscount' => "Grouped Renewal Adjustment",
'grdiscount_explain' => "You are adding %1\$s to your existing %2\$s. We'll group the renewals of these two products together so that they expire together. Since we'll keep the current expiry date for your %2\$s, this means that you'll be getting a different period of service this renewal cycle, and we've adjusted the price you're paying now accordingly.",
'GROUND_HOME_DELIVERY' => "FedEx Home Delivery&reg;",
'gr_cancel_blurb' => "This will immediately cancel the purchase. The renewal terms of the parent purchase will be adjusted accordingly.",
'gr_reactivate' => "Reactivate: %s",
'gv_amount' => "Amount",
'gv_buy' => "Buy Gift Voucher",
'gv_email' => "Email",
'gv_email_content' => "<#AMOUNT#> Gift Voucher
...
Redeem Now: <#LINK#>",
'gv_message' => "Message",
'gv_method' => "Send Gift Voucher By",
'gv_other' => "Other",
'gv_print' => "Print",
'gv_recipient_email' => "Recipient's Email",
'gv_recipient_name' => "Recipient's Name",
'gv_redeem' => "Redeem Gift Voucher",
'gv_redeemed' => "Voucher Redeemed: %s",
'gv_redeem_code' => "Redemption Code",
'gv_redeem_now' => "Redeem Now",
'gv_redeem_url' => "Redeem at %s",
'gv_sender' => "Sender's Name",
'gv_title' => "%s Gift Voucher",
'gv_view' => "We have emailed this voucher to the recipient, but it has not been redeemed yet.",
...
'hosting_domain_buy' => "I would like to purchase a domain",
...
'hosting_net_status' => "Network Status",
'hosting_no_problems' => "There are currently no problems to report",
...
'INTERNATIONAL_ECONOMY' => "FedEx International Economy&reg;",
'INTERNATIONAL_ECONOMY_FREIGHT' => "FedEx International Economy&reg; Freight",
'INTERNATIONAL_FIRST' => "FedEx International First&reg;",
'INTERNATIONAL_PRIORITY' => "FedEx International Priority&reg;",
'INTERNATIONAL_PRIORITY_FREIGHT' => "FedEx International Priority&reg; Freight",
'invoices' => "Invoices",
...
'must_reactivate_parent_first' => "Before you can reactivate this child purchase you must first reactivate the parent purchase.",
...
'nexustask' => "Task ran",
'nexustask_invoice_cancelled' => "The transaction failed because the invoice was canceled while payment was pending.",
...
'ne_login_for_other_payment' => "login to the client area to try an alternative method of payment.",
...
'ne_more_to_pay' => "Further payment is still required.",
'ne_new_invoice' => "A new invoice has been generated for you",
'ne_note_expiry_dates' => "Note that if payment is not received for an item before the expiry date, the item and associated services will expire on that date.",
...
'ne_ship_canc_notification' => "This email is to let you know that the shipment we previously emailed you about has been delayed:",
...
'ne_support_link_acp_link' => "in the Admin CP",
...
'ne_support_staff' => "A support request in the '<#DEPARTMENT#>' support department has been created or replied to.",
...
",
'notify_autopay_fail_title' => "Payment Failed: {title}",
...
Thank you for your order. See the instructions below for submitting your payment:
...
'not_valid_store_cat' => "The category you visited does not exist",
...
'ppi_title' => "Pay-Per-Incident: %s",
'print' => "Print",
'PRIORITY_OVERNIGHT' => "FedEx Priority Overnight&reg;",
...
'purchases_renew_blurb' => "Select the purchase you would like to renew:",
...
'purchase_cancel_confirm' => "Proceed",
...
'purchase_name' => "Name",
'purchase_reactivate' => "Reactivate",
'purchase_reactivated' => "Purchase Reactivated",
'purchase_renew' => "Renew Now",
'purchase_renewals' => "Renewal Cost",
'purchase_view' => "View Info",
'rating_feedback' => "Would you like to leave feedback?",
'rating_feedback_blurb' => "In addition to your rating, you can leave a feedback message. Note that this message will not be seen by our support staff. If you require further assistance, you should reply to the support request as normal.",
'rating_feedback_cancel' => "No thanks",
'rating_feedback_ok' => "Thank you for your feedback!",
'rating_feedback_send' => "Send Feedback",
'rating_outof' => "%d out of %d",
'reactivate_continue' => "Continue &rarr;",
'reactivate_siblings' => "You have some other associated purchases which are also canceled. Would you like to reactivate any others?",
'reactivate_terms' => "Renewal Terms",
'reactivate_title' => "Reactivate: %s",
'receive_admin_emails' => "Send me news and information",
'referrals' => "Referrals",
'referrals_bbcode' => "BBCode",
'referrals_bbcode_blurb' => "for forums",
'referrals_blurb' => "Refer members using the link codes below, and you can earn up to %s commission on purchases they make!",
...
'referrals_direct' => "Direct Link",
'referrals_html' => "HTML Code",
'referrals_html_blurb' => "for your website",
'referrals_preview' => "Preview",
'ref_blurb_more' => "More information",
'ref_com_limit' => "up to %s",
'ref_com_plimit' => "on those packages",
'ref_cond_and' => " and ",
'ref_cond_e' => "exactly",
'ref_cond_for_group' => "Person being referred is in group %s",
'ref_cond_for_purch' => "Person being referred has made %s %s %s",
'ref_cond_g' => "at least",
'ref_cond_l' => "less than",
'ref_cond_n' => "purchases",
'ref_cond_or' => " or ",
'ref_cond_packages' => "Person being referred is purchasing %s",
'ref_cond_packages_r' => "Person being referred is purchasing or renewing %s",
'ref_cond_v' => "worth of purchases",
'ref_url' => "Target link URL",
'renewals' => "Renewals",
'renewal_prefix' => "Renewal: ",
'renew_and_reactivate' => "Which child purchases would you like to reactivate?",
'renew_length' => "How long would you like to renew for?",
'renew_string_d' => "%d days",
'renew_string_d_s' => "%d day",
'renew_string_m' => "%d months",
'renew_string_m_s' => "%d month",
'renew_string_w' => "%d weeks",
'renew_string_w_s' => "%d week",
'renew_string_y' => "%d years",
'renew_string_y_s' => "%d year",
...
'rrule_purchase_amount' => "Purchase is %s %s",
...
'shiporder_items' => "Items",
'shiporder_track' => "Tracking Information",
'shiporder_track_click' => "Click here to view tracking information.",
'shipping_address' => "Shipping Address",
'shipping_address_change' => "Change",
'shipping_api_address_fail' => "The address provided could not be verified. Please check you have entered it correctly.",
'shipping_canceled' => "<#CUSTOMER_NAME#>,

This email is to let you know that the shipment we previously emailed you about has been delayed:
- - - - - - - - - -
<#ITEM_LIST#>
- - - - - - - - - -
...
",
'shipping_canceled_sbjt' => "Shipping Notification for %s",
...
'shipstatus_canc' => "This order has been canceled.",
'shipstatus_done' => "This order has been shipped.",
'shipstatus_pend' => "This order is waiting to be shipped.",
'ship_order_delivered' => "Delivered: ",
'ship_order_eta' => "Estimated delivery: ",
'ship_order_ordered' => "Ordered: ",
'ship_order_shipped' => "Shipped: ",
'split_already_paid' => "Already paid",
'split_left_to_pay' => "Left to pay",
'split_payment' => "I want to pay by multiple methods",
'split_payments_desc' => "You can pay with multiple transactions if you want to pay part of the invoice using one method and another part using others.",
'split_payments_go' => "Continue &rarr;",
'split_payments_label' => "Amount to pay",
'split_too_much' => "You must enter an amount less than %s",
'sr_open' => "Open Support Requests",
'staff_notify_body' => "<#STAFF_NAME#>,

A support request in the '<#DEPARTMENT#>' support department has been created or replied to by <#POSTER#>.
...
<#REPLY_NOTIFY#>",
'STANDARD_OVERNIGHT' => "FedEx Standard Overnight&reg;",
...
'store__latest' => "See our latest products",
...
'subscription_in_cart' => "Either you already have this in your cart, or you already have over 150 posts. Thanks anyways. ;)",
'support' => "Support",
...
'support_ppi_message' => "This department requires a payment of {PPI_AMOUNT} to submit a support request.",
...
'support_request_rate' => "Rate this response: ",
...
'ticketremidner_subject' => "%s Assigned Support Requests",
'ticketreminder_body' => "This message is sent every morning to remind you of support requests assigned to you.",
'time_zone' => "Time Zone",
'track_empty' => "No tracking information available.",
'track_event' => "Event",
'track_location' => "Location",
'track_notes' => "Notes",
'track_shipment' => "Track Shipment",
'track_time' => "Time",
'transaction_pend_invoice_paid' => "The invoice was paid in full by another transaction while this transaction was pending.",
...
'your_altcontacts' => "Your Current alternative contacts",
