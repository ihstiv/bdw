...
",
'booty_status_call' => "<#MEMBER_NAME#> has mentioned you in a status update.
...
'subject__booty_call' => "<a href='%s'>%s</a> mentioned you in <a href='%s'>this post</a>",
'subject__booty_status_call' => "<a href='%s'>%s</a> mentioned you in a <a href='%s'>status update</a>",
